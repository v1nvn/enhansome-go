...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,158](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 246,120.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,158 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,158; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,979 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,941 - Blazingly fast and light-weight Actor engine written in Golang.
- [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,237 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

_Libraries for building programs that leverage AI._

- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 585 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,799 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,131 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 143,206 - Run large language models locally.
...
- [PortAudio](https://github.com/gordonklaus/portaudio) ⭐ 771 - Go bindings for the PortAudio audio I/O library.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,715 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [go-jose](https://github.com/go-jose/go-jose) ⭐ 401 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,041 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,131 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,110 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
- [keto](https://github.com/ory/keto) ⭐ 5,036 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oidc](https://github.com/zitadel/oidc) ⭐ 1,574 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
- [openfga](https://github.com/openfga/openfga) ⭐ 3,682 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,340 - Session Manager for HTTP servers.
...
- [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,608 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,101 - Official Go implementation of the Ethereum protocol.
...
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,937 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,318 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,181 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,168 - Simple and clean Telegram bot client.
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,974 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,702 - Air - Live reload for Go apps.
...
- [Task](https://github.com/go-task/task) ⭐ 12,934 - simple "Make" alternative.
...
- [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 495 - An interactive table component for bubbletea.
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,390 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,043 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,534 - Terminal JSON viewer & processor.
...
- [go-isatty](https://github.com/mattn/go-isatty) ⭐ 862 - isatty for golang.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,367 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,745.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,252 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,048 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,408 - Basic thread-safe progress bar that works in every OS.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,824 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,362.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,839 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,362 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,608.
- [uilive](https://github.com/gosuri/uilive) ⭐ 1,709 - Library for updating terminal output in real time.
...
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,274 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,658 - Commander for modern Go CLI interactions.
...
- [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,153 - Struct-based argument parsing in Go.
- [go-flags](https://github.com/jessevdk/go-flags) ⭐ 2,663 - go command line option parser.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,234 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
- [version](https://github.com/mszostok/version) ⭐ 108 - Collects and displays CLI version information in multiple formats along with upgrade notice.
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,841 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,336 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,653 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,193 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,647 - Go configuration with fangs.
...
- [zerocfg](https://github.com/chaindead/zerocfg) ⭐ 187 - Zero-effort, concise configuration management that avoids boilerplate and repetitive code, supports multiple sources with priority overrides.
...
- [drone](https://github.com/drone/drone) ⭐ 32,826 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,566 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,734.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,135 - Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,372 - A message streaming bridge between a range of protocols.
- [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,109 - A high-performance ELT data integration framework with pluggable architecture.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,711 - Go package implementing compressed bitsets.
...
- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,601 - Go package implementing Bloom filters.
...
- [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,801 - Collection of useful, performant, and thread-safe data structures.
- [gods](https://github.com/emirpasic/gods) ⭐ 16,943 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [gota](https://github.com/kniren/gota) ⭐ 3,189 - Implementation of dataframes, series, and data wrangling methods for Go.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,655 - Distributed, Fault-tolerant task queue.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,525 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,405 - Modern text indexing library for go.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,111 -  A high performance memory-bound Go cache.
...
- [badger](https://github.com/dgraph-io/badger) ⭐ 14,638 - Fast key-value store in Go.
...
- [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,706 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover](https://github.com/ostafen/clover) ⭐ 756 - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 30,975 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,915 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,528 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,431 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,723 - Dolt – It's Git for Data.
...
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,270 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,724 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,138 - Scalable datastore for metrics, events, and real-time analytics.
...
- [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,161 - Fast k/v database compatible with lsm and b+tree.
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,228 - Milvus is a vector database for embedding management, analytics and search.
...
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,333 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,895 - Monitoring system and time series database.
...
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,806 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
...
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,554 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,271 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,912 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,547 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,039 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,499 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,781 - Database migrations. CLI and Golang library.
...
- [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,757 - Go toolset to handle MySQL protocol and replication.
...
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,906 - Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,636 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,214 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) ⭐ 646 - Powerful data retrieval methods as well as DB-agnostic query building capabilities.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,267 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,438 - Go library that helps you build SQL queries.
...
- [cayley](https://github.com/google/cayley) ⭐ 14,932 - Graph database with support for multiple backends.
...
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,515 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 703 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,940 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,940 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,427 query results easily.
...
- [go-mongox](https://github.com/chenmingyong0423/go-mongox) ⭐ 190 - A Go Mongo library based on the official driver, featuring streamlined document operations, generic binding of structs to collections, built-in CRUD, aggregation, automated field updates, struct validation, hooks, and plugin-based programming.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,359 - Official MongoDB driver for the Go language.
...
- [redigo](https://github.com/gomodule/redigo) ⭐ 9,820 - Redigo is a Go client for the Redis database.
- [redis](https://github.com/redis/go-redis) ⭐ 20,944 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,684 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
- [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,887 - Official Elasticsearch client for Go.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 968 - Fast trigram based code search.
...
- [carbon](https://github.com/dromara/carbon) ⭐ 5,059 - A simple, semantic and developer-friendly time package for golang.
...
- [dateparse](https://github.com/araddon/dateparse) ⭐ 2,086 - Parse date's without knowing format in advance.
...
- [consistent](https://github.com/buraksezer/consistent) ⭐ 734 - Consistent hashing with bounded loads.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,613 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,164 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,907 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,038 - A cloud native Kubernetes Global Balancer.
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,467 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,432 - A modular-designed and easy-to-use microservices framework in Go.
...
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,533 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,300 - NATS is a simple, secure, and
...
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,618 - Simplified distributed locking implementation using Redis.
...
- [rpcx](https://github.com/smallnest/rpcx) ⭐ 8,221 - Distributed pluggable RPC service framework like alibaba Dubbo.
- [Semaphore](https://github.com/jexia/semaphore) ⭐ 94 - A straightforward (micro) service orchestrator.
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,274).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,884 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,783 - BitTorrent client package.
- [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 968 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
- [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,377 - A Go library for email verification without sending any emails.
...
- [go-imap](https://github.com/emersion/go-imap) ⭐ 2,198 - IMAP library for clients and servers.
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,000 - A simple Go library for sending mails in Go.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,557 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,922 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,188 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 4,998 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
- [SendGrid](https://github.com/sendgrid/sendgrid-go) ⭐ 1,013 - SendGrid's Go library for sending email.
...
- [anko](https://github.com/mattn/anko) ⭐ 1,519 - Scriptable interpreter written in Go.
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,607.
...
- [expr](https://github.com/antonmedv/expr) ⭐ 6,914 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,030 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,271 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,201 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,607 - Lua 5.1 VM and compiler written in Go.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,659 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,228 - Go error library with error portability over the network.
...
- [oops](https://github.com/samber/oops) ⭐ 678 - Error handling with context, stack trace and source fragments.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,239 - FileSystem Abstraction System for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,482 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,695 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,798.
...
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1,361 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,775 - Arbitrary-precision fixed-point decimal numbers.
...
- [ledger](https://github.com/formancehq/ledger) ⭐ 974 - A programmable financial ledger that provides a foundation for money-moving applications.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,270 - Terminal stock watcher and stock position tracker.
...
- [nosurf](https://github.com/justinas/nosurf) ⭐ 1,667 - CSRF protection middleware for Go.
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,101 - dead simple 2D game engine in Go.
...
- [go-sdl2](https://github.com/veandco/go-sdl2) ⭐ 2,297 - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).
...
- [nano](https://github.com/lonng/nano) ⭐ 3,023 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,626 - Pure Go game engine.
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,553 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,069 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [goderive](https://github.com/awalterschulze/goderive) ⭐ 1,261 - Derives functions from input types
- [goverter](https://github.com/jmattheis/goverter) ⭐ 696 - Generate converters by defining an interface.
...
- [jennifer](https://github.com/dave/jennifer) ⭐ 3,504 - Generate arbitrary Go code without templates.
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,184 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,341 - Geolocation DB with spatial index and realtime geofencing.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,385 - Compile shell scripts to Go.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,729 - A high-performance and low-cost goroutine pool in Go.
...
- [rill](https://github.com/destel/rill) ⭐ 1,676 - Go toolkit for clean, composable, channel-based concurrency.
...
- [semaphore](https://github.com/marusama/semaphore) ⭐ 177 - Fast resizable semaphore implementation based on CAS (faster than channel-based semaphore implementations).
...
- [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,390 - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,680 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 411 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,051 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,655.
...
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,254 - Build native macOS applications using Go.
- [energy](https://github.com/energye/energy) ⭐ 479 - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,548 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [gotk3](https://github.com/gotk3/gotk3) ⭐ 2,159 - Go bindings for GTK3.
...
- [unison](https://github.com/richardwilkes/unison) ⭐ 267 - A unified graphical user experience toolkit for Go desktop applications. macOS, Windows, and Linux are supported.
...
- [webview](https://github.com/zserge/webview) ⭐ 13,144 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [systray](https://github.com/getlantern/systray) ⭐ 3,488 - Cross platform Go library to place an icon and menu in the notification area.
...
- [zenity](https://github.com/ncruces/zenity) ⭐ 812 - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
- [go-rpio](https://github.com/stianeikeland/go-rpio) ⭐ 2,243 - GPIO for Go, doesn't require cgo.
...
- [bimg](https://github.com/h2non/bimg) ⭐ 2,856 - Small package for fast and efficient image processing using libvips.
...
- [gltf](https://github.com/qmuntal/gltf) ⭐ 257 - Efficient and robust glTF 2.0 reader, writer and validator.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,076 - Go package for computer vision using OpenCV 3.3+.
- [goimagehash](https://github.com/corona10/goimagehash) ⭐ 800 - Go Perceptual image hashing package.
...
- [govips](https://github.com/davidbyttow/govips) ⭐ 1,443 - A lightning fast image processing and resizing library for Go.
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,765 - Screenshoting webpages using go and headless chrome on command line.
...
- [imaginary](https://github.com/h2non/imaginary) ⭐ 5,855 - Fast and simple HTTP microservice for image resizing.
...
- [picfit](https://github.com/thoas/picfit) ⭐ 2,227 - An image resizing server written in Go.
...
- [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,593 - Lightweight data stream processing engine for IoT edge.
...
- [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,186 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,117 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,275 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,491.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,969 - Get a JSON value with one line of code.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,292 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,292 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,292 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,292, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,076, [zap](https://github.com/uber-go/zap) ⭐ 23,176, [zerolog](https://github.com/rs/zerolog) ⭐ 11,475, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,122 - Simple rolling logger, implements io.WriteCloser.
...
- [slog](https://github.com/gookit/slog) ⭐ 472 - Lightweight, configurable, extensible logger for Go.
...
- [spew](https://github.com/davecgh/go-spew) ⭐ 6,245 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,176 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,475 - Zero-allocation JSON logger.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 789 - An accelerated Machine Learning framework for Go.
...
- [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,773 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,888 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 407 - Huggingface transformer pipelines for golang with onnxruntime.
...
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 784 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,316 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,007 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,899 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,390 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,090 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,755 - Asynchronous task queue/job queue based on distributed message passing.
...
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,954 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,026 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,525 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,588 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize](https://github.com/xuri/excelize) ⭐ 19,233 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [do](https://github.com/samber/do) ⭐ 2,123 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,559 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,823 - Automated Initialization in Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,794 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,794 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,579 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,657 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,657 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,240 - Nunu is a scaffolding tool for building Go applications.
...
- [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,120 - cross-platform, cli app to perform various operations on string.
...
- [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,237 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,512 - Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,951 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,215 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [shortid](https://github.com/teris-io/shortid) ⭐ 950 - Distributed generation of super short, unique, non-sequential, URL friendly IDs.
...
- [xz](https://github.com/ulikunitz/xz) ⭐ 513 - Pure golang package for reading and writing xz-compressed files.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,731.
...
- [slug](https://github.com/gosimple/slug) ⭐ 1,253 - URL-friendly slugify with multiple languages support.
...
- [arp](https://github.com/mdlayher/arp) ⭐ 373 - Package arp implements the ARP protocol, as described in RFC 826.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,749 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,363 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,617 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- [fortio](https://github.com/fortio/fortio) ⭐ 3,537 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- [gev](https://github.com/Allenxuxu/gev) ⭐ 1,751 - gev is a lightweight, fast non-blocking TCP network library based on Reactor mode.
...
- [go-stun](https://github.com/ccding/go-stun) ⭐ 706 - Go implementation of the STUN client (RFC 3489 and RFC 5389).
...
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,374 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [mdns](https://github.com/hashicorp/mdns) ⭐ 1,261 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
- [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,309 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,716 - An implementation of the QUIC protocol in pure Go.
...
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,909 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,891 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,885 - A pure Go implementation of the WebRTC API.
...
- [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 255 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- [req](https://github.com/imroc/req) ⭐ 4,511 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,938 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,157 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,292 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,185 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,241 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,556 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,305 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [reform](https://github.com/go-reform/reform) ⭐ 1,444 - Better ORM for Go, based on non-empty interfaces and code generation.
...
- [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,877 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,156 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,428 - A distributed tracing system.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,473 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,367 - go generate based graphql server library.
...
- [go-deepcopy](https://github.com/tiendc/go-deepcopy) ⭐ 94 - Fast deep copy library.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,035 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,862 - gonum/plot provides an API for building and drawing plots in Go.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,034 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,160 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 567 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,386 - Tool and library to remotely hack RTSP streams from surveillance cameras.
- [certificates](https://github.com/mvmaasakkers/certificates) ⭐ 38 - An opinionated tool for generating tls certificates.
- [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,239 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,685 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,634 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [themis](https://github.com/cossacklabs/themis) ⭐ 1,923 - high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps.
...
- [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,957 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,770 - High-performance 100% compatible drop-in replacement of "encoding/json".
- [mapstructure](https://github.com/mitchellh/mapstructure) ⭐ 7,986 - Go library for decoding generic map values into native Go structures.
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,782 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- [Clace](https://github.com/claceio/clace) ⭐ 618 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,564 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,532 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,493 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,402 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,659 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 53,016 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,713 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,156 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,534 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,117 - Make SSH apps, just like that!
...
- [goio](https://github.com/primetalk/goio) ⭐ 85 - An implementation of IO, Stream, Fiber for Golang, inspired by awesome Scala libraries cats and fs2.
...
- [quicktemplate](https://github.com/valyala/quicktemplate) ⭐ 3,222 - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
- [raymond](https://github.com/aymerick/raymond) ⭐ 634 - Complete handlebars implementation in Go.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,359 - A HTML templating language that has great developer tooling.
...
- [go-snaps](http://github.com/gkampitakis/go-snaps) ⭐ 213 - Jest-like snapshot testing in Golang.
...
- [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,357 - BDD-style framework with web UI and live reload.
- [gocrest](https://github.com/corbym/gocrest) ⭐ 106 - Composable hamcrest-like matchers for Go assertions.
- [godog](https://github.com/cucumber/godog) ⭐ 2,439 - Cucumber BDD framework for Go.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,138 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,096 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,710 - Sacred extension to the standard go testing package.
...
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,367 - Mock SQL driver for testing database interactions.
- [go-txdb](https://github.com/DATA-DOG/go-txdb) ⭐ 716 - Single transaction based database driver mainly for testing purposes.
- [gock](https://github.com/h2non/gock) ⭐ 2,171 - Versatile HTTP mocking made easy.
- [gomock](https://github.com/uber-go/mock) ⭐ 2,835 - Mocking framework for the Go programming language.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 481 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,940.
...
- [gofuzz](https://github.com/google/gofuzz) ⭐ 1,505 - Library for populating go objects with random values.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,896 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,715 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,977 - A Devtools driver to make web automation and scraping easy.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,550 - Formatters for time, numbers, and memory size to human readable format.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,106 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [toml](https://github.com/BurntSushi/toml) ⭐ 4,737 - TOML configuration format (encoder/decoder with reflection).
...
- [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,695 - Parse RSS and Atom feeds in Go.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,775 - Shell parser and formatter.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 24,286 - Fast and Elegant Scraping Framework for Gophers.
...
- [xurls](https://github.com/mvdan/xurls) ⭐ 1,219 - Extract urls from text.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,082 - The official AWS SDK for the Go programming language.
...
- [disgo](https://github.com/switchupcb/disgo) ⭐ 102 - Go API Wrapper for the Discord API.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,046 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google](https://github.com/google/google-api-go-client) ⭐ 4,260 - Auto-generated Google APIs for Go.
...
- [lark](https://github.com/chyroc/lark) ⭐ 445 - [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback.
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 2,699 - Minio Go Library for Amazon S3 compatible cloud storage.
...
- [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 728 - Wrapper for PayPal payment API.
...
- [stripe](https://github.com/stripe/stripe-go) ⭐ 2,322 - Go client for the Stripe API.
...
- [changie](https://github.com/miniscruff/changie) ⭐ 771 - Automated changelog tool for preparing releases with lots of customization options.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,176 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [delve](https://github.com/derekparker/delve) ⭐ 653 - Go debugger.
- [dive](https://github.com/wagoodman/dive) ⭐ 51,019 - A tool for exploring each layer in a Docker image.
...
- [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,789 - Fault tolerance and resilience patterns for Go.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,812 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,724 - Deliver Go binaries as fast and easily as possible.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,046 - A comprehensive, efficient, and reusable util function library of go.
...
- [limiters](https://github.com/mennanov/limiters) ⭐ 564 - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
- [lo](https://github.com/samber/lo) ⭐ 19,538 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mergo](https://github.com/imdario/mergo) ⭐ 3,003 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,813 - Package for MIME type detection based on magic numbers.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,695 - Simple library for retry mechanism.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,058 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,978 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,389 - usql is a universal command-line interface for SQL databases.
...
- [sno](https://github.com/muyo/sno) ⭐ 90 - Compact, sortable and fast unique IDs with embedded metadata.
- [ulid](https://github.com/oklog/ulid) ⭐ 4,728 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/gofrs/uuid) ⭐ 1,687 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
...
- [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,159 - Validators and sanitizers for strings, numerics, slices and structs.
...
- [jio](https://github.com/faceair/jio) ⭐ 118 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,110.
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,928 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,450 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 866 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,458 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,588 - highly extensible Git implementation in pure Go.
...
- [go-astiav](https://github.com/asticode/go-astiav) ⭐ 507 - Better C bindings for ffmpeg in GO.
...
- [Beego](https://github.com/beego/beego) ⭐ 32,110 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,098 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 449 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,799 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,406 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,645 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 - Gin parameter automatic binding tool,gin rpc tools.
- [Goa](https://github.com/goadesign/goa) ⭐ 5,874 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,417 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,432 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,842 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,293 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,136 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 697 - Modern UI Components for Go & Templ.
...
- [Limiter](https://github.com/ulule/limiter) ⭐ 2,217 - Dead simple rate limit middleware for Go.
...
- [Tollbooth](https://github.com/didip/tollbooth) ⭐ 2,795 - Rate limit HTTP request handler.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,903 - Small, fast and expressive HTTP router built on net/context.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,402 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,299 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,964 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,239 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,982 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,352 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 106 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [Spire](https://github.com/spiffe/spire) ⭐ 1,964 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- [golines](https://github.com/segmentio/golines) ⭐ 1,068 - Formatter that automatically shortens long lines in Go code.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,191 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,457 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,710.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 573 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,708 features to Vim/Neovim.
...
- [go-mode](https://github.com/dominikh/go-mode.el) ⭐ 1,419 - Go mode for GNU/Emacs.
- [gocode](https://github.com/nsf/gocode) ⭐ 5,005 - Autocompletion daemon for the Go programming language.
- [goimports-reviser](https://github.com/incu6us/goimports-reviser) ⭐ 668 - Formatting tool for imports.
...
- [vim-go](https://github.com/fatih/vim-go) ⭐ 16,140 - Go development plugin for Vim.
...
- [xgen](https://github.com/xuri/xgen) ⭐ 367 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,281 - Visualize call graph of your Go program using dot format.
...
- [drone-scp](https://github.com/appleboy/drone-scp) ⭐ 153 - Copy files and artifacts via SSH using a binary, docker or Drone CI.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,128 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,065 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,219 - Build powerful pipelines in any programming language.
...
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 48,987 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,977 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,942 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,843 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,881 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 27,975 - A modern load testing tool, using Go and JavaScript.
...
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,726 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,620 - Container Cluster Manager from Google.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,522 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,864 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Packer](https://github.com/mitchellh/packer) ⭐ 15,386 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
- [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,612 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,099 - Blazing fast S3 and local filesystem execution tool.
- [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 918 - Manage BareMetal Servers from Command Line (as easily as with Docker).
- [script](https://github.com/bitfield/script) ⭐ 6,714 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,005 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,077 - Reverse proxy and load balancer with support for multiple backends.
...
- [uTask](https://github.com/ovh/utask) ⭐ 1,281 - Automation engine that models and executes business processes declared in yaml.
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,277 - HTTP load testing tool and library. It's over 9000!
...
- [crawley](https://github.com/s0rg/crawley) ⭐ 299 - Web scraper/crawler for cli.
- [croc](https://github.com/schollz/croc) ⭐ 30,337 - Easily and securely send files or folders from one computer to another.
- [Documize](https://github.com/documize/community) ⭐ 2,237 - Modern wiki software that integrates data from SaaS tools.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,451 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,919 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
- [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 861 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
- [Gor](https://github.com/buger/gor) ⭐ 18,945 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,693 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,685 - LiteIDE is a simple, open source, cross-platform Go IDE.
...
- [restic](https://github.com/restic/restic) ⭐ 28,931 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 696 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,377 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,727 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
- [shell2http](https://github.com/msoap/shell2http) ⭐ 1,408 - Executing shell commands via http server (for prototyping or remote control).
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,280 - Proxy to simulate network and system conditions for automated tests.
...
- [Go AST Book (Chinese)](https://github.com/chai2010/go-ast-book) ⭐ 5,442 - A book focusing on Go `go/*` packages.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,058 - A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,745 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [gophers](https://github.com/egonelbre/gophers) ⭐ 3,650 - Free gophers.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 30,975
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,144
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,556
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,259 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,625 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,270 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,621 - Golang ebook intro how to build a web app with golang.
...
- [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,640 - Go's reference card.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,853 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,531 - Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,717 - Examples of Golang compared to Node.js for learning.
...
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,863 - Learn Go with test-driven development.
