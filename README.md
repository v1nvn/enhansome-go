...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 146,522 | 🐛 122 | 🌐 Go | 📅 2025-06-29
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 376,889 | 🐛 42 | 📅 2025-06-11
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 248,581 | 🐛 490 | 🌐 Python | 📅 2024-08-11.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 146,522 | 🐛 122 | 🌐 Go | 📅 2025-06-29 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 146,522 | 🐛 122 | 🌐 Go | 📅 2025-06-29; you rock!
...
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 260 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
...
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,250 | 🐛 88 | 🌐 Go | 📅 2024-08-22 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
...
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,020 | 🐛 365 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,606 | 🐛 480 | 🌐 Go | 📅 2025-07-01 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 145,265 | 🐛 1,890 | 🌐 Go | 📅 2025-07-01 - Run large language models locally.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,812 | 🐛 47 | 🌐 Go | 📅 2025-06-21 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,071 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,208 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
* [keto](https://github.com/ory/keto) ⭐ 5,054 | 🐛 59 | 🌐 Go | 📅 2025-06-30 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,594 | 🐛 34 | 🌐 Go | 📅 2025-07-01 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
* [openfga](https://github.com/openfga/openfga) ⭐ 3,769 | 🐛 131 | 🌐 Go | 📅 2025-07-01 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 758 | 🐛 275 | 🌐 Go | 📅 2025-07-01 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,637 | 🐛 271 | 🌐 Go | 📅 2025-07-02 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 972 | 🐛 806 | 🌐 Go | 📅 2025-07-02 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,222 | 🐛 315 | 🌐 Go | 📅 2025-07-02 - Official Go implementation of the Ethereum protocol.
...
* [gossamer](https://github.com/ChainSafe/gossamer) ⭐ 451 | 🐛 389 | 🌐 Go | 📅 2025-07-01 - A Go implementation of the Polkadot Host.
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,546 | 🐛 1,110 | 🌐 Go | 📅 2025-07-02 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,961 | 🐛 810 | 🌐 Go | 📅 2025-07-01 - A complete implementation of a Lightning Network node.
...
* [bot](https://github.com/go-telegram/bot) ⭐ 1,212 | 🐛 12 | 🌐 Go | 📅 2025-05-21 - Zero-dependencies Telegram Bot library with additional UI components
...
* [slack-bot](https://github.com/innogames/slack-bot) ⭐ 198 | 🐛 8 | 🌐 Go | 📅 2025-07-01 - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
...
* [telego](https://github.com/mymmrac/telego) ⭐ 729 | 🐛 3 | 🌐 Go | 📅 2025-07-01 - Telegram Bot API library for Golang with full one-to-one API implementation.
...
* [wayback](https://github.com/wabarc/wayback) ⭐ 1,988 | 🐛 55 | 🌐 Go | 📅 2025-06-30 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [air](https://github.com/cosmtrek/air) ⭐ 20,906 | 🐛 178 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [mage](https://github.com/magefile/mage) ⭐ 4,371 | 🐛 128 | 🌐 Go | 📅 2025-06-15 - Mage is a make/rake-like build tool using Go.
...
* [Task](https://github.com/go-task/task) ⭐ 13,055 | 🐛 393 | 🌐 Go | 📅 2025-06-30 - simple "Make" alternative.
* [taskctl](https://github.com/taskctl/taskctl) ⭐ 312 | 🐛 6 | 🌐 Go | 📅 2025-01-18 - Concurrent task runner.
* [xc](https://github.com/joerdav/xc) ⭐ 1,297 | 🐛 16 | 🌐 Go | 📅 2025-05-06 - Task runner with README.md defined tasks, executable markdown.
...
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,514 | 🐛 153 | 🌐 Go | 📅 2025-06-29 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,772 | 🐛 120 | 🌐 Go | 📅 2025-06-30 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,378 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,792 | 🐛 674 | 🌐 Python | 📅 2025-04-15.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,279 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
...
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,190 | 🐛 86 | 🌐 Go | 📅 2025-06-30 - Declaratively define styles for color, format and layout in the terminal.
...
* [pterm](https://github.com/pterm/pterm) ⭐ 5,127 | 🐛 59 | 🌐 Go | 📅 2025-06-07 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,838 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,376 | 🐛 105 | 🌐 Go | 📅 2024-07-22.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 719 | 🐛 40 | 🌐 Go | 📅 2025-07-01 - Command argument completion generator for spf13/cobra.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,329 | 🐛 74 | 🌐 Go | 📅 2025-06-30 - Multi-shell multi-command argument completer.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 40,993 | 🐛 318 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [pflag](https://github.com/spf13/pflag) ⭐ 2,585 | 🐛 178 | 🌐 Go | 📅 2025-06-28 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,294 | 🐛 50 | 🌐 Go | 📅 2025-06-14 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [env](https://github.com/caarlos0/env) ⭐ 5,596 | 🐛 9 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,423 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,252 | 🐛 56 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,297 | 🐛 22 | 🌐 Go | 📅 2025-06-19 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,787 | 🐛 518 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
...
* [CDS](https://github.com/ovh/cds) ⭐ 4,727 | 🐛 150 | 🌐 Go | 📅 2025-07-01 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
* [drone](https://github.com/drone/drone) ⭐ 32,927 | 🐛 74 | 🌐 Go | 📅 2025-07-01 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,569 | 🐛 24 | 🌐 Go | 📅 2025-07-02 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,788 | 🐛 95 | 🌐 Rust | 📅 2025-06-30.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,203 | 🐛 346 | 🌐 Go | 📅 2025-07-02 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,392 | 🐛 529 | 🌐 Go | 📅 2025-07-02 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,131 | 🐛 160 | 🌐 Go | 📅 2025-07-01 - A high-performance ELT data integration framework with pluggable architecture.
* [omniparser](https://github.com/jf-tech/omniparser) ⭐ 1,049 | 🐛 0 | 🌐 Go | 📅 2025-02-21 - A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,776 | 🐛 79 | 🌐 TypeScript | 📅 2025-07-01 - Distributed, Fault-tolerant task queue.
...
* [fastcache](https://github.com/VictoriaMetrics/fastcache) ⭐ 2,233 | 🐛 49 | 🌐 Go | 📅 2025-06-03 - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
...
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,197 | 🐛 42 | 🌐 Go | 📅 2024-11-29 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
* [nscache](https://github.com/no-src/nscache) ⭐ 12 | 🐛 5 | 🌐 Go | 📅 2025-07-01 - A Go caching framework that supports multiple data source drivers.
* [otter](https://github.com/maypok86/otter) ⭐ 1,965 | 🐛 2 | 🌐 Go | 📅 2025-06-29 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,161 | 🐛 5 | 🌐 Go | 📅 2025-06-16 -  A high performance memory-bound Go cache.
...
* [theine](https://github.com/Yiling-J/theine-go) ⭐ 300 | 🐛 6 | 🌐 Go | 📅 2025-03-02 - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
...
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,713 | 🐛 29 | 🌐 Go | 📅 2025-07-02 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,878 | 🐛 48 | 🌐 Go | 📅 2025-07-01 - An embedded key/value database for Go.
* [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
* [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,728 | 🐛 32 | 🌐 Go | 📅 2024-09-10 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,038 | 🐛 7,301 | 🌐 Go | 📅 2025-07-02 - Scalable, Geo-Replicated, Transactional Datastore.
...
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,982 | 🐛 32 | 🌐 Go | 📅 2025-07-02 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,812 | 🐛 436 | 🌐 Go | 📅 2025-07-02 - Dolt – It's Git for Data.
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,279 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,804 | 🐛 361 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,251 | 🐛 2,115 | 🌐 Rust | 📅 2025-07-02 - Scalable datastore for metrics, events, and real-time analytics.
...
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,706 | 🐛 675 | 🌐 Go | 📅 2025-07-02 - Milvus is a vector database for embedding management, analytics and search.
...
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,482 | 🐛 67 | 🌐 Go | 📅 2025-06-07 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,363 | 🐛 291 | 🌐 Go | 📅 2025-07-01 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,256 | 🐛 730 | 🌐 Go | 📅 2025-07-01 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,823 | 🐛 3 | 🌐 Go | 📅 2025-05-15 - Redis re-implemented with SQLite.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,718 | 🐛 71 | 🌐 Go | 📅 2025-07-02 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,654 | 🐛 5,174 | 🌐 Go | 📅 2025-07-02 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,418 | 🐛 945 | 🌐 Go | 📅 2025-07-01 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 6,987 | 🐛 216 | 🌐 Go | 📅 2025-07-01 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,667 | 🐛 119 | 🌐 Go | 📅 2025-07-02 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,102 | 🐛 28 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,637 | 🐛 96 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,923 | 🐛 431 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,934 | 🐛 35 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,749 | 🐛 876 | 🌐 Go | 📅 2025-07-01 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,249 | 🐛 41 | 🌐 Go | 📅 2025-06-26 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,410 | 🐛 610 | 🌐 Go | 📅 2025-07-02 - Generate type-safe code from SQL.
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,484 | 🐛 91 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
...
* [gokv](https://github.com/philippgille/gokv) ⭐ 798 | 🐛 43 | 🌐 Go | 📅 2025-06-29 - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,903 | 🐛 61 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,550 | 🐛 202 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,069 | 🐛 231 | 🌐 Go | 📅 2025-06-26 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,069 | 🐛 231 | 🌐 Go | 📅 2025-06-26 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,438 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,385 | 🐛 9 | 🌐 Go | 📅 2025-07-02 - Official MongoDB driver for the Go language.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,028 | 🐛 101 | 🌐 Go | 📅 2025-06-28 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,707 | 🐛 15 | 🌐 Go | 📅 2025-06-30 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,897 | 🐛 82 | 🌐 Go | 📅 2025-07-01 - Official Elasticsearch client for Go.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 992 | 🐛 23 | 🌐 Go | 📅 2025-06-27 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,089 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - A simple, semantic and developer-friendly time package for golang.
...
* [arpc](https://github.com/lesismal/arpc) ⭐ 1,061 | 🐛 0 | 🌐 Go | 📅 2025-02-20 - More effective network communication, support two-way-calling, notify, broadcast.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,644 | 🐛 28 | 🌐 Go | 📅 2025-07-01 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,322 | 🐛 25 | 🌐 Go | 📅 2025-06-19 - A Go framework for the API or Microservice with handy scaffolding tools.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,134 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,377 | 🐛 19 | 🌐 Go | 📅 2025-06-24 - A distributed systems development framework.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,332 | 🐛 360 | 🌐 Go | 📅 2025-07-01 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,977 | 🐛 138 | 🌐 Go | 📅 2025-07-01 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,507 | 🐛 54 | 🌐 Go | 📅 2025-06-25 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,537 | 🐛 122 | 🌐 Go | 📅 2025-06-01 - A modular-designed and easy-to-use microservices framework in Go.
...
* [micro](https://github.com/micro/micro) ⭐ 12,266 | 🐛 7 | 🌐 Go | 📅 2025-06-21 - A distributed systems runtime for the cloud and beyond.
...
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,425 | 🐛 464 | 🌐 Go | 📅 2025-07-01 - NATS is a simple, secure, and
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,660 | 🐛 44 | 🌐 Go | 📅 2025-07-01 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/etcd-io/raft) ⭐ 865 | 🐛 70 | 🌐 Go | 📅 2025-07-01 - Go implementation of the Raft consensus protocol, by CoreOS.
...
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,002 | 🐛 29 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 656 | 🐛 200 | 🌐 Go | 📅 2025-06-26 - Durable execution system for making code fault-tolerant and simple.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,802 | 🐛 63 | 🌐 Go | 📅 2025-06-30 - BitTorrent client package.
...
* [go-imap](https://github.com/emersion/go-imap) ⭐ 2,206 | 🐛 59 | 🌐 Go | 📅 2025-06-11 - IMAP library for clients and servers.
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,993 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,298 | 🐛 2 | 🌐 Go | 📅 2025-07-01 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,047 | 🐛 145 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,633 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,597 | 🐛 48 | 🌐 Go | 📅 2025-07-01 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,974 | 🐛 45 | 🌐 Go | 📅 2025-06-30 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,489 | 🐛 167 | 🌐 Go | 📅 2025-07-01 - PHP embedded in Go, with a `net/http` handler.
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,288 | 🐛 50 | 🌐 Go | 📅 2025-06-05 - Port of the Lua 5.2 VM to pure Go.
...
* [goja](https://github.com/dop251/goja) ⭐ 6,248 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [golua](https://github.com/aarzilli/golua) ⭐ 674 | 🐛 9 | 🌐 C | 📅 2025-02-17 - Go bindings for Lua C API.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,633 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [gval](https://github.com/PaesslerAG/gval) ⭐ 792 | 🐛 24 | 🌐 Go | 📅 2024-11-28 - A highly customizable expression language written in Go.
* [metacall](https://github.com/metacall/core) ⭐ 1,661 | 🐛 53 | 🌐 C | 📅 2025-07-01 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
* [tengo](https://github.com/d5/tengo) ⭐ 3,659 | 🐛 84 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
...
* [oops](https://github.com/samber/oops) ⭐ 702 | 🐛 16 | 🌐 Go | 📅 2025-06-30 - Error handling with context, stack trace and source fragments.
...
* [afero](https://github.com/spf13/afero) ⭐ 6,257 | 🐛 153 | 🌐 Go | 📅 2025-07-01 - FileSystem Abstraction System for Go.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 98 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,446 | 🐛 291 | 🌐 Go | 📅 2025-06-29).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,576 | 🐛 52 | 🌐 Go | 📅 2025-06-09 - Disk usage analyzer with console interface.
...
* [gofs](https://github.com/no-src/gofs) ⭐ 510 | 🐛 11 | 🌐 Go | 📅 2025-07-01 - A cross-platform real-time file synchronization tool out of the box.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,763 | 🐛 123 | 🌐 Go | 📅 2025-06-28 - PDF processor.
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 | 🐛 1 | 🌐 Go | 📅 2023-09-21 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,834 | 🐛 40 | 📅 2025-01-16.
...
* [ach](https://github.com/moov-io/ach) ⭐ 490 | 🐛 13 | 🌐 Go | 📅 2025-07-01 - A reader, writer, and validator for Automated Clearing House (ACH) files.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,377 | 🐛 135 | 🌐 Go | 📅 2025-07-01 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,818 | 🐛 141 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
...
* [ledger](https://github.com/formancehq/ledger) ⭐ 987 | 🐛 7 | 🌐 Go | 📅 2025-07-01 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,302 | 🐛 37 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
...
* [mo](https://github.com/samber/mo) ⭐ 3,010 | 🐛 23 | 🌐 Go | 📅 2025-05-25 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,187 | 🐛 304 | 🌐 Go | 📅 2025-07-01 - dead simple 2D game engine in Go.
...
* [goverter](https://github.com/jmattheis/goverter) ⭐ 710 | 🐛 16 | 🌐 Go | 📅 2025-06-21 - Generate converters by defining an interface.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,278 | 🐛 690 | 🌐 Go | 📅 2025-06-29 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,759 | 🐛 35 | 🌐 Go | 📅 2025-06-30 - S2 geometry library in Go.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,362 | 🐛 151 | 🌐 Go | 📅 2025-06-17 - Geolocation DB with spatial index and realtime geofencing.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,786 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,976 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [pond](https://github.com/alitto/pond) ⭐ 1,873 | 🐛 3 | 🌐 Go | 📅 2025-06-20 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 421 | 🐛 17 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,566 | 🐛 1,162 | 🌐 C++ | 📅 2025-06-30 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,674 | 🐛 17 | 🌐 Lua | 📅 2025-07-01.
...
* [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,271 | 🐛 37 | 🌐 Go | 📅 2025-03-08 - Build native macOS applications using Go.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,672 | 🐛 748 | 🌐 Go | 📅 2025-06-30 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [webview](https://github.com/zserge/webview) ⭐ 13,196 | 🐛 192 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,585 | 🐛 224 | 🌐 Go | 📅 2025-06-30 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [bimg](https://github.com/h2non/bimg) ⭐ 2,874 | 🐛 175 | 🌐 Go | 📅 2025-01-23 - Small package for fast and efficient image processing using libvips.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 720 | 🐛 6 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [govips](https://github.com/davidbyttow/govips) ⭐ 1,452 | 🐛 34 | 🌐 Go | 📅 2025-06-14 - A lightning fast image processing and resizing library for Go.
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,824 | 🐛 32 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
...
* [imagor](https://github.com/cshum/imagor) ⭐ 3,663 | 🐛 39 | 🌐 Go | 📅 2025-06-30 - Fast, secure image processing server and Go library, using libvips.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,601 | 🐛 57 | 🌐 Go | 📅 2025-07-02 - Lightweight data stream processing engine for IoT edge.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,207 | 🐛 102 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,180 | 🐛 9 | 🌐 Go | 📅 2025-07-02 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
* [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,889 | 🐛 3 | 🌐 Go | 📅 2025-05-24 - Simple, zero-dependency scheduling library for Go.
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,335 | 🐛 17 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,491 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,013 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,341 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,341 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,341 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,341 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,134 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,296 | 🐛 164 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,556 | 🐛 139 | 🌐 Go | 📅 2025-04-18, etc).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,145 | 🐛 100 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 974 | 🐛 53 | 🌐 Go | 📅 2025-07-01 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
...
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,263 | 🐛 65 | 🌐 Go | 📅 2024-04-06 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
* [tint](https://github.com/lmittmann/tint) ⭐ 1,034 | 🐛 0 | 🌐 Go | 📅 2025-06-07 - A slog.Handler that writes tinted logs.
...
* [zap](https://github.com/uber-go/zap) ⭐ 23,296 | 🐛 164 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,556 | 🐛 139 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 817 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - An accelerated Machine Learning framework for Go.
...
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,896 | 🐛 33 | 🌐 Go | 📅 2025-03-24 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,796 | 🐛 18 | 🌐 Go | 📅 2025-07-01 - Go RabbitMQ Client Library.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,489 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,919 | 🐛 284 | 🌐 HTML | 📅 2025-07-01 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
* [dbus](https://github.com/godbus/dbus) ⭐ 1,069 | 🐛 58 | 🌐 Go | 📅 2024-11-09 - Native Go bindings for D-Bus.
...
* [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,883 | 🐛 27 | 🌐 Go | 📅 2024-06-19 - The lightweight event bus with async compatibility.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,416 | 🐛 59 | 🌐 Go | 📅 2025-05-12 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,094 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,991 | 🐛 186 | 🌐 Go | 📅 2025-06-30 - Go client for the NATS
  messaging system.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,064 | 🐛 65 | 🌐 Go | 📅 2025-07-01 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,598 | 🐛 121 | 🌐 Go | 📅 2025-05-26 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [excelize](https://github.com/xuri/excelize) ⭐ 19,317 | 🐛 123 | 🌐 Go | 📅 2025-06-25 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [dig](https://github.com/uber-go/dig) ⭐ 4,215 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 185 | 🐛 15 | 🌐 Go | 📅 2025-05-27 - A dependency injection toolkit for Go, based on Guice.
* [do](https://github.com/samber/do) ⭐ 2,172 | 🐛 45 | 🌐 Go | 📅 2025-05-05 - A dependency injection framework based on Generics.
* [fx](https://github.com/uber-go/fx) ⭐ 6,623 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
...
* [google/wire](https://github.com/google/wire) ⭐ 13,896 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,720 | 🐛 43 | 🌐 Go | 📅 2025-06-30 - Allows users to spin up a quick Go project using a popular framework.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,927 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,927 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
...
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,283 | 🐛 0 | 🌐 Go | 📅 2025-06-14 - Nunu is a scaffolding tool for building Go applications.
...
* [archives](https://github.com/mholt/archives) ⭐ 256 | 🐛 7 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,616 | 🐛 219 | 🌐 Go | 📅 2025-07-01 - Automated service health dashboard.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,276 | 🐛 209 | 🌐 Go | 📅 2025-07-01 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,277 | 🐛 83 | 🌐 Go | 📅 2024-07-26 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,538 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,215 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,919 | 🐛 446 | 🌐 Go | 📅 2025-07-01 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,698 | 🐛 110 | 🌐 Go | 📅 2025-07-01 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [fortio](https://github.com/fortio/fortio) ⭐ 3,550 | 🐛 80 | 🌐 Go | 📅 2025-06-23 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
* [gaio](https://github.com/xtaci/gaio) ⭐ 792 | 🐛 17 | 🌐 Go | 📅 2025-06-02 - High performance async-io networking for Golang in proactor mode.
...
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,618 | 🐛 4 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,821 | 🐛 222 | 🌐 Go | 📅 2025-06-30 - BGP implemented in the Go Programming Language.
...
* [gosnmp](https://github.com/soniah/gosnmp) ⭐ 1,193 | 🐛 61 | 🌐 Go | 📅 2025-07-01 - Native Go library for performing SNMP actions.
...
* [HTTPLab](https://github.com/gchaincl/httplab) ⭐ 4,077 | 🐛 13 | 🌐 Go | 📅 2024-02-05 - HTTPLabs let you inspect HTTP requests and forge responses.
...
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,161 | 🐛 130 | 🌐 Go | 📅 2025-07-01 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,532 | 🐛 2 | 🌐 Go | 📅 2025-07-01 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,073 | 🐛 0 | 🌐 Go | 📅 2025-07-01 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,790 | 🐛 188 | 🌐 Go | 📅 2025-06-29 - An implementation of the QUIC protocol in pure Go.
...
* [webrtc](https://github.com/pions/webrtc) ⭐ 14,991 | 🐛 100 | 🌐 Go | 📅 2025-07-01 - A pure Go implementation of the WebRTC API.
...
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 274 | 🐛 6 | 🌐 Go | 📅 2025-07-01 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,150 | 🐛 72 | 🌐 Go | 📅 2025-07-01 - Retryable HTTP client in Go.
...
* [req](https://github.com/imroc/req) ⭐ 4,537 | 🐛 72 | 🌐 Go | 📅 2025-06-27 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,012 | 🐛 35 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,336 | 🐛 18 | 🌐 Go | 📅 2025-07-01 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,230 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,316 | 🐛 588 | 🌐 Go | 📅 2025-06-20 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,436 | 🐛 461 | 🌐 Go | 📅 2025-06-25 - The fantastic ORM library for Golang, aims to be developer friendly.
...
* [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,303 | 🐛 115 | 🌐 Go | 📅 2025-07-01 - Prisma Client Go, Typesafe database access for Go.
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,889 | 🐛 104 | 🌐 Go | 📅 2025-06-27 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,271 | 🐛 470 | 🌐 Go | 📅 2025-07-01 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,538 | 🐛 324 | 🌐 Go | 📅 2025-07-01 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 171 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,075 | 🐛 331 | 🌐 C++ | 📅 2025-06-23 - No instrumentation tracing for Golang applications via eBPF.
* [profile](https://github.com/pkg/profile) ⭐ 2,030 | 🐛 11 | 🌐 Go | 📅 2022-10-20 - Simple profiling support package for Go.
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,492 | 🐛 47 | 🌐 Go | 📅 2025-03-28 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,069 | 🐛 246 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,002 | 🐛 22 | 🌐 Go | 📅 2024-08-07 - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,149 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,266 | 🐛 26 | 🌐 Go | 📅 2025-06-12 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,725 | 🐛 93 | 🌐 Go | 📅 2025-07-01 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,697 | 🐛 155 | 🌐 Go | 📅 2025-07-01 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 888 | 🐛 24 | 🌐 Go | 📅 2025-07-01 - Small, safe, and easy CBOR encoding and decoding library.
...
* [jsoniter](https://github.com/json-iterator/go) ⭐ 13,796 | 🐛 266 | 🌐 Go | 📅 2024-05-27 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
* [algernon](https://github.com/xyproto/algernon) ⭐ 2,920 | 🐛 28 | 🌐 Go | 📅 2025-06-27 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,249 | 🐛 219 | 🌐 Go | 📅 2025-07-01 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
* [Clace](https://github.com/claceio/clace) ⭐ 635 | 🐛 3 | 🌐 Go | 📅 2025-06-11 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,733 | 🐛 327 | 🌐 Go | 📅 2025-07-01 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,582 | 🐛 51 | 🌐 Go | 📅 2025-07-01 - Fider is an open platform to collect and organize customer feedback.
...
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,447 | 🐛 49 | 🌐 Go | 📅 2025-07-01 - A self contained feature flag solution written in Go and Vue.js
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,685 | 🐛 19 | 🌐 Go | 📅 2025-07-01 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [minio](https://github.com/minio/minio) ⭐ 53,464 | 🐛 51 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 48,043 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,640 | 🐛 112 | 🌐 Go | 📅 2025-06-22 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,178 | 🐛 14 | 🌐 Go | 📅 2025-06-23 - Make SSH apps, just like that!
...
* [jet](https://github.com/CloudyKit/jet) ⭐ 1,338 | 🐛 21 | 🌐 Go | 📅 2025-03-23 - Jet template engine.
* [liquid](https://github.com/osteele/liquid) ⭐ 308 | 🐛 29 | 🌐 Go | 📅 2025-06-01 - Go implementation of Shopify Liquid templates.
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,470 | 🐛 52 | 🌐 Go | 📅 2025-03-21 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,432 | 🐛 69 | 🌐 Go | 📅 2025-06-25 - A HTML templating language that has great developer tooling.
...
* [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 971 | 🐛 7 | 🌐 Go | 📅 2025-06-02 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 2 | 🌐 Go | 📅 2025-07-01 - HTTP client testing framework.
...
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,444 | 🐛 46 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
...
* [godog](https://github.com/cucumber/godog) ⭐ 2,452 | 🐛 83 | 🌐 Go | 📅 2025-06-13 - Cucumber BDD framework for Go.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,282 | 🐛 241 | 🌐 Go | 📅 2025-07-01 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,161 | 🐛 141 | 🌐 Go | 📅 2025-07-01 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 24,853 | 🐛 370 | 🌐 Go | 📅 2025-07-01 - Sacred extension to the standard go testing package.
...
* [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,387 | 🐛 41 | 🌐 Go | 📅 2024-09-11 - Mock SQL driver for testing database interactions.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,878 | 🐛 95 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [mockery](https://github.com/vektra/mockery) ⭐ 6,661 | 🐛 38 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 486 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,069 | 🐛 231 | 🌐 Go | 📅 2025-06-26.
* [timex](https://github.com/cabify/timex) ⭐ 71 | 🐛 1 | 🌐 Go | 📅 2020-08-03 - A test-friendly replacement for the native `time` package.
* [xgo](https://github.com/xhd2015/xgo) ⭐ 408 | 🐛 59 | 🌐 Go | 📅 2025-07-01 - A general pureposed function mocking library.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 11,979 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [rod](https://github.com/go-rod/rod) ⭐ 6,037 | 🐛 183 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,570 | 🐛 41 | 🌐 Go | 📅 2025-07-01 - Formatters for time, numbers, and memory size to human readable format.
...
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,154 | 🐛 8 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,904 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,254 | 🐛 9 | 🌐 Go | 📅 2025-06-30 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,828 | 🐛 99 | 🌐 Go | 📅 2025-06-22 - Shell parser and formatter.
...
* [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,427 | 🐛 25 | 🌐 Go | 📅 2025-04-04 - HTML Sanitizer.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,564 | 🐛 3 | 🌐 Go | 📅 2025-06-07 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [xurls](https://github.com/mvdan/xurls) ⭐ 1,223 | 🐛 2 | 🌐 Go | 📅 2025-02-22 - Extract urls from text.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,124 | 🐛 81 | 🌐 Go | 📅 2025-07-01 - The official AWS SDK for the Go programming language.
...
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,443 | 🐛 188 | 🌐 Go | 📅 2025-05-24 - Go bindings for the Discord Chat API.
...
* [github](https://github.com/google/go-github) ⭐ 10,848 | 🐛 32 | 🌐 Go | 📅 2025-07-02 - Go library for accessing the GitHub REST API v3.
* [githubql](https://github.com/shurcooL/githubql) ⭐ 1,152 | 🐛 43 | 🌐 Go | 📅 2024-07-27 - Go library for accessing the GitHub GraphQL API v4.
* [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 166 | 🐛 13 | 🌐 Go | 📅 2025-07-01 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,119 | 🐛 210 | 🌐 Go | 📅 2025-06-25 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [go-salesforce](https://github.com/k-capehart/go-salesforce) ⭐ 44 | 🐛 6 | 🌐 Go | 📅 2025-07-01 - Go client library for interacting with the [Salesforce REST API](https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_list.htm).
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,278 | 🐛 20 | 🌐 Go | 📅 2025-07-01 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,281 | 🐛 385 | 🌐 Go | 📅 2025-07-02 - Google Cloud APIs Go Client Library.
...
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,340 | 🐛 8 | 🌐 Go | 📅 2025-07-01 - Go client for the Stripe API.
...
* [changie](https://github.com/miniscruff/changie) ⭐ 777 | 🐛 7 | 🌐 Go | 📅 2025-07-01 - Automated changelog tool for preparing releases with lots of customization options.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 378 | 🐛 36 | 🌐 Go | 📅 2025-07-01 - Cross Platform tool to validate configuration files.
...
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,227 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,266 | 🐛 167 | 🌐 Go | 📅 2025-06-30 - A tool for exploring each layer in a Docker image.
...
* [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,251 | 🐛 6 | 🌐 Go | 📅 2025-07-01 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 71,446 | 🐛 291 | 🌐 Go | 📅 2025-06-29 - Command-line fuzzy finder written in Go.
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,802 | 🐛 23 | 🌐 Go | 📅 2025-07-02 - Deliver Go binaries as fast and easily as possible.
...
* [json-log-viewer](https://github.com/hedhyw/json-log-viewer) ⭐ 158 | 🐛 10 | 🌐 Go | 📅 2025-06-25 - Interactive viewer for JSON logs.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,095 | 🐛 8 | 🌐 Go | 📅 2025-06-25 - A comprehensive, efficient, and reusable util function library of go.
...
* [limiters](https://github.com/mennanov/limiters) ⭐ 567 | 🐛 6 | 🌐 Go | 📅 2025-07-01 - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
* [lo](https://github.com/samber/lo) ⭐ 19,686 | 🐛 210 | 🌐 Go | 📅 2025-06-11 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [mc](https://github.com/minio/mc) ⭐ 3,080 | 🐛 42 | 🌐 Go | 📅 2025-06-25 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
* [mergo](https://github.com/imdario/mergo) ⭐ 3,016 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,819 | 🐛 43 | 🌐 Go | 📅 2025-07-01 - Package for MIME type detection based on magic numbers.
...
* [upterm](https://github.com/owenthereal/upterm) ⭐ 933 | 🐛 51 | 🌐 Go | 📅 2025-06-30 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
* [usql](https://github.com/knq/usql) ⭐ 9,410 | 🐛 94 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
...
* [uuid](https://github.com/gofrs/uuid) ⭐ 1,701 | 🐛 2 | 🌐 Go | 📅 2025-07-01 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,588 | 🐛 324 | 🌐 Go | 📅 2025-07-02 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 891 | 🐛 10 | 🌐 Go | 📅 2025-06-15 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,820 | 🐛 550 | 🌐 TypeScript | 📅 2025-06-27 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,679 | 🐛 165 | 🌐 Go | 📅 2025-07-01 - highly extensible Git implementation in pure Go.
* [go-vcs](https://github.com/sourcegraph/go-vcs) ⭐ 80 | 🐛 22 | 🌐 Go | 📅 2023-07-17 - manipulate and inspect VCS repositories in Go.
* [hercules](https://github.com/src-d/hercules) ⭐ 2,715 | 🐛 52 | 🌐 Go | 📅 2023-02-07 - gaining advanced insights from Git repository history.
...
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 800 | 🐛 25 | 🌐 Go | 📅 2025-07-01 - Pure Go RTSP server and client library.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,222 | 🐛 105 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 466 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,013 | 🐛 107 | 🌐 Go | 📅 2025-07-02 - An Express.js inspired web framework build on Fasthttp.
...
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,429 | 🐛 37 | 🌐 Go | 📅 2025-06-30 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Gin](https://github.com/gin-gonic/gin) ⭐ 82,959 | 🐛 855 | 🌐 Go | 📅 2025-07-01 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 | 🐛 13 | 🌐 Go | 📅 2025-04-16 - Gin parameter automatic binding tool,gin rpc tools.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,888 | 🐛 26 | 🌐 Go | 📅 2025-06-30 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,740 | 🐛 82 | 🌐 Go | 📅 2025-07-02 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,498 | 🐛 204 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,893 | 🐛 55 | 🌐 Go | 📅 2025-06-30 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,347 | 🐛 44 | 🌐 Go | 📅 2025-06-19 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,203 | 🐛 116 | 🌐 Go | 📅 2025-06-30 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
* [iWF](https://github.com/indeedeng/iwf) ⭐ 579 | 🐛 73 | 🌐 Go | 📅 2025-07-01 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
* [templui](https://github.com/axzilla/templui) ⭐ 743 | 🐛 2 | 🌐 JavaScript | 📅 2025-06-30 - Modern UI Components for Go & Templ.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,047 | 🐛 82 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,448 | 🐛 35 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,413 | 🐛 499 | 🌐 Go | 📅 2025-06-30 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,014 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 233 | 🐛 12 | 🌐 Go | 📅 2025-07-01 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [Cadence-client](https://github.com/uber-go/cadence-client) ⭐ 359 | 🐛 73 | 🌐 Go | 📅 2025-07-01 - A framework for authoring workflows and activities running on top of the Cadence orchestration engine made by Uber.
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,354 | 🐛 112 | 🌐 Go | 📅 2025-07-01 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 559 | 🐛 2 | 🌐 Go | 📅 2025-05-14 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
* [workflow](https://github.com/luno/workflow) ⭐ 174 | 🐛 4 | 🌐 Go | 📅 2025-06-17 - A tech stack agnostic Event Driven Workflow framework.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,026 | 🐛 260 | 🌐 Go | 📅 2025-07-01 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,408 | 🐛 243 | 🌐 Go | 📅 2025-07-01 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 | 🐛 19 | 🌐 Go | 📅 2025-06-28 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,979 | 🐛 158 | 🌐 Go | 📅 2025-07-01 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [fatcontext](https://github.com/Crocmagnon/fatcontext) ⭐ 47 | 🐛 2 | 🌐 Go | 📅 2025-07-01 - Fatcontext detects nested contexts in loops or function literals.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,256 | 🐛 115 | 🌐 Go | 📅 2025-07-01 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,219 | 🐛 47 | 🌐 Go | 📅 2025-06-25 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,487 | 🐛 579 | 🌐 Go | 📅 2025-06-11 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 141 | 🐛 35 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,853 | 🐛 370 | 🌐 Go | 📅 2025-07-01.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 791 | 🐛 75 | 🌐 Go | 📅 2025-06-30 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 575 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,746 | 🐛 95 | 🌐 Go | 📅 2025-07-01 features to Vim/Neovim.
...
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,078 | 🐛 416 | 🌐 TypeScript | 📅 2025-06-30 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,303 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
* [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,618 | 🐛 7 | 🌐 Go | 📅 2025-07-01 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,792 | 🐛 606 | 🌐 Go | 📅 2025-06-27 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [dish](https://github.com/thevxn/dish) ⭐ 239 | 🐛 5 | 🌐 Go | 📅 2025-07-01 - A lightweight, remotely configurable monitoring service.
...
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,166 | 🐛 2,501 | 🌐 Go | 📅 2025-07-02 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,226 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,766 | 🐛 13 | 🌐 Go | 📅 2025-07-01 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,328 | 🐛 2,707 | 🌐 Go | 📅 2025-07-02 - Fork of Gogs, entirely community driven.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,038 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,021 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,878 | 🐛 246 | 🌐 Go | 📅 2025-06-28 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,097 | 🐛 120 | 🌐 Go | 📅 2025-07-02 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,158 | 🐛 793 | 🌐 Go | 📅 2025-06-30 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,256 | 🐛 207 | 🌐 Go | 📅 2025-07-01 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,750 | 🐛 148 | 🌐 Go | 📅 2025-07-02 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,070 | 🐛 2,602 | 🌐 Go | 📅 2025-07-01 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,410 | 🐛 138 | 🌐 Go | 📅 2025-07-01 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,619 | 🐛 530 | 🌐 Go | 📅 2025-07-01 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,017 | 🐛 3,603 | 🌐 Go | 📅 2025-07-01 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,403 | 🐛 305 | 🌐 Go | 📅 2025-07-02 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 435 | 🐛 1 | 🌐 Go | 📅 2024-06-19 - Flexible HTTP command line stress tester.
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,180 | 🐛 108 | 🌐 Go | 📅 2025-07-02 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,327 | 🐛 137 | 🌐 Go | 📅 2025-07-02 - Pomerium is an identity-aware access proxy.
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,383 | 🐛 140 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 922 | 🐛 202 | 🌐 Go | 📅 2025-07-01 - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [traefik](https://github.com/containous/traefik) ⭐ 55,367 | 🐛 649 | 🌐 Go | 📅 2025-07-01 - Reverse proxy and load balancer with support for multiple backends.
...
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,327 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,430 | 🐛 66 | 🌐 Go | 📅 2025-07-01 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [croc](https://github.com/schollz/croc) ⭐ 30,489 | 🐛 11 | 🌐 Go | 📅 2025-06-23 - Easily and securely send files or folders from one computer to another.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,808 | 🐛 123 | 🌐 Go | 📅 2025-07-02 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [restic](https://github.com/restic/restic) ⭐ 29,170 | 🐛 471 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 700 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,440 | 🐛 53 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,985 | 🐛 592 | 🌐 Go | 📅 2025-07-02 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,148 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,765 | 🐛 2 | 🌐 Go | 📅 2024-12-22 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
* [gophers](https://github.com/egonelbre/gophers) ⭐ 3,674 | 🐛 5 | 🌐 Go | 📅 2022-07-06 - Free gophers.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,038 | 🐛 7,301 | 🌐 Go | 📅 2025-07-02
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,543 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,654 | 🐛 9,361 | 🌐 Go | 📅 2025-07-01 - List of projects on the Go community wiki.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,919 | 🐛 8 | 🌐 Go | 📅 2025-06-27 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,624 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,366 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,937 | 🐛 65 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
