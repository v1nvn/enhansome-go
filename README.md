...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 144,700](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 245,213.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 144,700 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 144,700; you rock!
...
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,929 - Blazingly fast and light-weight Actor engine written in Golang.
...
- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 576 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,722 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 32,965 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 142,465 - Run large language models locally.
...
- [malgo](https://github.com/gen2brain/malgo) ⭐ 333 - Mini audio library.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,672 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [go-jose](https://github.com/go-jose/go-jose) ⭐ 398 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
- [gosession](https://github.com/Kwynto/gosession) ⭐ 262 - This is quick session for net/http in GoLang. This package is perhaps the best implementation of the session mechanism, or at least it tries to become one.
- [goth](https://github.com/markbates/goth) ⭐ 6,023 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,094 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,104 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
- [keto](https://github.com/ory/keto) ⭐ 5,031 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,606 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
- [oidc](https://github.com/zitadel/oidc) ⭐ 1,572 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
- [openfga](https://github.com/openfga/openfga) ⭐ 3,661 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
- [osin](https://github.com/openshift/osin) ⭐ 1,925 - Golang OAuth2 server library.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,051 - Official Go implementation of the Ethereum protocol.
- [gosemble](https://github.com/LimeChain/gosemble) ⭐ 14 - A Go-based framework for building Polkadot/Substrate-compatible runtimes.
- [gossamer](https://github.com/ChainSafe/gossamer) ⭐ 450 - A Go implementation of the Polkadot Host.
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,507 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,930 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,311 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
- [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,801 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
- [arikawa](https://github.com/diamondburned/arikawa) ⭐ 521 - A library and framework for the Discord API.
- [bot](https://github.com/go-telegram/bot) ⭐ 1,168 - Zero-dependencies Telegram Bot library with additional UI components
...
- [slack-bot](https://github.com/innogames/slack-bot) ⭐ 196 - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
- [slacker](https://github.com/slack-io/slacker) ⭐ 53 - Easy to use framework to create Slack bots.
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,330 - Telegram bot framework is written in Go.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,592 - Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4,339 - Mage is a make/rake-like build tool using Go.
...
- [Task](https://github.com/go-task/task) ⭐ 12,888 - simple "Make" alternative.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,354 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 31,848 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,506 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,365 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,717.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,241 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,399 - Basic thread-safe progress bar that works in every OS.
- [pterm](https://github.com/pterm/pterm) ⭐ 5,093 - A library to beautify console output on every platform with many combinable components.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,820 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,359.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,836 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,359 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,603.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 660 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,266 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,591 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,014 - An expressive programming language and a versatile interactive shell.
...
- [go-readline-ny](https://github.com/nyaosorg/go-readline-ny) ⭐ 26 - A customizable line-editing library with Emacs keybindings, Unicode support, completion, and syntax highlighting. Used in NYAGOS shell.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,209 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,491 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,297 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [koanf](https://github.com/knadh/koanf) ⭐ 3,220 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,644 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,170 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,609 - Go configuration with fangs.
...
- [drone](https://github.com/drone/drone) ⭐ 32,803 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 150 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,561 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,720.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,095 - Woodpecker is a community fork of the Drone CI system.
...
- [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,103 - A high-performance ELT data integration framework with pluggable architecture.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,708 - Go package implementing compressed bitsets.

### Bit Sets

- [bitmap](https://github.com/kelindar/bitmap) ⭐ 334 - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
- [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,419 - Go package implementing bitsets.

### Bloom and Cuckoo Filters

- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,591 - Go package implementing Bloom filters.
...
- [boomfilters](https://github.com/tylertreat/BoomFilters) ⭐ 1,614 - Probabilistic data structures for processing continuous, unbounded streams.
- [cuckoo-filter](https://github.com/linvon/cuckoo-filter) ⭐ 300 - Cuckoo filter: a comprehensive cuckoo filter, which is configurable and space optimized compared with other implements, and all features mentioned in original paper are available.
...
- [gods](https://github.com/emirpasic/gods) ⭐ 16,935 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
- [gostl](https://github.com/liyue201/gostl) ⭐ 1,093 - Data structure and algorithm library for go, designed to provide functions similar to C++ STL.
...
- [gota](https://github.com/kniren/gota) ⭐ 3,186 - Implementation of dataframes, series, and data wrangling methods for Go.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,608 - Distributed, Fault-tolerant task queue.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,401 - Modern text indexing library for go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,837 - Efficient key/value cache for gigabytes of data.
...
- [groupcache](https://github.com/golang/groupcache) ⭐ 13,176 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [otter](https://github.com/maypok86/otter) ⭐ 1,890 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,088 -  A high performance memory-bound Go cache.
- [sturdyc](https://github.com/viccon/sturdyc) ⭐ 1,205 - A caching library with advanced concurrency features designed to make I/O heavy applications robust and highly performant.
...
- [badger](https://github.com/dgraph-io/badger) ⭐ 14,615 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,808 - An embedded key/value database for Go.
...
- [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) ⭐ 1,516 - CovenantSQL is a SQL database on blockchain.
- [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,301 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,896 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,504 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
...
- [godis](https://github.com/hdt3213/godis) ⭐ 3,688 - A Golang implemented high-performance Redis server and cluster.
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,266 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,692 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,107 - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,048 - Milvus is a vector database for embedding management, analytics and search.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,781 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,740 - Redis re-implemented with SQLite.
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,799 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
...
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,517 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,183 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,889 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,512 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,027 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,455 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,727 - Database migrations. CLI and Golang library.
...
- [soda](https://github.com/gobuffalo/pop/tree/master/soda) ⭐ 1,483 - Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.
...
- [rdb](https://github.com/HDT3213/rdb) ⭐ 535 - Redis RDB file parser for secondary development and memory analysis.
- [rwdb](https://github.com/andizzle/rwdb) ⭐ 20 - rwdb provides read replica capability for multiple database servers setup.
- [vitess](https://github.com/youtube/vitess) ⭐ 19,610 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [goqu](https://github.com/doug-martin/goqu) ⭐ 2,525 - Idiomatic SQL builder and query library.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,197 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,212 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,422 - Go library that helps you build SQL queries.
...
- [cayley](https://github.com/google/cayley) ⭐ 14,927 - Graph database with support for multiple backends.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,828 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,502 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 695 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,907 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,907 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,426 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,483 - Pure Go Postgres driver for database/sql.
...
- [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 157 - native and database/sql driver YDB (Yandex Database)
...
- [Kivik](https://github.com/go-kivik/kivik) ⭐ 322 - Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,349 - Official MongoDB driver for the Go language.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,919 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,669 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
- [xredis](https://github.com/shomali11/xredis) ⭐ 19 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

- [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,064 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
- [dateparse](https://github.com/araddon/dateparse) ⭐ 2,084 - Parse date's without knowing format in advance.
...
- [arpc](https://github.com/lesismal/arpc) ⭐ 1,036 - More effective network communication, support two-way-calling, notify, broadcast.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,113 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 708 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,896 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,391 - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,602 - Lightweight, fault-tolerant message streams for NATS.
- [lura](https://github.com/luraproject/lura) ⭐ 6,556 - Ultra performant API Gateway framework with middlewares.
- [micro](https://github.com/micro/micro) ⭐ 12,253 - A distributed systems runtime for the cloud and beyond.
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,521 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,253 - NATS is a simple, secure, and
...
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,607 - Simplified distributed locking implementation using Redis.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,260).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,855 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [Temporal](https://github.com/temporalio/sdk-go) ⭐ 641 - Durable execution system for making code fault-tolerant and simple.
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,779 - BitTorrent client package.
- [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 965 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
- [GoDNS](https://github.com/timothyye/godns) ⭐ 1,577 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- [email](https://github.com/jordan-wright/email) ⭐ 2,729 - A robust and flexible email library for Go.
- [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,373 - A Go library for email verification without sending any emails.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 989 - A simple Go library for sending mails in Go.
- [go-message](https://github.com/emersion/go-message) ⭐ 412 - Streaming library for the Internet Message Format and mail messages.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,543 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,902 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,156 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 4,981 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [cel-go](https://github.com/google/cel-go) ⭐ 2,555 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,886 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 7,946 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,261 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,177 - ECMAScript 5.1(+) implementation in Go.
...
- [gval](https://github.com/PaesslerAG/gval) ⭐ 788 - A highly customizable expression language written in Go.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,652 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 231 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
- [oops](https://github.com/samber/oops) ⭐ 668 - Error handling with context, stack trace and source fragments.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,226 - FileSystem Abstraction System for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,467 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,659 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,785.
...
- [go-money](https://github.com/rhymond/go-money) ⭐ 1,773 - Implementation of Fowler's Money pattern.
...
- [orderbook](https://github.com/i25959341/orderbook) ⭐ 486 - Matching Engine for Limit Order Book in Golang.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,258 - Terminal stock watcher and stock position tracker.
...
- [form](https://github.com/go-playground/form) ⭐ 835 - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
- [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,118 - CSRF protection for Go web applications & services.
...
- [nosurf](https://github.com/justinas/nosurf) ⭐ 1,664 - CSRF protection middleware for Go.
...
- [mo](https://github.com/samber/mo) ⭐ 2,981 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,063 - dead simple 2D game engine in Go.
- [ecs](https://github.com/andygeiss/ecs) ⭐ 144 - Build your own Game-Engine based on the Entity Component System concept in Golang.
- [engo](https://github.com/EngoEngine/engo) ⭐ 1,792 - Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm.
...
- [goworld](https://github.com/xiaonanln/goworld) ⭐ 2,643 - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- [nano](https://github.com/lonng/nano) ⭐ 3,013 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,623 - Pure Go game engine.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,054 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [goverter](https://github.com/jmattheis/goverter) ⭐ 694 - Generate converters by defining an interface.
- [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,215 - Generate decorators for Go interfaces using simple templates.
- [interfaces](https://github.com/rjeczalik/interfaces) ⭐ 432 - Command line tool for generating interface definitions.
- [jennifer](https://github.com/dave/jennifer) ⭐ 3,499 - Generate arbitrary Go code without templates.
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,162 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [godal](https://github.com/airbusgeo/godal) ⭐ 159 - Go wrapper for GDAL.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,336 - Geolocation DB with spatial index and realtime geofencing.
...
- [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,962 - Compiler from Go to JavaScript.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,698 - A high-performance and low-cost goroutine pool in Go.
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,916 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [pond](https://github.com/alitto/pond) ⭐ 1,784 - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [semaphore](https://github.com/marusama/semaphore) ⭐ 175 - Fast resizable semaphore implementation based on CAS (faster than channel-based semaphore implementations).
...
- [tunny](https://github.com/Jeffail/tunny) ⭐ 3,993 - Goroutine pool for golang.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,671 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 409 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 65,886 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,648.
...
- [energy](https://github.com/energye/energy) ⭐ 471 - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,503 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [webview](https://github.com/zserge/webview) ⭐ 13,124 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,169 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
- [systray](https://github.com/getlantern/systray) ⭐ 3,481 - Cross platform Go library to place an icon and menu in the notification area.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,557 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
- [emgo](https://github.com/ziutek/emgo) ⭐ 1,085 - Go-like language for programming embedded systems (e.g. STM32 MCU).
- [ghw](https://github.com/jaypipes/ghw) ⭐ 1,750 - Golang hardware discovery/inspection library.
...
- [bild](https://github.com/anthonynsimon/bild) ⭐ 4,104 - Collection of image processing algorithms in pure Go.
...
- [canvas](https://github.com/tdewolff/canvas) ⭐ 1,579 - Vector graphics to PDF, SVG or rasterized image.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,590 - 2D rendering in pure Go.
...
- [goimagehash](https://github.com/corona10/goimagehash) ⭐ 797 - Go Perceptual image hashing package.
...
- [govips](https://github.com/davidbyttow/govips) ⭐ 1,435 - A lightning fast image processing and resizing library for Go.
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,749 - Screenshoting webpages using go and headless chrome on command line.
...
- [imaginary](https://github.com/h2non/imaginary) ⭐ 5,850 - Fast and simple HTTP microservice for image resizing.
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,479 - Simple Go image processing package.
- [imagor](https://github.com/cshum/imagor) ⭐ 3,643 - Fast, secure image processing server and Go library, using libvips.
...
- [clockwerk](https://github.com/onatm/clockwerk) ⭐ 176 - Go package to schedule periodic jobs using a simple, fluent syntax.
...
- [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,875 - Simple, zero-dependency scheduling library for Go.
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,255 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,489.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,957 - Get a JSON value with one line of code.
...
- [httpretty](https://github.com/henvic/httpretty) ⭐ 408 - Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest).
- [journald](https://github.com/ssgreg/journald) ⭐ 43 - Go implementation of systemd Journal's native API for logging.
- [kemba](https://github.com/clok/kemba) ⭐ 16 - A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug) ⭐ 11,281, great for CLI tools and applications.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,270 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,270 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,270 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,270, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,057, [zap](https://github.com/uber-go/zap) ⭐ 23,135, [zerolog](https://github.com/rs/zerolog) ⭐ 11,442, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,108 - Simple rolling logger, implements io.WriteCloser.
...
- [slog](https://github.com/gookit/slog) ⭐ 468 - Lightweight, configurable, extensible logger for Go.
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,001 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,135 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,442 - Zero-allocation JSON logger.
...
- [GoLearn](https://github.com/sjwhitworth/golearn) ⭐ 9,397 - General Machine Learning library for Go.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 781 - An accelerated Machine Learning framework for Go.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,875 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 782 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,768 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,261 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 8,996 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Go-MediatR](https://github.com/mehdihadeli/Go-MediatR) ⭐ 241 - A library for handling mediator patterns and simplified CQRS patterns within an event-driven architecture, inspired by csharp MediatR library.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,373 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,088 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,742 - Asynchronous task queue/job queue based on distributed message passing.
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,935 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,004 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,491 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
- [zmq4](https://github.com/pebbe/zmq4) ⭐ 1,209 - Go interface to ZeroMQ version 4. Also available for [version 3](https://github.com/pebbe/zmq3) ⭐ 133 and [version 2](https://github.com/pebbe/zmq2) ⭐ 19.

**[⬆ back to top](#contents)**

## Microsoft Office

- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,579 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize](https://github.com/xuri/excelize) ⭐ 19,194 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [dig](https://github.com/uber-go/dig) ⭐ 4,185 - A reflection based dependency injection toolkit for Go.
- [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 184 - A dependency injection toolkit for Go, based on Guice.
- [do](https://github.com/samber/do) ⭐ 2,116 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,540 - A dependency injection based application framework for Go (built on top of dig).
...
- [gontainer](https://github.com/NVIDIA/gontainer) ⭐ 45 - A dependency injection service container for Go projects.
...
- [google/wire](https://github.com/google/wire) ⭐ 13,799 - Automated Initialization in Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,787 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,787 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,541 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,552 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,552 for more information. Nonetheless, some may find the layout useful.
...
- [modern-go-application](https://github.com/sagikazarmark/modern-go-application) ⭐ 1,916 - Go application boilerplate and example applying modern practices.
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,233 - Nunu is a scaffolding tool for building Go applications.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,487 - Automated service health dashboard.
...
- [go-resiliency](https://github.com/eapache/go-resiliency) ⭐ 2,290 - Resiliency patterns for golang.
- [go-unarr](https://github.com/gen2brain/go-unarr) ⭐ 291 - Decompression library for RAR, TAR, ZIP and 7z archives.
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,939 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,193 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [xz](https://github.com/ulikunitz/xz) ⭐ 511 - Pure golang package for reading and writing xz-compressed files.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,722.
...
- [kagome](https://github.com/ikawaha/kagome) ⭐ 872 - JP morphological analyzer written in pure Go.
...
- [spaGO](https://github.com/nlpodyssey/spago) ⭐ 1,802 - Self-contained Machine Learning and Natural Language Processing library in Go.
...
- [slug](https://github.com/gosimple/slug) ⭐ 1,248 - URL-friendly slugify with multiple languages support.
- [Slugify](https://github.com/avelino/slugify) ⭐ 34 - Go slugify application that handles string.

### Tokenizers

- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,523 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,128 which a Chinese word splitting algorithm.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,243 - Package and an accompanying tool to work with localized text.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,692 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,351 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,599 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- [fortio](https://github.com/fortio/fortio) ⭐ 3,532 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,545 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,800 - BGP implemented in the Go Programming Language.
- [gopacket](https://github.com/google/gopacket) ⭐ 6,531 - Go library for packet processing with libpcap bindings.
- [gopcap](https://github.com/akrennmair/gopcap) ⭐ 492 - Go wrapper for libpcap.
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,364 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,491 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
- [psql-wire](https://github.com/jeroenrinzema/psql-wire) ⭐ 140 - PostgreSQL server wire protocol. Build your own server and start serving connections..
- [publicip](https://github.com/polera/publicip) ⭐ 29 - Package publicip returns your public facing IPv4 address (internet egress).
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,700 - An implementation of the QUIC protocol in pure Go.
...
- [sdns](https://github.com/semihalev/sdns) ⭐ 995 - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,872 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,847 - A pure Go implementation of the WebRTC API.
- [winrm](https://github.com/masterzen/winrm) ⭐ 443 - Go WinRM client to remotely execute commands on Windows machines.
...
- [req](https://github.com/imroc/req) ⭐ 4,506 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [requests](https://github.com/carlmjohnson/requests) ⭐ 1,603 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
- [resty](https://github.com/go-resty/resty) ⭐ 10,911 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,145 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,254 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,175 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,221 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,273 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [pop/soda](https://github.com/gobuffalo/pop) ⭐ 1,483 - Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.
- [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,297 - Prisma Client Go, Typesafe database access for Go.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,059 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [go-instrument](https://github.com/nikolaydubina/go-instrument) ⭐ 261 - Automatically add spans to all methods and functions.
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,395 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 169 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,042 - No instrumentation tracing for Golang applications via eBPF.
- [profile](https://github.com/pkg/profile) ⭐ 2,026 - Simple profiling support package for Go.
- [statsviz](https://github.com/arl/statsviz) ⭐ 3,296 - Live visualization of your Go application runtime statistics.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,462 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,855 - gonum/plot provides an API for building and drawing plots in Go.
...
- [stats](https://github.com/montanaflynn/stats) ⭐ 2,981 - Statistics package with common functions missing from the Golang standard library.
...
- [age](https://github.com/FiloSottile/age) ⭐ 18,991 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,147 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 566 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,378 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,673 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,612 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [cbor](https://github.com/fxamacker/cbor) ⭐ 872 - Small, safe, and easy CBOR encoding and decoding library.
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,619 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,505 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,515 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,490 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,380 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,654 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 52,840 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,572 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,495 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,100 - Make SSH apps, just like that!
...
- [go-streams](https://github.com/reugn/go-streams) ⭐ 2,042 - Go stream processing library.
...
- [jet](https://github.com/CloudyKit/jet) ⭐ 1,322 - Jet template engine.
...
- [pongo2](https://github.com/flosch/pongo2) ⭐ 2,953 - Django-like template-engine for Go.
...
- [Razor](https://github.com/sipin/gorazor) ⭐ 868 - Razor view engine for Golang.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,323 - A HTML templating language that has great developer tooling.
...
- [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 953 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
- [go-cmp](https://github.com/google/go-cmp) ⭐ 4,414 - Package for comparing Go values in tests.
...
- [gotest.tools](https://github.com/gotestyourself/gotest.tools) ⭐ 562 - A collection of packages to augment the go testing package and support common patterns.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,104 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,157 - A helper for Rails' like test fixtures to test database applications.
- [Testify](https://github.com/stretchr/testify) ⭐ 24,673 - Sacred extension to the standard go testing package.
...
- [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,047 - Tool for generating self-contained mock objects.
...
- [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,026 - Easy mocking of HTTP responses from external resources.
- [minimock](https://github.com/gojuno/minimock) ⭐ 683 - Mock generator for Go interfaces.
- [mockery](https://github.com/vektra/mockery) ⭐ 6,600 - Tool to generate Go interfaces.
...
- [moq](https://github.com/matryer/moq) ⭐ 2,087 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 480 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,907.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,859 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,702 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,948 - A Devtools driver to make web automation and scraping easy.
...
- [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,545 - Markdown processor in Go.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,083 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,865 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [godump](https://github.com/yassinebenaid/godump) ⭐ 208 - Pretty print any GO variable with ease, an alternative to Go's `fmt.Printf("%#v")`.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,758 - Shell parser and formatter.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,400 - HTML Sanitizer.
- [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 - A sanitization-based swear filter for Go.

### Scrapers

- [colly](https://github.com/asciimoo/colly) ⭐ 24,224 - Fast and Elegant Scraping Framework for Gophers.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,066 - The official AWS SDK for the Go programming language.
...
- [coinpaprika-go](https://github.com/coinpaprika/coinpaprika-api-go-client) ⭐ 24 - Go client library for interacting with Coinpaprika's API.
...
- [github](https://github.com/google/go-github) ⭐ 10,817 - Go library for accessing the GitHub REST API v3.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,025 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [ip2location-io-go](https://github.com/ip2location/ip2location-io-go) ⭐ 11 - Go wrapper for the IP2Location.io API [IP2Location.io](https://www.ip2location.io/).
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 2,691 - Minio Go Library for Amazon S3 compatible cloud storage.
...
- [simples3](https://github.com/rhnvrm/simples3) ⭐ 163 - Simple no frills AWS S3 Library using REST with V4 Signing written in Go.
- [slack](https://github.com/slack-go/slack) ⭐ 4,783 - Slack API in Go.
...
- [boilr](https://github.com/tmrts/boilr) ⭐ 1,734 - Blazingly fast CLI tool for creating projects from boilerplate templates.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,160 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 50,909 - A tool for exploring each layer in a Docker image.
...
- [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,231 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,594 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,683 - Deliver Go binaries as fast and easily as possible.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,041 - A comprehensive, efficient, and reusable util function library of go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,503 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mc](https://github.com/minio/mc) ⭐ 3,047 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,686 - Simple library for retry mechanism.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,045 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,951 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,381 - usql is a universal command-line interface for SQL databases.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,722 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/gofrs/uuid) ⭐ 1,683 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
- [uuid](https://github.com/google/uuid) ⭐ 5,669 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,118 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [gody](https://github.com/guiferpa/gody) ⭐ 138 - :balloon: A lightweight struct validator for Go.
...
- [jio](https://github.com/faceair/jio) ⭐ 117 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,104.
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,925 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,409 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 859 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,318 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,565 - highly extensible Git implementation in pure Go.
- [go-vcs](https://github.com/sourcegraph/go-vcs) ⭐ 80 - manipulate and inspect VCS repositories in Go.
- [hercules](https://github.com/src-d/hercules) ⭐ 2,706 - gaining advanced insights from Git repository history.
...
- [go-astisub](https://github.com/asticode/go-astisub) ⭐ 639 - Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).
...
- [gortsplib](https://github.com/aler9/gortsplib) ⭐ 779 - Pure Go RTSP server and client library.
...
- [Beego](https://github.com/beego/beego) ⭐ 32,098 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,053 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 445 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,671 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,393 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,553 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 - Gin parameter automatic binding tool,gin rpc tools.
- [Goa](https://github.com/goadesign/goa) ⭐ 5,867 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 10,655 - Gofr is an opinionated microservice development framework.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,831 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,113 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
- [iWF](https://github.com/indeedeng/iwf) ⭐ 569 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
- [templui](https://github.com/axzilla/templui) ⭐ 657 - Modern UI Components for Go & Templ.
...
- [CORS](https://github.com/rs/cors) ⭐ 2,781 - Easily add CORS capabilities to your API.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,861 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,882 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,395 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,277 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,944 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,129 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 546 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
- [workflow](https://github.com/luno/workflow) ⭐ 160 - A tech stack agnostic Event Driven Workflow framework.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,958 - Container Signing, Verification and Storage in an OCI registry.
- [in-toto](https://github.com/in-toto/in-toto-golang) ⭐ 137 - Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation.
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,338 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 106 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) ⭐ 933 - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,086 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,063 - Formatter that automatically shortens long lines in Go code.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,185 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,439 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,673.
...
- [vacuum](https://github.com/daveshanley/vacuum) ⭐ 767 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 573 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,695 features to Vim/Neovim.
...
- [go-mode](https://github.com/dominikh/go-mode.el) ⭐ 1,415 - Go mode for GNU/Emacs.
- [gocode](https://github.com/nsf/gocode) ⭐ 5,005 - Autocompletion daemon for the Go programming language.
- [goimports-reviser](https://github.com/incu6us/goimports-reviser) ⭐ 665 - Formatting tool for imports.
...
- [vim-go](https://github.com/fatih/vim-go) ⭐ 16,134 - Go development plugin for Vim.
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,054 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [gotests](https://github.com/cweill/gotests) ⭐ 5,067 - Generate Go tests from your source code.
...
- [xgen](https://github.com/xuri/xgen) ⭐ 363 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,275 - Visualize call graph of your Go program using dot format.
...
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,765 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [MoniGO](https://github.com/iyashjayesh/monigo) ⭐ 268 - A performance monitoring library for Go applications. It provides real-time insights into application performance! 🚀
...
- [richgo](https://github.com/kyoh86/richgo) ⭐ 861 - Enrich `go test` outputs with text decorations.
...
- [typex](https://github.com/dtgorski/typex) ⭐ 205 - Examine Go types and their transitive dependencies, alternatively export results as TypeScript value objects (or types) declaration.
...
- [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,386 - Fast cross-platform HTTP benchmarking tool.
- [bosun](https://github.com/bosun-monitor/bosun) ⭐ 3,412 - Time Series Alerting Framework.
- [cassowary](https://github.com/rogerwelin/cassowary) ⭐ 801 - Modern cross-platform HTTP load-testing tool written in Go.
- [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,485 - High-performance load testing tool, written in Golang.
- [decompose](https://github.com/s0rg/decompose) ⭐ 102 - tool to generate and process Docker containers connections graphs.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,115 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,039 - Lightweight, programmable telemetry for servers and workstations.
...
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 48,860 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,957 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,911 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,824 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,808 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 27,903 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,184 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,718 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,469 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,370 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,703 - Cloud native application delivery.
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,154 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
- [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,125 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,480 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,817 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Packer](https://github.com/mitchellh/packer) ⭐ 15,384 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,073 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,703 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [traefik](https://github.com/containous/traefik) ⭐ 54,973 - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,258 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,355 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Chapar](https://github.com/chapar-rest/chapar) ⭐ 572 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
- [crawley](https://github.com/s0rg/crawley) ⭐ 297 - Web scraper/crawler for cli.
- [croc](https://github.com/schollz/croc) ⭐ 30,277 - Easily and securely send files or folders from one computer to another.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,436 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,656 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,645 - Portal is a quick and easy command-line file transfer utility from any computer to another.
- [restic](https://github.com/restic/restic) ⭐ 28,789 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 694 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,355 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,599 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
- [shell2http](https://github.com/msoap/shell2http) ⭐ 1,404 - Executing shell commands via http server (for prototyping or remote control).
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,269 - Proxy to simulate network and system conditions for automated tests.
...
- [vFlow](https://github.com/VerizonDigital/vflow) ⭐ 1,125 - High-performance, scalable and reliable IPFIX, sFlow and Netflow collector.
...
- [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) ⭐ 1,657 - Go HTTP request router benchmark and comparison.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,029 - A curated list of Go books.
...
- [gophers](https://github.com/egonelbre/gophers) ⭐ 3,639 - Free gophers.
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,529
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,136 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,602 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,127 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,597 - Golang ebook intro how to build a web app with golang.
...
- [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,638 - Go's reference card.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,839 - Clean Architecture template for Golang services.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,315 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,842 - Learn Go with test-driven development.
