...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 144,933](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 245,585.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 144,933 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 144,933; you rock!
...
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,936 - Blazingly fast and light-weight Actor engine written in Golang.
- [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,235 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
...
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,759 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,059 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 142,869 - Run large language models locally.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,694 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [gorbac](https://github.com/mikespook/gorbac) ⭐ 1,626 - provides a lightweight role-based access control (RBAC) implementation in Golang.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,035 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,117 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- [keto](https://github.com/ory/keto) ⭐ 5,033 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
- [loginsrv](https://github.com/tarent/loginsrv) ⭐ 1,923 - JWT login microservice with pluggable backends such as OAuth2 (Github), htpasswd, osiam.
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,614 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,672 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,335 - Session Manager for HTTP servers.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,081 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,510 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,933 - A complete implementation of a Lightning Network node.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,175 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,335 - Telegram bot framework is written in Go.
- [telego](https://github.com/mymmrac/telego) ⭐ 718 - Telegram Bot API library for Golang with full one-to-one API implementation.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,651 - Air - Live reload for Go apps.
...
- [goyek](https://github.com/goyek/goyek) ⭐ 622 - Create build pipelines in Go.
...
- [Task](https://github.com/go-task/task) ⭐ 12,908 - simple "Make" alternative.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,370 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 31,942 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,522 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,367 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,732.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,027 - Declaratively define styles for color, format and layout in the terminal.
...
- [spinner](https://github.com/briandowns/spinner) ⭐ 2,432 - Go package to easily provide a terminal spinner with options.
...
- [termenv](https://github.com/muesli/termenv) ⭐ 1,837 - Advanced ANSI style & color support for your terminal applications.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 666 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,273 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,629 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,022 - An expressive programming language and a versatile interactive shell.
...
- [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,151 - Struct-based argument parsing in Go.
...
- [ops](https://github.com/nanovms/ops) ⭐ 1,353 - Unikernel Builder/Orchestrator.
- [pflag](https://github.com/spf13/pflag) ⭐ 2,567 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,220 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,836 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,513 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,320 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,226 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,226 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,649 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,186 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,626 - Go configuration with fangs.
...
- [CDS](https://github.com/ovh/cds) ⭐ 4,712 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [drone](https://github.com/drone/drone) ⭐ 32,814 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 556 - go test output for humans.
- [goveralls](https://github.com/mattn/goveralls) ⭐ 791 - Go integration for Coveralls.io continuous code coverage tracking system.
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,563 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,728.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,113 - Woodpecker is a community fork of the Drone CI system.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,630 - Distributed, Fault-tolerant task queue.
...
- [queue](https://github.com/adrianbrad/queue) ⭐ 307 - Multiple thread-safe, generic queue implementations for Go.

### Sets

- [dsu](https://github.com/ihebu/dsu) ⭐ 15 - Disjoint Set data structure implementation in Go.
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,520 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,841 - Efficient key/value cache for gigabytes of data.
...
- [fastcache](https://github.com/VictoriaMetrics/fastcache) ⭐ 2,223 - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
- [GCache](https://github.com/bluele/gcache) ⭐ 2,682 - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
- [groupcache](https://github.com/golang/groupcache) ⭐ 13,178 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,105 -  A high performance memory-bound Go cache.
...
- [badger](https://github.com/dgraph-io/badger) ⭐ 14,628 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,817 - An embedded key/value database for Go.
...
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 30,967 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,904 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,509 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,431 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,702 - Dolt – It's Git for Data.
...
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,268 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,706 key/value database in Go.
...
- [immudb](https://github.com/codenotary/immudb) ⭐ 8,747 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,124 - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,139 - Milvus is a vector database for embedding management, analytics and search.
...
- [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,225 - High-performance embedded Object Database (NoSQL) with Go API.
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,324 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,847 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,774 - Redis re-implemented with SQLite.
...
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,661 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,543 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,237 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,902 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,532 - Safe database schema change and version control for DevOps teams.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,470 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,755 - Database migrations. CLI and Golang library.
...
- [gatewayd](https://github.com/gatewayd-io/gatewayd) ⭐ 260 - Cloud-native database gateway and framework for building data-driven applications. Like API gateways, for databases.
...
- [rdb](https://github.com/HDT3213/rdb) ⭐ 539 - Redis RDB file parser for secondary development and memory analysis.
- [rwdb](https://github.com/andizzle/rwdb) ⭐ 20 - rwdb provides read replica capability for multiple database servers setup.
- [vitess](https://github.com/youtube/vitess) ⭐ 19,619 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,206 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,238 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,432 - Go library that helps you build SQL queries.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,831 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,509 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 700 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,932 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,932 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,426 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,496 - Pure Go Postgres driver for database/sql.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,354 - Official MongoDB driver for the Go language.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,931 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,681 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
- [carbon](https://github.com/dromara/carbon) ⭐ 5,055 - A simple, semantic and developer-friendly time package for golang.
...
- [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,184 - A feature complete and high performance multi-group Raft library in Go.
...
- [emitter-io](https://github.com/emitter-io/emitter) ⭐ 3,931 - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,070 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,324 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,141 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 708 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,901 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,030 - A cloud native Kubernetes Global Balancer.
...
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,411 - A modular-designed and easy-to-use microservices framework in Go.
...
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,526 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,276 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,612 - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 845 - Go implementation of the Raft consensus protocol, by CoreOS.
- [rain](https://github.com/cenkalti/rain) ⭐ 1,046 - BitTorrent client and library.
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,612 - Simplified distributed locking implementation using Redis.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,265).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,870 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [hermes](https://github.com/matcornic/hermes) ⭐ 2,901 - Golang package that generates clean, responsive HTML e-mails.
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,917 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,174 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 4,990 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [anko](https://github.com/mattn/anko) ⭐ 1,517 - Scriptable interpreter written in Go.
...
- [cel-go](https://github.com/google/cel-go) ⭐ 2,561 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,894 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 7,983 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,266 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,189 - ECMAScript 5.1(+) implementation in Go.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,658 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,222 - Go error library with error portability over the network.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 265 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
- [oops](https://github.com/samber/oops) ⭐ 674 - Error handling with context, stack trace and source fragments.
...
- [copy](https://github.com/otiai10/copy) ⭐ 758 - Copy directory recursively.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,475 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,680 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,794.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,764 - Arbitrary-precision fixed-point decimal numbers.
...
- [orderbook](https://github.com/i25959341/orderbook) ⭐ 489 - Matching Engine for Limit Order Book in Golang.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,265 - Terminal stock watcher and stock position tracker.
...
- [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,120 - CSRF protection for Go web applications & services.
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,089 - dead simple 2D game engine in Go.
...
- [nano](https://github.com/lonng/nano) ⭐ 3,019 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,625 - Pure Go game engine.
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,548 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,064 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,172 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,339 - Geolocation DB with spatial index and realtime geofencing.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,379 - Compile shell scripts to Go.
...
- [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,972 - Compiler from Go to JavaScript.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,721 - A high-performance and low-cost goroutine pool in Go.
...
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 410 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 65,970 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,652.
- [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,021 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,250 - Build native macOS applications using Go.
- [energy](https://github.com/energye/energy) ⭐ 476 - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,525 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [webview](https://github.com/zserge/webview) ⭐ 13,139 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [systray](https://github.com/getlantern/systray) ⭐ 3,487 - Cross platform Go library to place an icon and menu in the notification area.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,561 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [bild](https://github.com/anthonynsimon/bild) ⭐ 4,106 - Collection of image processing algorithms in pure Go.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,598 - 2D rendering in pure Go.
...
- [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 712 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
- [govips](https://github.com/davidbyttow/govips) ⭐ 1,440 - A lightning fast image processing and resizing library for Go.
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,761 - Screenshoting webpages using go and headless chrome on command line.
- [gridder](https://github.com/shomali11/gridder) ⭐ 80 - A Grid based 2D Graphics library.
- [image2ascii](https://github.com/qeesung/image2ascii) ⭐ 919 - Convert image to ASCII.
- [imagick](https://github.com/gographics/imagick) ⭐ 1,822 - Go binding to ImageMagick's MagickWand C API.
- [imaginary](https://github.com/h2non/imaginary) ⭐ 5,853 - Fast and simple HTTP microservice for image resizing.
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,483 - Simple Go image processing package.
...
- [clockwerk](https://github.com/onatm/clockwerk) ⭐ 178 - Go package to schedule periodic jobs using a simple, fluent syntax.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,265 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,489.
- [goflow](https://github.com/fieldryand/goflow) ⭐ 437 - A simple but powerful DAG scheduler and dashboard.
- [gron](https://github.com/roylee0704/gron) ⭐ 1,035 - Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly.
...
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 549 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [tail](https://github.com/hpcloud/tail) ⭐ 2,761 - Go package striving to emulate the features of the BSD tail program.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,155 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,464 - Zero-allocation JSON logger.
...
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 404 - Huggingface transformer pipelines for golang with onnxruntime.
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,775 - Go RabbitMQ Client Library.
- [APNs2](https://github.com/sideshow/apns2) ⭐ 3,089 - HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps.
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,301 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,001 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,893 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
- [dbus](https://github.com/godbus/dbus) ⭐ 1,056 - Native Go bindings for D-Bus.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,383 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,089 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,753 - Asynchronous task queue/job queue based on distributed message passing.
...
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,949 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,947 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,015 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,505 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,584 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize](https://github.com/xuri/excelize) ⭐ 19,216 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [dig](https://github.com/uber-go/dig) ⭐ 4,192 - A reflection based dependency injection toolkit for Go.
...
- [google/wire](https://github.com/google/wire) ⭐ 13,811 - Automated Initialization in Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,789 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,789 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,558 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,607 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,607 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,237 - Nunu is a scaffolding tool for building Go applications.
...
- [archives](https://github.com/mholt/archives) ⭐ 239 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,498 - Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,946 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,205 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,255 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,727.
...
- [slug](https://github.com/gosimple/slug) ⭐ 1,251 - URL-friendly slugify with multiple languages support.
- [Slugify](https://github.com/avelino/slugify) ⭐ 34 - Go slugify application that handles string.

### Tokenizers

- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,525 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,140 which a Chinese word splitting algorithm.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,724 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,608 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,561 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,803 - BGP implemented in the Go Programming Language.
- [gopacket](https://github.com/google/gopacket) ⭐ 6,539 - Go library for packet processing with libpcap bindings.
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,258 - KCP - Fast and Reliable ARQ Protocol.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,499 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 750 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,708 - An implementation of the QUIC protocol in pure Go.
...
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,904 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,877 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [water](https://github.com/songgao/water) ⭐ 2,040 - Simple TUN/TAP library.
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,873 - A pure Go implementation of the WebRTC API.
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,921 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,153 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,286 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,181 - SQL-first Golang ORM. Successor of go-pg.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,293 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,872 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,106 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,418 - A distributed tracing system.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,467 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,363 - go generate based graphql server library.
...
- [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,068 - Implementation of GraphQL for Go.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,027 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- [graph](https://github.com/yourbasic/graph) ⭐ 727 - Library of basic graph algorithms.
...
- [Poly](https://github.com/bebop/poly) ⭐ 702 - A Go package for engineering organisms.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,022 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,153 - A secure low code honeypot framework, leveraging AI for System Virtualization.
...
- [cbor](https://github.com/fxamacker/cbor) ⭐ 877 - Small, safe, and easy CBOR encoding and decoding library.
...
- [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,953 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,767 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
- [algernon](https://github.com/xyproto/algernon) ⭐ 2,909 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,701 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,539 - Highly-available key value store for shared configuration and service discovery.
...
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,393 - A self contained feature flag solution written in Go and Vue.js
...
- [minio](https://github.com/minio/minio) ⭐ 52,941 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,648 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,519 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,108 - Make SSH apps, just like that!
...
- [jet](https://github.com/CloudyKit/jet) ⭐ 1,326 - Jet template engine.
...
- [pongo2](https://github.com/flosch/pongo2) ⭐ 2,954 - Django-like template-engine for Go.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,350 - A HTML templating language that has great developer tooling.
...
- [go-cmp](https://github.com/google/go-cmp) ⭐ 4,421 - Package for comparing Go values in tests.
...
- [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,307 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,121 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,086 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,691 - Sacred extension to the standard go testing package.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,828 - Mocking framework for the Go programming language.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,611 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 481 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,932.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,876 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,708 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,959 - A Devtools driver to make web automation and scraping easy.
...
- [sq](https://github.com/neilotoole/sq) ⭐ 2,288 - Convert data from SQL databases or document formats like CSV or Excel into formats such as JSON, Excel, CSV, HTML, Markdown, XML, and YAML.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,097 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,769 - Shell parser and formatter.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,403 - HTML Sanitizer.
- [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 - A sanitization-based swear filter for Go.

### Scrapers

- [colly](https://github.com/asciimoo/colly) ⭐ 24,244 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,511 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,073 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,416 - Go bindings for the Discord Chat API.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,033 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,266 - Google Cloud APIs Go Client Library.
...
- [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 727 - Wrapper for PayPal payment API.
...
- [stripe](https://github.com/stripe/stripe-go) ⭐ 2,317 - Go client for the Stripe API.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,164 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 50,979 - A tool for exploring each layer in a Docker image.
...
- [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,237 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
- [filetype](https://github.com/h2non/filetype) ⭐ 2,193 - Small package to infer the file type checking the magic numbers signature.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,717 - Command-line fuzzy finder written in Go.
...
- [go-funk](https://github.com/thoas/go-funk) ⭐ 4,897 - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,704 - Deliver Go binaries as fast and easily as possible.
...
- [lo](https://github.com/samber/lo) ⭐ 19,521 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mani](https://github.com/alajmo/mani) ⭐ 552 - CLI tool to help you manage multiple repositories.
- [mc](https://github.com/minio/mc) ⭐ 3,056 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
- [mergo](https://github.com/imdario/mergo) ⭐ 2,997 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [minify](https://github.com/tdewolff/minify) ⭐ 3,886 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,689 - Simple library for retry mechanism.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,056 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,966 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [toolbox](https://github.com/viant/toolbox) ⭐ 204 - Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,725 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/google/uuid) ⭐ 5,677 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [gody](https://github.com/guiferpa/gody) ⭐ 148 - :balloon: A lightweight struct validator for Go.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,426 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 864 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,386 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,581 - highly extensible Git implementation in pure Go.
...
- [go-astiav](https://github.com/asticode/go-astiav) ⭐ 505 - Better C bindings for ffmpeg in GO.
...
- [Beego](https://github.com/beego/beego) ⭐ 32,109 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,076 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 448 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,764 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,401 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,602 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,018 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,417 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,839 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,289 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,122 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 683 - Modern UI Components for Go & Templ.
...
- [Yokai](https://github.com/ankorstore/yokai) ⭐ 716 - Simple, modular, and observable Go framework for backend applications.
...
- [CORS](https://github.com/rs/cors) ⭐ 2,784 - Easily add CORS capabilities to your API.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,882 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,886 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,400 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,289 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,957 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,226 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,972 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,342 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 106 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,111 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,068 - Formatter that automatically shortens long lines in Go code.
- [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,006 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,182 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,448 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,691.
...
- [vacuum](https://github.com/daveshanley/vacuum) ⭐ 777 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 573 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,701 features to Vim/Neovim.
...
- [go-mode](https://github.com/dominikh/go-mode.el) ⭐ 1,417 - Go mode for GNU/Emacs.
...
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,586 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,057 - Lightweight, programmable telemetry for servers and workstations.
...
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 48,929 - Fork of Gogs, entirely community driven.
...
- [go-selfupdate](https://github.com/sanbornm/go-selfupdate) ⭐ 1,613 - Enable your Go applications to self update.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,963 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,928 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,835 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,847 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 27,945 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,189 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,024 - Command line tool for building and deploying Go applications on Kubernetes
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,536 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,378 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
...
- [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,128 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,500 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,843 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 356 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,091 - Blazing fast S3 and local filesystem execution tool.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,001 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,029 - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,272 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,365 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,315 - Easily and securely send files or folders from one computer to another.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,442 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,898 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,684 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,649 - Portal is a quick and easy command-line file transfer utility from any computer to another.
- [restic](https://github.com/restic/restic) ⭐ 28,854 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 695 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,367 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,688 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
- [shell2http](https://github.com/msoap/shell2http) ⭐ 1,406 - Executing shell commands via http server (for prototyping or remote control).
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,275 - Proxy to simulate network and system conditions for automated tests.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,042 - A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,744 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 30,967
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,141
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,541
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,204 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,616 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,205 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,605 - Golang ebook intro how to build a web app with golang.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,846 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,513 - Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,714 - Examples of Golang compared to Node.js for learning.
