...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,103](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 246,005.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,103 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,103; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,978 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,787 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,118 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 143,110 - Run large language models locally.
...
- [PortAudio](https://github.com/gordonklaus/portaudio) ⭐ 769 - Go bindings for the PortAudio audio I/O library.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,710 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,040 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,130 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,679 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,338 - Session Manager for HTTP servers.
...
- [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,606 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,092 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,517 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,935 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,316 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,339 - Telegram bot framework is written in Go.
- [telego](https://github.com/mymmrac/telego) ⭐ 720 - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,167 - Simple and clean Telegram bot client.
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,973 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,689 - Air - Live reload for Go apps.
...
- [goyek](https://github.com/goyek/goyek) ⭐ 623 - Create build pipelines in Go.
- [mage](https://github.com/magefile/mage) ⭐ 4,344 - Mage is a make/rake-like build tool using Go.
- [mmake](https://github.com/tj/mmake) ⭐ 1,725 - Modern Make.
- [realize](https://github.com/tockins/realize) ⭐ 4,456 - Go build a system with file watchers and live to reload. Run, build and watch file changes with custom paths.
- [Task](https://github.com/go-task/task) ⭐ 12,929 - simple "Make" alternative.
...
- [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,830 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,388 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,013 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,533 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,367 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,743.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,041 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,406 - Basic thread-safe progress bar that works in every OS.
- [pterm](https://github.com/pterm/pterm) ⭐ 5,099 - A library to beautify console output on every platform with many combinable components.
- [simpletable](https://github.com/alexeyco/simpletable) ⭐ 538 - Simple tables in a terminal with Go.
- [spinner](https://github.com/briandowns/spinner) ⭐ 2,434 - Go package to easily provide a terminal spinner with options.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,825 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,361.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,839 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,361 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,607.
...
- [yacspin](https://github.com/theckman/yacspin) ⭐ 448 - Yet Another CLi Spinner package, for working with terminal spinners.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 673 - Command argument completion generator for spf13/cobra.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,649 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,031 - An expressive programming language and a versatile interactive shell.
...
- [pflag](https://github.com/spf13/pflag) ⭐ 2,570 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,231 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,839 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,522 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,331 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,652 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,189 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,640 - Go configuration with fangs.
...
- [drone](https://github.com/drone/drone) ⭐ 32,821 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 559 - go test output for humans.
- [goveralls](https://github.com/mattn/goveralls) ⭐ 790 - Go integration for Coveralls.io continuous code coverage tracking system.
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,564 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,733.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,129 - Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,369 - A message streaming bridge between a range of protocols.
- [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,108 - A high-performance ELT data integration framework with pluggable architecture.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,710 - Go package implementing compressed bitsets.
...
- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,600 - Go package implementing Bloom filters.
...
- [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,799 - Collection of useful, performant, and thread-safe data structures.
- [gods](https://github.com/emirpasic/gods) ⭐ 16,941 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,648 - Distributed, Fault-tolerant task queue.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,523 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,403 - Modern text indexing library for go.
...
- [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 399 - Implementation to calculate levenshtein distance in Go.
...
- [badger](https://github.com/dgraph-io/badger) ⭐ 14,633 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,821 - An embedded key/value database for Go.
- [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,705 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover](https://github.com/ostafen/clover) ⭐ 755 - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 30,978 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,913 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,523 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,431 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,715 - Dolt – It's Git for Data.
...
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,268 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,714 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,136 - Scalable datastore for metrics, events, and real-time analytics.
...
- [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,160 - Fast k/v database compatible with lsm and b+tree.
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,197 - Milvus is a vector database for embedding management, analytics and search.
- [moss](https://github.com/couchbase/moss) ⭐ 1,004 - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,471 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
- [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,227 - High-performance embedded Object Database (NoSQL) with Go API.
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,332 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,876 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,778 - Redis re-implemented with SQLite.
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,805 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,664 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,552 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,262 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,909 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,539 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,035 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,488 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,768 - Database migrations. CLI and Golang library.
...
- [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,341 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,904 - Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,634 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [goqu](https://github.com/doug-martin/goqu) ⭐ 2,528 - Idiomatic SQL builder and query library.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,210 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,261 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,437 - Go library that helps you build SQL queries.
...
- [cayley](https://github.com/google/cayley) ⭐ 14,930 - Graph database with support for multiple backends.
...
- [gokv](https://github.com/philippgille/gokv) ⭐ 789 - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,842 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,511 - SQLite3 driver for go that uses database/sql.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,939 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,939 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,427 query results easily.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,942 - Redis client for Golang.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 967 - Fast trigram based code search.
...
- [carbon](https://github.com/dromara/carbon) ⭐ 5,057 - A simple, semantic and developer-friendly time package for golang.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,611 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [emitter-io](https://github.com/emitter-io/emitter) ⭐ 3,933 - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
...
- [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,316 - A Go framework for the API or Microservice with handy scaffolding tools.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,075 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,331 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,151 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,906 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,424 - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,603 - Lightweight, fault-tolerant message streams for NATS.
- [lura](https://github.com/luraproject/lura) ⭐ 6,559 - Ultra performant API Gateway framework with middlewares.
- [micro](https://github.com/micro/micro) ⭐ 12,257 - A distributed systems runtime for the cloud and beyond.
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,532 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,289 - NATS is a simple, secure, and
...
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,615 - Simplified distributed locking implementation using Redis.
...
- [rpcx](https://github.com/smallnest/rpcx) ⭐ 8,220 - Distributed pluggable RPC service framework like alibaba Dubbo.
- [Semaphore](https://github.com/jexia/semaphore) ⭐ 94 - A straightforward (micro) service orchestrator.
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,269).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,882 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [Temporal](https://github.com/temporalio/sdk-go) ⭐ 645 - Durable execution system for making code fault-tolerant and simple.
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,782 - BitTorrent client package.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 998 - A simple Go library for sending mails in Go.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,555 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,919 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,181 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 4,997 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [anko](https://github.com/mattn/anko) ⭐ 1,518 - Scriptable interpreter written in Go.
...
- [cel-go](https://github.com/google/cel-go) ⭐ 2,565 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,910 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,025 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,270 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,196 - ECMAScript 5.1(+) implementation in Go.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 275 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
- [oops](https://github.com/samber/oops) ⭐ 677 - Error handling with context, stack trace and source fragments.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,236 - FileSystem Abstraction System for Go.
- [afs](https://github.com/viant/afs) ⭐ 330 - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
- [copy](https://github.com/otiai10/copy) ⭐ 759 - Copy directory recursively.
...
- [go-wkhtmltopdf](https://github.com/SebastiaanKlippert/go-wkhtmltopdf) ⭐ 1,121 - A package to convert an HTML template to a PDF file.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,687 - PDF processor.
...
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1,359 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,774 - Arbitrary-precision fixed-point decimal numbers.
...
- [ledger](https://github.com/formancehq/ledger) ⭐ 973 - A programmable financial ledger that provides a foundation for money-moving applications.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,267 - Terminal stock watcher and stock position tracker.
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,098 - dead simple 2D game engine in Go.
...
- [g3n](https://github.com/g3n/engine) ⭐ 2,949 - Go 3D Game Engine.
...
- [nano](https://github.com/lonng/nano) ⭐ 3,022 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,626 - Pure Go game engine.
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,551 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
- [Pixel](https://github.com/gopxl/pixel) ⭐ 327 - Hand-crafted 2D game library in Go.
...
- [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,220 - Generate decorators for Go interfaces using simple templates.
- [interfaces](https://github.com/rjeczalik/interfaces) ⭐ 432 - Command line tool for generating interface definitions.
- [jennifer](https://github.com/dave/jennifer) ⭐ 3,503 - Generate arbitrary Go code without templates.
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,180 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 726 - A simple Go-based server for map tiles stored in mbtiles format.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,340 - Geolocation DB with spatial index and realtime geofencing.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,383 - Compile shell scripts to Go.
...
- [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,973 - Compiler from Go to JavaScript.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,728 - A high-performance and low-cost goroutine pool in Go.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,678 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 411 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,026 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,655.
...
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,252 - Build native macOS applications using Go.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,539 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [webview](https://github.com/zserge/webview) ⭐ 13,142 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,176 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,565 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [bimg](https://github.com/h2non/bimg) ⭐ 2,855 - Small package for fast and efficient image processing using libvips.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,600 - 2D rendering in pure Go.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,074 - Go package for computer vision using OpenCV 3.3+.
...
- [govips](https://github.com/davidbyttow/govips) ⭐ 1,441 - A lightning fast image processing and resizing library for Go.
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,764 - Screenshoting webpages using go and headless chrome on command line.
- [gridder](https://github.com/shomali11/gridder) ⭐ 80 - A Grid based 2D Graphics library.
- [image2ascii](https://github.com/qeesung/image2ascii) ⭐ 920 - Convert image to ASCII.
...
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,486 - Simple Go image processing package.
- [imagor](https://github.com/cshum/imagor) ⭐ 3,647 - Fast, secure image processing server and Go library, using libvips.
...
- [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,592 - Lightweight data stream processing engine for IoT edge.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,115 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,272 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,489.
...
- [fastjson](https://github.com/valyala/fastjson) ⭐ 2,378 - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,966 - Get a JSON value with one line of code.
...
- [kemba](https://github.com/clok/kemba) ⭐ 16 - A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug) ⭐ 11,283, great for CLI tools and applications.
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 550 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,286 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,286 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,286 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,286, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,075, [zap](https://github.com/uber-go/zap) ⭐ 23,165, [zerolog](https://github.com/rs/zerolog) ⭐ 11,471, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,118 - Simple rolling logger, implements io.WriteCloser.
...
- [pp](https://github.com/k0kubun/pp) ⭐ 1,951 - Colored pretty printer for Go language.
...
- [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 970 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
...
- [slog](https://github.com/gookit/slog) ⭐ 471 - Lightweight, configurable, extensible logger for Go.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,165 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,471 - Zero-allocation JSON logger.
...
- [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,770 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,885 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,778 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,313 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,004 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,897 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
- [dbus](https://github.com/godbus/dbus) ⭐ 1,057 - Native Go bindings for D-Bus.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,387 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,090 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,951 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,951 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,021 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,522 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [excelize](https://github.com/xuri/excelize) ⭐ 19,229 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [fx](https://github.com/uber-go/fx) ⭐ 6,555 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,818 - Automated Initialization in Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,791 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,791 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,573 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,641 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,641 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,239 - Nunu is a scaffolding tool for building Go applications.
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,537 - Rapid, easy full-stack web development starter kit built in Go.
...
- [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,119 - cross-platform, cli app to perform various operations on string.
...
- [archives](https://github.com/mholt/archives) ⭐ 241 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
- [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,236 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,511 - Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,950 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,212 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [gtree](https://github.com/ddddddO/gtree) ⭐ 299 - Provide CLI, Package and Web for tree output and directories creation from Markdown or programmatically.
...
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,259 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
- [sitemap-format](https://github.com/mingard/sitemap-format) ⭐ 6 - A simple sitemap generator, with a little syntactic sugar.
- [stateless](https://github.com/qmuntal/stateless) ⭐ 1,059 - A fluent library for creating state machines.
...
- [slug](https://github.com/gosimple/slug) ⭐ 1,252 - URL-friendly slugify with multiple languages support.
- [Slugify](https://github.com/avelino/slugify) ⭐ 34 - Go slugify application that handles string.

### Tokenizers

- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,526 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,144 which a Chinese word splitting algorithm.
...
- [prose](https://github.com/jdkato/prose) ⭐ 3,072 - Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more. English only.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,741 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,614 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,569 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,704 - Go library for downloading files or directories from various sources using a URL.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,808 - BGP implemented in the Go Programming Language.
- [gopacket](https://github.com/google/gopacket) ⭐ 6,541 - Go library for packet processing with libpcap bindings.
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,261 - KCP - Fast and Reliable ARQ Protocol.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 752 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,714 - An implementation of the QUIC protocol in pure Go.
...
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,908 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,888 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,881 - A pure Go implementation of the WebRTC API.
...
- [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 254 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,925 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,155 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,291 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,184 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,234 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,304 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,875 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,140 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,471 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [graphql](https://github.com/neelance/graphql-go) ⭐ 4,705 - GraphQL server with a focus on ease of use.
- [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,070 - Implementation of GraphQL for Go.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,034 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,029 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,159 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 567 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,383 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,684 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,627 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
- [luks.go](https://github.com/anatol/luks.go) ⭐ 90 - Pure Golang library to manage LUKS partitions.
- [memguard](https://github.com/awnumar/memguard) ⭐ 2,633 - A pure Go library for handling sensitive values in memory.
...
- [cbor](https://github.com/fxamacker/cbor) ⭐ 878 - Small, safe, and easy CBOR encoding and decoding library.
...
- [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,955 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,768 - High-performance 100% compatible drop-in replacement of "encoding/json".
- [mapstructure](https://github.com/mitchellh/mapstructure) ⭐ 7,983 - Go library for decoding generic map values into native Go structures.
...
- [algernon](https://github.com/xyproto/algernon) ⭐ 2,911 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,759 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,557 - Highly-available key value store for shared configuration and service discovery.
...
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,492 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,397 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,658 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 52,997 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,689 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,154 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,533 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [go-etl](https://github.com/Breeze0806/go-etl) ⭐ 146 - A lightweight toolkit for data source extraction, transformation, and loading (ETL).
...
- [pongo2](https://github.com/flosch/pongo2) ⭐ 2,955 - Django-like template-engine for Go.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,358 - A HTML templating language that has great developer tooling.
...
- [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 959 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
- [go-cmp](https://github.com/google/go-cmp) ⭐ 4,424 - Package for comparing Go values in tests.
...
- [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,308 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
- [is](https://github.com/matryer/is) ⭐ 1,860 - Professional lightweight testing mini-framework for Go.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,131 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,094 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,705 - Sacred extension to the standard go testing package.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,832 - Mocking framework for the Go programming language.
...
- [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,028 - Easy mocking of HTTP responses from external resources.
- [minimock](https://github.com/gojuno/minimock) ⭐ 685 - Mock generator for Go interfaces.
- [mockery](https://github.com/vektra/mockery) ⭐ 6,614 - Tool to generate Go interfaces.
...
- [moq](https://github.com/matryer/moq) ⭐ 2,090 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 481 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,939.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,886 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,712 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,974 - A Devtools driver to make web automation and scraping easy.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,103 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,879 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [toml](https://github.com/BurntSushi/toml) ⭐ 4,736 - TOML configuration format (encoder/decoder with reflection).
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,773 - Shell parser and formatter.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 24,276 - Fast and Elegant Scraping Framework for Gophers.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,083 - The official AWS SDK for the Go programming language.
...
- [githubql](https://github.com/shurcooL/githubql) ⭐ 1,149 - Go library for accessing the GitHub GraphQL API v4.
- [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 160 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,039 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google](https://github.com/google/google-api-go-client) ⭐ 4,259 - Auto-generated Google APIs for Go.
- [google-analytics](https://github.com/chonthu/go-google-analytics) ⭐ 15 - Simple wrapper for easy google analytics reporting.
- [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,268 - Google Cloud APIs Go Client Library.
...
- [lark](https://github.com/chyroc/lark) ⭐ 444 - [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,787 - Slack API in Go.
...
- [stripe](https://github.com/stripe/stripe-go) ⭐ 2,321 - Go client for the Stripe API.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,173 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 51,007 - A tool for exploring each layer in a Docker image.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,788 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,714 - Deliver Go binaries as fast and easily as possible.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,045 - A comprehensive, efficient, and reusable util function library of go.
...
- [limiters](https://github.com/mennanov/limiters) ⭐ 563 - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
- [lo](https://github.com/samber/lo) ⭐ 19,536 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mani](https://github.com/alajmo/mani) ⭐ 554 - CLI tool to help you manage multiple repositories.
...
- [mergo](https://github.com/imdario/mergo) ⭐ 3,002 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,692 - Simple library for retry mechanism.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,057 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,975 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [toolbox](https://github.com/viant/toolbox) ⭐ 215 - Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer.
...
- [usql](https://github.com/knq/usql) ⭐ 9,388 - usql is a universal command-line interface for SQL databases.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,726 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/google/uuid) ⭐ 5,685 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,129 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [gody](https://github.com/guiferpa/gody) ⭐ 150 - :balloon: A lightweight struct validator for Go.
...
- [jio](https://github.com/faceair/jio) ⭐ 118 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,108.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,447 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 865 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,434 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,587 - highly extensible Git implementation in pure Go.
...
- [go-astiav](https://github.com/asticode/go-astiav) ⭐ 506 - Better C bindings for ffmpeg in GO.
- [go-astisub](https://github.com/asticode/go-astisub) ⭐ 642 - Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,094 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 448 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,788 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,405 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,641 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 - Gin parameter automatic binding tool,gin rpc tools.
- [Goa](https://github.com/goadesign/goa) ⭐ 5,872 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,320 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,427 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,292 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,134 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
- [iWF](https://github.com/indeedeng/iwf) ⭐ 573 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
- [templui](https://github.com/axzilla/templui) ⭐ 693 - Modern UI Components for Go & Templ.
...
- [Yokai](https://github.com/ankorstore/yokai) ⭐ 718 - Simple, modular, and observable Go framework for backend applications.
...
- [CORS](https://github.com/rs/cors) ⭐ 2,785 - Easily add CORS capabilities to your API.
...
- [Limiter](https://github.com/ulule/limiter) ⭐ 2,216 - Dead simple rate limit middleware for Go.
...
- [alice](https://github.com/justinas/alice) ⭐ 3,255 - Painless middleware chaining for Go.
...
- [negroni](https://github.com/urfave/negroni) ⭐ 7,524 - Idiomatic HTTP middleware for Golang.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,895 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,890 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,298 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,961 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,236 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 549 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
- [workflow](https://github.com/luno/workflow) ⭐ 164 - A tech stack agnostic Event Driven Workflow framework.
...
- [xpath](https://github.com/antchfx/xpath) ⭐ 718 - XPath package for Go.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,979 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,350 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 106 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,418 - Errcheck is a program for checking for unchecked errors in Go programs.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,121 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,189 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,454 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,705.
...
- [vacuum](https://github.com/daveshanley/vacuum) ⭐ 779 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 573 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,705 features to Vim/Neovim.
...
- [go-mode](https://github.com/dominikh/go-mode.el) ⭐ 1,418 - Go mode for GNU/Emacs.
...
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,060 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,283 - Visualize call graph of your Go program using dot format.
...
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,769 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,396 - Fast cross-platform HTTP benchmarking tool.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,127 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,063 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,219 - Build powerful pipelines in any programming language.
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,748 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 48,973 - Fork of Gogs, entirely community driven.
...
- [go-selfupdate](https://github.com/sanbornm/go-selfupdate) ⭐ 1,614 - Enable your Go applications to self update.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,972 - GVM provides an interface to manage Go versions.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,838 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,871 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 27,965 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,198 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,028 - Command line tool for building and deploying Go applications on Kubernetes
- [kool](https://github.com/kool-dev/kool) ⭐ 687 - Command line tool for managing Docker environments as an easy way.
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,725 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,598 - Container Cluster Manager from Google.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,520 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,858 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,290 - Pomerium is an identity-aware access proxy.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,098 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,713 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,004 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,066 - Reverse proxy and load balancer with support for multiple backends.
...
- [uTask](https://github.com/ovh/utask) ⭐ 1,280 - Automation engine that models and executes business processes declared in yaml.
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,278 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,373 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Chapar](https://github.com/chapar-rest/chapar) ⭐ 575 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,330 - Easily and securely send files or folders from one computer to another.
- [Documize](https://github.com/documize/community) ⭐ 2,235 - Modern wiki software that integrates data from SaaS tools.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,449 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,917 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
- [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 859 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
- [Gor](https://github.com/buger/gor) ⭐ 18,944 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,691 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,650 - Portal is a quick and easy command-line file transfer utility from any computer to another.
- [restic](https://github.com/restic/restic) ⭐ 28,914 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 696 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,375 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,718 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,278 - Proxy to simulate network and system conditions for automated tests.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,052 - A curated list of Go books.
...
- [gophers](https://github.com/egonelbre/gophers) ⭐ 3,649 - Free gophers.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 30,978
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,145
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,551
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,245 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,622 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,258 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,614 - Golang ebook intro how to build a web app with golang.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,851 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,527 - Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,716 - Examples of Golang compared to Node.js for learning.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,324 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,859 - Learn Go with test-driven development.
