...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 147,326 | 🐛 125 | 🌐 Go | 📅 2025-07-14
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 382,099 | 🐛 44 | 📅 2025-07-05
[![Slack Widget](https://img.shields.io/badge/join-us%20on%20slack-gray.svg?longCache=true\&logo=slack\&colorB=red)](https://gophers.slack.com/messages/awesome)
[![Netlify Status](https://api.netlify.com/api/v1/badges/83a6dcbe-0da6-433e-b586-f68109286bd5/deploy-status)](https://app.netlify.com/sites/awesome-go/deploys)
[![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/avelino/awesome-go/)
[![Last Commit](https://img.shields.io/github/last-commit/avelino/awesome-go)](https://github.com/avelino/awesome-go/commits/main) ⭐ 147,326 | 🐛 125 | 🌐 Go | 📅 2025-07-14
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 250,230 | 🐛 480 | 🌐 Python | 📅 2025-07-05.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 147,326 | 🐛 125 | 🌐 Go | 📅 2025-07-14 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 147,326 | 🐛 125 | 🌐 Go | 📅 2025-07-14; you rock!
...
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 265 | 🐛 0 | 🌐 Go | 📅 2025-07-14 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
...
* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 631 | 🐛 12 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
* [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,138 | 🐛 372 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,860 | 🐛 470 | 🌐 Go | 📅 2025-07-14 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 146,510 | 🐛 1,893 | 🌐 Go | 📅 2025-07-15 - Run large language models locally.
...
* [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,735 | 🐛 24 | 🌐 Go | 📅 2025-07-14 - A low-level library to play sound on multiple platforms.
...
* [authboss](https://github.com/volatiletech/authboss) ⭐ 3,994 | 🐛 41 | 🌐 Go | 📅 2025-06-26 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,870 | 🐛 39 | 🌐 Go | 📅 2025-07-10 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [go-jose](https://github.com/go-jose/go-jose) ⭐ 418 | 🐛 35 | 🌐 Go | 📅 2025-07-14 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,254 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
* [keto](https://github.com/ory/keto) ⭐ 5,065 | 🐛 56 | 🌐 Go | 📅 2025-07-14 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,608 | 🐛 33 | 🌐 Go | 📅 2025-07-14 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
* [openfga](https://github.com/openfga/openfga) ⭐ 3,862 | 🐛 129 | 🌐 Go | 📅 2025-07-15 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [scs](https://github.com/alexedwards/scs) ⭐ 2,365 | 🐛 31 | 🌐 Go | 📅 2025-07-08 - Session Manager for HTTP servers.
...
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 762 | 🐛 278 | 🌐 Go | 📅 2025-07-14 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,655 | 🐛 287 | 🌐 Go | 📅 2025-07-15 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 973 | 🐛 795 | 🌐 Go | 📅 2025-07-14 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,288 | 🐛 324 | 🌐 Go | 📅 2025-07-15 - Official Go implementation of the Ethereum protocol.
...
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,569 | 🐛 1,103 | 🌐 Go | 📅 2025-07-14 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,968 | 🐛 819 | 🌐 Go | 📅 2025-07-14 - A complete implementation of a Lightning Network node.
* [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,351 | 🐛 141 | 🌐 Go | 📅 2025-03-14 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,816 | 🐛 21 | 🌐 Go | 📅 2025-07-09 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
* [bot](https://github.com/go-telegram/bot) ⭐ 1,228 | 🐛 12 | 🌐 Go | 📅 2025-07-08 - Zero-dependencies Telegram Bot library with additional UI components
...
* [telego](https://github.com/mymmrac/telego) ⭐ 738 | 🐛 3 | 🌐 Go | 📅 2025-07-01 - Telegram Bot API library for Golang with full one-to-one API implementation.
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,204 | 🐛 168 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
...
* [air](https://github.com/cosmtrek/air) ⭐ 21,038 | 🐛 181 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [Task](https://github.com/go-task/task) ⭐ 13,139 | 🐛 393 | 🌐 Go | 📅 2025-07-14 - simple "Make" alternative.
...
* [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,849 | 🐛 11 | 🌐 Go | 📅 2024-10-26 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
...
* [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 505 | 🐛 15 | 🌐 Go | 📅 2025-07-09 - An interactive table component for bubbletea.
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,571 | 🐛 156 | 🌐 Go | 📅 2025-07-14 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 33,210 | 🐛 117 | 🌐 Go | 📅 2025-07-14 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,673 | 🐛 4 | 🌐 Go | 📅 2025-07-14 - Terminal JSON viewer & processor.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,384 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,823 | 🐛 673 | 🌐 Python | 📅 2025-07-03.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,290 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
...
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,257 | 🐛 87 | 🌐 Go | 📅 2025-07-11 - Declaratively define styles for color, format and layout in the terminal.
...
* [pterm](https://github.com/pterm/pterm) ⭐ 5,168 | 🐛 64 | 🌐 Go | 📅 2025-07-10 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,848 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,386 | 🐛 103 | 🌐 Go | 📅 2025-07-10.
...
* [termui](https://github.com/gizak/termui) ⭐ 13,386 | 🐛 103 | 🌐 Go | 📅 2025-07-10 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,621 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
* [uilive](https://github.com/gosuri/uilive) ⭐ 1,705 | 🐛 12 | 🌐 Go | 📅 2023-07-22 - Library for updating terminal output in real time.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 743 | 🐛 40 | 🌐 Go | 📅 2025-07-01 - Command argument completion generator for spf13/cobra.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,346 | 🐛 74 | 🌐 Go | 📅 2025-07-13 - Multi-shell multi-command argument completer.
...
* [cmdr](https://github.com/hedzr/cmdr) ⭐ 140 | 🐛 0 | 🌐 Go | 📅 2025-07-13 - A POSIX/GNU style, getopt-like command-line UI Go library.
* [cobra](https://github.com/spf13/cobra) ⭐ 41,113 | 🐛 320 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [elvish](https://github.com/elves/elvish) ⭐ 6,059 | 🐛 338 | 🌐 Go | 📅 2025-07-14 - An expressive programming language and a versatile interactive shell.
...
* [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,159 | 🐛 29 | 🌐 Go | 📅 2025-07-12 - Struct-based argument parsing in Go.
...
* [pflag](https://github.com/spf13/pflag) ⭐ 2,594 | 🐛 178 | 🌐 Go | 📅 2025-06-28 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,339 | 🐛 49 | 🌐 Go | 📅 2025-07-13 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,862 | 🐛 48 | 🌐 Go | 📅 2025-01-05 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
* [env](https://github.com/caarlos0/env) ⭐ 5,624 | 🐛 9 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,524 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [hedzr/store](https://github.com/hedzr/store) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2025-07-13 - Extensible, high-performance configuration management library, optimized for hierarchical data.
...
* [ini](https://github.com/go-ini/ini) ⭐ 3,512 | 🐛 64 | 🌐 Go | 📅 2024-05-01 - Go package to read and write INI files.
...
* [koanf](https://github.com/knadh/koanf) ⭐ 3,312 | 🐛 9 | 🌐 Go | 📅 2025-07-12 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [kong](https://github.com/alecthomas/kong) ⭐ 2,717 | 🐛 26 | 🌐 Go | 📅 2025-07-14 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,398 | 🐛 22 | 🌐 Go | 📅 2025-07-08 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,862 | 🐛 519 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
...
* [CDS](https://github.com/ovh/cds) ⭐ 4,733 | 🐛 151 | 🌐 Go | 📅 2025-07-14 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
* [drone](https://github.com/drone/drone) ⭐ 32,966 | 🐛 74 | 🌐 Go | 📅 2025-07-14 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 157 | 🐛 6 | 🌐 Go | 📅 2025-07-14 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,567 | 🐛 25 | 🌐 Go | 📅 2025-07-14 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,831 | 🐛 90 | 🌐 Rust | 📅 2025-07-10.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,240 | 🐛 348 | 🌐 Go | 📅 2025-07-14 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,410 | 🐛 528 | 🌐 Go | 📅 2025-07-14 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,139 | 🐛 139 | 🌐 Go | 📅 2025-07-14 - A high-performance ELT data integration framework with pluggable architecture.
...
* [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,431 | 🐛 3 | 🌐 Go | 📅 2025-06-01 - Go package implementing bitsets.
...
* [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,815 | 🐛 30 | 🌐 Go | 📅 2024-05-16 - Collection of useful, performant, and thread-safe data structures.
* [gods](https://github.com/emirpasic/gods) ⭐ 17,019 | 🐛 68 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [gota](https://github.com/kniren/gota) ⭐ 3,205 | 🐛 81 | 🌐 Go | 📅 2023-08-09 - Implementation of dataframes, series, and data wrangling methods for Go.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,825 | 🐛 79 | 🌐 TypeScript | 📅 2025-07-14 - Distributed, Fault-tolerant task queue.
...
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,544 | 🐛 12 | 🌐 Go | 📅 2025-06-10 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,453 | 🐛 296 | 🌐 Go | 📅 2025-07-07 - Modern text indexing library for go.
...
* [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 422 | 🐛 3 | 🌐 Go | 📅 2025-05-19 - Implementation to calculate levenshtein distance in Go.
...
* [BigCache](https://github.com/allegro/bigcache) ⭐ 7,877 | 🐛 99 | 🌐 Go | 📅 2025-05-05 - Efficient key/value cache for gigabytes of data.
...
* [EchoVault](https://github.com/EchoVault/EchoVault) ⭐ 495 | 🐛 20 | 🌐 Go | 📅 2025-04-24 - Embeddable Distributed in-memory data store compatible with Redis clients.
...
* [gocache](https://github.com/eko/gocache) ⭐ 2,698 | 🐛 40 | 🌐 Go | 📅 2025-05-25 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,180 | 🐛 1 | 🌐 Go | 📅 2025-07-10 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,216 | 🐛 5 | 🌐 Go | 📅 2025-07-10 -  A high performance memory-bound Go cache.
...
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,765 | 🐛 28 | 🌐 Go | 📅 2025-07-10 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,909 | 🐛 45 | 🌐 Go | 📅 2025-07-14 - An embedded key/value database for Go.
* [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
* [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,738 | 🐛 32 | 🌐 Go | 📅 2024-09-10 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
* [clover](https://github.com/ostafen/clover) ⭐ 763 | 🐛 21 | 🌐 Go | 📅 2025-02-12 - A lightweight document-oriented NoSQL database written in pure Golang.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,084 | 🐛 7,409 | 🌐 Go | 📅 2025-07-15 - Scalable, Geo-Replicated, Transactional Datastore.
...
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,008 | 🐛 39 | 🌐 Go | 📅 2025-07-14 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,882 | 🐛 436 | 🌐 Go | 📅 2025-07-15 - Dolt – It's Git for Data.
...
* [godis](https://github.com/hdt3213/godis) ⭐ 3,723 | 🐛 16 | 🌐 Go | 📅 2025-07-05 - A Golang implemented high-performance Redis server and cluster.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,284 | 🐛 109 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,880 | 🐛 363 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 8,777 | 🐛 137 | 🌐 Go | 📅 2025-05-30 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,329 | 🐛 2,118 | 🌐 Rust | 📅 2025-07-15 - Scalable datastore for metrics, events, and real-time analytics.
...
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,963 | 🐛 700 | 🌐 Go | 📅 2025-07-15 - Milvus is a vector database for embedding management, analytics and search.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,381 | 🐛 296 | 🌐 Go | 📅 2025-07-15 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,465 | 🐛 692 | 🌐 Go | 📅 2025-07-14 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,910 | 🐛 2 | 🌐 Go | 📅 2025-07-14 - Redis re-implemented with SQLite.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,752 | 🐛 81 | 🌐 Go | 📅 2025-07-15 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,725 | 🐛 5,170 | 🌐 Go | 📅 2025-07-15 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,530 | 🐛 786 | 🌐 Go | 📅 2025-07-14 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 7,032 | 🐛 219 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,740 | 🐛 120 | 🌐 Go | 📅 2025-07-15 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,130 | 🐛 29 | 🌐 Go | 📅 2025-07-14 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,736 | 🐛 97 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,999 | 🐛 437 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,328 | 🐛 18 | 🌐 Go | 📅 2025-07-14 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,349 | 🐛 91 | 🌐 Go | 📅 2025-04-17 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
* [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,368 | 🐛 57 | 🌐 Go | 📅 2025-06-06 - HTTP proxy for ClickHouse database.
* [clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) ⭐ 498 | 🐛 26 | 🌐 Go | 📅 2025-06-27 - Collects small inserts and sends big requests to ClickHouse servers.
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,788 | 🐛 151 | 🌐 Go | 📅 2025-07-10 - Go toolset to handle MySQL protocol and replication.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,844 | 🐛 883 | 🌐 Go | 📅 2025-07-13 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
* [wescale](https://github.com/wesql/wescale) ⭐ 304 | 🐛 20 | 🌐 Go | 📅 2025-03-07 - WeScale is a database proxy designed to enhance the scalability, performance, security, and resilience of your applications.
...
* [gendry](https://github.com/didi/gendry) ⭐ 1,635 | 🐛 19 | 🌐 Go | 📅 2025-03-12 - Non-invasive SQL builder and powerful data binder.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,274 | 🐛 42 | 🌐 Go | 📅 2025-07-03 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,528 | 🐛 614 | 🌐 Go | 📅 2025-07-15 - Generate type-safe code from SQL.
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,506 | 🐛 91 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,934 | 🐛 62 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,571 | 🐛 203 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 740 | 🐛 5 | 🌐 Go | 📅 2025-07-14 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,145 | 🐛 230 | 🌐 Go | 📅 2025-07-12 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,145 | 🐛 230 | 🌐 Go | 📅 2025-07-12 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,445 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
* [pq](https://github.com/lib/pq) ⭐ 9,546 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
...
* [surrealdb.go](https://github.com/surrealdb/surrealdb.go) ⭐ 278 | 🐛 33 | 🌐 Go | 📅 2025-07-14 - SurrealDB Driver for Go.
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 167 | 🐛 244 | 🌐 Go | 📅 2025-07-14 - native and database/sql driver YDB (Yandex Database)

### NoSQL Database Drivers

* [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) ⭐ 450 | 🐛 38 | 🌐 Go | 📅 2025-07-12 - Aerospike client in Go language.
...
* [gocb](https://github.com/couchbase/gocb) ⭐ 373 | 🐛 4 | 🌐 Go | 📅 2025-07-10 - Official Couchbase Go SDK.
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,392 | 🐛 12 | 🌐 Go | 📅 2025-07-14 - Official MongoDB driver for the Go language.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,082 | 🐛 101 | 🌐 Go | 📅 2025-07-11 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,721 | 🐛 14 | 🌐 Go | 📅 2025-07-14 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
* [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,100 | 🐛 97 | 🌐 Go | 📅 2025-07-15 - ClickHouse SQL client for Go with a `database/sql` compatibility.
* [effdsl](https://github.com/sdqri/effdsl) ⭐ 33 | 🐛 3 | 🌐 Go | 📅 2025-06-29 - Elasticsearch query builder for Go.
* [elastic](https://github.com/olivere/elastic) ⭐ 7,475 | 🐛 115 | 🌐 Go | 📅 2024-08-08 - Elasticsearch client for Go.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,914 | 🐛 82 | 🌐 Go | 📅 2025-07-01 - Official Elasticsearch client for Go.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1,007 | 🐛 20 | 🌐 Go | 📅 2025-07-14 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,104 | 🐛 1 | 🌐 Go | 📅 2025-07-12 - A simple, semantic and developer-friendly time package for golang.
...
* [bedrock](https://github.com/z5labs/bedrock) ⭐ 13 | 🐛 1 | 🌐 Go | 📅 2025-07-12 - Provides a minimal, modular and composable foundation for quickly developing services and more use case specific frameworks in Go.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,663 | 🐛 35 | 🌐 Go | 📅 2025-07-14 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [gleam](https://github.com/chrislusf/gleam) ⭐ 3,528 | 🐛 40 | 🌐 Go | 📅 2025-04-20 - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
...
* [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,328 | 🐛 25 | 🌐 Go | 📅 2025-07-03 - A Go framework for the API or Microservice with handy scaffolding tools.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,160 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,391 | 🐛 20 | 🌐 Go | 📅 2025-07-08 - A distributed systems development framework.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,419 | 🐛 352 | 🌐 Go | 📅 2025-07-14 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 22,013 | 🐛 138 | 🌐 Go | 📅 2025-07-14 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,058 | 🐛 85 | 🌐 Go | 📅 2025-07-12 - A cloud native Kubernetes Global Balancer.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,530 | 🐛 57 | 🌐 Go | 📅 2025-07-15 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,590 | 🐛 122 | 🌐 Go | 📅 2025-07-14 - A modular-designed and easy-to-use microservices framework in Go.
* [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,607 | 🐛 43 | 🌐 Go | 📅 2024-04-19 - Lightweight, fault-tolerant message streams for NATS.
* [lura](https://github.com/luraproject/lura) ⭐ 6,581 | 🐛 8 | 🌐 Go | 📅 2025-06-25 - Ultra performant API Gateway framework with middlewares.
* [micro](https://github.com/micro/micro) ⭐ 12,269 | 🐛 7 | 🌐 Go | 📅 2025-07-06 - A distributed systems runtime for the cloud and beyond.
...
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,493 | 🐛 462 | 🌐 Go | 📅 2025-07-14 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 620 | 🐛 55 | 🌐 Go | 📅 2025-07-10 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,689 | 🐛 44 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/etcd-io/raft) ⭐ 877 | 🐛 70 | 🌐 Go | 📅 2025-07-10 - Go implementation of the Raft consensus protocol, by CoreOS.
* [rain](https://github.com/cenkalti/rain) ⭐ 1,048 | 🐛 2 | 🌐 Go | 📅 2025-07-15 - BitTorrent client and library.
* [redis-lock](https://github.com/bsm/redislock) ⭐ 1,635 | 🐛 4 | 🌐 Go | 📅 2025-06-09 - Simplified distributed locking implementation using Redis.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 381 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,360 | 🐛 358 | 🌐 C++ | 📅 2025-06-26).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,190 | 🐛 31 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 666 | 🐛 197 | 🌐 Go | 📅 2025-07-10 - Durable execution system for making code fault-tolerant and simple.
...
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,401 | 🐛 32 | 🌐 Go | 📅 2025-07-11 - A Go library for email verification without sending any emails.
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,038 | 🐛 4 | 🌐 Go | 📅 2025-07-11 - A simple Go library for sending mails in Go.
...
* [go-premailer](https://github.com/vanng822/go-premailer) ⭐ 171 | 🐛 3 | 🌐 Go | 📅 2025-07-10 - Inline styling for HTML mail in Go.
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,052 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,357 | 🐛 3 | 🌐 Go | 📅 2025-07-06 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,082 | 🐛 150 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 7,002 | 🐛 46 | 🌐 Go | 📅 2025-07-05 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,677 | 🐛 182 | 🌐 Go | 📅 2025-07-15 - PHP embedded in Go, with a `net/http` handler.
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,300 | 🐛 50 | 🌐 Go | 📅 2025-06-05 - Port of the Lua 5.2 VM to pure Go.
...
* [goja](https://github.com/dop251/goja) ⭐ 6,283 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
...
* [metacall](https://github.com/metacall/core) ⭐ 1,667 | 🐛 51 | 🌐 C | 📅 2025-07-10 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
* [starlark-go](https://github.com/google/starlark-go) ⭐ 2,498 | 🐛 65 | 🌐 Go | 📅 2025-07-01 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
* [starlet](https://github.com/1set/starlet) ⭐ 31 | 🐛 2 | 🌐 Go | 📅 2025-04-15 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,498 | 🐛 65 | 🌐 Go | 📅 2025-07-01 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
* [tengo](https://github.com/d5/tengo) ⭐ 3,669 | 🐛 84 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,594 | 🐛 5 | 🌐 Go | 📅 2025-07-15 - The Wa Programming Language embedded in Go.
...
* [eris](https://github.com/rotisserie/eris) ⭐ 1,678 | 🐛 5 | 🌐 Go | 📅 2025-04-03 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
* [oops](https://github.com/samber/oops) ⭐ 708 | 🐛 15 | 🌐 Go | 📅 2025-07-06 - Error handling with context, stack trace and source fragments.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 99 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 72,034 | 🐛 294 | 🌐 Go | 📅 2025-07-14).
...
* [ach](https://github.com/moov-io/ach) ⭐ 494 | 🐛 14 | 🌐 Go | 📅 2025-07-11 - A reader, writer, and validator for Automated Clearing House (ACH) files.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,382 | 🐛 134 | 🌐 Go | 📅 2025-07-15 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
* [currency](https://github.com/bojanz/currency) ⭐ 594 | 🐛 5 | 🌐 Go | 📅 2025-03-28 - Handles currency amounts, provides currency information and formatting.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,838 | 🐛 144 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
* [decimal](https://github.com/govalues/decimal) ⭐ 175 | 🐛 6 | 🌐 Go | 📅 2025-01-18 - Immutable decimal numbers with panic-free arithmetic.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,323 | 🐛 37 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
...
* [conform](https://github.com/leebenson/conform) ⭐ 325 | 🐛 5 | 🌐 Go | 📅 2025-07-09 - Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags.
* [form](https://github.com/go-playground/form) ⭐ 848 | 🐛 15 | 🌐 Go | 📅 2025-03-21 - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
* [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,130 | 🐛 28 | 🌐 Go | 📅 2025-04-14 - CSRF protection for Go web applications & services.
...
* [go-functional](https://github.com/BooleanCat/go-functional) ⭐ 508 | 🐛 1 | 🌐 Go | 📅 2025-06-13 - Functional programming in Go using generics
...
* [mo](https://github.com/samber/mo) ⭐ 3,023 | 🐛 23 | 🌐 Go | 📅 2025-07-06 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,227 | 🐛 295 | 🌐 Go | 📅 2025-07-14 - dead simple 2D game engine in Go.
...
* [g3n](https://github.com/g3n/engine) ⭐ 2,969 | 🐛 37 | 🌐 Go | 📅 2025-02-08 - Go 3D Game Engine.
...
* [Leaf](https://github.com/name5566/leaf) ⭐ 5,425 | 🐛 24 | 🌐 Go | 📅 2024-05-23 - Lightweight game server framework.
* [nano](https://github.com/lonng/nano) ⭐ 3,048 | 🐛 30 | 🌐 Go | 📅 2025-03-30 - Lightweight, facility, high performance golang based game server framework.
* [Oak](https://github.com/oakmound/oak) ⭐ 1,633 | 🐛 14 | 🌐 Go | 📅 2025-02-16 - Pure Go game engine.
* [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,574 | 🐛 59 | 🌐 Go | 📅 2025-07-14 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
* [Pixel](https://github.com/gopxl/pixel) ⭐ 336 | 🐛 33 | 🌐 Go | 📅 2025-03-07 - Hand-crafted 2D game library in Go.
...
* [go-enum](https://github.com/abice/go-enum) ⭐ 840 | 🐛 17 | 🌐 Go | 📅 2025-06-22 - Code generation for enums from code comments.
...
* [goverter](https://github.com/jmattheis/goverter) ⭐ 720 | 🐛 17 | 🌐 Go | 📅 2025-07-06 - Generate converters by defining an interface.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,317 | 🐛 692 | 🌐 Go | 📅 2025-07-11 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,377 | 🐛 151 | 🌐 Go | 📅 2025-06-17 - Geolocation DB with spatial index and realtime geofencing.
...
* [go2hx](https://github.com/go2hx/go2hx) ⭐ 136 | 🐛 32 | 🌐 Haxe | 📅 2025-07-14 - Compiler from Go to Haxe to Javascript/C++/Java/C#.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,824 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,996 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [pond](https://github.com/alitto/pond) ⭐ 1,889 | 🐛 4 | 🌐 Go | 📅 2025-07-13 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,726 | 🐛 42 | 🌐 Go | 📅 2025-07-08 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 424 | 🐛 19 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,856 | 🐛 1,167 | 🌐 C++ | 📅 2025-07-11 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,686 | 🐛 17 | 🌐 Lua | 📅 2025-07-14.
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,041 | 🐛 229 | 🌐 Go | 📅 2025-07-15 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,755 | 🐛 747 | 🌐 Go | 📅 2025-07-12 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [qt](https://github.com/therecipe/qt) ⭐ 10,693 | 🐛 373 | 🌐 Go | 📅 2024-03-04 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,256 | 🐛 137 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
* [systray](https://github.com/getlantern/systray) ⭐ 3,510 | 🐛 109 | 🌐 Go | 📅 2024-07-03 - Cross platform Go library to place an icon and menu in the notification area.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,600 | 🐛 218 | 🌐 Go | 📅 2025-07-14 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [sysinfo](https://github.com/zcalusic/sysinfo) ⭐ 550 | 🐛 16 | 🌐 Go | 📅 2024-12-09 - A pure Go library providing Linux OS / kernel / hardware system information.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 733 | 🐛 6 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,145 | 🐛 344 | 🌐 Go | 📅 2025-07-11 - Go package for computer vision using OpenCV 3.3+.
...
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,842 | 🐛 32 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
* [gridder](https://github.com/shomali11/gridder) ⭐ 80 | 🐛 0 | 🌐 Go | 📅 2021-09-30 - A Grid based 2D Graphics library.
* [image2ascii](https://github.com/qeesung/image2ascii) ⭐ 924 | 🐛 12 | 🌐 Go | 📅 2022-08-29 - Convert image to ASCII.
...
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,529 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
* [imagor](https://github.com/cshum/imagor) ⭐ 3,685 | 🐛 38 | 🌐 Go | 📅 2025-07-14 - Fast, secure image processing server and Go library, using libvips.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,614 | 🐛 61 | 🌐 Go | 📅 2025-07-14 - Lightweight data stream processing engine for IoT edge.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,220 | 🐛 103 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,199 | 🐛 8 | 🌐 Go | 📅 2025-07-10 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
* [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 | 🐛 39 | 🌐 Go | 📅 2019-11-04 - Lightweight stream processing engine for IoT.
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,356 | 🐛 30 | 🌐 Go | 📅 2025-07-11 - Kubernetes native IoT development framework.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,366 | 🐛 18 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,046 | 🐛 90 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [glog](https://github.com/golang/glog) ⭐ 3,602 | 🐛 2 | 🌐 Go | 📅 2025-04-29 - Leveled execution logs for Go.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 596 | 🐛 1 | 🌐 Go | 📅 2025-05-29 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,374 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,374 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,374 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,374 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,160 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,354 | 🐛 165 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,602 | 🐛 140 | 🌐 Go | 📅 2025-04-18, etc).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,164 | 🐛 99 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [slog-multi](https://github.com/samber/slog-multi) ⭐ 500 | 🐛 1 | 🌐 Go | 📅 2025-06-24 - Chain of slog.Handler (pipeline, fanout...).
* [slogor](https://gitlab.com/greyxor/slogor) - A colorful slog handler.
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,271 | 🐛 65 | 🌐 Go | 📅 2024-04-06 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
* [zap](https://github.com/uber-go/zap) ⭐ 23,354 | 🐛 165 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,602 | 🐛 140 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 829 | 🐛 2 | 🌐 Go | 📅 2025-07-04 - An accelerated Machine Learning framework for Go.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,807 | 🐛 111 | 🌐 Go | 📅 2024-08-12 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,908 | 🐛 33 | 🌐 Go | 📅 2025-03-24 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,893 | 🐛 60 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,811 | 🐛 18 | 🌐 Go | 📅 2025-07-08 - Go RabbitMQ Client Library.
* [APNs2](https://github.com/sideshow/apns2) ⭐ 3,096 | 🐛 33 | 🌐 Go | 📅 2024-10-25 - HTTP/2 Apple Push Notification provider for Go - Send push notifications to iOS, tvOS, Safari and OSX apps.
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,586 | 🐛 250 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,121 | 🐛 22 | 🌐 Go | 📅 2025-07-13 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,944 | 🐛 284 | 🌐 HTML | 📅 2025-07-14 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [emitter](https://github.com/olebedev/emitter) ⭐ 523 | 🐛 4 | 🌐 Go | 📅 2023-04-11 - Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,428 | 🐛 58 | 🌐 Go | 📅 2025-07-05 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,096 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,780 | 🐛 244 | 🌐 Go | 📅 2025-06-30 - Asynchronous task queue/job queue based on distributed message passing.
...
* [Mercure](https://github.com/dunglas/mercure) ⭐ 4,986 | 🐛 26 | 🌐 Go | 📅 2025-06-27 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,019 | 🐛 169 | 🌐 Go | 📅 2025-07-09 - Go client for the NATS
  messaging system.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,101 | 🐛 57 | 🌐 Go | 📅 2025-07-13 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,659 | 🐛 123 | 🌐 Go | 📅 2025-07-03 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,621 | 🐛 26 | 🌐 Go | 📅 2025-05-21 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/xuri/excelize) ⭐ 19,371 | 🐛 126 | 🌐 Go | 📅 2025-07-10 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [do](https://github.com/samber/do) ⭐ 2,193 | 🐛 45 | 🌐 Go | 📅 2025-07-05 - A dependency injection framework based on Generics.
...
* [google/wire](https://github.com/google/wire) ⭐ 13,945 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,857 | 🐛 24 | 🌐 Go | 📅 2025-07-10 - Allows users to spin up a quick Go project using a popular framework.
* [go-module](https://github.com/octomation/go-module) ⭐ 35 | 🐛 29 | 🌐 Shell | 📅 2025-07-04 - Template for a typical module written on Go.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,077 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,077 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
...
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,295 | 🐛 0 | 🌐 Go | 📅 2025-07-08 - Nunu is a scaffolding tool for building Go applications.
...
* [gobeam/Stringy](https://github.com/gobeam/Stringy) ⭐ 249 | 🐛 2 | 🌐 Go | 📅 2025-05-19 - String manipulation library to convert string to camel case, snake case, kebab case / slugify etc.
...
* [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,141 | 🐛 12 | 🌐 Go | 📅 2025-05-29 - cross-platform, cli app to perform various operations on string.
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,263 | 🐛 6 | 🌐 Go | 📅 2025-06-25 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,688 | 🐛 225 | 🌐 Go | 📅 2025-07-11 - Automated service health dashboard.
...
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,998 | 🐛 13 | 🌐 Go | 📅 2025-06-26 - Random data generator written in go.
...
* [whatlanggo](https://github.com/abadojack/whatlanggo) ⭐ 659 | 🐛 13 | 🌐 Go | 📅 2023-03-28 - Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc).
...
* [govader](https://github.com/jonreiter/govader) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2025-04-29 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,761 | 🐛 55 | 🌐 Python | 📅 2024-03-16.
...
* [kagome](https://github.com/ikawaha/kagome) ⭐ 883 | 🐛 4 | 🌐 Go | 📅 2025-06-18 - JP morphological analyzer written in pure Go.
...
* [slug](https://github.com/gosimple/slug) ⭐ 1,264 | 🐛 10 | 🌐 Go | 📅 2024-12-23 - URL-friendly slugify with multiple languages support.
* [Slugify](https://github.com/avelino/slugify) ⭐ 34 | 🐛 0 | 🌐 Go | 📅 2018-05-01 - Go slugify application that handles string.

### Tokenizers

* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,542 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,248 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [go-pinyin](https://github.com/mozillazg/go-pinyin) ⭐ 1,693 | 🐛 18 | 🌐 Go | 📅 2023-07-12 - CN Hanzi to Hanyu Pinyin converter.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 77 | 🐛 0 | 🌐 Go | 📅 2025-07-14 - Package bart provides a fast routing table algorithm.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 11,030 | 🐛 442 | 🌐 Go | 📅 2025-07-07 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [dns](https://github.com/miekg/dns) ⭐ 8,420 | 🐛 9 | 🌐 Go | 📅 2025-07-09 - Go library for working with DNS.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,734 | 🐛 99 | 🌐 Go | 📅 2025-07-11 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [fortio](https://github.com/fortio/fortio) ⭐ 3,558 | 🐛 82 | 🌐 Go | 📅 2025-07-11 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
* [gmqtt](https://github.com/DrmagicE/gmqtt) ⭐ 1,009 | 🐛 1 | 🌐 Go | 📅 2025-06-24 - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,646 | 🐛 1 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [go-powerdns](https://github.com/joeig/go-powerdns) ⭐ 97 | 🐛 1 | 🌐 Go | 📅 2025-07-14 - PowerDNS API bindings for Golang.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,825 | 🐛 224 | 🌐 Go | 📅 2025-07-13 - BGP implemented in the Go Programming Language.
...
* [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,401 | 🐛 85 | 🌐 Go | 📅 2025-07-10 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
* [gosnmp](https://github.com/soniah/gosnmp) ⭐ 1,200 | 🐛 60 | 🌐 Go | 📅 2025-07-09 - Native Go library for performing SNMP actions.
...
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,181 | 🐛 131 | 🌐 Go | 📅 2025-07-11 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,275 | 🐛 40 | 🌐 Go | 📅 2025-07-14 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,542 | 🐛 1 | 🌐 Go | 📅 2025-07-02 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,139 | 🐛 2 | 🌐 Go | 📅 2025-07-15 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,819 | 🐛 188 | 🌐 Go | 📅 2025-07-14 - An implementation of the QUIC protocol in pure Go.
...
* [sftp](https://github.com/pkg/sftp) ⭐ 1,589 | 🐛 47 | 🌐 Go | 📅 2025-07-13 - Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,990 | 🐛 15 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [water](https://github.com/songgao/water) ⭐ 2,054 | 🐛 30 | 🌐 Go | 📅 2024-07-30 - Simple TUN/TAP library.
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,059 | 🐛 100 | 🌐 Go | 📅 2025-07-11 - A pure Go implementation of the WebRTC API.
...
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 285 | 🐛 6 | 🌐 Go | 📅 2025-07-14 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [req](https://github.com/imroc/req) ⭐ 4,542 | 🐛 76 | 🌐 Go | 📅 2025-06-27 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,046 | 🐛 38 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
* [rq](https://github.com/ddo/rq) ⭐ 53 | 🐛 1 | 🌐 Go | 📅 2019-08-28 - A nicer interface for golang stdlib HTTP client.
* [sling](https://github.com/dghubble/sling) ⭐ 1,706 | 🐛 2 | 🌐 Go | 📅 2025-05-05 - Sling is a Go HTTP client library for creating and sending API requests.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,362 | 🐛 19 | 🌐 Go | 📅 2025-07-14 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,257 | 🐛 26 | 🌐 Go | 📅 2025-07-11 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,356 | 🐛 586 | 🌐 Go | 📅 2025-07-11 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,517 | 🐛 471 | 🌐 Go | 📅 2025-07-07 - The fantastic ORM library for Golang, aims to be developer friendly.
* [gormt](https://github.com/xxjwxc/gormt) ⭐ 2,407 | 🐛 57 | 🌐 Go | 📅 2025-06-24 - Mysql database to golang gorm struct.
...
* [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,306 | 🐛 115 | 🌐 Go | 📅 2025-07-14 - Prisma Client Go, Typesafe database access for Go.
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,896 | 🐛 104 | 🌐 Go | 📅 2025-06-27 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
* [gup](https://github.com/nao1215/gup) ⭐ 420 | 🐛 6 | 🌐 Go | 📅 2025-07-09 - Update binaries installed by "go install".
...
* [syft](https://github.com/anchore/syft) ⭐ 7,337 | 🐛 469 | 🌐 Go | 📅 2025-07-14 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,585 | 🐛 317 | 🌐 Go | 📅 2025-07-14 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 172 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,087 | 🐛 337 | 🌐 C++ | 📅 2025-07-14 - No instrumentation tracing for Golang applications via eBPF.
* [profile](https://github.com/pkg/profile) ⭐ 2,033 | 🐛 11 | 🌐 Go | 📅 2022-10-20 - Simple profiling support package for Go.
* [statsviz](https://github.com/arl/statsviz) ⭐ 3,314 | 🐛 11 | 🌐 Go | 📅 2025-06-17 - Live visualization of your Go application runtime statistics.
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,501 | 🐛 47 | 🌐 Go | 📅 2025-07-10 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,081 | 🐛 237 | 🌐 Go | 📅 2025-04-01 - Implementation of GraphQL for Go.
...
* [gonum/plot](https://github.com/gonum/plot) ⭐ 2,878 | 🐛 90 | 🌐 Go | 📅 2025-03-27 - gonum/plot provides an API for building and drawing plots in Go.
...
* [acra](https://github.com/cossacklabs/acra) ⭐ 1,408 | 🐛 13 | 🌐 Go | 📅 2025-04-17 - Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system.
* [age](https://github.com/FiloSottile/age) ⭐ 19,234 | 🐛 43 | 🌐 Go | 📅 2025-07-14 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,274 | 🐛 1 | 🌐 Go | 📅 2025-07-13 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [booster](https://github.com/anatol/booster) ⭐ 577 | 🐛 72 | 🌐 Go | 📅 2025-07-12 - Fast initramfs generator with full-disk encryption support.
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,530 | 🐛 28 | 🌐 Go | 📅 2025-07-13 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,754 | 🐛 94 | 🌐 Go | 📅 2025-07-13 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,720 | 🐛 158 | 🌐 Go | 📅 2025-07-13 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 896 | 🐛 23 | 🌐 Go | 📅 2025-07-14 - Small, safe, and easy CBOR encoding and decoding library.
* [colfer](https://github.com/pascaldekloe/colfer) ⭐ 749 | 🐛 10 | 🌐 Java | 📅 2024-08-07 - Code generation for the Colfer binary format.
* [csvutil](https://github.com/jszwec/csvutil) ⭐ 996 | 🐛 1 | 🌐 Go | 📅 2025-03-15 - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,979 | 🐛 115 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,480 | 🐛 222 | 🌐 Go | 📅 2025-07-15 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
* [Clace](https://github.com/claceio/clace) ⭐ 638 | 🐛 2 | 🌐 Go | 📅 2025-07-14 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,836 | 🐛 22 | 🌐 Go | 📅 2025-07-15 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,838 | 🐛 317 | 🌐 Go | 📅 2025-07-14 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,607 | 🐛 48 | 🌐 Go | 📅 2025-07-14 - Fider is an open platform to collect and organize customer feedback.
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,506 | 🐛 5 | 🌐 Go | 📅 2025-06-23 - Flagr is an open-source feature flagging and A/B testing service.
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,458 | 🐛 49 | 🌐 Go | 📅 2025-07-14 - A self contained feature flag solution written in Go and Vue.js
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,688 | 🐛 22 | 🌐 Go | 📅 2025-07-14 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [minio](https://github.com/minio/minio) ⭐ 53,792 | 🐛 54 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 49,150 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,190 | 🐛 82 | 🌐 Go | 📅 2025-07-07 - High-performance PHP application server, load-balancer and process manager.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,689 | 🐛 112 | 🌐 Go | 📅 2025-07-14 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,037 | 🐛 46 | 🌐 Go | 📅 2025-06-30 - HTTP reverse proxy cache and time series accelerator.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,209 | 🐛 15 | 🌐 Go | 📅 2025-07-14 - Make SSH apps, just like that!
...
* [jet](https://github.com/CloudyKit/jet) ⭐ 1,343 | 🐛 21 | 🌐 Go | 📅 2025-03-23 - Jet template engine.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,481 | 🐛 70 | 🌐 Go | 📅 2025-07-12 - A HTML templating language that has great developer tooling.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-07-14 - HTTP client testing framework.
...
* [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,365 | 🐛 167 | 🌐 Go | 📅 2024-07-30 - BDD-style framework with web UI and live reload.
* [gocrest](https://github.com/corbym/gocrest) ⭐ 106 | 🐛 2 | 🌐 Go | 📅 2024-09-06 - Composable hamcrest-like matchers for Go assertions.
* [godog](https://github.com/cucumber/godog) ⭐ 2,461 | 🐛 83 | 🌐 Go | 📅 2025-07-07 - Cucumber BDD framework for Go.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,289 | 🐛 242 | 🌐 Go | 📅 2025-07-14 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,189 | 🐛 141 | 🌐 Go | 📅 2025-07-09 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
* [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,165 | 🐛 16 | 🌐 Go | 📅 2025-07-14 - A helper for Rails' like test fixtures to test database applications.
* [Testify](https://github.com/stretchr/testify) ⭐ 24,900 | 🐛 371 | 🌐 Go | 📅 2025-07-01 - Sacred extension to the standard go testing package.
...
* [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,054 | 🐛 28 | 🌐 Go | 📅 2025-07-14 - Tool for generating self-contained mock objects.
...
* [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,397 | 🐛 41 | 🌐 Go | 📅 2024-09-11 - Mock SQL driver for testing database interactions.
...
* [gock](https://github.com/h2non/gock) ⭐ 2,182 | 🐛 47 | 🌐 Go | 📅 2024-09-24 - Versatile HTTP mocking made easy.
...
* [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,423 | 🐛 34 | 🌐 Go | 📅 2025-06-18 - HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI.
...
* [mockery](https://github.com/vektra/mockery) ⭐ 6,691 | 🐛 41 | 🌐 Go | 📅 2025-07-14 - Tool to generate Go interfaces.
...
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 499 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,145 | 🐛 230 | 🌐 Go | 📅 2025-07-12.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,021 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,793 | 🐛 54 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
* [rod](https://github.com/go-rod/rod) ⭐ 6,075 | 🐛 186 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,831 | 🐛 33 | 🌐 Go | 📅 2025-05-10 - Go library for the TOML format with query support and handy cli tools.
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,187 | 🐛 9 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,757 | 🐛 19 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,271 | 🐛 7 | 🌐 Go | 📅 2025-07-08 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
* [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,717 | 🐛 54 | 🌐 Go | 📅 2025-05-27 - Parse RSS and Atom feeds in Go.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,863 | 🐛 103 | 🌐 Go | 📅 2025-07-07 - Shell parser and formatter.
* [tokenizer](https://github.com/bzick/tokenizer) ⭐ 128 | 🐛 5 | 🌐 Go | 📅 2025-02-13 - Parse any string, slice or infinite buffer to any tokens.
* [vdf](https://github.com/andygrunwald/vdf) ⭐ 57 | 🐛 4 | 🌐 Go | 📅 2025-07-04 - A Lexer and Parser for Valves Data Format (known as vdf) written in Go.
...
* [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,443 | 🐛 26 | 🌐 Go | 📅 2025-04-04 - HTML Sanitizer.
* [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 | 🐛 1 | 🌐 Go | 📅 2025-06-01 - A sanitization-based swear filter for Go.

### Scrapers

* [colly](https://github.com/asciimoo/colly) ⭐ 24,437 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,594 | 🐛 3 | 🌐 Go | 📅 2025-07-11 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,151 | 🐛 81 | 🌐 Go | 📅 2025-07-14 - The official AWS SDK for the Go programming language.
...
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,469 | 🐛 187 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,163 | 🐛 210 | 🌐 Go | 📅 2025-07-12 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [go-salesforce](https://github.com/k-capehart/go-salesforce) ⭐ 44 | 🐛 7 | 🌐 Go | 📅 2025-07-02 - Go client library for interacting with the [Salesforce REST API](https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_list.htm).
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,291 | 🐛 18 | 🌐 Go | 📅 2025-07-13 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,289 | 🐛 383 | 🌐 Go | 📅 2025-07-15 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,740 | 🐛 22 | 🌐 Go | 📅 2025-07-10 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 739 | 🐛 1 | 🌐 Go | 📅 2025-07-11 - Wrapper for PayPal payment API.
...
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,348 | 🐛 9 | 🌐 Go | 📅 2025-07-14 - Go client for the Stripe API.
...
* [bed](https://github.com/itchyny/bed) ⭐ 1,306 | 🐛 1 | 🌐 Go | 📅 2024-12-01 - A Vim-like binary editor written in Go.
...
* [boilr](https://github.com/tmrts/boilr) ⭐ 1,737 | 🐛 44 | 🌐 Go | 📅 2023-03-07 - Blazingly fast CLI tool for creating projects from boilerplate templates.
* [changie](https://github.com/miniscruff/changie) ⭐ 778 | 🐛 5 | 🌐 Go | 📅 2025-07-12 - Automated changelog tool for preparing releases with lots of customization options.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 381 | 🐛 38 | 🌐 Go | 📅 2025-07-15 - Cross Platform tool to validate configuration files.
...
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,473 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,397 | 🐛 169 | 🌐 Go | 📅 2025-07-14 - A tool for exploring each layer in a Docker image.
...
* [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,255 | 🐛 4 | 🌐 Go | 📅 2025-07-03 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
* [filetype](https://github.com/h2non/filetype) ⭐ 2,211 | 🐛 47 | 🌐 Go | 📅 2025-06-27 - Small package to infer the file type checking the magic numbers signature.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 72,034 | 🐛 294 | 🌐 Go | 📅 2025-07-14 - Command-line fuzzy finder written in Go.
...
* [go-funk](https://github.com/thoas/go-funk) ⭐ 4,913 | 🐛 8 | 🌐 Go | 📅 2024-07-24 - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,900 | 🐛 22 | 🌐 Go | 📅 2025-07-15 - Deliver Go binaries as fast and easily as possible.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,116 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - A comprehensive, efficient, and reusable util function library of go.
* [lang](https://github.com/maxbolgarin/lang) ⭐ 2 | 🐛 0 | 🌐 Go | 📅 2025-07-05 - Generic one-liners to work with variables, slices and maps without boilerplate code.
...
* [limiters](https://github.com/mennanov/limiters) ⭐ 571 | 🐛 7 | 🌐 Go | 📅 2025-07-01 - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
* [lo](https://github.com/samber/lo) ⭐ 19,743 | 🐛 207 | 🌐 Go | 📅 2025-07-14 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [mc](https://github.com/minio/mc) ⭐ 3,091 | 🐛 39 | 🌐 Go | 📅 2025-07-13 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,828 | 🐛 42 | 🌐 Go | 📅 2025-07-14 - Package for MIME type detection based on magic numbers.
* [minify](https://github.com/tdewolff/minify) ⭐ 3,910 | 🐛 34 | 🌐 Go | 📅 2025-07-07 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
* [retry-go](https://github.com/avast/retry-go) ⭐ 2,726 | 🐛 14 | 🌐 Go | 📅 2025-03-21 - Simple library for retry mechanism.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,142 | 🐛 54 | 🌐 Go | 📅 2025-07-10 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,046 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
...
* [upterm](https://github.com/owenthereal/upterm) ⭐ 939 | 🐛 52 | 🌐 Go | 📅 2025-07-14 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
* [usql](https://github.com/knq/usql) ⭐ 9,428 | 🐛 95 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
...
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,670 | 🐛 46 | 🌐 Go | 📅 2025-05-06 - Interactive cli tool for HTTP inspection.
...
* [guid](https://github.com/sdrapkin/guid) ⭐ 67 | 🐛 1 | 🌐 Go | 📅 2025-07-14 - Fast cryptographically safe Guid generator for Go (\~10x faster than `uuid`).
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,759 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [xid](https://github.com/rs/xid) ⭐ 4,153 | 🐛 17 | 🌐 Go | 📅 2025-05-12 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
* [jio](https://github.com/faceair/jio) ⭐ 118 | 🐛 2 | 🌐 Go | 📅 2024-07-04 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,126 | 🐛 192 | 🌐 JavaScript | 📅 2025-06-18.
...
* [validate](https://github.com/gookit/validate) ⭐ 1,099 | 🐛 27 | 🌐 Go | 📅 2025-06-30 - Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,653 | 🐛 325 | 🌐 Go | 📅 2025-07-14 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 904 | 🐛 6 | 🌐 Go | 📅 2025-07-13 - A [Zod](https://github.com/colinhacks/zod) ⭐ 39,016 | 🐛 532 | 🌐 TypeScript | 📅 2025-07-11 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,717 | 🐛 162 | 🌐 Go | 📅 2025-07-11 - highly extensible Git implementation in pure Go.
...
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 805 | 🐛 19 | 🌐 Go | 📅 2025-07-12 - Pure Go RTSP server and client library.
...
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 531 | 🐛 1 | 🌐 Go | 📅 2025-07-11 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
...
* [Atreugo](https://github.com/savsgio/atreugo) ⭐ 1,283 | 🐛 5 | 🌐 Go | 📅 2025-01-01 - High performance and extensible micro web framework with zero memory allocations in hot paths.
* [Beego](https://github.com/beego/beego) ⭐ 32,147 | 🐛 19 | 🌐 Go | 📅 2025-07-10 - beego is an open-source, high-performance web framework for the Go programming language.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,259 | 🐛 107 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 482 | 🐛 17 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,132 | 🐛 105 | 🌐 Go | 📅 2025-07-14 - An Express.js inspired web framework build on Fasthttp.
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 535 | 🐛 32 | 🌐 Go | 📅 2025-07-09 - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
* [Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) ⭐ 566 | 🐛 27 | 🌐 Go | 📅 2025-07-09 - Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications.
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,439 | 🐛 39 | 🌐 Go | 📅 2025-07-15 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,121 | 🐛 857 | 🌐 Go | 📅 2025-07-15 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 | 🐛 13 | 🌐 Go | 📅 2025-07-05 - Gin parameter automatic binding tool,gin rpc tools.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,895 | 🐛 27 | 🌐 Go | 📅 2025-07-14 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 12,319 | 🐛 92 | 🌐 Go | 📅 2025-07-15 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,530 | 🐛 212 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,914 | 🐛 56 | 🌐 Go | 📅 2025-07-13 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,377 | 🐛 44 | 🌐 Go | 📅 2025-07-10 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,230 | 🐛 121 | 🌐 Go | 📅 2025-07-02 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
* [Revel](https://github.com/revel/revel) ⭐ 13,201 | 🐛 99 | 🌐 Go | 📅 2023-10-28 - High-productivity web framework for the Go language.
...
* [Ronykit](https://github.com/clubpay/ronykit) ⭐ 34 | 🐛 0 | 🌐 Go | 📅 2025-07-12 - Web framework with pluggable architecture and very performant.
* [rux](https://github.com/gookit/rux) ⭐ 97 | 🐛 2 | 🌐 Go | 📅 2025-06-21 - Simple and fast web framework for build golang HTTP applications.
* [templui](https://github.com/axzilla/templui) ⭐ 780 | 🐛 14 | 🌐 JavaScript | 📅 2025-07-10 - Modern UI Components for Go & Templ.
...
* [Yokai](https://github.com/ankorstore/yokai) ⭐ 734 | 🐛 1 | 🌐 Go | 📅 2025-06-17 - Simple, modular, and observable Go framework for backend applications.
...
* [Limiter](https://github.com/ulule/limiter) ⭐ 2,237 | 🐛 14 | 🌐 Go | 📅 2024-12-10 - Dead simple rate limit middleware for Go.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,135 | 🐛 85 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,456 | 🐛 503 | 🌐 Go | 📅 2025-07-14 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,038 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 234 | 🐛 15 | 🌐 Go | 📅 2025-07-14 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,391 | 🐛 113 | 🌐 Go | 📅 2025-07-14 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [xpath](https://github.com/antchfx/xpath) ⭐ 722 | 🐛 17 | 🌐 Go | 📅 2025-04-21 - XPath package for Go.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,057 | 🐛 268 | 🌐 Go | 📅 2025-07-14 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,440 | 🐛 243 | 🌐 Go | 📅 2025-07-14 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 108 | 🐛 19 | 🌐 Go | 📅 2025-07-14 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,990 | 🐛 160 | 🌐 Go | 📅 2025-07-14 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) ⭐ 660 | 🐛 6 | 🌐 Go | 📅 2023-02-19 - An easy way to find outdated dependencies of your Go projects.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,317 | 🐛 117 | 🌐 Go | 📅 2025-07-13 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,026 | 🐛 41 | 🌐 Go | 📅 2025-06-11 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,246 | 🐛 48 | 🌐 Go | 📅 2025-07-14 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,505 | 🐛 579 | 🌐 Go | 📅 2025-07-08 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 143 | 🐛 36 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,900 | 🐛 371 | 🌐 Go | 📅 2025-07-01.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 797 | 🐛 73 | 🌐 Go | 📅 2025-07-09 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
* [validate](https://github.com/mccoyst/validate) ⭐ 62 | 🐛 1 | 🌐 Go | 📅 2023-08-18 - Automatically validates struct fields with tags.
* [wrapcheck](https://github.com/tomarrell/wrapcheck) ⭐ 341 | 🐛 9 | 🌐 Go | 📅 2025-03-26 - A linter to check that errors from external packages are wrapped.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,756 | 🐛 96 | 🌐 Go | 📅 2025-07-14 features to Vim/Neovim.
...
* [vim-go](https://github.com/fatih/vim-go) ⭐ 16,145 | 🐛 40 | 🌐 Vim Script | 📅 2025-06-21 - Go development plugin for Vim.
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,082 | 🐛 423 | 🌐 TypeScript | 📅 2025-07-07 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [envdoc](https://github.com/g4s8/envdoc) ⭐ 86 | 🐛 6 | 🌐 Go | 📅 2025-07-14 -  generate documentation for environment variables from Go source files.
...
* [xgen](https://github.com/xuri/xgen) ⭐ 373 | 🐛 29 | 🌐 Go | 📅 2025-07-03 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,317 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
...
* [alaz](https://github.com/ddosify/alaz) ⭐ 692 | 🐛 7 | 🌐 C | 📅 2024-10-02 - Effortless, Low-Overhead, eBPF-based Kubernetes Monitoring.
* [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,674 | 🐛 203 | 🌐 Go | 📅 2025-06-21 - aptly is a Debian repository management tool.
...
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,424 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
...
* [docker-go-mingw](https://github.com/x1unix/docker-go-mingw) ⭐ 51 | 🐛 0 | 🌐 Shell | 📅 2025-07-12 - Docker image for building Go binaries for Windows with MinGW toolchain.
...
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,176 | 🐛 28 | 🌐 Go | 📅 2025-07-14 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,241 | 🐛 2,579 | 🌐 Go | 📅 2025-07-15 - Lightweight, programmable telemetry for servers and workstations.
...
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,566 | 🐛 2,725 | 🌐 Go | 📅 2025-07-15 - Fork of Gogs, entirely community driven.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,068 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,052 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,911 | 🐛 246 | 🌐 Go | 📅 2025-07-08 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,206 | 🐛 149 | 🌐 Go | 📅 2025-07-15 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,250 | 🐛 808 | 🌐 Go | 📅 2025-07-14 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,311 | 🐛 210 | 🌐 Go | 📅 2025-07-11 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [ko](https://github.com/google/ko) ⭐ 8,067 | 🐛 53 | 🌐 Go | 📅 2025-07-14 - Command line tool for building and deploying Go applications on Kubernetes
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,762 | 🐛 147 | 🌐 Go | 📅 2025-07-15 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,318 | 🐛 2,583 | 🌐 Go | 📅 2025-07-14 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,431 | 🐛 143 | 🌐 Go | 📅 2025-07-09 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,755 | 🐛 543 | 🌐 Go | 📅 2025-07-14 - Cloud native application delivery.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,695 | 🐛 527 | 🌐 Go | 📅 2025-07-14 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,095 | 🐛 3,622 | 🌐 Go | 📅 2025-07-14 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,191 | 🐛 106 | 🌐 Go | 📅 2025-07-15 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,341 | 🐛 132 | 🌐 Go | 📅 2025-07-15 - Pomerium is an identity-aware access proxy.
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,438 | 🐛 143 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 925 | 🐛 202 | 🌐 Go | 📅 2025-07-11 - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [tau](https://github.com/taubyte/tau) ⭐ 4,055 | 🐛 31 | 🌐 Go | 📅 2025-07-12 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
* [tlm](https://github.com/yusufcanb/tlm) ⭐ 1,437 | 🐛 6 | 🌐 Go | 📅 2025-03-28 - Local cli copilot, powered by CodeLLaMa
* [traefik](https://github.com/containous/traefik) ⭐ 55,545 | 🐛 652 | 🌐 Go | 📅 2025-07-14 - Reverse proxy and load balancer with support for multiple backends.
...
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,374 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,459 | 🐛 68 | 🌐 Go | 📅 2025-07-11 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 590 | 🐛 10 | 🌐 Go | 📅 2025-07-14 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,416 | 🐛 26 | 🌐 Go | 📅 2025-03-20 - Simulate bad network connections.
...
* [croc](https://github.com/schollz/croc) ⭐ 30,560 | 🐛 16 | 🌐 Go | 📅 2025-07-11 - Easily and securely send files or folders from one computer to another.
...
* [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,473 | 🐛 322 | 🌐 Go | 📅 2025-05-03 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,112 | 🐛 19 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
* [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
* [GoNB](https://github.com/janpfeifer/gonb) ⭐ 885 | 🐛 10 | 🌐 Go | 📅 2025-06-01 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
* [Gor](https://github.com/buger/gor) ⭐ 19,002 | 🐛 339 | 🌐 Go | 📅 2025-04-05 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,877 | 🐛 132 | 🌐 Go | 📅 2025-07-14 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,700 | 🐛 405 | 🌐 C++ | 📅 2025-05-19 - LiteIDE is a simple, open source, cross-platform Go IDE.
...
* [Plik](https://github.com/root-gg/plik) ⭐ 1,583 | 🐛 46 | 🌐 Go | 📅 2025-06-14 - Plik is a temporary file upload system (Wetransfer like) in Go.
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,663 | 🐛 28 | 🌐 Go | 📅 2024-08-20 - Portal is a quick and easy command-line file transfer utility from any computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,292 | 🐛 476 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 703 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,472 | 🐛 54 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,174 | 🐛 592 | 🌐 Go | 📅 2025-07-15 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,352 | 🐛 91 | 🌐 Go | 📅 2025-07-14 - Proxy to simulate network and system conditions for automated tests.
...
* [yai](https://github.com/ekkinox/yai) ⭐ 807 | 🐛 29 | 🌐 Go | 📅 2024-07-31 - AI powered terminal assistant.
...
* [go\_serialization\_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) ⭐ 1,596 | 🐛 6 | 🌐 Go | 📅 2025-07-04 - Benchmarks of Go serialization methods.
...
* [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 434 | 🐛 0 | 🌐 Go | 📅 2025-03-14 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,229 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,770 | 🐛 2 | 🌐 Go | 📅 2024-12-22 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,084 | 🐛 7,409 | 🌐 Go | 📅 2025-07-15
* [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
* [Google](https://google.github.io/styleguide/go/)
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,192 | 🐛 183 | 🌐 Go | 📅 2025-07-12
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,646 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,727 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,704 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,882 | 🐛 9,408 | 🌐 Go | 📅 2025-07-14 - List of projects on the Go community wiki.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,689 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,948 | 🐛 7 | 🌐 Go | 📅 2025-07-14 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,670 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,393 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,968 | 🐛 66 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
...
* [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) ⭐ 528 | 🐛 6 | 🌐 Go | 📅 2025-07-15 - A GitHub repository offering coding challenges for Go technical interview preparation.
