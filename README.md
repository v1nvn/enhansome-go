...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,697](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 247,060.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,697 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,697; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,986 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,243 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
...
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,888 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,273 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 144,051 - Run large language models locally.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,769 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,160 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- [keto](https://github.com/ory/keto) ⭐ 5,044 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,628 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
- [oidc](https://github.com/zitadel/oidc) ⭐ 1,583 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
- [openfga](https://github.com/openfga/openfga) ⭐ 3,718 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,146 - Official Go implementation of the Ethereum protocol.
...
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,948 - A complete implementation of a Lightning Network node.
...
- [arikawa](https://github.com/diamondburned/arikawa) ⭐ 524 - A library and framework for the Discord API.
- [bot](https://github.com/go-telegram/bot) ⭐ 1,192 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,351 - Telegram bot framework is written in Go.
- [telego](https://github.com/mymmrac/telego) ⭐ 725 - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,175 - Simple and clean Telegram bot client.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,781 - Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4,356 - Mage is a make/rake-like build tool using Go.
- [mmake](https://github.com/tj/mmake) ⭐ 1,725 - Modern Make.
...
- [Task](https://github.com/go-task/task) ⭐ 12,985 - simple "Make" alternative.
- [taskctl](https://github.com/taskctl/taskctl) ⭐ 311 - Concurrent task runner.
- [xc](https://github.com/joerdav/xc) ⭐ 1,293 - Task runner with README.md defined tasks, executable markdown.
...
- [box-cli-maker](https://github.com/Delta456/box-cli-maker) ⭐ 563 - Make Highly Customized Boxes for your CLI.
- [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 498 - An interactive table component for bubbletea.
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,435 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,322 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,570 - Terminal JSON viewer & processor.
- [go-ataman](https://github.com/workanator/go-ataman) ⭐ 19 - Go library for rendering ANSI colored text templates in terminals.
- [go-colorable](https://github.com/mattn/go-colorable) ⭐ 791 - Colorable writer for windows.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,374 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,767.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,262 - Minimalist Go library aimed at creating Console User Interfaces.
- [gommon/color](https://github.com/labstack/gommon/tree/master/color) ⭐ 552 - Style terminal text.
- [gookit/color](https://github.com/gookit/color) ⭐ 1,542 - Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows.
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,112 - Declaratively define styles for color, format and layout in the terminal.
...
- [pterm](https://github.com/pterm/pterm) ⭐ 5,113 - A library to beautify console output on every platform with many combinable components.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,830 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,368.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,847 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,368 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,608.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 687 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,295 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,761 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,037 - An expressive programming language and a versatile interactive shell.
...
- [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,155 - Struct-based argument parsing in Go.
...
- [pflag](https://github.com/spf13/pflag) ⭐ 2,576 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
- [readline](https://github.com/reeflective/readline) ⭐ 117 - Shell library with modern and easy to use UI features.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,255 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,846 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,546 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,365 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [koanf](https://github.com/knadh/koanf) ⭐ 3,249 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,662 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,223 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,701 - Go configuration with fangs.
...
- [CDS](https://github.com/ovh/cds) ⭐ 4,719 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,156 - Woodpecker is a community fork of the Drone CI system.
...
- [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,125 - A high-performance ELT data integration framework with pluggable architecture.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,715 - Go package implementing compressed bitsets.

### Bit Sets

- [bitmap](https://github.com/kelindar/bitmap) ⭐ 337 - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
- [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,422 - Go package implementing bitsets.

### Bloom and Cuckoo Filters

- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,604 - Go package implementing Bloom filters.
...
- [gods](https://github.com/emirpasic/gods) ⭐ 16,953 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
- [gostl](https://github.com/liyue201/gostl) ⭐ 1,097 - Data structure and algorithm library for go, designed to provide functions similar to C++ STL.
...
- [cmap](https://github.com/lrita/cmap) ⭐ 95 - a thread-safe concurrent map for go, support using `interface{}` as key and auto scale up shards.
...
- [fsm](https://github.com/cocoonspace/fsm) ⭐ 78 - Finite-State Machine package.
...
- [gota](https://github.com/kniren/gota) ⭐ 3,192 - Implementation of dataframes, series, and data wrangling methods for Go.
...
- [deque](https://github.com/gammazero/deque) ⭐ 686 - Fast ring-buffer deque (double-ended queue).
- [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) ⭐ 427 - Concurrent FIFO queue.
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,703 - Distributed, Fault-tolerant task queue.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,529 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,417 - Modern text indexing library for go.
...
- [trie](https://github.com/derekparker/trie) ⭐ 774 - Trie implementation in Go.
...
- [cache2go](https://github.com/muesli/cache2go) ⭐ 2,155 - In-memory key:value cache which supports automatic invalidation based on timeouts.
...
- [gocache](https://github.com/eko/gocache) ⭐ 2,669 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,131 -  A high performance memory-bound Go cache.
...
- [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,064 - An in-memory cache with item expiration and generics.
- [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger](https://github.com/dgraph-io/badger) ⭐ 14,662 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,850 - An embedded key/value database for Go.
- [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,716 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover](https://github.com/ostafen/clover) ⭐ 757 - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,008 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,943 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,547 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,433 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,748 - Dolt – It's Git for Data.
...
- [godis](https://github.com/hdt3213/godis) ⭐ 3,700 - A Golang implemented high-performance Redis server and cluster.
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,274 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,759 key/value database in Go.
...
- [immudb](https://github.com/codenotary/immudb) ⭐ 8,755 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,191 - Scalable datastore for metrics, events, and real-time analytics.
...
- [LinDB](https://github.com/lindb/lindb) ⭐ 3,037 - LinDB is a scalable, high performance, high availability distributed time series database.
- [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,166 - Fast k/v database compatible with lsm and b+tree.
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,462 - Milvus is a vector database for embedding management, analytics and search.
- [moss](https://github.com/couchbase/moss) ⭐ 1,004 - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,478 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
- [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,229 - High-performance embedded Object Database (NoSQL) with Go API.
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,348 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,042 - Monitoring system and time series database.
...
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,813 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,683 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,591 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,325 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,946 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,590 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,064 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,546 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,837 - Database migrations. CLI and Golang library.
...
- [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,343 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
- [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,361 - HTTP proxy for ClickHouse database.
...
- [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,764 - Go toolset to handle MySQL protocol and replication.
...
- [onedump](https://github.com/liweiyi88/onedump) ⭐ 191 - Database backup from different drivers to different destinations with one command and configuration.
- [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,185 - Advanced scheduling for PostgreSQL.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,706 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [Dotsql](https://github.com/gchaincl/dotsql) ⭐ 747 - Go library that helps you keep sql files in one place and use them with ease.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,226 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,329 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,460 - Go library that helps you build SQL queries.
...
- [cayley](https://github.com/google/cayley) ⭐ 14,938 - Graph database with support for multiple backends.
...
- [gokv](https://github.com/philippgille/gokv) ⭐ 791 - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,871 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,526 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 715 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [KSQL](https://github.com/VinGarcia/ksql) ⭐ 333 - A Simple and Powerful Golang SQL Library
- [pgx](https://github.com/jackc/pgx) ⭐ 11,987 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,987 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,434 query results easily.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,972 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,692 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
- [xredis](https://github.com/shomali11/xredis) ⭐ 19 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

- [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,075 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
- [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,892 - Official Elasticsearch client for Go.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 980 - Fast trigram based code search.
...
- [carbon](https://github.com/dromara/carbon) ⭐ 5,081 - A simple, semantic and developer-friendly time package for golang.
...
- [arpc](https://github.com/lesismal/arpc) ⭐ 1,041 - More effective network communication, support two-way-calling, notify, broadcast.
...
- [consistent](https://github.com/buraksezer/consistent) ⭐ 735 - Consistent hashing with bounded loads.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,623 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [evans](https://github.com/ktr0731/evans) ⭐ 4,397 - Evans: more expressive universal gRPC client.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,095 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,350 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,234 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,942 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [jsonrpc](https://github.com/ybbus/jsonrpc) ⭐ 353 - JSON-RPC 2.0 HTTP client implementation.
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,042 - A cloud native Kubernetes Global Balancer.
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,481 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,476 - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,603 - Lightweight, fault-tolerant message streams for NATS.
- [lura](https://github.com/luraproject/lura) ⭐ 6,566 - Ultra performant API Gateway framework with middlewares.
- [micro](https://github.com/micro/micro) ⭐ 12,256 - A distributed systems runtime for the cloud and beyond.
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,548 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,345 - NATS is a simple, secure, and
...
- [raft](https://github.com/etcd-io/raft) ⭐ 855 - Go implementation of the Raft consensus protocol, by CoreOS.
- [rain](https://github.com/cenkalti/rain) ⭐ 1,046 - BitTorrent client and library.
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,621 - Simplified distributed locking implementation using Redis.
...
- [rpcx](https://github.com/smallnest/rpcx) ⭐ 8,225 - Distributed pluggable RPC service framework like alibaba Dubbo.
- [Semaphore](https://github.com/jexia/semaphore) ⭐ 94 - A straightforward (micro) service orchestrator.
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,296).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,894 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [Temporal](https://github.com/temporalio/sdk-go) ⭐ 649 - Durable execution system for making code fault-tolerant and simple.
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,789 - BitTorrent client package.
- [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 973 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
- [GoDNS](https://github.com/timothyye/godns) ⭐ 1,585 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,383 - A Go library for email verification without sending any emails.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,010 - A simple Go library for sending mails in Go.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,566 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
- [mailchain](https://github.com/mailchain/mailchain) ⭐ 143 - Send encrypted emails to blockchain addresses written in Go.
- [mailgun-go](https://github.com/mailgun/mailgun-go) ⭐ 725 - Go library for sending mail with the Mailgun API.
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,957 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,233 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5,019 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,615.
- [cel-go](https://github.com/google/cel-go) ⭐ 2,572 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,613 - PHP embedded in Go, with a `net/http` handler.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,224 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,615 - Lua 5.1 VM and compiler written in Go.
...
- [tengo](https://github.com/d5/tengo) ⭐ 3,655 - Bytecode compiled script language for Go.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,665 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,236 - Go error library with error portability over the network.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 281 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
- [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2,460 - Go (golang) package for representing a list of errors as a single error.
...
- [multierr](https://github.com/uber-go/multierr) ⭐ 1,141 - Package for representing a list of errors as a single error.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,530 - Disk usage analyzer with console interface.
...
- [go-wkhtmltopdf](https://github.com/SebastiaanKlippert/go-wkhtmltopdf) ⭐ 1,123 - A package to convert an HTML template to a PDF file.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,720 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,815.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,791 - Arbitrary-precision fixed-point decimal numbers.
- [decimal](https://github.com/govalues/decimal) ⭐ 165 - Immutable decimal numbers with panic-free arithmetic.
...
- [ledger](https://github.com/formancehq/ledger) ⭐ 981 - A programmable financial ledger that provides a foundation for money-moving applications.
...
- [techan](https://github.com/sdcoffey/techan) ⭐ 862 - Technical analysis library with advanced market analysis and trading strategies.
...
- [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,123 - CSRF protection for Go web applications & services.
- [httpin](https://github.com/ggicci/httpin) ⭐ 358 - Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc.
- [nosurf](https://github.com/justinas/nosurf) ⭐ 1,671 - CSRF protection middleware for Go.
...
- [mo](https://github.com/samber/mo) ⭐ 2,996 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ark](https://github.com/mlange-42/ark) ⭐ 84 - Archetype-based Entity Component System (ECS) for Go.
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,136 - dead simple 2D game engine in Go.
...
- [g3n](https://github.com/g3n/engine) ⭐ 2,956 - Go 3D Game Engine.
...
- [gonet](https://github.com/xtaci/gonet) ⭐ 1,283 - Game server skeleton implemented with golang.
...
- [nano](https://github.com/lonng/nano) ⭐ 3,030 - Lightweight, facility, high performance golang based game server framework.
...
- [go-linq](https://github.com/ahmetalpbalkan/go-linq) ⭐ 3,583 - .NET LINQ-like query methods for Go.
- [goderive](https://github.com/awalterschulze/goderive) ⭐ 1,260 - Derives functions from input types
- [goverter](https://github.com/jmattheis/goverter) ⭐ 703 - Generate converters by defining an interface.
- [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,224 - Generate decorators for Go interfaces using simple templates.
- [interfaces](https://github.com/rjeczalik/interfaces) ⭐ 430 - Command line tool for generating interface definitions.
- [jennifer](https://github.com/dave/jennifer) ⭐ 3,508 - Generate arbitrary Go code without templates.
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,219 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [H3](https://github.com/uber/h3-go) ⭐ 351 - Go bindings for H3, a hierarchical hexagonal geospatial indexing system.
...
- [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 729 - A simple Go-based server for map tiles stored in mbtiles format.
...
- [S2 geometry](https://github.com/golang/geo) ⭐ 1,754 - S2 geometry library in Go.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,350 - Geolocation DB with spatial index and realtime geofencing.
...
- [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,983 - Compiler from Go to JavaScript.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,754 - A high-performance and low-cost goroutine pool in Go.
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,930 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [pond](https://github.com/alitto/pond) ⭐ 1,794 - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,695 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 415 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,236 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,658.
...
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,258 - Build native macOS applications using Go.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,596 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [ui](https://github.com/andlabs/ui) ⭐ 8,347 - Platform-native GUI library for Go. Cross platform.
...
- [webview](https://github.com/zserge/webview) ⭐ 13,163 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,198 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,571 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
- [emgo](https://github.com/ziutek/emgo) ⭐ 1,085 - Go-like language for programming embedded systems (e.g. STM32 MCU).
- [ghw](https://github.com/jaypipes/ghw) ⭐ 1,757 - Golang hardware discovery/inspection library.
...
- [canvas](https://github.com/tdewolff/canvas) ⭐ 1,584 - Vector graphics to PDF, SVG or rasterized image.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,607 - 2D rendering in pure Go.
...
- [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 715 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
- [go-webcolors](https://github.com/jyotiska/go-webcolors) ⭐ 28 - Port of webcolors library from Python to Go.
- [go-webp](https://github.com/kolesa-team/go-webp) ⭐ 262 - Library for encode and decode webp pictures, using libwebp.
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,094 - Go package for computer vision using OpenCV 3.3+.
...
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,782 - Screenshoting webpages using go and headless chrome on command line.
...
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,492 - Simple Go image processing package.
- [imagor](https://github.com/cshum/imagor) ⭐ 3,656 - Fast, secure image processing server and Go library, using libvips.
...
- [smartcrop](https://github.com/muesli/smartcrop) ⭐ 1,835 - Finds good crops for arbitrary images and crop sizes.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,133 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
- [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 - Lightweight stream processing engine for IoT.
- [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,343 - Kubernetes native IoT development framework.
...
- [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,882 - Simple, zero-dependency scheduling library for Go.
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,309 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,490.
...
- [gronx](https://github.com/adhocore/gronx) ⭐ 453 - Cron expression parser, task runner and daemon consuming crontab like task list.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,987 - Get a JSON value with one line of code.
...
- [glog](https://github.com/golang/glog) ⭐ 3,603 - Leveled execution logs for Go.
...
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 570 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,314 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,314 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,314 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,314, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,095, [zap](https://github.com/uber-go/zap) ⭐ 23,221, [zerolog](https://github.com/rs/zerolog) ⭐ 11,503, etc).
...
- [phuslu/log](https://github.com/phuslu/log) ⭐ 773 - High performance structured logging.
...
- [spew](https://github.com/davecgh/go-spew) ⭐ 6,253 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [tail](https://github.com/hpcloud/tail) ⭐ 2,764 - Go package striving to emulate the features of the BSD tail program.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,221 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,503 - Zero-allocation JSON logger.
...
- [GoLearn](https://github.com/sjwhitworth/golearn) ⭐ 9,404 - General Machine Learning library for Go.
...
- [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,786 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 411 - Huggingface transformer pipelines for golang with onnxruntime.
...
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 790 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,787 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,403 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,037 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,878 - The lightweight event bus with async compatibility.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,398 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,091 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,768 - Asynchronous task queue/job queue based on distributed message passing.
...
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,963 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,965 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,040 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,560 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [excelize](https://github.com/xuri/excelize) ⭐ 19,276 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,974 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
- [dig](https://github.com/uber-go/dig) ⭐ 4,198 - A reflection based dependency injection toolkit for Go.
- [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 184 - A dependency injection toolkit for Go, based on Guice.
- [do](https://github.com/samber/do) ⭐ 2,138 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,577 - A dependency injection based application framework for Go (built on top of dig).
...
- [gontainer](https://github.com/NVIDIA/gontainer) ⭐ 48 - A dependency injection service container for Go projects.
...
- [google/wire](https://github.com/google/wire) ⭐ 13,848 - Automated Initialization in Go.
...
- [kod](https://github.com/go-kod/kod) ⭐ 185 - A generics based dependency injection framework for Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,799 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,799 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,624 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,772 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,772 for more information. Nonetheless, some may find the layout useful.
- [golang-templates/seed](https://github.com/golang-templates/seed) ⭐ 523 - Go application GitHub repository template.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,261 - Nunu is a scaffolding tool for building Go applications.
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,542 - Rapid, easy full-stack web development starter kit built in Go.
...
- [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,123 - cross-platform, cli app to perform various operations on string.
...
- [archives](https://github.com/mholt/archives) ⭐ 245 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,552 - Automated service health dashboard.
...
- [go-resiliency](https://github.com/eapache/go-resiliency) ⭐ 2,295 - Resiliency patterns for golang.
- [go-unarr](https://github.com/gen2brain/go-unarr) ⭐ 292 - Decompression library for RAR, TAR, ZIP and 7z archives.
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,960 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,239 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [whatlanggo](https://github.com/abadojack/whatlanggo) ⭐ 657 - Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc).
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,738.
...
- [spaGO](https://github.com/nlpodyssey/spago) ⭐ 1,805 - Self-contained Machine Learning and Natural Language Processing library in Go.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,532 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,173 which a Chinese word splitting algorithm.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,260 - Package and an accompanying tool to work with localized text.
- [go-mystem](https://github.com/dveselov/mystem) ⭐ 34 - CGo bindings to Yandex.Mystem - russian morphology analyzer.
- [go-pinyin](https://github.com/mozillazg/go-pinyin) ⭐ 1,687 - CN Hanzi to Hanyu Pinyin converter.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,828 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,638 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gaio](https://github.com/xtaci/gaio) ⭐ 790 - High performance async-io networking for Golang in proactor mode.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,597 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [grab](https://github.com/cavaliercoder/grab) ⭐ 1,437 - Go package for managing file downloads.
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,268 - KCP - Fast and Reliable ARQ Protocol.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,506 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
- [net](https://golang.org/x/net) - This repository holds supplementary Go networking libraries.
- [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,322 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 929 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,739 - An implementation of the QUIC protocol in pure Go.
...
- [sdns](https://github.com/semihalev/sdns) ⭐ 998 - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
...
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,914 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,919 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,934 - A pure Go implementation of the WebRTC API.
...
- [go-ipmux](https://github.com/optimus-hft/go-ipmux) ⭐ 26 - A library for Multiplexing HTTP requests based on multiple Source IPs.
...
- [req](https://github.com/imroc/req) ⭐ 4,518 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,972 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,169 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,314 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,205 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,275 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,560 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,357 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,219 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,475 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 170 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,059 - No instrumentation tracing for Golang applications via eBPF.
- [profile](https://github.com/pkg/profile) ⭐ 2,027 - Simple profiling support package for Go.
- [statsviz](https://github.com/arl/statsviz) ⭐ 3,303 - Live visualization of your Go application runtime statistics.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,483 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,379 - go generate based graphql server library.
...
- [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) ⭐ 1,253 - Dataframes for machine-learning and statistics (similar to pandas).
...
- [go-hep](https://github.com/go-hep/hep) ⭐ 246 - A set of libraries and tools for performing High Energy Physics analyses with ease.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,047 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- [orb](https://github.com/paulmach/orb) ⭐ 995 - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
- [stats](https://github.com/montanaflynn/stats) ⭐ 2,984 - Statistics package with common functions missing from the Golang standard library.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,076 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,171 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 565 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,400 - Tool and library to remotely hack RTSP streams from surveillance cameras.
- [certificates](https://github.com/mvmaasakkers/certificates) ⭐ 38 - An opinionated tool for generating tls certificates.
- [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,242 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,704 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,659 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,962 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- [Clace](https://github.com/claceio/clace) ⭐ 628 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
- [discovery](https://github.com/Bilibili/discovery) ⭐ 1,794 - A registry for resilient mid-tier load balancing and failover.
- [dudeldu](https://github.com/krotik/dudeldu) ⭐ 145 - A simple SHOUTcast server.
- [Easegress](https://github.com/megaease/easegress) ⭐ 5,830 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,641 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,551 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,499 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,427 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,673 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 53,216 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,843 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,582 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,142 - Make SSH apps, just like that!
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,439 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
- [pongo2](https://github.com/flosch/pongo2) ⭐ 2,957 - Django-like template-engine for Go.
- [quicktemplate](https://github.com/valyala/quicktemplate) ⭐ 3,224 - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,386 - A HTML templating language that has great developer tooling.
...
- [charlatan](https://github.com/percolate/charlatan) ⭐ 203 - Tool to generate fake interface implementations for tests.
...
- [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 961 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
- [goc](https://github.com/qiniu/goc) ⭐ 858 - Goc is a comprehensive coverage testing system for The Go Programming Language.
...
- [godog](https://github.com/cucumber/godog) ⭐ 2,443 - Cucumber BDD framework for Go.
- [gofight](https://github.com/appleboy/gofight) ⭐ 439 - API Handler Testing for Golang Router framework.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,237 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,123 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,755 - Sacred extension to the standard go testing package.
...
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,377 - Mock SQL driver for testing database interactions.
- [go-txdb](https://github.com/DATA-DOG/go-txdb) ⭐ 718 - Single transaction based database driver mainly for testing purposes.
- [gock](https://github.com/h2non/gock) ⭐ 2,173 - Versatile HTTP mocking made easy.
- [gomock](https://github.com/uber-go/mock) ⭐ 2,854 - Mocking framework for the Go programming language.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,640 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 485 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,987.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,930 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,741 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,999 - A Devtools driver to make web automation and scraping easy.
- [selenoid](https://github.com/aerokube/selenoid) ⭐ 2,643 - alternative Selenium hub server that launches browsers within containers.

### Fail injection

- [failpoint](https://github.com/pingcap/failpoint) ⭐ 849 - An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang.
...
- [bytes](https://github.com/labstack/gommon/tree/master/bytes) ⭐ 552 - Formats and parses numeric byte values (10K, 2M, 3G, etc.).
...
- [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,821 - Go library for the TOML format with query support and handy cli tools.
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,123 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,887 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [toml](https://github.com/BurntSushi/toml) ⭐ 4,742 - TOML configuration format (encoder/decoder with reflection).
...
- [godump (goforj)](https://github.com/goforj/godump) ⭐ 904 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
- [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,703 - Parse RSS and Atom feeds in Go.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,794 - Shell parser and formatter.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,417 - HTML Sanitizer.
- [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 - A sanitization-based swear filter for Go.

### Scrapers

- [colly](https://github.com/asciimoo/colly) ⭐ 24,334 - Fast and Elegant Scraping Framework for Gophers.
...
- [xurls](https://github.com/mvdan/xurls) ⭐ 1,220 - Extract urls from text.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,101 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,426 - Go bindings for the Discord Chat API.
...
- [github](https://github.com/google/go-github) ⭐ 10,834 - Go library for accessing the GitHub REST API v3.
...
- [go-jira](https://github.com/andygrunwald/go-jira) ⭐ 1,536 - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)
- [go-lark](https://github.com/go-lark/lark) ⭐ 224 - An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,076 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,273 - Google Cloud APIs Go Client Library.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,793 - Slack API in Go.
...
- [stripe](https://github.com/stripe/stripe-go) ⭐ 2,331 - Go client for the Stripe API.
...
- [countries](https://github.com/biter777/countries) ⭐ 452 - Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standards.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,195 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [debounce](https://github.com/floatdrop/debounce) ⭐ 22 - A zero-allocation debouncer written in Go.
- [delve](https://github.com/derekparker/delve) ⭐ 651 - Go debugger.
- [dive](https://github.com/wagoodman/dive) ⭐ 51,122 - A tool for exploring each layer in a Docker image.
...
- [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,246 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
- [equalizer](https://github.com/reugn/equalizer) ⭐ 91 - Quota manager and rate limiter collection for Go.
- [ergo](https://github.com/cristianoliveira/ergo) ⭐ 637 - The management of multiple local services running over different ports made easy.
...
- [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,793 - Fault tolerance and resilience patterns for Go.
- [filetype](https://github.com/h2non/filetype) ⭐ 2,196 - Small package to infer the file type checking the magic numbers signature.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 71,066 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,749 - Deliver Go binaries as fast and easily as possible.
...
- [jump](https://github.com/gsamokovarov/jump) ⭐ 1,856 - Jump helps you navigate faster by learning your habits.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,062 - A comprehensive, efficient, and reusable util function library of go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,589 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mergo](https://github.com/imdario/mergo) ⭐ 3,007 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,816 - Package for MIME type detection based on magic numbers.
...
- [peco](https://github.com/peco/peco) ⭐ 7,759 - Simplistic interactive filtering tool.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,703 - Simple library for retry mechanism.
...
- [rospo](https://github.com/ferama/rospo) ⭐ 333 - Simple and reliable ssh tunnels with embedded ssh server in Golang.
...
- [scany](https://github.com/georgysavva/scany) ⭐ 1,434 - Library for scanning data from a database into Go structs and more.
- [serve](https://github.com/syntaqx/serve) ⭐ 342 - A static http server anywhere you need.
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,079 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,003 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [govalid](https://github.com/twharmon/govalid) ⭐ 92 - Fast, tag-based validation for structs.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,500 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 875 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,649 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [git2go](https://github.com/libgit2/git2go) ⭐ 1,971 - Go bindings for libgit2.
- [githooks](https://github.com/gabyx/githooks) ⭐ 110 - Per-repo and shared Git hooks with version control and auto update.
- [go-git](https://github.com/go-git/go-git) ⭐ 6,642 - highly extensible Git implementation in pure Go.
- [go-vcs](https://github.com/sourcegraph/go-vcs) ⭐ 80 - manipulate and inspect VCS repositories in Go.
- [hercules](https://github.com/src-d/hercules) ⭐ 2,711 - gaining advanced insights from Git repository history.
...
- [go-astiav](https://github.com/asticode/go-astiav) ⭐ 511 - Better C bindings for ffmpeg in GO.
...
- [goav](https://github.com/giorgisio/goav) ⭐ 2,116 - Comprehensive Go bindings for FFmpeg.
- [gortsplib](https://github.com/aler9/gortsplib) ⭐ 786 - Pure Go RTSP server and client library.
...
- [Atreugo](https://github.com/savsgio/atreugo) ⭐ 1,278 - High performance and extensible micro web framework with zero memory allocations in hot paths.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,159 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 455 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,897 - An Express.js inspired web framework build on Fasthttp.
...
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,790 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,794 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,459 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,862 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,318 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,162 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [rk-boot](https://github.com/rookie-ninja/rk-boot) ⭐ 542 - A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily.
...
- [go-fault](https://github.com/github/go-fault) ⭐ 508 - Fault injection middleware for Go.
- [go-server-timing](https://github.com/mitchellh/go-server-timing) ⭐ 859 - Add/parse Server-Timing header.
- [Limiter](https://github.com/ulule/limiter) ⭐ 2,222 - Dead simple rate limit middleware for Go.
...
- [Tollbooth](https://github.com/didip/tollbooth) ⭐ 2,799 - Rate limit HTTP request handler.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,965 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,900 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,415 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,343 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,989 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,263 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [xmlquery](https://github.com/antchfx/xmlquery) ⭐ 469 - xmlquery is Golang XPath package for XML query.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 5,009 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,375 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) ⭐ 660 - An easy way to find outdated dependencies of your Go projects.
- [goast-viewer](https://github.com/yuroyoro/goast-viewer) ⭐ 783 - Web based Golang AST visualizer.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,169 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,071 - Formatter that automatically shortens long lines in Go code.
...
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 139 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,755.
...
- [vacuum](https://github.com/daveshanley/vacuum) ⭐ 782 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
- [validate](https://github.com/mccoyst/validate) ⭐ 62 - Automatically validates struct fields with tags.
- [wrapcheck](https://github.com/tomarrell/wrapcheck) ⭐ 336 - A linter to check that errors from external packages are wrapped.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 574 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,724 features to Vim/Neovim.
...
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,070 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,292 - Visualize call graph of your Go program using dot format.
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,607 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,776 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,665 - aptly is a Debian repository management tool.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,144 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,101 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,224 - Build powerful pipelines in any programming language.
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,755 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,117 - Fork of Gogs, entirely community driven.
...
- [go-rocket-update](https://github.com/mouuff/go-rocket-update) ⭐ 106 - A simple way to make self updating Go applications - Supports Github and Gitlab.
...
- [govvv](https://github.com/ahmetalpbalkan/govvv) ⭐ 537 - “go build” wrapper to easily add version information into Go binaries.
- [grapes](https://github.com/yaronsumel/grapes) ⭐ 170 - Lightweight tool designed to distribute commands over ssh with ease.
- [GVM](https://github.com/moovweb/gvm) ⭐ 11,003 - GVM provides an interface to manage Go versions.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,853 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,974 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,066 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,219 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,037 - Command line tool for building and deploying Go applications on Kubernetes
- [kool](https://github.com/kool-dev/kool) ⭐ 687 - Command line tool for managing Docker environments as an easy way.
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,739 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,822 - Container Cluster Manager from Google.
...
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,723 - Cloud native application delivery.
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,174 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,563 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,926 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,303 - Pomerium is an identity-aware access proxy.
- [Rodent](https://github.com/alouche/rodent) ⭐ 33 - Rodent helps you manage Go versions, projects and track dependencies.
- [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 360 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,344 - Blazing fast S3 and local filesystem execution tool.
- [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 920 - Manage BareMetal Servers from Command Line (as easily as with Docker).
- [script](https://github.com/bitfield/script) ⭐ 6,733 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,021 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,205 - Reverse proxy and load balancer with support for multiple backends.
...
- [uTask](https://github.com/ovh/utask) ⭐ 1,285 - Automation engine that models and executes business processes declared in yaml.
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,296 - HTTP load testing tool and library. It's over 9000!
...
- [confd](https://github.com/kelseyhightower/confd) ⭐ 8,395 - Manage local application configuration files using templates and data from etcd or consul.
- [crawley](https://github.com/s0rg/crawley) ⭐ 301 - Web scraper/crawler for cli.
- [croc](https://github.com/schollz/croc) ⭐ 30,389 - Easily and securely send files or folders from one computer to another.
...
- [drive](https://github.com/odeke-em/drive) ⭐ 6,722 - Google Drive client for the commandline.
...
- [fjira](https://github.com/mk-5/fjira) ⭐ 179 - A fuzzy-search based terminal UI application for Attlasian Jira
- [Gebug](https://github.com/moshebe/gebug) ⭐ 631 - A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly.
...
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 870 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,720 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [Plik](https://github.com/root-gg/plik) ⭐ 1,573 - Plik is a temporary file upload system (Wetransfer like) in Go.
- [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,652 - Portal is a quick and easy command-line file transfer utility from any computer to another.
- [restic](https://github.com/restic/restic) ⭐ 29,025 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 699 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,413 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,836 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [stew](https://github.com/marwanhawari/stew) ⭐ 271 - An independent package manager for compiled binaries.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,317 - Proxy to simulate network and system conditions for automated tests.
...
- [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 424 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
- [Build Web Application with Golang](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/)
- [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
- [Go 101](https://go101.org) - A book focusing on Go syntax/semantics and all kinds of details.
- [Go AST Book (Chinese)](https://github.com/chai2010/go-ast-book) ⭐ 5,448 - A book focusing on Go `go/*` packages.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,090 - A curated list of Go books.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,008
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,154
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,578
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,374 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,647 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,446 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,635 - Golang ebook intro how to build a web app with golang.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,886 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,572 - Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,732 - Examples of Golang compared to Node.js for learning.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,338 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,896 - Learn Go with test-driven development.
