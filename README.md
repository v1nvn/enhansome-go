...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 150,495 | 🐛 142 | 🌐 Go | 📅 2025-08-21
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 393,864 | 🐛 53 | 📅 2025-07-18
[![Slack Widget](https://img.shields.io/badge/join-us%20on%20slack-gray.svg?longCache=true\&logo=slack\&colorB=red)](https://gophers.slack.com/messages/awesome)
[![Netlify Status](https://api.netlify.com/api/v1/badges/83a6dcbe-0da6-433e-b586-f68109286bd5/deploy-status)](https://app.netlify.com/sites/awesome-go/deploys)
[![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/avelino/awesome-go/)
[![Last Commit](https://img.shields.io/github/last-commit/avelino/awesome-go)](https://github.com/avelino/awesome-go/commits/main) ⭐ 150,495 | 🐛 142 | 🌐 Go | 📅 2025-08-21
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 256,112 | 🐛 485 | 🌐 Python | 📅 2025-07-17.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 150,495 | 🐛 142 | 🌐 Go | 📅 2025-08-21 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 150,495 | 🐛 142 | 🌐 Go | 📅 2025-08-21; you rock!
...
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,297 | 🐛 55 | 🌐 Go | 📅 2025-08-21 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
* [Ergo](https://github.com/ergo-services/ergo) ⭐ 4,059 | 🐛 6 | 🌐 Go | 📅 2025-07-21 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 276 | 🐛 0 | 🌐 Go | 📅 2025-08-21 - Fast and Distributed Actor framework using protocol buffers as message for Golang.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [Ollama](https://github.com/jmorganca/ollama) ⭐ 150,665 | 🐛 2,111 | 🌐 Go | 📅 2025-08-22 - Run large language models locally.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 34,759 | 🐛 400 | 🌐 Go | 📅 2025-08-21 - Open Source OpenAI alternative, self-host AI models.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,431 | 🐛 365 | 🌐 Go | 📅 2025-08-21 - LangChainGo is a framework for developing applications powered by language models.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 19,049 | 🐛 32 | 🌐 Go | 📅 2025-08-14 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,179 | 🐛 136 | 🌐 Go | 📅 2025-08-18 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
* [spicedb](https://github.com/authzed/spicedb) ⭐ 5,968 | 🐛 113 | 🌐 Go | 📅 2025-08-21 - A Zanzibar-inspired database that enables fine-grained authorization.
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,676 | 🐛 43 | 🌐 Go | 📅 2025-08-13 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
* [keto](https://github.com/ory/keto) ⭐ 5,097 | 🐛 58 | 🌐 Go | 📅 2025-08-21 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [openfga](https://github.com/openfga/openfga) ⭐ 4,017 | 🐛 139 | 🌐 Go | 📅 2025-08-21 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [paseto](https://github.com/o1egl/paseto) ⭐ 906 | 🐛 6 | 🌐 Go | 📅 2023-02-25 - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,591 | 🐛 319 | 🌐 Go | 📅 2025-08-21 - Official Go implementation of the Ethereum protocol.
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,653 | 🐛 1,076 | 🌐 Go | 📅 2025-08-21 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 8,005 | 🐛 807 | 🌐 Go | 📅 2025-08-20 - A complete implementation of a Lightning Network node.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,700 | 🐛 199 | 🌐 Go | 📅 2025-08-22 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,824 | 🐛 26 | 🌐 Go | 📅 2025-08-21 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
* [gno](https://github.com/gnolang/gno) ⭐ 986 | 🐛 697 | 🌐 Go | 📅 2025-08-21 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 771 | 🐛 296 | 🌐 Go | 📅 2025-08-18 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
* [gossamer](https://github.com/ChainSafe/gossamer) ⭐ 451 | 🐛 402 | 🌐 Go | 📅 2025-08-21 - A Go implementation of the Polkadot Host.
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,236 | 🐛 172 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,421 | 🐛 56 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
...
* [bot](https://github.com/go-telegram/bot) ⭐ 1,311 | 🐛 10 | 🌐 Go | 📅 2025-08-18 - Zero-dependencies Telegram Bot library with additional UI components
* [telego](https://github.com/mymmrac/telego) ⭐ 762 | 🐛 3 | 🌐 Go | 📅 2025-08-19 - Telegram Bot API library for Golang with full one-to-one API implementation.
...
* [air](https://github.com/cosmtrek/air) ⭐ 21,455 | 🐛 185 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
* [Task](https://github.com/go-task/task) ⭐ 13,389 | 🐛 399 | 🌐 Go | 📅 2025-08-22 - simple "Make" alternative.
...
* [mage](https://github.com/magefile/mage) ⭐ 4,437 | 🐛 130 | 🌐 Go | 📅 2025-06-15 - Mage is a make/rake-like build tool using Go.
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 34,541 | 🐛 124 | 🌐 Go | 📅 2025-08-19 - Go framework to build terminal apps, based on The Elm Architecture.
* [fx](https://github.com/antonmedv/fx) ⭐ 19,764 | 🐛 6 | 🌐 Go | 📅 2025-08-21 - Terminal JSON viewer & processor.
...
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,340 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,498 | 🐛 89 | 🌐 Go | 📅 2025-08-18 - Declaratively define styles for color, format and layout in the terminal.
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,806 | 🐛 169 | 🌐 Go | 📅 2025-08-20 - TUI components for bubbletea.
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,397 | 🐛 114 | 🌐 Go | 📅 2025-08-12 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,889 | 🐛 675 | 🌐 Python | 📅 2025-08-17.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,870 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,412 | 🐛 104 | 🌐 Go | 📅 2025-07-10.
...
* [termenv](https://github.com/muesli/termenv) ⭐ 1,904 | 🐛 39 | 🌐 Go | 📅 2025-08-12 - Advanced ANSI style & color support for your terminal applications.
* [uilive](https://github.com/gosuri/uilive) ⭐ 1,709 | 🐛 12 | 🌐 Go | 📅 2023-07-22 - Library for updating terminal output in real time.
* [gookit/color](https://github.com/gookit/color) ⭐ 1,560 | 🐛 8 | 🌐 Go | 📅 2025-08-22 - Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows.
...
* [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 513 | 🐛 18 | 🌐 Go | 📅 2025-08-13 - An interactive table component for bubbletea.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,502 | 🐛 322 | 🌐 Go | 📅 2025-08-11 - Commander for modern Go CLI interactions.
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,443 | 🐛 50 | 🌐 Go | 📅 2025-08-16 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
* [elvish](https://github.com/elves/elvish) ⭐ 6,087 | 🐛 340 | 🌐 Go | 📅 2025-07-14 - An expressive programming language and a versatile interactive shell.
...
* [pflag](https://github.com/spf13/pflag) ⭐ 2,626 | 🐛 151 | 🌐 Go | 📅 2025-08-02 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
* [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,174 | 🐛 31 | 🌐 Go | 📅 2025-07-12 - Struct-based argument parsing in Go.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,405 | 🐛 79 | 🌐 Go | 📅 2025-08-21 - Multi-shell multi-command argument completer.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 800 | 🐛 42 | 🌐 Go | 📅 2025-08-16 - Command argument completion generator for spf13/cobra.
...
* [viper](https://github.com/spf13/viper) ⭐ 29,111 | 🐛 519 | 🌐 Go | 📅 2025-08-21 - Go configuration with fangs.
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,677 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,516 | 🐛 27 | 🌐 Go | 📅 2025-08-21 - A blazingly fast JSON serializing & deserializing library.
* [env](https://github.com/caarlos0/env) ⭐ 5,704 | 🐛 12 | 🌐 Go | 📅 2025-08-12 - Parse environment variables to Go structs (with defaults).
...
* [koanf](https://github.com/knadh/koanf) ⭐ 3,400 | 🐛 11 | 🌐 Go | 📅 2025-08-21 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
* [kong](https://github.com/alecthomas/kong) ⭐ 2,761 | 🐛 30 | 🌐 Go | 📅 2025-08-18 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [xdg](https://github.com/adrg/xdg) ⭐ 864 | 🐛 5 | 🌐 Go | 📅 2025-08-20 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
* [nfigure](https://github.com/muir/nfigure) ⭐ 8 | 🐛 6 | 🌐 Go | 📅 2025-08-21 - Per-library struct-tag based configuration from command lines (Posix & Go-style); environment, JSON, YAML
...
* [drone](https://github.com/drone/drone) ⭐ 33,110 | 🐛 76 | 🌐 Go | 📅 2025-08-21 - Drone is a Continuous Integration platform built on Docker, written in Go.
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,393 | 🐛 346 | 🌐 Go | 📅 2025-08-22 - Woodpecker is a community fork of the Drone CI system.
* [CDS](https://github.com/ovh/cds) ⭐ 4,752 | 🐛 158 | 🌐 Go | 📅 2025-08-21 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,569 | 🐛 23 | 🌐 Go | 📅 2025-08-19 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,901 | 🐛 98 | 🌐 Rust | 📅 2025-08-21.
...
* [go-semver-release](https://github.com/s0ders/go-semver-release) ⭐ 17 | 🐛 8 | 🌐 Go | 📅 2025-08-21 - Automate the semantic versioning of Git repositories.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,433 | 🐛 526 | 🌐 Go | 📅 2025-08-19 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,178 | 🐛 160 | 🌐 Go | 📅 2025-08-21 - A high-performance ELT data integration framework with pluggable architecture.
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,749 | 🐛 69 | 🌐 Go | 📅 2025-08-19 - Go package implementing compressed bitsets.
...
* [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,443 | 🐛 3 | 🌐 Go | 📅 2025-08-18 - Go package implementing bitsets.
...
* [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,645 | 🐛 19 | 🌐 Go | 📅 2025-08-18 - Go package implementing Bloom filters.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 17,091 | 🐛 68 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,935 | 🐛 93 | 🌐 Python | 📅 2025-08-21 - Distributed, Fault-tolerant task queue.
...
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,578 | 🐛 13 | 🌐 Go | 📅 2025-08-15 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,508 | 🐛 299 | 🌐 Go | 📅 2025-08-21 - Modern text indexing library for go.
* [trie](https://github.com/derekparker/trie) ⭐ 777 | 🐛 13 | 🌐 Go | 📅 2025-08-21 - Trie implementation in Go.
* [go-edlib](https://github.com/hbollon/go-edlib) ⭐ 545 | 🐛 0 | 🌐 Go | 📅 2025-08-19 - Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,389 | 🐛 7 | 🌐 Go | 📅 2025-08-20 -  A high performance memory-bound Go cache.
...
* [fastcache](https://github.com/VictoriaMetrics/fastcache) ⭐ 2,255 | 🐛 44 | 🌐 Go | 📅 2025-08-06 - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
...
* [go-freelru](https://github.com/elastic/go-freelru) ⭐ 248 | 🐛 18 | 🌐 Go | 📅 2025-08-21 A GC-less, fast and generic LRU hashmap library with optional locking, sharding, eviction and expiration.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 60,018 | 🐛 723 | 🌐 Go | 📅 2025-08-21 - Monitoring system and time series database.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,906 | 🐛 5,218 | 🌐 Go | 📅 2025-08-22 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 36,715 | 🐛 685 | 🌐 Go | 📅 2025-08-22 - Milvus is a vector database for embedding management, analytics and search.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,201 | 🐛 7,592 | 🌐 Go | 📅 2025-08-22 - Scalable, Geo-Replicated, Transactional Datastore.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,509 | 🐛 2,138 | 🌐 Rust | 📅 2025-08-21 - Scalable datastore for metrics, events, and real-time analytics.
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,163 | 🐛 44 | 🌐 Go | 📅 2025-08-22 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,996 | 🐛 434 | 🌐 Go | 📅 2025-08-22 - Dolt – It's Git for Data.
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,878 | 🐛 77 | 🌐 Go | 📅 2025-08-22 - The lightweight, distributed, relational database built on SQLite.
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,931 | 🐛 32 | 🌐 Go | 📅 2025-08-20 - Fast key-value store in Go.
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,821 | 🐛 793 | 🌐 Go | 📅 2025-08-21 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,031 | 🐛 44 | 🌐 Go | 📅 2025-08-21 - An embedded key/value database for Go.
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,295 | 🐛 109 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 38,025 | 🐛 366 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,457 | 🐛 311 | 🌐 Go | 📅 2025-08-22 - RocksDB/LevelDB inspired key-value database in Go.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 4,143 | 🐛 2 | 🌐 Go | 📅 2025-07-14 - Redis re-implemented with SQLite.
...
* [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,324 | 🐛 4 | 🌐 Go | 📅 2025-08-04 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 17,225 | 🐛 437 | 🌐 Go | 📅 2025-08-20 - Database migrations. CLI and Golang library.
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,897 | 🐛 127 | 🌐 Go | 📅 2025-08-22 - Safe database schema change and version control for DevOps teams.
* [goose](https://github.com/pressly/goose) ⭐ 8,974 | 🐛 102 | 🌐 Go | 📅 2025-08-16 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
* [atlas](https://github.com/ariga/atlas) ⭐ 7,219 | 🐛 224 | 🌐 Go | 📅 2025-08-12 - A Database Toolkit. A CLI designed to help companies better work with their data.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,258 | 🐛 37 | 🌐 Go | 📅 2025-08-18 - A lightweight, framework-agnostic database migration tool.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 20,018 | 🐛 876 | 🌐 Go | 📅 2025-08-21 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,982 | 🐛 37 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
...
* [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,384 | 🐛 62 | 🌐 Go | 📅 2025-08-21 - HTTP proxy for ClickHouse database.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,789 | 🐛 608 | 🌐 Go | 📅 2025-08-21 - Generate type-safe code from SQL.
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,558 | 🐛 92 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
...
* [goqu](https://github.com/doug-martin/goqu) ⭐ 2,555 | 🐛 144 | 🌐 Go | 📅 2024-05-22 - Idiomatic SQL builder and query library.
...
* [sqlingo](https://github.com/lqs/sqlingo) ⭐ 436 | 🐛 5 | 🌐 Go | 📅 2025-01-06 - A lightweight DSL to build SQL in Go.
...
* [patcher](https://github.com/Jacobbrewer1/patcher) ⭐ 6 | 🐛 2 | 🌐 Go | 📅 2025-08-21 - Powerful SQL Query builder that automatically generates SQL queries from structs.
...
* [gokv](https://github.com/philippgille/gokv) ⭐ 806 | 🐛 43 | 🌐 Go | 📅 2025-06-29 - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
* [go-transaction-manager](https://github.com/avito-tech/go-transaction-manager) ⭐ 322 | 🐛 3 | 🌐 Go | 📅 2025-08-21 - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15,013 | 🐛 63 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [pgx](https://github.com/jackc/pgx) ⭐ 12,330 | 🐛 239 | 🌐 Go | 📅 2025-08-09 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pq](https://github.com/lib/pq) ⭐ 9,590 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,655 | 🐛 203 | 🌐 C | 📅 2025-08-14 - SQLite3 driver for go that uses database/sql.
* [go-mssqldb](https://github.com/denisenkom/go-mssqldb) ⭐ 1,863 | 🐛 177 | 🌐 Go | 📅 2025-04-26 - Microsoft MSSQL driver for Go.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 762 | 🐛 6 | 🌐 Go | 📅 2025-08-21 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [Sqinn-Go](https://github.com/cvilsmeier/sqinn-go) ⭐ 466 | 🐛 0 | 🌐 Go | 📅 2025-08-21 - SQLite with pure Go.
...
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 1 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,330 | 🐛 239 | 🌐 Go | 📅 2025-08-09 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,456 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,420 | 🐛 88 | 🌐 Go | 📅 2025-08-21 - Redis client for Golang.
...
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,750 | 🐛 14 | 🌐 Go | 📅 2025-08-06 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
* [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) ⭐ 449 | 🐛 37 | 🌐 Go | 📅 2025-08-21 - Aerospike client in Go language.
...
* [Kivik](https://github.com/go-kivik/kivik) ⭐ 327 | 🐛 37 | 🌐 Go | 📅 2025-08-20 - Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases.
...
* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,122 | 🐛 89 | 🌐 Go | 📅 2025-08-22 - ClickHouse SQL client for Go with a `database/sql` compatibility.
* [elasticsql](https://github.com/cch123/elasticsql) ⭐ 1,190 | 🐛 13 | 🌐 Go | 📅 2023-08-06 - Convert sql to elasticsearch dsl in Go.
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1,049 | 🐛 20 | 🌐 Go | 📅 2025-08-21 - Fast trigram based code search.
...
* [approx](https://github.com/goschtalt/approx) ⭐ 15 | 🐛 0 | 🌐 Go | 📅 2025-08-21 - A Duration extension supporting parsing/printing durations in days, weeks and years.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,656 | 🐛 338 | 🌐 Go | 📅 2025-08-20 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,249 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,744 | 🐛 126 | 🌐 Go | 📅 2025-08-20 - A modular-designed and easy-to-use microservices framework in Go.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,460 | 🐛 22 | 🌐 Go | 📅 2025-08-19 - A distributed systems development framework.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 22,113 | 🐛 141 | 🌐 Go | 📅 2025-08-21 - The Go language implementation of gRPC. HTTP/2 based RPC.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,818 | 🐛 433 | 🌐 Go | 📅 2025-08-21 - NATS is a simple, secure, and
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,729 | 🐛 46 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,612 | 🐛 62 | 🌐 Go | 📅 2025-08-21 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [lura](https://github.com/luraproject/lura) ⭐ 6,598 | 🐛 10 | 🌐 Go | 📅 2025-08-21 - Ultra performant API Gateway framework with middlewares.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,833 | 🐛 66 | 🌐 Go | 📅 2025-08-21 - BitTorrent client package.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,752 | 🐛 17 | 🌐 Go | 📅 2025-08-20 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,386 | 🐛 33 | 🌐 Go | 📅 2025-08-18 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
* [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,356 | 🐛 25 | 🌐 Go | 📅 2025-07-25 - A Go framework for the API or Microservice with handy scaffolding tools.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,069 | 🐛 87 | 🌐 Go | 📅 2025-08-21 - A cloud native Kubernetes Global Balancer.
...
* [raft](https://github.com/etcd-io/raft) ⭐ 896 | 🐛 70 | 🌐 Go | 📅 2025-08-19 - Go implementation of the Raft consensus protocol, by CoreOS.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 700 | 🐛 199 | 🌐 Go | 📅 2025-08-19 - Durable execution system for making code fault-tolerant and simple.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 658 | 🐛 36 | 🌐 Go | 📅 2025-08-22 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 382 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,451 | 🐛 360 | 🌐 C++ | 📅 2025-08-08).
* [jsonrpc](https://github.com/ybbus/jsonrpc) ⭐ 358 | 🐛 1 | 🌐 Go | 📅 2025-05-21 - JSON-RPC 2.0 HTTP client implementation.
* [Tarmac](https://github.com/tarmac-project/tarmac) ⭐ 336 | 🐛 8 | 🌐 Go | 📅 2025-08-21 - Framework for writing functions, microservices, or monoliths with WebAssembly
...
* [bedrock](https://github.com/z5labs/bedrock) ⭐ 13 | 🐛 5 | 🌐 Go | 📅 2025-08-21 - Provides a minimal, modular and composable foundation for quickly developing services and more use case specific frameworks in Go.
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,182 | 🐛 252 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,561 | 🐛 2 | 🌐 Go | 📅 2025-08-17 - Email and SMTP testing tool for developers.
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,648 | 🐛 132 | 🌐 Go | 📅 2025-07-18 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
* [mox](https://github.com/mjl-/mox) ⭐ 5,141 | 🐛 151 | 🌐 Go | 📅 2025-08-21 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,099 | 🐛 6 | 🌐 Go | 📅 2025-08-08 - A simple Go library for sending mails in Go.
...
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 10,105 | 🐛 197 | 🌐 Go | 📅 2025-08-21 - PHP embedded in Go, with a `net/http` handler.
* [expr](https://github.com/antonmedv/expr) ⭐ 7,117 | 🐛 49 | 🌐 Go | 📅 2025-08-12 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,707 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [goja](https://github.com/dop251/goja) ⭐ 6,385 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
...
* [cel-go](https://github.com/google/cel-go) ⭐ 2,647 | 🐛 52 | 🌐 Go | 📅 2025-08-18 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [oops](https://github.com/samber/oops) ⭐ 734 | 🐛 15 | 🌐 Go | 📅 2025-08-12 - Error handling with context, stack trace and source fragments.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,921 | 🐛 136 | 🌐 Go | 📅 2025-08-18 - PDF processor.
* [afero](https://github.com/spf13/afero) ⭐ 6,308 | 🐛 159 | 🌐 Go | 📅 2025-08-19 - FileSystem Abstraction System for Go.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 103 | 🐛 3 | 🌐 Go | 📅 2025-08-20 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 73,083 | 🐛 300 | 🌐 Go | 📅 2025-08-21).
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,465 | 🐛 35 | 🌐 Go | 📅 2025-08-03 - Terminal stock watcher and stock position tracker.
* [go-money](https://github.com/rhymond/go-money) ⭐ 1,793 | 🐛 25 | 🌐 Go | 📅 2025-04-30 - Implementation of Fowler's Money pattern.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,510 | 🐛 141 | 🌐 Go | 📅 2025-08-21 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
* [ledger](https://github.com/formancehq/ledger) ⭐ 1,017 | 🐛 11 | 🌐 Go | 📅 2025-08-21 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,356 | 🐛 297 | 🌐 Go | 📅 2025-08-19 - dead simple 2D game engine in Go.
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,135 | 🐛 6 | 🌐 C | 📅 2025-08-07 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
* [Pixel](https://github.com/gopxl/pixel) ⭐ 345 | 🐛 32 | 🌐 Go | 📅 2025-03-07 - Hand-crafted 2D game library in Go.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,498 | 🐛 713 | 🌐 Go | 📅 2025-08-20 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,778 | 🐛 32 | 🌐 Go | 📅 2025-08-21 - S2 geometry library in Go.
...
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 13,000 | 🐛 192 | 🌐 Go | 📅 2025-08-19 - Compiler from Go to JavaScript.
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,464 | 🐛 12 | 🌐 Go | 📅 2025-08-21 - Compile shell scripts to Go.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,915 | 🐛 0 | 🌐 Go | 📅 2025-08-08 - A high-performance and low-cost goroutine pool in Go.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,979 | 🐛 747 | 🌐 Go | 📅 2025-08-21 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
* [webview](https://github.com/zserge/webview) ⭐ 13,289 | 🐛 192 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [walk](https://github.com/lxn/walk) ⭐ 7,007 | 🐛 346 | 🌐 Go | 📅 2024-01-21 - Windows application library kit for Go.
...
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 441 | 🐛 21 | 🌐 C++ | 📅 2025-08-18 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 67,715 | 🐛 1,180 | 🌐 C++ | 📅 2025-08-20 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,707 | 🐛 17 | 🌐 Lua | 📅 2025-07-14.
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,325 | 🐛 137 | 🌐 Go | 📅 2025-08-03 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
* [systray](https://github.com/getlantern/systray) ⭐ 3,549 | 🐛 109 | 🌐 Go | 📅 2024-07-03 - Cross platform Go library to place an icon and menu in the notification area.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,627 | 🐛 223 | 🌐 Go | 📅 2025-08-21 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [imaginary](https://github.com/h2non/imaginary) ⭐ 5,903 | 🐛 133 | 🌐 Go | 📅 2025-01-14 - Fast and simple HTTP microservice for image resizing.
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,564 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
* [gg](https://github.com/fogleman/gg) ⭐ 4,649 | 🐛 94 | 🌐 Go | 📅 2023-12-14 - 2D rendering in pure Go.
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,121 | 🐛 20 | 🌐 Go | 📅 2024-09-24 - Collection of image processing algorithms in pure Go.
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,884 | 🐛 35 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
...
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,607 | 🐛 19 | 🌐 Go | 📅 2025-07-28 - Vector graphics to PDF, SVG or rasterized image.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 745 | 🐛 7 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,273 | 🐛 104 | 🌐 Go | 📅 2025-08-21 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,246 | 🐛 8 | 🌐 Go | 📅 2025-08-22 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,475 | 🐛 17 | 🌐 Go | 📅 2025-08-14 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,498 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
* [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,939 | 🐛 4 | 🌐 Go | 📅 2025-07-30 - Simple, zero-dependency scheduling library for Go.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,140 | 🐛 91 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [jsondiff](https://github.com/wI2L/jsondiff) ⭐ 596 | 🐛 0 | 🌐 Go | 📅 2025-08-15 - JSON diff library for Go based on RFC6902 (JSON Patch).
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,435 | 🐛 74 | 🌐 Go | 📅 2025-08-04 - Structured logger for Go.
* [zap](https://github.com/uber-go/zap) ⭐ 23,522 | 🐛 166 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,746 | 🐛 144 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [tint](https://github.com/lmittmann/tint) ⭐ 1,087 | 🐛 0 | 🌐 Go | 📅 2025-06-07 - A slog.Handler that writes tinted logs.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 647 | 🐛 3 | 🌐 Go | 📅 2025-05-29 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,435 | 🐛 74 | 🌐 Go | 📅 2025-08-04, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,249 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,522 | 🐛 166 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,746 | 🐛 144 | 🌐 Go | 📅 2025-04-18, etc).
...
* [logrusly](https://github.com/sebest/logrusly) ⭐ 29 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,435 | 🐛 74 | 🌐 Go | 📅 2025-08-04 plug-in to send errors to a [Loggly](https://www.loggly.com/).
...
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,435 | 🐛 74 | 🌐 Go | 📅 2025-08-04 logger.
...
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 866 | 🐛 2 | 🌐 Go | 📅 2025-08-21 - An accelerated Machine Learning framework for Go.
...
* [catboost-cgo](https://github.com/mirecl/catboost-cgo) ⭐ 18 | 🐛 6 | 🌐 C | 📅 2025-08-21 - Fast, scalable, high performance Gradient Boosting on Decision Trees library. Golang using Cgo for blazing fast inference CatBoost Model.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,165 | 🐛 56 | 🌐 Go | 📅 2025-08-20 - Go library for Apache Kafka.
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,846 | 🐛 253 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,784 | 🐛 98 | 🌐 Go | 📅 2025-08-20 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,819 | 🐛 245 | 🌐 Go | 📅 2025-08-21 - Asynchronous task queue/job queue based on distributed message passing.
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,098 | 🐛 157 | 🌐 Go | 📅 2025-08-21 - Go client for the NATS
  messaging system.
...
* [Mercure](https://github.com/dunglas/mercure) ⭐ 5,026 | 🐛 14 | 🌐 Go | 📅 2025-08-21 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,979 | 🐛 290 | 🌐 HTML | 📅 2025-08-22 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,900 | 🐛 27 | 🌐 Go | 📅 2024-06-19 - The lightweight event bus with async compatibility.
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,649 | 🐛 25 | 🌐 Go | 📅 2025-08-19 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/xuri/excelize) ⭐ 19,530 | 🐛 134 | 🌐 Go | 📅 2025-08-19 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [fx](https://github.com/uber-go/fx) ⭐ 6,799 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
* [dig](https://github.com/uber-go/dig) ⭐ 4,274 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [do](https://github.com/samber/do) ⭐ 2,256 | 🐛 36 | 🌐 Go | 📅 2025-08-21 - A dependency injection framework based on Generics.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,549 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,549 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 8,043 | 🐛 29 | 🌐 Go | 📅 2025-07-19 - Allows users to spin up a quick Go project using a popular framework.
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,851 | 🐛 1 | 🌐 Go | 📅 2025-08-20 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,851 | 🐛 1 | 🌐 Go | 📅 2025-08-20 for building production grade scalable web service applications.
...
* [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,809 | 🐛 3 | 🌐 Go | 📅 2025-08-15 - Rapid, easy full-stack web development starter kit built in Go.
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,357 | 🐛 2 | 🌐 Go | 📅 2025-08-11 - Nunu is a scaffolding tool for building Go applications.
...
* [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,163 | 🐛 12 | 🌐 Go | 📅 2025-07-25 - cross-platform, cli app to perform various operations on string.
...
* [bexp](https://github.com/happy-sdk/happy/tree/main/pkg/strings/bexp) ⭐ 21 | 🐛 0 | 🌐 Go | 📅 2025-08-21 - Go implementation of Brace Expansion mechanism to generate arbitrary strings.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,396 | 🐛 224 | 🌐 Go | 📅 2025-08-18 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,971 | 🐛 223 | 🌐 Go | 📅 2025-08-21 - Automated service health dashboard.
...
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,318 | 🐛 85 | 🌐 Go | 📅 2024-07-26 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
* [stateless](https://github.com/qmuntal/stateless) ⭐ 1,099 | 🐛 20 | 🌐 Go | 📅 2025-05-23 - A fluent library for creating state machines.
...
* [xz](https://github.com/ulikunitz/xz) ⭐ 521 | 🐛 17 | 🌐 Go | 📅 2025-08-21 - Pure golang package for reading and writing xz-compressed files.
...
* [archives](https://github.com/mholt/archives) ⭐ 295 | 🐛 8 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [gommit](https://github.com/antham/gommit) ⭐ 115 | 🐛 1 | 🌐 Go | 📅 2025-08-21 - Analyze git commit messages to ensure they follow defined patterns.
...
* [govader](https://github.com/jonreiter/govader) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2025-04-29 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,795 | 🐛 55 | 🌐 Python | 📅 2024-03-16.
...
* [gse](https://github.com/go-ego/gse) ⭐ 2,700 | 🐛 13 | 🌐 Go | 📅 2025-06-09 - Go efficient text segmentation; support english, chinese, japanese and other.
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,557 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,338 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,330 | 🐛 15 | 🌐 Go | 📅 2025-08-01 - Package and an accompanying tool to work with localized text.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,845 | 🐛 97 | 🌐 Go | 📅 2025-08-15 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,201 | 🐛 105 | 🌐 Go | 📅 2025-08-22 - A pure Go implementation of the WebRTC API.
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,212 | 🐛 133 | 🌐 Go | 📅 2025-08-13 - Extremely simple & fast udp tunnel based on KCP protocol.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 11,339 | 🐛 454 | 🌐 Go | 📅 2025-08-21 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,921 | 🐛 189 | 🌐 Go | 📅 2025-08-20 - An implementation of the QUIC protocol in pure Go.
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,746 | 🐛 4 | 🌐 Go | 📅 2025-08-10 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
* [dns](https://github.com/miekg/dns) ⭐ 8,466 | 🐛 5 | 🌐 Go | 📅 2025-08-18 - Go library for working with DNS.
* [gopacket](https://github.com/google/gopacket) ⭐ 6,599 | 🐛 359 | 🌐 Go | 📅 2025-03-19 - Go library for packet processing with libpcap bindings.
* [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,453 | 🐛 89 | 🌐 Go | 📅 2025-08-12 - A library to create a customized HTTP/HTTPS proxy server using Go.
* [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,401 | 🐛 27 | 🌐 Go | 📅 2025-06-17 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,302 | 🐛 65 | 🌐 Go | 📅 2025-07-31 - KCP - Fast and Reliable ARQ Protocol.
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 4,102 | 🐛 14 | 🌐 Go | 📅 2025-08-10 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,861 | 🐛 234 | 🌐 Go | 📅 2025-08-21 - BGP implemented in the Go Programming Language.
...
* [gws](https://github.com/lxzan/gws) ⭐ 1,597 | 🐛 0 | 🌐 Go | 📅 2025-07-25 - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,233 | 🐛 2 | 🌐 Go | 📅 2025-07-29 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 85 | 🐛 1 | 🌐 Go | 📅 2025-08-21 - Package bart provides a fast routing table algorithm.
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,156 | 🐛 44 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,183 | 🐛 73 | 🌐 Go | 📅 2025-08-18 - Retryable HTTP client in Go.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,733 | 🐛 476 | 🌐 Go | 📅 2025-08-20 - The fantastic ORM library for Golang, aims to be developer friendly.
* [ent](https://github.com/facebook/ent) ⭐ 16,471 | 🐛 597 | 🌐 Go | 📅 2025-08-14 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [bun](https://github.com/uptrace/bun) ⭐ 4,324 | 🐛 27 | 🌐 Go | 📅 2025-08-12 - SQL-first Golang ORM. Successor of go-pg.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,419 | 🐛 14 | 🌐 Go | 📅 2025-08-19 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,500 | 🐛 474 | 🌐 Go | 📅 2025-08-21 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,761 | 🐛 320 | 🌐 Go | 📅 2025-08-20 - A distributed tracing system.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,136 | 🐛 345 | 🌐 C++ | 📅 2025-08-13 - No instrumentation tracing for Golang applications via eBPF.
* [statsviz](https://github.com/arl/statsviz) ⭐ 3,455 | 🐛 9 | 🌐 Go | 📅 2025-08-08 - Live visualization of your Go application runtime statistics.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,443 | 🐛 376 | 🌐 Go | 📅 2025-08-21 - go generate based graphql server library.
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,096 | 🐛 238 | 🌐 Go | 📅 2025-07-28 - Implementation of GraphQL for Go.
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,532 | 🐛 48 | 🌐 Go | 📅 2025-08-21 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
* [graphql](https://github.com/neelance/graphql-go) ⭐ 4,711 | 🐛 28 | 🌐 Go | 📅 2025-08-21 - GraphQL server with a focus on ease of use.
...
* [gograph](https://github.com/hmdsefi/gograph) ⭐ 89 | 🐛 4 | 🌐 Go | 📅 2025-08-20 - A golang generic graph library that provides mathematical graph-theory and algorithms.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,513 | 🐛 49 | 🌐 Go | 📅 2025-08-18 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
* [lego](https://github.com/go-acme/lego) ⭐ 8,818 | 🐛 157 | 🌐 Go | 📅 2025-08-21 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,862 | 🐛 93 | 🌐 Go | 📅 2025-08-22 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
* [memguard](https://github.com/awnumar/memguard) ⭐ 2,655 | 🐛 11 | 🌐 Go | 📅 2025-07-14 - A pure Go library for handling sensitive values in memory.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,391 | 🐛 5 | 🌐 Go | 📅 2025-08-21 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [dongle](https://github.com/golang-module/dongle) ⭐ 993 | 🐛 3 | 🌐 Go | 📅 2025-08-22 - A simple, semantic and developer-friendly golang package for encoding\&decoding and encryption\&decryption.
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,999 | 🐛 116 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 917 | 🐛 26 | 🌐 Go | 📅 2025-08-19 - Small, safe, and easy CBOR encoding and decoding library.
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 66,296 | 🐛 214 | 🌐 Go | 📅 2025-08-21 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
* [minio](https://github.com/minio/minio) ⭐ 54,733 | 🐛 55 | 🌐 Go | 📅 2025-08-21 - Minio is a distributed object storage server.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 50,119 | 🐛 288 | 🌐 Go | 📅 2025-08-21 - Highly-available key value store for shared configuration and service discovery.
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 49,998 | 🐛 19 | 🌐 Go | 📅 2025-08-16 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,884 | 🐛 121 | 🌐 Go | 📅 2025-08-21 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,849 | 🐛 7 | 🌐 Go | 📅 2025-08-21 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,525 | 🐛 53 | 🌐 Go | 📅 2025-08-20 - A self contained feature flag solution written in Go and Vue.js
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,334 | 🐛 15 | 🌐 Go | 📅 2025-08-18 - Make SSH apps, just like that!
...
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,720 | 🐛 46 | 🌐 Go | 📅 2025-08-21 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,606 | 🐛 61 | 🌐 Go | 📅 2025-08-18 - A HTML templating language that has great developer tooling.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 25,048 | 🐛 372 | 🌐 Go | 📅 2025-08-18 - Sacred extension to the standard go testing package.
* [keploy](https://github.com/keploy/keploy) ⭐ 10,343 | 🐛 261 | 🌐 Go | 📅 2025-08-22 - Generate Testcase and Data Mocks from API calls automatically.
* [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,377 | 🐛 167 | 🌐 Go | 📅 2024-07-30 - BDD-style framework with web UI and live reload.
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,490 | 🐛 49 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
...
* [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,462 | 🐛 29 | 🌐 Go | 📅 2025-08-21 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-08-21 - HTTP client testing framework.
...
* [mockery](https://github.com/vektra/mockery) ⭐ 6,755 | 🐛 49 | 🌐 Go | 📅 2025-08-21 - Tool to generate Go interfaces.
...
* [minimock](https://github.com/gojuno/minimock) ⭐ 718 | 🐛 11 | 🌐 Go | 📅 2025-08-21 - Mock generator for Go interfaces.
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 514 | 🐛 2 | 🌐 Go | 📅 2025-08-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,330 | 🐛 239 | 🌐 Go | 📅 2025-08-09.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,164 | 🐛 148 | 🌐 Go | 📅 2025-08-05 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
* [rod](https://github.com/go-rod/rod) ⭐ 6,179 | 🐛 192 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,623 | 🐛 45 | 🌐 Go | 📅 2025-08-12 - Formatters for time, numbers, and memory size to human readable format.
...
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,271 | 🐛 12 | 🌐 Go | 📅 2025-07-22 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,005 | 🐛 18 | 🌐 Go | 📅 2025-08-11 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,998 | 🐛 96 | 🌐 Go | 📅 2025-08-18 - Shell parser and formatter.
...
* [godump](https://github.com/yassinebenaid/godump) ⭐ 218 | 🐛 3 | 🌐 Go | 📅 2025-08-21 - Pretty print any GO variable with ease, an alternative to Go's `fmt.Printf("%#v")`.
...
* [colly](https://github.com/asciimoo/colly) ⭐ 24,561 | 🐛 191 | 🌐 Go | 📅 2025-08-21 - Fast and Elegant Scraping Framework for Gophers.
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,668 | 🐛 4 | 🌐 Go | 📅 2025-08-12 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [github](https://github.com/google/go-github) ⭐ 10,911 | 🐛 50 | 🌐 Go | 📅 2025-08-18 - Go library for accessing the GitHub REST API v3.
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,257 | 🐛 214 | 🌐 Go | 📅 2025-08-12 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,311 | 🐛 17 | 🌐 Go | 📅 2025-08-21 - Auto-generated Google APIs for Go.
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,311 | 🐛 373 | 🌐 Go | 📅 2025-08-22 - Google Cloud APIs Go Client Library.
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,213 | 🐛 85 | 🌐 Go | 📅 2025-08-21 - The official AWS SDK for the Go programming language.
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,786 | 🐛 20 | 🌐 Go | 📅 2025-08-21 - Minio Go Library for Amazon S3 compatible cloud storage.
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,378 | 🐛 13 | 🌐 Go | 📅 2025-08-20 - Go client for the Stripe API.
...
* [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 170 | 🐛 14 | 🌐 Go | 📅 2025-08-21 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
* [gopensky](https://github.com/navidys/gopensky) ⭐ 2 | 🐛 1 | 🌐 Go | 📅 2025-08-21 - Go client implementation for [OpenSKY Network](https://opensky-network.org/) live's API (airspace ADS-B and Mode S data).
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 73,083 | 🐛 300 | 🌐 Go | 📅 2025-08-21 - Command-line fuzzy finder written in Go.
* [dive](https://github.com/wagoodman/dive) ⭐ 51,777 | 🐛 177 | 🌐 Go | 📅 2025-08-21 - A tool for exploring each layer in a Docker image.
...
* [lo](https://github.com/samber/lo) ⭐ 20,009 | 🐛 211 | 🌐 Go | 📅 2025-08-18 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,139 | 🐛 382 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,788 | 🐛 115 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 15,039 | 🐛 24 | 🌐 Go | 📅 2025-08-22 - Deliver Go binaries as fast and easily as possible.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,676 | 🐛 46 | 🌐 Go | 📅 2025-05-06 - Interactive cli tool for HTTP inspection.
* [usql](https://github.com/knq/usql) ⭐ 9,495 | 🐛 95 | 🌐 Go | 📅 2025-07-20 - usql is a universal command-line interface for SQL databases.
* [peco](https://github.com/peco/peco) ⭐ 7,781 | 🐛 52 | 🌐 Go | 📅 2025-06-21 - Simplistic interactive filtering tool.
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,165 | 🐛 7 | 🌐 Go | 📅 2025-08-21 - A comprehensive, efficient, and reusable util function library of go.
...
* [minify](https://github.com/tdewolff/minify) ⭐ 3,942 | 🐛 30 | 🌐 Go | 📅 2025-08-20 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
* [mergo](https://github.com/imdario/mergo) ⭐ 3,040 | 🐛 16 | 🌐 Go | 📅 2025-08-21 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
* [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,823 | 🐛 28 | 🌐 Go | 📅 2025-08-21 - Fault tolerance and resilience patterns for Go.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,228 | 🐛 57 | 🌐 Go | 📅 2025-08-05 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [delve](https://github.com/derekparker/delve) ⭐ 656 | 🐛 2 | 🌐 Go | 📅 2025-08-21 - Go debugger.
...
* [dbt](https://github.com/nikogura/dbt) ⭐ 69 | 🐛 6 | 🌐 Go | 📅 2025-08-22 - A framework for running self-updating signed binaries from a central, trusted repository.
...
* [ghokin](https://github.com/antham/ghokin) ⭐ 47 | 🐛 1 | 🌐 Go | 📅 2025-08-21 - Parallelized formatter with no external dependencies for gherkin (cucumber, behat...).
...
* [uuid](https://github.com/google/uuid) ⭐ 5,802 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,882 | 🐛 319 | 🌐 Go | 📅 2025-08-15 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
* [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,177 | 🐛 167 | 🌐 Go | 📅 2025-01-22 - Validators and sanitizers for strings, numerics, slices and structs.
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,988 | 🐛 58 | 🌐 Go | 📅 2024-03-23 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 948 | 🐛 7 | 🌐 Go | 📅 2025-07-23 - A [Zod](https://github.com/colinhacks/zod) ⭐ 39,620 | 🐛 261 | 🌐 TypeScript | 📅 2025-08-21 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,796 | 🐛 174 | 🌐 Go | 📅 2025-08-20 - highly extensible Git implementation in pure Go.
...
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 546 | 🐛 2 | 🌐 Go | 📅 2025-08-15 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
* [go-astiav](https://github.com/asticode/go-astiav) ⭐ 541 | 🐛 5 | 🌐 Go | 📅 2025-08-19 - Better C bindings for ffmpeg in GO.
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,675 | 🐛 873 | 🌐 Go | 📅 2025-08-12 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,434 | 🐛 86 | 🌐 Go | 📅 2025-08-21 - An Express.js inspired web framework build on Fasthttp.
* [Beego](https://github.com/beego/beego) ⭐ 32,212 | 🐛 20 | 🌐 Go | 📅 2025-08-21 - beego is an open-source, high-performance web framework for the Go programming language.
* [Echo](https://github.com/labstack/echo) ⭐ 31,428 | 🐛 110 | 🌐 Go | 📅 2025-08-12 - High performance, minimalist Go web framework.
* [Revel](https://github.com/revel/revel) ⭐ 13,222 | 🐛 99 | 🌐 Go | 📅 2023-10-28 - High-productivity web framework for the Go language.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,648 | 🐛 232 | 🌐 Go | 📅 2025-08-21 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 12,572 | 🐛 85 | 🌐 Go | 📅 2025-08-21 - Gofr is an opinionated microservice development framework.
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,638 | 🐛 38 | 🌐 Go | 📅 2025-08-21 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,984 | 🐛 55 | 🌐 Go | 📅 2025-08-21 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,332 | 🐛 136 | 🌐 Go | 📅 2025-08-05 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
* [templui](https://github.com/axzilla/templui) ⭐ 878 | 🐛 1 | 🌐 JavaScript | 📅 2025-08-21 - Modern UI Components for Go & Templ.
...
* [Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) ⭐ 575 | 🐛 27 | 🌐 Go | 📅 2025-08-21 - Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,539 | 🐛 34 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
* [chi](https://github.com/go-chi/chi) ⭐ 20,368 | 🐛 86 | 🌐 Go | 📅 2025-08-15 - Small, fast and expressive HTTP router built on net/context.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,591 | 🐛 522 | 🌐 Go | 📅 2025-08-20 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,163 | 🐛 115 | 🌐 Go | 📅 2025-08-11 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 239 | 🐛 13 | 🌐 Go | 📅 2025-08-19 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [go-ole](https://github.com/go-ole/go-ole) ⭐ 1,260 | 🐛 7 | 🌐 Go | 📅 2025-04-21 - Win32 OLE implementation for golang.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,541 | 🐛 114 | 🌐 Go | 📅 2025-08-21 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,149 | 🐛 265 | 🌐 Go | 📅 2025-08-21 - Container Signing, Verification and Storage in an OCI registry.
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,526 | 🐛 256 | 🌐 Go | 📅 2025-08-21 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 111 | 🐛 21 | 🌐 Go | 📅 2025-08-20 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
* [Spire](https://github.com/spiffe/spire) ⭐ 2,026 | 🐛 159 | 🌐 Go | 📅 2025-08-21 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,526 | 🐛 114 | 🌐 Go | 📅 2025-08-21 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,548 | 🐛 586 | 🌐 Go | 📅 2025-08-08 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [revive](https://github.com/mgechev/revive) ⭐ 5,269 | 🐛 70 | 🌐 Go | 📅 2025-08-18 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 1,986 | 🐛 137 | 🌐 Go | 📅 2025-08-17 - source code linter that brings checks that are currently not implemented in other linters.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 821 | 🐛 68 | 🌐 Go | 📅 2025-08-20 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 150 | 🐛 39 | 🌐 Go | 📅 2025-08-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 25,048 | 🐛 372 | 🌐 Go | 📅 2025-08-18.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 14 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,779 | 🐛 102 | 🌐 Go | 📅 2025-08-21 features to Vim/Neovim.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 117,002 | 🐛 2,631 | 🌐 Go | 📅 2025-08-21 - Container Cluster Manager from Google.
* [Moby](https://github.com/moby/moby) ⭐ 70,508 | 🐛 3,668 | 🌐 Go | 📅 2025-08-21 - Collaborative project for the container ecosystem to assemble container-based systems.
* [traefik](https://github.com/containous/traefik) ⭐ 56,166 | 🐛 674 | 🌐 Go | 📅 2025-08-21 - Reverse proxy and load balancer with support for multiple backends.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 50,256 | 🐛 2,779 | 🌐 Go | 📅 2025-08-21 - Fork of Gogs, entirely community driven.
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,840 | 🐛 550 | 🌐 Go | 📅 2025-08-21 - Run Kubernetes locally.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,567 | 🐛 129 | 🌐 Go | 📅 2025-08-21 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,563 | 🐛 753 | 🌐 Go | 📅 2025-08-21 - A modern load testing tool, using Go and JavaScript.
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,470 | 🐛 95 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
* [Hey](https://github.com/rakyll/hey) ⭐ 19,187 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,438 | 🐛 297 | 🌐 Go | 📅 2025-08-22 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,460 | 🐛 213 | 🌐 Go | 📅 2025-08-21 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,472 | 🐛 141 | 🌐 Go | 📅 2025-08-18 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,180 | 🐛 217 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,212 | 🐛 25 | 🌐 Go | 📅 2025-08-20 - Flannel is a network fabric for containers, designed for Kubernetes.
...
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,814 | 🐛 556 | 🌐 Go | 📅 2025-08-20 - Cloud native application delivery.
...
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,475 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,969 | 🐛 252 | 🌐 Go | 📅 2025-07-29 - Little helper to run CNCF's k3s in Docker.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,676 | 🐛 30 | 🌐 Go | 📅 2025-08-21 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,423 | 🐛 2,664 | 🌐 Go | 📅 2025-08-22 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,233 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [tau](https://github.com/taubyte/tau) ⭐ 4,420 | 🐛 34 | 🌐 Go | 📅 2025-08-21 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,417 | 🐛 136 | 🌐 Go | 📅 2025-08-21 - Pomerium is an identity-aware access proxy.
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,529 | 🐛 147 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [bosun](https://github.com/bosun-monitor/bosun) ⚠️ Archived - Time Series Alerting Framework.
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,793 | 🐛 148 | 🌐 Go | 📅 2025-08-22 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,797 | 🐛 12 | 🌐 Go | 📅 2025-08-21 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
...
* [uTask](https://github.com/ovh/utask) ⭐ 1,312 | 🐛 62 | 🌐 Go | 📅 2025-08-21 - Automation engine that models and executes business processes declared in yaml.
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,208 | 🐛 120 | 🌐 Go | 📅 2025-08-21 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,201 | 🐛 0 | 🌐 Go | 📅 2025-08-21 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 929 | 🐛 203 | 🌐 Go | 📅 2025-08-21 - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 387 | 🐛 12 | 🌐 Go | 📅 2025-08-20 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
* [croc](https://github.com/schollz/croc) ⭐ 30,881 | 🐛 11 | 🌐 Go | 📅 2025-08-12 - Easily and securely send files or folders from one computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,744 | 🐛 492 | 🌐 Go | 📅 2025-08-07 - De-duplicating backup program.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,570 | 🐛 610 | 🌐 Go | 📅 2025-08-21 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 12,048 | 🐛 142 | 🌐 Go | 📅 2025-08-21 - Distributed POSIX file system built on top of Redis and AWS S3.
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,436 | 🐛 92 | 🌐 Go | 📅 2025-08-18 - Proxy to simulate network and system conditions for automated tests.
...
* [scc](https://github.com/boyter/scc) ⭐ 7,581 | 🐛 55 | 🌐 Go | 📅 2025-08-22 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,551 | 🐛 72 | 🌐 Go | 📅 2025-08-21 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,210 | 🐛 34 | 🌐 Go | 📅 2025-08-09 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,432 | 🐛 5 | 🌐 Go | 📅 2025-06-18 - Executing shell commands via http server (for prototyping or remote control).
...
* [GoNB](https://github.com/janpfeifer/gonb) ⭐ 901 | 🐛 10 | 🌐 Go | 📅 2025-08-11 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,411 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,201 | 🐛 7,592 | 🌐 Go | 📅 2025-08-22
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 129,516 | 🐛 9,508 | 🌐 Go | 📅 2025-08-22 - List of projects on the Go community wiki.
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 39,505 | 🐛 6 | 📅 2025-07-30 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,804 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,768 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,787 | 🐛 66 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 23,081 | 🐛 67 | 🌐 Go | 📅 2025-08-21 - Learn Go with test-driven development.
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,442 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,690 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 7,016 | 🐛 10 | 🌐 Go | 📅 2025-08-21 - Clean Architecture template for Golang services.
...
* [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) ⭐ 1,045 | 🐛 5 | 🌐 Go | 📅 2025-08-22 - A GitHub repository offering coding challenges for Go technical interview preparation.
