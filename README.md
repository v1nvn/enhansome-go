...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 146,783 | 🐛 125 | 🌐 Go | 📅 2025-06-29
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 378,761 | 🐛 41 | 📅 2025-07-05
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 249,123 | 🐛 475 | 🌐 Python | 📅 2025-07-05.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 146,783 | 🐛 125 | 🌐 Go | 📅 2025-06-29 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 146,783 | 🐛 125 | 🌐 Go | 📅 2025-06-29; you rock!
...
* [Ergo](https://github.com/ergo-services/ergo) ⭐ 4,012 | 🐛 4 | 🌐 Go | 📅 2025-07-04 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 261 | 🐛 1 | 🌐 Go | 📅 2025-07-05 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
...
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,259 | 🐛 87 | 🌐 Go | 📅 2024-08-22 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 620 | 🐛 11 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
* [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,046 | 🐛 366 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,690 | 🐛 477 | 🌐 Go | 📅 2025-07-05 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 145,666 | 🐛 1,858 | 🌐 Go | 📅 2025-07-06 - Run large language models locally.
...
* [PortAudio](https://github.com/gordonklaus/portaudio) ⭐ 775 | 🐛 6 | 🌐 Go | 📅 2025-02-06 - Go bindings for the PortAudio audio I/O library.
...
* [authboss](https://github.com/volatiletech/authboss) ⭐ 3,988 | 🐛 41 | 🌐 Go | 📅 2025-06-26 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,832 | 🐛 49 | 🌐 Go | 📅 2025-06-21 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [go-jose](https://github.com/go-jose/go-jose) ⭐ 414 | 🐛 32 | 🌐 Go | 📅 2025-06-26 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
* [gorbac](https://github.com/mikespook/gorbac) ⭐ 1,634 | 🐛 4 | 🌐 Go | 📅 2024-07-22 - provides a lightweight role-based access control (RBAC) implementation in Golang.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,079 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,230 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
* [keto](https://github.com/ory/keto) ⭐ 5,056 | 🐛 57 | 🌐 Go | 📅 2025-07-04 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [openfga](https://github.com/openfga/openfga) ⭐ 3,789 | 🐛 131 | 🌐 Go | 📅 2025-07-06 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [scs](https://github.com/alexedwards/scs) ⭐ 2,356 | 🐛 29 | 🌐 Go | 📅 2025-04-17 - Session Manager for HTTP servers.
...
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,640 | 🐛 273 | 🌐 Go | 📅 2025-07-04 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 973 | 🐛 792 | 🌐 Go | 📅 2025-07-05 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,238 | 🐛 317 | 🌐 Go | 📅 2025-07-05 - Official Go implementation of the Ethereum protocol.
...
* [gossamer](https://github.com/ChainSafe/gossamer) ⭐ 451 | 🐛 392 | 🌐 Go | 📅 2025-07-05 - A Go implementation of the Polkadot Host.
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,552 | 🐛 1,105 | 🌐 Go | 📅 2025-07-03 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,963 | 🐛 814 | 🌐 Go | 📅 2025-07-04 - A complete implementation of a Lightning Network node.
...
* [arikawa](https://github.com/diamondburned/arikawa) ⭐ 525 | 🐛 35 | 🌐 Go | 📅 2025-07-03 - A library and framework for the Discord API.
* [bot](https://github.com/go-telegram/bot) ⭐ 1,215 | 🐛 13 | 🌐 Go | 📅 2025-05-21 - Zero-dependencies Telegram Bot library with additional UI components
...
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,382 | 🐛 55 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,193 | 🐛 168 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
* [wayback](https://github.com/wabarc/wayback) ⭐ 1,992 | 🐛 55 | 🌐 Go | 📅 2025-07-05 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [Task](https://github.com/go-task/task) ⭐ 13,068 | 🐛 394 | 🌐 Go | 📅 2025-07-03 - simple "Make" alternative.
* [taskctl](https://github.com/taskctl/taskctl) ⭐ 312 | 🐛 6 | 🌐 Go | 📅 2025-01-18 - Concurrent task runner.
* [xc](https://github.com/joerdav/xc) ⭐ 1,300 | 🐛 16 | 🌐 Go | 📅 2025-07-04 - Task runner with README.md defined tasks, executable markdown.
...
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,534 | 🐛 153 | 🌐 Go | 📅 2025-06-29 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,920 | 🐛 121 | 🌐 Go | 📅 2025-07-03 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,652 | 🐛 5 | 🌐 Go | 📅 2025-06-25 - Terminal JSON viewer & processor.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,382 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,797 | 🐛 673 | 🌐 Python | 📅 2025-07-03.
...
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,207 | 🐛 87 | 🌐 Go | 📅 2025-07-04 - Declaratively define styles for color, format and layout in the terminal.
...
* [mpb](https://github.com/vbauerster/mpb) ⭐ 2,411 | 🐛 17 | 🌐 Go | 📅 2025-06-05 - Multi progress bar for terminal applications.
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,434 | 🐛 13 | 🌐 Go | 📅 2025-02-08 - Basic thread-safe progress bar that works in every OS.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,132 | 🐛 59 | 🌐 Go | 📅 2025-06-07 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,844 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,377 | 🐛 105 | 🌐 Go | 📅 2024-07-22.
* [termenv](https://github.com/muesli/termenv) ⭐ 1,855 | 🐛 37 | 🌐 Go | 📅 2025-05-05 - Advanced ANSI style & color support for your terminal applications.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 725 | 🐛 40 | 🌐 Go | 📅 2025-07-01 - Command argument completion generator for spf13/cobra.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,334 | 🐛 74 | 🌐 Go | 📅 2025-07-02 - Multi-shell multi-command argument completer.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,039 | 🐛 318 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [elvish](https://github.com/elves/elvish) ⭐ 6,051 | 🐛 337 | 🌐 Go | 📅 2025-06-29 - An expressive programming language and a versatile interactive shell.
...
* [goopt](https://github.com/napalu/goopt) ⭐ 3 | 🐛 0 | 🌐 Go | 📅 2025-07-04 - A declarative, struct-tag based CLI framework for Go, with a broad feature set such as hierarchical commands/flags, i18n, shell completion, and validation.
...
* [pflag](https://github.com/spf13/pflag) ⭐ 2,587 | 🐛 177 | 🌐 Go | 📅 2025-06-28 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,310 | 🐛 50 | 🌐 Go | 📅 2025-06-14 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,450 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,256 | 🐛 56 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,282 | 🐛 11 | 🌐 Go | 📅 2025-06-30 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,311 | 🐛 24 | 🌐 Go | 📅 2025-06-19 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,810 | 🐛 518 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
...
* [drone](https://github.com/drone/drone) ⭐ 32,934 | 🐛 74 | 🌐 Go | 📅 2025-07-04 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 157 | 🐛 6 | 🌐 Go | 📅 2025-07-04 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,568 | 🐛 25 | 🌐 Go | 📅 2025-07-03 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,799 | 🐛 89 | 🌐 Rust | 📅 2025-07-05.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,213 | 🐛 344 | 🌐 Go | 📅 2025-07-05 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,394 | 🐛 528 | 🌐 Go | 📅 2025-07-04 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,133 | 🐛 133 | 🌐 Go | 📅 2025-07-03 - A high-performance ELT data integration framework with pluggable architecture.
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,727 | 🐛 72 | 🌐 Go | 📅 2025-06-28 - Go package implementing compressed bitsets.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,785 | 🐛 79 | 🌐 TypeScript | 📅 2025-07-05 - Distributed, Fault-tolerant task queue.
...
* [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 415 | 🐛 3 | 🌐 Go | 📅 2025-05-19 - Implementation to calculate levenshtein distance in Go.
...
* [EchoVault](https://github.com/EchoVault/EchoVault) ⭐ 494 | 🐛 20 | 🌐 Go | 📅 2025-04-24 - Embeddable Distributed in-memory data store compatible with Redis clients.
* [fastcache](https://github.com/VictoriaMetrics/fastcache) ⭐ 2,236 | 🐛 49 | 🌐 Go | 📅 2025-06-03 - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
...
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,204 | 🐛 42 | 🌐 Go | 📅 2024-11-29 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,114 | 🐛 3 | 🌐 Go | 📅 2025-07-05 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [theine](https://github.com/Yiling-J/theine-go) ⭐ 329 | 🐛 6 | 🌐 Go | 📅 2025-03-02 - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
* [timedmap](https://github.com/zekroTJA/timedmap) ⭐ 75 | 🐛 0 | 🌐 Go | 📅 2024-05-05 - Map with expiring key-value pairs.
* [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,101 | 🐛 15 | 🌐 Go | 📅 2025-07-05 - An in-memory cache with item expiration and generics.
* [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2022-10-02 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

* [badger](https://github.com/dgraph-io/badger) ⭐ 14,730 | 🐛 30 | 🌐 Go | 📅 2025-07-03 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,893 | 🐛 48 | 🌐 Go | 📅 2025-07-04 - An embedded key/value database for Go.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,044 | 🐛 7,323 | 🌐 Go | 📅 2025-07-06 - Scalable, Geo-Replicated, Transactional Datastore.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,839 | 🐛 432 | 🌐 Go | 📅 2025-07-05 - Dolt – It's Git for Data.
...
* [godis](https://github.com/hdt3213/godis) ⭐ 3,713 | 🐛 16 | 🌐 Go | 📅 2025-07-05 - A Golang implemented high-performance Redis server and cluster.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,283 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,821 | 🐛 362 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 8,769 | 🐛 134 | 🌐 Go | 📅 2025-05-30 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,273 | 🐛 2,113 | 🌐 Rust | 📅 2025-07-04 - Scalable datastore for metrics, events, and real-time analytics.
...
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,802 | 🐛 705 | 🌐 Go | 📅 2025-07-04 - Milvus is a vector database for embedding management, analytics and search.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,366 | 🐛 298 | 🌐 Go | 📅 2025-07-05 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,325 | 🐛 731 | 🌐 Go | 📅 2025-07-04 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,843 | 🐛 3 | 🌐 Go | 📅 2025-07-04 - Redis re-implemented with SQLite.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,736 | 🐛 76 | 🌐 Go | 📅 2025-07-06 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,679 | 🐛 5,198 | 🌐 Go | 📅 2025-07-05 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,461 | 🐛 952 | 🌐 Go | 📅 2025-07-05 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 7,001 | 🐛 219 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,695 | 🐛 121 | 🌐 Go | 📅 2025-07-06 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,107 | 🐛 29 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,660 | 🐛 97 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,934 | 🐛 434 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,324 | 🐛 18 | 🌐 Go | 📅 2025-07-04 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,346 | 🐛 90 | 🌐 Go | 📅 2025-04-17 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,779 | 🐛 152 | 🌐 Go | 📅 2025-07-04 - Go toolset to handle MySQL protocol and replication.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,191 | 🐛 1 | 🌐 Go | 📅 2025-06-30 - Advanced scheduling for PostgreSQL.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,938 | 🐛 36 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
...
* [rdb](https://github.com/HDT3213/rdb) ⭐ 544 | 🐛 4 | 🌐 Go | 📅 2025-06-29 - Redis RDB file parser for secondary development and memory analysis.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,804 | 🐛 875 | 🌐 Go | 📅 2025-07-05 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,259 | 🐛 41 | 🌐 Go | 📅 2025-07-03 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,434 | 🐛 611 | 🌐 Go | 📅 2025-07-02 - Generate type-safe code from SQL.
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,492 | 🐛 91 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,911 | 🐛 62 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,089 | 🐛 233 | 🌐 Go | 📅 2025-06-26 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,089 | 🐛 233 | 🌐 Go | 📅 2025-06-26 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,440 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 166 | 🐛 246 | 🌐 Go | 📅 2025-07-04 - native and database/sql driver YDB (Yandex Database)
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,386 | 🐛 8 | 🌐 Go | 📅 2025-07-02 - Official MongoDB driver for the Go language.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,041 | 🐛 95 | 🌐 Go | 📅 2025-07-05 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,712 | 🐛 25 | 🌐 Go | 📅 2025-07-05 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
* [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,091 | 🐛 92 | 🌐 Go | 📅 2025-07-03 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,904 | 🐛 82 | 🌐 Go | 📅 2025-07-01 - Official Elasticsearch client for Go.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 995 | 🐛 23 | 🌐 Go | 📅 2025-06-27 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,090 | 🐛 1 | 🌐 Go | 📅 2025-07-05 - A simple, semantic and developer-friendly time package for golang.
...
* [now](https://github.com/jinzhu/now) ⭐ 4,539 | 🐛 13 | 🌐 Go | 📅 2025-06-09 - Now is a time toolkit for golang.
...
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,196 | 🐛 52 | 🌐 Go | 📅 2024-07-12 - A feature complete and high performance multi-group Raft library in Go.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,653 | 🐛 28 | 🌐 Go | 📅 2025-07-03 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,143 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,378 | 🐛 19 | 🌐 Go | 📅 2025-07-02 - A distributed systems development framework.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,364 | 🐛 359 | 🌐 Go | 📅 2025-07-04 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,987 | 🐛 137 | 🌐 Go | 📅 2025-07-02 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,052 | 🐛 88 | 🌐 Go | 📅 2025-07-05 - A cloud native Kubernetes Global Balancer.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,515 | 🐛 54 | 🌐 Go | 📅 2025-07-04 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
...
* [micro](https://github.com/micro/micro) ⭐ 12,266 | 🐛 7 | 🌐 Go | 📅 2025-07-02 - A distributed systems runtime for the cloud and beyond.
...
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,440 | 🐛 462 | 🌐 Go | 📅 2025-07-04 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 616 | 🐛 58 | 🌐 Go | 📅 2025-07-04 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,671 | 🐛 44 | 🌐 Go | 📅 2025-07-01 - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
* [redis-lock](https://github.com/bsm/redislock) ⭐ 1,632 | 🐛 3 | 🌐 Go | 📅 2025-06-09 - Simplified distributed locking implementation using Redis.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,333 | 🐛 356 | 🌐 C++ | 📅 2025-06-26).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,080 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,804 | 🐛 63 | 🌐 Go | 📅 2025-07-03 - BitTorrent client package.
* [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 982 | 🐛 8 | 🌐 Go | 📅 2025-04-18 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
* [email](https://github.com/jordan-wright/email) ⭐ 2,738 | 🐛 54 | 🌐 Go | 📅 2024-02-21 - A robust and flexible email library for Go.
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,396 | 🐛 31 | 🌐 Go | 📅 2025-07-04 - A Go library for email verification without sending any emails.
...
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,587 | 🐛 130 | 🌐 Go | 📅 2025-04-16 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,013 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,313 | 🐛 0 | 🌐 Go | 📅 2025-07-02 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,051 | 🐛 147 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,641 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,603 | 🐛 49 | 🌐 Go | 📅 2025-07-01 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,982 | 🐛 45 | 🌐 Go | 📅 2025-07-05 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,555 | 🐛 173 | 🌐 Go | 📅 2025-07-05 - PHP embedded in Go, with a `net/http` handler.
...
* [goja](https://github.com/dop251/goja) ⭐ 6,260 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [golua](https://github.com/aarzilli/golua) ⭐ 674 | 🐛 9 | 🌐 C | 📅 2025-02-17 - Go bindings for Lua C API.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,641 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [gval](https://github.com/PaesslerAG/gval) ⭐ 792 | 🐛 24 | 🌐 Go | 📅 2024-11-28 - A highly customizable expression language written in Go.
* [metacall](https://github.com/metacall/core) ⭐ 1,662 | 🐛 53 | 🌐 C | 📅 2025-07-02 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
* [tengo](https://github.com/d5/tengo) ⭐ 3,661 | 🐛 84 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,587 | 🐛 6 | 🌐 Go | 📅 2025-07-05 - The Wa Programming Language embedded in Go.
...
* [eris](https://github.com/rotisserie/eris) ⭐ 1,677 | 🐛 5 | 🌐 Go | 📅 2025-04-03 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
* [errors](https://github.com/cockroachdb/errors) ⭐ 2,246 | 🐛 18 | 🌐 Go | 📅 2025-05-16 - Go error library with error portability over the network.
...
* [oops](https://github.com/samber/oops) ⭐ 705 | 🐛 15 | 🌐 Go | 📅 2025-07-05 - Error handling with context, stack trace and source fragments.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 98 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,524 | 🐛 290 | 🌐 Go | 📅 2025-07-06).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,593 | 🐛 51 | 🌐 Go | 📅 2025-07-02 - Disk usage analyzer with console interface.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,774 | 🐛 127 | 🌐 Go | 📅 2025-06-28 - PDF processor.
...
* [vfs](https://github.com/C2FO/vfs) ⭐ 342 | 🐛 9 | 🌐 Go | 📅 2025-05-12 - A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS.
...
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,380 | 🐛 135 | 🌐 Go | 📅 2025-07-05 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,829 | 🐛 142 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
...
* [ledger](https://github.com/formancehq/ledger) ⭐ 989 | 🐛 7 | 🌐 Go | 📅 2025-07-04 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [mo](https://github.com/samber/mo) ⭐ 3,016 | 🐛 23 | 🌐 Go | 📅 2025-07-05 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,197 | 🐛 303 | 🌐 Go | 📅 2025-07-05 - dead simple 2D game engine in Go.
...
* [Leaf](https://github.com/name5566/leaf) ⭐ 5,422 | 🐛 24 | 🌐 Go | 📅 2024-05-23 - Lightweight game server framework.
...
* [prototype](https://github.com/gonutz/prototype) ⭐ 90 | 🐛 1 | 🌐 C | 📅 2025-07-05 - Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API.
...
* [goverter](https://github.com/jmattheis/goverter) ⭐ 713 | 🐛 16 | 🌐 Go | 📅 2025-06-21 - Generate converters by defining an interface.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,292 | 🐛 691 | 🌐 Go | 📅 2025-06-29 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,759 | 🐛 36 | 🌐 Go | 📅 2025-07-04 - S2 geometry library in Go.
...
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,425 | 🐛 13 | 🌐 Go | 📅 2025-05-18 - Compile shell scripts to Go.
...
* [go2hx](https://github.com/go2hx/go2hx) ⭐ 136 | 🐛 31 | 🌐 Haxe | 📅 2025-07-05 - Compiler from Go to Haxe to Javascript/C++/Java/C#.
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,990 | 🐛 191 | 🌐 Go | 📅 2025-06-16 - Compiler from Go to JavaScript.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,804 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,720 | 🐛 42 | 🌐 Go | 📅 2025-04-16 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 421 | 🐛 18 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,645 | 🐛 1,171 | 🌐 C++ | 📅 2025-07-05 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,677 | 🐛 17 | 🌐 Lua | 📅 2025-07-01.
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,033 | 🐛 227 | 🌐 Go | 📅 2025-07-06 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
* [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,273 | 🐛 37 | 🌐 Go | 📅 2025-03-08 - Build native macOS applications using Go.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,700 | 🐛 741 | 🌐 Go | 📅 2025-07-05 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [gotk3](https://github.com/gotk3/gotk3) ⭐ 2,170 | 🐛 124 | 🌐 Go | 📅 2024-08-08 - Go bindings for GTK3.
...
* [webview](https://github.com/zserge/webview) ⭐ 13,204 | 🐛 190 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [systray](https://github.com/getlantern/systray) ⭐ 3,504 | 🐛 109 | 🌐 Go | 📅 2024-07-03 - Cross platform Go library to place an icon and menu in the notification area.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,590 | 🐛 216 | 🌐 Go | 📅 2025-07-04 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,117 | 🐛 20 | 🌐 Go | 📅 2024-09-24 - Collection of image processing algorithms in pure Go.
* [bimg](https://github.com/h2non/bimg) ⭐ 2,881 | 🐛 175 | 🌐 Go | 📅 2025-01-23 - Small package for fast and efficient image processing using libvips.
* [cameron](https://github.com/aofei/cameron) ⭐ 128 | 🐛 0 | 🌐 Go | 📅 2025-05-17 - An avatar generator for Go.
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,591 | 🐛 19 | 🌐 Go | 📅 2025-05-08 - Vector graphics to PDF, SVG or rasterized image.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 724 | 🐛 6 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,129 | 🐛 344 | 🌐 Go | 📅 2025-07-05 - Go package for computer vision using OpenCV 3.3+.
...
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,832 | 🐛 32 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
...
* [imaginary](https://github.com/h2non/imaginary) ⭐ 5,873 | 🐛 132 | 🌐 Go | 📅 2025-01-14 - Fast and simple HTTP microservice for image resizing.
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,516 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
* [imagor](https://github.com/cshum/imagor) ⭐ 3,661 | 🐛 39 | 🌐 Go | 📅 2025-06-30 - Fast, secure image processing server and Go library, using libvips.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,209 | 🐛 102 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,187 | 🐛 8 | 🌐 Go | 📅 2025-07-05 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,341 | 🐛 17 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,024 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,351 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,351 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,351 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,351 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,143 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,313 | 🐛 164 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,574 | 🐛 139 | 🌐 Go | 📅 2025-04-18, etc).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,149 | 🐛 100 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [zap](https://github.com/uber-go/zap) ⭐ 23,313 | 🐛 164 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,574 | 🐛 139 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [catboost-cgo](https://github.com/mirecl/catboost-cgo) ⭐ 16 | 🐛 5 | 🌐 C | 📅 2025-07-04 - Fast, scalable, high performance Gradient Boosting on Decision Trees library. Golang using Cgo for blazing fast inference CatBoost Model.
...
* [goml](https://github.com/cdipaolo/goml) ⭐ 1,594 | 🐛 4 | 🌐 Go | 📅 2022-07-15 - On-line Machine Learning in Go.
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 823 | 🐛 2 | 🌐 Go | 📅 2025-07-04 - An accelerated Machine Learning framework for Go.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,798 | 🐛 111 | 🌐 Go | 📅 2024-08-12 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,801 | 🐛 18 | 🌐 Go | 📅 2025-07-02 - Go RabbitMQ Client Library.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,077 | 🐛 22 | 🌐 Go | 📅 2025-07-04 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,925 | 🐛 284 | 🌐 HTML | 📅 2025-07-05 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,885 | 🐛 27 | 🌐 Go | 📅 2024-06-19 - The lightweight event bus with async compatibility.
...
* [Go-MediatR](https://github.com/mehdihadeli/Go-MediatR) ⭐ 246 | 🐛 2 | 🌐 Go | 📅 2025-05-08 - A library for handling mediator patterns and simplified CQRS patterns within an event-driven architecture, inspired by csharp MediatR library.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,417 | 🐛 58 | 🌐 Go | 📅 2025-07-05 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,095 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,774 | 🐛 244 | 🌐 Go | 📅 2025-06-30 - Asynchronous task queue/job queue based on distributed message passing.
...
* [Mercure](https://github.com/dunglas/mercure) ⭐ 4,974 | 🐛 25 | 🌐 Go | 📅 2025-06-27 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,002 | 🐛 187 | 🌐 Go | 📅 2025-06-30 - Go client for the NATS
  messaging system.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,069 | 🐛 63 | 🌐 Go | 📅 2025-07-04 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,619 | 🐛 123 | 🌐 Go | 📅 2025-07-03 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [excelize](https://github.com/xuri/excelize) ⭐ 19,330 | 🐛 126 | 🌐 Go | 📅 2025-07-05 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [do](https://github.com/samber/do) ⭐ 2,184 | 🐛 45 | 🌐 Go | 📅 2025-07-05 - A dependency injection framework based on Generics.
* [fx](https://github.com/uber-go/fx) ⭐ 6,628 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
...
* [google/wire](https://github.com/google/wire) ⭐ 13,913 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,813 | 🐛 1 | 🌐 Go | 📅 2025-06-26 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,813 | 🐛 1 | 🌐 Go | 📅 2025-06-26 for building production grade scalable web service applications.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,755 | 🐛 46 | 🌐 Go | 📅 2025-07-06 - Allows users to spin up a quick Go project using a popular framework.
...
* [go-starter](https://github.com/allaboutapps/go-starter) ⭐ 559 | 🐛 6 | 🌐 Go | 📅 2025-04-09 - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,974 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,974 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
...
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,288 | 🐛 0 | 🌐 Go | 📅 2025-06-14 - Nunu is a scaffolding tool for building Go applications.
* [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,560 | 🐛 2 | 🌐 Go | 📅 2025-06-24 - Rapid, easy full-stack web development starter kit built in Go.
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,255 | 🐛 6 | 🌐 Go | 📅 2025-06-25 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,638 | 🐛 220 | 🌐 Go | 📅 2025-07-03 - Automated service health dashboard.
...
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,982 | 🐛 13 | 🌐 Go | 📅 2025-06-26 - Random data generator written in go.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,286 | 🐛 211 | 🌐 Go | 📅 2025-07-02 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [llvm](https://github.com/llir/llvm) ⭐ 1,228 | 🐛 18 | 🌐 Go | 📅 2024-12-06 - Library for interacting with LLVM IR in pure Go.
...
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,279 | 🐛 83 | 🌐 Go | 📅 2024-07-26 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
* [govader](https://github.com/jonreiter/govader) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2025-04-29 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,756 | 🐛 55 | 🌐 Python | 📅 2024-03-16.
...
* [kagome](https://github.com/ikawaha/kagome) ⭐ 881 | 🐛 4 | 🌐 Go | 📅 2025-06-18 - JP morphological analyzer written in pure Go.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,282 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Package and an accompanying tool to work with localized text.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 73 | 🐛 0 | 🌐 Go | 📅 2025-07-05 - Package bart provides a fast routing table algorithm.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,955 | 🐛 441 | 🌐 Go | 📅 2025-07-03 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,714 | 🐛 109 | 🌐 Go | 📅 2025-07-05 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
* [ftpserverlib](https://github.com/fclairamb/ftpserverlib) ⭐ 449 | 🐛 7 | 🌐 Go | 📅 2025-06-15 - Fully featured FTP server library.
...
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,624 | 🐛 2 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,824 | 🐛 220 | 🌐 Go | 📅 2025-07-05 - BGP implemented in the Go Programming Language.
...
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,169 | 🐛 130 | 🌐 Go | 📅 2025-07-01 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,272 | 🐛 40 | 🌐 Go | 📅 2025-07-01 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,540 | 🐛 2 | 🌐 Go | 📅 2025-07-02 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,087 | 🐛 1 | 🌐 Go | 📅 2025-07-04 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,797 | 🐛 189 | 🌐 Go | 📅 2025-06-29 - An implementation of the QUIC protocol in pure Go.
...
* [sdns](https://github.com/semihalev/sdns) ⭐ 998 | 🐛 0 | 🌐 Go | 📅 2025-07-05 - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,963 | 🐛 15 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,008 | 🐛 99 | 🌐 Go | 📅 2025-07-03 - A pure Go implementation of the WebRTC API.
...
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 279 | 🐛 6 | 🌐 Go | 📅 2025-07-01 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,153 | 🐛 72 | 🌐 Go | 📅 2025-07-01 - Retryable HTTP client in Go.
...
* [requests](https://github.com/carlmjohnson/requests) ⭐ 1,611 | 🐛 2 | 🌐 Go | 📅 2025-04-16 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,346 | 🐛 25 | 🌐 Go | 📅 2025-07-02 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,235 | 🐛 28 | 🌐 Go | 📅 2025-07-04 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,327 | 🐛 586 | 🌐 Go | 📅 2025-06-20 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,457 | 🐛 464 | 🌐 Go | 📅 2025-06-25 - The fantastic ORM library for Golang, aims to be developer friendly.
...
* [gup](https://github.com/nao1215/gup) ⭐ 416 | 🐛 5 | 🌐 Go | 📅 2025-06-16 - Update binaries installed by "go install".
...
* [syft](https://github.com/anchore/syft) ⭐ 7,281 | 🐛 472 | 🌐 Go | 📅 2025-07-04 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,554 | 🐛 321 | 🌐 Go | 📅 2025-07-05 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 171 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,081 | 🐛 333 | 🌐 C++ | 📅 2025-07-02 - No instrumentation tracing for Golang applications via eBPF.
* [profile](https://github.com/pkg/profile) ⭐ 2,031 | 🐛 11 | 🌐 Go | 📅 2022-10-20 - Simple profiling support package for Go.
* [statsviz](https://github.com/arl/statsviz) ⭐ 3,310 | 🐛 11 | 🌐 Go | 📅 2025-06-17 - Live visualization of your Go application runtime statistics.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,397 | 🐛 367 | 🌐 Go | 📅 2025-07-01 - go generate based graphql server library.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,079 | 🐛 246 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [acra](https://github.com/cossacklabs/acra) ⭐ 1,406 | 🐛 13 | 🌐 Go | 📅 2025-04-17 - Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system.
* [age](https://github.com/FiloSottile/age) ⭐ 19,166 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,207 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [booster](https://github.com/anatol/booster) ⭐ 570 | 🐛 73 | 🌐 Go | 📅 2025-03-15 - Fast initramfs generator with full-disk encryption support.
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,456 | 🐛 28 | 🌐 Go | 📅 2024-10-11 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
* [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,268 | 🐛 25 | 🌐 Go | 📅 2025-07-02 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,736 | 🐛 94 | 🌐 Go | 📅 2025-07-01 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [memguard](https://github.com/awnumar/memguard) ⭐ 2,642 | 🐛 8 | 🌐 Go | 📅 2024-04-26 - A pure Go library for handling sensitive values in memory.
...
* [csvutil](https://github.com/jszwec/csvutil) ⭐ 989 | 🐛 1 | 🌐 Go | 📅 2025-03-15 - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,975 | 🐛 115 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [jsoniter](https://github.com/json-iterator/go) ⭐ 13,807 | 🐛 267 | 🌐 Go | 📅 2024-05-27 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,311 | 🐛 218 | 🌐 Go | 📅 2025-07-01 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,760 | 🐛 318 | 🌐 Go | 📅 2025-07-05 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,588 | 🐛 49 | 🌐 Go | 📅 2025-07-04 - Fider is an open platform to collect and organize customer feedback.
...
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,452 | 🐛 45 | 🌐 Go | 📅 2025-07-05 - A self contained feature flag solution written in Go and Vue.js
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,685 | 🐛 24 | 🌐 Go | 📅 2025-07-05 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [minio](https://github.com/minio/minio) ⭐ 53,560 | 🐛 51 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 48,170 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,178 | 🐛 80 | 🌐 Go | 📅 2025-07-05 - High-performance PHP application server, load-balancer and process manager.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,658 | 🐛 110 | 🌐 Go | 📅 2025-07-03 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,191 | 🐛 14 | 🌐 Go | 📅 2025-06-23 - Make SSH apps, just like that!
...
* [templ](https://github.com/a-h/templ) ⭐ 9,446 | 🐛 72 | 🌐 Go | 📅 2025-07-03 - A HTML templating language that has great developer tooling.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-07-05 - HTTP client testing framework.
...
* [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,362 | 🐛 167 | 🌐 Go | 📅 2024-07-30 - BDD-style framework with web UI and live reload.
...
* [httpexpect](https://github.com/gavv/httpexpect) ⭐ 2,651 | 🐛 16 | 🌐 Go | 📅 2025-06-02 - Concise, declarative, and easy to use end-to-end HTTP and REST API testing.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,280 | 🐛 237 | 🌐 Go | 📅 2025-07-03 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,170 | 🐛 139 | 🌐 Go | 📅 2025-07-03 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
* [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,164 | 🐛 21 | 🌐 Go | 📅 2025-07-05 - A helper for Rails' like test fixtures to test database applications.
* [Testify](https://github.com/stretchr/testify) ⭐ 24,875 | 🐛 371 | 🌐 Go | 📅 2025-07-01 - Sacred extension to the standard go testing package.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,893 | 🐛 95 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [mockery](https://github.com/vektra/mockery) ⭐ 6,675 | 🐛 40 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 490 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,089 | 🐛 233 | 🌐 Go | 📅 2025-06-26.
* [timex](https://github.com/cabify/timex) ⭐ 71 | 🐛 1 | 🌐 Go | 📅 2020-08-03 - A test-friendly replacement for the native `time` package.
* [xgo](https://github.com/xhd2015/xgo) ⭐ 411 | 🐛 59 | 🌐 Go | 📅 2025-07-01 - A general pureposed function mocking library.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 11,995 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,771 | 🐛 54 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
* [rod](https://github.com/go-rod/rod) ⭐ 6,056 | 🐛 183 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,161 | 🐛 8 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,911 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,260 | 🐛 4 | 🌐 Go | 📅 2025-07-04 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,840 | 🐛 99 | 🌐 Go | 📅 2025-06-22 - Shell parser and formatter.
...
* [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,432 | 🐛 26 | 🌐 Go | 📅 2025-04-04 - HTML Sanitizer.
* [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 | 🐛 1 | 🌐 Go | 📅 2025-06-01 - A sanitization-based swear filter for Go.

### Scrapers

* [colly](https://github.com/asciimoo/colly) ⭐ 24,396 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,574 | 🐛 3 | 🌐 Go | 📅 2025-06-07 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,448 | 🐛 187 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
...
* [github](https://github.com/google/go-github) ⭐ 10,852 | 🐛 32 | 🌐 Go | 📅 2025-07-04 - Go library for accessing the GitHub REST API v3.
...
* [go-jira](https://github.com/andygrunwald/go-jira) ⭐ 1,540 | 🐛 182 | 🌐 Go | 📅 2025-03-29 - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,131 | 🐛 211 | 🌐 Go | 📅 2025-06-25 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [golang-tmdb](https://github.com/cyruzin/golang-tmdb) ⭐ 138 | 🐛 1 | 🌐 Go | 📅 2025-07-03 - Golang wrapper for The Movie Database API v3.
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,282 | 🐛 20 | 🌐 Go | 📅 2025-07-05 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,281 | 🐛 381 | 🌐 Go | 📅 2025-07-04 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,730 | 🐛 18 | 🌐 Go | 📅 2025-07-01 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 737 | 🐛 2 | 🌐 Go | 📅 2025-06-30 - Wrapper for PayPal payment API.
...
* [slack](https://github.com/slack-go/slack) ⭐ 4,806 | 🐛 102 | 🌐 Go | 📅 2025-07-04 - Slack API in Go.
...
* [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,706 | 🐛 7 | 🌐 Go | 📅 2025-06-09 - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,232 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,311 | 🐛 167 | 🌐 Go | 📅 2025-06-30 - A tool for exploring each layer in a Docker image.
...
* [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,253 | 🐛 4 | 🌐 Go | 📅 2025-07-03 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
* [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,805 | 🐛 27 | 🌐 Go | 📅 2025-06-24 - Fault tolerance and resilience patterns for Go.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 71,524 | 🐛 290 | 🌐 Go | 📅 2025-07-06 - Command-line fuzzy finder written in Go.
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,807 | 🐛 23 | 🌐 Go | 📅 2025-07-05 - Deliver Go binaries as fast and easily as possible.
...
* [jump](https://github.com/gsamokovarov/jump) ⭐ 1,862 | 🐛 2 | 🌐 Go | 📅 2025-06-20 - Jump helps you navigate faster by learning your habits.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,105 | 🐛 8 | 🌐 Go | 📅 2025-06-25 - A comprehensive, efficient, and reusable util function library of go.
...
* [lo](https://github.com/samber/lo) ⭐ 19,708 | 🐛 208 | 🌐 Go | 📅 2025-07-02 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,122 | 🐛 54 | 🌐 Go | 📅 2025-07-03 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,026 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
...
* [usql](https://github.com/knq/usql) ⭐ 9,414 | 🐛 94 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,753 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [jio](https://github.com/faceair/jio) ⭐ 118 | 🐛 2 | 🌐 Go | 📅 2024-07-04 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,117 | 🐛 192 | 🌐 JavaScript | 📅 2025-06-18.
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,940 | 🐛 57 | 🌐 Go | 📅 2024-03-23 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,611 | 🐛 323 | 🌐 Go | 📅 2025-07-02 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 896 | 🐛 7 | 🌐 Go | 📅 2025-07-03 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,877 | 🐛 530 | 🌐 TypeScript | 📅 2025-07-04 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,691 | 🐛 169 | 🌐 Go | 📅 2025-07-01 - highly extensible Git implementation in pure Go.
...
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 803 | 🐛 20 | 🌐 Go | 📅 2025-07-05 - Pure Go RTSP server and client library.
...
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 529 | 🐛 1 | 🌐 Go | 📅 2025-07-04 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
...
* [Beego](https://github.com/beego/beego) ⭐ 32,136 | 🐛 17 | 🌐 Go | 📅 2025-06-25 - beego is an open-source, high-performance web framework for the Go programming language.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,241 | 🐛 107 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 480 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,047 | 🐛 103 | 🌐 Go | 📅 2025-07-04 - An Express.js inspired web framework build on Fasthttp.
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,005 | 🐛 855 | 🌐 Go | 📅 2025-07-01 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 | 🐛 13 | 🌐 Go | 📅 2025-07-05 - Gin parameter automatic binding tool,gin rpc tools.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,890 | 🐛 26 | 🌐 Go | 📅 2025-07-02 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,743 | 🐛 81 | 🌐 Go | 📅 2025-07-04 - Gofr is an opinionated microservice development framework.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,899 | 🐛 56 | 🌐 Go | 📅 2025-07-04 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,357 | 🐛 44 | 🌐 Go | 📅 2025-07-04 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,215 | 🐛 118 | 🌐 Go | 📅 2025-07-02 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
* [templui](https://github.com/axzilla/templui) ⭐ 753 | 🐛 6 | 🌐 JavaScript | 📅 2025-07-05 - Modern UI Components for Go & Templ.
...
* [negroni](https://github.com/urfave/negroni) ⭐ 7,531 | 🐛 9 | 🌐 Go | 📅 2025-05-03 - Idiomatic HTTP middleware for Golang.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,072 | 🐛 83 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,914 | 🐛 82 | 🌐 Go | 📅 2024-07-22 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,463 | 🐛 35 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,430 | 🐛 499 | 🌐 Go | 📅 2025-07-04 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,022 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 233 | 🐛 11 | 🌐 Go | 📅 2025-07-05 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,367 | 🐛 112 | 🌐 Go | 📅 2025-07-05 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 559 | 🐛 2 | 🌐 Go | 📅 2025-07-04 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,038 | 🐛 261 | 🌐 Go | 📅 2025-07-01 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,418 | 🐛 245 | 🌐 Go | 📅 2025-07-05 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 | 🐛 19 | 🌐 Go | 📅 2025-07-02 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,983 | 🐛 157 | 🌐 Go | 📅 2025-07-04 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,275 | 🐛 115 | 🌐 Go | 📅 2025-07-04 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,222 | 🐛 47 | 🌐 Go | 📅 2025-06-25 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,491 | 🐛 579 | 🌐 Go | 📅 2025-06-11 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 141 | 🐛 35 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,875 | 🐛 371 | 🌐 Go | 📅 2025-07-01.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 791 | 🐛 76 | 🌐 Go | 📅 2025-07-02 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,751 | 🐛 95 | 🌐 Go | 📅 2025-07-01 features to Vim/Neovim.
...
* [vim-go](https://github.com/fatih/vim-go) ⭐ 16,142 | 🐛 40 | 🌐 Vim Script | 📅 2025-06-21 - Go development plugin for Vim.
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,078 | 🐛 417 | 🌐 TypeScript | 📅 2025-07-02 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,624 | 🐛 7 | 🌐 Go | 📅 2025-07-01 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,795 | 🐛 607 | 🌐 Go | 📅 2025-06-27 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,412 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
...
* [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,477 | 🐛 16 | 🌐 Go | 📅 2025-03-13 - High-performance load testing tool, written in Golang.
...
* [dish](https://github.com/thevxn/dish) ⭐ 240 | 🐛 8 | 🌐 Go | 📅 2025-07-03 - A lightweight, remotely configurable monitoring service.
...
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,186 | 🐛 2,525 | 🌐 Go | 📅 2025-07-06 - Lightweight, programmable telemetry for servers and workstations.
...
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,387 | 🐛 2,711 | 🌐 Go | 📅 2025-07-06 - Fork of Gogs, entirely community driven.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,049 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,032 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,888 | 🐛 246 | 🌐 Go | 📅 2025-06-28 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,131 | 🐛 123 | 🌐 Go | 📅 2025-07-03 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,184 | 🐛 795 | 🌐 Go | 📅 2025-07-04 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,277 | 🐛 207 | 🌐 Go | 📅 2025-07-01 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [ko](https://github.com/google/ko) ⭐ 8,055 | 🐛 51 | 🌐 Go | 📅 2025-07-03 - Command line tool for building and deploying Go applications on Kubernetes
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,754 | 🐛 149 | 🌐 Go | 📅 2025-07-04 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,159 | 🐛 2,615 | 🌐 Go | 📅 2025-07-06 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,414 | 🐛 139 | 🌐 Go | 📅 2025-07-01 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,750 | 🐛 541 | 🌐 Go | 📅 2025-07-04 - Cloud native application delivery.
...
* [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,141 | 🐛 48 | 🌐 Go | 📅 2025-06-30 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,642 | 🐛 535 | 🌐 Go | 📅 2025-07-03 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,039 | 🐛 3,615 | 🌐 Go | 📅 2025-07-05 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,407 | 🐛 303 | 🌐 Go | 📅 2025-07-06 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 436 | 🐛 1 | 🌐 Go | 📅 2024-06-19 - Flexible HTTP command line stress tester.
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,181 | 🐛 109 | 🌐 Go | 📅 2025-07-04 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,331 | 🐛 138 | 🌐 Go | 📅 2025-07-05 - Pomerium is an identity-aware access proxy.
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 366 | 🐛 21 | 🌐 Go | 📅 2025-07-04 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,391 | 🐛 140 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
...
* [tau](https://github.com/taubyte/tau) ⭐ 4,045 | 🐛 28 | 🌐 Go | 📅 2025-06-23 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
* [traefik](https://github.com/containous/traefik) ⭐ 55,430 | 🐛 654 | 🌐 Go | 📅 2025-07-04 - Reverse proxy and load balancer with support for multiple backends.
...
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,338 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,437 | 🐛 66 | 🌐 Go | 📅 2025-07-04 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 584 | 🐛 10 | 🌐 Go | 📅 2025-07-05 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [croc](https://github.com/schollz/croc) ⭐ 30,512 | 🐛 12 | 🌐 Go | 📅 2025-07-04 - Easily and securely send files or folders from one computer to another.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,003 | 🐛 18 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,833 | 🐛 120 | 🌐 Go | 📅 2025-07-04 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,695 | 🐛 405 | 🌐 C++ | 📅 2025-05-19 - LiteIDE is a simple, open source, cross-platform Go IDE.
...
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,656 | 🐛 28 | 🌐 Go | 📅 2024-08-20 - Portal is a quick and easy command-line file transfer utility from any computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,210 | 🐛 472 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 701 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,448 | 🐛 53 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,071 | 🐛 594 | 🌐 Go | 📅 2025-07-06 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [Go AST Book (Chinese)](https://github.com/chai2010/go-ast-book) ⭐ 5,462 | 🐛 8 | 🌐 Go | 📅 2024-09-26 - A book focusing on Go `go/*` packages.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,178 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,769 | 🐛 2 | 🌐 Go | 📅 2024-12-22 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
* [gophers](https://github.com/ashleymcnamara/gophers) ⭐ 3,020 | 🐛 1 | 🌐 Go | 📅 2025-01-23 - Gopher artworks by Ashley McNamara.
* [gophers](https://github.com/egonelbre/gophers) ⭐ 3,680 | 🐛 5 | 🌐 Go | 📅 2022-07-06 - Free gophers.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,044 | 🐛 7,323 | 🌐 Go | 📅 2025-07-06
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,621 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,593 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,689 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,732 | 🐛 9,368 | 🌐 Go | 📅 2025-07-05 - List of projects on the Go community wiki.
...
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,659 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,928 | 🐛 7 | 🌐 Go | 📅 2025-07-05 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,637 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,951 | 🐛 66 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
