...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 146,966 | 🐛 126 | 🌐 Go | 📅 2025-06-29
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 380,171 | 🐛 42 | 📅 2025-07-05
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 249,512 | 🐛 477 | 🌐 Python | 📅 2025-07-05.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 146,966 | 🐛 126 | 🌐 Go | 📅 2025-06-29 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 146,966 | 🐛 126 | 🌐 Go | 📅 2025-06-29; you rock!
...
* [Ergo](https://github.com/ergo-services/ergo) ⭐ 4,016 | 🐛 4 | 🌐 Go | 📅 2025-07-07 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 262 | 🐛 0 | 🌐 Go | 📅 2025-07-07 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
* [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,970 | 🐛 22 | 🌐 Go | 📅 2025-07-04 - Blazingly fast and light-weight Actor engine written in Golang.
...
* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 625 | 🐛 11 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
* [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,076 | 🐛 367 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,755 | 🐛 478 | 🌐 Go | 📅 2025-07-08 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 145,945 | 🐛 1,857 | 🌐 Go | 📅 2025-07-08 - Run large language models locally.
...
* [minimp3](https://github.com/tosone/minimp3) ⭐ 129 | 🐛 2 | 🌐 C | 📅 2023-08-02 - Lightweight MP3 decoder library.
...
* [authboss](https://github.com/volatiletech/authboss) ⭐ 3,990 | 🐛 41 | 🌐 Go | 📅 2025-06-26 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,847 | 🐛 50 | 🌐 Go | 📅 2025-06-21 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [gologin](https://github.com/dghubble/gologin) ⭐ 1,915 | 🐛 0 | 🌐 Go | 📅 2025-07-02 - chainable handlers for login with OAuth1 and OAuth2 authentication providers.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,084 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,236 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,129 | 🐛 4 | 🌐 Go | 📅 2025-07-07 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
* [keto](https://github.com/ory/keto) ⭐ 5,058 | 🐛 57 | 🌐 Go | 📅 2025-07-08 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,604 | 🐛 30 | 🌐 Go | 📅 2025-07-02 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
* [openfga](https://github.com/openfga/openfga) ⭐ 3,804 | 🐛 130 | 🌐 Go | 📅 2025-07-09 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [scs](https://github.com/alexedwards/scs) ⭐ 2,361 | 🐛 30 | 🌐 Go | 📅 2025-07-08 - Session Manager for HTTP servers.
...
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,646 | 🐛 276 | 🌐 Go | 📅 2025-07-08 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 973 | 🐛 790 | 🌐 Go | 📅 2025-07-08 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,257 | 🐛 317 | 🌐 Go | 📅 2025-07-09 - Official Go implementation of the Ethereum protocol.
...
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,558 | 🐛 1,103 | 🌐 Go | 📅 2025-07-08 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,967 | 🐛 820 | 🌐 Go | 📅 2025-07-09 - A complete implementation of a Lightning Network node.
* [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,348 | 🐛 140 | 🌐 Go | 📅 2025-03-14 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
* [bot](https://github.com/go-telegram/bot) ⭐ 1,218 | 🐛 11 | 🌐 Go | 📅 2025-07-08 - Zero-dependencies Telegram Bot library with additional UI components
...
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,384 | 🐛 55 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
* [telego](https://github.com/mymmrac/telego) ⭐ 731 | 🐛 3 | 🌐 Go | 📅 2025-07-01 - Telegram Bot API library for Golang with full one-to-one API implementation.
...
* [wayback](https://github.com/wabarc/wayback) ⭐ 1,996 | 🐛 55 | 🌐 Go | 📅 2025-07-07 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [air](https://github.com/cosmtrek/air) ⭐ 20,956 | 🐛 177 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [mage](https://github.com/magefile/mage) ⭐ 4,379 | 🐛 130 | 🌐 Go | 📅 2025-06-15 - Mage is a make/rake-like build tool using Go.
...
* [Task](https://github.com/go-task/task) ⭐ 13,088 | 🐛 393 | 🌐 Go | 📅 2025-07-07 - simple "Make" alternative.
...
* [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,845 | 🐛 11 | 🌐 Go | 📅 2024-10-26 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
...
* [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 504 | 🐛 16 | 🌐 Go | 📅 2024-10-31 - An interactive table component for bubbletea.
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,556 | 🐛 153 | 🌐 Go | 📅 2025-06-29 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 33,011 | 🐛 116 | 🌐 Go | 📅 2025-07-07 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,655 | 🐛 4 | 🌐 Go | 📅 2025-07-08 - Terminal JSON viewer & processor.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,383 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,807 | 🐛 673 | 🌐 Python | 📅 2025-07-03.
...
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,228 | 🐛 86 | 🌐 Go | 📅 2025-07-08 - Declaratively define styles for color, format and layout in the terminal.
...
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,436 | 🐛 14 | 🌐 Go | 📅 2025-02-08 - Basic thread-safe progress bar that works in every OS.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,139 | 🐛 60 | 🌐 Go | 📅 2025-06-07 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,845 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,380 | 🐛 105 | 🌐 Go | 📅 2024-07-22.
* [termenv](https://github.com/muesli/termenv) ⭐ 1,863 | 🐛 37 | 🌐 Go | 📅 2025-05-05 - Advanced ANSI style & color support for your terminal applications.
* [termui](https://github.com/gizak/termui) ⭐ 13,380 | 🐛 105 | 🌐 Go | 📅 2024-07-22 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,619 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 734 | 🐛 40 | 🌐 Go | 📅 2025-07-01 - Command argument completion generator for spf13/cobra.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,340 | 🐛 74 | 🌐 Go | 📅 2025-07-02 - Multi-shell multi-command argument completer.
...
* [cmdr](https://github.com/hedzr/cmdr) ⭐ 140 | 🐛 0 | 🌐 Go | 📅 2025-07-05 - A POSIX/GNU style, getopt-like command-line UI Go library.
* [cobra](https://github.com/spf13/cobra) ⭐ 41,073 | 🐛 319 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
* [command-chain](https://github.com/rainu/go-command-chain) ⭐ 67 | 🐛 0 | 🌐 Go | 📅 2025-07-03 - A go library for configure and run command chains - such as pipelining in unix shells.
...
* [elvish](https://github.com/elves/elvish) ⭐ 6,053 | 🐛 338 | 🌐 Go | 📅 2025-07-07 - An expressive programming language and a versatile interactive shell.
...
* [liner](https://github.com/peterh/liner) ⭐ 1,064 | 🐛 17 | 🌐 Go | 📅 2023-06-23 - Go readline-like library for command-line interfaces.
...
* [pflag](https://github.com/spf13/pflag) ⭐ 2,591 | 🐛 177 | 🌐 Go | 📅 2025-06-28 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,317 | 🐛 50 | 🌐 Go | 📅 2025-06-14 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [env](https://github.com/caarlos0/env) ⭐ 5,614 | 🐛 9 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,460 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [koanf](https://github.com/knadh/koanf) ⭐ 3,289 | 🐛 11 | 🌐 Go | 📅 2025-06-30 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [kong](https://github.com/alecthomas/kong) ⭐ 2,712 | 🐛 26 | 🌐 Go | 📅 2025-07-04 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,353 | 🐛 22 | 🌐 Go | 📅 2025-07-08 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,827 | 🐛 519 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
...
* [drone](https://github.com/drone/drone) ⭐ 32,949 | 🐛 74 | 🌐 Go | 📅 2025-07-08 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 157 | 🐛 7 | 🌐 Go | 📅 2025-07-04 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
* [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 569 | 🐛 6 | 🌐 Go | 📅 2023-06-06 - go test output for humans.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,568 | 🐛 25 | 🌐 Go | 📅 2025-07-08 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,806 | 🐛 87 | 🌐 Rust | 📅 2025-07-06.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,221 | 🐛 344 | 🌐 Go | 📅 2025-07-08 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,398 | 🐛 527 | 🌐 Go | 📅 2025-07-09 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,134 | 🐛 140 | 🌐 Go | 📅 2025-07-09 - A high-performance ELT data integration framework with pluggable architecture.
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,729 | 🐛 72 | 🌐 Go | 📅 2025-06-28 - Go package implementing compressed bitsets.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 16,998 | 🐛 67 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [gota](https://github.com/kniren/gota) ⭐ 3,204 | 🐛 81 | 🌐 Go | 📅 2023-08-09 - Implementation of dataframes, series, and data wrangling methods for Go.
...
* [deque](https://github.com/gammazero/deque) ⭐ 689 | 🐛 6 | 🌐 Go | 📅 2025-05-01 - Fast ring-buffer deque (double-ended queue).
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,802 | 🐛 81 | 🌐 TypeScript | 📅 2025-07-09 - Distributed, Fault-tolerant task queue.
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,443 | 🐛 296 | 🌐 Go | 📅 2025-07-07 - Modern text indexing library for go.
...
* [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 419 | 🐛 3 | 🌐 Go | 📅 2025-05-19 - Implementation to calculate levenshtein distance in Go.
...
* [cache2go](https://github.com/muesli/cache2go) ⭐ 2,158 | 🐛 35 | 🌐 Go | 📅 2024-07-02 - In-memory key:value cache which supports automatic invalidation based on timeouts.
...
* [coherence-go-client](https://github.com/oracle/coherence-go-client) ⭐ 13 | 🐛 1 | 🌐 Go | 📅 2025-07-08 - Full implementation of Oracle Coherence cache API for Go applications using gRPC as network transport.
...
* [GCache](https://github.com/bluele/gcache) ⭐ 2,692 | 🐛 28 | 🌐 Go | 📅 2024-03-01 - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
* [go-freelru](https://github.com/elastic/go-freelru) ⭐ 242 | 🐛 17 | 🌐 Go | 📅 2025-07-09 A GC-less, fast and generic LRU hashmap library with optional locking, sharding, eviction and expiration.
...
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,205 | 🐛 42 | 🌐 Go | 📅 2024-11-29 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,153 | 🐛 1 | 🌐 Go | 📅 2025-07-07 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,198 | 🐛 5 | 🌐 Go | 📅 2025-06-16 -  A high performance memory-bound Go cache.
...
* [theine](https://github.com/Yiling-J/theine-go) ⭐ 335 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
* [timedmap](https://github.com/zekroTJA/timedmap) ⭐ 75 | 🐛 0 | 🌐 Go | 📅 2024-05-05 - Map with expiring key-value pairs.
* [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,104 | 🐛 14 | 🌐 Go | 📅 2025-07-08 - An in-memory cache with item expiration and generics.
* [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2022-10-02 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

* [badger](https://github.com/dgraph-io/badger) ⭐ 14,744 | 🐛 30 | 🌐 Go | 📅 2025-07-03 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,899 | 🐛 45 | 🌐 Go | 📅 2025-07-08 - An embedded key/value database for Go.
* [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
* [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,734 | 🐛 32 | 🌐 Go | 📅 2024-09-10 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,057 | 🐛 7,318 | 🌐 Go | 📅 2025-07-09 - Scalable, Geo-Replicated, Transactional Datastore.
...
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,997 | 🐛 36 | 🌐 Go | 📅 2025-07-09 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,435 | 🐛 8 | 🌐 Go | 📅 2021-11-10 - Home-grown disk-backed key-value store.
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,854 | 🐛 429 | 🌐 Go | 📅 2025-07-09 - Dolt – It's Git for Data.
...
* [godis](https://github.com/hdt3213/godis) ⭐ 3,718 | 🐛 16 | 🌐 Go | 📅 2025-07-05 - A Golang implemented high-performance Redis server and cluster.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,280 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,842 | 🐛 362 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,293 | 🐛 2,118 | 🌐 Rust | 📅 2025-07-08 - Scalable datastore for metrics, events, and real-time analytics.
...
* [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,202 | 🐛 16 | 🌐 Go | 📅 2025-02-18 - Fast k/v database compatible with lsm and b+tree.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,855 | 🐛 708 | 🌐 Go | 📅 2025-07-08 - Milvus is a vector database for embedding management, analytics and search.
...
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,480 | 🐛 67 | 🌐 Go | 📅 2025-06-07 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,373 | 🐛 296 | 🌐 Go | 📅 2025-07-08 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,363 | 🐛 706 | 🌐 Go | 📅 2025-07-08 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,855 | 🐛 3 | 🌐 Go | 📅 2025-07-07 - Redis re-implemented with SQLite.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,744 | 🐛 73 | 🌐 Go | 📅 2025-07-09 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,697 | 🐛 5,207 | 🌐 Go | 📅 2025-07-09 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,480 | 🐛 789 | 🌐 Go | 📅 2025-07-08 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 7,009 | 🐛 218 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,714 | 🐛 120 | 🌐 Go | 📅 2025-07-09 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,116 | 🐛 28 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,675 | 🐛 97 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,952 | 🐛 435 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,328 | 🐛 18 | 🌐 Go | 📅 2025-07-08 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
...
* [dbbench](https://github.com/sj14/dbbench) ⭐ 108 | 🐛 10 | 🌐 Go | 📅 2025-07-04 - Database benchmarking tool with support for several databases and scripts.
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,784 | 🐛 152 | 🌐 Go | 📅 2025-07-06 - Go toolset to handle MySQL protocol and replication.
...
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,941 | 🐛 36 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
* [prep](https://github.com/hexdigest/prep) ⭐ 35 | 🐛 0 | 🌐 Go | 📅 2017-12-19 - Use prepared SQL statements without changing your code.
* [pREST](https://github.com/prest/prest) ⭐ 4,368 | 🐛 141 | 🌐 Go | 📅 2025-04-29 - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,813 | 🐛 886 | 🌐 Go | 📅 2025-07-08 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [goqu](https://github.com/doug-martin/goqu) ⭐ 2,533 | 🐛 143 | 🌐 Go | 📅 2024-05-22 - Idiomatic SQL builder and query library.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,262 | 🐛 41 | 🌐 Go | 📅 2025-07-03 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,451 | 🐛 613 | 🌐 Go | 📅 2025-07-02 - Generate type-safe code from SQL.
...
* [sqrl](https://github.com/elgris/sqrl) ⭐ 280 | 🐛 7 | 🌐 Go | 📅 2023-06-15 - SQL query builder, fork of Squirrel with improved performance.
...
* [xo](https://github.com/knq/xo) ⭐ 3,831 | 🐛 53 | 🌐 Go | 📅 2025-06-23 - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,914 | 🐛 62 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,564 | 🐛 203 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 735 | 🐛 6 | 🌐 Go | 📅 2025-07-08 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,112 | 🐛 235 | 🌐 Go | 📅 2025-06-26 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,112 | 🐛 235 | 🌐 Go | 📅 2025-06-26 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,440 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
* [pq](https://github.com/lib/pq) ⭐ 9,532 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 166 | 🐛 243 | 🌐 Go | 📅 2025-07-08 - native and database/sql driver YDB (Yandex Database)
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,388 | 🐛 14 | 🌐 Go | 📅 2025-07-09 - Official MongoDB driver for the Go language.
...
* [qmgo](https://github.com/qiniu/qmgo) ⭐ 1,325 | 🐛 49 | 🌐 Go | 📅 2025-07-05 - The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,045 | 🐛 97 | 🌐 Go | 📅 2025-07-07 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,715 | 🐛 23 | 🌐 Go | 📅 2025-07-08 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
* [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,095 | 🐛 92 | 🌐 Go | 📅 2025-07-08 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1,000 | 🐛 23 | 🌐 Go | 📅 2025-06-27 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,095 | 🐛 1 | 🌐 Go | 📅 2025-07-07 - A simple, semantic and developer-friendly time package for golang.
...
* [bedrock](https://github.com/z5labs/bedrock) ⭐ 13 | 🐛 1 | 🌐 Go | 📅 2025-07-04 - Provides a minimal, modular and composable foundation for quickly developing services and more use case specific frameworks in Go.
...
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,197 | 🐛 52 | 🌐 Go | 📅 2024-07-12 - A feature complete and high performance multi-group Raft library in Go.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,658 | 🐛 29 | 🌐 Go | 📅 2025-07-09 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [emitter-io](https://github.com/emitter-io/emitter) ⭐ 3,946 | 🐛 15 | 🌐 Go | 📅 2025-03-13 - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,150 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,380 | 🐛 20 | 🌐 Go | 📅 2025-07-08 - A distributed systems development framework.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,393 | 🐛 359 | 🌐 Go | 📅 2025-07-08 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,996 | 🐛 141 | 🌐 Go | 📅 2025-07-08 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,055 | 🐛 84 | 🌐 Go | 📅 2025-07-08 - A cloud native Kubernetes Global Balancer.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,520 | 🐛 54 | 🌐 Go | 📅 2025-07-07 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,570 | 🐛 123 | 🌐 Go | 📅 2025-06-01 - A modular-designed and easy-to-use microservices framework in Go.
...
* [micro](https://github.com/micro/micro) ⭐ 12,267 | 🐛 7 | 🌐 Go | 📅 2025-07-06 - A distributed systems runtime for the cloud and beyond.
* [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,569 | 🐛 26 | 🌐 Go | 📅 2025-04-16 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,455 | 🐛 461 | 🌐 Go | 📅 2025-07-08 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 619 | 🐛 54 | 🌐 Go | 📅 2025-07-08 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,675 | 🐛 44 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/etcd-io/raft) ⭐ 871 | 🐛 70 | 🌐 Go | 📅 2025-07-01 - Go implementation of the Raft consensus protocol, by CoreOS.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,339 | 🐛 356 | 🌐 C++ | 📅 2025-06-26).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,110 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 658 | 🐛 197 | 🌐 Go | 📅 2025-07-09 - Durable execution system for making code fault-tolerant and simple.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,809 | 🐛 63 | 🌐 Go | 📅 2025-07-08 - BitTorrent client package.
* [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 987 | 🐛 8 | 🌐 Go | 📅 2025-04-18 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
* [email](https://github.com/jordan-wright/email) ⭐ 2,739 | 🐛 54 | 🌐 Go | 📅 2024-02-21 - A robust and flexible email library for Go.
...
* [go-imap](https://github.com/emersion/go-imap) ⭐ 2,208 | 🐛 61 | 🌐 Go | 📅 2025-06-11 - IMAP library for clients and servers.
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,032 | 🐛 4 | 🌐 Go | 📅 2025-07-02 - A simple Go library for sending mails in Go.
...
* [hermes](https://github.com/matcornic/hermes) ⭐ 2,907 | 🐛 20 | 🌐 Go | 📅 2025-04-04 - Golang package that generates clean, responsive HTML e-mails.
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,592 | 🐛 130 | 🌐 Go | 📅 2025-04-16 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
* [mailgun-go](https://github.com/mailgun/mailgun-go) ⭐ 731 | 🐛 1 | 🌐 Go | 📅 2025-06-27 - Go library for sending mail with the Mailgun API.
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,029 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,328 | 🐛 1 | 🌐 Go | 📅 2025-07-06 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,057 | 🐛 148 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,642 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,606 | 🐛 50 | 🌐 Go | 📅 2025-07-08 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,992 | 🐛 46 | 🌐 Go | 📅 2025-07-05 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,600 | 🐛 178 | 🌐 Go | 📅 2025-07-08 - PHP embedded in Go, with a `net/http` handler.
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,295 | 🐛 50 | 🌐 Go | 📅 2025-06-05 - Port of the Lua 5.2 VM to pure Go.
...
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,642 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [gval](https://github.com/PaesslerAG/gval) ⭐ 792 | 🐛 24 | 🌐 Go | 📅 2024-11-28 - A highly customizable expression language written in Go.
* [metacall](https://github.com/metacall/core) ⭐ 1,665 | 🐛 52 | 🌐 C | 📅 2025-07-08 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
* [starlark-go](https://github.com/google/starlark-go) ⭐ 2,494 | 🐛 63 | 🌐 Go | 📅 2025-07-01 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
* [starlet](https://github.com/1set/starlet) ⭐ 30 | 🐛 2 | 🌐 Go | 📅 2025-04-15 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,494 | 🐛 63 | 🌐 Go | 📅 2025-07-01 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
* [tengo](https://github.com/d5/tengo) ⭐ 3,664 | 🐛 84 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,593 | 🐛 5 | 🌐 Go | 📅 2025-07-08 - The Wa Programming Language embedded in Go.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 98 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,616 | 🐛 290 | 🌐 Go | 📅 2025-07-06).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,602 | 🐛 52 | 🌐 Go | 📅 2025-07-02 - Disk usage analyzer with console interface.
...
* [go-wkhtmltopdf](https://github.com/SebastiaanKlippert/go-wkhtmltopdf) ⭐ 1,131 | 🐛 10 | 🌐 Go | 📅 2024-07-02 - A package to convert an HTML template to a PDF file.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,779 | 🐛 127 | 🌐 Go | 📅 2025-07-08 - PDF processor.
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 | 🐛 1 | 🌐 Go | 📅 2023-09-21 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,845 | 🐛 39 | 📅 2025-07-08.
...
* [ach](https://github.com/moov-io/ach) ⭐ 492 | 🐛 14 | 🌐 Go | 📅 2025-07-09 - A reader, writer, and validator for Automated Clearing House (ACH) files.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,380 | 🐛 135 | 🌐 Go | 📅 2025-07-09 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,834 | 🐛 144 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
* [decimal](https://github.com/govalues/decimal) ⭐ 174 | 🐛 6 | 🌐 Go | 📅 2025-01-18 - Immutable decimal numbers with panic-free arithmetic.
...
* [ledger](https://github.com/formancehq/ledger) ⭐ 990 | 🐛 7 | 🌐 Go | 📅 2025-07-08 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,307 | 🐛 37 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
...
* [conform](https://github.com/leebenson/conform) ⭐ 325 | 🐛 5 | 🌐 Go | 📅 2023-12-23 - Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags.
* [form](https://github.com/go-playground/form) ⭐ 846 | 🐛 15 | 🌐 Go | 📅 2025-03-21 - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
* [nosurf](https://github.com/justinas/nosurf) ⭐ 1,678 | 🐛 15 | 🌐 Go | 📅 2025-05-13 - CSRF protection middleware for Go.
...
* [mo](https://github.com/samber/mo) ⭐ 3,017 | 🐛 23 | 🌐 Go | 📅 2025-07-06 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,204 | 🐛 299 | 🌐 Go | 📅 2025-07-08 - dead simple 2D game engine in Go.
...
* [g3n](https://github.com/g3n/engine) ⭐ 2,964 | 🐛 37 | 🌐 Go | 📅 2025-02-08 - Go 3D Game Engine.
...
* [nano](https://github.com/lonng/nano) ⭐ 3,043 | 🐛 30 | 🌐 Go | 📅 2025-03-30 - Lightweight, facility, high performance golang based game server framework.
...
* [Pixel](https://github.com/gopxl/pixel) ⭐ 335 | 🐛 33 | 🌐 Go | 📅 2025-03-07 - Hand-crafted 2D game library in Go.
* [prototype](https://github.com/gonutz/prototype) ⭐ 90 | 🐛 1 | 🌐 C | 📅 2025-07-06 - Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API.
...
* [goverter](https://github.com/jmattheis/goverter) ⭐ 717 | 🐛 16 | 🌐 Go | 📅 2025-07-06 - Generate converters by defining an interface.
...
* [jennifer](https://github.com/dave/jennifer) ⭐ 3,514 | 🐛 17 | 🌐 Go | 📅 2024-09-08 - Generate arbitrary Go code without templates.
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,300 | 🐛 692 | 🌐 Go | 📅 2025-07-07 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,763 | 🐛 33 | 🌐 Go | 📅 2025-07-07 - S2 geometry library in Go.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,370 | 🐛 151 | 🌐 Go | 📅 2025-06-17 - Geolocation DB with spatial index and realtime geofencing.
...
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,991 | 🐛 191 | 🌐 Go | 📅 2025-06-16 - Compiler from Go to JavaScript.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,811 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,984 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [go-actor](https://github.com/vladopajic/go-actor) ⭐ 230 | 🐛 0 | 🌐 Go | 📅 2025-06-05 - A tiny library for writing concurrent programs using actor model.
...
* [pond](https://github.com/alitto/pond) ⭐ 1,885 | 🐛 3 | 🌐 Go | 📅 2025-06-20 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [rill](https://github.com/destel/rill) ⭐ 1,685 | 🐛 2 | 🌐 Go | 📅 2025-02-02 - Go toolkit for clean, composable, channel-based concurrency.
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,722 | 🐛 42 | 🌐 Go | 📅 2025-07-08 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 422 | 🐛 19 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,718 | 🐛 1,163 | 🌐 C++ | 📅 2025-07-08 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,678 | 🐛 17 | 🌐 Lua | 📅 2025-07-01.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,713 | 🐛 743 | 🌐 Go | 📅 2025-07-07 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [qt](https://github.com/therecipe/qt) ⭐ 10,689 | 🐛 373 | 🌐 Go | 📅 2024-03-04 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
* [webview](https://github.com/zserge/webview) ⭐ 13,213 | 🐛 190 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,246 | 🐛 136 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,593 | 🐛 216 | 🌐 Go | 📅 2025-07-08 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 729 | 🐛 6 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,136 | 🐛 344 | 🌐 Go | 📅 2025-07-08 - Go package for computer vision using OpenCV 3.3+.
...
* [govips](https://github.com/davidbyttow/govips) ⭐ 1,458 | 🐛 31 | 🌐 Go | 📅 2025-07-07 - A lightning fast image processing and resizing library for Go.
...
* [imaginary](https://github.com/h2non/imaginary) ⭐ 5,876 | 🐛 132 | 🌐 Go | 📅 2025-01-14 - Fast and simple HTTP microservice for image resizing.
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,518 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
* [imagor](https://github.com/cshum/imagor) ⭐ 3,670 | 🐛 39 | 🌐 Go | 📅 2025-06-30 - Fast, secure image processing server and Go library, using libvips.
...
* [mergi](https://github.com/noelyahan/mergi) ⭐ 240 | 🐛 2 | 🌐 Go | 📅 2024-11-05 - Tool & Go library for image manipulation (Merge, Crop, Resize, Watermark, Animate).
...
* [picfit](https://github.com/thoas/picfit) ⭐ 2,252 | 🐛 12 | 🌐 Go | 📅 2025-06-10 - An image resizing server written in Go.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,606 | 🐛 61 | 🌐 Go | 📅 2025-07-08 - Lightweight data stream processing engine for IoT edge.
...
* [flogo](https://github.com/tibcosoftware/flogo) ⭐ 2,469 | 🐛 127 | 🌐 CSS | 📅 2024-04-24 - Project Flogo is an Open Source Framework for IoT Edge Apps & Integration.
* [gatt](https://github.com/paypal/gatt) ⭐ 1,158 | 🐛 49 | 🌐 Go | 📅 2022-08-17 - Gatt is a Go package for building Bluetooth Low Energy peripherals.
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,210 | 🐛 103 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,190 | 🐛 8 | 🌐 Go | 📅 2025-07-08 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,354 | 🐛 17 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,493 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,031 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [jsondiff](https://github.com/wI2L/jsondiff) ⭐ 585 | 🐛 0 | 🌐 Go | 📅 2025-05-09 - JSON diff library for Go based on RFC6902 (JSON Patch).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,153 | 🐛 100 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [phuslu/log](https://github.com/phuslu/log) ⭐ 779 | 🐛 6 | 🌐 Go | 📅 2025-05-17 - High performance structured logging.
* [pp](https://github.com/k0kubun/pp) ⭐ 1,964 | 🐛 6 | 🌐 Go | 📅 2025-07-09 - Colored pretty printer for Go language.
...
* [slog-multi](https://github.com/samber/slog-multi) ⭐ 496 | 🐛 1 | 🌐 Go | 📅 2025-06-24 - Chain of slog.Handler (pipeline, fanout...).
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,583 | 🐛 140 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [GoLearn](https://github.com/sjwhitworth/golearn) ⭐ 9,411 | 🐛 89 | 🌐 Go | 📅 2024-01-15 - General Machine Learning library for Go.
...
* [goml](https://github.com/cdipaolo/goml) ⭐ 1,595 | 🐛 4 | 🌐 Go | 📅 2022-07-15 - On-line Machine Learning in Go.
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 824 | 🐛 2 | 🌐 Go | 📅 2025-07-04 - An accelerated Machine Learning framework for Go.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,801 | 🐛 111 | 🌐 Go | 📅 2024-08-12 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,906 | 🐛 33 | 🌐 Go | 📅 2025-03-24 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 428 | 🐛 6 | 🌐 Go | 📅 2025-07-04 - Huggingface transformer pipelines for golang with onnxruntime.
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,804 | 🐛 18 | 🌐 Go | 📅 2025-07-08 - Go RabbitMQ Client Library.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,542 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,083 | 🐛 23 | 🌐 Go | 📅 2025-07-08 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,931 | 🐛 284 | 🌐 HTML | 📅 2025-07-08 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,886 | 🐛 27 | 🌐 Go | 📅 2024-06-19 - The lightweight event bus with async compatibility.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,421 | 🐛 58 | 🌐 Go | 📅 2025-07-05 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,095 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [melody](https://github.com/olahol/melody) ⭐ 3,941 | 🐛 13 | 🌐 Go | 📅 2025-06-08 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
* [Mercure](https://github.com/dunglas/mercure) ⭐ 4,981 | 🐛 26 | 🌐 Go | 📅 2025-06-27 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,007 | 🐛 186 | 🌐 Go | 📅 2025-07-08 - Go client for the NATS
  messaging system.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,080 | 🐛 64 | 🌐 Go | 📅 2025-07-08 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,630 | 🐛 123 | 🌐 Go | 📅 2025-07-03 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
* [zmq4](https://github.com/pebbe/zmq4) ⭐ 1,211 | 🐛 58 | 🌐 Go | 📅 2025-07-06 - Go interface to ZeroMQ version 4. Also available for [version 3](https://github.com/pebbe/zmq3) ⭐ 133 | 🐛 1 | 🌐 Go | 📅 2025-05-11 and [version 2](https://github.com/pebbe/zmq2) ⭐ 19 | 🐛 1 | 🌐 Go | 📅 2025-05-11.

**[⬆ back to top](#contents)**

## Microsoft Office

* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,615 | 🐛 26 | 🌐 Go | 📅 2025-05-21 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/xuri/excelize) ⭐ 19,342 | 🐛 127 | 🌐 Go | 📅 2025-07-08 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [fx](https://github.com/uber-go/fx) ⭐ 6,640 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
...
* [GoLobby/Container](https://github.com/golobby/container) ⭐ 594 | 🐛 5 | 🌐 Go | 📅 2024-07-11 - GoLobby Container is a lightweight yet powerful IoC dependency injection container for the Go programming language.
...
* [google/wire](https://github.com/google/wire) ⭐ 13,924 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,819 | 🐛 0 | 🌐 Go | 📅 2025-07-07 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,819 | 🐛 0 | 🌐 Go | 📅 2025-07-07 for building production grade scalable web service applications.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,776 | 🐛 45 | 🌐 Go | 📅 2025-07-07 - Allows users to spin up a quick Go project using a popular framework.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,016 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,016 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
...
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,291 | 🐛 0 | 🌐 Go | 📅 2025-07-08 - Nunu is a scaffolding tool for building Go applications.
* [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,565 | 🐛 2 | 🌐 Go | 📅 2025-06-24 - Rapid, easy full-stack web development starter kit built in Go.
...
* [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,133 | 🐛 12 | 🌐 Go | 📅 2025-05-29 - cross-platform, cli app to perform various operations on string.
...
* [archives](https://github.com/mholt/archives) ⭐ 263 | 🐛 7 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,260 | 🐛 6 | 🌐 Go | 📅 2025-06-25 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,654 | 🐛 220 | 🌐 Go | 📅 2025-07-08 - Automated service health dashboard.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,294 | 🐛 216 | 🌐 Go | 📅 2025-07-02 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,281 | 🐛 83 | 🌐 Go | 📅 2024-07-26 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
* [xz](https://github.com/ulikunitz/xz) ⭐ 516 | 🐛 17 | 🌐 Go | 📅 2025-02-27 - Pure golang package for reading and writing xz-compressed files.
...
* [lingua-go](https://github.com/pemistahl/lingua-go) ⭐ 1,254 | 🐛 9 | 🌐 Go | 📅 2025-02-06 - An accurate natural language detection library, suitable for long and short text alike. Supports detecting multiple languages in mixed-language text.
...
* [govader](https://github.com/jonreiter/govader) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2025-04-29 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,759 | 🐛 55 | 🌐 Python | 📅 2024-03-16.
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,539 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,230 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,285 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Package and an accompanying tool to work with localized text.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,985 | 🐛 443 | 🌐 Go | 📅 2025-07-07 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [dns](https://github.com/miekg/dns) ⭐ 8,418 | 🐛 12 | 🌐 Go | 📅 2025-06-01 - Go library for working with DNS.
* [dnsmonster](https://github.com/mosajjal/dnsmonster) ⭐ 331 | 🐛 4 | 🌐 Go | 📅 2025-05-14 - Passive DNS Capture/Monitoring Framework.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,721 | 🐛 109 | 🌐 Go | 📅 2025-07-05 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [fortio](https://github.com/fortio/fortio) ⭐ 3,554 | 🐛 82 | 🌐 Go | 📅 2025-07-08 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
* [ftpserverlib](https://github.com/fclairamb/ftpserverlib) ⭐ 449 | 🐛 8 | 🌐 Go | 📅 2025-07-08 - Fully featured FTP server library.
...
* [gev](https://github.com/Allenxuxu/gev) ⭐ 1,756 | 🐛 14 | 🌐 Go | 📅 2025-06-07 - gev is a lightweight, fast non-blocking TCP network library based on Reactor mode.
...
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,635 | 🐛 1 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,712 | 🐛 178 | 🌐 Go | 📅 2025-06-29 - Go library for downloading files or directories from various sources using a URL.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,825 | 🐛 221 | 🌐 Go | 📅 2025-07-08 - BGP implemented in the Go Programming Language.
...
* [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,396 | 🐛 85 | 🌐 Go | 📅 2025-06-05 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
* [gosnmp](https://github.com/soniah/gosnmp) ⭐ 1,197 | 🐛 61 | 🌐 Go | 📅 2025-07-01 - Native Go library for performing SNMP actions.
* [gotcp](https://github.com/gansidui/gotcp) ⭐ 514 | 🐛 0 | 🌐 Go | 📅 2023-08-08 - Go package for quickly writing tcp applications.
* [grab](https://github.com/cavaliercoder/grab) ⭐ 1,446 | 🐛 33 | 🌐 Go | 📅 2024-05-14 - Go package for managing file downloads.
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,285 | 🐛 63 | 🌐 Go | 📅 2025-06-18 - KCP - Fast and Reliable ARQ Protocol.
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,170 | 🐛 130 | 🌐 Go | 📅 2025-07-01 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,273 | 🐛 40 | 🌐 Go | 📅 2025-07-06 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
* [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,351 | 🐛 25 | 🌐 Go | 📅 2025-06-17 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,093 | 🐛 1 | 🌐 Go | 📅 2025-07-08 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,806 | 🐛 188 | 🌐 Go | 📅 2025-07-07 - An implementation of the QUIC protocol in pure Go.
...
* [sdns](https://github.com/semihalev/sdns) ⭐ 999 | 🐛 0 | 🌐 Go | 📅 2025-07-06 - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
...
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,937 | 🐛 56 | 🌐 Go | 📅 2025-01-27 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,974 | 🐛 15 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [water](https://github.com/songgao/water) ⭐ 2,052 | 🐛 30 | 🌐 Go | 📅 2024-07-30 - Simple TUN/TAP library.
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,025 | 🐛 100 | 🌐 Go | 📅 2025-07-03 - A pure Go implementation of the WebRTC API.
...
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 279 | 🐛 5 | 🌐 Go | 📅 2025-07-06 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,155 | 🐛 73 | 🌐 Go | 📅 2025-07-07 - Retryable HTTP client in Go.
...
* [req](https://github.com/imroc/req) ⭐ 4,542 | 🐛 74 | 🌐 Go | 📅 2025-06-27 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
* [requests](https://github.com/carlmjohnson/requests) ⭐ 1,614 | 🐛 2 | 🌐 Go | 📅 2025-04-16 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
* [resty](https://github.com/go-resty/resty) ⭐ 11,033 | 🐛 36 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,190 | 🐛 36 | 🌐 Go | 📅 2025-06-17 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,350 | 🐛 22 | 🌐 Go | 📅 2025-07-06 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,237 | 🐛 27 | 🌐 Go | 📅 2025-07-08 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,337 | 🐛 586 | 🌐 Go | 📅 2025-06-20 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,566 | 🐛 6 | 🌐 Go | 📅 2025-07-06 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,483 | 🐛 465 | 🌐 Go | 📅 2025-07-07 - The fantastic ORM library for Golang, aims to be developer friendly.
...
* [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,304 | 🐛 115 | 🌐 Go | 📅 2025-07-02 - Prisma Client Go, Typesafe database access for Go.
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,892 | 🐛 104 | 🌐 Go | 📅 2025-06-27 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
* [upper.io/db](https://github.com/upper/db) ⭐ 3,601 | 🐛 159 | 🌐 Go | 📅 2025-03-21 - Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.
...
* [gup](https://github.com/nao1215/gup) ⭐ 417 | 🐛 5 | 🌐 Go | 📅 2025-06-16 - Update binaries installed by "go install".
...
* [syft](https://github.com/anchore/syft) ⭐ 7,304 | 🐛 470 | 🌐 Go | 📅 2025-07-08 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,562 | 🐛 323 | 🌐 Go | 📅 2025-07-09 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 171 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,080 | 🐛 332 | 🌐 C++ | 📅 2025-07-08 - No instrumentation tracing for Golang applications via eBPF.
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,495 | 🐛 48 | 🌐 Go | 📅 2025-03-28 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,401 | 🐛 368 | 🌐 Go | 📅 2025-07-07 - go generate based graphql server library.
...
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,079 | 🐛 237 | 🌐 Go | 📅 2025-04-01 - Implementation of GraphQL for Go.
* [gws](https://github.com/Zaba505/gws) ⭐ 6 | 🐛 2 | 🌐 Go | 📅 2020-09-04 - Apollos' "GraphQL over Websocket" client and server implementation.
* [jsonpath](https://github.com/AsaiYusuke/jsonpath) ⭐ 26 | 🐛 2 | 🌐 Go | 📅 2025-07-05 - A query library for retrieving part of JSON based on JSONPath syntax.
...
* [mql](https://github.com/hashicorp/mql) ⭐ 61 | 🐛 1 | 🌐 Go | 📅 2025-06-24 - Model Query Language (mql) is a query language for your database models.
...
* [go-deepcopy](https://github.com/tiendc/go-deepcopy) ⭐ 99 | 🐛 0 | 🌐 Go | 📅 2025-06-09 - Fast deep copy library.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,084 | 🐛 246 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,192 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,216 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [booster](https://github.com/anatol/booster) ⭐ 576 | 🐛 73 | 🌐 Go | 📅 2025-03-15 - Fast initramfs generator with full-disk encryption support.
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,460 | 🐛 29 | 🌐 Go | 📅 2025-07-08 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,742 | 🐛 93 | 🌐 Go | 📅 2025-07-08 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
* [dongle](https://github.com/golang-module/dongle) ⭐ 987 | 🐛 2 | 🌐 Go | 📅 2025-06-30 - A simple, semantic and developer-friendly golang package for encoding\&decoding and encryption\&decryption.
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,713 | 🐛 158 | 🌐 Go | 📅 2025-07-08 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 894 | 🐛 23 | 🌐 Go | 📅 2025-07-05 - Small, safe, and easy CBOR encoding and decoding library.
* [colfer](https://github.com/pascaldekloe/colfer) ⭐ 749 | 🐛 10 | 🌐 Java | 📅 2024-08-07 - Code generation for the Colfer binary format.
* [csvutil](https://github.com/jszwec/csvutil) ⭐ 990 | 🐛 1 | 🌐 Go | 📅 2025-03-15 - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,380 | 🐛 222 | 🌐 Go | 📅 2025-07-08 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,835 | 🐛 21 | 🌐 Go | 📅 2025-07-08 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,796 | 🐛 319 | 🌐 Go | 📅 2025-07-08 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,593 | 🐛 50 | 🌐 Go | 📅 2025-07-08 - Fider is an open platform to collect and organize customer feedback.
...
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,455 | 🐛 45 | 🌐 Go | 📅 2025-07-08 - A self contained feature flag solution written in Go and Vue.js
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,687 | 🐛 21 | 🌐 Go | 📅 2025-07-08 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [minio](https://github.com/minio/minio) ⭐ 53,657 | 🐛 51 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 48,797 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,179 | 🐛 80 | 🌐 Go | 📅 2025-07-07 - High-performance PHP application server, load-balancer and process manager.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,672 | 🐛 110 | 🌐 Go | 📅 2025-07-03 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,056 | 🐛 4 | 🌐 Go | 📅 2025-05-11 - Go stream processing library.
...
* [pongo2](https://github.com/flosch/pongo2) ⭐ 2,959 | 🐛 72 | 🌐 Go | 📅 2024-08-14 - Django-like template-engine for Go.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,454 | 🐛 69 | 🌐 Go | 📅 2025-07-07 - A HTML templating language that has great developer tooling.
...
* [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,445 | 🐛 28 | 🌐 Go | 📅 2025-07-08 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
* [go-carpet](https://github.com/msoap/go-carpet) ⭐ 248 | 🐛 3 | 🌐 Go | 📅 2024-09-30 - Tool for viewing test coverage in terminal.
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,459 | 🐛 47 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
...
* [godog](https://github.com/cucumber/godog) ⭐ 2,458 | 🐛 83 | 🌐 Go | 📅 2025-07-07 - Cucumber BDD framework for Go.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,284 | 🐛 240 | 🌐 Go | 📅 2025-07-08 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,181 | 🐛 139 | 🌐 Go | 📅 2025-07-03 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 24,876 | 🐛 371 | 🌐 Go | 📅 2025-07-01 - Sacred extension to the standard go testing package.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,901 | 🐛 95 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,038 | 🐛 5 | 🌐 Go | 📅 2025-04-05 - Easy mocking of HTTP responses from external resources.
* [minimock](https://github.com/gojuno/minimock) ⭐ 691 | 🐛 9 | 🌐 Go | 📅 2025-06-10 - Mock generator for Go interfaces.
* [mockery](https://github.com/vektra/mockery) ⭐ 6,685 | 🐛 41 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [moq](https://github.com/matryer/moq) ⭐ 2,106 | 🐛 27 | 🌐 Go | 📅 2025-02-13 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 492 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,112 | 🐛 235 | 🌐 Go | 📅 2025-06-26.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,002 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [rod](https://github.com/go-rod/rod) ⭐ 6,060 | 🐛 184 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [sq](https://github.com/neilotoole/sq) ⭐ 2,304 | 🐛 31 | 🌐 Go | 📅 2025-04-16 - Convert data from SQL databases or document formats like CSV or Excel into formats such as JSON, Excel, CSV, HTML, Markdown, XML, and YAML.
...
* [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,828 | 🐛 33 | 🌐 Go | 📅 2025-05-10 - Go library for the TOML format with query support and handy cli tools.
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,168 | 🐛 8 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,917 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,752 | 🐛 18 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,846 | 🐛 99 | 🌐 Go | 📅 2025-07-07 - Shell parser and formatter.
...
* [colly](https://github.com/asciimoo/colly) ⭐ 24,421 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,582 | 🐛 3 | 🌐 Go | 📅 2025-06-07 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,145 | 🐛 81 | 🌐 Go | 📅 2025-07-03 - The official AWS SDK for the Go programming language.
...
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,457 | 🐛 187 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
...
* [github](https://github.com/google/go-github) ⭐ 10,855 | 🐛 32 | 🌐 Go | 📅 2025-07-04 - Go library for accessing the GitHub REST API v3.
...
* [go-jira](https://github.com/andygrunwald/go-jira) ⭐ 1,540 | 🐛 182 | 🌐 Go | 📅 2025-07-06 - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,142 | 🐛 210 | 🌐 Go | 📅 2025-07-08 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,282 | 🐛 20 | 🌐 Go | 📅 2025-07-07 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,283 | 🐛 385 | 🌐 Go | 📅 2025-07-09 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,733 | 🐛 19 | 🌐 Go | 📅 2025-07-01 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,344 | 🐛 9 | 🌐 Go | 📅 2025-07-08 - Go client for the Stripe API.
...
* [clipboard](https://github.com/golang-design/clipboard) ⭐ 700 | 🐛 24 | 🌐 Go | 📅 2025-06-14 - 📋 cross-platform clipboard package in Go.
...
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,235 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,354 | 🐛 168 | 🌐 Go | 📅 2025-07-07 - A tool for exploring each layer in a Docker image.
...
* [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,806 | 🐛 27 | 🌐 Go | 📅 2025-06-24 - Fault tolerance and resilience patterns for Go.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 71,616 | 🐛 290 | 🌐 Go | 📅 2025-07-06 - Command-line fuzzy finder written in Go.
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,822 | 🐛 22 | 🌐 Go | 📅 2025-07-09 - Deliver Go binaries as fast and easily as possible.
...
* [hub](https://github.com/github/hub) ⭐ 22,912 | 🐛 294 | 🌐 Go | 📅 2024-02-02 - wrap git commands with additional functionality to interact with github from the terminal.
...
* [jump](https://github.com/gsamokovarov/jump) ⭐ 1,864 | 🐛 2 | 🌐 Go | 📅 2025-06-20 - Jump helps you navigate faster by learning your habits.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,108 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - A comprehensive, efficient, and reusable util function library of go.
...
* [limiters](https://github.com/mennanov/limiters) ⭐ 570 | 🐛 6 | 🌐 Go | 📅 2025-07-01 - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
...
* [mc](https://github.com/minio/mc) ⭐ 3,087 | 🐛 41 | 🌐 Go | 📅 2025-07-02 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,824 | 🐛 42 | 🌐 Go | 📅 2025-07-07 - Package for MIME type detection based on magic numbers.
* [minify](https://github.com/tdewolff/minify) ⭐ 3,904 | 🐛 34 | 🌐 Go | 📅 2025-07-07 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
* [panicparse](https://github.com/maruel/panicparse) ⭐ 3,671 | 🐛 3 | 🌐 Go | 📅 2025-03-13 - Groups similar goroutines and colorizes stack dump.
...
* [retry-go](https://github.com/avast/retry-go) ⭐ 2,719 | 🐛 14 | 🌐 Go | 📅 2025-03-21 - Simple library for retry mechanism.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,126 | 🐛 54 | 🌐 Go | 📅 2025-07-03 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,032 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
...
* [usql](https://github.com/knq/usql) ⭐ 9,423 | 🐛 94 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,755 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [uuid](https://github.com/gofrs/uuid) ⭐ 1,701 | 🐛 7 | 🌐 Go | 📅 2025-07-07 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
* [uuid](https://github.com/google/uuid) ⭐ 5,721 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [xid](https://github.com/rs/xid) ⭐ 4,150 | 🐛 17 | 🌐 Go | 📅 2025-05-12 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
* [jio](https://github.com/faceair/jio) ⭐ 118 | 🐛 2 | 🌐 Go | 📅 2024-07-04 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,118 | 🐛 192 | 🌐 JavaScript | 📅 2025-06-18.
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,943 | 🐛 57 | 🌐 Go | 📅 2024-03-23 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
* [validate](https://github.com/gookit/validate) ⭐ 1,097 | 🐛 27 | 🌐 Go | 📅 2025-06-30 - Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,627 | 🐛 322 | 🌐 Go | 📅 2025-07-02 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 897 | 🐛 7 | 🌐 Go | 📅 2025-07-03 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,920 | 🐛 511 | 🌐 TypeScript | 📅 2025-07-08 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [froggit-go](https://github.com/jfrog/froggit-go) ⭐ 47 | 🐛 18 | 🌐 Go | 📅 2025-06-25 - Froggit-Go is a Go library, allowing to perform actions on VCS providers.
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,701 | 🐛 167 | 🌐 Go | 📅 2025-07-08 - highly extensible Git implementation in pure Go.
...
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 804 | 🐛 18 | 🌐 Go | 📅 2025-07-06 - Pure Go RTSP server and client library.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,244 | 🐛 106 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 479 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,076 | 🐛 103 | 🌐 Go | 📅 2025-07-07 - An Express.js inspired web framework build on Fasthttp.
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 533 | 🐛 31 | 🌐 Go | 📅 2025-07-08 - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
* [Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) ⭐ 565 | 🐛 28 | 🌐 Go | 📅 2025-07-08 - Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications.
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,435 | 🐛 39 | 🌐 Go | 📅 2025-07-08 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,033 | 🐛 859 | 🌐 Go | 📅 2025-07-08 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 | 🐛 13 | 🌐 Go | 📅 2025-07-05 - Gin parameter automatic binding tool,gin rpc tools.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,893 | 🐛 25 | 🌐 Go | 📅 2025-07-06 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,866 | 🐛 79 | 🌐 Go | 📅 2025-07-08 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,512 | 🐛 207 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,902 | 🐛 57 | 🌐 Go | 📅 2025-07-07 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,366 | 🐛 44 | 🌐 Go | 📅 2025-07-04 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [templui](https://github.com/axzilla/templui) ⭐ 761 | 🐛 8 | 🌐 JavaScript | 📅 2025-07-09 - Modern UI Components for Go & Templ.
...
* [Yokai](https://github.com/ankorstore/yokai) ⭐ 733 | 🐛 1 | 🌐 Go | 📅 2025-06-17 - Simple, modular, and observable Go framework for backend applications.
...
* [alice](https://github.com/justinas/alice) ⭐ 3,267 | 🐛 11 | 🌐 Go | 📅 2024-06-06 - Painless middleware chaining for Go.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,087 | 🐛 83 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,918 | 🐛 82 | 🌐 Go | 📅 2024-07-22 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,470 | 🐛 34 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,442 | 🐛 501 | 🌐 Go | 📅 2025-07-07 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,028 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [Cadence-client](https://github.com/uber-go/cadence-client) ⭐ 359 | 🐛 73 | 🌐 Go | 📅 2025-07-08 - A framework for authoring workflows and activities running on top of the Cadence orchestration engine made by Uber.
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,376 | 🐛 110 | 🌐 Go | 📅 2025-07-08 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 561 | 🐛 2 | 🌐 Go | 📅 2025-07-09 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,047 | 🐛 260 | 🌐 Go | 📅 2025-07-08 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,425 | 🐛 242 | 🌐 Go | 📅 2025-07-08 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 | 🐛 19 | 🌐 Go | 📅 2025-07-02 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,985 | 🐛 157 | 🌐 Go | 📅 2025-07-08 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,281 | 🐛 119 | 🌐 Go | 📅 2025-07-08 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
* [golines](https://github.com/segmentio/golines) ⭐ 1,079 | 🐛 72 | 🌐 Go | 📅 2025-04-14 - Formatter that automatically shortens long lines in Go code.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,223 | 🐛 48 | 🌐 Go | 📅 2025-07-08 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,500 | 🐛 579 | 🌐 Go | 📅 2025-07-08 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 141 | 🐛 35 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,876 | 🐛 371 | 🌐 Go | 📅 2025-07-01.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 792 | 🐛 75 | 🌐 Go | 📅 2025-07-07 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,753 | 🐛 96 | 🌐 Go | 📅 2025-07-08 features to Vim/Neovim.
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,799 | 🐛 608 | 🌐 Go | 📅 2025-06-27 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [gotutor](https://github.com/ahmedakef/gotutor) ⭐ 36 | 🐛 0 | 🌐 Elm | 📅 2025-07-08 - Online Go Debugger & Visualizer.
...
* [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,672 | 🐛 202 | 🌐 Go | 📅 2025-06-21 - aptly is a Debian repository management tool.
...
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,414 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
...
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,178 | 🐛 29 | 🌐 Go | 📅 2025-07-07 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,204 | 🐛 2,560 | 🌐 Go | 📅 2025-07-09 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,228 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,771 | 🐛 11 | 🌐 Go | 📅 2025-07-04 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,446 | 🐛 2,712 | 🌐 Go | 📅 2025-07-09 - Fork of Gogs, entirely community driven.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,053 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,039 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,893 | 🐛 246 | 🌐 Go | 📅 2025-07-08 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,162 | 🐛 129 | 🌐 Go | 📅 2025-07-08 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,213 | 🐛 797 | 🌐 Go | 📅 2025-07-08 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,290 | 🐛 207 | 🌐 Go | 📅 2025-07-08 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [ko](https://github.com/google/ko) ⭐ 8,058 | 🐛 52 | 🌐 Go | 📅 2025-07-03 - Command line tool for building and deploying Go applications on Kubernetes
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,758 | 🐛 148 | 🌐 Go | 📅 2025-07-09 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,214 | 🐛 2,608 | 🌐 Go | 📅 2025-07-09 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,420 | 🐛 141 | 🌐 Go | 📅 2025-07-07 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,754 | 🐛 541 | 🌐 Go | 📅 2025-07-08 - Cloud native application delivery.
* [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,182 | 🐛 4 | 🌐 Go | 📅 2025-07-05 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
* [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,145 | 🐛 47 | 🌐 Go | 📅 2025-07-09 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,668 | 🐛 526 | 🌐 Go | 📅 2025-07-08 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,053 | 🐛 3,609 | 🌐 Go | 📅 2025-07-08 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,407 | 🐛 302 | 🌐 Go | 📅 2025-07-07 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 436 | 🐛 1 | 🌐 Go | 📅 2024-06-19 - Flexible HTTP command line stress tester.
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,184 | 🐛 105 | 🌐 Go | 📅 2025-07-08 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,645 | 🐛 29 | 🌐 Go | 📅 2025-06-27 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,331 | 🐛 134 | 🌐 Go | 📅 2025-07-08 - Pomerium is an identity-aware access proxy.
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,397 | 🐛 140 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 925 | 🐛 200 | 🌐 Go | 📅 2025-07-08 - Manage BareMetal Servers from Command Line (as easily as with Docker).
* [script](https://github.com/bitfield/script) ⭐ 6,768 | 🐛 42 | 🌐 Go | 📅 2025-03-22 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
* [tau](https://github.com/taubyte/tau) ⭐ 4,050 | 🐛 28 | 🌐 Go | 📅 2025-06-23 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
* [traefik](https://github.com/containous/traefik) ⭐ 55,465 | 🐛 657 | 🌐 Go | 📅 2025-07-08 - Reverse proxy and load balancer with support for multiple backends.
...
* [uTask](https://github.com/ovh/utask) ⭐ 1,291 | 🐛 52 | 🌐 Go | 📅 2025-07-07 - Automation engine that models and executes business processes declared in yaml.
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,354 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,442 | 🐛 66 | 🌐 Go | 📅 2025-07-04 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 584 | 🐛 10 | 🌐 Go | 📅 2025-07-07 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [confd](https://github.com/kelseyhightower/confd) ⭐ 8,401 | 🐛 179 | 🌐 Go | 📅 2024-07-16 - Manage local application configuration files using templates and data from etcd or consul.
* [crawley](https://github.com/s0rg/crawley) ⭐ 302 | 🐛 3 | 🌐 Go | 📅 2025-06-18 - Web scraper/crawler for cli.
* [croc](https://github.com/schollz/croc) ⭐ 30,529 | 🐛 15 | 🌐 Go | 📅 2025-07-07 - Easily and securely send files or folders from one computer to another.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,011 | 🐛 18 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
* [Gor](https://github.com/buger/gor) ⭐ 18,998 | 🐛 339 | 🌐 Go | 📅 2025-04-05 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,852 | 🐛 124 | 🌐 Go | 📅 2025-07-08 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [nes](https://github.com/fogleman/nes) ⭐ 5,574 | 🐛 12 | 🌐 Go | 📅 2024-08-17 - Nintendo Entertainment System (NES) emulator written in Go.
...
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,661 | 🐛 28 | 🌐 Go | 📅 2024-08-20 - Portal is a quick and easy command-line file transfer utility from any computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,241 | 🐛 474 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 702 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,460 | 🐛 53 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,104 | 🐛 591 | 🌐 Go | 📅 2025-07-09 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [Stack Up](https://github.com/pressly/sup) ⭐ 2,504 | 🐛 56 | 🌐 Go | 📅 2023-12-24 - Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers.
...
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,342 | 🐛 91 | 🌐 Go | 📅 2025-07-07 - Proxy to simulate network and system conditions for automated tests.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,193 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [gophers](https://github.com/egonelbre/gophers) ⭐ 3,683 | 🐛 5 | 🌐 Go | 📅 2022-07-06 - Free gophers.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,057 | 🐛 7,318 | 🌐 Go | 📅 2025-07-09
* [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
* [Google](https://google.github.io/styleguide/go/)
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,186 | 🐛 182 | 🌐 Go | 📅 2025-06-30
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,631 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,637 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,778 | 🐛 9,380 | 🌐 Go | 📅 2025-07-08 - List of projects on the Go community wiki.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,678 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,933 | 🐛 7 | 🌐 Go | 📅 2025-07-08 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,653 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [golang-examples](https://github.com/SimonWaldherr/golang-examples) ⭐ 1,630 | 🐛 6 | 🌐 Go | 📅 2025-04-19 - Many examples to learn Golang.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,377 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,960 | 🐛 66 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
