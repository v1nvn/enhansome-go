...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,204](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 246,237.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,204 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,204; you rock!
...
- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 587 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,813 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,155 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 143,301 - Run large language models locally.
...
- [PortAudio](https://github.com/gordonklaus/portaudio) ⭐ 773 - Go bindings for the PortAudio audio I/O library.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,721 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [go-jose](https://github.com/go-jose/go-jose) ⭐ 402 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
- [gologin](https://github.com/dghubble/gologin) ⭐ 1,908 - chainable handlers for login with OAuth1 and OAuth2 authentication providers.
...
- [keto](https://github.com/ory/keto) ⭐ 5,037 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
- [loginsrv](https://github.com/tarent/loginsrv) ⭐ 1,924 - JWT login microservice with pluggable backends such as OAuth2 (Github), htpasswd, osiam.
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,619 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,689 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,342 - Session Manager for HTTP servers.
...
- [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,609 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,107 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,516 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,938 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,319 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,183 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,340 - Telegram bot framework is written in Go.
...
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,975 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,710 - Air - Live reload for Go apps.
...
- [goyek](https://github.com/goyek/goyek) ⭐ 625 - Create build pipelines in Go.
- [mage](https://github.com/magefile/mage) ⭐ 4,347 - Mage is a make/rake-like build tool using Go.
...
- [Task](https://github.com/go-task/task) ⭐ 12,939 - simple "Make" alternative.
...
- [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,831 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
...
- [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 496 - An interactive table component for bubbletea.
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,391 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,079 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,537 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,368 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,749.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,250 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,059 - Declaratively define styles for color, format and layout in the terminal.
- [marker](https://github.com/cyucelen/marker) ⭐ 50 - Easiest way to match and mark strings for colorful terminal outputs.
- [mpb](https://github.com/vbauerster/mpb) ⭐ 2,405 - Multi progress bar for terminal applications.
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,409 - Basic thread-safe progress bar that works in every OS.
- [pterm](https://github.com/pterm/pterm) ⭐ 5,101 - A library to beautify console output on every platform with many combinable components.
- [simpletable](https://github.com/alexeyco/simpletable) ⭐ 538 - Simple tables in a terminal with Go.
- [spinner](https://github.com/briandowns/spinner) ⭐ 2,435 - Go package to easily provide a terminal spinner with options.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,824 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,363.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,840 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,363 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,608.
- [uilive](https://github.com/gosuri/uilive) ⭐ 1,708 - Library for updating terminal output in real time.
- [uiprogress](https://github.com/gosuri/uiprogress) ⭐ 2,128 - Flexible library to render progress bars in terminal applications.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 675 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,275 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,669 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,032 - An expressive programming language and a versatile interactive shell.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,239 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,525 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,345 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,230 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,232 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
- [konf](https://github.com/nil-go/konf) ⭐ 321 - The simplest API for reading/watching config from file, env, flag and clouds (e.g. AWS, Azure, GCP).
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,654 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,192 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,658 - Go configuration with fangs.
...
- [drone](https://github.com/drone/drone) ⭐ 32,833 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 560 - go test output for humans.
- [goveralls](https://github.com/mattn/goveralls) ⭐ 790 - Go integration for Coveralls.io continuous code coverage tracking system.
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,566 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,735.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,139 - Woodpecker is a community fork of the Drone CI system.
...
- [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,110 - A high-performance ELT data integration framework with pluggable architecture.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,713 - Go package implementing compressed bitsets.
...
- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,603 - Go package implementing Bloom filters.
...
- [gods](https://github.com/emirpasic/gods) ⭐ 16,946 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,672 - Distributed, Fault-tolerant task queue.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,524 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,406 - Modern text indexing library for go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,844 - Efficient key/value cache for gigabytes of data.
...
- [cache2go](https://github.com/muesli/cache2go) ⭐ 2,154 - In-memory key:value cache which supports automatic invalidation based on timeouts.
...
- [fastcache](https://github.com/VictoriaMetrics/fastcache) ⭐ 2,226 - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
...
- [gocache](https://github.com/eko/gocache) ⭐ 2,664 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [groupcache](https://github.com/golang/groupcache) ⭐ 13,181 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,110 -  A high performance memory-bound Go cache.
...
- [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,057 - An in-memory cache with item expiration and generics.
- [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger](https://github.com/dgraph-io/badger) ⭐ 14,639 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,824 - An embedded key/value database for Go.
...
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 30,976 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,303 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,919 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,726 - Dolt – It's Git for Data.
...
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,270 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,722 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,140 - Scalable datastore for metrics, events, and real-time analytics.
...
- [LinDB](https://github.com/lindb/lindb) ⭐ 3,035 - LinDB is a scalable, high performance, high availability distributed time series database.
- [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,162 - Fast k/v database compatible with lsm and b+tree.
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,266 - Milvus is a vector database for embedding management, analytics and search.
- [moss](https://github.com/couchbase/moss) ⭐ 1,004 - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,472 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
- [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,229 - High-performance embedded Object Database (NoSQL) with Go API.
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,335 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,906 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,780 - Redis re-implemented with SQLite.
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,807 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,667 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,555 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,280 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,914 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,549 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,042 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,501 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
- [gorm-seeder](https://github.com/Kachit/gorm-seeder) ⭐ 16 - Simple database seeder for Gorm ORM.
- [gormigrate](https://github.com/go-gormigrate/gormigrate) ⭐ 1,092 - Database schema migration helper for Gorm ORM.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,786 - Database migrations. CLI and Golang library.
...
- [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,357 - HTTP proxy for ClickHouse database.
...
- [gatewayd](https://github.com/gatewayd-io/gatewayd) ⭐ 261 - Cloud-native database gateway and framework for building data-driven applications. Like API gateways, for databases.
- [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,755 - Go toolset to handle MySQL protocol and replication.
...
- [onedump](https://github.com/liweiyi88/onedump) ⭐ 189 - Database backup from different drivers to different destinations with one command and configuration.
- [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,183 - Advanced scheduling for PostgreSQL.
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,908 - Web-based PostgreSQL database browser.
- [prep](https://github.com/hexdigest/prep) ⭐ 35 - Use prepared SQL statements without changing your code.
- [pREST](https://github.com/prest/prest) ⭐ 4,359 - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,640 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
- [wescale](https://github.com/wesql/wescale) ⭐ 303 - WeScale is a database proxy designed to enhance the scalability, performance, security, and resilience of your applications.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,216 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,276 - Generate type-safe code from SQL.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,844 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,516 - SQLite3 driver for go that uses database/sql.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,945 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,945 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,427 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,500 - Pure Go Postgres driver for database/sql.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,361 - Official MongoDB driver for the Go language.
...
- [redigo](https://github.com/gomodule/redigo) ⭐ 9,821 - Redigo is a Go client for the Redis database.
- [redis](https://github.com/redis/go-redis) ⭐ 20,952 - Redis client for Golang.
...
- [carbon](https://github.com/dromara/carbon) ⭐ 5,061 - A simple, semantic and developer-friendly time package for golang.
...
- [dateparse](https://github.com/araddon/dateparse) ⭐ 2,088 - Parse date's without knowing format in advance.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,615 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [evans](https://github.com/ktr0731/evans) ⭐ 4,391 - Evans: more expressive universal gRPC client.
...
- [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,317 - A Go framework for the API or Microservice with handy scaffolding tools.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,076 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,333 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,172 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,913 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,039 - A cloud native Kubernetes Global Balancer.
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,468 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,438 - A modular-designed and easy-to-use microservices framework in Go.
...
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,306 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,622 - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,617 - Simplified distributed locking implementation using Redis.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,280).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,885 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [Temporal](https://github.com/temporalio/sdk-go) ⭐ 646 - Durable execution system for making code fault-tolerant and simple.
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,785 - BitTorrent client package.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,002 - A simple Go library for sending mails in Go.
...
- [go-simple-mail](https://github.com/xhit/go-simple-mail) ⭐ 679 - Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,560 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,929 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,196 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 4,999 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,608.
- [cel-go](https://github.com/google/cel-go) ⭐ 2,566 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,925 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,048 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,273 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,204 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,608 - Lua 5.1 VM and compiler written in Go.
...
- [starlark-go](https://github.com/google/starlark-go) ⭐ 2,477 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
- [starlet](https://github.com/1set/starlet) ⭐ 30 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,477 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
- [tengo](https://github.com/d5/tengo) ⭐ 3,654 - Bytecode compiled script language for Go.
- [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,576 - The Wa Programming Language embedded in Go.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,660 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
- [errlog](https://github.com/snwfdhmp/errlog) ⭐ 460 - Hackable package that determines responsible source code for an error (and some other fast-debugging features). Pluggable to any logger in-place.
...
- [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2,455 - Go (golang) package for representing a list of errors as a single error.
...
- [multierr](https://github.com/uber-go/multierr) ⭐ 1,138 - Package for representing a list of errors as a single error.
- [oops](https://github.com/samber/oops) ⭐ 679 - Error handling with context, stack trace and source fragments.
...
- [afs](https://github.com/viant/afs) ⭐ 331 - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,484 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,697 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,801.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,778 - Arbitrary-precision fixed-point decimal numbers.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,272 - Terminal stock watcher and stock position tracker.
...
- [form](https://github.com/go-playground/form) ⭐ 837 - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
- [nosurf](https://github.com/justinas/nosurf) ⭐ 1,669 - CSRF protection middleware for Go.
...
- [mo](https://github.com/samber/mo) ⭐ 2,988 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,108 - dead simple 2D game engine in Go.
...
- [Leaf](https://github.com/name5566/leaf) ⭐ 5,408 - Lightweight game server framework.
- [nano](https://github.com/lonng/nano) ⭐ 3,024 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,627 - Pure Go game engine.
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,555 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [termloop](https://github.com/JoelOtter/termloop) ⭐ 1,456 - Terminal-based game engine for Go, built on top of Termbox.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,189 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,386 - Compile shell scripts to Go.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,731 - A high-performance and low-cost goroutine pool in Go.
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,924 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [goworker](https://github.com/benmanns/goworker) ⭐ 2,826 - goworker is a Go-based background worker.
...
- [pond](https://github.com/alitto/pond) ⭐ 1,788 - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [tunny](https://github.com/Jeffail/tunny) ⭐ 3,995 - Goroutine pool for golang.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,681 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 411 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,074 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,655.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,562 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [webview](https://github.com/zserge/webview) ⭐ 13,146 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,178 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
- [systray](https://github.com/getlantern/systray) ⭐ 3,489 - Cross platform Go library to place an icon and menu in the notification area.
...
- [zenity](https://github.com/ncruces/zenity) ⭐ 813 - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
- [ghw](https://github.com/jaypipes/ghw) ⭐ 1,754 - Golang hardware discovery/inspection library.
...
- [bild](https://github.com/anthonynsimon/bild) ⭐ 4,109 - Collection of image processing algorithms in pure Go.
- [bimg](https://github.com/h2non/bimg) ⭐ 2,858 - Small package for fast and efficient image processing using libvips.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,080 - Go package for computer vision using OpenCV 3.3+.
...
- [govips](https://github.com/davidbyttow/govips) ⭐ 1,444 - A lightning fast image processing and resizing library for Go.
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,766 - Screenshoting webpages using go and headless chrome on command line.
...
- [imagick](https://github.com/gographics/imagick) ⭐ 1,822 - Go binding to ImageMagick's MagickWand C API.
- [imaginary](https://github.com/h2non/imaginary) ⭐ 5,857 - Fast and simple HTTP microservice for image resizing.
...
- [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,594 - Lightweight data stream processing engine for IoT edge.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,119 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,880 - Simple, zero-dependency scheduling library for Go.
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,280 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492.
...
- [fastjson](https://github.com/valyala/fastjson) ⭐ 2,379 - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,971 - Get a JSON value with one line of code.
...
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 551 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,294 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,294 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,294 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,294, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,076, [zap](https://github.com/uber-go/zap) ⭐ 23,184, [zerolog](https://github.com/rs/zerolog) ⭐ 11,476, etc).
...
- [phuslu/log](https://github.com/phuslu/log) ⭐ 764 - High performance structured logging.
...
- [slog-multi](https://github.com/samber/slog-multi) ⭐ 482 - Chain of slog.Handler (pipeline, fanout...).
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,007 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,184 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,476 - Zero-allocation JSON logger.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 793 - An accelerated Machine Learning framework for Go.
...
- [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,775 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,887 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
- [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,881 - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,780 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,323 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,008 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,391 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,090 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,757 - Asynchronous task queue/job queue based on distributed message passing.
...
- [melody](https://github.com/olahol/melody) ⭐ 3,920 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,952 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,029 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,526 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [excelize](https://github.com/xuri/excelize) ⭐ 19,236 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [do](https://github.com/samber/do) ⭐ 2,125 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,562 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,824 - Automated Initialization in Go.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,582 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,660 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,660 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,245 - Nunu is a scaffolding tool for building Go applications.
...
- [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,121 - cross-platform, cli app to perform various operations on string.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,516 - Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,954 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,222 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,260 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,733.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,526 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,145 which a Chinese word splitting algorithm.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,250 - Package and an accompanying tool to work with localized text.
...
- [cidranger](https://github.com/yl2chen/cidranger) ⭐ 942 - Fast IP to CIDR lookup for Go.
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,758 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,364 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,620 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- [fortio](https://github.com/fortio/fortio) ⭐ 3,538 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
- [ftp](https://github.com/jlaffaye/ftp) ⭐ 1,358 - Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959).
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,573 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
- [gnet](https://github.com/fish-tennis/gnet) ⭐ 21 - `gnet` is a high-performance networking framework,especially for game servers.
- [gNxI](https://github.com/google/gnxi) ⭐ 272 - A collection of tools for Network Management that use the gNMI and gNOI protocols.
- [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,706 - Go library for downloading files or directories from various sources using a URL.
...
- [gopacket](https://github.com/google/gopacket) ⭐ 6,542 - Go library for packet processing with libpcap bindings.
- [gopcap](https://github.com/akrennmair/gopcap) ⭐ 492 - Go wrapper for libpcap.
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,373 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [HTTPLab](https://github.com/gchaincl/httplab) ⭐ 4,076 - HTTPLabs let you inspect HTTP requests and forge responses.
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,263 - KCP - Fast and Reliable ARQ Protocol.
...
- [mdns](https://github.com/hashicorp/mdns) ⭐ 1,263 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,501 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,722 - An implementation of the QUIC protocol in pure Go.
...
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,910 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,898 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,890 - A pure Go implementation of the WebRTC API.
...
- [go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) ⭐ 398 - Get easily stdlib HTTP client, which does not share any state with other clients.
...
- [grequests](https://github.com/levigross/grequests) ⭐ 2,152 - A Go "clone" of the great and famous Requests library.
...
- [requests](https://github.com/carlmjohnson/requests) ⭐ 1,605 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
- [resty](https://github.com/go-resty/resty) ⭐ 10,946 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,158 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [gl](https://github.com/go-gl/gl) ⭐ 1,157 - Go bindings for OpenGL (generated via glow).
- [glfw](https://github.com/go-gl/glfw) ⭐ 1,625 - Go bindings for GLFW 3.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,295 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,186 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,240 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,306 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,301 - Prisma Client Go, Typesafe database access for Go.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,175 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,430 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 169 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,045 - No instrumentation tracing for Golang applications via eBPF.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,474 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,368 - go generate based graphql server library.
...
- [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,071 - Implementation of GraphQL for Go.
...
- [vfsgen](https://github.com/shurcooL/vfsgen) ⭐ 983 - Generates a vfsdata.go file that statically implements the given virtual filesystem.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,038 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,041 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,163 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 567 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,388 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,687 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,636 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
- [luks.go](https://github.com/anatol/luks.go) ⭐ 90 - Pure Golang library to manage LUKS partitions.
- [memguard](https://github.com/awnumar/memguard) ⭐ 2,634 - A pure Go library for handling sensitive values in memory.
...
- [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,958 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,771 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
- [algernon](https://github.com/xyproto/algernon) ⭐ 2,912 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,791 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [devd](https://github.com/cortesi/devd) ⭐ 3,453 - Local webserver for developers.
...
- [Easegress](https://github.com/megaease/easegress) ⭐ 5,826 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,563 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,534 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,495 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,405 - A self contained feature flag solution written in Go and Vue.js
...
- [minio](https://github.com/minio/minio) ⭐ 53,036 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,730 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,157 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,536 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,116 - Make SSH apps, just like that!
...
- [jet](https://github.com/CloudyKit/jet) ⭐ 1,328 - Jet template engine.
- [liquid](https://github.com/osteele/liquid) ⭐ 303 - Go implementation of Shopify Liquid templates.
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,429 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,362 - A HTML templating language that has great developer tooling.
...
- [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,439 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
- [go-carpet](https://github.com/msoap/go-carpet) ⭐ 248 - Tool for viewing test coverage in terminal.
- [go-cmp](https://github.com/google/go-cmp) ⭐ 4,425 - Package for comparing Go values in tests.
...
- [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,309 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,160 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,098 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,716 - Sacred extension to the standard go testing package.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,836 - Mocking framework for the Go programming language.
...
- [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,030 - Easy mocking of HTTP responses from external resources.
- [minimock](https://github.com/gojuno/minimock) ⭐ 684 - Mock generator for Go interfaces.
- [mockery](https://github.com/vektra/mockery) ⭐ 6,618 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 482 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,945.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,900 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,719 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,978 - A Devtools driver to make web automation and scraping easy.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,552 - Formatters for time, numbers, and memory size to human readable format.
...
- [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,816 - Go library for the TOML format with query support and handy cli tools.
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,108 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,876 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [toml](https://github.com/BurntSushi/toml) ⭐ 4,738 - TOML configuration format (encoder/decoder with reflection).
...
- [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,696 - Parse RSS and Atom feeds in Go.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,776 - Shell parser and formatter.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,405 - HTML Sanitizer.
- [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 - A sanitization-based swear filter for Go.

### Scrapers

- [colly](https://github.com/asciimoo/colly) ⭐ 24,291 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,520 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,085 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,417 - Go bindings for the Discord Chat API.
...
- [github](https://github.com/google/go-github) ⭐ 10,822 - Go library for accessing the GitHub REST API v3.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,049 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google](https://github.com/google/google-api-go-client) ⭐ 4,262 - Auto-generated Google APIs for Go.
...
- [changie](https://github.com/miniscruff/changie) ⭐ 772 - Automated changelog tool for preparing releases with lots of customization options.
...
- [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 375 - Cross Platform tool to validate configuration files.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,178 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 51,028 - A tool for exploring each layer in a Docker image.
...
- [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,790 - Fault tolerance and resilience patterns for Go.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,840 - Command-line fuzzy finder written in Go.
...
- [go-bsdiff](https://github.com/gabstv/go-bsdiff) ⭐ 164 - Pure Go bsdiff and bspatch libraries and CLI tools.
...
- [go-funk](https://github.com/thoas/go-funk) ⭐ 4,900 - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,730 - Deliver Go binaries as fast and easily as possible.
...
- [jump](https://github.com/gsamokovarov/jump) ⭐ 1,853 - Jump helps you navigate faster by learning your habits.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,048 - A comprehensive, efficient, and reusable util function library of go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,541 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mc](https://github.com/minio/mc) ⭐ 3,058 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
- [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,812 - Package for MIME type detection based on magic numbers.
- [minify](https://github.com/tdewolff/minify) ⭐ 3,889 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- [scany](https://github.com/georgysavva/scany) ⭐ 1,427 - Library for scanning data from a database into Go structs and more.
- [serve](https://github.com/syntaqx/serve) ⭐ 341 - A static http server anywhere you need.
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,061 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,982 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [toolbox](https://github.com/viant/toolbox) ⭐ 216 - Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,730 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/gofrs/uuid) ⭐ 1,688 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
...
- [xid](https://github.com/rs/xid) ⭐ 4,131 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,930 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
- [validate](https://github.com/gookit/validate) ⭐ 1,099 - Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 866 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,471 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,592 - highly extensible Git implementation in pure Go.
...
- [Beego](https://github.com/beego/beego) ⭐ 32,113 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,106 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 450 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,811 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,408 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,666 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 - Gin parameter automatic binding tool,gin rpc tools.
- [Goa](https://github.com/goadesign/goa) ⭐ 5,873 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,457 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,436 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,843 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,297 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,140 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
- [iWF](https://github.com/indeedeng/iwf) ⭐ 574 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
- [templui](https://github.com/axzilla/templui) ⭐ 699 - Modern UI Components for Go & Templ.
...
- [Limiter](https://github.com/ulule/limiter) ⭐ 2,218 - Dead simple rate limit middleware for Go.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,909 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,892 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,404 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,305 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,967 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [go-ole](https://github.com/go-ole/go-ole) ⭐ 1,242 - Win32 OLE implementation for golang.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,243 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [workflow](https://github.com/luno/workflow) ⭐ 165 - A tech stack agnostic Event Driven Workflow framework.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,984 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,357 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 106 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [Spire](https://github.com/spiffe/spire) ⭐ 1,966 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,124 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,069 - Formatter that automatically shortens long lines in Go code.
- [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,009 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,196 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,458 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,716.
...
- [vacuum](https://github.com/daveshanley/vacuum) ⭐ 780 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 573 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,706 features to Vim/Neovim.
...
- [go-mode](https://github.com/dominikh/go-mode.el) ⭐ 1,420 - Go mode for GNU/Emacs.
...
- [vim-go](https://github.com/fatih/vim-go) ⭐ 16,141 - Go development plugin for Vim.
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,061 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [xgen](https://github.com/xuri/xgen) ⭐ 368 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,589 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,770 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [OctoLinker](https://github.com/OctoLinker/browser-extension) ⭐ 5,312 - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.
...
- [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,658 - aptly is a Debian repository management tool.
...
- [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,397 - Fast cross-platform HTTP benchmarking tool.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,129 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,069 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,221 - Build powerful pipelines in any programming language.
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,749 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,011 - Fork of Gogs, entirely community driven.
...
- [go-selfupdate](https://github.com/sanbornm/go-selfupdate) ⭐ 1,615 - Enable your Go applications to self update.
...
- [Hey](https://github.com/rakyll/hey) ⭐ 18,949 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,845 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,891 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 27,988 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,199 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,728 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,635 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,380 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,709 - Cloud native application delivery.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,524 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,867 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,617 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,291 - Pomerium is an identity-aware access proxy.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,101 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,717 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,007 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,093 - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,281 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,374 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,390 - Simulate bad network connections.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,344 - Easily and securely send files or folders from one computer to another.
- [Documize](https://github.com/documize/community) ⭐ 2,238 - Modern wiki software that integrates data from SaaS tools.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,930 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
- [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 863 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
- [Gor](https://github.com/buger/gor) ⭐ 18,949 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,698 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,686 - LiteIDE is a simple, open source, cross-platform Go IDE.
...
- [nes](https://github.com/fogleman/nes) ⭐ 5,558 - Nintendo Entertainment System (NES) emulator written in Go.
...
- [restic](https://github.com/restic/restic) ⭐ 28,939 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 696 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,378 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,745 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
- [shell2http](https://github.com/msoap/shell2http) ⭐ 1,409 - Executing shell commands via http server (for prototyping or remote control).
...
- [stew](https://github.com/marwanhawari/stew) ⭐ 269 - An independent package manager for compiled binaries.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,282 - Proxy to simulate network and system conditions for automated tests.
...
- [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 418 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
- [Build Web Application with Golang](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/)
- [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
- [Go 101](https://go101.org) - A book focusing on Go syntax/semantics and all kinds of details.
- [Go AST Book (Chinese)](https://github.com/chai2010/go-ast-book) ⭐ 5,443 - A book focusing on Go `go/*` packages.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,063 - A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,748 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [gophers](https://github.com/ashleymcnamara/gophers) ⭐ 3,007 - Gopher artworks by Ashley McNamara.
- [gophers](https://github.com/egonelbre/gophers) ⭐ 3,651 - Free gophers.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 30,976
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,558
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,272 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,287 - List of projects on the Go community wiki.
...
- [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,641 - Go's reference card.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,856 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,537 - Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,723 - Examples of Golang compared to Node.js for learning.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,326 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,864 - Learn Go with test-driven development.
