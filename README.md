...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,876](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
We use the _[Golang Bridge](https://github.com/gobridge/about-us/blob/master/README.md) ⭐ 406_ community Slack for instant communication, follow the [form here to join](https://invite.slack.golangbridge.org/).
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 247,348.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,876 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,876; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,992 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 600 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,937 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,358 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 144,415 - Run large language models locally.
...
- [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,725 - A low-level library to play sound on multiple platforms.
...
- [authboss](https://github.com/volatiletech/authboss) ⭐ 3,972 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,778 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,051 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,169 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- [keto](https://github.com/ory/keto) ⭐ 5,046 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,633 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,726 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [paseto](https://github.com/o1egl/paseto) ⭐ 893 - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
- [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,619 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,166 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,529 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,952 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,327 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,197 - Zero-dependencies Telegram Bot library with additional UI components
- [echotron](https://github.com/NicoNex/echotron) ⭐ 404 - An elegant and concurrent library for Telegram Bots in Go.
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,357 - Telegram bot framework is written in Go.
- [telego](https://github.com/mymmrac/telego) ⭐ 727 - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,177 - Simple and clean Telegram bot client.
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,980 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,802 - Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4,361 - Mage is a make/rake-like build tool using Go.
- [mmake](https://github.com/tj/mmake) ⭐ 1,726 - Modern Make.
- [realize](https://github.com/tockins/realize) ⭐ 4,457 - Go build a system with file watchers and live to reload. Run, build and watch file changes with custom paths.
- [Task](https://github.com/go-task/task) ⭐ 12,999 - simple "Make" alternative.
...
- [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,839 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,457 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,425 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,588 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,377 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,773.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,125 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,420 - Basic thread-safe progress bar that works in every OS.
- [pterm](https://github.com/pterm/pterm) ⭐ 5,119 - A library to beautify console output on every platform with many combinable components.
...
- [acmd](https://github.com/cristalhq/acmd) ⭐ 124 - Simple, useful, and opinionated CLI package in Go.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 688 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,304 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,834 - Commander for modern Go CLI interactions.
...
- [Dnote](https://github.com/dnote/dnote) ⭐ 2,877 - A simple command line notebook with multi-device sync.
...
- [liner](https://github.com/peterh/liner) ⭐ 1,062 - Go readline-like library for command-line interfaces.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,263 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,847 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,555 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,374 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,243 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,723 - Go configuration with fangs.
...
- [drone](https://github.com/drone/drone) ⭐ 32,883 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 154 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,165 - Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,382 - A message streaming bridge between a range of protocols.
...
- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,609 - Go package implementing Bloom filters.
...
- [boomfilters](https://github.com/tylertreat/BoomFilters) ⭐ 1,616 - Probabilistic data structures for processing continuous, unbounded streams.
...
- [gods](https://github.com/emirpasic/gods) ⭐ 16,969 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,711 - Distributed, Fault-tolerant task queue.
...
- [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 401 - Implementation to calculate levenshtein distance in Go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,856 - Efficient key/value cache for gigabytes of data.
...
- [gocache](https://github.com/eko/gocache) ⭐ 2,671 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [otter](https://github.com/maypok86/otter) ⭐ 1,910 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,138 -  A high performance memory-bound Go cache.
...
- [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,092 - An in-memory cache with item expiration and generics.
- [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger](https://github.com/dgraph-io/badger) ⭐ 14,678 - Fast key-value store in Go.
...
- [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,720 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover](https://github.com/ostafen/clover) ⭐ 758 - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,014 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,954 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,558 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
...
- [godis](https://github.com/hdt3213/godis) ⭐ 3,702 - A Golang implemented high-performance Redis server and cluster.
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,276 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,764 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,202 - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,513 - Milvus is a vector database for embedding management, analytics and search.
...
- [pogreb](https://github.com/akrylysov/pogreb) ⭐ 1,340 - Embedded key-value store for read-heavy workloads.
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,076 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,785 - Redis re-implemented with SQLite.
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,817 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,689 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,606 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,357 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,955 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,611 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,070 - A lightweight, framework-agnostic database migration tool.
...
- [goavro](https://github.com/linkedin/goavro) ⭐ 1,029 - A Go package that encodes and decodes Avro data.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,561 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,857 - Database migrations. CLI and Golang library.
...
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,920 - Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,715 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,344 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,462 - Go library that helps you build SQL queries.
...
- [cayley](https://github.com/google/cayley) ⭐ 14,941 - Graph database with support for multiple backends.
...
- [go-transaction-manager](https://github.com/avito-tech/go-transaction-manager) ⭐ 311 - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
...
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,529 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 717 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,999 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,999 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,437 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,504 - Pure Go Postgres driver for database/sql.
...
- [go-mongox](https://github.com/chenmingyong0423/go-mongox) ⭐ 192 - A Go Mongo library based on the official driver, featuring streamlined document operations, generic binding of structs to collections, built-in CRUD, aggregation, automated field updates, struct validation, hooks, and plugin-based programming.
...
- [gomemcache](https://github.com/bradfitz/gomemcache/) ⭐ 1,817 - memcache client library for the Go programming language.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,982 - Redis client for Golang.
...
- [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,079 - ClickHouse SQL client for Go with a `database/sql` compatibility.
- [effdsl](https://github.com/sdqri/effdsl) ⭐ 30 - Elasticsearch query builder for Go.
- [elastic](https://github.com/olivere/elastic) ⭐ 7,474 - Elasticsearch client for Go.
...
- [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,893 - Official Elasticsearch client for Go.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,627 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,105 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,357 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,261 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,951 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [jsonrpc](https://github.com/ybbus/jsonrpc) ⭐ 354 - JSON-RPC 2.0 HTTP client implementation.
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,044 - A cloud native Kubernetes Global Balancer.
...
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,491 - A modular-designed and easy-to-use microservices framework in Go.
...
- [micro](https://github.com/micro/micro) ⭐ 12,258 - A distributed systems runtime for the cloud and beyond.
...
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,363 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,643 - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 858 - Go implementation of the Raft consensus protocol, by CoreOS.
- [rain](https://github.com/cenkalti/rain) ⭐ 1,047 - BitTorrent client and library.
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,625 - Simplified distributed locking implementation using Redis.
...
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,900 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,791 - BitTorrent client package.
...
- [GoDNS](https://github.com/timothyye/godns) ⭐ 1,588 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- [go-imap](https://github.com/emersion/go-imap) ⭐ 2,202 - IMAP library for clients and servers.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,570 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,963 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,246 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5,026 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,618.
- [cel-go](https://github.com/google/cel-go) ⭐ 2,578 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,020 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,280 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,232 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,618 - Lua 5.1 VM and compiler written in Go.
- [gval](https://github.com/PaesslerAG/gval) ⭐ 793 - A highly customizable expression language written in Go.
- [metacall](https://github.com/metacall/core) ⭐ 1,656 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
- [starlark-go](https://github.com/google/starlark-go) ⭐ 2,483 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
- [starlet](https://github.com/1set/starlet) ⭐ 30 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,483 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
- [tengo](https://github.com/d5/tengo) ⭐ 3,657 - Bytecode compiled script language for Go.
- [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,583 - The Wa Programming Language embedded in Go.
...
- [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2,463 - Go (golang) package for representing a list of errors as a single error.
...
- [oops](https://github.com/samber/oops) ⭐ 688 - Error handling with context, stack trace and source fragments.
...
- [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 97 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,156).
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,540 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,731 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,820.
...
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1,368 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,799 - Arbitrary-precision fixed-point decimal numbers.
- [decimal](https://github.com/govalues/decimal) ⭐ 167 - Immutable decimal numbers with panic-free arithmetic.
...
- [ledger](https://github.com/formancehq/ledger) ⭐ 982 - A programmable financial ledger that provides a foundation for money-moving applications.
...
- [techan](https://github.com/sdcoffey/techan) ⭐ 864 - Technical analysis library with advanced market analysis and trading strategies.
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,283 - Terminal stock watcher and stock position tracker.
...
- [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,124 - CSRF protection for Go web applications & services.
...
- [go-functional](https://github.com/BooleanCat/go-functional) ⭐ 503 - Functional programming in Go using generics
...
- [mo](https://github.com/samber/mo) ⭐ 2,999 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,146 - dead simple 2D game engine in Go.
...
- [g3n](https://github.com/g3n/engine) ⭐ 2,958 - Go 3D Game Engine.
- [go-astar](https://github.com/beefsack/go-astar) ⭐ 614 - Go implementation of the A\* path finding algorithm.
- [go-sdl2](https://github.com/veandco/go-sdl2) ⭐ 2,300 - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).
...
- [nano](https://github.com/lonng/nano) ⭐ 3,034 - Lightweight, facility, high performance golang based game server framework.
...
- [go-enum](https://github.com/abice/go-enum) ⭐ 838 - Code generation for enums from code comments.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,234 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,938 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [pond](https://github.com/alitto/pond) ⭐ 1,799 - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,701 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 415 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,295 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,661.
...
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,259 - Build native macOS applications using Go.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,614 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [qt](https://github.com/therecipe/qt) ⭐ 10,675 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- [webview](https://github.com/zserge/webview) ⭐ 13,171 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,206 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [ghw](https://github.com/jaypipes/ghw) ⭐ 1,758 - Golang hardware discovery/inspection library.
...
- [bild](https://github.com/anthonynsimon/bild) ⭐ 4,112 - Collection of image processing algorithms in pure Go.
- [bimg](https://github.com/h2non/bimg) ⭐ 2,866 - Small package for fast and efficient image processing using libvips.
- [cameron](https://github.com/aofei/cameron) ⭐ 127 - An avatar generator for Go.
- [canvas](https://github.com/tdewolff/canvas) ⭐ 1,585 - Vector graphics to PDF, SVG or rasterized image.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,611 - 2D rendering in pure Go.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,104 - Go package for computer vision using OpenCV 3.3+.
...
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,785 - Screenshoting webpages using go and headless chrome on command line.
...
- [picfit](https://github.com/thoas/picfit) ⭐ 2,238 - An image resizing server written in Go.
...
- [webp-server](https://github.com/mehdipourfar/webp-server) ⭐ 76 - Simple and minimal image server capable of storing, resizing, converting and caching images.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,139 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,315 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,491.
...
- [OjG](https://github.com/ohler55/ojg) ⭐ 896 - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
- [kemba](https://github.com/clok/kemba) ⭐ 16 - A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug) ⭐ 11,289, great for CLI tools and applications.
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 575 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,318 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,318 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,318 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,318, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,105, [zap](https://github.com/uber-go/zap) ⭐ 23,235, [zerolog](https://github.com/rs/zerolog) ⭐ 11,514, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,129 - Simple rolling logger, implements io.WriteCloser.
...
- [slog](https://github.com/gookit/slog) ⭐ 478 - Lightweight, configurable, extensible logger for Go.
- [slog-formatter](https://github.com/samber/slog-formatter) ⭐ 173 - Common formatters for slog and helpers to build your own.
- [slog-multi](https://github.com/samber/slog-multi) ⭐ 489 - Chain of slog.Handler (pipeline, fanout...).
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,022 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,235 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,514 - Zero-allocation JSON logger.
...
- [goml](https://github.com/cdipaolo/goml) ⭐ 1,593 - On-line Machine Learning in Go.
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 804 - An accelerated Machine Learning framework for Go.
...
- [ocrserver](https://github.com/otiai10/ocrserver) ⭐ 738 - A simple OCR API server, seriously easy to be deployed by Docker and Heroku.
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 793 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,425 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,044 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,880 - The lightweight event bus with async compatibility.
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,972 - Go client for the NATS
  messaging system.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,565 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [excelize](https://github.com/xuri/excelize) ⭐ 19,280 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,975 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
- [fx](https://github.com/uber-go/fx) ⭐ 6,584 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,864 - Automated Initialization in Go.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,643 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,809 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,809 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,269 - Nunu is a scaffolding tool for building Go applications.
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,548 - Rapid, easy full-stack web development starter kit built in Go.
...
- [xstrings](https://github.com/huandu/xstrings) ⭐ 1,409 - Collection of useful string functions ported from other languages.
...
- [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,248 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,565 - Automated service health dashboard.
...
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,269 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
- [sitemap-format](https://github.com/mingard/sitemap-format) ⭐ 6 - A simple sitemap generator, with a little syntactic sugar.
- [stateless](https://github.com/qmuntal/stateless) ⭐ 1,065 - A fluent library for creating state machines.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,742.
...
- [gse](https://github.com/go-ego/gse) ⭐ 2,670 - Go efficient text segmentation; support english, chinese, japanese and other.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,266 - Package and an accompanying tool to work with localized text.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,852 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,658 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- [fortio](https://github.com/fortio/fortio) ⭐ 3,543 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,816 - BGP implemented in the Go Programming Language.
...
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,387 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,269 - KCP - Fast and Reliable ARQ Protocol.
...
- [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,329 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 994 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [sftp](https://github.com/pkg/sftp) ⭐ 1,583 - Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>.
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,919 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,928 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,947 - A pure Go implementation of the WebRTC API.
...
- [gentleman](https://github.com/h2non/gentleman) ⭐ 1,109 - Full-featured plugin-driven HTTP client library.
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,980 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [bun](https://github.com/uptrace/bun) ⭐ 4,214 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,280 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,383 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [upper.io/db](https://github.com/upper/db) ⭐ 3,599 - Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.
...
- [glide](https://github.com/Masterminds/glide) ⭐ 8,132 - Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,224 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,488 - A distributed tracing system.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,382 - go generate based graphql server library.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,053 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- [stats](https://github.com/montanaflynn/stats) ⭐ 2,985 - Statistics package with common functions missing from the Golang standard library.
...
- [acra](https://github.com/cossacklabs/acra) ⭐ 1,401 - Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system.
- [age](https://github.com/FiloSottile/age) ⭐ 19,093 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,179 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 565 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,405 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,707 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,665 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [mapstructure](https://github.com/mitchellh/mapstructure) ⭐ 7,989 - Go library for decoding generic map values into native Go structures.
...
- [algernon](https://github.com/xyproto/algernon) ⭐ 2,914 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,033 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- [Clace](https://github.com/claceio/clace) ⭐ 630 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,662 - Highly-available key value store for shared configuration and service discovery.
...
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,433 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,676 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 53,262 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,889 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,594 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,145 - Make SSH apps, just like that!
...
- [jet](https://github.com/CloudyKit/jet) ⭐ 1,333 - Jet template engine.
- [liquid](https://github.com/osteele/liquid) ⭐ 304 - Go implementation of Shopify Liquid templates.
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,460 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,393 - A HTML templating language that has great developer tooling.
...
- [go-cmp](https://github.com/google/go-cmp) ⭐ 4,430 - Package for comparing Go values in tests.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,255 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,134 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,773 - Sacred extension to the standard go testing package.
...
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,383 - Mock SQL driver for testing database interactions.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,858 - Mocking framework for the Go programming language.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,644 - Tool to generate Go interfaces.
...
- [moq](https://github.com/matryer/moq) ⭐ 2,095 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 485 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,999.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,941 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [rod](https://github.com/go-rod/rod) ⭐ 6,006 - A Devtools driver to make web automation and scraping easy.
...
- [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,553 - Markdown processor in Go.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,131 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,891 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [godump](https://github.com/yassinebenaid/godump) ⭐ 212 - Pretty print any GO variable with ease, an alternative to Go's `fmt.Printf("%#v")`.
- [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,126 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,799 - Shell parser and formatter.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,420 - HTML Sanitizer.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,539 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,104 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,431 - Go bindings for the Discord Chat API.
...
- [github](https://github.com/google/go-github) ⭐ 10,837 - Go library for accessing the GitHub REST API v3.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,085 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google](https://github.com/google/google-api-go-client) ⭐ 4,266 - Auto-generated Google APIs for Go.
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 2,712 - Minio Go Library for Amazon S3 compatible cloud storage.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,797 - Slack API in Go.
...
- [stripe](https://github.com/stripe/stripe-go) ⭐ 2,333 - Go client for the Stripe API.
...
- [circuitbreaker](https://github.com/rubyist/circuitbreaker) ⭐ 1,147 - Circuit Breakers in Go.
- [clipboard](https://github.com/golang-design/clipboard) ⭐ 689 - 📋 cross-platform clipboard package in Go.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,200 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [debounce](https://github.com/floatdrop/debounce) ⭐ 24 - A zero-allocation debouncer written in Go.
- [delve](https://github.com/derekparker/delve) ⭐ 652 - Go debugger.
- [dive](https://github.com/wagoodman/dive) ⭐ 51,153 - A tool for exploring each layer in a Docker image.
...
- [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,247 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 71,156 - Command-line fuzzy finder written in Go.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,068 - A comprehensive, efficient, and reusable util function library of go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,623 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mergo](https://github.com/imdario/mergo) ⭐ 3,008 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,817 - Package for MIME type detection based on magic numbers.
- [minify](https://github.com/tdewolff/minify) ⭐ 3,899 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,706 - Simple library for retry mechanism.
...
- [scany](https://github.com/georgysavva/scany) ⭐ 1,437 - Library for scanning data from a database into Go structs and more.
- [serve](https://github.com/syntaqx/serve) ⭐ 343 - A static http server anywhere you need.
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,090 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,739 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/google/uuid) ⭐ 5,698 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,141 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,163 - Validators and sanitizers for strings, numerics, slices and structs.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,521 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 883 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,686 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,652 - highly extensible Git implementation in pure Go.
...
- [v4l](https://github.com/korandiz/v4l) ⭐ 84 - Video capture library for Linux, written in Go.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,169 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 455 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,927 - An Express.js inspired web framework build on Fasthttp.
...
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,819 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 - Gin parameter automatic binding tool,gin rpc tools.
- [Goa](https://github.com/goadesign/goa) ⭐ 5,880 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,793 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,464 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,872 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,329 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [templui](https://github.com/axzilla/templui) ⭐ 728 - Modern UI Components for Go & Templ.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,982 - Small, fast and expressive HTTP router built on net/context.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,421 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,366 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,993 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,275 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 554 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 5,011 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,388 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
- [Spiffe-Vault](https://github.com/philips-labs/spiffe-vault) ⭐ 88 - Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication.
...
- [go-critic](https://github.com/go-critic/go-critic) ⭐ 1,968 - source code linter that brings checks that are currently not implemented in other linters.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,185 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,211 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,473 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 139 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,773.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 574 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,737 features to Vim/Neovim.
...
- [vim-go](https://github.com/fatih/vim-go) ⭐ 16,143 - Go development plugin for Vim.
...
- [gotests](https://github.com/cweill/gotests) ⭐ 5,075 - Generate Go tests from your source code.
...
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,780 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,666 - aptly is a Debian repository management tool.
...
- [Balerter](https://github.com/balerter/balerter) ⭐ 304 - A self-hosted script-based alerting manager.
...
- [bosun](https://github.com/bosun-monitor/bosun) ⭐ 3,413 - Time Series Alerting Framework.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,149 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,119 - Lightweight, programmable telemetry for servers and workstations.
...
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,160 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 11,013 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,987 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,860 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,994 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,090 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,227 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,042 - Command line tool for building and deploying Go applications on Kubernetes
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,879 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,388 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,728 - Cloud native application delivery.
...
- [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,133 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,577 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,947 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Packer](https://github.com/mitchellh/packer) ⭐ 15,390 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
- [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 434 - Flexible HTTP command line stress tester.
- [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,173 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
- [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,624 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,307 - Pomerium is an identity-aware access proxy.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,355 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,738 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [skm](https://github.com/TimothyYe/skm) ⭐ 976 - SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily!
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,023 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,242 - Reverse proxy and load balancer with support for multiple backends.
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,401 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,407 - Easily and securely send files or folders from one computer to another.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,460 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,952 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
- [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 874 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
- [Gor](https://github.com/buger/gor) ⭐ 18,970 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [restic](https://github.com/restic/restic) ⭐ 29,052 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 699 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,416 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,874 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,323 - Proxy to simulate network and system conditions for automated tests.
...
- [yai](https://github.com/ekkinox/yai) ⭐ 801 - AI powered terminal assistant.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,104 - A curated list of Go books.
...
- [gophers](https://github.com/egonelbre/gophers) ⭐ 3,659 - Free gophers.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,014
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,158
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,409 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,652 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,501 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,644 - Golang ebook intro how to build a web app with golang.
...
- [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,649 - Go's reference card.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,895 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,586 - Curated list of Go design patterns, recipes and idioms.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,344 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,905 - Learn Go with test-driven development.
