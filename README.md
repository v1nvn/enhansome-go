...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 147,602 | 🐛 128 | 🌐 Go | 📅 2025-07-14
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 383,047 | 🐛 46 | 📅 2025-07-05
[![Slack Widget](https://img.shields.io/badge/join-us%20on%20slack-gray.svg?longCache=true\&logo=slack\&colorB=red)](https://gophers.slack.com/messages/awesome)
[![Netlify Status](https://api.netlify.com/api/v1/badges/83a6dcbe-0da6-433e-b586-f68109286bd5/deploy-status)](https://app.netlify.com/sites/awesome-go/deploys)
[![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/avelino/awesome-go/)
[![Last Commit](https://img.shields.io/github/last-commit/avelino/awesome-go)](https://github.com/avelino/awesome-go/commits/main) ⭐ 147,602 | 🐛 128 | 🌐 Go | 📅 2025-07-14
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 250,659 | 🐛 480 | 🌐 Python | 📅 2025-07-17.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 147,602 | 🐛 128 | 🌐 Go | 📅 2025-07-14 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 147,602 | 🐛 128 | 🌐 Go | 📅 2025-07-14; you rock!
...
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,266 | 🐛 87 | 🌐 Go | 📅 2024-08-22 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
* [Ergo](https://github.com/ergo-services/ergo) ⭐ 4,027 | 🐛 4 | 🌐 Go | 📅 2025-07-07 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
* [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,986 | 🐛 22 | 🌐 Go | 📅 2025-07-04 - Blazingly fast and light-weight Actor engine written in Golang.
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 267 | 🐛 0 | 🌐 Go | 📅 2025-07-17 - Fast and Distributed Actor framework using protocol buffers as message for Golang.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [Ollama](https://github.com/jmorganca/ollama) ⭐ 146,814 | 🐛 1,917 | 🌐 Go | 📅 2025-07-17 - Run large language models locally.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,924 | 🐛 470 | 🌐 Go | 📅 2025-07-17 - Open Source OpenAI alternative, self-host AI models.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,169 | 🐛 374 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 634 | 🐛 13 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,879 | 🐛 39 | 🌐 Go | 📅 2025-07-10 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,261 | 🐛 45 | 🌐 Go | 📅 2025-07-16 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
* [goth](https://github.com/markbates/goth) ⭐ 6,108 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,646 | 🐛 41 | 🌐 Go | 📅 2025-05-05 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
* [keto](https://github.com/ory/keto) ⭐ 5,067 | 🐛 57 | 🌐 Go | 📅 2025-07-16 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
* [authboss](https://github.com/volatiletech/authboss) ⭐ 3,997 | 🐛 41 | 🌐 Go | 📅 2025-07-16 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
* [openfga](https://github.com/openfga/openfga) ⭐ 3,888 | 🐛 129 | 🌐 Go | 📅 2025-07-17 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
* [scs](https://github.com/alexedwards/scs) ⭐ 2,369 | 🐛 31 | 🌐 Go | 📅 2025-07-08 - Session Manager for HTTP servers.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,131 | 🐛 5 | 🌐 Go | 📅 2025-07-13 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
...
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,608 | 🐛 32 | 🌐 Go | 📅 2025-07-17 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
...
* [go-jose](https://github.com/go-jose/go-jose) ⭐ 420 | 🐛 31 | 🌐 Go | 📅 2025-07-17 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,300 | 🐛 318 | 🌐 Go | 📅 2025-07-17 - Official Go implementation of the Ethereum protocol.
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,581 | 🐛 1,104 | 🌐 Go | 📅 2025-07-16 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,974 | 🐛 821 | 🌐 Go | 📅 2025-07-16 - A complete implementation of a Lightning Network node.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,657 | 🐛 277 | 🌐 Go | 📅 2025-07-17 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
* [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,355 | 🐛 143 | 🌐 Go | 📅 2025-03-14 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
* [gno](https://github.com/gnolang/gno) ⭐ 972 | 🐛 798 | 🌐 Go | 📅 2025-07-17 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,206 | 🐛 170 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,397 | 🐛 55 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
...
* [bot](https://github.com/go-telegram/bot) ⭐ 1,230 | 🐛 12 | 🌐 Go | 📅 2025-07-08 - Zero-dependencies Telegram Bot library with additional UI components
...
* [arikawa](https://github.com/diamondburned/arikawa) ⭐ 533 | 🐛 35 | 🌐 Go | 📅 2025-07-03 - A library and framework for the Discord API.
...
* [air](https://github.com/cosmtrek/air) ⭐ 21,082 | 🐛 181 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
* [Task](https://github.com/go-task/task) ⭐ 13,159 | 🐛 395 | 🌐 Go | 📅 2025-07-14 - simple "Make" alternative.
...
* [mage](https://github.com/magefile/mage) ⭐ 4,403 | 🐛 130 | 🌐 Go | 📅 2025-06-15 - Mage is a make/rake-like build tool using Go.
* [mmake](https://github.com/tj/mmake) ⭐ 1,727 | 🐛 11 | 🌐 Go | 📅 2023-07-01 - Modern Make.
* [xc](https://github.com/joerdav/xc) ⭐ 1,304 | 🐛 15 | 🌐 Go | 📅 2025-07-10 - Task runner with README.md defined tasks, executable markdown.
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 33,319 | 🐛 117 | 🌐 Go | 📅 2025-07-17 - Go framework to build terminal apps, based on The Elm Architecture.
* [fx](https://github.com/antonmedv/fx) ⭐ 19,689 | 🐛 4 | 🌐 Go | 📅 2025-07-15 - Terminal JSON viewer & processor.
...
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,292 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,274 | 🐛 88 | 🌐 Go | 📅 2025-07-16 - Declaratively define styles for color, format and layout in the terminal.
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,593 | 🐛 157 | 🌐 Go | 📅 2025-07-16 - TUI components for bubbletea.
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,384 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,825 | 🐛 673 | 🌐 Python | 📅 2025-07-03.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,179 | 🐛 64 | 🌐 Go | 📅 2025-07-10 - A library to beautify console output on every platform with many combinable components.
...
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,438 | 🐛 15 | 🌐 Go | 📅 2025-02-08 - Basic thread-safe progress bar that works in every OS.
...
* [spinner](https://github.com/briandowns/spinner) ⭐ 2,445 | 🐛 17 | 🌐 Go | 📅 2025-01-20 - Go package to easily provide a terminal spinner with options.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,148 | 🐛 320 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,343 | 🐛 49 | 🌐 Go | 📅 2025-07-13 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
* [elvish](https://github.com/elves/elvish) ⭐ 6,063 | 🐛 338 | 🌐 Go | 📅 2025-07-14 - An expressive programming language and a versatile interactive shell.
...
* [Dnote](https://github.com/dnote/dnote) ⭐ 2,888 | 🐛 60 | 🌐 Go | 📅 2024-07-01 - A simple command line notebook with multi-device sync.
* [go-flags](https://github.com/jessevdk/go-flags) ⭐ 2,665 | 🐛 63 | 🌐 Go | 📅 2024-07-26 - go command line option parser.
* [pflag](https://github.com/spf13/pflag) ⭐ 2,599 | 🐛 169 | 🌐 Go | 📅 2025-07-17 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
* [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,162 | 🐛 29 | 🌐 Go | 📅 2025-07-12 - Struct-based argument parsing in Go.
* [ops](https://github.com/nanovms/ops) ⭐ 1,369 | 🐛 140 | 🌐 Go | 📅 2025-06-29 - Unikernel Builder/Orchestrator.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,356 | 🐛 74 | 🌐 Go | 📅 2025-07-17 - Multi-shell multi-command argument completer.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 753 | 🐛 40 | 🌐 Go | 📅 2025-07-17 - Command argument completion generator for spf13/cobra.
...
* [sflags](https://github.com/octago/sflags) ⭐ 162 | 🐛 5 | 🌐 Go | 📅 2025-04-02 - Struct based flags generator for flag, urfave/cli, pflag, cobra, kingpin, and other libraries.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,895 | 🐛 521 | 🌐 Go | 📅 2025-07-17 - Go configuration with fangs.
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,534 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,405 | 🐛 21 | 🌐 Go | 📅 2025-07-08 - A blazingly fast JSON serializing & deserializing library.
* [env](https://github.com/caarlos0/env) ⭐ 5,630 | 🐛 10 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,265 | 🐛 57 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [ini](https://github.com/go-ini/ini) ⭐ 3,514 | 🐛 64 | 🌐 Go | 📅 2024-05-01 - Go package to read and write INI files.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,315 | 🐛 9 | 🌐 Go | 📅 2025-07-12 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [konf](https://github.com/nil-go/konf) ⭐ 325 | 🐛 8 | 🌐 Go | 📅 2025-07-14 - The simplest API for reading/watching config from file, env, flag and clouds (e.g. AWS, Azure, GCP).
...
* [uConfig](https://github.com/omeid/uconfig) ⭐ 72 | 🐛 1 | 🌐 Go | 📅 2024-04-23 - Lightweight, zero-dependency, and extendable configuration management.
* [env](https://github.com/junk1tm/env) ⭐ 71 | 🐛 5 | 🌐 Go | 📅 2024-08-15 - A lightweight package for loading environment variables into structs.
...
* [drone](https://github.com/drone/drone) ⭐ 32,980 | 🐛 75 | 🌐 Go | 📅 2025-07-17 - Drone is a Continuous Integration platform built on Docker, written in Go.
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,244 | 🐛 351 | 🌐 Go | 📅 2025-07-17 - Woodpecker is a community fork of the Drone CI system.
* [CDS](https://github.com/ovh/cds) ⭐ 4,738 | 🐛 152 | 🌐 Go | 📅 2025-07-17 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,567 | 🐛 25 | 🌐 Go | 📅 2025-07-17 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,833 | 🐛 92 | 🌐 Rust | 📅 2025-07-10.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,411 | 🐛 526 | 🌐 Go | 📅 2025-07-18 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,143 | 🐛 136 | 🌐 Go | 📅 2025-07-17 - A high-performance ELT data integration framework with pluggable architecture.
...
* [algorithms](https://github.com/shady831213/algorithms) ⭐ 822 | 🐛 0 | 🌐 Go | 📅 2021-03-17 - Algorithms and data structures.CLRS study.
...
* [gota](https://github.com/kniren/gota) ⭐ 3,206 | 🐛 81 | 🌐 Go | 📅 2023-08-09 - Implementation of dataframes, series, and data wrangling methods for Go.
* [hyperloglog](https://github.com/axiomhq/hyperloglog) ⭐ 985 | 🐛 5 | 🌐 Go | 📅 2025-05-19 - HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,832 | 🐛 85 | 🌐 TypeScript | 📅 2025-07-17 - Distributed, Fault-tolerant task queue.
* [deque](https://github.com/gammazero/deque) ⭐ 691 | 🐛 5 | 🌐 Go | 📅 2025-07-10 - Fast ring-buffer deque (double-ended queue).
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,457 | 🐛 296 | 🌐 Go | 📅 2025-07-17 - Modern text indexing library for go.
...
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,211 | 🐛 42 | 🌐 Go | 📅 2024-11-29 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
* [BigCache](https://github.com/allegro/bigcache) ⭐ 7,882 | 🐛 99 | 🌐 Go | 📅 2025-05-05 - Efficient key/value cache for gigabytes of data.
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,269 | 🐛 6 | 🌐 Go | 📅 2025-07-16 -  A high performance memory-bound Go cache.
* [gocache](https://github.com/eko/gocache) ⭐ 2,702 | 🐛 37 | 🌐 Go | 📅 2025-07-16 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,235 | 🐛 1 | 🌐 Go | 📅 2025-07-10 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [sturdyc](https://github.com/viccon/sturdyc) ⭐ 1,226 | 🐛 5 | 🌐 Go | 📅 2025-04-04 - A caching library with advanced concurrency features designed to make I/O heavy applications robust and highly performant.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,508 | 🐛 693 | 🌐 Go | 📅 2025-07-17 - Monitoring system and time series database.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,736 | 🐛 5,184 | 🌐 Go | 📅 2025-07-18 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 36,041 | 🐛 709 | 🌐 Go | 📅 2025-07-18 - Milvus is a vector database for embedding management, analytics and search.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,089 | 🐛 7,379 | 🌐 Go | 📅 2025-07-18 - Scalable, Geo-Replicated, Transactional Datastore.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,342 | 🐛 2,125 | 🌐 Rust | 📅 2025-07-18 - Scalable datastore for metrics, events, and real-time analytics.
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,017 | 🐛 40 | 🌐 Go | 📅 2025-07-17 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,893 | 🐛 432 | 🌐 Go | 📅 2025-07-17 - Dolt – It's Git for Data.
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,765 | 🐛 80 | 🌐 Go | 📅 2025-07-15 - The lightweight, distributed, relational database built on SQLite.
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,798 | 🐛 32 | 🌐 Go | 📅 2025-07-16 - Fast key-value store in Go.
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,547 | 🐛 787 | 🌐 Go | 📅 2025-07-17 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,920 | 🐛 43 | 🌐 Go | 📅 2025-07-17 - An embedded key/value database for Go.
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,285 | 🐛 109 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,898 | 🐛 363 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,381 | 🐛 297 | 🌐 Go | 📅 2025-07-17 - RocksDB/LevelDB inspired key-value database in Go.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,991 | 🐛 2 | 🌐 Go | 📅 2025-07-14 - Redis re-implemented with SQLite.
...
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,482 | 🐛 66 | 🌐 Go | 📅 2025-06-07 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
* [column](https://github.com/kelindar/column) ⭐ 1,487 | 🐛 26 | 🌐 Go | 📅 2025-06-28 - High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions.
* [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,439 | 🐛 8 | 🌐 Go | 📅 2021-11-10 - Home-grown disk-backed key-value store.
...
* [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,234 | 🐛 17 | 🌐 Go | 📅 2025-03-12 - High-performance embedded Object Database (NoSQL) with Go API.
...
* [clover](https://github.com/ostafen/clover) ⭐ 764 | 🐛 21 | 🌐 Go | 📅 2025-02-12 - A lightweight document-oriented NoSQL database written in pure Golang.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 17,021 | 🐛 437 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,752 | 🐛 121 | 🌐 Go | 📅 2025-07-18 - Safe database schema change and version control for DevOps teams.
* [goose](https://github.com/pressly/goose) ⭐ 8,762 | 🐛 98 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
* [atlas](https://github.com/ariga/atlas) ⭐ 7,068 | 🐛 220 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,140 | 🐛 31 | 🌐 Go | 📅 2025-07-14 - A lightweight, framework-agnostic database migration tool.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,328 | 🐛 18 | 🌐 Go | 📅 2025-07-17 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
* [gormigrate](https://github.com/go-gormigrate/gormigrate) ⭐ 1,103 | 🐛 17 | 🌐 Go | 📅 2025-03-28 - Database schema migration helper for Gorm ORM.
...
* [libschema](https://github.com/muir/libschema) ⭐ 17 | 🐛 2 | 🌐 Go | 📅 2025-07-16 - Define your migrations separately in each library. Migrations for open source libraries. MySQL & PostgreSQL.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,857 | 🐛 881 | 🌐 Go | 📅 2025-07-17 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,952 | 🐛 35 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,790 | 🐛 150 | 🌐 Go | 📅 2025-07-15 - Go toolset to handle MySQL protocol and replication.
* [pREST](https://github.com/prest/prest) ⭐ 4,373 | 🐛 141 | 🌐 Go | 📅 2025-04-29 - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
* [dbbench](https://github.com/sj14/dbbench) ⭐ 109 | 🐛 12 | 🌐 Go | 📅 2025-07-17 - Database benchmarking tool with support for several databases and scripts.
...
* [dg](https://github.com/codingconcepts/dg) ⭐ 34 | 🐛 3 | 🌐 Go | 📅 2024-08-21 - A fast data generator that produces CSV files from generated relational data.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,554 | 🐛 619 | 🌐 Go | 📅 2025-07-17 - Generate type-safe code from SQL.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,278 | 🐛 42 | 🌐 Go | 📅 2025-07-03 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) ⭐ 651 | 🐛 41 | 🌐 Go | 📅 2023-05-01 - Powerful data retrieval methods as well as DB-agnostic query building capabilities.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,165 | 🐛 229 | 🌐 Go | 📅 2025-07-12 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pq](https://github.com/lib/pq) ⭐ 9,554 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,575 | 🐛 203 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
* [go-mssqldb](https://github.com/denisenkom/go-mssqldb) ⭐ 1,857 | 🐛 177 | 🌐 Go | 📅 2025-04-26 - Microsoft MSSQL driver for Go.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 740 | 🐛 5 | 🌐 Go | 📅 2025-07-18 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [godror](https://github.com/godror/godror) ⭐ 559 | 🐛 3 | 🌐 C | 📅 2025-07-17 - Oracle driver for Go, using the ODPI-C driver.
...
* [surrealdb.go](https://github.com/surrealdb/surrealdb.go) ⭐ 278 | 🐛 33 | 🌐 Go | 📅 2025-07-18 - SurrealDB Driver for Go.
* [firebirdsql](https://github.com/nakagami/firebirdsql) ⭐ 244 | 🐛 14 | 🌐 Go | 📅 2025-05-09 - Firebird RDBMS SQL driver for Go.
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 167 | 🐛 242 | 🌐 Go | 📅 2025-07-17 - native and database/sql driver YDB (Yandex Database)
...
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,165 | 🐛 229 | 🌐 Go | 📅 2025-07-12 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,447 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,096 | 🐛 106 | 🌐 Go | 📅 2025-07-16 - Redis client for Golang.
* [redigo](https://github.com/gomodule/redigo) ⭐ 9,834 | 🐛 23 | 🌐 Go | 📅 2025-05-21 - Redigo is a Go client for the Redis database.
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,394 | 🐛 12 | 🌐 Go | 📅 2025-07-18 - Official MongoDB driver for the Go language.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,724 | 🐛 12 | 🌐 Go | 📅 2025-07-16 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,443 | 🐛 353 | 🌐 Go | 📅 2025-07-18 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,166 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,607 | 🐛 119 | 🌐 Go | 📅 2025-07-16 - A modular-designed and easy-to-use microservices framework in Go.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,398 | 🐛 21 | 🌐 Go | 📅 2025-07-16 - A distributed systems development framework.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 22,025 | 🐛 143 | 🌐 Go | 📅 2025-07-17 - The Go language implementation of gRPC. HTTP/2 based RPC.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,517 | 🐛 456 | 🌐 Go | 📅 2025-07-17 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [micro](https://github.com/micro/micro) ⭐ 12,270 | 🐛 7 | 🌐 Go | 📅 2025-07-15 - A distributed systems runtime for the cloud and beyond.
* [raft](https://github.com/hashicorp/raft) ⭐ 8,693 | 🐛 44 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,542 | 🐛 57 | 🌐 Go | 📅 2025-07-15 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [lura](https://github.com/luraproject/lura) ⭐ 6,582 | 🐛 8 | 🌐 Go | 📅 2025-06-25 - Ultra performant API Gateway framework with middlewares.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,809 | 🐛 63 | 🌐 Go | 📅 2025-07-14 - BitTorrent client package.
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,202 | 🐛 52 | 🌐 Go | 📅 2025-07-17 - A feature complete and high performance multi-group Raft library in Go.
...
* [gleam](https://github.com/chrislusf/gleam) ⭐ 3,531 | 🐛 40 | 🌐 Go | 📅 2025-04-20 - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,666 | 🐛 27 | 🌐 Go | 📅 2025-07-18 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
* [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,608 | 🐛 43 | 🌐 Go | 📅 2024-04-19 - Lightweight, fault-tolerant message streams for NATS.
* [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,327 | 🐛 25 | 🌐 Go | 📅 2025-07-03 - A Go framework for the API or Microservice with handy scaffolding tools.
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,210 | 🐛 32 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
* [redis-lock](https://github.com/bsm/redislock) ⭐ 1,640 | 🐛 4 | 🌐 Go | 📅 2025-06-09 - Simplified distributed locking implementation using Redis.
* [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,574 | 🐛 25 | 🌐 Go | 📅 2025-04-16 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,058 | 🐛 86 | 🌐 Go | 📅 2025-07-18 - A cloud native Kubernetes Global Balancer.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 669 | 🐛 194 | 🌐 Go | 📅 2025-07-17 - Durable execution system for making code fault-tolerant and simple.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 623 | 🐛 56 | 🌐 Go | 📅 2025-07-16 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 381 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,371 | 🐛 358 | 🌐 C++ | 📅 2025-06-26).
...
* [outboxer](https://github.com/italolelis/outboxer) ⭐ 163 | 🐛 1 | 🌐 Go | 📅 2025-07-15 - Outboxer is a go library that implements the outbox pattern.
...
* [GoDNS](https://github.com/timothyye/godns) ⭐ 1,596 | 🐛 16 | 🌐 Go | 📅 2025-07-02 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,072 | 🐛 250 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,369 | 🐛 5 | 🌐 Go | 📅 2025-07-16 - Email and SMTP testing tool for developers.
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,603 | 🐛 130 | 🌐 Go | 📅 2025-04-16 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
* [mox](https://github.com/mjl-/mox) ⭐ 5,096 | 🐛 150 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,407 | 🐛 31 | 🌐 Go | 📅 2025-07-17 - A Go library for email verification without sending any emails.
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,044 | 🐛 5 | 🌐 Go | 📅 2025-07-16 - A simple Go library for sending mails in Go.
...
* [truemail-go](https://github.com/truemail-rb/truemail-go) ⭐ 121 | 🐛 1 | 🌐 Go | 📅 2024-08-30 - Configurable Golang email validator/verifier. Verify email via Regex, DNS, SMTP and even more.
...
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,724 | 🐛 169 | 🌐 Go | 📅 2025-07-17 - PHP embedded in Go, with a `net/http` handler.
* [expr](https://github.com/antonmedv/expr) ⭐ 7,017 | 🐛 46 | 🌐 Go | 📅 2025-07-05 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,657 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [goja](https://github.com/dop251/goja) ⭐ 6,286 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [tengo](https://github.com/d5/tengo) ⭐ 3,669 | 🐛 85 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,303 | 🐛 50 | 🌐 Go | 📅 2025-06-05 - Port of the Lua 5.2 VM to pure Go.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,611 | 🐛 51 | 🌐 Go | 📅 2025-07-17 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,597 | 🐛 5 | 🌐 Go | 📅 2025-07-17 - The Wa Programming Language embedded in Go.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,657 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
...
* [eris](https://github.com/rotisserie/eris) ⭐ 1,682 | 🐛 5 | 🌐 Go | 📅 2025-04-03 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
* [oops](https://github.com/samber/oops) ⭐ 711 | 🐛 15 | 🌐 Go | 📅 2025-07-06 - Error handling with context, stack trace and source fragments.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,807 | 🐛 128 | 🌐 Go | 📅 2025-07-14 - PDF processor.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 99 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 72,095 | 🐛 299 | 🌐 Go | 📅 2025-07-16).
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,847 | 🐛 145 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,337 | 🐛 38 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
* [go-money](https://github.com/rhymond/go-money) ⭐ 1,781 | 🐛 23 | 🌐 Go | 📅 2025-04-30 - Implementation of Fowler's Money pattern.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,384 | 🐛 135 | 🌐 Go | 📅 2025-07-17 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
* [ledger](https://github.com/formancehq/ledger) ⭐ 990 | 🐛 5 | 🌐 Go | 📅 2025-07-17 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [mo](https://github.com/samber/mo) ⭐ 3,026 | 🐛 23 | 🌐 Go | 📅 2025-07-06 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,240 | 🐛 295 | 🌐 Go | 📅 2025-07-17 - dead simple 2D game engine in Go.
* [Leaf](https://github.com/name5566/leaf) ⭐ 5,427 | 🐛 24 | 🌐 Go | 📅 2024-05-23 - Lightweight game server framework.
* [nano](https://github.com/lonng/nano) ⭐ 3,054 | 🐛 30 | 🌐 Go | 📅 2025-03-30 - Lightweight, facility, high performance golang based game server framework.
...
* [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,580 | 🐛 58 | 🌐 Go | 📅 2025-07-15 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,102 | 🐛 4 | 🌐 C | 📅 2025-06-17 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
* [Ark](https://github.com/mlange-42/ark) ⭐ 90 | 🐛 9 | 🌐 Go | 📅 2025-05-16 - Archetype-based Entity Component System (ECS) for Go.
* [prototype](https://github.com/gonutz/prototype) ⭐ 90 | 🐛 1 | 🌐 C | 📅 2025-07-09 - Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,360 | 🐛 694 | 🌐 Go | 📅 2025-07-17 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) ⭐ 3,592 | 🐛 11 | 🌐 Go | 📅 2022-08-08 - .NET LINQ-like query methods for Go.
* [jennifer](https://github.com/dave/jennifer) ⭐ 3,519 | 🐛 17 | 🌐 Go | 📅 2024-09-08 - Generate arbitrary Go code without templates.
* [goderive](https://github.com/awalterschulze/goderive) ⭐ 1,262 | 🐛 19 | 🌐 Go | 📅 2025-03-06 - Derives functions from input types
* [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,231 | 🐛 21 | 🌐 Go | 📅 2025-06-27 - Generate decorators for Go interfaces using simple templates.
* [go-enum](https://github.com/abice/go-enum) ⭐ 844 | 🐛 17 | 🌐 Go | 📅 2025-06-22 - Code generation for enums from code comments.
* [goverter](https://github.com/jmattheis/goverter) ⭐ 721 | 🐛 16 | 🌐 Go | 📅 2025-07-06 - Generate converters by defining an interface.
...
* [copygen](https://github.com/switchupcb/copygen) ⭐ 392 | 🐛 3 | 🌐 Go | 📅 2025-03-06 - Generate any code based on Go types, including type-to-type converters (copy code) without reflection by default.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,382 | 🐛 151 | 🌐 Go | 📅 2025-06-17 - Geolocation DB with spatial index and realtime geofencing.
...
* [godal](https://github.com/airbusgeo/godal) ⭐ 166 | 🐛 8 | 🌐 Go | 📅 2025-02-26 - Go wrapper for GDAL.
...
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,443 | 🐛 14 | 🌐 Go | 📅 2025-05-18 - Compile shell scripts to Go.
* [c4go](https://github.com/Konstantin8105/c4go) ⭐ 374 | 🐛 27 | 🌐 C | 📅 2024-09-19 - Transpile C code to Go code.
* [go2hx](https://github.com/go2hx/go2hx) ⭐ 136 | 🐛 32 | 🌐 Haxe | 📅 2025-07-17 - Compiler from Go to Haxe to Javascript/C++/Java/C#.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,832 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,997 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
* [tunny](https://github.com/Jeffail/tunny) ⭐ 4,003 | 🐛 8 | 🌐 Go | 📅 2023-03-09 - Goroutine pool for golang.
* [goworker](https://github.com/benmanns/goworker) ⭐ 2,832 | 🐛 34 | 🌐 Go | 📅 2025-04-15 - goworker is a Go-based background worker.
* [pond](https://github.com/alitto/pond) ⭐ 1,894 | 🐛 4 | 🌐 Go | 📅 2025-07-13 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,774 | 🐛 749 | 🌐 Go | 📅 2025-07-15 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
* [webview](https://github.com/zserge/webview) ⭐ 13,230 | 🐛 190 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,722 | 🐛 42 | 🌐 Go | 📅 2025-07-15 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
...
* [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,281 | 🐛 39 | 🌐 Go | 📅 2025-03-08 - Build native macOS applications using Go.
...
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,043 | 🐛 226 | 🌐 Go | 📅 2025-07-17 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
* [Spot](https://github.com/roblillack/spot) ⭐ 1,228 | 🐛 7 | 🌐 Go | 📅 2024-12-19 - Reactive, cross-platform desktop GUI toolkit.
...
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 426 | 🐛 19 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,918 | 🐛 1,170 | 🌐 C++ | 📅 2025-07-15 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,688 | 🐛 17 | 🌐 Lua | 📅 2025-07-14.
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,266 | 🐛 137 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,149 | 🐛 345 | 🌐 Go | 📅 2025-07-11 - Go package for computer vision using OpenCV 3.3+.
* [imaginary](https://github.com/h2non/imaginary) ⭐ 5,883 | 🐛 133 | 🌐 Go | 📅 2025-01-14 - Fast and simple HTTP microservice for image resizing.
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,532 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
* [gg](https://github.com/fogleman/gg) ⭐ 4,625 | 🐛 94 | 🌐 Go | 📅 2023-12-14 - 2D rendering in pure Go.
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,123 | 🐛 20 | 🌐 Go | 📅 2024-09-24 - Collection of image processing algorithms in pure Go.
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,846 | 🐛 34 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
* [imagor](https://github.com/cshum/imagor) ⭐ 3,686 | 🐛 37 | 🌐 Go | 📅 2025-07-17 - Fast, secure image processing server and Go library, using libvips.
...
* [picfit](https://github.com/thoas/picfit) ⭐ 2,259 | 🐛 12 | 🌐 Go | 📅 2025-06-10 - An image resizing server written in Go.
...
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,598 | 🐛 20 | 🌐 Go | 📅 2025-05-08 - Vector graphics to PDF, SVG or rasterized image.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,221 | 🐛 103 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
* [flogo](https://github.com/tibcosoftware/flogo) ⭐ 2,474 | 🐛 127 | 🌐 CSS | 📅 2024-04-24 - Project Flogo is an Open Source Framework for IoT Edge Apps & Integration.
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,615 | 🐛 64 | 🌐 Go | 📅 2025-07-15 - Lightweight data stream processing engine for IoT edge.
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,356 | 🐛 30 | 🌐 Go | 📅 2025-07-16 - Kubernetes native IoT development framework.
* [rulego](https://github.com/rulego/rulego) ⭐ 1,202 | 🐛 8 | 🌐 Go | 📅 2025-07-10 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,377 | 🐛 18 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
* [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,895 | 🐛 4 | 🌐 Go | 📅 2025-05-24 - Simple, zero-dependency scheduling library for Go.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,060 | 🐛 90 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,385 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [zap](https://github.com/uber-go/zap) ⭐ 23,368 | 🐛 165 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,616 | 🐛 140 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,170 | 🐛 99 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [log15](https://github.com/inconshreveable/log15) ⭐ 1,098 | 🐛 47 | 🌐 Go | 📅 2025-07-17 - Simple, powerful logging for Go.
* [tint](https://github.com/lmittmann/tint) ⭐ 1,046 | 🐛 0 | 🌐 Go | 📅 2025-06-07 - A slog.Handler that writes tinted logs.
* [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 975 | 🐛 53 | 🌐 Go | 📅 2025-07-08 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
* [phuslu/log](https://github.com/phuslu/log) ⭐ 781 | 🐛 6 | 🌐 Go | 📅 2025-05-17 - High performance structured logging.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 602 | 🐛 1 | 🌐 Go | 📅 2025-05-29 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,385 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,166 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,368 | 🐛 165 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,616 | 🐛 140 | 🌐 Go | 📅 2025-04-18, etc).
...
* [logrusly](https://github.com/sebest/logrusly) ⭐ 29 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,385 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
...
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,385 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
...
* [goml](https://github.com/cdipaolo/goml) ⭐ 1,596 | 🐛 4 | 🌐 Go | 📅 2022-07-15 - On-line Machine Learning in Go.
* [eaopt](https://github.com/MaxHalford/eaopt) ⭐ 902 | 🐛 9 | 🌐 Go | 📅 2025-01-27 - An evolutionary optimization library.
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 837 | 🐛 3 | 🌐 Go | 📅 2025-07-17 - An accelerated Machine Learning framework for Go.
* [bayesian](https://github.com/jbrukh/bayesian) ⭐ 810 | 🐛 8 | 🌐 Go | 📅 2023-11-17 - Naive Bayesian Classification for Golang.
* [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 807 | 🐛 44 | 🌐 Go | 📅 2024-09-02 - Go Interface to Open Neural Network Exchange (ONNX).
...
* [ocrserver](https://github.com/otiai10/ocrserver) ⭐ 741 | 🐛 4 | 🌐 Go | 📅 2021-08-05 - A simple OCR API server, seriously easy to be deployed by Docker and Heroku.
...
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 431 | 🐛 7 | 🌐 Go | 📅 2025-07-14 - Huggingface transformer pipelines for golang with onnxruntime.
...
* [catboost-cgo](https://github.com/mirecl/catboost-cgo) ⭐ 16 | 🐛 6 | 🌐 C | 📅 2025-07-14 - Fast, scalable, high performance Gradient Boosting on Decision Trees library. Golang using Cgo for blazing fast inference CatBoost Model.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,600 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,135 | 🐛 23 | 🌐 Go | 📅 2025-07-13 - Real-time messaging (Websockets or SockJS) server in Go.
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,676 | 🐛 124 | 🌐 Go | 📅 2025-07-03 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,433 | 🐛 58 | 🌐 Go | 📅 2025-07-05 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,099 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,785 | 🐛 244 | 🌐 Go | 📅 2025-06-30 - Asynchronous task queue/job queue based on distributed message passing.
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,023 | 🐛 169 | 🌐 Go | 📅 2025-07-15 - Go client for the NATS
  messaging system.
...
* [Mercure](https://github.com/dunglas/mercure) ⭐ 4,991 | 🐛 24 | 🌐 Go | 📅 2025-07-17 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,946 | 🐛 286 | 🌐 HTML | 📅 2025-07-17 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [go-nsq](https://github.com/nsqio/go-nsq) ⭐ 2,633 | 🐛 33 | 🌐 Go | 📅 2025-03-13 - the official Go package for NSQ.
...
* [Quamina](https://github.com/timbray/quamina) ⭐ 432 | 🐛 16 | 🌐 Go | 📅 2025-07-03 - Fast pattern-matching for filtering messages and events.
...
* [Ratus](https://github.com/hyperonym/ratus) ⭐ 120 | 🐛 10 | 🌐 Go | 📅 2025-07-10 - Ratus is a RESTful asynchronous task queue server.
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,624 | 🐛 26 | 🌐 Go | 📅 2025-05-21 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/xuri/excelize) ⭐ 19,380 | 🐛 125 | 🌐 Go | 📅 2025-07-17 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
* [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,986 | 🐛 10 | 🌐 Go | 📅 2025-04-18 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
* [godocx](https://github.com/gomutex/godocx) ⭐ 189 | 🐛 10 | 🌐 Go | 📅 2025-05-25 - Library for reading and writing Microsoft Word (Docx) files.
...
* [google/wire](https://github.com/google/wire) ⭐ 13,956 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
* [fx](https://github.com/uber-go/fx) ⭐ 6,671 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
* [dig](https://github.com/uber-go/dig) ⭐ 4,224 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [do](https://github.com/samber/do) ⭐ 2,199 | 🐛 46 | 🌐 Go | 📅 2025-07-05 - A dependency injection framework based on Generics.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,111 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,111 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,875 | 🐛 25 | 🌐 Go | 📅 2025-07-17 - Allows users to spin up a quick Go project using a popular framework.
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,825 | 🐛 0 | 🌐 Go | 📅 2025-07-12 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,825 | 🐛 0 | 🌐 Go | 📅 2025-07-12 for building production grade scalable web service applications.
...
* [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,570 | 🐛 2 | 🌐 Go | 📅 2025-06-24 - Rapid, easy full-stack web development starter kit built in Go.
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,299 | 🐛 0 | 🌐 Go | 📅 2025-07-08 - Nunu is a scaffolding tool for building Go applications.
...
* [golang-templates/seed](https://github.com/golang-templates/seed) ⭐ 534 | 🐛 0 | 🌐 Makefile | 📅 2025-07-07 - Go application GitHub repository template.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,311 | 🐛 215 | 🌐 Go | 📅 2025-07-14 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,720 | 🐛 227 | 🌐 Go | 📅 2025-07-17 - Automated service health dashboard.
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 5,027 | 🐛 13 | 🌐 Go | 📅 2025-06-26 - Random data generator written in go.
...
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,288 | 🐛 83 | 🌐 Go | 📅 2024-07-26 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) ⭐ 1,239 | 🐛 4 | 🌐 Go | 📅 2023-05-30 - Generic object pool for Golang.
* [llvm](https://github.com/llir/llvm) ⭐ 1,230 | 🐛 18 | 🌐 Go | 📅 2024-12-06 - Library for interacting with LLVM IR in pure Go.
...
* [archives](https://github.com/mholt/archives) ⭐ 266 | 🐛 8 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [lingua-go](https://github.com/pemistahl/lingua-go) ⭐ 1,260 | 🐛 9 | 🌐 Go | 📅 2025-02-06 - An accurate natural language detection library, suitable for long and short text alike. Supports detecting multiple languages in mixed-language text.
...
* [kagome](https://github.com/ikawaha/kagome) ⭐ 886 | 🐛 5 | 🌐 Go | 📅 2025-06-18 - JP morphological analyzer written in pure Go.
...
* [gse](https://github.com/go-ego/gse) ⭐ 2,682 | 🐛 13 | 🌐 Go | 📅 2025-06-09 - Go efficient text segmentation; support english, chinese, japanese and other.
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,544 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,262 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,295 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Package and an accompanying tool to work with localized text.
* [go-pinyin](https://github.com/mozillazg/go-pinyin) ⭐ 1,694 | 🐛 18 | 🌐 Go | 📅 2023-07-12 - CN Hanzi to Hanyu Pinyin converter.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,742 | 🐛 100 | 🌐 Go | 📅 2025-07-15 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,077 | 🐛 101 | 🌐 Go | 📅 2025-07-18 - A pure Go implementation of the WebRTC API.
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,183 | 🐛 132 | 🌐 Go | 📅 2025-07-11 - Extremely simple & fast udp tunnel based on KCP protocol.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 11,044 | 🐛 442 | 🌐 Go | 📅 2025-07-07 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,823 | 🐛 190 | 🌐 Go | 📅 2025-07-17 - An implementation of the QUIC protocol in pure Go.
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,651 | 🐛 1 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
* [dns](https://github.com/miekg/dns) ⭐ 8,424 | 🐛 9 | 🌐 Go | 📅 2025-07-09 - Go library for working with DNS.
* [gopacket](https://github.com/google/gopacket) ⭐ 6,570 | 🐛 361 | 🌐 Go | 📅 2025-03-19 - Go library for packet processing with libpcap bindings.
* [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,408 | 🐛 85 | 🌐 Go | 📅 2025-07-10 - A library to create a customized HTTP/HTTPS proxy server using Go.
* [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,359 | 🐛 26 | 🌐 Go | 📅 2025-06-17 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 4,000 | 🐛 15 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,943 | 🐛 56 | 🌐 Go | 📅 2025-01-27 - Higher-level API for building SSH servers (wraps crypto/ssh).
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,832 | 🐛 222 | 🌐 Go | 📅 2025-07-17 - BGP implemented in the Go Programming Language.
* [fortio](https://github.com/fortio/fortio) ⭐ 3,561 | 🐛 83 | 🌐 Go | 📅 2025-07-17 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,544 | 🐛 6 | 🌐 Go | 📅 2025-07-16 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
* [water](https://github.com/songgao/water) ⭐ 2,057 | 🐛 30 | 🌐 Go | 📅 2024-07-30 - Simple TUN/TAP library.
...
* [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,713 | 🐛 178 | 🌐 Go | 📅 2025-06-29 - Go library for downloading files or directories from various sources using a URL.
...
* [gws](https://github.com/lxzan/gws) ⭐ 1,569 | 🐛 1 | 🌐 Go | 📅 2025-05-13 - High-Performance WebSocket Server & Client With AsyncIO Supporting .
* [grab](https://github.com/cavaliercoder/grab) ⭐ 1,448 | 🐛 33 | 🌐 Go | 📅 2024-05-14 - Go package for managing file downloads.
...
* [gosnmp](https://github.com/soniah/gosnmp) ⭐ 1,201 | 🐛 55 | 🌐 Go | 📅 2025-07-17 - Native Go library for performing SNMP actions.
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,144 | 🐛 2 | 🌐 Go | 📅 2025-07-16 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [winrm](https://github.com/masterzen/winrm) ⭐ 444 | 🐛 48 | 🌐 Go | 📅 2024-07-02 - Go WinRM client to remotely execute commands on Windows machines.
...
* [gNxI](https://github.com/google/gnxi) ⭐ 276 | 🐛 28 | 🌐 Python | 📅 2025-05-08 - A collection of tools for Network Management that use the gNMI and gNOI protocols.
...
* [psql-wire](https://github.com/jeroenrinzema/psql-wire) ⭐ 151 | 🐛 16 | 🌐 Go | 📅 2025-07-10 - PostgreSQL server wire protocol. Build your own server and start serving connections..
...
* [bart](https://github.com/gaissmai/bart) ⭐ 78 | 🐛 1 | 🌐 Go | 📅 2025-07-17 - Package bart provides a fast routing table algorithm.
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,056 | 🐛 39 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
* [req](https://github.com/imroc/req) ⭐ 4,549 | 🐛 76 | 🌐 Go | 📅 2025-06-27 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
* [requests](https://github.com/carlmjohnson/requests) ⭐ 1,621 | 🐛 2 | 🌐 Go | 📅 2025-04-16 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
* [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,196 | 🐛 37 | 🌐 Go | 📅 2025-06-17 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 289 | 🐛 10 | 🌐 Go | 📅 2025-07-16 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [gl](https://github.com/go-gl/gl) ⭐ 1,164 | 🐛 18 | 🌐 C | 📅 2024-07-07 - Go bindings for OpenGL (generated via glow).
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,548 | 🐛 472 | 🌐 Go | 📅 2025-07-15 - The fantastic ORM library for Golang, aims to be developer friendly.
* [ent](https://github.com/facebook/ent) ⭐ 16,372 | 🐛 586 | 🌐 Go | 📅 2025-07-11 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,898 | 🐛 104 | 🌐 Go | 📅 2025-06-27 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
* [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,307 | 🐛 115 | 🌐 Go | 📅 2025-07-15 - Prisma Client Go, Typesafe database access for Go.
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,572 | 🐛 6 | 🌐 Go | 📅 2025-07-06 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,345 | 🐛 468 | 🌐 Go | 📅 2025-07-17 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [gup](https://github.com/nao1215/gup) ⭐ 424 | 🐛 6 | 🌐 Go | 📅 2025-07-09 - Update binaries installed by "go install".
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,602 | 🐛 322 | 🌐 Go | 📅 2025-07-18 - A distributed tracing system.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,088 | 🐛 335 | 🌐 C++ | 📅 2025-07-17 - No instrumentation tracing for Golang applications via eBPF.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,406 | 🐛 372 | 🌐 Go | 📅 2025-07-14 - go generate based graphql server library.
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,080 | 🐛 241 | 🌐 Go | 📅 2025-07-16 - Implementation of GraphQL for Go.
...
* [graphql](https://github.com/neelance/graphql-go) ⭐ 4,708 | 🐛 42 | 🌐 Go | 📅 2025-06-12 - GraphQL server with a focus on ease of use.
...
* [mql](https://github.com/hashicorp/mql) ⭐ 63 | 🐛 1 | 🌐 Go | 📅 2025-06-24 - Model Query Language (mql) is a query language for your database models.
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,007 | 🐛 23 | 🌐 Go | 📅 2024-08-07 - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,270 | 🐛 44 | 🌐 Go | 📅 2025-07-14 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
* [lego](https://github.com/go-acme/lego) ⭐ 8,727 | 🐛 158 | 🌐 Go | 📅 2025-07-17 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,587 | 🐛 28 | 🌐 Go | 📅 2025-07-13 - Tool and library to remotely hack RTSP streams from surveillance cameras.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,764 | 🐛 93 | 🌐 Go | 📅 2025-07-13 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [secure](https://github.com/unrolled/secure) ⭐ 2,315 | 🐛 0 | 🌐 Go | 📅 2024-10-22 - HTTP middleware for Go that facilitates some quick security wins.
...
* [acra](https://github.com/cossacklabs/acra) ⭐ 1,411 | 🐛 13 | 🌐 Go | 📅 2025-04-17 - Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system.
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,283 | 🐛 1 | 🌐 Go | 📅 2025-07-17 - A secure low code honeypot framework, leveraging AI for System Virtualization.
...
* [passwap](https://github.com/zitadel/passwap) ⭐ 66 | 🐛 1 | 🌐 Go | 📅 2025-07-11 - Provides a unified implementation between different password hashing algorithms
...
* [secureio](https://github.com/xaionaro-go/secureio) ⭐ 33 | 🐛 1 | 🌐 Go | 📅 2020-06-28 - An keyexchanging+authenticating+encrypting wrapper and multiplexer for `io.ReadWriteCloser` based on XChaCha20-poly1305, ECDH and ED25519.
...
* [Interpol](https://github.com/avahidi/interpol) ⭐ 6 | 🐛 0 | 🌐 Go | 📅 2025-07-05 - Rule-based data generator for fuzzing and penetration testing.
...
* [jsoniter](https://github.com/json-iterator/go) ⭐ 13,824 | 🐛 267 | 🌐 Go | 📅 2024-05-27 - High-performance 100% compatible drop-in replacement of "encoding/json".
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,980 | 🐛 115 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [csvutil](https://github.com/jszwec/csvutil) ⭐ 997 | 🐛 1 | 🌐 Go | 📅 2025-03-15 - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,600 | 🐛 222 | 🌐 Go | 📅 2025-07-16 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
* [minio](https://github.com/minio/minio) ⭐ 53,852 | 🐛 53 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,854 | 🐛 307 | 🌐 Go | 📅 2025-07-17 - Highly-available key value store for shared configuration and service discovery.
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 49,212 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,706 | 🐛 114 | 🌐 Go | 📅 2025-07-17 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,196 | 🐛 82 | 🌐 Go | 📅 2025-07-07 - High-performance PHP application server, load-balancer and process manager.
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,836 | 🐛 22 | 🌐 Go | 📅 2025-07-18 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,459 | 🐛 46 | 🌐 Go | 📅 2025-07-18 - A self contained feature flag solution written in Go and Vue.js
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,220 | 🐛 15 | 🌐 Go | 📅 2025-07-14 - Make SSH apps, just like that!
* [Fider](https://github.com/getfider/fider) ⭐ 3,610 | 🐛 46 | 🌐 Go | 📅 2025-07-16 - Fider is an open platform to collect and organize customer feedback.
* [devd](https://github.com/cortesi/devd) ⭐ 3,459 | 🐛 30 | 🌐 Go | 📅 2024-05-01 - Local webserver for developers.
...
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,510 | 🐛 6 | 🌐 Go | 📅 2025-07-17 - Flagr is an open-source feature flagging and A/B testing service.
...
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,689 | 🐛 22 | 🌐 Go | 📅 2025-07-17 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,062 | 🐛 4 | 🌐 Go | 📅 2025-05-11 - Go stream processing library.
* [machine](https://github.com/whitaker-io/machine) ⭐ 162 | 🐛 8 | 🌐 Go | 📅 2025-07-16 - Go library for writing and generating stream workers with built in metrics and traceability.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,500 | 🐛 72 | 🌐 Go | 📅 2025-07-12 - A HTML templating language that has great developer tooling.
* [quicktemplate](https://github.com/valyala/quicktemplate) ⭐ 3,238 | 🐛 40 | 🌐 Go | 📅 2024-07-21 - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
...
* [Razor](https://github.com/sipin/gorazor) ⭐ 872 | 🐛 2 | 🌐 Go | 📅 2025-03-28 - Razor view engine for Golang.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 24,913 | 🐛 371 | 🌐 Go | 📅 2025-07-01 - Sacred extension to the standard go testing package.
* [keploy](https://github.com/keploy/keploy) ⭐ 10,289 | 🐛 241 | 🌐 Go | 📅 2025-07-17 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,196 | 🐛 142 | 🌐 Go | 📅 2025-07-15 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [godog](https://github.com/cucumber/godog) ⭐ 2,463 | 🐛 82 | 🌐 Go | 📅 2025-07-17 - Cucumber BDD framework for Go.
* [is](https://github.com/matryer/is) ⭐ 1,906 | 🐛 7 | 🌐 Go | 📅 2024-02-08 - Professional lightweight testing mini-framework for Go.
* [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,447 | 🐛 27 | 🌐 Go | 📅 2025-07-10 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
* [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,315 | 🐛 3 | 🌐 Go | 📅 2025-07-03 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
* [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 980 | 🐛 7 | 🌐 Go | 📅 2025-06-02 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-07-17 - HTTP client testing framework.
...
* [mockery](https://github.com/vektra/mockery) ⭐ 6,698 | 🐛 40 | 🌐 Go | 📅 2025-07-15 - Tool to generate Go interfaces.
* [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,402 | 🐛 41 | 🌐 Go | 📅 2024-09-11 - Mock SQL driver for testing database interactions.
* [gomock](https://github.com/uber-go/mock) ⭐ 2,926 | 🐛 97 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [gock](https://github.com/h2non/gock) ⭐ 2,184 | 🐛 47 | 🌐 Go | 📅 2024-09-24 - Versatile HTTP mocking made easy.
...
* [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,054 | 🐛 26 | 🌐 Go | 📅 2025-07-15 - Tool for generating self-contained mock objects.
...
* [minimock](https://github.com/gojuno/minimock) ⭐ 710 | 🐛 9 | 🌐 Go | 📅 2025-06-10 - Mock generator for Go interfaces.
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 500 | 🐛 0 | 🌐 Go | 📅 2025-07-15 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,165 | 🐛 229 | 🌐 Go | 📅 2025-07-12.
* [xgo](https://github.com/xhd2015/xgo) ⭐ 413 | 🐛 60 | 🌐 Go | 📅 2025-07-01 - A general pureposed function mocking library.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,029 | 🐛 147 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
* [rod](https://github.com/go-rod/rod) ⭐ 6,086 | 🐛 187 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,804 | 🐛 54 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
...
* [cdp](https://github.com/mafredri/cdp) ⭐ 756 | 🐛 17 | 🌐 Go | 📅 2024-11-09 - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.
...
* [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,577 | 🐛 42 | 🌐 Go | 📅 2025-07-01 - Formatters for time, numbers, and memory size to human readable format.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,307 | 🐛 31 | 🌐 Go | 📅 2025-04-16 - Convert data from SQL databases or document formats like CSV or Excel into formats such as JSON, Excel, CSV, HTML, Markdown, XML, and YAML.
...
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,195 | 🐛 10 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,945 | 🐛 17 | 🌐 Go | 📅 2025-07-14 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,870 | 🐛 103 | 🌐 Go | 📅 2025-07-07 - Shell parser and formatter.
* [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,718 | 🐛 54 | 🌐 Go | 📅 2025-05-27 - Parse RSS and Atom feeds in Go.
* [go-querystring](https://github.com/google/go-querystring) ⭐ 2,061 | 🐛 20 | 🌐 Go | 📅 2025-06-23 - Go library for encoding structs into URL query parameters.
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,275 | 🐛 8 | 🌐 Go | 📅 2025-07-08 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
* [go-fasttld](https://github.com/elliotwutingfeng/go-fasttld) ⭐ 38 | 🐛 1 | 🌐 Go | 📅 2025-07-11 - High performance effective top level domains (eTLD) extraction module.
...
* [colly](https://github.com/asciimoo/colly) ⭐ 24,453 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,601 | 🐛 3 | 🌐 Go | 📅 2025-07-11 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,177 | 🐛 211 | 🌐 Go | 📅 2025-07-12 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,474 | 🐛 188 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
* [slack](https://github.com/slack-go/slack) ⭐ 4,811 | 🐛 103 | 🌐 Go | 📅 2025-07-04 - Slack API in Go.
* [google](https://github.com/google/google-api-go-client) ⭐ 4,291 | 🐛 18 | 🌐 Go | 📅 2025-07-17 - Auto-generated Google APIs for Go.
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,291 | 🐛 387 | 🌐 Go | 📅 2025-07-18 - Google Cloud APIs Go Client Library.
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,159 | 🐛 82 | 🌐 Go | 📅 2025-07-17 - The official AWS SDK for the Go programming language.
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,743 | 🐛 21 | 🌐 Go | 📅 2025-07-17 - Minio Go Library for Amazon S3 compatible cloud storage.
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,349 | 🐛 9 | 🌐 Go | 📅 2025-07-17 - Go client for the Stripe API.
...
* [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 741 | 🐛 1 | 🌐 Go | 📅 2025-07-11 - Wrapper for PayPal payment API.
...
* [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 167 | 🐛 15 | 🌐 Go | 📅 2025-07-16 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 72,095 | 🐛 299 | 🌐 Go | 📅 2025-07-16 - Command-line fuzzy finder written in Go.
* [dive](https://github.com/wagoodman/dive) ⭐ 51,430 | 🐛 169 | 🌐 Go | 📅 2025-07-14 - A tool for exploring each layer in a Docker image.
* [hub](https://github.com/github/hub) ⭐ 22,909 | 🐛 294 | 🌐 Go | 📅 2024-02-02 - wrap git commands with additional functionality to interact with github from the terminal.
* [lo](https://github.com/samber/lo) ⭐ 19,766 | 🐛 206 | 🌐 Go | 📅 2025-07-15 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,056 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,595 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,907 | 🐛 22 | 🌐 Go | 📅 2025-07-18 - Deliver Go binaries as fast and easily as possible.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,669 | 🐛 46 | 🌐 Go | 📅 2025-05-06 - Interactive cli tool for HTTP inspection.
* [usql](https://github.com/knq/usql) ⭐ 9,435 | 🐛 95 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
* [peco](https://github.com/peco/peco) ⭐ 7,771 | 🐛 52 | 🌐 Go | 📅 2025-06-21 - Simplistic interactive filtering tool.
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,125 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - A comprehensive, efficient, and reusable util function library of go.
...
* [minify](https://github.com/tdewolff/minify) ⭐ 3,911 | 🐛 31 | 🌐 Go | 📅 2025-07-15 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
* [mc](https://github.com/minio/mc) ⭐ 3,096 | 🐛 38 | 🌐 Go | 📅 2025-07-16 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
* [mergo](https://github.com/imdario/mergo) ⭐ 3,020 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
* [retry-go](https://github.com/avast/retry-go) ⭐ 2,728 | 🐛 14 | 🌐 Go | 📅 2025-03-21 - Simple library for retry mechanism.
* [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,712 | 🐛 7 | 🌐 Go | 📅 2025-06-09 - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
* [jump](https://github.com/gsamokovarov/jump) ⭐ 1,868 | 🐛 2 | 🌐 Go | 📅 2025-07-16 - Jump helps you navigate faster by learning your habits.
...
* [bed](https://github.com/itchyny/bed) ⭐ 1,317 | 🐛 1 | 🌐 Go | 📅 2024-12-01 - A Vim-like binary editor written in Go.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,148 | 🐛 54 | 🌐 Go | 📅 2025-07-10 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [upterm](https://github.com/owenthereal/upterm) ⭐ 941 | 🐛 53 | 🌐 Go | 📅 2025-07-17 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
...
* [clipboard](https://github.com/golang-design/clipboard) ⭐ 705 | 🐛 24 | 🌐 Go | 📅 2025-06-14 - 📋 cross-platform clipboard package in Go.
* [delve](https://github.com/derekparker/delve) ⭐ 654 | 🐛 2 | 🌐 Go | 📅 2025-07-17 - Go debugger.
...
* [remote-touchpad](https://github.com/Unrud/remote-touchpad) ⭐ 608 | 🐛 13 | 🌐 Go | 📅 2025-03-18 - Control mouse and keyboard from a smartphone.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 381 | 🐛 37 | 🌐 Go | 📅 2025-07-15 - Cross Platform tool to validate configuration files.
...
* [rospo](https://github.com/ferama/rospo) ⭐ 339 | 🐛 7 | 🌐 Go | 📅 2025-07-14 - Simple and reliable ssh tunnels with embedded ssh server in Golang.
...
* [uuid](https://github.com/google/uuid) ⭐ 5,732 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [xid](https://github.com/rs/xid) ⭐ 4,156 | 🐛 17 | 🌐 Go | 📅 2025-05-12 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
* [uuid](https://github.com/gofrs/uuid) ⭐ 1,701 | 🐛 8 | 🌐 Go | 📅 2025-07-07 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,677 | 🐛 325 | 🌐 Go | 📅 2025-07-14 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 916 | 🐛 6 | 🌐 Go | 📅 2025-07-13 - A [Zod](https://github.com/colinhacks/zod) ⭐ 39,079 | 🐛 547 | 🌐 TypeScript | 📅 2025-07-18 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,727 | 🐛 162 | 🌐 Go | 📅 2025-07-11 - highly extensible Git implementation in pure Go.
...
* [gmf](https://github.com/3d0c/gmf) ⭐ 913 | 🐛 49 | 🌐 Go | 📅 2022-09-06 - Go bindings for FFmpeg av\* libraries.
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 806 | 🐛 19 | 🌐 Go | 📅 2025-07-17 - Pure Go RTSP server and client library.
...
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 537 | 🐛 0 | 🌐 Go | 📅 2025-07-16 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
* [go-astiav](https://github.com/asticode/go-astiav) ⭐ 526 | 🐛 3 | 🌐 Go | 📅 2025-05-23 - Better C bindings for ffmpeg in GO.
* [libvlc-go](https://github.com/adrg/libvlc-go) ⭐ 473 | 🐛 8 | 🌐 Go | 📅 2025-06-03 - Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player).
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,176 | 🐛 858 | 🌐 Go | 📅 2025-07-17 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,149 | 🐛 101 | 🌐 Go | 📅 2025-07-18 - An Express.js inspired web framework build on Fasthttp.
* [Beego](https://github.com/beego/beego) ⭐ 32,153 | 🐛 19 | 🌐 Go | 📅 2025-07-17 - beego is an open-source, high-performance web framework for the Go programming language.
* [Echo](https://github.com/labstack/echo) ⭐ 31,269 | 🐛 107 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Revel](https://github.com/revel/revel) ⭐ 13,202 | 🐛 99 | 🌐 Go | 📅 2023-10-28 - High-productivity web framework for the Go language.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,553 | 🐛 215 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 12,473 | 🐛 84 | 🌐 Go | 📅 2025-07-16 - Gofr is an opinionated microservice development framework.
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,391 | 🐛 45 | 🌐 Go | 📅 2025-07-16 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,899 | 🐛 27 | 🌐 Go | 📅 2025-07-14 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [goravel](https://github.com/goravel/goravel) ⭐ 3,915 | 🐛 57 | 🌐 Go | 📅 2025-07-13 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
* [Goyave](https://github.com/go-goyave/goyave) ⭐ 1,718 | 🐛 15 | 🌐 Go | 📅 2025-07-03 - Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities.
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,441 | 🐛 39 | 🌐 Go | 📅 2025-07-15 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Atreugo](https://github.com/savsgio/atreugo) ⭐ 1,284 | 🐛 5 | 🌐 Go | 📅 2025-01-01 - High performance and extensible micro web framework with zero memory allocations in hot paths.
* [templui](https://github.com/axzilla/templui) ⭐ 800 | 🐛 9 | 🌐 JavaScript | 📅 2025-07-18 - Modern UI Components for Go & Templ.
...
* [iWF](https://github.com/indeedeng/iwf) ⭐ 581 | 🐛 74 | 🌐 Go | 📅 2025-07-17 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
* [patron](https://github.com/beatlabs/patron) ⭐ 125 | 🐛 26 | 🌐 Go | 📅 2025-07-07 - Patron is a microservice framework following best cloud practices with a focus on productivity.
...
* [Ronykit](https://github.com/clubpay/ronykit) ⭐ 34 | 🐛 0 | 🌐 Go | 📅 2025-07-17 - Web framework with pluggable architecture and very performant.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,474 | 🐛 34 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
* [chi](https://github.com/go-chi/chi) ⭐ 20,156 | 🐛 85 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
* [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,924 | 🐛 82 | 🌐 Go | 📅 2024-07-22 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,462 | 🐛 504 | 🌐 Go | 📅 2025-07-17 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,049 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [go-ole](https://github.com/go-ole/go-ole) ⭐ 1,252 | 🐛 6 | 🌐 Go | 📅 2025-04-21 - Win32 OLE implementation for golang.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,392 | 🐛 114 | 🌐 Go | 📅 2025-07-17 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [Cadence-client](https://github.com/uber-go/cadence-client) ⭐ 359 | 🐛 72 | 🌐 Go | 📅 2025-07-09 - A framework for authoring workflows and activities running on top of the Cadence orchestration engine made by Uber.
...
* [xmlquery](https://github.com/antchfx/xmlquery) ⭐ 471 | 🐛 18 | 🌐 Go | 📅 2025-04-16 - xmlquery is Golang XPath package for XML query.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,066 | 🐛 259 | 🌐 Go | 📅 2025-07-17 - Container Signing, Verification and Storage in an OCI registry.
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,448 | 🐛 249 | 🌐 Go | 📅 2025-07-17 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 108 | 🐛 20 | 🌐 Go | 📅 2025-07-17 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
* [Spire](https://github.com/spiffe/spire) ⭐ 1,993 | 🐛 155 | 🌐 Go | 📅 2025-07-17 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,340 | 🐛 115 | 🌐 Go | 📅 2025-07-17 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,427 | 🐛 13 | 🌐 Go | 📅 2025-06-30 - Errcheck is a program for checking for unchecked errors in Go programs.
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,030 | 🐛 41 | 🌐 Go | 📅 2025-06-11 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 802 | 🐛 73 | 🌐 Go | 📅 2025-07-17 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 144 | 🐛 36 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,913 | 🐛 371 | 🌐 Go | 📅 2025-07-01.
...
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,086 | 🐛 422 | 🌐 TypeScript | 📅 2025-07-17 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [goimports-reviser](https://github.com/incu6us/goimports-reviser) ⭐ 677 | 🐛 24 | 🌐 Go | 📅 2025-04-16 - Formatting tool for imports.
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,756 | 🐛 96 | 🌐 Go | 📅 2025-07-17 features to Vim/Neovim.
...
* [xgen](https://github.com/xuri/xgen) ⭐ 376 | 🐛 29 | 🌐 Go | 📅 2025-07-03 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,804 | 🐛 609 | 🌐 Go | 📅 2025-06-27 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,321 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
...
* [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,631 | 🐛 7 | 🌐 Go | 📅 2025-07-14 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
* [gotutor](https://github.com/ahmedakef/gotutor) ⭐ 52 | 🐛 0 | 🌐 Elm | 📅 2025-07-11 - Online Go Debugger & Visualizer.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,372 | 🐛 2,581 | 🌐 Go | 📅 2025-07-18 - Container Cluster Manager from Google.
* [Moby](https://github.com/moby/moby) ⭐ 70,099 | 🐛 3,619 | 🌐 Go | 📅 2025-07-17 - Collaborative project for the container ecosystem to assemble container-based systems.
* [traefik](https://github.com/containous/traefik) ⭐ 55,597 | 🐛 657 | 🌐 Go | 📅 2025-07-17 - Reverse proxy and load balancer with support for multiple backends.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,602 | 🐛 2,725 | 🌐 Go | 📅 2025-07-18 - Fork of Gogs, entirely community driven.
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,703 | 🐛 535 | 🌐 Go | 📅 2025-07-17 - Run Kubernetes locally.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,230 | 🐛 152 | 🌐 Go | 📅 2025-07-17 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,274 | 🐛 793 | 🌐 Go | 📅 2025-07-17 - A modern load testing tool, using Go and JavaScript.
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,386 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
* [Hey](https://github.com/rakyll/hey) ⭐ 19,073 | 🐛 183 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,407 | 🐛 303 | 🌐 Go | 📅 2025-07-14 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,324 | 🐛 212 | 🌐 Go | 📅 2025-07-11 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,433 | 🐛 143 | 🌐 Go | 📅 2025-07-09 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,089 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,184 | 🐛 27 | 🌐 Go | 📅 2025-07-17 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,486 | 🐛 16 | 🌐 Go | 📅 2025-03-13 - High-performance load testing tool, written in Golang.
* [ko](https://github.com/google/ko) ⭐ 8,069 | 🐛 54 | 🌐 Go | 📅 2025-07-18 - Command line tool for building and deploying Go applications on Kubernetes
* [script](https://github.com/bitfield/script) ⭐ 6,775 | 🐛 42 | 🌐 Go | 📅 2025-03-22 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,757 | 🐛 543 | 🌐 Go | 📅 2025-07-17 - Cloud native application delivery.
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,431 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,915 | 🐛 247 | 🌐 Go | 📅 2025-07-08 - Little helper to run CNCF's k3s in Docker.
...
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,256 | 🐛 2,582 | 🌐 Go | 📅 2025-07-18 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,228 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,348 | 🐛 132 | 🌐 Go | 📅 2025-07-18 - Pomerium is an identity-aware access proxy.
* [tau](https://github.com/taubyte/tau) ⭐ 4,058 | 🐛 31 | 🌐 Go | 📅 2025-07-12 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,448 | 🐛 143 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [bosun](https://github.com/bosun-monitor/bosun) ⚠️ Archived - Time Series Alerting Framework.
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,763 | 🐛 141 | 🌐 Go | 📅 2025-07-18 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,775 | 🐛 12 | 🌐 Go | 📅 2025-07-04 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
...
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) ⭐ 1,620 | 🐛 16 | 🌐 Go | 📅 2024-08-17 - Enable your Go applications to self update.
* [tlm](https://github.com/yusufcanb/tlm) ⭐ 1,438 | 🐛 6 | 🌐 Go | 📅 2025-03-28 - Local cli copilot, powered by CodeLLaMa
* [uTask](https://github.com/ovh/utask) ⭐ 1,292 | 🐛 54 | 🌐 Go | 📅 2025-07-17 - Automation engine that models and executes business processes declared in yaml.
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,195 | 🐛 109 | 🌐 Go | 📅 2025-07-17 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
* [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,148 | 🐛 47 | 🌐 Go | 📅 2025-07-09 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 925 | 🐛 198 | 🌐 Go | 📅 2025-07-17 - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [kool](https://github.com/kool-dev/kool) ⭐ 691 | 🐛 6 | 🌐 Go | 📅 2025-05-23 - Command line tool for managing Docker environments as an easy way.
...
* [easyssh-proxy](https://github.com/appleboy/easyssh-proxy) ⭐ 332 | 🐛 13 | 🌐 Go | 📅 2024-12-07 - Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`.
...
* [dish](https://github.com/thevxn/dish) ⭐ 246 | 🐛 3 | 🌐 Go | 📅 2025-07-17 - A lightweight, remotely configurable monitoring service.
...
* [croc](https://github.com/schollz/croc) ⭐ 30,583 | 🐛 17 | 🌐 Go | 📅 2025-07-11 - Easily and securely send files or folders from one computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,319 | 🐛 478 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,220 | 🐛 591 | 🌐 Go | 📅 2025-07-17 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,927 | 🐛 135 | 🌐 Go | 📅 2025-07-17 - Distributed POSIX file system built on top of Redis and AWS S3.
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,357 | 🐛 91 | 🌐 Go | 📅 2025-07-14 - Proxy to simulate network and system conditions for automated tests.
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,417 | 🐛 26 | 🌐 Go | 📅 2025-03-20 - Simulate bad network connections.
* [confd](https://github.com/kelseyhightower/confd) ⭐ 8,404 | 🐛 179 | 🌐 Go | 📅 2024-07-16 - Manage local application configuration files using templates and data from etcd or consul.
* [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,697 | 🐛 405 | 🌐 C++ | 📅 2025-05-19 - LiteIDE is a simple, open source, cross-platform Go IDE.
* [scc](https://github.com/boyter/scc) ⭐ 7,479 | 🐛 54 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [drive](https://github.com/odeke-em/drive) ⭐ 6,722 | 🐛 287 | 🌐 Go | 📅 2024-02-09 - Google Drive client for the commandline.
* [nes](https://github.com/fogleman/nes) ⭐ 5,579 | 🐛 12 | 🌐 Go | 📅 2024-08-17 - Nintendo Entertainment System (NES) emulator written in Go.
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,467 | 🐛 67 | 🌐 Go | 📅 2025-07-16 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Documize](https://github.com/documize/community) ⭐ 2,272 | 🐛 46 | 🌐 JavaScript | 📅 2024-12-31 - Modern wiki software that integrates data from SaaS tools.
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,146 | 🐛 21 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
* [sonic](https://github.com/go-sonic/sonic) ⭐ 2,095 | 🐛 3 | 🌐 Go | 📅 2024-05-10 - Sonic is a Go Blogging Platform. Simple and Powerful.
...
* [Plik](https://github.com/root-gg/plik) ⭐ 1,590 | 🐛 46 | 🌐 Go | 📅 2025-06-14 - Plik is a temporary file upload system (Wetransfer like) in Go.
...
* [GoNB](https://github.com/janpfeifer/gonb) ⭐ 889 | 🐛 10 | 🌐 Go | 📅 2025-06-01 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,245 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [gophers](https://github.com/egonelbre/gophers) ⭐ 3,687 | 🐛 5 | 🌐 Go | 📅 2022-07-06 - Free gophers.
* [gophers](https://github.com/ashleymcnamara/gophers) ⭐ 3,022 | 🐛 1 | 🌐 Go | 📅 2025-01-23 - Gopher artworks by Ashley McNamara.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,089 | 🐛 7,379 | 🌐 Go | 📅 2025-07-18
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,652 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,197 | 🐛 185 | 🌐 Go | 📅 2025-07-17
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,929 | 🐛 9,428 | 🌐 Go | 📅 2025-07-17 - List of projects on the Go community wiki.
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,808 | 🐛 5 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,710 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,695 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,679 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,397 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,672 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,961 | 🐛 8 | 🌐 Go | 📅 2025-07-18 - Clean Architecture template for Golang services.
...
* [golang-examples](https://github.com/SimonWaldherr/golang-examples) ⭐ 1,632 | 🐛 6 | 🌐 Go | 📅 2025-04-19 - Many examples to learn Golang.
...
* [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) ⭐ 604 | 🐛 8 | 🌐 Go | 📅 2025-07-18 - A GitHub repository offering coding challenges for Go technical interview preparation.
