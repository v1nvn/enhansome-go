...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,364](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 246,549.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,364 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,364; you rock!
...
- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 591 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
...
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,196 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 143,607 - Run large language models locally.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,737 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [go-jose](https://github.com/go-jose/go-jose) ⭐ 403 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,045 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,142 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- [oidc](https://github.com/zitadel/oidc) ⭐ 1,577 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
- [openfga](https://github.com/openfga/openfga) ⭐ 3,703 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,121 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,522 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,943 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,323 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- [arikawa](https://github.com/diamondburned/arikawa) ⭐ 523 - A library and framework for the Discord API.
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,345 - Telegram bot framework is written in Go.
- [telego](https://github.com/mymmrac/telego) ⭐ 721 - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,172 - Simple and clean Telegram bot client.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,738 - Air - Live reload for Go apps.
...
- [Task](https://github.com/go-task/task) ⭐ 12,960 - simple "Make" alternative.
...
- [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,835 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,408 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,186 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,549 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,369 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,754.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,257 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,084 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,412 - Basic thread-safe progress bar that works in every OS.
- [pterm](https://github.com/pterm/pterm) ⭐ 5,107 - A library to beautify console output on every platform with many combinable components.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,828 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,368.
...
- [uiprogress](https://github.com/gosuri/uiprogress) ⭐ 2,129 - Flexible library to render progress bars in terminal applications.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 680 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,283 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,691 - Commander for modern Go CLI interactions.
...
- [Dnote](https://github.com/dnote/dnote) ⭐ 2,875 - A simple command line notebook with multi-device sync.
- [elvish](https://github.com/elves/elvish) ⭐ 6,035 - An expressive programming language and a versatile interactive shell.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,243 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,530 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,353 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,233 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,239 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,210 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,669 - Go configuration with fangs.
- [xdg](https://github.com/adrg/xdg) ⭐ 824 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
- [CDS](https://github.com/ovh/cds) ⭐ 4,716 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [drone](https://github.com/drone/drone) ⭐ 32,853 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,147 - Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,375 - A message streaming bridge between a range of protocols.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,681 - Distributed, Fault-tolerant task queue.
...
- [groupcache](https://github.com/golang/groupcache) ⭐ 13,183 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,117 -  A high performance memory-bound Go cache.
...
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,836 - An embedded key/value database for Go.
- [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,712 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover](https://github.com/ostafen/clover) ⭐ 756 - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 30,985 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,926 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,532 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,433 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,736 - Dolt – It's Git for Data.
...
- [godis](https://github.com/hdt3213/godis) ⭐ 3,694 - A Golang implemented high-performance Redis server and cluster.
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,271 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,730 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,157 - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,345 - Milvus is a vector database for embedding management, analytics and search.
...
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,338 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,958 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,782 - Redis re-implemented with SQLite.
...
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,671 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,570 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,306 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,564 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,050 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,516 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
- [gorm-seeder](https://github.com/Kachit/gorm-seeder) ⭐ 16 - Simple database seeder for Gorm ORM.
- [gormigrate](https://github.com/go-gormigrate/gormigrate) ⭐ 1,094 - Database schema migration helper for Gorm ORM.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,811 - Database migrations. CLI and Golang library.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,667 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [goqu](https://github.com/doug-martin/goqu) ⭐ 2,531 - Idiomatic SQL builder and query library.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,220 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,300 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,448 - Go library that helps you build SQL queries.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,851 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,522 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 708 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,969 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,969 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,432 query results easily.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,368 - Official MongoDB driver for the Go language.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,963 - Redis client for Golang.
...
- [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,889 - Official Elasticsearch client for Go.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 973 - Fast trigram based code search.
...
- [carbon](https://github.com/dromara/carbon) ⭐ 5,078 - A simple, semantic and developer-friendly time package for golang.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,618 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,083 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,338 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,203 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,926 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,451 - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,603 - Lightweight, fault-tolerant message streams for NATS.
- [lura](https://github.com/luraproject/lura) ⭐ 6,564 - Ultra performant API Gateway framework with middlewares.
...
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,315 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,627 - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 849 - Go implementation of the Raft consensus protocol, by CoreOS.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,287).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,889 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [GoDNS](https://github.com/timothyye/godns) ⭐ 1,581 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- [email](https://github.com/jordan-wright/email) ⭐ 2,735 - A robust and flexible email library for Go.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,006 - A simple Go library for sending mails in Go.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,561 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
- [mailchain](https://github.com/mailchain/mailchain) ⭐ 143 - Send encrypted emails to blockchain addresses written in Go.
- [mailgun-go](https://github.com/mailgun/mailgun-go) ⭐ 724 - Go library for sending mail with the Mailgun API.
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,942 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,211 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5,009 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [cel-go](https://github.com/google/cel-go) ⭐ 2,569 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,934 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,087 - PHP embedded in Go, with a `net/http` handler.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,209 - ECMAScript 5.1(+) implementation in Go.
...
- [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,579 - The Wa Programming Language embedded in Go.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,230 - Go error library with error portability over the network.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 278 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
- [oops](https://github.com/samber/oops) ⭐ 683 - Error handling with context, stack trace and source fragments.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,243 - FileSystem Abstraction System for Go.
- [afs](https://github.com/viant/afs) ⭐ 334 - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,515 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,710 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,804.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,275 - Terminal stock watcher and stock position tracker.
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,118 - dead simple 2D game engine in Go.
...
- [go-sdl2](https://github.com/veandco/go-sdl2) ⭐ 2,299 - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).
...
- [Leaf](https://github.com/name5566/leaf) ⭐ 5,411 - Lightweight game server framework.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,074 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [go-enum](https://github.com/abice/go-enum) ⭐ 834 - Code generation for enums from code comments.
...
- [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,221 - Generate decorators for Go interfaces using simple templates.
- [interfaces](https://github.com/rjeczalik/interfaces) ⭐ 430 - Command line tool for generating interface definitions.
- [jennifer](https://github.com/dave/jennifer) ⭐ 3,505 - Generate arbitrary Go code without templates.
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,198 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [S2 geometry](https://github.com/golang/geo) ⭐ 1,752 - S2 geometry library in Go.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,737 - A high-performance and low-cost goroutine pool in Go.
...
- [rill](https://github.com/destel/rill) ⭐ 1,677 - Go toolkit for clean, composable, channel-based concurrency.
...
- [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,391 - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,684 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 413 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,136 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,656.
- [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,023 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,257 - Build native macOS applications using Go.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,572 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [qt](https://github.com/therecipe/qt) ⭐ 10,668 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- [webview](https://github.com/zserge/webview) ⭐ 13,152 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,182 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,568 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [bild](https://github.com/anthonynsimon/bild) ⭐ 4,110 - Collection of image processing algorithms in pure Go.
- [bimg](https://github.com/h2non/bimg) ⭐ 2,859 - Small package for fast and efficient image processing using libvips.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,602 - 2D rendering in pure Go.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,088 - Go package for computer vision using OpenCV 3.3+.
- [goimagehash](https://github.com/corona10/goimagehash) ⭐ 801 - Go Perceptual image hashing package.
...
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,773 - Screenshoting webpages using go and headless chrome on command line.
- [gridder](https://github.com/shomali11/gridder) ⭐ 80 - A Grid based 2D Graphics library.
- [image2ascii](https://github.com/qeesung/image2ascii) ⭐ 921 - Convert image to ASCII.
...
- [picfit](https://github.com/thoas/picfit) ⭐ 2,228 - An image resizing server written in Go.
...
- [smartcrop](https://github.com/muesli/smartcrop) ⭐ 1,834 - Finds good crops for arbitrary images and crop sizes.
...
- [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,597 - Lightweight data stream processing engine for IoT edge.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,124 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,293 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,491.
...
- [ajson](https://github.com/spyzhov/ajson) ⭐ 273 - Abstract JSON for golang with JSONPath support.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,978 - Get a JSON value with one line of code.
...
- [OjG](https://github.com/ohler55/ojg) ⭐ 893 - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
- [kemba](https://github.com/clok/kemba) ⭐ 16 - A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug) ⭐ 11,287, great for CLI tools and applications.
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 556 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,301 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,301 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,301 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,301, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,083, [zap](https://github.com/uber-go/zap) ⭐ 23,192, [zerolog](https://github.com/rs/zerolog) ⭐ 11,488, etc).
...
- [phuslu/log](https://github.com/phuslu/log) ⭐ 766 - High performance structured logging.
...
- [slog](https://github.com/gookit/slog) ⭐ 474 - Lightweight, configurable, extensible logger for Go.
- [slog-formatter](https://github.com/samber/slog-formatter) ⭐ 171 - Common formatters for slog and helpers to build your own.
- [slog-multi](https://github.com/samber/slog-multi) ⭐ 483 - Chain of slog.Handler (pipeline, fanout...).
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,012 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,192 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,488 - Zero-allocation JSON logger.
...
- [GoLearn](https://github.com/sjwhitworth/golearn) ⭐ 9,401 - General Machine Learning library for Go.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 798 - An accelerated Machine Learning framework for Go.
...
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 408 - Huggingface transformer pipelines for golang with onnxruntime.
...
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 786 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,782 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,344 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,016 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,766 - Asynchronous task queue/job queue based on distributed message passing.
...
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,959 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,956 - Go client for the NATS
  messaging system.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,542 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [excelize](https://github.com/xuri/excelize) ⭐ 19,254 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [fx](https://github.com/uber-go/fx) ⭐ 6,565 - A dependency injection based application framework for Go (built on top of dig).
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,600 - Allows users to spin up a quick Go project using a popular framework.
...
- [go-starter](https://github.com/allaboutapps/go-starter) ⭐ 551 - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,708 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,708 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,252 - Nunu is a scaffolding tool for building Go applications.
...
- [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,241 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,536 - Automated service health dashboard.
...
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,228 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [lk](https://github.com/hyperboloide/lk) ⭐ 384 - A simple licensing library for golang.
...
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,263 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
- [spaGO](https://github.com/nlpodyssey/spago) ⭐ 1,804 - Self-contained Machine Learning and Natural Language Processing library in Go.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,527 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,154 which a Chinese word splitting algorithm.
...
- [ctxi18n](https://github.com/invopop/ctxi18n/) ⭐ 71 - Context aware i18n with a short and consise API, pluralization, interpolation, and `fs.FS` support. YAML locale definitions are based on [Rails i18n](https://guides.rubyonrails.org/i18n.html).
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,255 - Package and an accompanying tool to work with localized text.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,779 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,373 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,629 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gaio](https://github.com/xtaci/gaio) ⭐ 786 - High performance async-io networking for Golang in proactor mode.
...
- [gopacket](https://github.com/google/gopacket) ⭐ 6,544 - Go library for packet processing with libpcap bindings.
- [gopcap](https://github.com/akrennmair/gopcap) ⭐ 492 - Go wrapper for libpcap.
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,380 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [gws](https://github.com/lxzan/gws) ⭐ 1,552 - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
- [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,146 - Extremely simple & fast udp tunnel based on KCP protocol.
...
- [mdns](https://github.com/hashicorp/mdns) ⭐ 1,265 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,503 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 834 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,729 - An implementation of the QUIC protocol in pure Go.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,916 - A pure Go implementation of the WebRTC API.
...
- [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 257 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- [req](https://github.com/imroc/req) ⭐ 4,513 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,162 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,302 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,189 - SQL-first Golang ORM. Successor of go-pg.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,329 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,880 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,197 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [go-instrument](https://github.com/nikolaydubina/go-instrument) ⭐ 265 - Automatically add spans to all methods and functions.
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,452 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 170 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,052 - No instrumentation tracing for Golang applications via eBPF.
- [profile](https://github.com/pkg/profile) ⭐ 2,027 - Simple profiling support package for Go.
- [statsviz](https://github.com/arl/statsviz) ⭐ 3,302 - Live visualization of your Go application runtime statistics.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,372 - go generate based graphql server library.
...
- [graphql](https://github.com/neelance/graphql-go) ⭐ 4,706 - GraphQL server with a focus on ease of use.
...
- [go-deepcopy](https://github.com/tiendc/go-deepcopy) ⭐ 95 - Fast deep copy library.
...
- [orb](https://github.com/paulmach/orb) ⭐ 994 - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,053 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,166 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 567 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,394 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,695 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
- [dongle](https://github.com/golang-module/dongle) ⭐ 981 - A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption.
...
- [secure](https://github.com/unrolled/secure) ⭐ 2,309 - HTTP middleware for Go that facilitates some quick security wins.
...
- [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,959 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,775 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,857 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- [Clace](https://github.com/claceio/clace) ⭐ 624 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,589 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,541 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,499 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,414 - A self contained feature flag solution written in Go and Vue.js
...
- [minio](https://github.com/minio/minio) ⭐ 53,101 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,772 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,162 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,561 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,132 - Make SSH apps, just like that!
...
- [go-streams](https://github.com/reugn/go-streams) ⭐ 2,045 - Go stream processing library.
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,433 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [raymond](https://github.com/aymerick/raymond) ⭐ 635 - Complete handlebars implementation in Go.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,372 - A HTML templating language that has great developer tooling.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,211 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,104 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
- [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,159 - A helper for Rails' like test fixtures to test database applications.
- [Testify](https://github.com/stretchr/testify) ⭐ 24,729 - Sacred extension to the standard go testing package.
...
- [testza](https://github.com/MarvinJWendt/testza) ⭐ 420 - Full-featured test framework with nice colorized output.
...
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,369 - Mock SQL driver for testing database interactions.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,843 - Mocking framework for the Go programming language.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,626 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 483 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,969.
- [timex](https://github.com/cabify/timex) ⭐ 72 - A test-friendly replacement for the native `time` package.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,907 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,730 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,990 - A Devtools driver to make web automation and scraping easy.
- [selenoid](https://github.com/aerokube/selenoid) ⭐ 2,642 - alternative Selenium hub server that launches browsers within containers.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,556 - Formatters for time, numbers, and memory size to human readable format.
...
- [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,550 - Markdown processor in Go.
...
- [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,819 - Go library for the TOML format with query support and handy cli tools.
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,110 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,882 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [toml](https://github.com/BurntSushi/toml) ⭐ 4,740 - TOML configuration format (encoder/decoder with reflection).
...
- [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,701 - Parse RSS and Atom feeds in Go.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,785 - Shell parser and formatter.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,409 - HTML Sanitizer.
- [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 - A sanitization-based swear filter for Go.

### Scrapers

- [colly](https://github.com/asciimoo/colly) ⭐ 24,312 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,527 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,091 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,419 - Go bindings for the Discord Chat API.
...
- [githubql](https://github.com/shurcooL/githubql) ⭐ 1,150 - Go library for accessing the GitHub GraphQL API v4.
- [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 162 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,060 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google](https://github.com/google/google-api-go-client) ⭐ 4,263 - Auto-generated Google APIs for Go.
- [google-analytics](https://github.com/chonthu/go-google-analytics) ⭐ 15 - Simple wrapper for easy google analytics reporting.
- [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,270 - Google Cloud APIs Go Client Library.
...
- [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 730 - Wrapper for PayPal payment API.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,788 - Slack API in Go.
...
- [stripe](https://github.com/stripe/stripe-go) ⭐ 2,327 - Go client for the Stripe API.
...
- [clipboard](https://github.com/golang-design/clipboard) ⭐ 683 - 📋 cross-platform clipboard package in Go.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,180 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 51,065 - A tool for exploring each layer in a Docker image.
...
- [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,791 - Fault tolerance and resilience patterns for Go.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,919 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,740 - Deliver Go binaries as fast and easily as possible.
...
- [json-log-viewer](https://github.com/hedhyw/json-log-viewer) ⭐ 155 - Interactive viewer for JSON logs.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,050 - A comprehensive, efficient, and reusable util function library of go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,562 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [peco](https://github.com/peco/peco) ⭐ 7,752 - Simplistic interactive filtering tool.
...
- [remote-touchpad](https://github.com/Unrud/remote-touchpad) ⭐ 603 - Control mouse and keyboard from a smartphone.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,699 - Simple library for retry mechanism.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,070 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,992 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,394 - usql is a universal command-line interface for SQL databases.
...
- [uuid](https://github.com/google/uuid) ⭐ 5,689 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,136 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [govalid](https://github.com/twharmon/govalid) ⭐ 90 - Fast, tag-based validation for structs.
...
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,931 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,463 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 868 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,553 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [gortsplib](https://github.com/aler9/gortsplib) ⭐ 784 - Pure Go RTSP server and client library.
- [libvlc-go](https://github.com/adrg/libvlc-go) ⭐ 469 - Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player).
- [m3u8](https://github.com/grafov/m3u8) ⭐ 1,261 - Parser and generator library of M3U8 playlists for Apple HLS.
...
- [Beego](https://github.com/beego/beego) ⭐ 32,115 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,128 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 453 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,845 - An Express.js inspired web framework build on Fasthttp.
...
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,717 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,714 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,442 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,855 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,147 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 703 - Modern UI Components for Go & Templ.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,929 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,891 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,407 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,318 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 228 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,252 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,994 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,358 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) ⭐ 938 - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,146 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,729.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 574 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,710 features to Vim/Neovim.
...
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,063 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [xgen](https://github.com/xuri/xgen) ⭐ 369 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,287 - Visualize call graph of your Go program using dot format.
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,596 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,132 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,077 - Lightweight, programmable telemetry for servers and workstations.
...
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,053 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,988 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,961 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,847 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,921 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,022 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,207 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,731 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,382 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,713 - Cloud native application delivery.
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,166 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,535 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,887 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,168 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,315 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,726 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,013 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [tlm](https://github.com/yusufcanb/tlm) ⭐ 1,429 - Local cli copilot, powered by CodeLLaMa
- [traefik](https://github.com/containous/traefik) ⭐ 55,129 - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,289 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,379 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Chapar](https://github.com/chapar-rest/chapar) ⭐ 576 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
- [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,395 - Simulate bad network connections.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,359 - Easily and securely send files or folders from one computer to another.
- [Documize](https://github.com/documize/community) ⭐ 2,245 - Modern wiki software that integrates data from SaaS tools.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,454 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,937 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
- [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 867 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
- [Gor](https://github.com/buger/gor) ⭐ 18,957 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,704 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [myLG](https://github.com/mehrdadrad/mylg) ⭐ 2,714 - Command Line Network Diagnostic tool written in Go.
...
- [restic](https://github.com/restic/restic) ⭐ 28,969 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 697 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,395 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,794 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,300 - Proxy to simulate network and system conditions for automated tests.
...
- [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 419 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
- [Build Web Application with Golang](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/)
- [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
- [Go 101](https://go101.org) - A book focusing on Go syntax/semantics and all kinds of details.
- [Go AST Book (Chinese)](https://github.com/chai2010/go-ast-book) ⭐ 5,447 - A book focusing on Go `go/*` packages.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,066 - A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,752 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 30,985
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,150
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,567
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,310 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,631 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,346 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,620 - Golang ebook intro how to build a web app with golang.
...
- [Design Patterns in Go](https://github.com/shubhamzanwar/design-patterns) ⭐ 127 - Collection of programming design patterns implemented in Go.
...
- [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,645 - Go's reference card.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,861 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,548 - Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,729 - Examples of Golang compared to Node.js for learning.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,335 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,875 - Learn Go with test-driven development.
