...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,050](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 245,897.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,050 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,050; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,977 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,940 - Blazingly fast and light-weight Actor engine written in Golang.
...
- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 584 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,782 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,097 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 143,049 - Run large language models locally.
...
- [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,720 - A low-level library to play sound on multiple platforms.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,705 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,039 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,123 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,109 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,616 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,676 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [cometbft](https://github.com/cometbft/cometbft) ⭐ 752 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
- [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,605 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,090 - Official Go implementation of the Ethereum protocol.
- [gosemble](https://github.com/LimeChain/gosemble) ⭐ 14 - A Go-based framework for building Polkadot/Substrate-compatible runtimes.
- [gossamer](https://github.com/ChainSafe/gossamer) ⭐ 452 - A Go implementation of the Polkadot Host.
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,515 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,934 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,315 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,179 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,166 - Simple and clean Telegram bot client.
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,972 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,676 - Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4,343 - Mage is a make/rake-like build tool using Go.
...
- [Task](https://github.com/go-task/task) ⭐ 12,924 - simple "Make" alternative.
- [taskctl](https://github.com/taskctl/taskctl) ⭐ 311 - Concurrent task runner.
- [xc](https://github.com/joerdav/xc) ⭐ 1,291 - Task runner with README.md defined tasks, executable markdown.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,384 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 31,986 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,529 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,367 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,736.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,251 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,035 - Declaratively define styles for color, format and layout in the terminal.
- [marker](https://github.com/cyucelen/marker) ⭐ 50 - Easiest way to match and mark strings for colorful terminal outputs.
- [mpb](https://github.com/vbauerster/mpb) ⭐ 2,404 - Multi progress bar for terminal applications.
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,402 - Basic thread-safe progress bar that works in every OS.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,825 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,362.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,839 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,362 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,607.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 671 - Command argument completion generator for spf13/cobra.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,644 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,025 - An expressive programming language and a versatile interactive shell.
...
- [liner](https://github.com/peterh/liner) ⭐ 1,064 - Go readline-like library for command-line interfaces.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,229 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,518 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,325 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,229 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,229 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,187 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,635 - Go configuration with fangs.
...
- [zerocfg](https://github.com/chaindead/zerocfg) ⭐ 186 - Zero-effort, concise configuration management that avoids boilerplate and repetitive code, supports multiple sources with priority overrides.
...
- [CDS](https://github.com/ovh/cds) ⭐ 4,714 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [drone](https://github.com/drone/drone) ⭐ 32,819 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 558 - go test output for humans.
- [goveralls](https://github.com/mattn/goveralls) ⭐ 791 - Go integration for Coveralls.io continuous code coverage tracking system.
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,564 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,731.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,124 - Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,368 - A message streaming bridge between a range of protocols.
...
- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,597 - Go package implementing Bloom filters.
...
- [gods](https://github.com/emirpasic/gods) ⭐ 16,940 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
- [gostl](https://github.com/liyue201/gostl) ⭐ 1,095 - Data structure and algorithm library for go, designed to provide functions similar to C++ STL.
...
- [fsm](https://github.com/cocoonspace/fsm) ⭐ 77 - Finite-State Machine package.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,642 - Distributed, Fault-tolerant task queue.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,522 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,843 - Efficient key/value cache for gigabytes of data.
...
- [groupcache](https://github.com/golang/groupcache) ⭐ 13,180 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [otter](https://github.com/maypok86/otter) ⭐ 1,895 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
- [badger](https://github.com/dgraph-io/badger) ⭐ 14,632 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,820 - An embedded key/value database for Go.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,910 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,518 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,431 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,712 - Dolt – It's Git for Data.
...
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,268 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,712 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,133 - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,173 - Milvus is a vector database for embedding management, analytics and search.
...
- [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,226 - High-performance embedded Object Database (NoSQL) with Go API.
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,329 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,867 - Monitoring system and time series database.
...
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,662 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,548 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,255 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,908 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,536 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,034 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,479 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,767 - Database migrations. CLI and Golang library.
...
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,905 - Web-based PostgreSQL database browser.
...
- [rdb](https://github.com/HDT3213/rdb) ⭐ 540 - Redis RDB file parser for secondary development and memory analysis.
- [rwdb](https://github.com/andizzle/rwdb) ⭐ 20 - rwdb provides read replica capability for multiple database servers setup.
- [vitess](https://github.com/youtube/vitess) ⭐ 19,631 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,208 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,260 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,435 - Go library that helps you build SQL queries.
...
- [cayley](https://github.com/google/cayley) ⭐ 14,931 - Graph database with support for multiple backends.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,838 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,511 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 701 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,937 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,937 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,426 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,501 - Pure Go Postgres driver for database/sql.
...
- [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 159 - native and database/sql driver YDB (Yandex Database)
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,357 - Official MongoDB driver for the Go language.
...
- [carbon](https://github.com/dromara/carbon) ⭐ 5,056 - A simple, semantic and developer-friendly time package for golang.
...
- [arpc](https://github.com/lesismal/arpc) ⭐ 1,039 - More effective network communication, support two-way-calling, notify, broadcast.
...
- [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,185 - A feature complete and high performance multi-group Raft library in Go.
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,612 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [gleam](https://github.com/chrislusf/gleam) ⭐ 3,522 - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,074 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,329 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,149 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
...
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,037 - A cloud native Kubernetes Global Balancer.
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,464 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,421 - A modular-designed and easy-to-use microservices framework in Go.
...
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,531 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,285 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,620 - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 846 - Go implementation of the Raft consensus protocol, by CoreOS.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,266).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,878 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [Temporal](https://github.com/temporalio/sdk-go) ⭐ 644 - Durable execution system for making code fault-tolerant and simple.
...
- [email](https://github.com/jordan-wright/email) ⭐ 2,734 - A robust and flexible email library for Go.
...
- [go-imap](https://github.com/emersion/go-imap) ⭐ 2,197 - IMAP library for clients and servers.
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 995 - A simple Go library for sending mails in Go.
...
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,180 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 4,992 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,606.
...
- [expr](https://github.com/antonmedv/expr) ⭐ 6,907 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,015 - PHP embedded in Go, with a `net/http` handler.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,195 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,606 - Lua 5.1 VM and compiler written in Go.
...
- [emperror](https://github.com/emperror/emperror) ⭐ 354 - Error handling tools and best practices for Go libraries and applications.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,226 - Go error library with error portability over the network.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 273 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
- [oops](https://github.com/samber/oops) ⭐ 675 - Error handling with context, stack trace and source fragments.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,233 - FileSystem Abstraction System for Go.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,684 - PDF processor.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,773 - Arbitrary-precision fixed-point decimal numbers.
...
- [go-finance](https://github.com/alpeb/go-finance) ⭐ 183 - Library of financial functions for time value of money (annuities), cash flow, interest rate conversions, bonds and depreciation calculations.
...
- [orderbook](https://github.com/i25959341/orderbook) ⭐ 490 - Matching Engine for Limit Order Book in Golang.
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,095 - dead simple 2D game engine in Go.
...
- [g3n](https://github.com/g3n/engine) ⭐ 2,947 - Go 3D Game Engine.
...
- [goworld](https://github.com/xiaonanln/goworld) ⭐ 2,647 - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- [nano](https://github.com/lonng/nano) ⭐ 3,021 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,626 - Pure Go game engine.
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,550 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [go-enum](https://github.com/abice/go-enum) ⭐ 831 - Code generation for enums from code comments.
...
- [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,219 - Generate decorators for Go interfaces using simple templates.
- [interfaces](https://github.com/rjeczalik/interfaces) ⭐ 432 - Command line tool for generating interface definitions.
- [jennifer](https://github.com/dave/jennifer) ⭐ 3,502 - Generate arbitrary Go code without templates.
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,179 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [H3](https://github.com/uber/h3-go) ⭐ 346 - Go bindings for H3, a hierarchical hexagonal geospatial indexing system.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,382 - Compile shell scripts to Go.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,676 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 410 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,005 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,655.
...
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,250 - Build native macOS applications using Go.
- [energy](https://github.com/energye/energy) ⭐ 478 - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,533 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [walk](https://github.com/lxn/walk) ⭐ 6,978 - Windows application library kit for Go.
- [webview](https://github.com/zserge/webview) ⭐ 13,140 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [ghw](https://github.com/jaypipes/ghw) ⭐ 1,753 - Golang hardware discovery/inspection library.
...
- [canvas](https://github.com/tdewolff/canvas) ⭐ 1,583 - Vector graphics to PDF, SVG or rasterized image.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,599 - 2D rendering in pure Go.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,073 - Go package for computer vision using OpenCV 3.3+.
...
- [govips](https://github.com/davidbyttow/govips) ⭐ 1,442 - A lightning fast image processing and resizing library for Go.
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,763 - Screenshoting webpages using go and headless chrome on command line.
...
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,484 - Simple Go image processing package.
- [imagor](https://github.com/cshum/imagor) ⭐ 3,646 - Fast, secure image processing server and Go library, using libvips.
...
- [smartcrop](https://github.com/muesli/smartcrop) ⭐ 1,833 - Finds good crops for arbitrary images and crop sizes.
...
- [transformimgs](https://github.com/Pixboost/transformimgs) ⭐ 263 - Transformimgs resizes and optimises images for Web using next-generation formats.
...
- [clockwerk](https://github.com/onatm/clockwerk) ⭐ 180 - Go package to schedule periodic jobs using a simple, fluent syntax.
...
- [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,879 - Simple, zero-dependency scheduling library for Go.
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,269 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,489.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,965 - Get a JSON value with one line of code.
...
- [glog](https://github.com/golang/glog) ⭐ 3,600 - Leveled execution logs for Go.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,285 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,285 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,285 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,285, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,074, [zap](https://github.com/uber-go/zap) ⭐ 23,162, [zerolog](https://github.com/rs/zerolog) ⭐ 11,469, etc).
...
- [phuslu/log](https://github.com/phuslu/log) ⭐ 763 - High performance structured logging.
- [pp](https://github.com/k0kubun/pp) ⭐ 1,950 - Colored pretty printer for Go language.
...
- [spew](https://github.com/davecgh/go-spew) ⭐ 6,243 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,004 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,162 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,469 - Zero-allocation JSON logger.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,883 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 405 - Huggingface transformer pipelines for golang with onnxruntime.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,311 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,894 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,950 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,020 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,518 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,587 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize](https://github.com/xuri/excelize) ⭐ 19,224 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [dig](https://github.com/uber-go/dig) ⭐ 4,196 - A reflection based dependency injection toolkit for Go.
...
- [fx](https://github.com/uber-go/fx) ⭐ 6,553 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,815 - Automated Initialization in Go.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,565 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,631 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,631 for more information. Nonetheless, some may find the layout useful.
- [golang-templates/seed](https://github.com/golang-templates/seed) ⭐ 522 - Go application GitHub repository template.
...
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,536 - Rapid, easy full-stack web development starter kit built in Go.
...
- [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,117 - cross-platform, cli app to perform various operations on string.
...
- [archives](https://github.com/mholt/archives) ⭐ 240 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,506 - Automated service health dashboard.
...
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,210 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,258 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,728.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,526 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,143 which a Chinese word splitting algorithm.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,247 - Package and an accompanying tool to work with localized text.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,738 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,359 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,613 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gev](https://github.com/Allenxuxu/gev) ⭐ 1,750 - gev is a lightweight, fast non-blocking TCP network library based on Reactor mode.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,567 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,805 - BGP implemented in the Go Programming Language.
...
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,372 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [gws](https://github.com/lxzan/gws) ⭐ 1,548 - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,500 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 751 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,712 - An implementation of the QUIC protocol in pure Go.
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,884 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [water](https://github.com/songgao/water) ⭐ 2,041 - Simple TUN/TAP library.
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,880 - A pure Go implementation of the WebRTC API.
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,926 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,154 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,289 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,182 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,230 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,301 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [upper.io/db](https://github.com/upper/db) ⭐ 3,595 - Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,134 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [go-instrument](https://github.com/nikolaydubina/go-instrument) ⭐ 263 - Automatically add spans to all methods and functions.
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,423 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 169 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,046 - No instrumentation tracing for Golang applications via eBPF.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,470 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,033 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,861 - gonum/plot provides an API for building and drawing plots in Go.
...
- [stats](https://github.com/montanaflynn/stats) ⭐ 2,983 - Statistics package with common functions missing from the Golang standard library.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,026 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,158 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 566 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,382 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [go-yara](https://github.com/hillu/go-yara) ⭐ 369 - Go Bindings for [YARA](https://github.com/plusvic/yara) ⭐ 138, the "pattern matching swiss knife for malware researchers (and everyone else)".
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,625 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,766 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
- [algernon](https://github.com/xyproto/algernon) ⭐ 2,910 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,742 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- [Clace](https://github.com/claceio/clace) ⭐ 617 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,552 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,530 - Fider is an open platform to collect and organize customer feedback.
...
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,656 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 52,978 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,686 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,151 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,525 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,112 - Make SSH apps, just like that!
...
- [jet](https://github.com/CloudyKit/jet) ⭐ 1,327 - Jet template engine.
- [liquid](https://github.com/osteele/liquid) ⭐ 303 - Go implementation of Shopify Liquid templates.
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,428 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,354 - A HTML templating language that has great developer tooling.
...
- [godog](https://github.com/cucumber/godog) ⭐ 2,438 - Cucumber BDD framework for Go.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,132 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,091 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,700 - Sacred extension to the standard go testing package.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,830 - Mocking framework for the Go programming language.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 481 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,937.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,884 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,711 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,971 - A Devtools driver to make web automation and scraping easy.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,549 - Formatters for time, numbers, and memory size to human readable format.
...
- [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,815 - Go library for the TOML format with query support and handy cli tools.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,877 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,772 - Shell parser and formatter.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 24,267 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,519 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,081 - The official AWS SDK for the Go programming language.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,038 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,267 - Google Cloud APIs Go Client Library.
...
- [stripe](https://github.com/stripe/stripe-go) ⭐ 2,320 - Go client for the Stripe API.
...
- [clipboard](https://github.com/golang-design/clipboard) ⭐ 682 - 📋 cross-platform clipboard package in Go.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,169 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 51,000 - A tool for exploring each layer in a Docker image.
...
- [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,241 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,772 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,713 - Deliver Go binaries as fast and easily as possible.
...
- [lo](https://github.com/samber/lo) ⭐ 19,534 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mc](https://github.com/minio/mc) ⭐ 3,057 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
- [mergo](https://github.com/imdario/mergo) ⭐ 3,001 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [peco](https://github.com/peco/peco) ⭐ 7,750 - Simplistic interactive filtering tool.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,971 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,387 - usql is a universal command-line interface for SQL databases.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,727 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/gofrs/uuid) ⭐ 1,686 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
- [uuid](https://github.com/google/uuid) ⭐ 5,680 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,128 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,158 - Validators and sanitizers for strings, numerics, slices and structs.
...
- [jio](https://github.com/faceair/jio) ⭐ 118 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,107.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,443 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 865 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,424 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,089 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 448 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,785 - An Express.js inspired web framework build on Fasthttp.
...
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,631 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,265 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,423 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,290 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,127 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 691 - Modern UI Components for Go & Templ.
...
- [Yokai](https://github.com/ankorstore/yokai) ⭐ 717 - Simple, modular, and observable Go framework for backend applications.
...
- [negroni](https://github.com/urfave/negroni) ⭐ 7,526 - Idiomatic HTTP middleware for Golang.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,893 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,889 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,401 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,296 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [Cadence-client](https://github.com/uber-go/cadence-client) ⭐ 358 - A framework for authoring workflows and activities running on top of the Cadence orchestration engine made by Uber.
...
- [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 548 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
...
- [xmlquery](https://github.com/antchfx/xmlquery) ⭐ 466 - xmlquery is Golang XPath package for XML query.
- [xmlwriter](https://github.com/shabbyrobe/xmlwriter) ⭐ 28 - Procedural XML generation API based on libxml2's xmlwriter module.
- [xpath](https://github.com/antchfx/xpath) ⭐ 717 - XPath package for Go.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,975 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,347 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 106 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [Spire](https://github.com/spiffe/spire) ⭐ 1,963 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,452 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,700.
...
- [vacuum](https://github.com/daveshanley/vacuum) ⭐ 778 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
- [vim-go](https://github.com/fatih/vim-go) ⭐ 16,138 - Go development plugin for Vim.
...
- [xgen](https://github.com/xuri/xgen) ⭐ 366 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,284 - Visualize call graph of your Go program using dot format.
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,588 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,768 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,395 - Fast cross-platform HTTP benchmarking tool.
...
- [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,482 - High-performance load testing tool, written in Golang.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,123 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,059 - Lightweight, programmable telemetry for servers and workstations.
...
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 48,962 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,967 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,938 - Hey is a tiny program that sends some load to a web application.
...
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,866 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 27,960 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,194 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,027 - Command line tool for building and deploying Go applications on Kubernetes
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,574 - Container Cluster Manager from Google.
...
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,162 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,515 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,852 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,096 - Blazing fast S3 and local filesystem execution tool.
...
- [skm](https://github.com/TimothyYe/skm) ⭐ 973 - SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily!
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,057 - Reverse proxy and load balancer with support for multiple backends.
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,368 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Chapar](https://github.com/chapar-rest/chapar) ⭐ 574 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,326 - Easily and securely send files or folders from one computer to another.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,446 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,914 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,686 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [nes](https://github.com/fogleman/nes) ⭐ 5,557 - Nintendo Entertainment System (NES) emulator written in Go.
...
- [restic](https://github.com/restic/restic) ⭐ 28,895 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 696 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,371 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,716 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
- [shell2http](https://github.com/msoap/shell2http) ⭐ 1,407 - Executing shell commands via http server (for prototyping or remote control).
...
- [sonic](https://github.com/go-sonic/sonic) ⭐ 2,087 - Sonic is a Go Blogging Platform. Simple and Powerful.
...
- [stew](https://github.com/marwanhawari/stew) ⭐ 268 - An independent package manager for compiled binaries.
...
- [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 416 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
- [Build Web Application with Golang](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/)
- [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
- [Go 101](https://go101.org) - A book focusing on Go syntax/semantics and all kinds of details.
- [Go AST Book (Chinese)](https://github.com/chai2010/go-ast-book) ⭐ 5,439 - A book focusing on Go `go/*` packages.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,048 - A curated list of Go books.
...
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,143
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,549
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,230 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,623 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,245 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,610 - Golang ebook intro how to build a web app with golang.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,849 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,518 - Curated list of Go design patterns, recipes and idioms.
...
- [golang-examples](https://github.com/SimonWaldherr/golang-examples) ⭐ 1,623 - Many examples to learn Golang.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,322 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,855 - Learn Go with test-driven development.
