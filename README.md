...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,749](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 247,171.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,749 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,749; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,987 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
- [Goakt](https://github.com/Tochemey/goakt) ⭐ 256 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,950 - Blazingly fast and light-weight Actor engine written in Golang.
- [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,244 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

_Libraries for building programs that leverage AI._

- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 596 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,915 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,290 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 144,218 - Run large language models locally.
...
- [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,724 - A low-level library to play sound on multiple platforms.
...
- [authboss](https://github.com/volatiletech/authboss) ⭐ 3,970 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,770 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [gologin](https://github.com/dghubble/gologin) ⭐ 1,909 - chainable handlers for login with OAuth1 and OAuth2 authentication providers.
- [gorbac](https://github.com/mikespook/gorbac) ⭐ 1,628 - provides a lightweight role-based access control (RBAC) implementation in Golang.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,048 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,164 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,118 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
- [keto](https://github.com/ory/keto) ⭐ 5,045 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,630 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
- [oidc](https://github.com/zitadel/oidc) ⭐ 1,584 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
- [openfga](https://github.com/openfga/openfga) ⭐ 3,722 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,615 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,156 - Official Go implementation of the Ethereum protocol.
...
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,328 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
- [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,804 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,194 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,353 - Telegram bot framework is written in Go.
...
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,979 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,787 - Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4,358 - Mage is a make/rake-like build tool using Go.
...
- [Task](https://github.com/go-task/task) ⭐ 12,989 - simple "Make" alternative.
...
- [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 499 - An interactive table component for bubbletea.
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,444 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,363 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,581 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,376 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,767.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,264 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,117 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,418 - Basic thread-safe progress bar that works in every OS.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,831 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,370.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,847 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,370 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,609.
...
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,298 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,803 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,038 - An expressive programming language and a versatile interactive shell.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,258 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,549 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,370 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [koanf](https://github.com/knadh/koanf) ⭐ 3,251 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,673 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,230 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,711 - Go configuration with fangs.
...
- [CDS](https://github.com/ovh/cds) ⭐ 4,720 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [drone](https://github.com/drone/drone) ⭐ 32,872 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,566 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,748.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,160 - Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,379 - A message streaming bridge between a range of protocols.
- [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,126 - A high-performance ELT data integration framework with pluggable architecture.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,718 - Go package implementing compressed bitsets.

### Bit Sets

- [bitmap](https://github.com/kelindar/bitmap) ⭐ 337 - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
- [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,423 - Go package implementing bitsets.

### Bloom and Cuckoo Filters

- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,606 - Go package implementing Bloom filters.
...
- [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,806 - Collection of useful, performant, and thread-safe data structures.
- [gods](https://github.com/emirpasic/gods) ⭐ 16,957 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [fsm](https://github.com/cocoonspace/fsm) ⭐ 79 - Finite-State Machine package.
...
- [gota](https://github.com/kniren/gota) ⭐ 3,193 - Implementation of dataframes, series, and data wrangling methods for Go.
...
- [deque](https://github.com/edwingeng/deque) ⭐ 199 - A highly optimized double-ended queue.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,706 - Distributed, Fault-tolerant task queue.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,532 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,853 - Efficient key/value cache for gigabytes of data.
...
- [cache2go](https://github.com/muesli/cache2go) ⭐ 2,156 - In-memory key:value cache which supports automatic invalidation based on timeouts.
...
- [GCache](https://github.com/bluele/gcache) ⭐ 2,686 - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
- [gocache](https://github.com/eko/gocache) ⭐ 2,670 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [pocache](https://github.com/naughtygopher/pocache) ⭐ 224 - Pocache is a minimal cache package which focuses on a preemptive optimistic caching strategy.
...
- [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,080 - An in-memory cache with item expiration and generics.
- [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger](https://github.com/dgraph-io/badger) ⭐ 14,669 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,852 - An embedded key/value database for Go.
- [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,717 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover](https://github.com/ostafen/clover) ⭐ 758 - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,007 - Scalable, Geo-Replicated, Transactional Datastore.
- [Coffer](https://github.com/claygod/coffer) ⭐ 40 - Simple ACID key-value database that supports transactions.
- [column](https://github.com/kelindar/column) ⭐ 1,475 - High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions.
- [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) ⭐ 1,518 - CovenantSQL is a SQL database on blockchain.
- [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,306 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,946 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,550 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,433 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,752 - Dolt – It's Git for Data.
...
- [godis](https://github.com/hdt3213/godis) ⭐ 3,701 - A Golang implemented high-performance Redis server and cluster.
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,276 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,756 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,195 - Scalable datastore for metrics, events, and real-time analytics.
...
- [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,167 - Fast k/v database compatible with lsm and b+tree.
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,494 - Milvus is a vector database for embedding management, analytics and search.
- [moss](https://github.com/couchbase/moss) ⭐ 1,005 - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,480 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
- [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,231 - High-performance embedded Object Database (NoSQL) with Go API.
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,350 - RocksDB/LevelDB inspired key-value database in Go.
- [piladb](https://github.com/fern4lvarez/piladb) ⭐ 206 - Lightweight RESTful database engine based on stack data structures.
- [pogreb](https://github.com/akrylysov/pogreb) ⭐ 1,338 - Embedded key-value store for read-heavy workloads.
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,047 - Monitoring system and time series database.
...
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,814 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,686 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,595 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,335 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,952 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,600 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,067 - A lightweight, framework-agnostic database migration tool.
...
- [goavro](https://github.com/linkedin/goavro) ⭐ 1,028 - A Go package that encodes and decodes Avro data.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,552 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,845 - Database migrations. CLI and Golang library.
...
- [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,186 - Advanced scheduling for PostgreSQL.
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,919 - Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,710 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,228 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,334 - Generate type-safe code from SQL.
...
- [gokv](https://github.com/philippgille/gokv) ⭐ 792 - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,878 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,526 - SQLite3 driver for go that uses database/sql.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,990 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,990 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,435 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,502 - Pure Go Postgres driver for database/sql.
...
- [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 161 - native and database/sql driver YDB (Yandex Database)
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,379 - Official MongoDB driver for the Go language.
...
- [redigo](https://github.com/gomodule/redigo) ⭐ 9,823 - Redigo is a Go client for the Redis database.
- [redis](https://github.com/redis/go-redis) ⭐ 20,976 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,695 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
- [xredis](https://github.com/shomali11/xredis) ⭐ 19 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

- [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,077 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
- [dateparse](https://github.com/araddon/dateparse) ⭐ 2,089 - Parse date's without knowing format in advance.
...
- [go-sunrise](https://github.com/nathan-osman/go-sunrise) ⭐ 167 - Calculate the sunrise and sunset times for a given location.
...
- [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,188 - A feature complete and high performance multi-group Raft library in Go.
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,625 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [emitter-io](https://github.com/emitter-io/emitter) ⭐ 3,935 - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,102 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,351 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,246 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,945 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,043 - A cloud native Kubernetes Global Balancer.
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,482 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,481 - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,603 - Lightweight, fault-tolerant message streams for NATS.
- [lura](https://github.com/luraproject/lura) ⭐ 6,567 - Ultra performant API Gateway framework with middlewares.
- [micro](https://github.com/micro/micro) ⭐ 12,256 - A distributed systems runtime for the cloud and beyond.
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,549 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,355 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,641 - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 857 - Go implementation of the Raft consensus protocol, by CoreOS.
- [rain](https://github.com/cenkalti/rain) ⭐ 1,046 - BitTorrent client and library.
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,622 - Simplified distributed locking implementation using Redis.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,299).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,895 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,789 - BitTorrent client package.
...
- [GoDNS](https://github.com/timothyye/godns) ⭐ 1,586 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,012 - A simple Go library for sending mails in Go.
...
- [go-simple-mail](https://github.com/xhit/go-simple-mail) ⭐ 681 - Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send.
...
- [mailgun-go](https://github.com/mailgun/mailgun-go) ⭐ 727 - Go library for sending mail with the Mailgun API.
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,961 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,238 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5,023 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [cel-go](https://github.com/google/cel-go) ⭐ 2,575 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,950 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,789 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,277 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,227 - ECMAScript 5.1(+) implementation in Go.
...
- [starlark-go](https://github.com/google/starlark-go) ⭐ 2,482 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
- [starlet](https://github.com/1set/starlet) ⭐ 30 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,482 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
- [tengo](https://github.com/d5/tengo) ⭐ 3,656 - Bytecode compiled script language for Go.
- [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,582 - The Wa Programming Language embedded in Go.
...
- [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2,462 - Go (golang) package for representing a list of errors as a single error.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,534 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,723 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,817.
...
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1,367 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,794 - Arbitrary-precision fixed-point decimal numbers.
- [decimal](https://github.com/govalues/decimal) ⭐ 166 - Immutable decimal numbers with panic-free arithmetic.
...
- [orderbook](https://github.com/i25959341/orderbook) ⭐ 492 - Matching Engine for Limit Order Book in Golang.
...
- [techan](https://github.com/sdcoffey/techan) ⭐ 863 - Technical analysis library with advanced market analysis and trading strategies.
...
- [form](https://github.com/go-playground/form) ⭐ 838 - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
- [mo](https://github.com/samber/mo) ⭐ 2,997 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,139 - dead simple 2D game engine in Go.
...
- [goworld](https://github.com/xiaonanln/goworld) ⭐ 2,652 - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- [Leaf](https://github.com/name5566/leaf) ⭐ 5,416 - Lightweight game server framework.
- [nano](https://github.com/lonng/nano) ⭐ 3,032 - Lightweight, facility, high performance golang based game server framework.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,077 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [go-enum](https://github.com/abice/go-enum) ⭐ 837 - Code generation for enums from code comments.
- [go-enum-encoding](https://github.com/nikolaydubina/go-enum-encoding) ⭐ 15 - Code generation for enum encoding from code comments.
- [go-linq](https://github.com/ahmetalpbalkan/go-linq) ⭐ 3,584 - .NET LINQ-like query methods for Go.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,229 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,351 - Geolocation DB with spatial index and realtime geofencing.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,406 - Compile shell scripts to Go.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,757 - A high-performance and low-cost goroutine pool in Go.
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,933 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [rill](https://github.com/destel/rill) ⭐ 1,680 - Go toolkit for clean, composable, channel-based concurrency.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,697 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 415 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,255 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,659.
- [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,026 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,259 - Build native macOS applications using Go.
- [energy](https://github.com/energye/energy) ⭐ 483 - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,601 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [qt](https://github.com/therecipe/qt) ⭐ 10,673 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- [webview](https://github.com/zserge/webview) ⭐ 13,165 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [systray](https://github.com/getlantern/systray) ⭐ 3,496 - Cross platform Go library to place an icon and menu in the notification area.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,573 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [bimg](https://github.com/h2non/bimg) ⭐ 2,865 - Small package for fast and efficient image processing using libvips.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,609 - 2D rendering in pure Go.
...
- [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 716 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,097 - Go package for computer vision using OpenCV 3.3+.
- [goimagehash](https://github.com/corona10/goimagehash) ⭐ 802 - Go Perceptual image hashing package.
...
- [govips](https://github.com/davidbyttow/govips) ⭐ 1,446 - A lightning fast image processing and resizing library for Go.
...
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,495 - Simple Go image processing package.
...
- [picfit](https://github.com/thoas/picfit) ⭐ 2,229 - An image resizing server written in Go.
...
- [steganography](https://github.com/auyer/steganography) ⭐ 338 - Pure Go Library for LSB steganography.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,311 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,491.
- [goflow](https://github.com/fieldryand/goflow) ⭐ 439 - A simple but powerful DAG scheduler and dashboard.
...
- [JobRunner](https://github.com/bamzi/jobrunner) ⭐ 1,071 - Smart and featureful cron job scheduler with job queuing and live monitoring built in.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,989 - Get a JSON value with one line of code.
...
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 571 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [slog](https://github.com/gookit/slog) ⭐ 477 - Lightweight, configurable, extensible logger for Go.
- [slog-formatter](https://github.com/samber/slog-formatter) ⭐ 173 - Common formatters for slog and helpers to build your own.
- [slog-multi](https://github.com/samber/slog-multi) ⭐ 488 - Chain of slog.Handler (pipeline, fanout...).
- [slogor](https://gitlab.com/greyxor/slogor) - A colorful slog handler.
- [spew](https://github.com/davecgh/go-spew) ⭐ 6,255 - Implements a deep pretty printer for Go data structures to aid in debugging.
- [sqldb-logger](https://github.com/simukti/sqldb-logger) ⭐ 376 - A logger for Go SQL database driver without modify existing \*sql.DB stdlib usage.
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,021 - A slog.Handler that writes tinted logs.
...
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,506 - Zero-allocation JSON logger.
...
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 412 - Huggingface transformer pipelines for golang with onnxruntime.
...
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 791 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,789 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,411 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,040 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,906 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,399 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,091 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,770 - Asynchronous task queue/job queue based on distributed message passing.
...
- [melody](https://github.com/olahol/melody) ⭐ 3,925 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,967 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,043 - Go library for Apache Kafka.
...
- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,594 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize](https://github.com/xuri/excelize) ⭐ 19,279 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [dig](https://github.com/uber-go/dig) ⭐ 4,199 - A reflection based dependency injection toolkit for Go.
- [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 184 - A dependency injection toolkit for Go, based on Guice.
- [do](https://github.com/samber/do) ⭐ 2,141 - A dependency injection framework based on Generics.
...
- [google/wire](https://github.com/google/wire) ⭐ 13,855 - Automated Initialization in Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,800 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,800 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,631 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,781 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,781 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,265 - Nunu is a scaffolding tool for building Go applications.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,554 - Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,961 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,243 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [lk](https://github.com/hyperboloide/lk) ⭐ 385 - A simple licensing library for golang.
...
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,268 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
- [sitemap-format](https://github.com/mingard/sitemap-format) ⭐ 6 - A simple sitemap generator, with a little syntactic sugar.
- [stateless](https://github.com/qmuntal/stateless) ⭐ 1,064 - A fluent library for creating state machines.
...
- [kagome](https://github.com/ikawaha/kagome) ⭐ 877 - JP morphological analyzer written in pure Go.
...
- [slug](https://github.com/gosimple/slug) ⭐ 1,255 - URL-friendly slugify with multiple languages support.
- [Slugify](https://github.com/avelino/slugify) ⭐ 34 - Go slugify application that handles string.

### Tokenizers

- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,533 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,176 which a Chinese word splitting algorithm.
...
- [gse](https://github.com/go-ego/gse) ⭐ 2,669 - Go efficient text segmentation; support english, chinese, japanese and other.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,262 - Package and an accompanying tool to work with localized text.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,840 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,378 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,645 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- [fortio](https://github.com/fortio/fortio) ⭐ 3,542 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,601 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,707 - Go library for downloading files or directories from various sources using a URL.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,814 - BGP implemented in the Go Programming Language.
- [gopacket](https://github.com/google/gopacket) ⭐ 6,546 - Go library for packet processing with libpcap bindings.
- [gopcap](https://github.com/akrennmair/gopcap) ⭐ 492 - Go wrapper for libpcap.
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,386 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [gosnmp](https://github.com/soniah/gosnmp) ⭐ 1,190 - Native Go library for performing SNMP actions.
- [gotcp](https://github.com/gansidui/gotcp) ⭐ 514 - Go package for quickly writing tcp applications.
- [grab](https://github.com/cavaliercoder/grab) ⭐ 1,438 - Go package for managing file downloads.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,507 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
- [net](https://golang.org/x/net) - This repository holds supplementary Go networking libraries.
- [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,326 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 932 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,743 - An implementation of the QUIC protocol in pure Go.
...
- [sftp](https://github.com/pkg/sftp) ⭐ 1,581 - Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>.
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,916 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,922 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,943 - A pure Go implementation of the WebRTC API.
...
- [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 261 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,142 - Retryable HTTP client in Go.
...
- [req](https://github.com/imroc/req) ⭐ 4,520 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,974 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,317 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,208 - SQL-first Golang ORM. Successor of go-pg.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,367 - The fantastic ORM library for Golang, aims to be developer friendly.
- [gormt](https://github.com/xxjwxc/gormt) ⭐ 2,399 - Mysql database to golang gorm struct.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,222 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,482 - A distributed tracing system.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,380 - go generate based graphql server library.
...
- [orb](https://github.com/paulmach/orb) ⭐ 996 - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
- [acmetool](https://github.com/hlandau/acme) ⭐ 2,075 - ACME (Let's Encrypt) client tool with automatic renewal.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,079 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,175 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 565 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,401 - Tool and library to remotely hack RTSP streams from surveillance cameras.
- [certificates](https://github.com/mvmaasakkers/certificates) ⭐ 38 - An opinionated tool for generating tls certificates.
- [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,243 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,702 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [go-password-validator](https://github.com/lane-c-wagner/go-password-validator) ⭐ 531 - Password validator based on raw cryptographic entropy values.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,661 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,781 - High-performance 100% compatible drop-in replacement of "encoding/json".
- [mapstructure](https://github.com/mitchellh/mapstructure) ⭐ 7,988 - Go library for decoding generic map values into native Go structures.
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,984 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [devd](https://github.com/cortesi/devd) ⭐ 3,454 - Local webserver for developers.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,651 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,552 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,499 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,429 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,675 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 53,237 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,859 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,173 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,588 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,441 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
- [pongo2](https://github.com/flosch/pongo2) ⭐ 2,957 - Django-like template-engine for Go.
- [quicktemplate](https://github.com/valyala/quicktemplate) ⭐ 3,225 - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,390 - A HTML templating language that has great developer tooling.
...
- [go-mutesting](https://github.com/zimmski/go-mutesting) ⭐ 655 - Mutation testing for Go source code.
...
- [goc](https://github.com/qiniu/goc) ⭐ 859 - Goc is a comprehensive coverage testing system for The Go Programming Language.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,248 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,129 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,766 - Sacred extension to the standard go testing package.
...
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,378 - Mock SQL driver for testing database interactions.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,643 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 485 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,990.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,934 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [rod](https://github.com/go-rod/rod) ⭐ 6,003 - A Devtools driver to make web automation and scraping easy.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,127 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,890 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [godump](https://github.com/yassinebenaid/godump) ⭐ 211 - Pretty print any GO variable with ease, an alternative to Go's `fmt.Printf("%#v")`.
- [godump (goforj)](https://github.com/goforj/godump) ⭐ 906 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
- [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,704 - Parse RSS and Atom feeds in Go.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,418 - HTML Sanitizer.
- [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 - A sanitization-based swear filter for Go.

### Scrapers

- [colly](https://github.com/asciimoo/colly) ⭐ 24,339 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,536 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [xurls](https://github.com/mvdan/xurls) ⭐ 1,221 - Extract urls from text.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,430 - Go bindings for the Discord Chat API.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,079 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 732 - Wrapper for PayPal payment API.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,794 - Slack API in Go.
...
- [countries](https://github.com/biter777/countries) ⭐ 454 - Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standards.
- [countries](https://github.com/pioz/countries) ⭐ 90 - All you need when you are working with countries in Go.
- [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,698 - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,198 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [debounce](https://github.com/floatdrop/debounce) ⭐ 23 - A zero-allocation debouncer written in Go.
- [delve](https://github.com/derekparker/delve) ⭐ 652 - Go debugger.
- [dive](https://github.com/wagoodman/dive) ⭐ 51,130 - A tool for exploring each layer in a Docker image.
...
- [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,794 - Fault tolerance and resilience patterns for Go.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 71,101 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,762 - Deliver Go binaries as fast and easily as possible.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,064 - A comprehensive, efficient, and reusable util function library of go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,598 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [minify](https://github.com/tdewolff/minify) ⭐ 3,895 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- [peco](https://github.com/peco/peco) ⭐ 7,760 - Simplistic interactive filtering tool.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,705 - Simple library for retry mechanism.
...
- [scany](https://github.com/georgysavva/scany) ⭐ 1,435 - Library for scanning data from a database into Go structs and more.
- [serve](https://github.com/syntaqx/serve) ⭐ 342 - A static http server anywhere you need.
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,084 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,006 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,401 - usql is a universal command-line interface for SQL databases.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,738 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,162 - Validators and sanitizers for strings, numerics, slices and structs.
...
- [jio](https://github.com/faceair/jio) ⭐ 118 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,117.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,509 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 876 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,662 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [git2go](https://github.com/libgit2/git2go) ⭐ 1,972 - Go bindings for libgit2.
- [githooks](https://github.com/gabyx/githooks) ⭐ 110 - Per-repo and shared Git hooks with version control and auto update.
- [go-git](https://github.com/go-git/go-git) ⭐ 6,646 - highly extensible Git implementation in pure Go.
...
- [gortsplib](https://github.com/aler9/gortsplib) ⭐ 788 - Pure Go RTSP server and client library.
- [libvlc-go](https://github.com/adrg/libvlc-go) ⭐ 469 - Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player).
...
- [Atreugo](https://github.com/savsgio/atreugo) ⭐ 1,279 - High performance and extensible micro web framework with zero memory allocations in hot paths.
...
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,911 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,418 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,799 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,785 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,462 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,863 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
- [Goyave](https://github.com/go-goyave/goyave) ⭐ 1,709 - Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities.
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,323 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,168 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 722 - Modern UI Components for Go & Templ.
...
- [Yokai](https://github.com/ankorstore/yokai) ⭐ 721 - Simple, modular, and observable Go framework for backend applications.
...
- [CORS](https://github.com/rs/cors) ⭐ 2,787 - Easily add CORS capabilities to your API.
...
- [Limiter](https://github.com/ulule/limiter) ⭐ 2,226 - Dead simple rate limit middleware for Go.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,966 - Small, fast and expressive HTTP router built on net/context.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,416 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,352 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,988 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 231 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,268 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [workflow](https://github.com/luno/workflow) ⭐ 168 - A tech stack agnostic Event Driven Workflow framework.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 5,008 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,378 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [Spire](https://github.com/spiffe/spire) ⭐ 1,974 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- [asty](https://github.com/asty-org/asty) ⭐ 86 - Converts golang AST to JSON and JSON to AST.
...
- [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) ⭐ 940 - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,174 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,072 - Formatter that automatically shortens long lines in Go code.
- [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,012 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,201 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,469 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 139 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,766.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 574 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,732 features to Vim/Neovim.
...
- [vim-go](https://github.com/fatih/vim-go) ⭐ 16,144 - Go development plugin for Vim.
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,071 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [gotests](https://github.com/cweill/gotests) ⭐ 5,072 - Generate Go tests from your source code.
...
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,609 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
- [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,400 - Fast cross-platform HTTP benchmarking tool.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,147 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,109 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,224 - Build powerful pipelines in any programming language.
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,757 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,125 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 11,007 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,977 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,854 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,985 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,074 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,222 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,041 - Command line tool for building and deploying Go applications on Kubernetes
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,837 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,384 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,726 - Cloud native application delivery.
...
- [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,131 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,568 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,930 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Packer](https://github.com/mitchellh/packer) ⭐ 15,389 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
- [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,622 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,304 - Pomerium is an identity-aware access proxy.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,350 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,735 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,216 - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,299 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,396 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,399 - Easily and securely send files or folders from one computer to another.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,458 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,948 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- [hotswap](https://github.com/edwingeng/hotswap) ⭐ 396 - A complete solution to reload your go code without restarting your server, interrupting or blocking any ongoing procedure.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,725 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [lgo](https://github.com/yunabe/lgo) ⭐ 2,454 - Interactive Go programming with Jupyter. It supports code completion, code inspection and 100% Go compatibility.
...
- [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,690 - LiteIDE is a simple, open source, cross-platform Go IDE.
...
- [nes](https://github.com/fogleman/nes) ⭐ 5,562 - Nintendo Entertainment System (NES) emulator written in Go.
...
- [Plik](https://github.com/root-gg/plik) ⭐ 1,572 - Plik is a temporary file upload system (Wetransfer like) in Go.
...
- [restic](https://github.com/restic/restic) ⭐ 29,030 - De-duplicating backup program.
...
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,849 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [sonic](https://github.com/go-sonic/sonic) ⭐ 2,089 - Sonic is a Go Blogging Platform. Simple and Powerful.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,318 - Proxy to simulate network and system conditions for automated tests.
...
- [Go AST Book (Chinese)](https://github.com/chai2010/go-ast-book) ⭐ 5,449 - A book focusing on Go `go/*` packages.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,096 - A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,755 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,007
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,157
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,580
...
- [Awesome Golang Workshops](https://github.com/amit-davidson/awesome-golang-workshops) ⭐ 518 - A curated list of awesome golang workshops.
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,387 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,649 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,473 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,639 - Golang ebook intro how to build a web app with golang.
...
- [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,647 - Go's reference card.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,889 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,578 - Curated list of Go design patterns, recipes and idioms.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,340 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,897 - Learn Go with test-driven development.
