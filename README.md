...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,499](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 246,733.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,499 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,499; you rock!
...
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,948 - Blazingly fast and light-weight Actor engine written in Golang.
- [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,241 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

_Libraries for building programs that leverage AI._

- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 592 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,841 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,220 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 143,740 - Run large language models locally.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,750 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,046 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,148 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,623 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,705 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,347 - Session Manager for HTTP servers.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,128 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,526 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,946 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,324 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,189 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telego](https://github.com/mymmrac/telego) ⭐ 724 - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,177 - Simple and clean Telegram bot client.
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,977 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,757 - Air - Live reload for Go apps.
...
- [Task](https://github.com/go-task/task) ⭐ 12,967 - simple "Make" alternative.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,419 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,250 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,553 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,369 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,759.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,261 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,095 - Declaratively define styles for color, format and layout in the terminal.
...
- [spinner](https://github.com/briandowns/spinner) ⭐ 2,437 - Go package to easily provide a terminal spinner with options.
...
- [termui](https://github.com/gizak/termui) ⭐ 13,373 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,607.
...
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,290 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,717 - Commander for modern Go CLI interactions.
...
- [Dnote](https://github.com/dnote/dnote) ⭐ 2,876 - A simple command line notebook with multi-device sync.
...
- [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,154 - Struct-based argument parsing in Go.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,250 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,845 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,535 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,357 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [koanf](https://github.com/knadh/koanf) ⭐ 3,244 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,660 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,213 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,683 - Go configuration with fangs.
...
- [abstruse](https://github.com/bleenco/abstruse) ⭐ 949 - Abstruse is a distributed CI platform.
- [Bencher](https://bencher.dev/) - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
- [CDS](https://github.com/ovh/cds) ⭐ 4,717 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [drone](https://github.com/drone/drone) ⭐ 32,862 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [go-semver-release](https://github.com/s0ders/go-semver-release) ⭐ 16 - Automate the semantic versioning of Git repositories.
...
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,566 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,745.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,150 - Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,378 - A message streaming bridge between a range of protocols.
...
- [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,804 - Collection of useful, performant, and thread-safe data structures.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,691 - Distributed, Fault-tolerant task queue.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,409 - Modern text indexing library for go.
...
- [trie](https://github.com/derekparker/trie) ⭐ 772 - Trie implementation in Go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,850 - Efficient key/value cache for gigabytes of data.
...
- [groupcache](https://github.com/golang/groupcache) ⭐ 13,184 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,120 -  A high performance memory-bound Go cache.
...
- [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,062 - An in-memory cache with item expiration and generics.
- [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger](https://github.com/dgraph-io/badger) ⭐ 14,653 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,842 - An embedded key/value database for Go.
...
- [clover](https://github.com/ostafen/clover) ⭐ 756 - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 30,995 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,305 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,934 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,534 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,433 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,741 - Dolt – It's Git for Data.
...
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,272 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,741 key/value database in Go.
...
- [immudb](https://github.com/codenotary/immudb) ⭐ 8,752 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,165 - Scalable datastore for metrics, events, and real-time analytics.
...
- [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,163 - Fast k/v database compatible with lsm and b+tree.
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,379 - Milvus is a vector database for embedding management, analytics and search.
...
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,342 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,980 - Monitoring system and time series database.
...
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,810 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,678 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,576 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,313 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,929 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,569 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,053 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,535 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,823 - Database migrations. CLI and Golang library.
...
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,912 - Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,687 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,221 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) ⭐ 648 - Powerful data retrieval methods as well as DB-agnostic query building capabilities.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,312 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,454 - Go library that helps you build SQL queries.
...
- [cayley](https://github.com/google/cayley) ⭐ 14,935 - Graph database with support for multiple backends.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,856 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,523 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 711 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
- [godror](https://github.com/godror/godror) ⭐ 556 - Oracle driver for Go, using the ODPI-C driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,974 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,974 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,432 query results easily.
...
- [gomemcache](https://github.com/bradfitz/gomemcache/) ⭐ 1,815 - memcache client library for the Go programming language.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,371 - Official MongoDB driver for the Go language.
...
- [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,072 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 974 - Fast trigram based code search.
...
- [carbon](https://github.com/dromara/carbon) ⭐ 5,079 - A simple, semantic and developer-friendly time package for golang.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,621 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [evans](https://github.com/ktr0731/evans) ⭐ 4,394 - Evans: more expressive universal gRPC client.
...
- [go-doudou](https://github.com/unionj-cloud/go-doudou) ⭐ 1,199 - A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity.
...
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,346 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,211 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,931 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,475 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,456 - A modular-designed and easy-to-use microservices framework in Go.
...
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,539 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,324 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,631 - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 850 - Go implementation of the Raft consensus protocol, by CoreOS.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,292).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,891 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,788 - BitTorrent client package.
- [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 970 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
- [GoDNS](https://github.com/timothyye/godns) ⭐ 1,582 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,380 - A Go library for email verification without sending any emails.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,007 - A simple Go library for sending mails in Go.
- [go-message](https://github.com/emersion/go-message) ⭐ 414 - Streaming library for the Internet Message Format and mail messages.
- [go-premailer](https://github.com/vanng822/go-premailer) ⭐ 170 - Inline styling for HTML mail in Go.
...
- [hermes](https://github.com/matcornic/hermes) ⭐ 2,903 - Golang package that generates clean, responsive HTML e-mails.
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,943 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,214 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5,012 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
- [SendGrid](https://github.com/sendgrid/sendgrid-go) ⭐ 1,016 - SendGrid's Go library for sending email.
...
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,611.
...
- [expr](https://github.com/antonmedv/expr) ⭐ 6,943 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,098 - PHP embedded in Go, with a `net/http` handler.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,213 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,611 - Lua 5.1 VM and compiler written in Go.
- [gval](https://github.com/PaesslerAG/gval) ⭐ 792 - A highly customizable expression language written in Go.
- [metacall](https://github.com/metacall/core) ⭐ 1,654 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
- [starlark-go](https://github.com/google/starlark-go) ⭐ 2,480 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
- [starlet](https://github.com/1set/starlet) ⭐ 30 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,480 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,662 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,232 - Go error library with error portability over the network.
- [errorx](https://github.com/joomcode/errorx) ⭐ 1,255 - A feature rich error package with stack traces, composition of errors and more.
...
- [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2,458 - Go (golang) package for representing a list of errors as a single error.
...
- [multierr](https://github.com/uber-go/multierr) ⭐ 1,139 - Package for representing a list of errors as a single error.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,244 - FileSystem Abstraction System for Go.
- [afs](https://github.com/viant/afs) ⭐ 337 - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,521 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,713 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,811.
...
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1,364 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,783 - Arbitrary-precision fixed-point decimal numbers.
...
- [ledger](https://github.com/formancehq/ledger) ⭐ 977 - A programmable financial ledger that provides a foundation for money-moving applications.
...
- [udecimal](https://github.com/quagmt/udecimal) ⭐ 143 - High performance, high precision, zero allocation fixed-point decimal library for financial applications.
...
- [mo](https://github.com/samber/mo) ⭐ 2,992 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ark](https://github.com/mlange-42/ark) ⭐ 80 - Archetype-based Entity Component System (ECS) for Go.
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,124 - dead simple 2D game engine in Go.
...
- [g3n](https://github.com/g3n/engine) ⭐ 2,953 - Go 3D Game Engine.
...
- [goworld](https://github.com/xiaonanln/goworld) ⭐ 2,651 - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- [nano](https://github.com/lonng/nano) ⭐ 3,027 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,627 - Pure Go game engine.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,075 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [go-linq](https://github.com/ahmetalpbalkan/go-linq) ⭐ 3,582 - .NET LINQ-like query methods for Go.
...
- [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,222 - Generate decorators for Go interfaces using simple templates.
- [interfaces](https://github.com/rjeczalik/interfaces) ⭐ 430 - Command line tool for generating interface definitions.
- [jennifer](https://github.com/dave/jennifer) ⭐ 3,507 - Generate arbitrary Go code without templates.
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,205 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [godal](https://github.com/airbusgeo/godal) ⭐ 161 - Go wrapper for GDAL.
...
- [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 727 - A simple Go-based server for map tiles stored in mbtiles format.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,347 - Geolocation DB with spatial index and realtime geofencing.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,396 - Compile shell scripts to Go.
...
- [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,980 - Compiler from Go to JavaScript.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,740 - A high-performance and low-cost goroutine pool in Go.
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,926 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [rill](https://github.com/destel/rill) ⭐ 1,678 - Go toolkit for clean, composable, channel-based concurrency.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,691 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 413 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,168 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,657.
- [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,024 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,580 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [qt](https://github.com/therecipe/qt) ⭐ 10,671 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- [walk](https://github.com/lxn/walk) ⭐ 6,980 - Windows application library kit for Go.
- [webview](https://github.com/zserge/webview) ⭐ 13,158 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,187 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
- [systray](https://github.com/getlantern/systray) ⭐ 3,492 - Cross platform Go library to place an icon and menu in the notification area.
...
- [zenity](https://github.com/ncruces/zenity) ⭐ 815 - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
- [goroslib](https://github.com/aler9/goroslib) ⭐ 366 - Robot Operating System (ROS) library for Go.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,604 - 2D rendering in pure Go.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,089 - Go package for computer vision using OpenCV 3.3+.
...
- [govatar](https://github.com/o1egl/govatar) ⭐ 602 - Library and CMD tool for generating funny avatars.
...
- [imaginary](https://github.com/h2non/imaginary) ⭐ 5,861 - Fast and simple HTTP microservice for image resizing.
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,491 - Simple Go image processing package.
- [imagor](https://github.com/cshum/imagor) ⭐ 3,651 - Fast, secure image processing server and Go library, using libvips.
...
- [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,598 - Lightweight data stream processing engine for IoT edge.
...
- [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,193 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,126 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
- [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 - Lightweight stream processing engine for IoT.
- [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,341 - Kubernetes native IoT development framework.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,300 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,491.
- [goflow](https://github.com/fieldryand/goflow) ⭐ 438 - A simple but powerful DAG scheduler and dashboard.
...
- [gronx](https://github.com/adhocore/gronx) ⭐ 452 - Cron expression parser, task runner and daemon consuming crontab like task list.
...
- [ajson](https://github.com/spyzhov/ajson) ⭐ 274 - Abstract JSON for golang with JSONPath support.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,982 - Get a JSON value with one line of code.
...
- [OjG](https://github.com/ohler55/ojg) ⭐ 894 - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 558 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,306 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,306 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,306 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,306, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,089, [zap](https://github.com/uber-go/zap) ⭐ 23,204, [zerolog](https://github.com/rs/zerolog) ⭐ 11,498, etc).
...
- [phuslu/log](https://github.com/phuslu/log) ⭐ 771 - High performance structured logging.
- [pp](https://github.com/k0kubun/pp) ⭐ 1,953 - Colored pretty printer for Go language.
...
- [slog](https://github.com/gookit/slog) ⭐ 475 - Lightweight, configurable, extensible logger for Go.
- [slog-formatter](https://github.com/samber/slog-formatter) ⭐ 171 - Common formatters for slog and helpers to build your own.
- [slog-multi](https://github.com/samber/slog-multi) ⭐ 484 - Chain of slog.Handler (pipeline, fanout...).
...
- [tail](https://github.com/hpcloud/tail) ⭐ 2,763 - Go package striving to emulate the features of the BSD tail program.
- [tint](https://github.com/lmittmann/tint) ⭐ 1,014 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,204 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,498 - Zero-allocation JSON logger.
...
- [GoLearn](https://github.com/sjwhitworth/golearn) ⭐ 9,403 - General Machine Learning library for Go.
...
- [goml](https://github.com/cdipaolo/goml) ⭐ 1,591 - On-line Machine Learning in Go.
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 801 - An accelerated Machine Learning framework for Go.
...
- [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,783 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,884 - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 788 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,783 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,355 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,026 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [mangos](https://github.com/nanomsg/mangos) ⭐ 710 - Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability.
...
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,961 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,958 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,033 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,547 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [excelize](https://github.com/xuri/excelize) ⭐ 19,265 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,973 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
- [do](https://github.com/samber/do) ⭐ 2,131 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,571 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,835 - Automated Initialization in Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,796 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,796 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,610 - Allows users to spin up a quick Go project using a popular framework.
...
- [go-starter](https://github.com/allaboutapps/go-starter) ⭐ 552 - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,733 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,733 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,255 - Nunu is a scaffolding tool for building Go applications.
...
- [archives](https://github.com/mholt/archives) ⭐ 244 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
- [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,244 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,543 - Automated service health dashboard.
...
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,231 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [stateless](https://github.com/qmuntal/stateless) ⭐ 1,062 - A fluent library for creating state machines.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,736.
...
- [kagome](https://github.com/ikawaha/kagome) ⭐ 875 - JP morphological analyzer written in pure Go.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,528 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,159 which a Chinese word splitting algorithm.
...
- [gse](https://github.com/go-ego/gse) ⭐ 2,666 - Go efficient text segmentation; support english, chinese, japanese and other.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,257 - Package and an accompanying tool to work with localized text.
- [go-mystem](https://github.com/dveselov/mystem) ⭐ 34 - CGo bindings to Yandex.Mystem - russian morphology analyzer.
- [go-pinyin](https://github.com/mozillazg/go-pinyin) ⭐ 1,686 - CN Hanzi to Hanyu Pinyin converter.
- [go-words](https://github.com/saleh-rahimzadeh/go-words) ⭐ 7 - A words table and text resource library for Golang projects.
- [gotext](https://github.com/leonelquinteros/gotext) ⭐ 469 - GNU gettext utilities for Go.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,797 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,628 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gmqtt](https://github.com/DrmagicE/gmqtt) ⭐ 1,003 - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,581 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,810 - BGP implemented in the Go Programming Language.
...
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,381 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,265 - KCP - Fast and Reliable ARQ Protocol.
- [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,148 - Extremely simple & fast udp tunnel based on KCP protocol.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,505 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
- [net](https://golang.org/x/net) - This repository holds supplementary Go networking libraries.
- [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,313 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 875 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,733 - An implementation of the QUIC protocol in pure Go.
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,906 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,920 - A pure Go implementation of the WebRTC API.
...
- [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,141 - Retryable HTTP client in Go.
- [go-zoox/fetch](https://github.com/go-zoox/fetch) ⭐ 77 - A Powerful, Lightweight, Easy Http Client, inspired by Web Fetch API.
- [grequests](https://github.com/levigross/grequests) ⭐ 2,155 - A Go "clone" of the great and famous Requests library.
...
- [req](https://github.com/imroc/req) ⭐ 4,514 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [requests](https://github.com/carlmjohnson/requests) ⭐ 1,606 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
- [resty](https://github.com/go-resty/resty) ⭐ 10,958 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
- [rq](https://github.com/ddo/rq) ⭐ 53 - A nicer interface for golang stdlib HTTP client.
- [sling](https://github.com/dghubble/sling) ⭐ 1,702 - Sling is a Go HTTP client library for creating and sending API requests.
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,164 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bun](https://github.com/uptrace/bun) ⭐ 4,197 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,263 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,559 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,342 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [gopm](https://github.com/gpmgo/gopm) ⭐ 2,459 - Go Package Manager.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,204 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,458 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 170 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,054 - No instrumentation tracing for Golang applications via eBPF.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,478 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,374 - go generate based graphql server library.
...
- [mql](https://github.com/hashicorp/mql) ⭐ 59 - Model Query Language (mql) is a query language for your database models.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,044 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,061 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,395 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,699 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,649 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [gogoprotobuf](https://github.com/gogo/protobuf) ⭐ 5,687 - Protocol Buffers for Go with Gadgets.
- [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,961 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,777 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,891 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- [Clace](https://github.com/claceio/clace) ⭐ 626 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,607 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,545 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,499 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,419 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,669 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 53,141 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,787 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,168 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,567 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [jet](https://github.com/CloudyKit/jet) ⭐ 1,330 - Jet template engine.
- [liquid](https://github.com/osteele/liquid) ⭐ 303 - Go implementation of Shopify Liquid templates.
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,435 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,384 - A HTML templating language that has great developer tooling.
...
- [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 960 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
- [go-cmp](https://github.com/google/go-cmp) ⭐ 4,427 - Package for comparing Go values in tests.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,216 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,114 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,740 - Sacred extension to the standard go testing package.
...
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,372 - Mock SQL driver for testing database interactions.
- [go-txdb](https://github.com/DATA-DOG/go-txdb) ⭐ 717 - Single transaction based database driver mainly for testing purposes.
- [gock](https://github.com/h2non/gock) ⭐ 2,173 - Versatile HTTP mocking made easy.
- [gomock](https://github.com/uber-go/mock) ⭐ 2,847 - Mocking framework for the Go programming language.
- [govcr](https://github.com/seborama/govcr) ⭐ 187 - HTTP mock for Golang: record and replay HTTP interactions for offline testing.
- [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,416 - HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,629 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 484 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,974.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,916 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [rod](https://github.com/go-rod/rod) ⭐ 5,991 - A Devtools driver to make web automation and scraping easy.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,558 - Formatters for time, numbers, and memory size to human readable format.
- [gotabulate](https://github.com/bndr/gotabulate) ⭐ 338 - Easily pretty-print your tabular data with Go.
- [sq](https://github.com/neilotoole/sq) ⭐ 2,290 - Convert data from SQL databases or document formats like CSV or Excel into formats such as JSON, Excel, CSV, HTML, Markdown, XML, and YAML.
...
- [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,551 - Markdown processor in Go.
...
- [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,820 - Go library for the TOML format with query support and handy cli tools.
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,113 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,883 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [godump](https://github.com/yassinebenaid/godump) ⭐ 210 - Pretty print any GO variable with ease, an alternative to Go's `fmt.Printf("%#v")`.
- [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,702 - Parse RSS and Atom feeds in Go.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,787 - Shell parser and formatter.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,411 - HTML Sanitizer.
- [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 - A sanitization-based swear filter for Go.

### Scrapers

- [colly](https://github.com/asciimoo/colly) ⭐ 24,320 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,531 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [go-runewidth](https://github.com/mattn/go-runewidth) ⭐ 638 - Functions to get fixed width of the character or string.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,095 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,420 - Go bindings for the Discord Chat API.
...
- [github](https://github.com/google/go-github) ⭐ 10,826 - Go library for accessing the GitHub REST API v3.
- [githubql](https://github.com/shurcooL/githubql) ⭐ 1,151 - Go library for accessing the GitHub GraphQL API v4.
- [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 163 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
- [go-jira](https://github.com/andygrunwald/go-jira) ⭐ 1,533 - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,061 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [lark](https://github.com/chyroc/lark) ⭐ 446 - [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback.
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 2,703 - Minio Go Library for Amazon S3 compatible cloud storage.
...
- [webhooks](https://github.com/go-playground/webhooks) ⭐ 986 - Webhook receiver for GitHub and Bitbucket.
...
- [bed](https://github.com/itchyny/bed) ⭐ 1,296 - A Vim-like binary editor written in Go.
...
- [clipboard](https://github.com/golang-design/clipboard) ⭐ 685 - 📋 cross-platform clipboard package in Go.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,184 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 51,082 - A tool for exploring each layer in a Docker image.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,979 - Command-line fuzzy finder written in Go.
...
- [go-funk](https://github.com/thoas/go-funk) ⭐ 4,904 - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,742 - Deliver Go binaries as fast and easily as possible.
...
- [json-log-viewer](https://github.com/hedhyw/json-log-viewer) ⭐ 156 - Interactive viewer for JSON logs.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,052 - A comprehensive, efficient, and reusable util function library of go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,565 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,815 - Package for MIME type detection based on magic numbers.
...
- [peco](https://github.com/peco/peco) ⭐ 7,758 - Simplistic interactive filtering tool.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,998 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,397 - usql is a universal command-line interface for SQL databases.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,732 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/google/uuid) ⭐ 5,693 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,138 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,932 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,472 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 872 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,584 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,625 - highly extensible Git implementation in pure Go.
- [go-vcs](https://github.com/sourcegraph/go-vcs) ⭐ 80 - manipulate and inspect VCS repositories in Go.
- [hercules](https://github.com/src-d/hercules) ⭐ 2,710 - gaining advanced insights from Git repository history.
...
- [Atreugo](https://github.com/savsgio/atreugo) ⭐ 1,276 - High performance and extensible micro web framework with zero memory allocations in hot paths.
- [Beego](https://github.com/beego/beego) ⭐ 32,118 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,142 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 455 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,865 - An Express.js inspired web framework build on Fasthttp.
...
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,746 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 - Gin parameter automatic binding tool,gin rpc tools.
- [Goa](https://github.com/goadesign/goa) ⭐ 5,879 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,815 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,448 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,858 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,305 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,151 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 716 - Modern UI Components for Go & Templ.
...
- [Limiter](https://github.com/ulule/limiter) ⭐ 2,221 - Dead simple rate limit middleware for Go.
...
- [Tollbooth](https://github.com/didip/tollbooth) ⭐ 2,797 - Rate limit HTTP request handler.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,939 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,895 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,327 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,982 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,255 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,999 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,364 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,157 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,070 - Formatter that automatically shortens long lines in Go code.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,199 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,468 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,740.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 574 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,712 features to Vim/Neovim.
...
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,065 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,290 - Visualize call graph of your Go program using dot format.
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,600 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,773 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [OctoLinker](https://github.com/OctoLinker/browser-extension) ⭐ 5,314 - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.
...
- [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,660 - aptly is a Debian repository management tool.
...
- [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,480 - High-performance load testing tool, written in Golang.
...
- [drone-scp](https://github.com/appleboy/drone-scp) ⭐ 154 - Copy files and artifacts via SSH using a binary, docker or Drone CI.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,135 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,081 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,222 - Build powerful pipelines in any programming language.
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,753 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,070 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,991 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,967 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,849 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,940 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,036 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,212 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,035 - Command line tool for building and deploying Go applications on Kubernetes
- [kool](https://github.com/kool-dev/kool) ⭐ 687 - Command line tool for managing Docker environments as an easy way.
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,735 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,777 - Container Cluster Manager from Google.
...
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,717 - Cloud native application delivery.
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,168 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
- [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,132 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
- [kwatch](https://github.com/abahmed/kwatch) ⭐ 980 - Monitor & detect crashes in your Kubernetes(K8s) cluster instantly.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,543 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,902 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Packer](https://github.com/mitchellh/packer) ⭐ 15,388 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
- [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 434 - Flexible HTTP command line stress tester.
- [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,170 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,296 - Pomerium is an identity-aware access proxy.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,325 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,730 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,015 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [tlm](https://github.com/yusufcanb/tlm) ⭐ 1,430 - Local cli copilot, powered by CodeLLaMa
- [traefik](https://github.com/containous/traefik) ⭐ 55,153 - Reverse proxy and load balancer with support for multiple backends.
...
- [uTask](https://github.com/ovh/utask) ⭐ 1,282 - Automation engine that models and executes business processes declared in yaml.
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,387 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,369 - Easily and securely send files or folders from one computer to another.
- [Documize](https://github.com/documize/community) ⭐ 2,249 - Modern wiki software that integrates data from SaaS tools.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,940 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- [Gor](https://github.com/buger/gor) ⭐ 18,960 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,707 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [restic](https://github.com/restic/restic) ⭐ 28,989 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 698 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,398 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,804 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
- [shell2http](https://github.com/msoap/shell2http) ⭐ 1,412 - Executing shell commands via http server (for prototyping or remote control).
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,305 - Proxy to simulate network and system conditions for automated tests.
...
- [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 422 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,082 - A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,754 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [gopher-stickers](https://github.com/tenntenn/gopher-stickers) ⭐ 599
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 30,995
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,151
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,573
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,338 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,643 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,381 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,624 - Golang ebook intro how to build a web app with golang.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,869 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,556 - Curated list of Go design patterns, recipes and idioms.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,339 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,882 - Learn Go with test-driven development.
