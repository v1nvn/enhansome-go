...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,939](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 247,439.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,939 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,939; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,994 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
- [Goakt](https://github.com/Tochemey/goakt) ⭐ 257 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,957 - Blazingly fast and light-weight Actor engine written in Golang.
- [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,247 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

_Libraries for building programs that leverage AI._

- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 601 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,943 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,378 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 144,480 - Run large language models locally.
...
- [GoAudio](https://github.com/DylanMeeus/GoAudio) ⭐ 374 - Native Go Audio Processing Library.
...
- [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,727 - A low-level library to play sound on multiple platforms.
- [PortAudio](https://github.com/gordonklaus/portaudio) ⭐ 775 - Go bindings for the PortAudio audio I/O library.
...
- [authboss](https://github.com/volatiletech/authboss) ⭐ 3,973 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,780 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [go-jose](https://github.com/go-jose/go-jose) ⭐ 405 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,634 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,729 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [paseto](https://github.com/o1egl/paseto) ⭐ 894 - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
- [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,620 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,173 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,531 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,953 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,329 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,198 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,360 - Telegram bot framework is written in Go.
...
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,981 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,806 - Air - Live reload for Go apps.
...
- [Task](https://github.com/go-task/task) ⭐ 13,003 - simple "Make" alternative.
- [taskctl](https://github.com/taskctl/taskctl) ⭐ 311 - Concurrent task runner.
- [xc](https://github.com/joerdav/xc) ⭐ 1,295 - Task runner with README.md defined tasks, executable markdown.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,461 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,444 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [chalk](https://github.com/ttacon/chalk) ⭐ 466 - Intuitive package for prettifying terminal/console output.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,592 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,377 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,774.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,267 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,132 - Declaratively define styles for color, format and layout in the terminal.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,831 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,371.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,849 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,371 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,609.
- [uilive](https://github.com/gosuri/uilive) ⭐ 1,707 - Library for updating terminal output in real time.
- [uiprogress](https://github.com/gosuri/uiprogress) ⭐ 2,131 - Flexible library to render progress bars in terminal applications.
...
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,308 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,843 - Commander for modern Go CLI interactions.
...
- [Dnote](https://github.com/dnote/dnote) ⭐ 2,879 - A simple command line notebook with multi-device sync.
- [elvish](https://github.com/elves/elvish) ⭐ 6,042 - An expressive programming language and a versatile interactive shell.
...
- [go-flags](https://github.com/jessevdk/go-flags) ⭐ 2,661 - go command line option parser.
...
- [pflag](https://github.com/spf13/pflag) ⭐ 2,577 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,264 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,557 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,375 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,238 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,254 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,675 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,251 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,729 - Go configuration with fangs.
- [xdg](https://github.com/adrg/xdg) ⭐ 830 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
- [CDS](https://github.com/ovh/cds) ⭐ 4,722 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [drone](https://github.com/drone/drone) ⭐ 32,886 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,566 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,750.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,169 - Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,384 - A message streaming bridge between a range of protocols.
...
- [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,808 - Collection of useful, performant, and thread-safe data structures.
- [gods](https://github.com/emirpasic/gods) ⭐ 16,970 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [gota](https://github.com/kniren/gota) ⭐ 3,195 - Implementation of dataframes, series, and data wrangling methods for Go.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,715 - Distributed, Fault-tolerant task queue.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,535 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,422 - Modern text indexing library for go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,857 - Efficient key/value cache for gigabytes of data.
...
- [EchoVault](https://github.com/EchoVault/EchoVault) ⭐ 490 - Embeddable Distributed in-memory data store compatible with Redis clients.
...
- [gocache](https://github.com/eko/gocache) ⭐ 2,672 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [groupcache](https://github.com/golang/groupcache) ⭐ 13,187 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [otter](https://github.com/maypok86/otter) ⭐ 1,923 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,140 -  A high performance memory-bound Go cache.
...
- [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,094 - An in-memory cache with item expiration and generics.
- [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger](https://github.com/dgraph-io/badger) ⭐ 14,681 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,853 - An embedded key/value database for Go.
...
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,016 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,560 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,435 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,764 - Dolt – It's Git for Data.
...
- [godis](https://github.com/hdt3213/godis) ⭐ 3,703 - A Golang implemented high-performance Redis server and cluster.
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,277 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,767 key/value database in Go.
...
- [immudb](https://github.com/codenotary/immudb) ⭐ 8,758 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,209 - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,524 - Milvus is a vector database for embedding management, analytics and search.
...
- [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,233 - High-performance embedded Object Database (NoSQL) with Go API.
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,353 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,090 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,786 - Redis re-implemented with SQLite.
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,818 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,690 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,610 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,362 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,956 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,616 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,072 - A lightweight, framework-agnostic database migration tool.
...
- [goavro](https://github.com/linkedin/goavro) ⭐ 1,030 - A Go package that encodes and decodes Avro data.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,564 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,861 - Database migrations. CLI and Golang library.
...
- [soda](https://github.com/gobuffalo/pop/tree/master/soda) ⭐ 1,486 - Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.
...
- [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,187 - Advanced scheduling for PostgreSQL.
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,921 - Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,718 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,349 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,464 - Go library that helps you build SQL queries.
- [xo](https://github.com/knq/xo) ⭐ 3,824 - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
- [go-transaction-manager](https://github.com/avito-tech/go-transaction-manager) ⭐ 312 - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,880 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,531 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 718 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 12,005 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,005 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,438 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,509 - Pure Go Postgres driver for database/sql.
...
- [go-mongox](https://github.com/chenmingyong0423/go-mongox) ⭐ 193 - A Go Mongo library based on the official driver, featuring streamlined document operations, generic binding of structs to collections, built-in CRUD, aggregation, automated field updates, struct validation, hooks, and plugin-based programming.
...
- [gomemcache](https://github.com/bradfitz/gomemcache/) ⭐ 1,818 - memcache client library for the Go programming language.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,377 - Official MongoDB driver for the Go language.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,986 - Redis client for Golang.
...
- [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,894 - Official Elasticsearch client for Go.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 983 - Fast trigram based code search.
...
- [now](https://github.com/jinzhu/now) ⭐ 4,537 - Now is a time toolkit for golang.
...
- [arpc](https://github.com/lesismal/arpc) ⭐ 1,042 - More effective network communication, support two-way-calling, notify, broadcast.
...
- [gleam](https://github.com/chrislusf/gleam) ⭐ 3,524 - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,110 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,360 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,267 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,952 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,486 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,494 - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,604 - Lightweight, fault-tolerant message streams for NATS.
- [lura](https://github.com/luraproject/lura) ⭐ 6,569 - Ultra performant API Gateway framework with middlewares.
- [micro](https://github.com/micro/micro) ⭐ 12,259 - A distributed systems runtime for the cloud and beyond.
...
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,369 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,644 - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 859 - Go implementation of the Raft consensus protocol, by CoreOS.
- [rain](https://github.com/cenkalti/rain) ⭐ 1,047 - BitTorrent client and library.
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,626 - Simplified distributed locking implementation using Redis.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,304).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,902 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [Temporal](https://github.com/temporalio/sdk-go) ⭐ 650 - Durable execution system for making code fault-tolerant and simple.
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,793 - BitTorrent client package.
...
- [email](https://github.com/jordan-wright/email) ⭐ 2,737 - A robust and flexible email library for Go.
- [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,385 - A Go library for email verification without sending any emails.
...
- [go-imap](https://github.com/emersion/go-imap) ⭐ 2,203 - IMAP library for clients and servers.
...
- [go-simple-mail](https://github.com/xhit/go-simple-mail) ⭐ 680 - Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,574 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,964 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,248 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5,029 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [anko](https://github.com/mattn/anko) ⭐ 1,521 - Scriptable interpreter written in Go.
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,617.
- [cel-go](https://github.com/google/cel-go) ⭐ 2,581 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,954 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,101 - PHP embedded in Go, with a `net/http` handler.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,234 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,617 - Lua 5.1 VM and compiler written in Go.
- [gval](https://github.com/PaesslerAG/gval) ⭐ 793 - A highly customizable expression language written in Go.
- [metacall](https://github.com/metacall/core) ⭐ 1,657 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
- [starlark-go](https://github.com/google/starlark-go) ⭐ 2,485 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
- [starlet](https://github.com/1set/starlet) ⭐ 30 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,485 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
- [tengo](https://github.com/d5/tengo) ⭐ 3,657 - Bytecode compiled script language for Go.
- [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,584 - The Wa Programming Language embedded in Go.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,667 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,238 - Go error library with error portability over the network.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 282 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
- [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2,464 - Go (golang) package for representing a list of errors as a single error.
...
- [oops](https://github.com/samber/oops) ⭐ 690 - Error handling with context, stack trace and source fragments.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,247 - FileSystem Abstraction System for Go.
...
- [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 97 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,184).
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,547 - Disk usage analyzer with console interface.
...
- [go-wkhtmltopdf](https://github.com/SebastiaanKlippert/go-wkhtmltopdf) ⭐ 1,124 - A package to convert an HTML template to a PDF file.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,733 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,822.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,800 - Arbitrary-precision fixed-point decimal numbers.
- [decimal](https://github.com/govalues/decimal) ⭐ 169 - Immutable decimal numbers with panic-free arithmetic.
...
- [orderbook](https://github.com/i25959341/orderbook) ⭐ 493 - Matching Engine for Limit Order Book in Golang.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,287 - Terminal stock watcher and stock position tracker.
...
- [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,125 - CSRF protection for Go web applications & services.
...
- [mo](https://github.com/samber/mo) ⭐ 3,001 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,149 - dead simple 2D game engine in Go.
...
- [g3n](https://github.com/g3n/engine) ⭐ 2,959 - Go 3D Game Engine.
- [go-astar](https://github.com/beefsack/go-astar) ⭐ 615 - Go implementation of the A\* path finding algorithm.
- [go-sdl2](https://github.com/veandco/go-sdl2) ⭐ 2,301 - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).
...
- [nano](https://github.com/lonng/nano) ⭐ 3,036 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,629 - Pure Go game engine.
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,559 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,081 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [copygen](https://github.com/switchupcb/copygen) ⭐ 390 - Generate any code based on Go types, including type-to-type converters (copy code) without reflection by default.
...
- [goverter](https://github.com/jmattheis/goverter) ⭐ 706 - Generate converters by defining an interface.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,237 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 730 - A simple Go-based server for map tiles stored in mbtiles format.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,357 - Geolocation DB with spatial index and realtime geofencing.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,405 - Compile shell scripts to Go.
- [c4go](https://github.com/Konstantin8105/c4go) ⭐ 372 - Transpile C code to Go code.
- [esp32](https://github.com/andygeiss/esp32-transpiler) ⭐ 92 - Transpile Go into Arduino code.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,764 - A high-performance and low-cost goroutine pool in Go.
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,939 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [go-actor](https://github.com/vladopajic/go-actor) ⭐ 226 - A tiny library for writing concurrent programs using actor model.
...
- [pond](https://github.com/alitto/pond) ⭐ 1,804 - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,703 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 415 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,306 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,663.
- [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,028 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,260 - Build native macOS applications using Go.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,616 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [qt](https://github.com/therecipe/qt) ⭐ 10,676 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
- [Spot](https://github.com/roblillack/spot) ⭐ 1,223 - Reactive, cross-platform desktop GUI toolkit.
- [ui](https://github.com/andlabs/ui) ⭐ 8,348 - Platform-native GUI library for Go. Cross platform.
...
- [walk](https://github.com/lxn/walk) ⭐ 6,983 - Windows application library kit for Go.
- [webview](https://github.com/zserge/webview) ⭐ 13,175 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,211 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,576 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [bimg](https://github.com/h2non/bimg) ⭐ 2,868 - Small package for fast and efficient image processing using libvips.
- [cameron](https://github.com/aofei/cameron) ⭐ 127 - An avatar generator for Go.
- [canvas](https://github.com/tdewolff/canvas) ⭐ 1,586 - Vector graphics to PDF, SVG or rasterized image.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,612 - 2D rendering in pure Go.
...
- [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 718 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,106 - Go package for computer vision using OpenCV 3.3+.
...
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,795 - Screenshoting webpages using go and headless chrome on command line.
...
- [imagor](https://github.com/cshum/imagor) ⭐ 3,657 - Fast, secure image processing server and Go library, using libvips.
...
- [picfit](https://github.com/thoas/picfit) ⭐ 2,240 - An image resizing server written in Go.
...
- [scout](https://github.com/jonoton/scout) ⭐ 19 - Scout is a standalone open source software solution for DIY video security.
...
- [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,600 - Lightweight data stream processing engine for IoT edge.
...
- [gatt](https://github.com/paypal/gatt) ⭐ 1,157 - Gatt is a Go package for building Bluetooth Low Energy peripherals.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,140 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,316 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,491.
...
- [fastjson](https://github.com/valyala/fastjson) ⭐ 2,384 - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
- [gabs](https://github.com/Jeffail/gabs) ⭐ 3,513 - For parsing, creating and editing unknown or dynamic JSON in Go.
- [gjo](https://github.com/skanehira/gjo) ⭐ 130 - Small utility to create JSON objects.
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,995 - Get a JSON value with one line of code.
...
- [kemba](https://github.com/clok/kemba) ⭐ 16 - A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug) ⭐ 11,290, great for CLI tools and applications.
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 577 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,322 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,322 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,322 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,322, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,110, [zap](https://github.com/uber-go/zap) ⭐ 23,240, [zerolog](https://github.com/rs/zerolog) ⭐ 11,517, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,131 - Simple rolling logger, implements io.WriteCloser.
...
- [slog-multi](https://github.com/samber/slog-multi) ⭐ 490 - Chain of slog.Handler (pipeline, fanout...).
- [slogor](https://gitlab.com/greyxor/slogor) - A colorful slog handler.
- [spew](https://github.com/davecgh/go-spew) ⭐ 6,257 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,024 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,240 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,517 - Zero-allocation JSON logger.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 805 - An accelerated Machine Learning framework for Go.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,891 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 415 - Huggingface transformer pipelines for golang with onnxruntime.
...
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 795 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [tfgo](https://github.com/galeone/tfgo) ⭐ 2,471 - Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python.
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,791 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,430 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
- [Beaver](https://github.com/Clivern/Beaver) ⭐ 1,570 - A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps.
- [Bus](https://github.com/mustafaturan/bus) ⭐ 348 - Minimalist message bus implementation for internal communication.
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,045 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,908 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- [go-socket.io](https://github.com/googollee/go-socket.io) ⭐ 5,778 - socket.io library for golang, a realtime application framework.
...
- [melody](https://github.com/olahol/melody) ⭐ 3,928 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,973 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,046 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,567 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,597 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize](https://github.com/xuri/excelize) ⭐ 19,284 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [godocx](https://github.com/gomutex/godocx) ⭐ 182 - Library for reading and writing Microsoft Word (Docx) files.
...
- [do](https://github.com/samber/do) ⭐ 2,147 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,586 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,867 - Automated Initialization in Go.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,648 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,820 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,820 for more information. Nonetheless, some may find the layout useful.
- [golang-templates/seed](https://github.com/golang-templates/seed) ⭐ 524 - Go application GitHub repository template.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,271 - Nunu is a scaffolding tool for building Go applications.
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,550 - Rapid, easy full-stack web development starter kit built in Go.
...
- [archives](https://github.com/mholt/archives) ⭐ 246 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
- [battery](https://github.com/distatus/battery) ⭐ 261 - Cross-platform, normalized battery information library.
- [bitio](https://github.com/icza/bitio) ⭐ 249 - Highly optimized bit-level Reader and Writer for Go.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,568 - Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,963 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,255 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [healthcheck](https://github.com/etherlabsio/healthcheck) ⭐ 273 - An opinionated and concurrent health-check HTTP handler for RESTful services.
...
- [shortid](https://github.com/teris-io/shortid) ⭐ 954 - Distributed generation of super short, unique, non-sequential, URL friendly IDs.
...
- [stateless](https://github.com/qmuntal/stateless) ⭐ 1,066 - A fluent library for creating state machines.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,743.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,534 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,184 which a Chinese word splitting algorithm.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,267 - Package and an accompanying tool to work with localized text.
...
- [cidranger](https://github.com/yl2chen/cidranger) ⭐ 943 - Fast IP to CIDR lookup for Go.
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,861 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,381 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,662 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- [fortio](https://github.com/fortio/fortio) ⭐ 3,544 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,605 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gopacket](https://github.com/google/gopacket) ⭐ 6,551 - Go library for packet processing with libpcap bindings.
- [gopcap](https://github.com/akrennmair/gopcap) ⭐ 492 - Go wrapper for libpcap.
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,388 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [grab](https://github.com/cavaliercoder/grab) ⭐ 1,440 - Go package for managing file downloads.
- [graval](https://github.com/koofr/graval) ⭐ 28 - Experimental FTP server framework.
- [gws](https://github.com/lxzan/gws) ⭐ 1,556 - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,273 - KCP - Fast and Reliable ARQ Protocol.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,508 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
- [net](https://golang.org/x/net) - This repository holds supplementary Go networking libraries.
- [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,332 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,007 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [psql-wire](https://github.com/jeroenrinzema/psql-wire) ⭐ 144 - PostgreSQL server wire protocol. Build your own server and start serving connections..
- [publicip](https://github.com/polera/publicip) ⭐ 29 - Package publicip returns your public facing IPv4 address (internet egress).
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,748 - An implementation of the QUIC protocol in pure Go.
...
- [sftp](https://github.com/pkg/sftp) ⭐ 1,584 - Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>.
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,920 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,931 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,952 - A pure Go implementation of the WebRTC API.
...
- [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 264 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- [heimdall](https://github.com/gojektech/heimdall) ⭐ 2,673 - An enhanced http client with retry and hystrix capabilities.
...
- [req](https://github.com/imroc/req) ⭐ 4,526 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,982 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
- [rq](https://github.com/ddo/rq) ⭐ 53 - A nicer interface for golang stdlib HTTP client.
- [sling](https://github.com/dghubble/sling) ⭐ 1,704 - Sling is a Go HTTP client library for creating and sending API requests.
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,174 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [gl](https://github.com/go-gl/gl) ⭐ 1,159 - Go bindings for OpenGL (generated via glow).
...
- [mathgl](https://github.com/go-gl/mathgl) ⭐ 580 - Pure Go math package specialized for 3D math, with inspiration from GLM.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,320 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,216 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,283 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,392 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [pop/soda](https://github.com/gobuffalo/pop) ⭐ 1,486 - Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,226 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,492 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 170 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,062 - No instrumentation tracing for Golang applications via eBPF.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,486 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,385 - go generate based graphql server library.
...
- [go-deepcopy](https://github.com/tiendc/go-deepcopy) ⭐ 96 - Fast deep copy library.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,055 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,869 - gonum/plot provides an API for building and drawing plots in Go.
...
- [orb](https://github.com/paulmach/orb) ⭐ 997 - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
- [Poly](https://github.com/bebop/poly) ⭐ 703 - A Go package for engineering organisms.
...
- [acra](https://github.com/cossacklabs/acra) ⭐ 1,402 - Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system.
- [age](https://github.com/FiloSottile/age) ⭐ 19,101 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,181 - A secure low code honeypot framework, leveraging AI for System Virtualization.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,709 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
- [dongle](https://github.com/golang-module/dongle) ⭐ 980 - A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption.
...
- [go-peer](https://github.com/number571/go-peer) ⭐ 293 - A software library for creating secure and anonymous decentralized systems.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,668 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,054 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [Easegress](https://github.com/megaease/easegress) ⭐ 5,831 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,672 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,554 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,500 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,435 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,677 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 53,274 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,909 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,596 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,147 - Make SSH apps, just like that!
...
- [go-streams](https://github.com/reugn/go-streams) ⭐ 2,047 - Go stream processing library.
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,461 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
- [pongo2](https://github.com/flosch/pongo2) ⭐ 2,957 - Django-like template-engine for Go.
- [quicktemplate](https://github.com/valyala/quicktemplate) ⭐ 3,226 - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,394 - A HTML templating language that has great developer tooling.
...
- [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 962 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
- [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,358 - BDD-style framework with web UI and live reload.
- [gocrest](https://github.com/corbym/gocrest) ⭐ 106 - Composable hamcrest-like matchers for Go assertions.
- [godog](https://github.com/cucumber/godog) ⭐ 2,445 - Cucumber BDD framework for Go.
...
- [is](https://github.com/matryer/is) ⭐ 1,863 - Professional lightweight testing mini-framework for Go.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,258 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,138 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,782 - Sacred extension to the standard go testing package.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,861 - Mocking framework for the Go programming language.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,645 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 485 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,005.
...
- [cdp](https://github.com/mafredri/cdp) ⭐ 752 - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,944 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,744 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 6,008 - A Devtools driver to make web automation and scraping easy.
...
- [sq](https://github.com/neilotoole/sq) ⭐ 2,299 - Convert data from SQL databases or document formats like CSV or Excel into formats such as JSON, Excel, CSV, HTML, Markdown, XML, and YAML.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,134 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,894 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
- [htmlquery](https://github.com/antchfx/htmlquery) ⭐ 767 - An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression.
...
- [toml](https://github.com/BurntSushi/toml) ⭐ 4,743 - TOML configuration format (encoder/decoder with reflection).
...
- [godump](https://github.com/yassinebenaid/godump) ⭐ 213 - Pretty print any GO variable with ease, an alternative to Go's `fmt.Printf("%#v")`.
- [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,170 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,802 - Shell parser and formatter.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,421 - HTML Sanitizer.
- [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 - A sanitization-based swear filter for Go.

### Scrapers

- [colly](https://github.com/asciimoo/colly) ⭐ 24,346 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,541 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,105 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,433 - Go bindings for the Discord Chat API.
...
- [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 165 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,086 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google](https://github.com/google/google-api-go-client) ⭐ 4,267 - Auto-generated Google APIs for Go.
...
- [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 733 - Wrapper for PayPal payment API.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,798 - Slack API in Go.
...
- [webhooks](https://github.com/go-playground/webhooks) ⭐ 988 - Webhook receiver for GitHub and Bitbucket.
...
- [bed](https://github.com/itchyny/bed) ⭐ 1,300 - A Vim-like binary editor written in Go.
...
- [clipboard](https://github.com/golang-design/clipboard) ⭐ 691 - 📋 cross-platform clipboard package in Go.
...
- [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,700 - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,202 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [debounce](https://github.com/floatdrop/debounce) ⭐ 29 - A zero-allocation debouncer written in Go.
- [delve](https://github.com/derekparker/delve) ⭐ 652 - Go debugger.
- [dive](https://github.com/wagoodman/dive) ⭐ 51,160 - A tool for exploring each layer in a Docker image.
...
- [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,249 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
- [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,795 - Fault tolerance and resilience patterns for Go.
- [filetype](https://github.com/h2non/filetype) ⭐ 2,197 - Small package to infer the file type checking the magic numbers signature.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 71,184 - Command-line fuzzy finder written in Go.
...
- [go-funk](https://github.com/thoas/go-funk) ⭐ 4,905 - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
- [godaemon](https://github.com/VividCortex/godaemon) ⭐ 494 - Utility to write daemons.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,768 - Deliver Go binaries as fast and easily as possible.
...
- [hub](https://github.com/github/hub) ⭐ 22,915 - wrap git commands with additional functionality to interact with github from the terminal.
...
- [lo](https://github.com/samber/lo) ⭐ 19,631 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mc](https://github.com/minio/mc) ⭐ 3,063 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
- [panicparse](https://github.com/maruel/panicparse) ⭐ 3,671 - Groups similar goroutines and colorizes stack dump.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,709 - Simple library for retry mechanism.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,093 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,008 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [toolbox](https://github.com/viant/toolbox) ⭐ 217 - Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer.
- [UNIS](https://github.com/esemplastic/unis) ⭐ 70 - Common Architecture™ for String Utilities in Go.
- [upterm](https://github.com/owenthereal/upterm) ⭐ 929 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
- [usql](https://github.com/knq/usql) ⭐ 9,405 - usql is a universal command-line interface for SQL databases.
...
- [uuid](https://github.com/google/uuid) ⭐ 5,701 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,142 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [gody](https://github.com/guiferpa/gody) ⭐ 152 - :balloon: A lightweight struct validator for Go.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,523 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 884 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,694 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,653 - highly extensible Git implementation in pure Go.
...
- [go-m3u8](https://github.com/etherlabsio/go-m3u8) ⭐ 33 - Parser and generator library for Apple m3u8 playlists. Actively maintained version of quangngotan95/go-m3u8 with improvements and latest HLS playlist parsing compatibility.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,175 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 457 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,934 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,421 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,830 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,792 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,466 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,874 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,328 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,170 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 730 - Modern UI Components for Go & Templ.
...
- [Yokai](https://github.com/ankorstore/yokai) ⭐ 723 - Simple, modular, and observable Go framework for backend applications.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,988 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,902 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,423 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,374 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,280 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [zek](https://github.com/miku/zek) ⭐ 767 - Generate a Go struct from XML.

## Zero Trust

_Libraries and tools to implement Zero Trust architectures._

- [Cosign](https://github.com/sigstore/cosign) ⭐ 5,012 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,391 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 105 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [Spire](https://github.com/spiffe/spire) ⭐ 1,973 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,190 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,072 - Formatter that automatically shortens long lines in Go code.
- [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,017 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 139 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,782.
...
- [go-mode](https://github.com/dominikh/go-mode.el) ⭐ 1,422 - Go mode for GNU/Emacs.
...
- [GoSublime](https://github.com/DisposaBoy/GoSublime) ⭐ 3,417 - Golang plugin collection for the text editor SublimeText 3 providing code completion and other IDE-like features.
...
- [envdoc](https://github.com/g4s8/envdoc) ⭐ 85 -  generate documentation for environment variables from Go source files.
...
- [gotests](https://github.com/cweill/gotests) ⭐ 5,077 - Generate Go tests from your source code.
...
- [xgen](https://github.com/xuri/xgen) ⭐ 370 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,781 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,401 - Fast cross-platform HTTP benchmarking tool.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,151 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,122 - Lightweight, programmable telemetry for servers and workstations.
...
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,176 - Fork of Gogs, entirely community driven.
...
- [Hey](https://github.com/rakyll/hey) ⭐ 18,991 - Hey is a tiny program that sends some load to a web application.
...
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,997 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,095 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,234 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,894 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,389 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,732 - Cloud native application delivery.
...
- [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,134 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,584 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,950 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Packer](https://github.com/mitchellh/packer) ⭐ 15,392 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
- [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 434 - Flexible HTTP command line stress tester.
- [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,175 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,310 - Pomerium is an identity-aware access proxy.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,357 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,743 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,027 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,251 - Reverse proxy and load balancer with support for multiple backends.
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,403 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,403 - Simulate bad network connections.
- [confd](https://github.com/kelseyhightower/confd) ⭐ 8,397 - Manage local application configuration files using templates and data from etcd or consul.
- [crawley](https://github.com/s0rg/crawley) ⭐ 301 - Web scraper/crawler for cli.
- [croc](https://github.com/schollz/croc) ⭐ 30,405 - Easily and securely send files or folders from one computer to another.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,461 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,967 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- [Gor](https://github.com/buger/gor) ⭐ 18,971 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,730 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [Plik](https://github.com/root-gg/plik) ⭐ 1,575 - Plik is a temporary file upload system (Wetransfer like) in Go.
...
- [restic](https://github.com/restic/restic) ⭐ 29,062 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 699 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,417 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,883 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,324 - Proxy to simulate network and system conditions for automated tests.
...
- [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 423 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
- [Build Web Application with Golang](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/)
- [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
- [Go 101](https://go101.org) - A book focusing on Go syntax/semantics and all kinds of details.
- [Go AST Book (Chinese)](https://github.com/chai2010/go-ast-book) ⭐ 5,450 - A book focusing on Go `go/*` packages.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,109 - A curated list of Go books.
...
- [The Golang Standard Library by Example (Chinese)](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) ⭐ 9,548
...
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,160
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,587
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,417 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,655 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,518 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,646 - Golang ebook intro how to build a web app with golang.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,897 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,585 - Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,734 - Examples of Golang compared to Node.js for learning.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,346 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,907 - Learn Go with test-driven development.
