...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 146,460 | 🐛 122 | 🌐 Go | 📅 2025-06-29
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 376,458 | 🐛 42 | 📅 2025-06-11
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 248,454 | 🐛 491 | 🌐 Python | 📅 2024-08-11.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 146,460 | 🐛 122 | 🌐 Go | 📅 2025-06-29 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 146,460 | 🐛 122 | 🌐 Go | 📅 2025-06-29; you rock!
...
* [Ergo](https://github.com/ergo-services/ergo) ⭐ 4,004 | 🐛 4 | 🌐 Go | 📅 2025-06-30 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 259 | 🐛 3 | 🌐 Go | 📅 2025-06-30 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
* [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,967 | 🐛 23 | 🌐 Go | 📅 2025-06-06 - Blazingly fast and light-weight Actor engine written in Golang.
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,250 | 🐛 87 | 🌐 Go | 📅 2024-08-22 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 612 | 🐛 11 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
* [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,013 | 🐛 363 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,588 | 🐛 477 | 🌐 Go | 📅 2025-06-30 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 145,189 | 🐛 1,903 | 🌐 Go | 📅 2025-07-01 - Run large language models locally.
...
* [flac](https://github.com/mewkiz/flac) ⭐ 333 | 🐛 8 | 🌐 Go | 📅 2024-08-11 - Native Go FLAC encoder/decoder with support for FLAC streams.
...
* [authboss](https://github.com/volatiletech/authboss) ⭐ 3,985 | 🐛 41 | 🌐 Go | 📅 2025-06-26 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,806 | 🐛 47 | 🌐 Go | 📅 2025-06-21 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [go-jose](https://github.com/go-jose/go-jose) ⭐ 412 | 🐛 31 | 🌐 Go | 📅 2025-06-26 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,069 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
* [jeff](https://github.com/abraithwaite/jeff) ⭐ 268 | 🐛 2 | 🌐 Go | 📅 2025-01-23 - Simple, flexible, secure, and idiomatic web session management with pluggable backends.
* [jwt](https://github.com/pascaldekloe/jwt) ⭐ 362 | 🐛 0 | 🌐 Go | 📅 2023-04-29 - Lightweight JSON Web Token (JWT) library.
* [jwt](https://github.com/cristalhq/jwt) ⭐ 684 | 🐛 2 | 🌐 Go | 📅 2025-06-22 - Safe, simple, and fast JSON Web Tokens for Go.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,202 | 🐛 47 | 🌐 Go | 📅 2025-06-12 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,127 | 🐛 4 | 🌐 Go | 📅 2025-06-28 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
* [keto](https://github.com/ory/keto) ⭐ 5,053 | 🐛 59 | 🌐 Go | 📅 2025-06-30 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,593 | 🐛 34 | 🌐 Go | 📅 2025-06-20 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
* [openfga](https://github.com/openfga/openfga) ⭐ 3,765 | 🐛 128 | 🌐 Go | 📅 2025-07-01 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 756 | 🐛 273 | 🌐 Go | 📅 2025-06-30 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,635 | 🐛 269 | 🌐 Go | 📅 2025-06-30 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 971 | 🐛 801 | 🌐 Go | 📅 2025-06-30 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,214 | 🐛 324 | 🌐 Go | 📅 2025-06-30 - Official Go implementation of the Ethereum protocol.
...
* [gossamer](https://github.com/ChainSafe/gossamer) ⭐ 451 | 🐛 388 | 🌐 Go | 📅 2025-06-30 - A Go implementation of the Polkadot Host.
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,545 | 🐛 1,111 | 🌐 Go | 📅 2025-06-30 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,962 | 🐛 816 | 🌐 Go | 📅 2025-06-30 - A complete implementation of a Lightning Network node.
...
* [arikawa](https://github.com/diamondburned/arikawa) ⭐ 526 | 🐛 35 | 🌐 Go | 📅 2025-07-01 - A library and framework for the Discord API.
* [bot](https://github.com/go-telegram/bot) ⭐ 1,210 | 🐛 11 | 🌐 Go | 📅 2025-05-21 - Zero-dependencies Telegram Bot library with additional UI components
...
* [go-twitch-irc](https://github.com/gempir/go-twitch-irc) ⭐ 376 | 🐛 8 | 🌐 Go | 📅 2024-09-29 - Library to write bots for twitch.tv chat
* [micha](https://github.com/onrik/micha) ⭐ 30 | 🐛 0 | 🌐 Go | 📅 2025-05-15 - Go Library for Telegram bot api.
* [slack-bot](https://github.com/innogames/slack-bot) ⭐ 198 | 🐛 9 | 🌐 Go | 📅 2025-07-01 - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
* [slacker](https://github.com/slack-io/slacker) ⭐ 54 | 🐛 9 | 🌐 Go | 📅 2024-11-16 - Easy to use framework to create Slack bots.
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,379 | 🐛 54 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,190 | 🐛 168 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
* [wayback](https://github.com/wabarc/wayback) ⭐ 1,986 | 🐛 55 | 🌐 Go | 📅 2025-06-30 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [air](https://github.com/cosmtrek/air) ⭐ 20,894 | 🐛 178 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [goyek](https://github.com/goyek/goyek) ⭐ 628 | 🐛 2 | 🌐 Go | 📅 2025-06-30 - Create build pipelines in Go.
* [mage](https://github.com/magefile/mage) ⭐ 4,368 | 🐛 128 | 🌐 Go | 📅 2025-06-15 - Mage is a make/rake-like build tool using Go.
...
* [Task](https://github.com/go-task/task) ⭐ 13,047 | 🐛 391 | 🌐 Go | 📅 2025-06-30 - simple "Make" alternative.
...
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,509 | 🐛 153 | 🌐 Go | 📅 2025-06-29 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,740 | 🐛 120 | 🌐 Go | 📅 2025-06-30 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,637 | 🐛 5 | 🌐 Go | 📅 2025-06-25 - Terminal JSON viewer & processor.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,378 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,788 | 🐛 674 | 🌐 Python | 📅 2025-04-15.
...
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,184 | 🐛 86 | 🌐 Go | 📅 2025-06-30 - Declaratively define styles for color, format and layout in the terminal.
...
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,432 | 🐛 13 | 🌐 Go | 📅 2025-02-08 - Basic thread-safe progress bar that works in every OS.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,126 | 🐛 59 | 🌐 Go | 📅 2025-06-07 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,837 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,374 | 🐛 105 | 🌐 Go | 📅 2024-07-22.
...
* [termui](https://github.com/gizak/termui) ⭐ 13,374 | 🐛 105 | 🌐 Go | 📅 2024-07-22 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,615 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 715 | 🐛 40 | 🌐 Go | 📅 2025-06-30 - Command argument completion generator for spf13/cobra.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,325 | 🐛 74 | 🌐 Go | 📅 2025-06-30 - Multi-shell multi-command argument completer.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 40,978 | 🐛 318 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [elvish](https://github.com/elves/elvish) ⭐ 6,047 | 🐛 337 | 🌐 Go | 📅 2025-06-29 - An expressive programming language and a versatile interactive shell.
...
* [pflag](https://github.com/spf13/pflag) ⭐ 2,585 | 🐛 179 | 🌐 Go | 📅 2025-06-28 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,291 | 🐛 50 | 🌐 Go | 📅 2025-06-14 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [bcl](https://github.com/wkhere/bcl) ⭐ 26 | 🐛 3 | 🌐 Go | 📅 2025-06-30 - BCL is a configuration language similar to HCL.
* [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,857 | 🐛 48 | 🌐 Go | 📅 2025-01-05 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
* [env](https://github.com/caarlos0/env) ⭐ 5,594 | 🐛 9 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,421 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [gookit/config](https://github.com/gookit/config) ⭐ 556 | 🐛 10 | 🌐 Go | 📅 2025-04-25 - application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge.
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,250 | 🐛 56 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,267 | 🐛 11 | 🌐 Go | 📅 2025-06-30 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [nfigure](https://github.com/muir/nfigure) ⭐ 8 | 🐛 4 | 🌐 Go | 📅 2025-07-01 - Per-library struct-tag based configuration from command lines (Posix & Go-style); environment, JSON, YAML
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,291 | 🐛 22 | 🌐 Go | 📅 2025-06-19 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,779 | 🐛 517 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
* [xdg](https://github.com/adrg/xdg) ⭐ 837 | 🐛 5 | 🌐 Go | 📅 2025-06-04 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
* [CDS](https://github.com/ovh/cds) ⭐ 4,727 | 🐛 151 | 🌐 Go | 📅 2025-06-30 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
* [drone](https://github.com/drone/drone) ⭐ 32,921 | 🐛 74 | 🌐 Go | 📅 2025-06-30 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,568 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,783 | 🐛 95 | 🌐 Rust | 📅 2025-06-30.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,202 | 🐛 345 | 🌐 Go | 📅 2025-06-30 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,391 | 🐛 525 | 🌐 Go | 📅 2025-06-30 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,130 | 🐛 149 | 🌐 Go | 📅 2025-07-01 - A high-performance ELT data integration framework with pluggable architecture.
...
* [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,427 | 🐛 3 | 🌐 Go | 📅 2025-06-01 - Go package implementing bitsets.

### Bloom and Cuckoo Filters

* [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,615 | 🐛 18 | 🌐 Go | 📅 2024-12-10 - Go package implementing Bloom filters.
...
* [gota](https://github.com/kniren/gota) ⭐ 3,200 | 🐛 81 | 🌐 Go | 📅 2023-08-09 - Implementation of dataframes, series, and data wrangling methods for Go.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,771 | 🐛 75 | 🌐 TypeScript | 📅 2025-06-30 - Distributed, Fault-tolerant task queue.
...
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,540 | 🐛 12 | 🌐 Go | 📅 2025-06-10 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,432 | 🐛 295 | 🌐 Go | 📅 2025-06-30 - Modern text indexing library for go.
...
* [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 406 | 🐛 3 | 🌐 Go | 📅 2025-05-19 - Implementation to calculate levenshtein distance in Go.
...
* [BigCache](https://github.com/allegro/bigcache) ⭐ 7,864 | 🐛 99 | 🌐 Go | 📅 2025-05-05 - Efficient key/value cache for gigabytes of data.
...
* [gocache](https://github.com/eko/gocache) ⭐ 2,683 | 🐛 39 | 🌐 Go | 📅 2025-05-25 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,195 | 🐛 42 | 🌐 Go | 📅 2024-11-29 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
* [otter](https://github.com/maypok86/otter) ⭐ 1,951 | 🐛 2 | 🌐 Go | 📅 2025-06-29 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,156 | 🐛 5 | 🌐 Go | 📅 2025-06-16 -  A high performance memory-bound Go cache.
* [sturdyc](https://github.com/viccon/sturdyc) ⭐ 1,209 | 🐛 5 | 🌐 Go | 📅 2025-04-04 - A caching library with advanced concurrency features designed to make I/O heavy applications robust and highly performant.
* [theine](https://github.com/Yiling-J/theine-go) ⭐ 299 | 🐛 6 | 🌐 Go | 📅 2025-03-02 - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
...
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,712 | 🐛 27 | 🌐 Go | 📅 2025-06-27 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,875 | 🐛 42 | 🌐 Go | 📅 2025-06-29 - An embedded key/value database for Go.
* [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
* [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,726 | 🐛 32 | 🌐 Go | 📅 2024-09-10 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,032 | 🐛 7,337 | 🌐 Go | 📅 2025-07-01 - Scalable, Geo-Replicated, Transactional Datastore.
...
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,979 | 🐛 33 | 🌐 Go | 📅 2025-06-30 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,790 | 🐛 436 | 🌐 Go | 📅 2025-07-01 - Dolt – It's Git for Data.
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,279 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,799 | 🐛 361 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,249 | 🐛 2,115 | 🌐 Rust | 📅 2025-06-30 - Scalable datastore for metrics, events, and real-time analytics.
* [ledisdb](https://github.com/siddontang/ledisdb) ⭐ 4,118 | 🐛 0 | 🌐 Go | 📅 2023-10-22 - Ledisdb is a high performance NoSQL like Redis based on LevelDB.
...
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,681 | 🐛 667 | 🌐 Go | 📅 2025-07-01 - Milvus is a vector database for embedding management, analytics and search.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,361 | 🐛 292 | 🌐 Go | 📅 2025-07-01 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,229 | 🐛 733 | 🌐 Go | 📅 2025-06-30 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,820 | 🐛 3 | 🌐 Go | 📅 2025-05-15 - Redis re-implemented with SQLite.
* [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,825 | 🐛 2 | 🌐 Go | 📅 2025-04-22 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,713 | 🐛 73 | 🌐 Go | 📅 2025-06-30 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,647 | 🐛 5,168 | 🌐 Go | 📅 2025-07-01 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,403 | 🐛 939 | 🌐 Go | 📅 2025-07-01 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 6,981 | 🐛 216 | 🌐 Go | 📅 2025-06-12 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,653 | 🐛 115 | 🌐 Go | 📅 2025-07-01 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,098 | 🐛 28 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,617 | 🐛 96 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [libschema](https://github.com/muir/libschema) ⭐ 17 | 🐛 1 | 🌐 Go | 📅 2025-06-30 - Define your migrations separately in each library. Migrations for open source libraries. MySQL & PostgreSQL.
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,918 | 🐛 431 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,324 | 🐛 18 | 🌐 Go | 📅 2025-06-30 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
...
* [dbbench](https://github.com/sj14/dbbench) ⭐ 108 | 🐛 10 | 🌐 Go | 📅 2025-06-30 - Database benchmarking tool with support for several databases and scripts.
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,775 | 🐛 150 | 🌐 Go | 📅 2025-06-11 - Go toolset to handle MySQL protocol and replication.
* [gorm-multitenancy](https://github.com/bartventer/gorm-multitenancy) ⭐ 60 | 🐛 13 | 🌐 Go | 📅 2025-06-30 - Multi-tenancy support for GORM managed databases.
...
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,932 | 🐛 35 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
* [prep](https://github.com/hexdigest/prep) ⭐ 35 | 🐛 0 | 🌐 Go | 📅 2017-12-19 - Use prepared SQL statements without changing your code.
* [pREST](https://github.com/prest/prest) ⭐ 4,363 | 🐛 141 | 🌐 Go | 📅 2025-04-29 - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,740 | 🐛 879 | 🌐 Go | 📅 2025-06-30 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [goqu](https://github.com/doug-martin/goqu) ⭐ 2,531 | 🐛 143 | 🌐 Go | 📅 2024-05-22 - Idiomatic SQL builder and query library.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,248 | 🐛 41 | 🌐 Go | 📅 2025-06-26 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,404 | 🐛 611 | 🌐 Go | 📅 2025-06-23 - Generate type-safe code from SQL.
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,480 | 🐛 91 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
* [xo](https://github.com/knq/xo) ⭐ 3,829 | 🐛 52 | 🌐 Go | 📅 2025-06-23 - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,899 | 🐛 61 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,546 | 🐛 202 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,060 | 🐛 231 | 🌐 Go | 📅 2025-06-26 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,060 | 🐛 231 | 🌐 Go | 📅 2025-06-26 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,438 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
* [pq](https://github.com/lib/pq) ⭐ 9,524 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 165 | 🐛 250 | 🌐 Go | 📅 2025-06-30 - native and database/sql driver YDB (Yandex Database)
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,385 | 🐛 10 | 🌐 Go | 📅 2025-06-30 - Official MongoDB driver for the Go language.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,025 | 🐛 101 | 🌐 Go | 📅 2025-06-28 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,705 | 🐛 13 | 🌐 Go | 📅 2025-06-30 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
* [elastic](https://github.com/olivere/elastic) ⭐ 7,470 | 🐛 115 | 🌐 Go | 📅 2024-08-08 - Elasticsearch client for Go.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,896 | 🐛 82 | 🌐 Go | 📅 2025-06-24 - Official Elasticsearch client for Go.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,090 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - A simple, semantic and developer-friendly time package for golang.
...
* [arpc](https://github.com/lesismal/arpc) ⭐ 1,056 | 🐛 0 | 🌐 Go | 📅 2025-02-20 - More effective network communication, support two-way-calling, notify, broadcast.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,643 | 🐛 37 | 🌐 Go | 📅 2025-07-01 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [emitter-io](https://github.com/emitter-io/emitter) ⭐ 3,943 | 🐛 15 | 🌐 Go | 📅 2025-03-13 - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
...
* [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,322 | 🐛 24 | 🌐 Go | 📅 2025-06-19 - A Go framework for the API or Microservice with handy scaffolding tools.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,128 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,374 | 🐛 19 | 🌐 Go | 📅 2025-06-24 - A distributed systems development framework.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,327 | 🐛 358 | 🌐 Go | 📅 2025-06-26 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,974 | 🐛 140 | 🌐 Go | 📅 2025-06-26 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,050 | 🐛 86 | 🌐 Go | 📅 2025-06-30 - A cloud native Kubernetes Global Balancer.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,506 | 🐛 52 | 🌐 Go | 📅 2025-06-25 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,538 | 🐛 120 | 🌐 Go | 📅 2025-06-01 - A modular-designed and easy-to-use microservices framework in Go.
...
* [lura](https://github.com/luraproject/lura) ⭐ 6,574 | 🐛 8 | 🌐 Go | 📅 2025-06-25 - Ultra performant API Gateway framework with middlewares.
* [micro](https://github.com/micro/micro) ⭐ 12,265 | 🐛 7 | 🌐 Go | 📅 2025-06-21 - A distributed systems runtime for the cloud and beyond.
* [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,562 | 🐛 26 | 🌐 Go | 📅 2025-04-16 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,420 | 🐛 465 | 🌐 Go | 📅 2025-06-30 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 613 | 🐛 55 | 🌐 Go | 📅 2025-06-30 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,659 | 🐛 45 | 🌐 Go | 📅 2025-06-24 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/etcd-io/raft) ⭐ 865 | 🐛 71 | 🌐 Go | 📅 2025-07-01 - Go implementation of the Raft consensus protocol, by CoreOS.
* [rain](https://github.com/cenkalti/rain) ⭐ 1,049 | 🐛 4 | 🌐 Go | 📅 2025-07-01 - BitTorrent client and library.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,324 | 🐛 354 | 🌐 C++ | 📅 2025-06-26).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,987 | 🐛 29 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 655 | 🐛 200 | 🌐 Go | 📅 2025-06-26 - Durable execution system for making code fault-tolerant and simple.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,801 | 🐛 63 | 🌐 Go | 📅 2025-06-30 - BitTorrent client package.
...
* [GoDNS](https://github.com/timothyye/godns) ⭐ 1,590 | 🐛 16 | 🌐 Go | 📅 2025-06-16 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,393 | 🐛 34 | 🌐 Go | 📅 2025-06-26 - A Go library for email verification without sending any emails.
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,023 | 🐛 4 | 🌐 Go | 📅 2025-06-30 - A simple Go library for sending mails in Go.
...
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,583 | 🐛 131 | 🌐 Go | 📅 2025-04-16 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,986 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,288 | 🐛 2 | 🌐 Go | 📅 2025-06-30 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,043 | 🐛 145 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,630 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,597 | 🐛 50 | 🌐 Go | 📅 2025-06-23 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,972 | 🐛 45 | 🌐 Go | 📅 2025-06-30 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,466 | 🐛 171 | 🌐 Go | 📅 2025-06-30 - PHP embedded in Go, with a `net/http` handler.
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,287 | 🐛 50 | 🌐 Go | 📅 2025-06-05 - Port of the Lua 5.2 VM to pure Go.
...
* [goja](https://github.com/dop251/goja) ⭐ 6,250 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [golua](https://github.com/aarzilli/golua) ⭐ 674 | 🐛 9 | 🌐 C | 📅 2025-02-17 - Go bindings for Lua C API.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,630 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
...
* [starlark-go](https://github.com/google/starlark-go) ⭐ 2,489 | 🐛 64 | 🌐 Go | 📅 2025-06-23 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
* [starlet](https://github.com/1set/starlet) ⭐ 30 | 🐛 2 | 🌐 Go | 📅 2025-04-15 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,489 | 🐛 64 | 🌐 Go | 📅 2025-06-23 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [errors](https://github.com/cockroachdb/errors) ⭐ 2,242 | 🐛 18 | 🌐 Go | 📅 2025-05-16 - Go error library with error portability over the network.
...
* [oops](https://github.com/samber/oops) ⭐ 701 | 🐛 16 | 🌐 Go | 📅 2025-06-30 - Error handling with context, stack trace and source fragments.
...
* [afero](https://github.com/spf13/afero) ⭐ 6,256 | 🐛 153 | 🌐 Go | 📅 2025-07-01 - FileSystem Abstraction System for Go.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 96 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,420 | 🐛 290 | 🌐 Go | 📅 2025-06-29).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,574 | 🐛 52 | 🌐 Go | 📅 2025-06-09 - Disk usage analyzer with console interface.
...
* [go-wkhtmltopdf](https://github.com/SebastiaanKlippert/go-wkhtmltopdf) ⭐ 1,127 | 🐛 10 | 🌐 Go | 📅 2024-07-02 - A package to convert an HTML template to a PDF file.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,756 | 🐛 123 | 🌐 Go | 📅 2025-06-28 - PDF processor.
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 | 🐛 1 | 🌐 Go | 📅 2023-09-21 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,835 | 🐛 39 | 📅 2025-01-16.
* [vfs](https://github.com/C2FO/vfs) ⭐ 341 | 🐛 9 | 🌐 Go | 📅 2025-05-12 - A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS.
...
* [ach](https://github.com/moov-io/ach) ⭐ 490 | 🐛 15 | 🌐 Go | 📅 2025-06-27 - A reader, writer, and validator for Automated Clearing House (ACH) files.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,377 | 🐛 135 | 🌐 Go | 📅 2025-06-30 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,817 | 🐛 141 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
* [decimal](https://github.com/govalues/decimal) ⭐ 171 | 🐛 6 | 🌐 Go | 📅 2025-01-18 - Immutable decimal numbers with panic-free arithmetic.
...
* [ledger](https://github.com/formancehq/ledger) ⭐ 985 | 🐛 8 | 🌐 Go | 📅 2025-06-30 - A programmable financial ledger that provides a foundation for money-moving applications.
* [money](https://github.com/govalues/money) ⭐ 37 | 🐛 0 | 🌐 Go | 📅 2025-01-25 - Immutable monetary amounts and exchange rates with panic-free arithmetic.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,302 | 🐛 36 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
...
* [mo](https://github.com/samber/mo) ⭐ 3,008 | 🐛 23 | 🌐 Go | 📅 2025-05-25 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,183 | 🐛 303 | 🌐 Go | 📅 2025-06-30 - dead simple 2D game engine in Go.
...
* [g3n](https://github.com/g3n/engine) ⭐ 2,963 | 🐛 37 | 🌐 Go | 📅 2025-02-08 - Go 3D Game Engine.
...
* [Leaf](https://github.com/name5566/leaf) ⭐ 5,420 | 🐛 24 | 🌐 Go | 📅 2024-05-23 - Lightweight game server framework.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,273 | 🐛 690 | 🌐 Go | 📅 2025-06-29 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,758 | 🐛 35 | 🌐 Go | 📅 2025-06-30 - S2 geometry library in Go.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,360 | 🐛 151 | 🌐 Go | 📅 2025-06-17 - Geolocation DB with spatial index and realtime geofencing.
...
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,419 | 🐛 12 | 🌐 Go | 📅 2025-05-18 - Compile shell scripts to Go.
...
* [go2hx](https://github.com/go2hx/go2hx) ⭐ 137 | 🐛 31 | 🌐 Haxe | 📅 2025-06-30 - Compiler from Go to Haxe to Javascript/C++/Java/C#.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,785 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,973 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [pond](https://github.com/alitto/pond) ⭐ 1,872 | 🐛 3 | 🌐 Go | 📅 2025-06-20 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 419 | 🐛 20 | 🌐 C++ | 📅 2025-06-27 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,538 | 🐛 1,162 | 🌐 C++ | 📅 2025-06-30 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,674 | 🐛 17 | 🌐 Lua | 📅 2025-06-27.
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,032 | 🐛 224 | 🌐 Go | 📅 2025-06-30 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
* [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,269 | 🐛 37 | 🌐 Go | 📅 2025-03-08 - Build native macOS applications using Go.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,670 | 🐛 747 | 🌐 Go | 📅 2025-06-30 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [webview](https://github.com/zserge/webview) ⭐ 13,196 | 🐛 194 | 🌐 C++ | 📅 2025-06-24 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,224 | 🐛 135 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,582 | 🐛 224 | 🌐 Go | 📅 2025-06-30 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,115 | 🐛 20 | 🌐 Go | 📅 2024-09-24 - Collection of image processing algorithms in pure Go.
...
* [gg](https://github.com/fogleman/gg) ⭐ 4,617 | 🐛 94 | 🌐 Go | 📅 2023-12-14 - 2D rendering in pure Go.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,123 | 🐛 342 | 🌐 Go | 📅 2025-05-30 - Go package for computer vision using OpenCV 3.3+.
...
* [imagick](https://github.com/gographics/imagick) ⭐ 1,824 | 🐛 3 | 🌐 Go | 📅 2024-12-16 - Go binding to ImageMagick's MagickWand C API.
* [imaginary](https://github.com/h2non/imaginary) ⭐ 5,869 | 🐛 131 | 🌐 Go | 📅 2025-01-14 - Fast and simple HTTP microservice for image resizing.
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,508 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,601 | 🐛 59 | 🌐 Go | 📅 2025-06-27 - Lightweight data stream processing engine for IoT edge.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,205 | 🐛 102 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,176 | 🐛 10 | 🌐 Go | 📅 2025-06-30 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
* [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 | 🐛 39 | 🌐 Go | 📅 2019-11-04 - Lightweight stream processing engine for IoT.
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,349 | 🐛 30 | 🌐 Go | 📅 2025-06-23 - Kubernetes native IoT development framework.
...
* [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,886 | 🐛 3 | 🌐 Go | 📅 2025-05-24 - Simple, zero-dependency scheduling library for Go.
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,336 | 🐛 17 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,009 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [OjG](https://github.com/ohler55/ojg) ⭐ 898 | 🐛 0 | 🌐 Go | 📅 2025-06-29 - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,340 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,340 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,340 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,340 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,128 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,289 | 🐛 164 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,553 | 🐛 138 | 🌐 Go | 📅 2025-04-18, etc).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,142 | 🐛 100 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 973 | 🐛 54 | 🌐 Go | 📅 2025-06-30 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
...
* [slog-formatter](https://github.com/samber/slog-formatter) ⭐ 173 | 🐛 0 | 🌐 Go | 📅 2025-06-30 - Common formatters for slog and helpers to build your own.
...
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,262 | 🐛 65 | 🌐 Go | 📅 2024-04-06 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
* [tint](https://github.com/lmittmann/tint) ⭐ 1,027 | 🐛 0 | 🌐 Go | 📅 2025-06-07 - A slog.Handler that writes tinted logs.
...
* [zap](https://github.com/uber-go/zap) ⭐ 23,289 | 🐛 164 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,553 | 🐛 138 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 817 | 🐛 2 | 🌐 Go | 📅 2025-06-28 - An accelerated Machine Learning framework for Go.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,794 | 🐛 111 | 🌐 Go | 📅 2024-08-12 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 421 | 🐛 6 | 🌐 Go | 📅 2025-06-26 - Huggingface transformer pipelines for golang with onnxruntime.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,479 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,069 | 🐛 20 | 🌐 Go | 📅 2025-06-29 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,917 | 🐛 284 | 🌐 HTML | 📅 2025-06-30 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
* [dbus](https://github.com/godbus/dbus) ⭐ 1,069 | 🐛 59 | 🌐 Go | 📅 2024-11-09 - Native Go bindings for D-Bus.
...
* [go-nsq](https://github.com/nsqio/go-nsq) ⭐ 2,630 | 🐛 33 | 🌐 Go | 📅 2025-03-13 - the official Go package for NSQ.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,415 | 🐛 59 | 🌐 Go | 📅 2025-05-12 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,094 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [Mercure](https://github.com/dunglas/mercure) ⭐ 4,972 | 🐛 24 | 🌐 Go | 📅 2025-06-27 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,989 | 🐛 185 | 🌐 Go | 📅 2025-06-30 - Go client for the NATS
  messaging system.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,063 | 🐛 64 | 🌐 Go | 📅 2025-06-30 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,594 | 🐛 121 | 🌐 Go | 📅 2025-05-26 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,611 | 🐛 26 | 🌐 Go | 📅 2025-05-21 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/xuri/excelize) ⭐ 19,315 | 🐛 123 | 🌐 Go | 📅 2025-06-25 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [dig](https://github.com/uber-go/dig) ⭐ 4,214 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 185 | 🐛 15 | 🌐 Go | 📅 2025-05-27 - A dependency injection toolkit for Go, based on Guice.
* [do](https://github.com/samber/do) ⭐ 2,170 | 🐛 45 | 🌐 Go | 📅 2025-05-05 - A dependency injection framework based on Generics.
* [fx](https://github.com/uber-go/fx) ⭐ 6,619 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
...
* [google/wire](https://github.com/google/wire) ⭐ 13,890 | 🐛 111 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [nject](https://github.com/muir/nject) ⭐ 30 | 🐛 3 | 🌐 Go | 📅 2025-06-30 - A type safe, reflective framework for libraries, tests, http endpoints, and service startup.
...
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,811 | 🐛 0 | 🌐 Go | 📅 2025-06-26 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,811 | 🐛 0 | 🌐 Go | 📅 2025-06-26 for building production grade scalable web service applications.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,705 | 🐛 43 | 🌐 Go | 📅 2025-06-30 - Allows users to spin up a quick Go project using a popular framework.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,903 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,903 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
* [golang-templates/seed](https://github.com/golang-templates/seed) ⭐ 529 | 🐛 0 | 🌐 Makefile | 📅 2025-06-30 - Go application GitHub repository template.
...
* [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,558 | 🐛 2 | 🌐 Go | 📅 2025-06-24 - Rapid, easy full-stack web development starter kit built in Go.
...
* [archives](https://github.com/mholt/archives) ⭐ 255 | 🐛 7 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,615 | 🐛 218 | 🌐 Go | 📅 2025-06-30 - Automated service health dashboard.
...
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,968 | 🐛 13 | 🌐 Go | 📅 2025-06-26 - Random data generator written in go.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,273 | 🐛 209 | 🌐 Go | 📅 2025-07-01 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [lingua-go](https://github.com/pemistahl/lingua-go) ⭐ 1,250 | 🐛 9 | 🌐 Go | 📅 2025-02-06 - An accurate natural language detection library, suitable for long and short text alike. Supports detecting multiple languages in mixed-language text.
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,538 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,209 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,277 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Package and an accompanying tool to work with localized text.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,913 | 🐛 446 | 🌐 Go | 📅 2025-06-30 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,696 | 🐛 110 | 🌐 Go | 📅 2025-07-01 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,820 | 🐛 220 | 🌐 Go | 📅 2025-06-30 - BGP implemented in the Go Programming Language.
* [gopacket](https://github.com/google/gopacket) ⭐ 6,554 | 🐛 360 | 🌐 Go | 📅 2025-03-19 - Go library for packet processing with libpcap bindings.
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,282 | 🐛 63 | 🌐 Go | 📅 2025-06-18 - KCP - Fast and Reliable ARQ Protocol.
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,161 | 🐛 130 | 🌐 Go | 📅 2025-06-20 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,523 | 🐛 2 | 🌐 Go | 📅 2025-05-18 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,068 | 🐛 0 | 🌐 Go | 📅 2025-06-29 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,786 | 🐛 187 | 🌐 Go | 📅 2025-06-29 - An implementation of the QUIC protocol in pure Go.
...
* [sdns](https://github.com/semihalev/sdns) ⭐ 997 | 🐛 0 | 🌐 Go | 📅 2025-06-30 - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
...
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,931 | 🐛 56 | 🌐 Go | 📅 2025-01-27 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
* [webrtc](https://github.com/pions/webrtc) ⭐ 14,990 | 🐛 99 | 🌐 Go | 📅 2025-07-01 - A pure Go implementation of the WebRTC API.
...
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 273 | 🐛 6 | 🌐 Go | 📅 2025-06-27 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,150 | 🐛 74 | 🌐 Go | 📅 2025-06-24 - Retryable HTTP client in Go.
...
* [req](https://github.com/imroc/req) ⭐ 4,536 | 🐛 70 | 🌐 Go | 📅 2025-06-27 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,008 | 🐛 35 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,182 | 🐛 35 | 🌐 Go | 📅 2025-06-17 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,332 | 🐛 18 | 🌐 Go | 📅 2025-06-18 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,228 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,313 | 🐛 587 | 🌐 Go | 📅 2025-06-20 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,565 | 🐛 8 | 🌐 Go | 📅 2025-06-12 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,432 | 🐛 460 | 🌐 Go | 📅 2025-06-25 - The fantastic ORM library for Golang, aims to be developer friendly.
...
* [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,304 | 🐛 115 | 🌐 Go | 📅 2025-06-30 - Prisma Client Go, Typesafe database access for Go.
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,888 | 🐛 104 | 🌐 Go | 📅 2025-06-27 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,269 | 🐛 472 | 🌐 Go | 📅 2025-07-01 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,534 | 🐛 324 | 🌐 Go | 📅 2025-07-01 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 171 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,071 | 🐛 331 | 🌐 C++ | 📅 2025-06-23 - No instrumentation tracing for Golang applications via eBPF.
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,491 | 🐛 47 | 🌐 Go | 📅 2025-03-28 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,395 | 🐛 368 | 🌐 Go | 📅 2025-06-30 - go generate based graphql server library.
...
* [graphql](https://github.com/neelance/graphql-go) ⭐ 4,712 | 🐛 42 | 🌐 Go | 📅 2025-06-12 - GraphQL server with a focus on ease of use.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,067 | 🐛 246 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,145 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,449 | 🐛 28 | 🌐 Go | 📅 2024-10-11 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
* [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,266 | 🐛 25 | 🌐 Go | 📅 2025-06-12 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,725 | 🐛 94 | 🌐 Go | 📅 2025-07-01 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,696 | 🐛 156 | 🌐 Go | 📅 2025-06-30 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,965 | 🐛 114 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [jsoniter](https://github.com/json-iterator/go) ⭐ 13,792 | 🐛 266 | 🌐 Go | 📅 2024-05-27 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
* [algernon](https://github.com/xyproto/algernon) ⭐ 2,919 | 🐛 28 | 🌐 Go | 📅 2025-06-27 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,231 | 🐛 216 | 🌐 Go | 📅 2025-07-01 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,835 | 🐛 11 | 🌐 Go | 📅 2025-06-30 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,728 | 🐛 325 | 🌐 Go | 📅 2025-06-30 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,580 | 🐛 51 | 🌐 Go | 📅 2025-06-30 - Fider is an open platform to collect and organize customer feedback.
...
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,443 | 🐛 48 | 🌐 Go | 📅 2025-06-30 - A self contained feature flag solution written in Go and Vue.js
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,685 | 🐛 19 | 🌐 Go | 📅 2025-06-30 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [minio](https://github.com/minio/minio) ⭐ 53,441 | 🐛 53 | 🌐 Go | 📅 2025-06-25 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 48,025 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,177 | 🐛 80 | 🌐 Go | 📅 2025-06-27 - High-performance PHP application server, load-balancer and process manager.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,639 | 🐛 111 | 🌐 Go | 📅 2025-06-22 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,176 | 🐛 14 | 🌐 Go | 📅 2025-06-23 - Make SSH apps, just like that!
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,050 | 🐛 4 | 🌐 Go | 📅 2025-05-11 - Go stream processing library.
...
* [jet](https://github.com/CloudyKit/jet) ⭐ 1,336 | 🐛 21 | 🌐 Go | 📅 2025-03-23 - Jet template engine.
* [liquid](https://github.com/osteele/liquid) ⭐ 307 | 🐛 29 | 🌐 Go | 📅 2025-06-01 - Go implementation of Shopify Liquid templates.
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,468 | 🐛 52 | 🌐 Go | 📅 2025-03-21 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,431 | 🐛 69 | 🌐 Go | 📅 2025-06-25 - A HTML templating language that has great developer tooling.
...
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,443 | 🐛 46 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
...
* [godog](https://github.com/cucumber/godog) ⭐ 2,450 | 🐛 83 | 🌐 Go | 📅 2025-06-13 - Cucumber BDD framework for Go.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,282 | 🐛 241 | 🌐 Go | 📅 2025-06-30 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,158 | 🐛 138 | 🌐 Go | 📅 2025-06-30 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
* [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,163 | 🐛 20 | 🌐 Go | 📅 2025-06-29 - A helper for Rails' like test fixtures to test database applications.
* [Testify](https://github.com/stretchr/testify) ⭐ 24,848 | 🐛 371 | 🌐 Go | 📅 2025-06-30 - Sacred extension to the standard go testing package.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,877 | 🐛 90 | 🌐 Go | 📅 2025-06-13 - Mocking framework for the Go programming language.
...
* [mockery](https://github.com/vektra/mockery) ⭐ 6,660 | 🐛 38 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 486 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,060 | 🐛 231 | 🌐 Go | 📅 2025-06-26.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 11,973 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,759 | 🐛 53 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
* [rod](https://github.com/go-rod/rod) ⭐ 6,032 | 🐛 181 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,567 | 🐛 42 | 🌐 Go | 📅 2025-05-12 - Formatters for time, numbers, and memory size to human readable format.
...
* [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,558 | 🐛 218 | 🌐 Go | 📅 2024-01-29 - Markdown processor in Go.
...
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,149 | 🐛 8 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,902 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,750 | 🐛 17 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,251 | 🐛 6 | 🌐 Go | 📅 2025-06-30 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,827 | 🐛 99 | 🌐 Go | 📅 2025-06-22 - Shell parser and formatter.
...
* [colly](https://github.com/asciimoo/colly) ⭐ 24,380 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,560 | 🐛 3 | 🌐 Go | 📅 2025-06-07 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,123 | 🐛 81 | 🌐 Go | 📅 2025-06-30 - The official AWS SDK for the Go programming language.
...
* [github](https://github.com/google/go-github) ⭐ 10,844 | 🐛 32 | 🌐 Go | 📅 2025-07-01 - Go library for accessing the GitHub REST API v3.
* [githubql](https://github.com/shurcooL/githubql) ⭐ 1,152 | 🐛 43 | 🌐 Go | 📅 2024-07-27 - Go library for accessing the GitHub GraphQL API v4.
* [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 166 | 🐛 13 | 🌐 Go | 📅 2025-06-30 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,116 | 🐛 211 | 🌐 Go | 📅 2025-06-25 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [golang-tmdb](https://github.com/cyruzin/golang-tmdb) ⭐ 138 | 🐛 2 | 🌐 Go | 📅 2025-06-30 - Golang wrapper for The Movie Database API v3.
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,276 | 🐛 20 | 🌐 Go | 📅 2025-06-30 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,280 | 🐛 385 | 🌐 Go | 📅 2025-07-01 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,724 | 🐛 17 | 🌐 Go | 📅 2025-07-01 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [slack](https://github.com/slack-go/slack) ⭐ 4,805 | 🐛 104 | 🌐 Go | 📅 2025-06-29 - Slack API in Go.
...
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,338 | 🐛 10 | 🌐 Go | 📅 2025-07-01 - Go client for the Stripe API.
...
* [bed](https://github.com/itchyny/bed) ⭐ 1,303 | 🐛 1 | 🌐 Go | 📅 2024-12-01 - A Vim-like binary editor written in Go.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 377 | 🐛 38 | 🌐 Go | 📅 2025-07-01 - Cross Platform tool to validate configuration files.
...
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,225 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,246 | 🐛 167 | 🌐 Go | 📅 2025-06-30 - A tool for exploring each layer in a Docker image.
...
* [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,803 | 🐛 27 | 🌐 Go | 📅 2025-06-24 - Fault tolerance and resilience patterns for Go.
* [filetype](https://github.com/h2non/filetype) ⭐ 2,205 | 🐛 46 | 🌐 Go | 📅 2025-06-27 - Small package to infer the file type checking the magic numbers signature.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 71,420 | 🐛 290 | 🌐 Go | 📅 2025-06-29 - Command-line fuzzy finder written in Go.
...
* [go-funk](https://github.com/thoas/go-funk) ⭐ 4,907 | 🐛 8 | 🌐 Go | 📅 2024-07-24 - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,799 | 🐛 23 | 🌐 Go | 📅 2025-07-01 - Deliver Go binaries as fast and easily as possible.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,094 | 🐛 8 | 🌐 Go | 📅 2025-06-25 - A comprehensive, efficient, and reusable util function library of go.
...
* [lo](https://github.com/samber/lo) ⭐ 19,684 | 🐛 210 | 🌐 Go | 📅 2025-06-11 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [mc](https://github.com/minio/mc) ⭐ 3,077 | 🐛 42 | 🌐 Go | 📅 2025-06-25 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
* [mergo](https://github.com/imdario/mergo) ⭐ 3,015 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
* [retry-go](https://github.com/avast/retry-go) ⭐ 2,715 | 🐛 14 | 🌐 Go | 📅 2025-03-21 - Simple library for retry mechanism.
...
* [serve](https://github.com/syntaqx/serve) ⭐ 343 | 🐛 2 | 🌐 Go | 📅 2025-05-05 - A static http server anywhere you need.
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,112 | 🐛 56 | 🌐 Go | 📅 2025-06-23 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,018 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
...
* [upterm](https://github.com/owenthereal/upterm) ⭐ 931 | 🐛 51 | 🌐 Go | 📅 2025-06-30 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,749 | 🐛 4 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [uuid](https://github.com/gofrs/uuid) ⭐ 1,700 | 🐛 3 | 🌐 Go | 📅 2025-06-23 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
* [uuid](https://github.com/google/uuid) ⭐ 5,708 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,580 | 🐛 324 | 🌐 Go | 📅 2025-06-25 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 891 | 🐛 10 | 🌐 Go | 📅 2025-06-15 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,801 | 🐛 548 | 🌐 TypeScript | 📅 2025-06-27 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,675 | 🐛 169 | 🌐 Go | 📅 2025-06-30 - highly extensible Git implementation in pure Go.
...
* [go-astiav](https://github.com/asticode/go-astiav) ⭐ 516 | 🐛 1 | 🌐 Go | 📅 2025-05-23 - Better C bindings for ffmpeg in GO.
...
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 798 | 🐛 26 | 🌐 Go | 📅 2025-07-01 - Pure Go RTSP server and client library.
...
* [Beego](https://github.com/beego/beego) ⭐ 32,129 | 🐛 16 | 🌐 Go | 📅 2025-06-25 - beego is an open-source, high-performance web framework for the Go programming language.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,212 | 🐛 105 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 464 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,002 | 🐛 108 | 🌐 Go | 📅 2025-07-01 - An Express.js inspired web framework build on Fasthttp.
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 533 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
* [Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) ⭐ 565 | 🐛 27 | 🌐 Go | 📅 2025-06-30 - Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications.
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,428 | 🐛 37 | 🌐 Go | 📅 2025-06-30 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Gin](https://github.com/gin-gonic/gin) ⭐ 82,947 | 🐛 854 | 🌐 Go | 📅 2025-07-01 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 | 🐛 13 | 🌐 Go | 📅 2025-04-16 - Gin parameter automatic binding tool,gin rpc tools.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,888 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,744 | 🐛 99 | 🌐 Go | 📅 2025-07-01 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,492 | 🐛 203 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,889 | 🐛 59 | 🌐 Go | 📅 2025-06-30 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,346 | 🐛 44 | 🌐 Go | 📅 2025-06-19 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,200 | 🐛 114 | 🌐 Go | 📅 2025-06-30 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
* [iWF](https://github.com/indeedeng/iwf) ⭐ 579 | 🐛 73 | 🌐 Go | 📅 2025-06-30 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
* [patron](https://github.com/beatlabs/patron) ⭐ 125 | 🐛 20 | 🌐 Go | 📅 2025-06-30 - Patron is a microservice framework following best cloud practices with a focus on productivity.
...
* [templui](https://github.com/axzilla/templui) ⭐ 741 | 🐛 2 | 🌐 JavaScript | 📅 2025-06-30 - Modern UI Components for Go & Templ.
...
* [negroni](https://github.com/urfave/negroni) ⭐ 7,528 | 🐛 9 | 🌐 Go | 📅 2025-05-03 - Idiomatic HTTP middleware for Golang.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,039 | 🐛 81 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,908 | 🐛 81 | 🌐 Go | 📅 2024-07-22 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,437 | 🐛 35 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
* [nchi](https://github.com/muir/nchi) ⭐ 18 | 🐛 3 | 🌐 Go | 📅 2025-06-30 - chi-like router built on httprouter with dependency injection based middleware wrappers
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,410 | 🐛 498 | 🌐 Go | 📅 2025-06-30 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,010 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 233 | 🐛 12 | 🌐 Go | 📅 2025-06-30 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [go-ole](https://github.com/go-ole/go-ole) ⭐ 1,248 | 🐛 6 | 🌐 Go | 📅 2025-04-21 - Win32 OLE implementation for golang.
...
* [Cadence-client](https://github.com/uber-go/cadence-client) ⭐ 359 | 🐛 72 | 🌐 Go | 📅 2025-06-30 - A framework for authoring workflows and activities running on top of the Cadence orchestration engine made by Uber.
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,345 | 🐛 114 | 🌐 Go | 📅 2025-06-30 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 558 | 🐛 2 | 🌐 Go | 📅 2025-05-14 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
* [workflow](https://github.com/luno/workflow) ⭐ 173 | 🐛 4 | 🌐 Go | 📅 2025-06-17 - A tech stack agnostic Event Driven Workflow framework.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,027 | 🐛 264 | 🌐 Go | 📅 2025-06-30 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,405 | 🐛 242 | 🌐 Go | 📅 2025-06-30 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 | 🐛 19 | 🌐 Go | 📅 2025-06-28 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,979 | 🐛 160 | 🌐 Go | 📅 2025-06-27 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,422 | 🐛 13 | 🌐 Go | 📅 2025-06-30 - Errcheck is a program for checking for unchecked errors in Go programs.
* [fatcontext](https://github.com/Crocmagnon/fatcontext) ⭐ 47 | 🐛 2 | 🌐 Go | 📅 2025-06-30 - Fatcontext detects nested contexts in loops or function literals.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 1,971 | 🐛 134 | 🌐 Go | 📅 2025-06-15 - source code linter that brings checks that are currently not implemented in other linters.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,241 | 🐛 115 | 🌐 Go | 📅 2025-06-30 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
* [golines](https://github.com/segmentio/golines) ⭐ 1,075 | 🐛 72 | 🌐 Go | 📅 2025-04-14 - Formatter that automatically shortens long lines in Go code.
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,019 | 🐛 41 | 🌐 Go | 📅 2025-06-11 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,218 | 🐛 46 | 🌐 Go | 📅 2025-06-25 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 141 | 🐛 35 | 🌐 Go | 📅 2025-06-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,848 | 🐛 371 | 🌐 Go | 📅 2025-06-30.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 790 | 🐛 74 | 🌐 Go | 📅 2025-06-30 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 575 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,746 | 🐛 96 | 🌐 Go | 📅 2025-07-01 features to Vim/Neovim.
...
* [goimports-reviser](https://github.com/incu6us/goimports-reviser) ⭐ 673 | 🐛 23 | 🌐 Go | 📅 2025-04-16 - Formatting tool for imports.
...
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,077 | 🐛 416 | 🌐 TypeScript | 📅 2025-06-30 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [xgen](https://github.com/xuri/xgen) ⭐ 372 | 🐛 30 | 🌐 Go | 📅 2025-06-20 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,302 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
* [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,617 | 🐛 11 | 🌐 Go | 📅 2025-06-30 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,791 | 🐛 606 | 🌐 Go | 📅 2025-06-27 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,168 | 🐛 29 | 🌐 Go | 📅 2025-06-30 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,163 | 🐛 2,484 | 🌐 Go | 📅 2025-07-01 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,226 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,765 | 🐛 13 | 🌐 Go | 📅 2025-06-29 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,316 | 🐛 2,716 | 🌐 Go | 📅 2025-07-01 - Fork of Gogs, entirely community driven.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,034 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,020 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,876 | 🐛 246 | 🌐 Go | 📅 2025-06-28 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,091 | 🐛 122 | 🌐 Go | 📅 2025-06-30 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,151 | 🐛 792 | 🌐 Go | 📅 2025-06-30 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,253 | 🐛 208 | 🌐 Go | 📅 2025-06-09 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,750 | 🐛 147 | 🌐 Go | 📅 2025-07-01 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,051 | 🐛 2,603 | 🌐 Go | 📅 2025-07-01 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,405 | 🐛 137 | 🌐 Go | 📅 2025-06-18 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,748 | 🐛 542 | 🌐 Go | 📅 2025-06-30 - Cloud native application delivery.
* [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,179 | 🐛 2 | 🌐 Go | 📅 2025-06-26 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,618 | 🐛 557 | 🌐 Go | 📅 2025-06-30 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,007 | 🐛 3,599 | 🌐 Go | 📅 2025-06-30 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,404 | 🐛 307 | 🌐 Go | 📅 2025-06-28 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 434 | 🐛 1 | 🌐 Go | 📅 2024-06-19 - Flexible HTTP command line stress tester.
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,180 | 🐛 104 | 🌐 Go | 📅 2025-07-01 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,636 | 🐛 29 | 🌐 Go | 📅 2025-06-27 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,327 | 🐛 138 | 🌐 Go | 📅 2025-07-01 - Pomerium is an identity-aware access proxy.
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,378 | 🐛 140 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 922 | 🐛 201 | 🌐 Go | 📅 2025-06-30 - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [traefik](https://github.com/containous/traefik) ⭐ 55,355 | 🐛 648 | 🌐 Go | 📅 2025-07-01 - Reverse proxy and load balancer with support for multiple backends.
...
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,322 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,427 | 🐛 67 | 🌐 Go | 📅 2025-06-30 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [croc](https://github.com/schollz/croc) ⭐ 30,478 | 🐛 11 | 🌐 Go | 📅 2025-06-23 - Easily and securely send files or folders from one computer to another.
...
* [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,469 | 🐛 322 | 🌐 Go | 📅 2025-05-03 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,990 | 🐛 18 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
* [Gor](https://github.com/buger/gor) ⭐ 18,991 | 🐛 338 | 🌐 Go | 📅 2025-04-05 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,805 | 🐛 122 | 🌐 Go | 📅 2025-07-01 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [nes](https://github.com/fogleman/nes) ⭐ 5,571 | 🐛 12 | 🌐 Go | 📅 2024-08-17 - Nintendo Entertainment System (NES) emulator written in Go.
...
* [restic](https://github.com/restic/restic) ⭐ 29,161 | 🐛 465 | 🌐 Go | 📅 2025-06-02 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 700 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,436 | 🐛 53 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,968 | 🐛 594 | 🌐 Go | 📅 2025-07-01 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,414 | 🐛 5 | 🌐 Go | 📅 2025-06-18 - Executing shell commands via http server (for prototyping or remote control).
...
* [stew](https://github.com/marwanhawari/stew) ⭐ 274 | 🐛 10 | 🌐 Go | 📅 2025-05-06 - An independent package manager for compiled binaries.
...
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,336 | 🐛 91 | 🌐 Go | 📅 2025-06-30 - Proxy to simulate network and system conditions for automated tests.
...
* [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 428 | 🐛 0 | 🌐 Go | 📅 2025-03-14 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,149 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [gophers](https://github.com/ashleymcnamara/gophers) ⭐ 3,018 | 🐛 1 | 🌐 Go | 📅 2025-01-23 - Gopher artworks by Ashley McNamara.
* [gophers](https://github.com/egonelbre/gophers) ⭐ 3,672 | 🐛 5 | 🌐 Go | 📅 2022-07-06 - Free gophers.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,032 | 🐛 7,337 | 🌐 Go | 📅 2025-07-01
* [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
* [Google](https://google.github.io/styleguide/go/)
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,172 | 🐛 180 | 🌐 Go | 📅 2025-06-30
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,611 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,534 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,678 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,637 | 🐛 9,362 | 🌐 Go | 📅 2025-06-30 - List of projects on the Go community wiki.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,664 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
...
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,654 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,915 | 🐛 8 | 🌐 Go | 📅 2025-06-27 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,621 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,735 | 🐛 1 | 🌐 Go | 📅 2023-02-02 - Examples of Golang compared to Node.js for learning.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,364 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,929 | 🐛 65 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
