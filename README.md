...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 147,078 | 🐛 122 | 🌐 Go | 📅 2025-07-10
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 380,930 | 🐛 42 | 📅 2025-07-05
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 249,748 | 🐛 478 | 🌐 Python | 📅 2025-07-05.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 147,078 | 🐛 122 | 🌐 Go | 📅 2025-07-10 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 147,078 | 🐛 122 | 🌐 Go | 📅 2025-07-10; you rock!
...
* [Ergo](https://github.com/ergo-services/ergo) ⭐ 4,018 | 🐛 4 | 🌐 Go | 📅 2025-07-07 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 263 | 🐛 0 | 🌐 Go | 📅 2025-07-10 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
* [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,976 | 🐛 22 | 🌐 Go | 📅 2025-07-04 - Blazingly fast and light-weight Actor engine written in Golang.
...
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,098 | 🐛 371 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,787 | 🐛 482 | 🌐 Go | 📅 2025-07-10 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 146,165 | 🐛 1,879 | 🌐 Go | 📅 2025-07-11 - Run large language models locally.
...
* [flac](https://github.com/mewkiz/flac) ⭐ 336 | 🐛 9 | 🌐 Go | 📅 2024-08-11 - Native Go FLAC encoder/decoder with support for FLAC streams.
...
* [authboss](https://github.com/volatiletech/authboss) ⭐ 3,991 | 🐛 41 | 🌐 Go | 📅 2025-06-26 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,856 | 🐛 48 | 🌐 Go | 📅 2025-07-10 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [go-jose](https://github.com/go-jose/go-jose) ⭐ 417 | 🐛 34 | 🌐 Go | 📅 2025-06-26 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,094 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,244 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,130 | 🐛 4 | 🌐 Go | 📅 2025-07-10 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
* [keto](https://github.com/ory/keto) ⭐ 5,061 | 🐛 56 | 🌐 Go | 📅 2025-07-10 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,640 | 🐛 41 | 🌐 Go | 📅 2025-05-05 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,604 | 🐛 32 | 🌐 Go | 📅 2025-07-10 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
* [openfga](https://github.com/openfga/openfga) ⭐ 3,822 | 🐛 128 | 🌐 Go | 📅 2025-07-11 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [scs](https://github.com/alexedwards/scs) ⭐ 2,363 | 🐛 31 | 🌐 Go | 📅 2025-07-08 - Session Manager for HTTP servers.
...
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,649 | 🐛 282 | 🌐 Go | 📅 2025-07-11 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 973 | 🐛 793 | 🌐 Go | 📅 2025-07-10 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,274 | 🐛 321 | 🌐 Go | 📅 2025-07-09 - Official Go implementation of the Ethereum protocol.
...
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,562 | 🐛 1,102 | 🌐 Go | 📅 2025-07-10 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,969 | 🐛 820 | 🌐 Go | 📅 2025-07-10 - A complete implementation of a Lightning Network node.
...
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,813 | 🐛 21 | 🌐 Go | 📅 2025-07-09 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
* [bot](https://github.com/go-telegram/bot) ⭐ 1,220 | 🐛 12 | 🌐 Go | 📅 2025-07-08 - Zero-dependencies Telegram Bot library with additional UI components
...
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,385 | 🐛 55 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
* [telego](https://github.com/mymmrac/telego) ⭐ 733 | 🐛 3 | 🌐 Go | 📅 2025-07-01 - Telegram Bot API library for Golang with full one-to-one API implementation.
...
* [wayback](https://github.com/wabarc/wayback) ⭐ 1,999 | 🐛 56 | 🌐 Go | 📅 2025-07-07 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [air](https://github.com/cosmtrek/air) ⭐ 20,987 | 🐛 178 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [mage](https://github.com/magefile/mage) ⭐ 4,380 | 🐛 130 | 🌐 Go | 📅 2025-06-15 - Mage is a make/rake-like build tool using Go.
...
* [Task](https://github.com/go-task/task) ⭐ 13,101 | 🐛 392 | 🌐 Go | 📅 2025-07-09 - simple "Make" alternative.
* [taskctl](https://github.com/taskctl/taskctl) ⭐ 312 | 🐛 6 | 🌐 Go | 📅 2025-01-18 - Concurrent task runner.
* [xc](https://github.com/joerdav/xc) ⭐ 1,301 | 🐛 15 | 🌐 Go | 📅 2025-07-10 - Task runner with README.md defined tasks, executable markdown.
...
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,559 | 🐛 154 | 🌐 Go | 📅 2025-07-10 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 33,072 | 🐛 117 | 🌐 Go | 📅 2025-07-10 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,657 | 🐛 4 | 🌐 Go | 📅 2025-07-08 - Terminal JSON viewer & processor.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,384 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,815 | 🐛 673 | 🌐 Python | 📅 2025-07-03.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,287 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
...
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,236 | 🐛 86 | 🌐 Go | 📅 2025-07-10 - Declaratively define styles for color, format and layout in the terminal.
...
* [mpb](https://github.com/vbauerster/mpb) ⭐ 2,414 | 🐛 17 | 🌐 Go | 📅 2025-06-05 - Multi progress bar for terminal applications.
...
* [pterm](https://github.com/pterm/pterm) ⭐ 5,146 | 🐛 64 | 🌐 Go | 📅 2025-07-10 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,846 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,382 | 🐛 103 | 🌐 Go | 📅 2025-07-10.
* [termenv](https://github.com/muesli/termenv) ⭐ 1,865 | 🐛 37 | 🌐 Go | 📅 2025-05-05 - Advanced ANSI style & color support for your terminal applications.
* [termui](https://github.com/gizak/termui) ⭐ 13,382 | 🐛 103 | 🌐 Go | 📅 2025-07-10 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,619 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
...
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,342 | 🐛 74 | 🌐 Go | 📅 2025-07-10 - Multi-shell multi-command argument completer.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,089 | 🐛 320 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [elvish](https://github.com/elves/elvish) ⭐ 6,056 | 🐛 338 | 🌐 Go | 📅 2025-07-07 - An expressive programming language and a versatile interactive shell.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,326 | 🐛 51 | 🌐 Go | 📅 2025-06-14 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [env](https://github.com/caarlos0/env) ⭐ 5,618 | 🐛 9 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,479 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [ini](https://github.com/go-ini/ini) ⭐ 3,510 | 🐛 64 | 🌐 Go | 📅 2024-05-01 - Go package to read and write INI files.
...
* [koanf](https://github.com/knadh/koanf) ⭐ 3,297 | 🐛 11 | 🌐 Go | 📅 2025-07-10 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [kong](https://github.com/alecthomas/kong) ⭐ 2,714 | 🐛 26 | 🌐 Go | 📅 2025-07-04 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,380 | 🐛 22 | 🌐 Go | 📅 2025-07-08 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,833 | 🐛 519 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
...
* [CDS](https://github.com/ovh/cds) ⭐ 4,729 | 🐛 149 | 🌐 Go | 📅 2025-07-08 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
* [drone](https://github.com/drone/drone) ⭐ 32,951 | 🐛 74 | 🌐 Go | 📅 2025-07-11 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [go-semver-release](https://github.com/s0ders/go-semver-release) ⭐ 17 | 🐛 5 | 🌐 Go | 📅 2025-07-07 - Automate the semantic versioning of Git repositories.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,567 | 🐛 25 | 🌐 Go | 📅 2025-07-10 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,823 | 🐛 88 | 🌐 Rust | 📅 2025-07-10.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,225 | 🐛 346 | 🌐 Go | 📅 2025-07-11 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,402 | 🐛 526 | 🌐 Go | 📅 2025-07-10 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,136 | 🐛 158 | 🌐 Go | 📅 2025-07-10 - A high-performance ELT data integration framework with pluggable architecture.
...
* [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,622 | 🐛 18 | 🌐 Go | 📅 2024-12-10 - Go package implementing Bloom filters.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 17,012 | 🐛 67 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [deque](https://github.com/gammazero/deque) ⭐ 690 | 🐛 5 | 🌐 Go | 📅 2025-07-10 - Fast ring-buffer deque (double-ended queue).
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,811 | 🐛 79 | 🌐 TypeScript | 📅 2025-07-10 - Distributed, Fault-tolerant task queue.
...
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,543 | 🐛 12 | 🌐 Go | 📅 2025-06-10 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,447 | 🐛 296 | 🌐 Go | 📅 2025-07-07 - Modern text indexing library for go.
...
* [BigCache](https://github.com/allegro/bigcache) ⭐ 7,874 | 🐛 99 | 🌐 Go | 📅 2025-05-05 - Efficient key/value cache for gigabytes of data.
...
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,206 | 🐛 42 | 🌐 Go | 📅 2024-11-29 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,171 | 🐛 1 | 🌐 Go | 📅 2025-07-10 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,206 | 🐛 5 | 🌐 Go | 📅 2025-07-10 -  A high performance memory-bound Go cache.
...
* [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,105 | 🐛 15 | 🌐 Go | 📅 2025-07-09 - An in-memory cache with item expiration and generics.
* [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2022-10-02 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

* [badger](https://github.com/dgraph-io/badger) ⭐ 14,747 | 🐛 28 | 🌐 Go | 📅 2025-07-10 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,903 | 🐛 43 | 🌐 Go | 📅 2025-07-10 - An embedded key/value database for Go.
...
* [clover](https://github.com/ostafen/clover) ⭐ 760 | 🐛 21 | 🌐 Go | 📅 2025-02-12 - A lightweight document-oriented NoSQL database written in pure Golang.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,067 | 🐛 7,358 | 🌐 Go | 📅 2025-07-11 - Scalable, Geo-Replicated, Transactional Datastore.
...
* [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,310 | 🐛 4 | 🌐 Go | 📅 2025-06-17 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,000 | 🐛 41 | 🌐 Go | 📅 2025-07-10 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,867 | 🐛 433 | 🌐 Go | 📅 2025-07-11 - Dolt – It's Git for Data.
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,282 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,853 | 🐛 363 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 8,776 | 🐛 135 | 🌐 Go | 📅 2025-05-30 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,303 | 🐛 2,118 | 🌐 Rust | 📅 2025-07-10 - Scalable datastore for metrics, events, and real-time analytics.
...
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,897 | 🐛 693 | 🌐 Go | 📅 2025-07-11 - Milvus is a vector database for embedding management, analytics and search.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,375 | 🐛 293 | 🌐 Go | 📅 2025-07-11 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,405 | 🐛 706 | 🌐 Go | 📅 2025-07-10 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,857 | 🐛 3 | 🌐 Go | 📅 2025-07-10 - Redis re-implemented with SQLite.
* [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,828 | 🐛 2 | 🌐 Go | 📅 2025-04-22 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,745 | 🐛 73 | 🌐 Go | 📅 2025-07-10 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,711 | 🐛 5,197 | 🌐 Go | 📅 2025-07-11 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,502 | 🐛 791 | 🌐 Go | 📅 2025-07-10 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 7,019 | 🐛 218 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,728 | 🐛 120 | 🌐 Go | 📅 2025-07-11 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,120 | 🐛 28 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,695 | 🐛 97 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,963 | 🐛 436 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,349 | 🐛 90 | 🌐 Go | 📅 2025-04-17 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
* [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,366 | 🐛 57 | 🌐 Go | 📅 2025-06-06 - HTTP proxy for ClickHouse database.
...
* [dbbench](https://github.com/sj14/dbbench) ⭐ 108 | 🐛 10 | 🌐 Go | 📅 2025-07-10 - Database benchmarking tool with support for several databases and scripts.
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,784 | 🐛 151 | 🌐 Go | 📅 2025-07-10 - Go toolset to handle MySQL protocol and replication.
* [gorm-multitenancy](https://github.com/bartventer/gorm-multitenancy) ⭐ 61 | 🐛 14 | 🌐 Go | 📅 2025-07-07 - Multi-tenancy support for GORM managed databases.
...
* [onedump](https://github.com/liweiyi88/onedump) ⭐ 199 | 🐛 0 | 🌐 Go | 📅 2025-07-02 - Database backup from different drivers to different destinations with one command and configuration.
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,192 | 🐛 1 | 🌐 Go | 📅 2025-06-30 - Advanced scheduling for PostgreSQL.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,944 | 🐛 35 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,830 | 🐛 886 | 🌐 Go | 📅 2025-07-10 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,264 | 🐛 42 | 🌐 Go | 📅 2025-07-03 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,475 | 🐛 614 | 🌐 Go | 📅 2025-07-09 - Generate type-safe code from SQL.
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,499 | 🐛 91 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
* [xo](https://github.com/knq/xo) ⭐ 3,835 | 🐛 53 | 🌐 Go | 📅 2025-06-23 - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
* [go-transaction-manager](https://github.com/avito-tech/go-transaction-manager) ⭐ 319 | 🐛 1 | 🌐 Go | 📅 2025-04-17 - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,923 | 🐛 62 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,568 | 🐛 203 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 737 | 🐛 5 | 🌐 Go | 📅 2025-07-10 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,123 | 🐛 234 | 🌐 Go | 📅 2025-06-26 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,123 | 🐛 234 | 🌐 Go | 📅 2025-06-26 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,441 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
* [pq](https://github.com/lib/pq) ⭐ 9,538 | 🐛 339 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 166 | 🐛 243 | 🌐 Go | 📅 2025-07-10 - native and database/sql driver YDB (Yandex Database)
...
* [Kivik](https://github.com/go-kivik/kivik) ⭐ 324 | 🐛 37 | 🌐 Go | 📅 2025-05-25 - Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases.
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,390 | 🐛 13 | 🌐 Go | 📅 2025-07-10 - Official MongoDB driver for the Go language.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,059 | 🐛 99 | 🌐 Go | 📅 2025-07-07 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,716 | 🐛 21 | 🌐 Go | 📅 2025-07-11 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
* [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,097 | 🐛 93 | 🌐 Go | 📅 2025-07-10 - ClickHouse SQL client for Go with a `database/sql` compatibility.
* [effdsl](https://github.com/sdqri/effdsl) ⭐ 32 | 🐛 3 | 🌐 Go | 📅 2025-06-29 - Elasticsearch query builder for Go.
* [elastic](https://github.com/olivere/elastic) ⭐ 7,474 | 🐛 115 | 🌐 Go | 📅 2024-08-08 - Elasticsearch client for Go.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,910 | 🐛 82 | 🌐 Go | 📅 2025-07-01 - Official Elasticsearch client for Go.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1,002 | 🐛 23 | 🌐 Go | 📅 2025-06-27 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,098 | 🐛 1 | 🌐 Go | 📅 2025-07-09 - A simple, semantic and developer-friendly time package for golang.
...
* [now](https://github.com/jinzhu/now) ⭐ 4,543 | 🐛 13 | 🌐 Go | 📅 2025-06-09 - Now is a time toolkit for golang.
...
* [consistent](https://github.com/buraksezer/consistent) ⭐ 738 | 🐛 6 | 🌐 Go | 📅 2023-11-07 - Consistent hashing with bounded loads.
...
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,199 | 🐛 52 | 🌐 Go | 📅 2024-07-12 - A feature complete and high performance multi-group Raft library in Go.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,661 | 🐛 29 | 🌐 Go | 📅 2025-07-11 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [emitter-io](https://github.com/emitter-io/emitter) ⭐ 3,947 | 🐛 15 | 🌐 Go | 📅 2025-03-13 - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
* [evans](https://github.com/ktr0731/evans) ⭐ 4,402 | 🐛 36 | 🌐 Go | 📅 2023-12-26 - Evans: more expressive universal gRPC client.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,152 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,384 | 🐛 19 | 🌐 Go | 📅 2025-07-08 - A distributed systems development framework.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,403 | 🐛 359 | 🌐 Go | 📅 2025-07-11 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 22,000 | 🐛 142 | 🌐 Go | 📅 2025-07-10 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,058 | 🐛 86 | 🌐 Go | 📅 2025-07-10 - A cloud native Kubernetes Global Balancer.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,526 | 🐛 54 | 🌐 Go | 📅 2025-07-10 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,578 | 🐛 122 | 🌐 Go | 📅 2025-06-01 - A modular-designed and easy-to-use microservices framework in Go.
...
* [lura](https://github.com/luraproject/lura) ⭐ 6,577 | 🐛 8 | 🌐 Go | 📅 2025-06-25 - Ultra performant API Gateway framework with middlewares.
...
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,467 | 🐛 462 | 🌐 Go | 📅 2025-07-10 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 619 | 🐛 54 | 🌐 Go | 📅 2025-07-10 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,682 | 🐛 44 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/etcd-io/raft) ⭐ 876 | 🐛 70 | 🌐 Go | 📅 2025-07-10 - Go implementation of the Raft consensus protocol, by CoreOS.
* [rain](https://github.com/cenkalti/rain) ⭐ 1,050 | 🐛 2 | 🌐 Go | 📅 2025-07-01 - BitTorrent client and library.
* [redis-lock](https://github.com/bsm/redislock) ⭐ 1,633 | 🐛 3 | 🌐 Go | 📅 2025-06-09 - Simplified distributed locking implementation using Redis.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,352 | 🐛 356 | 🌐 C++ | 📅 2025-06-26).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,143 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,810 | 🐛 63 | 🌐 Go | 📅 2025-07-10 - BitTorrent client package.
* [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 990 | 🐛 8 | 🌐 Go | 📅 2025-04-18 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
* [email](https://github.com/jordan-wright/email) ⭐ 2,739 | 🐛 55 | 🌐 Go | 📅 2024-02-21 - A robust and flexible email library for Go.
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,398 | 🐛 31 | 🌐 Go | 📅 2025-07-04 - A Go library for email verification without sending any emails.
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,033 | 🐛 4 | 🌐 Go | 📅 2025-07-10 - A simple Go library for sending mails in Go.
...
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,593 | 🐛 130 | 🌐 Go | 📅 2025-04-16 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,039 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,338 | 🐛 2 | 🌐 Go | 📅 2025-07-06 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,059 | 🐛 149 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [truemail-go](https://github.com/truemail-rb/truemail-go) ⭐ 120 | 🐛 1 | 🌐 Go | 📅 2024-08-30 - Configurable Golang email validator/verifier. Verify email via Regex, DNS, SMTP and even more.
...
* [anko](https://github.com/mattn/anko) ⭐ 1,523 | 🐛 25 | 🌐 Go | 📅 2025-04-03 - Scriptable interpreter written in Go.
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,647 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,609 | 🐛 50 | 🌐 Go | 📅 2025-07-08 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,989 | 🐛 46 | 🌐 Go | 📅 2025-07-05 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,637 | 🐛 179 | 🌐 Go | 📅 2025-07-09 - PHP embedded in Go, with a `net/http` handler.
...
* [goja](https://github.com/dop251/goja) ⭐ 6,271 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [golua](https://github.com/aarzilli/golua) ⭐ 673 | 🐛 9 | 🌐 C | 📅 2025-02-17 - Go bindings for Lua C API.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,647 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [gval](https://github.com/PaesslerAG/gval) ⭐ 793 | 🐛 24 | 🌐 Go | 📅 2024-11-28 - A highly customizable expression language written in Go.
* [metacall](https://github.com/metacall/core) ⭐ 1,665 | 🐛 51 | 🌐 C | 📅 2025-07-10 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
* [starlet](https://github.com/1set/starlet) ⭐ 30 | 🐛 2 | 🌐 Go | 📅 2025-04-15 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,497 | 🐛 63 | 🌐 Go | 📅 2025-07-01 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
* [tengo](https://github.com/d5/tengo) ⭐ 3,665 | 🐛 84 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,593 | 🐛 5 | 🌐 Go | 📅 2025-07-10 - The Wa Programming Language embedded in Go.
...
* [errors](https://github.com/cockroachdb/errors) ⭐ 2,248 | 🐛 18 | 🌐 Go | 📅 2025-05-16 - Go error library with error portability over the network.
...
* [afero](https://github.com/spf13/afero) ⭐ 6,266 | 🐛 153 | 🌐 Go | 📅 2025-07-10 - FileSystem Abstraction System for Go.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 98 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,906 | 🐛 293 | 🌐 Go | 📅 2025-07-06).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,604 | 🐛 51 | 🌐 Go | 📅 2025-07-09 - Disk usage analyzer with console interface.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,788 | 🐛 126 | 🌐 Go | 📅 2025-07-10 - PDF processor.
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 | 🐛 1 | 🌐 Go | 📅 2023-09-21 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,846 | 🐛 39 | 📅 2025-07-08.
...
* [ach](https://github.com/moov-io/ach) ⭐ 492 | 🐛 15 | 🌐 Go | 📅 2025-07-10 - A reader, writer, and validator for Automated Clearing House (ACH) files.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,380 | 🐛 134 | 🌐 Go | 📅 2025-07-10 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [ledger](https://github.com/formancehq/ledger) ⭐ 990 | 🐛 7 | 🌐 Go | 📅 2025-07-10 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,314 | 🐛 37 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
...
* [mo](https://github.com/samber/mo) ⭐ 3,019 | 🐛 23 | 🌐 Go | 📅 2025-07-06 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,219 | 🐛 300 | 🌐 Go | 📅 2025-07-10 - dead simple 2D game engine in Go.
...
* [g3n](https://github.com/g3n/engine) ⭐ 2,967 | 🐛 37 | 🌐 Go | 📅 2025-02-08 - Go 3D Game Engine.
...
* [Harfang3D](https://github.com/harfang3d/harfang3d) ⭐ 619 | 🐛 5 | 🌐 C++ | 📅 2023-09-08 - 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev](https://github.com/harfang3d/harfang-go) ⚠️ Archived).
...
* [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,573 | 🐛 58 | 🌐 Go | 📅 2025-07-10 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,098 | 🐛 4 | 🌐 C | 📅 2025-06-17 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
* [tile](https://github.com/kelindar/tile) ⭐ 197 | 🐛 2 | 🌐 Go | 📅 2025-06-28 - Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export.
...
* [goverter](https://github.com/jmattheis/goverter) ⭐ 718 | 🐛 17 | 🌐 Go | 📅 2025-07-06 - Generate converters by defining an interface.
...
* [jennifer](https://github.com/dave/jennifer) ⭐ 3,516 | 🐛 17 | 🌐 Go | 📅 2024-09-08 - Generate arbitrary Go code without templates.
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,305 | 🐛 693 | 🌐 Go | 📅 2025-07-09 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,373 | 🐛 151 | 🌐 Go | 📅 2025-06-17 - Geolocation DB with spatial index and realtime geofencing.
...
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,437 | 🐛 14 | 🌐 Go | 📅 2025-05-18 - Compile shell scripts to Go.
...
* [go2hx](https://github.com/go2hx/go2hx) ⭐ 136 | 🐛 32 | 🌐 Haxe | 📅 2025-07-07 - Compiler from Go to Haxe to Javascript/C++/Java/C#.
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,992 | 🐛 192 | 🌐 Go | 📅 2025-06-16 - Compiler from Go to JavaScript.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,814 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,989 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [go-actor](https://github.com/vladopajic/go-actor) ⭐ 231 | 🐛 0 | 🌐 Go | 📅 2025-06-05 - A tiny library for writing concurrent programs using actor model.
...
* [pond](https://github.com/alitto/pond) ⭐ 1,887 | 🐛 3 | 🌐 Go | 📅 2025-06-20 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,398 | 🐛 20 | 🌐 Go | 📅 2025-02-13 - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,724 | 🐛 42 | 🌐 Go | 📅 2025-07-08 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 423 | 🐛 19 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,774 | 🐛 1,158 | 🌐 C++ | 📅 2025-07-10 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,683 | 🐛 17 | 🌐 Lua | 📅 2025-07-01.
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,035 | 🐛 226 | 🌐 Go | 📅 2025-07-10 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
* [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,275 | 🐛 38 | 🌐 Go | 📅 2025-03-08 - Build native macOS applications using Go.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,729 | 🐛 747 | 🌐 Go | 📅 2025-07-07 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [gotk3](https://github.com/gotk3/gotk3) ⭐ 2,173 | 🐛 122 | 🌐 Go | 📅 2024-08-08 - Go bindings for GTK3.
...
* [qt](https://github.com/therecipe/qt) ⭐ 10,692 | 🐛 373 | 🌐 Go | 📅 2024-03-04 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
* [webview](https://github.com/zserge/webview) ⭐ 13,223 | 🐛 190 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,252 | 🐛 136 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
* [systray](https://github.com/getlantern/systray) ⭐ 3,506 | 🐛 109 | 🌐 Go | 📅 2024-07-03 - Cross platform Go library to place an icon and menu in the notification area.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,599 | 🐛 221 | 🌐 Go | 📅 2025-07-10 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,119 | 🐛 20 | 🌐 Go | 📅 2024-09-24 - Collection of image processing algorithms in pure Go.
...
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,594 | 🐛 20 | 🌐 Go | 📅 2025-05-08 - Vector graphics to PDF, SVG or rasterized image.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 730 | 🐛 6 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,140 | 🐛 344 | 🌐 Go | 📅 2025-07-08 - Go package for computer vision using OpenCV 3.3+.
...
* [govips](https://github.com/davidbyttow/govips) ⭐ 1,460 | 🐛 31 | 🌐 Go | 📅 2025-07-07 - A lightning fast image processing and resizing library for Go.
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,839 | 🐛 32 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
...
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,521 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
* [imagor](https://github.com/cshum/imagor) ⭐ 3,681 | 🐛 39 | 🌐 Go | 📅 2025-06-30 - Fast, secure image processing server and Go library, using libvips.
...
* [smartcrop](https://github.com/muesli/smartcrop) ⭐ 1,837 | 🐛 9 | 🌐 Go | 📅 2023-07-06 - Finds good crops for arbitrary images and crop sizes.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,611 | 🐛 63 | 🌐 Go | 📅 2025-07-11 - Lightweight data stream processing engine for IoT edge.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,214 | 🐛 103 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,195 | 🐛 8 | 🌐 Go | 📅 2025-07-10 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
* [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 | 🐛 39 | 🌐 Go | 📅 2019-11-04 - Lightweight stream processing engine for IoT.
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,354 | 🐛 30 | 🌐 Go | 📅 2025-07-10 - Kubernetes native IoT development framework.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,357 | 🐛 17 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,034 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [jsondiff](https://github.com/wI2L/jsondiff) ⭐ 588 | 🐛 0 | 🌐 Go | 📅 2025-05-09 - JSON diff library for Go based on RFC6902 (JSON Patch).
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 594 | 🐛 1 | 🌐 Go | 📅 2025-05-29 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,362 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,362 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,362 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,362 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,152 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,331 | 🐛 165 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,586 | 🐛 140 | 🌐 Go | 📅 2025-04-18, etc).
...
* [slf4g](https://github.com/echocat/slf4g) ⭐ 4 | 🐛 1 | 🌐 Go | 📅 2025-07-10 - Simple Logging Facade for Golang: Simple structured logging; but powerful, extendable and customizable, with huge amount of learnings from decades of past logging frameworks.
...
* [tint](https://github.com/lmittmann/tint) ⭐ 1,044 | 🐛 0 | 🌐 Go | 📅 2025-06-07 - A slog.Handler that writes tinted logs.
...
* [zap](https://github.com/uber-go/zap) ⭐ 23,331 | 🐛 165 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,586 | 🐛 140 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,802 | 🐛 111 | 🌐 Go | 📅 2024-08-12 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 430 | 🐛 7 | 🌐 Go | 📅 2025-07-09 - Huggingface transformer pipelines for golang with onnxruntime.
* [libsvm](https://github.com/datastream/libsvm) ⭐ 73 | 🐛 1 | 🌐 Go | 📅 2016-05-09 - libsvm golang version derived work based on LIBSVM 3.14.
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,891 | 🐛 60 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,807 | 🐛 18 | 🌐 Go | 📅 2025-07-08 - Go RabbitMQ Client Library.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,555 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,093 | 🐛 21 | 🌐 Go | 📅 2025-07-10 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,938 | 🐛 283 | 🌐 HTML | 📅 2025-07-10 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,888 | 🐛 27 | 🌐 Go | 📅 2024-06-19 - The lightweight event bus with async compatibility.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,425 | 🐛 58 | 🌐 Go | 📅 2025-07-05 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,095 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,778 | 🐛 244 | 🌐 Go | 📅 2025-06-30 - Asynchronous task queue/job queue based on distributed message passing.
...
* [melody](https://github.com/olahol/melody) ⭐ 3,946 | 🐛 13 | 🌐 Go | 📅 2025-06-08 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
* [Mercure](https://github.com/dunglas/mercure) ⭐ 4,984 | 🐛 26 | 🌐 Go | 📅 2025-06-27 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,011 | 🐛 170 | 🌐 Go | 📅 2025-07-09 - Go client for the NATS
  messaging system.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,085 | 🐛 65 | 🌐 Go | 📅 2025-07-10 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,634 | 🐛 123 | 🌐 Go | 📅 2025-07-03 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [excelize](https://github.com/xuri/excelize) ⭐ 19,357 | 🐛 126 | 🌐 Go | 📅 2025-07-10 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,984 | 🐛 9 | 🌐 Go | 📅 2025-04-18 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
* [fx](https://github.com/uber-go/fx) ⭐ 6,646 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
...
* [google/wire](https://github.com/google/wire) ⭐ 13,934 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,820 | 🐛 0 | 🌐 Go | 📅 2025-07-07 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,820 | 🐛 0 | 🌐 Go | 📅 2025-07-07 for building production grade scalable web service applications.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,803 | 🐛 30 | 🌐 Go | 📅 2025-07-10 - Allows users to spin up a quick Go project using a popular framework.
...
* [goapp](https://github.com/naughtygopher/goapp) ⭐ 983 | 🐛 1 | 🌐 Go | 📅 2025-07-06 - An opinionated guideline to structure & develop a Go web application/service.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,041 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,041 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
...
* [goxygen](https://github.com/shpota/goxygen) ⭐ 3,589 | 🐛 15 | 🌐 Go | 📅 2024-12-18 - Generate a modern Web project with Go and Angular, React, or Vue in seconds.
...
* [xstrings](https://github.com/huandu/xstrings) ⭐ 1,408 | 🐛 0 | 🌐 Go | 📅 2024-06-06 - Collection of useful string functions ported from other languages.
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,262 | 🐛 6 | 🌐 Go | 📅 2025-06-25 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,668 | 🐛 222 | 🌐 Go | 📅 2025-07-10 - Automated service health dashboard.
...
* [go-resiliency](https://github.com/eapache/go-resiliency) ⭐ 2,299 | 🐛 2 | 🌐 Go | 📅 2025-02-23 - Resiliency patterns for golang.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,298 | 🐛 213 | 🌐 Go | 📅 2025-07-10 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [slug](https://github.com/gosimple/slug) ⭐ 1,261 | 🐛 10 | 🌐 Go | 📅 2024-12-23 - URL-friendly slugify with multiple languages support.
* [Slugify](https://github.com/avelino/slugify) ⭐ 34 | 🐛 0 | 🌐 Go | 📅 2018-05-01 - Go slugify application that handles string.

### Tokenizers

* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,540 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,235 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,288 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Package and an accompanying tool to work with localized text.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 74 | 🐛 0 | 🌐 Go | 📅 2025-07-10 - Package bart provides a fast routing table algorithm.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,998 | 🐛 443 | 🌐 Go | 📅 2025-07-07 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [dns](https://github.com/miekg/dns) ⭐ 8,418 | 🐛 8 | 🌐 Go | 📅 2025-07-09 - Go library for working with DNS.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,725 | 🐛 109 | 🌐 Go | 📅 2025-07-10 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [fortio](https://github.com/fortio/fortio) ⭐ 3,554 | 🐛 81 | 🌐 Go | 📅 2025-07-09 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,639 | 🐛 1 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,825 | 🐛 223 | 🌐 Go | 📅 2025-07-10 - BGP implemented in the Go Programming Language.
* [gopacket](https://github.com/google/gopacket) ⭐ 6,564 | 🐛 360 | 🌐 Go | 📅 2025-03-19 - Go library for packet processing with libpcap bindings.
...
* [gws](https://github.com/lxzan/gws) ⭐ 1,566 | 🐛 1 | 🌐 Go | 📅 2025-05-13 - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,176 | 🐛 130 | 🌐 Go | 📅 2025-07-01 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,353 | 🐛 26 | 🌐 Go | 📅 2025-06-17 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,123 | 🐛 1 | 🌐 Go | 📅 2025-07-08 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,809 | 🐛 189 | 🌐 Go | 📅 2025-07-07 - An implementation of the QUIC protocol in pure Go.
...
* [sdns](https://github.com/semihalev/sdns) ⭐ 999 | 🐛 2 | 🌐 Go | 📅 2025-07-10 - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
* [sftp](https://github.com/pkg/sftp) ⭐ 1,588 | 🐛 48 | 🌐 Go | 📅 2025-06-02 - Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,980 | 🐛 15 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,038 | 🐛 100 | 🌐 Go | 📅 2025-07-10 - A pure Go implementation of the WebRTC API.
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,157 | 🐛 73 | 🌐 Go | 📅 2025-07-07 - Retryable HTTP client in Go.
...
* [heimdall](https://github.com/gojektech/heimdall) ⭐ 2,681 | 🐛 50 | 🌐 Go | 📅 2024-05-29 - An enhanced http client with retry and hystrix capabilities.
...
* [requests](https://github.com/carlmjohnson/requests) ⭐ 1,620 | 🐛 2 | 🌐 Go | 📅 2025-04-16 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
* [resty](https://github.com/go-resty/resty) ⭐ 11,037 | 🐛 36 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,355 | 🐛 19 | 🌐 Go | 📅 2025-07-09 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,241 | 🐛 25 | 🌐 Go | 📅 2025-07-10 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,343 | 🐛 587 | 🌐 Go | 📅 2025-07-10 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,568 | 🐛 6 | 🌐 Go | 📅 2025-07-06 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,487 | 🐛 467 | 🌐 Go | 📅 2025-07-07 - The fantastic ORM library for Golang, aims to be developer friendly.
* [gormt](https://github.com/xxjwxc/gormt) ⭐ 2,405 | 🐛 57 | 🌐 Go | 📅 2025-06-24 - Mysql database to golang gorm struct.
...
* [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,305 | 🐛 115 | 🌐 Go | 📅 2025-07-09 - Prisma Client Go, Typesafe database access for Go.
...
* [upper.io/db](https://github.com/upper/db) ⭐ 3,602 | 🐛 159 | 🌐 Go | 📅 2025-03-21 - Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,320 | 🐛 473 | 🌐 Go | 📅 2025-07-10 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,568 | 🐛 323 | 🌐 Go | 📅 2025-07-11 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 171 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,081 | 🐛 332 | 🌐 C++ | 📅 2025-07-09 - No instrumentation tracing for Golang applications via eBPF.
* [profile](https://github.com/pkg/profile) ⭐ 2,033 | 🐛 11 | 🌐 Go | 📅 2022-10-20 - Simple profiling support package for Go.
* [statsviz](https://github.com/arl/statsviz) ⭐ 3,313 | 🐛 11 | 🌐 Go | 📅 2025-06-17 - Live visualization of your Go application runtime statistics.
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,495 | 🐛 47 | 🌐 Go | 📅 2025-07-10 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [acmetool](https://github.com/hlandau/acme) ⭐ 2,079 | 🐛 72 | 🌐 Go | 📅 2023-05-27 - ACME (Let's Encrypt) client tool with automatic renewal.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,199 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,264 | 🐛 2 | 🌐 Go | 📅 2025-07-11 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [booster](https://github.com/anatol/booster) ⭐ 577 | 🐛 73 | 🌐 Go | 📅 2025-03-15 - Fast initramfs generator with full-disk encryption support.
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,463 | 🐛 29 | 🌐 Go | 📅 2025-07-08 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,749 | 🐛 93 | 🌐 Go | 📅 2025-07-11 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,718 | 🐛 160 | 🌐 Go | 📅 2025-07-10 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
* [luks.go](https://github.com/anatol/luks.go) ⭐ 90 | 🐛 3 | 🌐 Go | 📅 2025-03-16 - Pure Golang library to manage LUKS partitions.
* [memguard](https://github.com/awnumar/memguard) ⭐ 2,643 | 🐛 8 | 🌐 Go | 📅 2024-04-26 - A pure Go library for handling sensitive values in memory.
...
* [passwap](https://github.com/zitadel/passwap) ⭐ 66 | 🐛 2 | 🌐 Go | 📅 2025-07-10 - Provides a unified implementation between different password hashing algorithms
...
* [secure](https://github.com/unrolled/secure) ⭐ 2,313 | 🐛 0 | 🌐 Go | 📅 2024-10-22 - HTTP middleware for Go that facilitates some quick security wins.
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 895 | 🐛 23 | 🌐 Go | 📅 2025-07-05 - Small, safe, and easy CBOR encoding and decoding library.
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,417 | 🐛 221 | 🌐 Go | 📅 2025-07-09 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,806 | 🐛 322 | 🌐 Go | 📅 2025-07-10 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,599 | 🐛 50 | 🌐 Go | 📅 2025-07-09 - Fider is an open platform to collect and organize customer feedback.
...
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,458 | 🐛 45 | 🌐 Go | 📅 2025-07-08 - A self contained feature flag solution written in Go and Vue.js
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,687 | 🐛 22 | 🌐 Go | 📅 2025-07-10 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [minio](https://github.com/minio/minio) ⭐ 53,720 | 🐛 53 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 48,909 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,183 | 🐛 81 | 🌐 Go | 📅 2025-07-07 - High-performance PHP application server, load-balancer and process manager.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,675 | 🐛 111 | 🌐 Go | 📅 2025-07-03 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,199 | 🐛 14 | 🌐 Go | 📅 2025-06-23 - Make SSH apps, just like that!
...
* [go-etl](https://github.com/Breeze0806/go-etl) ⭐ 149 | 🐛 1 | 🌐 Go | 📅 2025-07-03 - A lightweight toolkit for data source extraction, transformation, and loading (ETL).
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,059 | 🐛 4 | 🌐 Go | 📅 2025-05-11 - Go stream processing library.
...
* [jet](https://github.com/CloudyKit/jet) ⭐ 1,341 | 🐛 21 | 🌐 Go | 📅 2025-03-23 - Jet template engine.
* [liquid](https://github.com/osteele/liquid) ⭐ 309 | 🐛 30 | 🌐 Go | 📅 2025-06-01 - Go implementation of Shopify Liquid templates.
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,484 | 🐛 53 | 🌐 Go | 📅 2025-03-21 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
* [Razor](https://github.com/sipin/gorazor) ⭐ 871 | 🐛 2 | 🌐 Go | 📅 2025-03-28 - Razor view engine for Golang.
...
* [sprout](https://github.com/go-sprout/sprout) ⭐ 173 | 🐛 4 | 🌐 Go | 📅 2025-06-30 - Useful template functions for Go templates.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,462 | 🐛 70 | 🌐 Go | 📅 2025-07-09 - A HTML templating language that has great developer tooling.
...
* [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 976 | 🐛 7 | 🌐 Go | 📅 2025-06-02 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-07-10 - HTTP client testing framework.
...
* [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,445 | 🐛 27 | 🌐 Go | 📅 2025-07-10 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
* [go-carpet](https://github.com/msoap/go-carpet) ⭐ 248 | 🐛 3 | 🌐 Go | 📅 2024-09-30 - Tool for viewing test coverage in terminal.
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,460 | 🐛 47 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
...
* [go-snaps](http://github.com/gkampitakis/go-snaps) ⭐ 220 | 🐛 7 | 🌐 Go | 📅 2025-06-04 - Jest-like snapshot testing in Golang.
...
* [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,311 | 🐛 3 | 🌐 Go | 📅 2025-07-03 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
* [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,364 | 🐛 167 | 🌐 Go | 📅 2024-07-30 - BDD-style framework with web UI and live reload.
* [gocrest](https://github.com/corbym/gocrest) ⭐ 106 | 🐛 2 | 🌐 Go | 📅 2024-09-06 - Composable hamcrest-like matchers for Go assertions.
* [godog](https://github.com/cucumber/godog) ⭐ 2,459 | 🐛 83 | 🌐 Go | 📅 2025-07-07 - Cucumber BDD framework for Go.
...
* [httpexpect](https://github.com/gavv/httpexpect) ⭐ 2,653 | 🐛 16 | 🌐 Go | 📅 2025-06-02 - Concise, declarative, and easy to use end-to-end HTTP and REST API testing.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,284 | 🐛 238 | 🌐 Go | 📅 2025-07-09 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcase](https://github.com/adamluzsi/testcase) ⭐ 123 | 🐛 0 | 🌐 Go | 📅 2025-07-08 - Idiomatic testing framework for Behavior Driven Development.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,184 | 🐛 140 | 🌐 Go | 📅 2025-07-09 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 24,878 | 🐛 371 | 🌐 Go | 📅 2025-07-01 - Sacred extension to the standard go testing package.
...
* [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,392 | 🐛 41 | 🌐 Go | 📅 2024-09-11 - Mock SQL driver for testing database interactions.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,906 | 🐛 95 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,039 | 🐛 5 | 🌐 Go | 📅 2025-04-05 - Easy mocking of HTTP responses from external resources.
* [minimock](https://github.com/gojuno/minimock) ⭐ 705 | 🐛 9 | 🌐 Go | 📅 2025-06-10 - Mock generator for Go interfaces.
* [mockery](https://github.com/vektra/mockery) ⭐ 6,688 | 🐛 41 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [moq](https://github.com/matryer/moq) ⭐ 2,107 | 🐛 27 | 🌐 Go | 📅 2025-02-13 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 495 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,123 | 🐛 234 | 🌐 Go | 📅 2025-06-26.
* [timex](https://github.com/cabify/timex) ⭐ 71 | 🐛 1 | 🌐 Go | 📅 2020-08-03 - A test-friendly replacement for the native `time` package.
* [xgo](https://github.com/xhd2015/xgo) ⭐ 413 | 🐛 59 | 🌐 Go | 📅 2025-07-01 - A general pureposed function mocking library.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,007 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,780 | 🐛 54 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
* [rod](https://github.com/go-rod/rod) ⭐ 6,066 | 🐛 185 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,178 | 🐛 8 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,753 | 🐛 18 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,849 | 🐛 101 | 🌐 Go | 📅 2025-07-07 - Shell parser and formatter.
...
* [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,438 | 🐛 26 | 🌐 Go | 📅 2025-04-04 - HTML Sanitizer.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,585 | 🐛 3 | 🌐 Go | 📅 2025-06-07 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,148 | 🐛 82 | 🌐 Go | 📅 2025-07-09 - The official AWS SDK for the Go programming language.
...
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,462 | 🐛 187 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
...
* [go-jira](https://github.com/andygrunwald/go-jira) ⭐ 1,543 | 🐛 182 | 🌐 Go | 📅 2025-07-06 - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,148 | 🐛 211 | 🌐 Go | 📅 2025-07-10 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,284 | 🐛 18 | 🌐 Go | 📅 2025-07-10 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,286 | 🐛 384 | 🌐 Go | 📅 2025-07-10 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,736 | 🐛 21 | 🌐 Go | 📅 2025-07-10 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 739 | 🐛 2 | 🌐 Go | 📅 2025-06-30 - Wrapper for PayPal payment API.
...
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,346 | 🐛 9 | 🌐 Go | 📅 2025-07-10 - Go client for the Stripe API.
...
* [changie](https://github.com/miniscruff/changie) ⭐ 777 | 🐛 4 | 🌐 Go | 📅 2025-07-03 - Automated changelog tool for preparing releases with lots of customization options.
...
* [clipboard](https://github.com/golang-design/clipboard) ⭐ 701 | 🐛 24 | 🌐 Go | 📅 2025-06-14 - 📋 cross-platform clipboard package in Go.
...
* [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,707 | 🐛 7 | 🌐 Go | 📅 2025-06-09 - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,367 | 🐛 169 | 🌐 Go | 📅 2025-07-07 - A tool for exploring each layer in a Docker image.
...
* [filetype](https://github.com/h2non/filetype) ⭐ 2,208 | 🐛 47 | 🌐 Go | 📅 2025-06-27 - Small package to infer the file type checking the magic numbers signature.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 71,907 | 🐛 293 | 🌐 Go | 📅 2025-07-06 - Command-line fuzzy finder written in Go.
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,857 | 🐛 25 | 🌐 Go | 📅 2025-07-11 - Deliver Go binaries as fast and easily as possible.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,109 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - A comprehensive, efficient, and reusable util function library of go.
...
* [lo](https://github.com/samber/lo) ⭐ 19,728 | 🐛 206 | 🌐 Go | 📅 2025-07-07 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [mc](https://github.com/minio/mc) ⭐ 3,088 | 🐛 41 | 🌐 Go | 📅 2025-07-02 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
* [mergo](https://github.com/imdario/mergo) ⭐ 3,019 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,826 | 🐛 42 | 🌐 Go | 📅 2025-07-07 - Package for MIME type detection based on magic numbers.
...
* [peco](https://github.com/peco/peco) ⭐ 7,767 | 🐛 52 | 🌐 Go | 📅 2025-06-21 - Simplistic interactive filtering tool.
...
* [retry-go](https://github.com/avast/retry-go) ⭐ 2,723 | 🐛 14 | 🌐 Go | 📅 2025-03-21 - Simple library for retry mechanism.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,137 | 🐛 54 | 🌐 Go | 📅 2025-07-10 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,036 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
...
* [toolbox](https://github.com/viant/toolbox) ⭐ 222 | 🐛 5 | 🌐 Go | 📅 2024-12-10 - Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer.
* [UNIS](https://github.com/esemplastic/unis) ⭐ 70 | 🐛 2 | 🌐 Go | 📅 2017-05-09 - Common Architecture™ for String Utilities in Go.
* [upterm](https://github.com/owenthereal/upterm) ⭐ 936 | 🐛 51 | 🌐 Go | 📅 2025-07-07 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
* [usql](https://github.com/knq/usql) ⭐ 9,421 | 🐛 95 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
...
* [yogo](https://github.com/antham/yogo) ⭐ 45 | 🐛 0 | 🌐 HTML | 📅 2025-07-10 - Check yopmail mails from command line.
...
* [guid](https://github.com/sdrapkin/guid) ⭐ 59 | 🐛 1 | 🌐 Go | 📅 2025-07-10 - Fast cryptographically safe Guid generator for Go (\~10x faster than `uuid`).
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,757 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [uuid](https://github.com/google/uuid) ⭐ 5,725 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [xid](https://github.com/rs/xid) ⭐ 4,151 | 🐛 17 | 🌐 Go | 📅 2025-05-12 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
* [govalid](https://github.com/twharmon/govalid) ⭐ 97 | 🐛 0 | 🌐 Go | 📅 2025-05-20 - Fast, tag-based validation for structs.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,631 | 🐛 323 | 🌐 Go | 📅 2025-07-02 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 900 | 🐛 7 | 🌐 Go | 📅 2025-07-03 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,958 | 🐛 516 | 🌐 TypeScript | 📅 2025-07-10 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,706 | 🐛 162 | 🌐 Go | 📅 2025-07-10 - highly extensible Git implementation in pure Go.
...
* [goav](https://github.com/giorgisio/goav) ⭐ 2,121 | 🐛 48 | 🌐 Go | 📅 2022-05-19 - Comprehensive Go bindings for FFmpeg.
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 804 | 🐛 20 | 🌐 Go | 📅 2025-07-10 - Pure Go RTSP server and client library.
...
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 531 | 🐛 1 | 🌐 Go | 📅 2025-07-06 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
...
* [Beego](https://github.com/beego/beego) ⭐ 32,140 | 🐛 18 | 🌐 Go | 📅 2025-07-10 - beego is an open-source, high-performance web framework for the Go programming language.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,247 | 🐛 106 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 481 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,088 | 🐛 104 | 🌐 Go | 📅 2025-07-11 - An Express.js inspired web framework build on Fasthttp.
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,065 | 🐛 862 | 🌐 Go | 📅 2025-07-08 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 12,008 | 🐛 78 | 🌐 Go | 📅 2025-07-09 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,514 | 🐛 210 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,905 | 🐛 55 | 🌐 Go | 📅 2025-07-07 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
* [Goyave](https://github.com/go-goyave/goyave) ⭐ 1,714 | 🐛 15 | 🌐 Go | 📅 2025-07-03 - Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities.
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,369 | 🐛 46 | 🌐 Go | 📅 2025-07-10 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [templui](https://github.com/axzilla/templui) ⭐ 761 | 🐛 11 | 🌐 JavaScript | 📅 2025-07-10 - Modern UI Components for Go & Templ.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,100 | 🐛 84 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,917 | 🐛 82 | 🌐 Go | 📅 2024-07-22 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,468 | 🐛 34 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,452 | 🐛 504 | 🌐 Go | 📅 2025-07-10 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,031 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,384 | 🐛 111 | 🌐 Go | 📅 2025-07-11 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,047 | 🐛 261 | 🌐 Go | 📅 2025-07-09 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,431 | 🐛 245 | 🌐 Go | 📅 2025-07-10 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 108 | 🐛 20 | 🌐 Go | 📅 2025-07-09 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [goast-viewer](https://github.com/yuroyoro/goast-viewer) ⭐ 783 | 🐛 2 | 🌐 JavaScript | 📅 2023-11-30 - Web based Golang AST visualizer.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,290 | 🐛 120 | 🌐 Go | 📅 2025-07-10 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
* [golines](https://github.com/segmentio/golines) ⭐ 1,080 | 🐛 72 | 🌐 Go | 📅 2025-04-14 - Formatter that automatically shortens long lines in Go code.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,226 | 🐛 49 | 🌐 Go | 📅 2025-07-10 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 143 | 🐛 35 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,878 | 🐛 371 | 🌐 Go | 📅 2025-07-01.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 794 | 🐛 73 | 🌐 Go | 📅 2025-07-09 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,754 | 🐛 96 | 🌐 Go | 📅 2025-07-10 features to Vim/Neovim.
...
* [vim-go](https://github.com/fatih/vim-go) ⭐ 16,143 | 🐛 40 | 🌐 Vim Script | 📅 2025-06-21 - Go development plugin for Vim.
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,310 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,801 | 🐛 608 | 🌐 Go | 📅 2025-06-27 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [gotestdox](https://github.com/bitfield/gotestdox) ⭐ 144 | 🐛 3 | 🌐 Go | 📅 2024-06-08 - Show Go test results as readable sentences.
...
* [gotutor](https://github.com/ahmedakef/gotutor) ⭐ 52 | 🐛 0 | 🌐 Elm | 📅 2025-07-08 - Online Go Debugger & Visualizer.
...
* [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,672 | 🐛 203 | 🌐 Go | 📅 2025-06-21 - aptly is a Debian repository management tool.
...
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,218 | 🐛 2,575 | 🌐 Go | 📅 2025-07-11 - Lightweight, programmable telemetry for servers and workstations.
...
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,520 | 🐛 2,713 | 🌐 Go | 📅 2025-07-11 - Fork of Gogs, entirely community driven.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,059 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,045 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,902 | 🐛 246 | 🌐 Go | 📅 2025-07-08 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,177 | 🐛 135 | 🌐 Go | 📅 2025-07-10 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,228 | 🐛 805 | 🌐 Go | 📅 2025-07-10 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,297 | 🐛 210 | 🌐 Go | 📅 2025-07-10 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,762 | 🐛 149 | 🌐 Go | 📅 2025-07-10 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,259 | 🐛 2,612 | 🌐 Go | 📅 2025-07-11 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,421 | 🐛 142 | 🌐 Go | 📅 2025-07-09 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
...
* [kwatch](https://github.com/abahmed/kwatch) ⭐ 982 | 🐛 25 | 🌐 Go | 📅 2025-07-07 - Monitor & detect crashes in your Kubernetes(K8s) cluster instantly.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,672 | 🐛 525 | 🌐 Go | 📅 2025-07-10 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,070 | 🐛 3,619 | 🌐 Go | 📅 2025-07-10 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,408 | 🐛 303 | 🌐 Go | 📅 2025-07-11 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 436 | 🐛 1 | 🌐 Go | 📅 2024-06-19 - Flexible HTTP command line stress tester.
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,187 | 🐛 103 | 🌐 Go | 📅 2025-07-10 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,647 | 🐛 29 | 🌐 Go | 📅 2025-06-27 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,334 | 🐛 132 | 🌐 Go | 📅 2025-07-11 - Pomerium is an identity-aware access proxy.
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 368 | 🐛 22 | 🌐 Go | 📅 2025-07-08 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,401 | 🐛 141 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 925 | 🐛 201 | 🌐 Go | 📅 2025-07-10 - Manage BareMetal Servers from Command Line (as easily as with Docker).
* [script](https://github.com/bitfield/script) ⭐ 6,771 | 🐛 42 | 🌐 Go | 📅 2025-03-22 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
* [tau](https://github.com/taubyte/tau) ⭐ 4,050 | 🐛 30 | 🌐 Go | 📅 2025-06-23 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
* [traefik](https://github.com/containous/traefik) ⭐ 55,494 | 🐛 649 | 🌐 Go | 📅 2025-07-10 - Reverse proxy and load balancer with support for multiple backends.
...
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,367 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,448 | 🐛 68 | 🌐 Go | 📅 2025-07-10 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 587 | 🐛 10 | 🌐 Go | 📅 2025-07-10 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [confd](https://github.com/kelseyhightower/confd) ⭐ 8,402 | 🐛 179 | 🌐 Go | 📅 2024-07-16 - Manage local application configuration files using templates and data from etcd or consul.
* [crawley](https://github.com/s0rg/crawley) ⭐ 303 | 🐛 3 | 🌐 Go | 📅 2025-06-18 - Web scraper/crawler for cli.
* [croc](https://github.com/schollz/croc) ⭐ 30,539 | 🐛 14 | 🌐 Go | 📅 2025-07-10 - Easily and securely send files or folders from one computer to another.
* [Documize](https://github.com/documize/community) ⭐ 2,268 | 🐛 46 | 🌐 JavaScript | 📅 2024-12-31 - Modern wiki software that integrates data from SaaS tools.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,015 | 🐛 18 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,865 | 🐛 131 | 🌐 Go | 📅 2025-07-11 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [restic](https://github.com/restic/restic) ⭐ 29,264 | 🐛 473 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 702 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,464 | 🐛 53 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,138 | 🐛 594 | 🌐 Go | 📅 2025-07-10 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,416 | 🐛 5 | 🌐 Go | 📅 2025-06-18 - Executing shell commands via http server (for prototyping or remote control).
...
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,347 | 🐛 91 | 🌐 Go | 📅 2025-07-07 - Proxy to simulate network and system conditions for automated tests.
...
* [go\_serialization\_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) ⭐ 1,595 | 🐛 6 | 🌐 Go | 📅 2025-07-04 - Benchmarks of Go serialization methods.
...
* [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 432 | 🐛 0 | 🌐 Go | 📅 2025-03-14 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,205 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [gophers](https://github.com/egonelbre/gophers) ⭐ 3,684 | 🐛 5 | 🌐 Go | 📅 2022-07-06 - Free gophers.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,067 | 🐛 7,358 | 🌐 Go | 📅 2025-07-11
* [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
* [Google](https://google.github.io/styleguide/go/)
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,190 | 🐛 182 | 🌐 Go | 📅 2025-06-30
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,636 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,665 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,699 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,821 | 🐛 9,387 | 🌐 Go | 📅 2025-07-11 - List of projects on the Go community wiki.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,683 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,934 | 🐛 7 | 🌐 Go | 📅 2025-07-08 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,659 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,737 | 🐛 1 | 🌐 Go | 📅 2023-02-02 - Examples of Golang compared to Node.js for learning.
...
* [golang-examples](https://github.com/SimonWaldherr/golang-examples) ⭐ 1,631 | 🐛 6 | 🌐 Go | 📅 2025-04-19 - Many examples to learn Golang.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,384 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,959 | 🐛 66 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
...
* [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) ⭐ 234 | 🐛 5 | 🌐 Go | 📅 2025-07-11 - A GitHub repository offering coding challenges for Go technical interview preparation.
