...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 150,895 | 🐛 147 | 🌐 Go | 📅 2025-08-21
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 395,225 | 🐛 55 | 📅 2025-07-18
[![Slack Widget](https://img.shields.io/badge/join-us%20on%20slack-gray.svg?longCache=true\&logo=slack\&colorB=red)](https://gophers.slack.com/messages/awesome)
[![Netlify Status](https://api.netlify.com/api/v1/badges/83a6dcbe-0da6-433e-b586-f68109286bd5/deploy-status)](https://app.netlify.com/sites/awesome-go/deploys)
[![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/avelino/awesome-go/)
[![Last Commit](https://img.shields.io/github/last-commit/avelino/awesome-go)](https://github.com/avelino/awesome-go/commits/main) ⭐ 150,895 | 🐛 147 | 🌐 Go | 📅 2025-08-21
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 256,876 | 🐛 488 | 🌐 Python | 📅 2025-07-17.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 150,895 | 🐛 147 | 🌐 Go | 📅 2025-08-21 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 150,895 | 🐛 147 | 🌐 Go | 📅 2025-08-21; you rock!
...
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,304 | 🐛 57 | 🌐 Go | 📅 2025-08-25 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
...
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 276 | 🐛 4 | 🌐 Go | 📅 2025-08-27 - Fast and Distributed Actor framework using protocol buffers as message for Golang.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [Ollama](https://github.com/jmorganca/ollama) ⭐ 150,987 | 🐛 2,149 | 🌐 Go | 📅 2025-08-26 - Run large language models locally.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 34,862 | 🐛 394 | 🌐 Go | 📅 2025-08-26 - Open Source OpenAI alternative, self-host AI models.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,462 | 🐛 364 | 🌐 Go | 📅 2025-08-25 - LangChainGo is a framework for developing applications powered by language models.
* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 691 | 🐛 12 | 🌐 Go | 📅 2025-08-02 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 19,058 | 🐛 31 | 🌐 Go | 📅 2025-08-14 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,418 | 🐛 44 | 🌐 Go | 📅 2025-08-25 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 5,978 | 🐛 113 | 🌐 Go | 📅 2025-08-26 - A Zanzibar-inspired database that enables fine-grained authorization.
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,681 | 🐛 43 | 🌐 Go | 📅 2025-08-13 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
* [keto](https://github.com/ory/keto) ⭐ 5,098 | 🐛 58 | 🌐 Go | 📅 2025-08-26 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
* [authboss](https://github.com/volatiletech/authboss) ⭐ 4,039 | 🐛 43 | 🌐 Go | 📅 2025-07-16 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
* [openfga](https://github.com/openfga/openfga) ⭐ 4,032 | 🐛 139 | 🌐 Go | 📅 2025-08-26 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
* [scs](https://github.com/alexedwards/scs) ⭐ 2,396 | 🐛 33 | 🌐 Go | 📅 2025-08-13 - Session Manager for HTTP servers.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,189 | 🐛 7 | 🌐 Go | 📅 2025-08-25 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
...
* [gologin](https://github.com/dghubble/gologin) ⭐ 1,919 | 🐛 0 | 🌐 Go | 📅 2025-08-24 - chainable handlers for login with OAuth1 and OAuth2 authentication providers.
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,643 | 🐛 28 | 🌐 Go | 📅 2025-08-26 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
...
* [go-jose](https://github.com/go-jose/go-jose) ⭐ 429 | 🐛 30 | 🌐 Go | 📅 2025-08-18 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,631 | 🐛 298 | 🌐 Go | 📅 2025-08-27 - Official Go implementation of the Ethereum protocol.
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,656 | 🐛 1,076 | 🌐 Go | 📅 2025-08-26 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 8,003 | 🐛 808 | 🌐 Go | 📅 2025-08-20 - A complete implementation of a Lightning Network node.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,707 | 🐛 215 | 🌐 Go | 📅 2025-08-26 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,827 | 🐛 25 | 🌐 Go | 📅 2025-08-21 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
* [gno](https://github.com/gnolang/gno) ⭐ 988 | 🐛 706 | 🌐 Go | 📅 2025-08-26 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 778 | 🐛 299 | 🌐 Go | 📅 2025-08-26 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,243 | 🐛 172 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,425 | 🐛 58 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
* [wayback](https://github.com/wabarc/wayback) ⭐ 2,049 | 🐛 56 | 🌐 Go | 📅 2025-08-25 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [telego](https://github.com/mymmrac/telego) ⭐ 769 | 🐛 4 | 🌐 Go | 📅 2025-08-26 - Telegram Bot API library for Golang with full one-to-one API implementation.
...
* [slack-bot](https://github.com/innogames/slack-bot) ⭐ 200 | 🐛 8 | 🌐 Go | 📅 2025-08-26 - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
...
* [air](https://github.com/cosmtrek/air) ⭐ 21,498 | 🐛 187 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
* [Task](https://github.com/go-task/task) ⭐ 13,410 | 🐛 402 | 🌐 Go | 📅 2025-08-27 - simple "Make" alternative.
...
* [xc](https://github.com/joerdav/xc) ⭐ 1,322 | 🐛 15 | 🌐 Go | 📅 2025-07-10 - Task runner with README.md defined tasks, executable markdown.
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 34,718 | 🐛 126 | 🌐 Go | 📅 2025-08-26 - Go framework to build terminal apps, based on The Elm Architecture.
* [fx](https://github.com/antonmedv/fx) ⭐ 19,786 | 🐛 6 | 🌐 Go | 📅 2025-08-21 - Terminal JSON viewer & processor.
* [termui](https://github.com/gizak/termui) ⭐ 13,412 | 🐛 104 | 🌐 Go | 📅 2025-07-10 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,634 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,348 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,529 | 🐛 91 | 🌐 Go | 📅 2025-08-26 - Declaratively define styles for color, format and layout in the terminal.
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,834 | 🐛 171 | 🌐 Go | 📅 2025-08-26 - TUI components for bubbletea.
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,398 | 🐛 114 | 🌐 Go | 📅 2025-08-12 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,904 | 🐛 678 | 🌐 Python | 📅 2025-08-26.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,225 | 🐛 66 | 🌐 Go | 📅 2025-08-08 - A library to beautify console output on every platform with many combinable components.
...
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,477 | 🐛 16 | 🌐 Go | 📅 2025-02-08 - Basic thread-safe progress bar that works in every OS.
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,876 | 🐛 48 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,412 | 🐛 104 | 🌐 Go | 📅 2025-07-10.
* [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,873 | 🐛 14 | 🌐 Go | 📅 2024-10-26 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
...
* [gookit/color](https://github.com/gookit/color) ⭐ 1,560 | 🐛 3 | 🌐 Go | 📅 2025-08-25 - Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows.
* [aurora](https://github.com/logrusorgru/aurora) ⭐ 1,469 | 🐛 2 | 🌐 Go | 📅 2025-01-07 - ANSI terminal colors that support fmt.Printf/Sprintf.
...
* [box-cli-maker](https://github.com/Delta456/box-cli-maker) ⭐ 573 | 🐛 6 | 🌐 Go | 📅 2025-07-20 - Make Highly Customized Boxes for your CLI.
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) ⭐ 557 | 🐛 12 | 🌐 Go | 📅 2023-12-20 - Style terminal text.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,561 | 🐛 323 | 🌐 Go | 📅 2025-08-11 - Commander for modern Go CLI interactions.
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,462 | 🐛 50 | 🌐 Go | 📅 2025-08-26 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
* [elvish](https://github.com/elves/elvish) ⭐ 6,088 | 🐛 339 | 🌐 Go | 📅 2025-07-14 - An expressive programming language and a versatile interactive shell.
* [kingpin](https://github.com/alecthomas/kingpin) ⭐ 3,539 | 🐛 29 | 🌐 Go | 📅 2025-08-24 - Command line and flag parser supporting sub commands (superseded by `kong`; see below).
...
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,409 | 🐛 82 | 🌐 Go | 📅 2025-08-26 - Multi-shell multi-command argument completer.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 802 | 🐛 42 | 🌐 Go | 📅 2025-08-16 - Command argument completion generator for spf13/cobra.
...
* [carapace-spec](https://github.com/rsteube/carapace-spec) ⭐ 22 | 🐛 17 | 🌐 Go | 📅 2025-08-26 - Define simple completions using a spec file.
...
* [viper](https://github.com/spf13/viper) ⭐ 29,145 | 🐛 521 | 🌐 Go | 📅 2025-08-26 - Go configuration with fangs.
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,692 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,533 | 🐛 27 | 🌐 Go | 📅 2025-08-26 - A blazingly fast JSON serializing & deserializing library.
* [env](https://github.com/caarlos0/env) ⭐ 5,713 | 🐛 12 | 🌐 Go | 📅 2025-08-12 - Parse environment variables to Go structs (with defaults).
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,305 | 🐛 59 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [ini](https://github.com/go-ini/ini) ⭐ 3,523 | 🐛 65 | 🌐 Go | 📅 2024-05-01 - Go package to read and write INI files.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,411 | 🐛 10 | 🌐 Go | 📅 2025-08-26 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
* [kong](https://github.com/alecthomas/kong) ⭐ 2,765 | 🐛 30 | 🌐 Go | 📅 2025-08-18 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [xdg](https://github.com/adrg/xdg) ⭐ 867 | 🐛 6 | 🌐 Go | 📅 2025-08-25 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
* [konf](https://github.com/nil-go/konf) ⭐ 343 | 🐛 15 | 🌐 Go | 📅 2025-08-26 - The simplest API for reading/watching config from file, env, flag and clouds (e.g. AWS, Azure, GCP).
* [hjson](https://github.com/hjson/hjson-go) ⭐ 340 | 🐛 5 | 🌐 Go | 📅 2025-04-21 - Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments.
...
* [envh](https://github.com/antham/envh) ⭐ 100 | 🐛 0 | 🌐 Go | 📅 2025-08-25 - Helpers to manage environment variables.
...
* [nfigure](https://github.com/muir/nfigure) ⭐ 8 | 🐛 7 | 🌐 Go | 📅 2025-08-26 - Per-library struct-tag based configuration from command lines (Posix & Go-style); environment, JSON, YAML
...
* [drone](https://github.com/drone/drone) ⭐ 33,130 | 🐛 76 | 🌐 Go | 📅 2025-08-26 - Drone is a Continuous Integration platform built on Docker, written in Go.
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,406 | 🐛 349 | 🌐 Go | 📅 2025-08-26 - Woodpecker is a community fork of the Drone CI system.
* [CDS](https://github.com/ovh/cds) ⭐ 4,753 | 🐛 158 | 🌐 Go | 📅 2025-08-25 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,570 | 🐛 23 | 🌐 Go | 📅 2025-08-26 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,911 | 🐛 98 | 🌐 Rust | 📅 2025-08-26.
...
* [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 577 | 🐛 6 | 🌐 Go | 📅 2023-06-06 - go test output for humans.
* [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 175 | 🐛 7 | 🌐 Go | 📅 2025-08-25 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,432 | 🐛 532 | 🌐 Go | 📅 2025-08-26 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,184 | 🐛 158 | 🌐 Go | 📅 2025-08-26 - A high-performance ELT data integration framework with pluggable architecture.
...
* [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,649 | 🐛 19 | 🌐 Go | 📅 2025-08-18 - Go package implementing Bloom filters.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 17,103 | 🐛 68 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [gota](https://github.com/kniren/gota) ⭐ 3,227 | 🐛 81 | 🌐 Go | 📅 2023-08-09 - Implementation of dataframes, series, and data wrangling methods for Go.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,971 | 🐛 95 | 🌐 Python | 📅 2025-08-26 - Distributed, Fault-tolerant task queue.
...
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,585 | 🐛 13 | 🌐 Go | 📅 2025-08-15 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,515 | 🐛 300 | 🌐 Go | 📅 2025-08-25 - Modern text indexing library for go.
...
* [BigCache](https://github.com/allegro/bigcache) ⭐ 7,917 | 🐛 99 | 🌐 Go | 📅 2025-08-18 - Efficient key/value cache for gigabytes of data.
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,408 | 🐛 7 | 🌐 Go | 📅 2025-08-20 -  A high performance memory-bound Go cache.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,290 | 🐛 3 | 🌐 Go | 📅 2025-08-25 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
* [fastcache](https://github.com/VictoriaMetrics/fastcache) ⭐ 2,257 | 🐛 44 | 🌐 Go | 📅 2025-08-06 - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
...
* [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,133 | 🐛 17 | 🌐 Go | 📅 2025-08-26 - An in-memory cache with item expiration and generics.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 60,088 | 🐛 731 | 🌐 Go | 📅 2025-08-26 - Monitoring system and time series database.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,936 | 🐛 5,236 | 🌐 Go | 📅 2025-08-27 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 36,817 | 🐛 678 | 🌐 Go | 📅 2025-08-27 - Milvus is a vector database for embedding management, analytics and search.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,217 | 🐛 7,605 | 🌐 Go | 📅 2025-08-27 - Scalable, Geo-Replicated, Transactional Datastore.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,534 | 🐛 2,146 | 🌐 Rust | 📅 2025-08-27 - Scalable datastore for metrics, events, and real-time analytics.
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,174 | 🐛 41 | 🌐 Go | 📅 2025-08-27 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
* [dolt](https://github.com/dolthub/dolt) ⭐ 19,012 | 🐛 436 | 🌐 Go | 📅 2025-08-27 - Dolt – It's Git for Data.
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,894 | 🐛 75 | 🌐 Go | 📅 2025-08-26 - The lightweight, distributed, relational database built on SQLite.
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,944 | 🐛 32 | 🌐 Go | 📅 2025-08-20 - Fast key-value store in Go.
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,849 | 🐛 803 | 🌐 Go | 📅 2025-08-27 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,037 | 🐛 43 | 🌐 Go | 📅 2025-08-26 - An embedded key/value database for Go.
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,298 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 38,038 | 🐛 366 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,464 | 🐛 314 | 🌐 Go | 📅 2025-08-26 - RocksDB/LevelDB inspired key-value database in Go.
* [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,853 | 🐛 4 | 🌐 Go | 📅 2025-08-12 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
...
* [godis](https://github.com/hdt3213/godis) ⭐ 3,749 | 🐛 18 | 🌐 Go | 📅 2025-07-05 - A Golang implemented high-performance Redis server and cluster.
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,497 | 🐛 67 | 🌐 Go | 📅 2025-08-26 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 17,256 | 🐛 436 | 🌐 Go | 📅 2025-08-24 - Database migrations. CLI and Golang library.
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,920 | 🐛 127 | 🌐 Go | 📅 2025-08-26 - Safe database schema change and version control for DevOps teams.
* [goose](https://github.com/pressly/goose) ⭐ 9,001 | 🐛 102 | 🌐 Go | 📅 2025-08-24 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
* [atlas](https://github.com/ariga/atlas) ⭐ 7,238 | 🐛 226 | 🌐 Go | 📅 2025-08-25 - A Database Toolkit. A CLI designed to help companies better work with their data.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,289 | 🐛 37 | 🌐 Go | 📅 2025-08-25 - A lightweight, framework-agnostic database migration tool.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 20,038 | 🐛 883 | 🌐 Go | 📅 2025-08-26 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [pREST](https://github.com/prest/prest) ⭐ 4,389 | 🐛 142 | 🌐 Go | 📅 2025-08-25 - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,810 | 🐛 604 | 🌐 Go | 📅 2025-08-25 - Generate type-safe code from SQL.
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,566 | 🐛 92 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,341 | 🐛 46 | 🌐 Go | 📅 2025-08-09 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
* [goqu](https://github.com/doug-martin/goqu) ⭐ 2,556 | 🐛 146 | 🌐 Go | 📅 2024-05-22 - Idiomatic SQL builder and query library.
...
* [sqlingo](https://github.com/lqs/sqlingo) ⭐ 436 | 🐛 5 | 🌐 Go | 📅 2025-08-25 - A lightweight DSL to build SQL in Go.
...
* [cayley](https://github.com/google/cayley) ⭐ 14,958 | 🐛 92 | 🌐 Go | 📅 2025-06-27 - Graph database with support for multiple backends.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15,024 | 🐛 64 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [pgx](https://github.com/jackc/pgx) ⭐ 12,354 | 🐛 241 | 🌐 Go | 📅 2025-08-09 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pq](https://github.com/lib/pq) ⭐ 9,598 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,669 | 🐛 203 | 🌐 C | 📅 2025-08-14 - SQLite3 driver for go that uses database/sql.
* [go-mssqldb](https://github.com/denisenkom/go-mssqldb) ⭐ 1,863 | 🐛 177 | 🌐 Go | 📅 2025-04-26 - Microsoft MSSQL driver for Go.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 765 | 🐛 6 | 🌐 Go | 📅 2025-08-26 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [Sqinn-Go](https://github.com/cvilsmeier/sqinn-go) ⭐ 477 | 🐛 0 | 🌐 Go | 📅 2025-08-21 - SQLite with pure Go.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 167 | 🐛 244 | 🌐 Go | 📅 2025-08-26 - native and database/sql driver YDB (Yandex Database)
...
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 1 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,354 | 🐛 241 | 🌐 Go | 📅 2025-08-09 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,456 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,441 | 🐛 88 | 🌐 Go | 📅 2025-08-26 - Redis client for Golang.
* [redigo](https://github.com/gomodule/redigo) ⭐ 9,845 | 🐛 23 | 🌐 Go | 📅 2025-05-21 - Redigo is a Go client for the Redis database.
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,429 | 🐛 10 | 🌐 Go | 📅 2025-08-25 - Official MongoDB driver for the Go language.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,751 | 🐛 14 | 🌐 Go | 📅 2025-08-25 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
* [Kivik](https://github.com/go-kivik/kivik) ⭐ 327 | 🐛 37 | 🌐 Go | 📅 2025-08-22 - Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases.
...
* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,127 | 🐛 89 | 🌐 Go | 📅 2025-08-27 - ClickHouse SQL client for Go with a `database/sql` compatibility.
* [elasticsql](https://github.com/cch123/elasticsql) ⭐ 1,190 | 🐛 13 | 🌐 Go | 📅 2023-08-06 - Convert sql to elasticsearch dsl in Go.
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1,064 | 🐛 20 | 🌐 Go | 📅 2025-08-21 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,117 | 🐛 3 | 🌐 Go | 📅 2025-08-26 - A simple, semantic and developer-friendly time package for golang.
* [now](https://github.com/jinzhu/now) ⭐ 4,562 | 🐛 14 | 🌐 Go | 📅 2025-08-11 - Now is a time toolkit for golang.
* [dateparse](https://github.com/araddon/dateparse) ⭐ 2,107 | 🐛 65 | 🌐 Go | 📅 2023-12-30 - Parse date's without knowing format in advance.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,679 | 🐛 342 | 🌐 Go | 📅 2025-08-26 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,259 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,755 | 🐛 126 | 🌐 Go | 📅 2025-08-20 - A modular-designed and easy-to-use microservices framework in Go.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,460 | 🐛 22 | 🌐 Go | 📅 2025-08-19 - A distributed systems development framework.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 22,134 | 🐛 143 | 🌐 Go | 📅 2025-08-26 - The Go language implementation of gRPC. HTTP/2 based RPC.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,872 | 🐛 437 | 🌐 Go | 📅 2025-08-27 - NATS is a simple, secure, and
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,735 | 🐛 46 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [rpcx](https://github.com/smallnest/rpcx) ⭐ 8,241 | 🐛 8 | 🌐 Go | 📅 2025-08-26 - Distributed pluggable RPC service framework like alibaba Dubbo.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,625 | 🐛 62 | 🌐 Go | 📅 2025-08-25 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
...
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,227 | 🐛 56 | 🌐 Go | 📅 2025-07-23 - A feature complete and high performance multi-group Raft library in Go.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,756 | 🐛 23 | 🌐 Go | 📅 2025-08-26 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,408 | 🐛 32 | 🌐 Go | 📅 2025-08-24 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [redis-lock](https://github.com/bsm/redislock) ⭐ 1,671 | 🐛 4 | 🌐 Go | 📅 2025-06-09 - Simplified distributed locking implementation using Redis.
* [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,619 | 🐛 26 | 🌐 Go | 📅 2025-04-16 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,071 | 🐛 88 | 🌐 Go | 📅 2025-08-26 - A cloud native Kubernetes Global Balancer.
...
* [raft](https://github.com/etcd-io/raft) ⭐ 898 | 🐛 70 | 🌐 Go | 📅 2025-08-26 - Go implementation of the Raft consensus protocol, by CoreOS.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 704 | 🐛 191 | 🌐 Go | 📅 2025-08-26 - Durable execution system for making code fault-tolerant and simple.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 662 | 🐛 36 | 🌐 Go | 📅 2025-08-27 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 383 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,458 | 🐛 359 | 🌐 C++ | 📅 2025-08-08).
...
* [outboxer](https://github.com/italolelis/outboxer) ⭐ 163 | 🐛 7 | 🌐 Go | 📅 2025-08-25 - Outboxer is a go library that implements the outbox pattern.
...
* [bedrock](https://github.com/z5labs/bedrock) ⭐ 13 | 🐛 6 | 🌐 Go | 📅 2025-08-25 - Provides a minimal, modular and composable foundation for quickly developing services and more use case specific frameworks in Go.
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,200 | 🐛 252 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,616 | 🐛 2 | 🌐 Go | 📅 2025-08-26 - Email and SMTP testing tool for developers.
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,649 | 🐛 132 | 🌐 Go | 📅 2025-07-18 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
* [mox](https://github.com/mjl-/mox) ⭐ 5,150 | 🐛 152 | 🌐 Go | 📅 2025-08-21 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
* [hermes](https://github.com/matcornic/hermes) ⭐ 2,916 | 🐛 20 | 🌐 Go | 📅 2025-04-04 - Golang package that generates clean, responsive HTML e-mails.
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,103 | 🐛 6 | 🌐 Go | 📅 2025-08-08 - A simple Go library for sending mails in Go.
...
* [go-premailer](https://github.com/vanng822/go-premailer) ⭐ 173 | 🐛 4 | 🌐 Go | 📅 2025-08-26 - Inline styling for HTML mail in Go.
...
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 10,126 | 🐛 194 | 🌐 Go | 📅 2025-08-26 - PHP embedded in Go, with a `net/http` handler.
* [expr](https://github.com/antonmedv/expr) ⭐ 7,126 | 🐛 50 | 🌐 Go | 📅 2025-08-12 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,711 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [goja](https://github.com/dop251/goja) ⭐ 6,393 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [tengo](https://github.com/d5/tengo) ⭐ 3,685 | 🐛 86 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,330 | 🐛 50 | 🌐 Go | 📅 2025-07-18 - Port of the Lua 5.2 VM to pure Go.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,653 | 🐛 54 | 🌐 Go | 📅 2025-08-18 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,605 | 🐛 5 | 🌐 Go | 📅 2025-08-27 - The Wa Programming Language embedded in Go.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,711 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,931 | 🐛 138 | 🌐 Go | 📅 2025-08-18 - PDF processor.
* [afero](https://github.com/spf13/afero) ⭐ 6,335 | 🐛 159 | 🌐 Go | 📅 2025-08-22 - FileSystem Abstraction System for Go.
* [gdu](https://github.com/dundee/gdu) ⭐ 4,716 | 🐛 55 | 🌐 Go | 📅 2025-07-09 - Disk usage analyzer with console interface.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 103 | 🐛 3 | 🌐 Go | 📅 2025-08-20 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 73,229 | 🐛 302 | 🌐 Go | 📅 2025-08-26).
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 | 🐛 1 | 🌐 Go | 📅 2023-09-21 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,952 | 🐛 41 | 📅 2025-07-08.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,902 | 🐛 145 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,479 | 🐛 35 | 🌐 Go | 📅 2025-08-03 - Terminal stock watcher and stock position tracker.
* [go-money](https://github.com/rhymond/go-money) ⭐ 1,797 | 🐛 25 | 🌐 Go | 📅 2025-04-30 - Implementation of Fowler's Money pattern.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,512 | 🐛 142 | 🌐 Go | 📅 2025-08-27 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
* [ledger](https://github.com/formancehq/ledger) ⭐ 1,022 | 🐛 11 | 🌐 Go | 📅 2025-08-25 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [currency](https://github.com/bojanz/currency) ⭐ 600 | 🐛 6 | 🌐 Go | 📅 2025-08-24 - Handles currency amounts, provides currency information and formatting.
* [orderbook](https://github.com/i25959341/orderbook) ⭐ 509 | 🐛 5 | 🌐 Go | 📅 2025-04-04 - Matching Engine for Limit Order Book in Golang.
* [ach](https://github.com/moov-io/ach) ⭐ 505 | 🐛 18 | 🌐 Go | 📅 2025-08-26 - A reader, writer, and validator for Automated Clearing House (ACH) files.
...
* [money](https://github.com/govalues/money) ⭐ 40 | 🐛 0 | 🌐 Go | 📅 2025-01-25 - Immutable monetary amounts and exchange rates with panic-free arithmetic.
...
* [httpin](https://github.com/ggicci/httpin) ⭐ 371 | 🐛 11 | 🌐 Go | 📅 2025-08-26 - Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc.
...
* [mo](https://github.com/samber/mo) ⭐ 3,079 | 🐛 17 | 🌐 Go | 📅 2025-08-26 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,365 | 🐛 297 | 🌐 Go | 📅 2025-08-26 - dead simple 2D game engine in Go.
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,147 | 🐛 6 | 🌐 C | 📅 2025-08-07 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
* [Ark](https://github.com/mlange-42/ark) ⭐ 103 | 🐛 14 | 🌐 Go | 📅 2025-08-26 - Archetype-based Entity Component System (ECS) for Go.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,517 | 🐛 714 | 🌐 Go | 📅 2025-08-20 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,251 | 🐛 22 | 🌐 Go | 📅 2025-08-21 - Generate decorators for Go interfaces using simple templates.
* [go-enum](https://github.com/abice/go-enum) ⭐ 864 | 🐛 12 | 🌐 Go | 📅 2025-08-25 - Code generation for enums from code comments.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,461 | 🐛 152 | 🌐 Go | 📅 2025-08-26 - Geolocation DB with spatial index and realtime geofencing.
...
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 13,003 | 🐛 192 | 🌐 Go | 📅 2025-08-19 - Compiler from Go to JavaScript.
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,502 | 🐛 14 | 🌐 Go | 📅 2025-08-25 - Compile shell scripts to Go.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,928 | 🐛 0 | 🌐 Go | 📅 2025-08-08 - A high-performance and low-cost goroutine pool in Go.
* [conc](https://github.com/sourcegraph/conc) ⭐ 10,061 | 🐛 25 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [rill](https://github.com/destel/rill) ⭐ 1,697 | 🐛 2 | 🌐 Go | 📅 2025-08-25 - Go toolkit for clean, composable, channel-based concurrency.
...
* [async](https://github.com/reugn/async) ⭐ 268 | 🐛 0 | 🌐 Go | 📅 2025-07-05 - An alternative sync library for Go (Future, Promise, Locks).
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,996 | 🐛 750 | 🌐 Go | 📅 2025-08-25 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
* [webview](https://github.com/zserge/webview) ⭐ 13,304 | 🐛 192 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [walk](https://github.com/lxn/walk) ⭐ 7,008 | 🐛 346 | 🌐 Go | 📅 2024-01-21 - Windows application library kit for Go.
* [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,298 | 🐛 39 | 🌐 Go | 📅 2025-03-08 - Build native macOS applications using Go.
...
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,068 | 🐛 230 | 🌐 Go | 📅 2025-08-20 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
* [Spot](https://github.com/roblillack/spot) ⭐ 1,234 | 🐛 7 | 🌐 Go | 📅 2024-12-19 - Reactive, cross-platform desktop GUI toolkit.
* [energy](https://github.com/energye/energy) ⭐ 518 | 🐛 7 | 🌐 Go | 📅 2025-06-17 - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 443 | 🐛 20 | 🌐 C++ | 📅 2025-08-23 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 67,821 | 🐛 1,184 | 🌐 C++ | 📅 2025-08-26 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,711 | 🐛 17 | 🌐 Lua | 📅 2025-07-14.
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,332 | 🐛 137 | 🌐 Go | 📅 2025-08-03 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
* [systray](https://github.com/getlantern/systray) ⭐ 3,553 | 🐛 109 | 🌐 Go | 📅 2024-07-03 - Cross platform Go library to place an icon and menu in the notification area.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,631 | 🐛 224 | 🌐 Go | 📅 2025-08-26 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [emgo](https://github.com/ziutek/emgo) ⭐ 1,088 | 🐛 13 | 🌐 C | 📅 2021-12-05 - Go-like language for programming embedded systems (e.g. STM32 MCU).
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,195 | 🐛 339 | 🌐 Go | 📅 2025-08-06 - Go package for computer vision using OpenCV 3.3+.
* [imaginary](https://github.com/h2non/imaginary) ⭐ 5,904 | 🐛 135 | 🌐 Go | 📅 2025-01-14 - Fast and simple HTTP microservice for image resizing.
...
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,891 | 🐛 37 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
* [imagor](https://github.com/cshum/imagor) ⭐ 3,719 | 🐛 39 | 🌐 Go | 📅 2025-08-27 - Fast, secure image processing server and Go library, using libvips.
* [ln](https://github.com/fogleman/ln) ⭐ 3,336 | 🐛 12 | 🌐 Go | 📅 2019-07-19 - 3D line art rendering in Go.
* [bimg](https://github.com/h2non/bimg) ⭐ 2,901 | 🐛 177 | 🌐 Go | 📅 2025-01-23 - Small package for fast and efficient image processing using libvips.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 747 | 🐛 7 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,624 | 🐛 52 | 🌐 Go | 📅 2025-08-26 - Lightweight data stream processing engine for IoT edge.
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,365 | 🐛 25 | 🌐 Go | 📅 2025-08-27 - Kubernetes native IoT development framework.
* [rulego](https://github.com/rulego/rulego) ⭐ 1,254 | 🐛 8 | 🌐 Go | 📅 2025-08-25 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,487 | 🐛 20 | 🌐 Go | 📅 2025-08-26 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
* [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,941 | 🐛 4 | 🌐 Go | 📅 2025-07-30 - Simple, zero-dependency scheduling library for Go.
...
* [cheek](https://github.com/bart6114/cheek) ⭐ 196 | 🐛 13 | 🌐 Go | 📅 2025-08-26 - A simple crontab like scheduler that aims to offer a KISS approach to job scheduling.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,149 | 🐛 90 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,449 | 🐛 74 | 🌐 Go | 📅 2025-08-04 - Structured logger for Go.
* [zap](https://github.com/uber-go/zap) ⭐ 23,546 | 🐛 166 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,752 | 🐛 144 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,223 | 🐛 100 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 662 | 🐛 2 | 🌐 Go | 📅 2025-08-26 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,449 | 🐛 74 | 🌐 Go | 📅 2025-08-04, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,259 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,546 | 🐛 166 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,752 | 🐛 144 | 🌐 Go | 📅 2025-04-18, etc).
* [glg](https://github.com/kpango/glg) ⭐ 190 | 🐛 3 | 🌐 Go | 📅 2024-09-17 - glg is simple and fast leveled logging library for Go.
* [slog-formatter](https://github.com/samber/slog-formatter) ⭐ 188 | 🐛 0 | 🌐 Go | 📅 2025-08-25 - Common formatters for slog and helpers to build your own.
...
* [logrusly](https://github.com/sebest/logrusly) ⭐ 29 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,449 | 🐛 74 | 🌐 Go | 📅 2025-08-04 plug-in to send errors to a [Loggly](https://www.loggly.com/).
...
* [kemba](https://github.com/clok/kemba) ⭐ 16 | 🐛 6 | 🌐 Go | 📅 2025-08-24 - A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug) ⭐ 11,314 | 🐛 79 | 🌐 JavaScript | 📅 2025-05-13, great for CLI tools and applications.
* [log](https://github.com/heartwilltell/log) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2022-12-06 - Simple leveled logging wrapper around standard log package.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,449 | 🐛 74 | 🌐 Go | 📅 2025-08-04 logger.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,828 | 🐛 112 | 🌐 Go | 📅 2024-08-12 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,944 | 🐛 33 | 🌐 Go | 📅 2025-03-24 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 869 | 🐛 1 | 🌐 Go | 📅 2025-08-25 - An accelerated Machine Learning framework for Go.
...
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 443 | 🐛 8 | 🌐 Go | 📅 2025-08-26 - Huggingface transformer pipelines for golang with onnxruntime.
...
* [catboost-cgo](https://github.com/mirecl/catboost-cgo) ⭐ 18 | 🐛 6 | 🌐 C | 📅 2025-08-25 - Fast, scalable, high performance Gradient Boosting on Decision Trees library. Golang using Cgo for blazing fast inference CatBoost Model.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,169 | 🐛 51 | 🌐 Go | 📅 2025-08-26 - Go library for Apache Kafka.
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,885 | 🐛 253 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,239 | 🐛 25 | 🌐 Go | 📅 2025-08-25 - Real-time messaging (Websockets or SockJS) server in Go.
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,793 | 🐛 72 | 🌐 Go | 📅 2025-08-27 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,480 | 🐛 58 | 🌐 Go | 📅 2025-08-26 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,117 | 🐛 32 | 🌐 Go | 📅 2025-07-22 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,109 | 🐛 157 | 🌐 Go | 📅 2025-08-26 - Go client for the NATS
  messaging system.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,987 | 🐛 289 | 🌐 HTML | 📅 2025-08-27 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [APNs2](https://github.com/sideshow/apns2) ⭐ 3,117 | 🐛 32 | 🌐 Go | 📅 2025-07-22 - HTTP/2 Apple Push Notification provider for Go - Send push notifications to iOS, tvOS, Safari and OSX apps.
...
* [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,901 | 🐛 27 | 🌐 Go | 📅 2024-06-19 - The lightweight event bus with async compatibility.
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,841 | 🐛 17 | 🌐 Go | 📅 2025-07-08 - Go RabbitMQ Client Library.
...
* [Quamina](https://github.com/timbray/quamina) ⭐ 434 | 🐛 15 | 🌐 Go | 📅 2025-08-22 - Fast pattern-matching for filtering messages and events.
...
* [rabtap](https://github.com/jandelgado/rabtap) ⭐ 273 | 🐛 9 | 🌐 Go | 📅 2025-08-26 - RabbitMQ swiss army knife cli app.
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,652 | 🐛 25 | 🌐 Go | 📅 2025-08-19 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/xuri/excelize) ⭐ 19,547 | 🐛 135 | 🌐 Go | 📅 2025-08-19 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [godocx](https://github.com/gomutex/godocx) ⭐ 204 | 🐛 18 | 🌐 Go | 📅 2025-08-11 - Library for reading and writing Microsoft Word (Docx) files.
...
* [fx](https://github.com/uber-go/fx) ⭐ 6,815 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
* [dig](https://github.com/uber-go/dig) ⭐ 4,284 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [do](https://github.com/samber/do) ⭐ 2,261 | 🐛 35 | 🌐 Go | 📅 2025-08-26 - A dependency injection framework based on Generics.
...
* [goioc/di](https://github.com/goioc/di) ⭐ 369 | 🐛 3 | 🌐 Go | 📅 2025-08-25 - Spring-inspired Dependency Injection Container.
...
* [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 184 | 🐛 17 | 🌐 Go | 📅 2025-08-24 - A dependency injection toolkit for Go, based on Guice.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,610 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,610 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 8,067 | 🐛 29 | 🌐 Go | 📅 2025-07-19 - Allows users to spin up a quick Go project using a popular framework.
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,858 | 🐛 1 | 🌐 Go | 📅 2025-08-26 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,858 | 🐛 1 | 🌐 Go | 📅 2025-08-26 for building production grade scalable web service applications.
...
* [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,814 | 🐛 3 | 🌐 Go | 📅 2025-08-15 - Rapid, easy full-stack web development starter kit built in Go.
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,366 | 🐛 2 | 🌐 Go | 📅 2025-08-25 - Nunu is a scaffolding tool for building Go applications.
* [modern-go-application](https://github.com/sagikazarmark/modern-go-application) ⭐ 1,925 | 🐛 23 | 🌐 Go | 📅 2024-11-01 - Go application boilerplate and example applying modern practices.
* [goapp](https://github.com/naughtygopher/goapp) ⭐ 1,001 | 🐛 0 | 🌐 Go | 📅 2025-07-22 - An opinionated guideline to structure & develop a Go web application/service.
...
* [go-module](https://github.com/octomation/go-module) ⭐ 35 | 🐛 31 | 🌐 Shell | 📅 2025-08-21 - Template for a typical module written on Go.
...
* [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,169 | 🐛 10 | 🌐 Go | 📅 2025-08-26 - cross-platform, cli app to perform various operations on string.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,406 | 🐛 225 | 🌐 Go | 📅 2025-08-26 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 8,021 | 🐛 217 | 🌐 Go | 📅 2025-08-27 - Automated service health dashboard.
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 5,135 | 🐛 13 | 🌐 Go | 📅 2025-08-19 - Random data generator written in go.
* [go-resiliency](https://github.com/eapache/go-resiliency) ⭐ 2,308 | 🐛 2 | 🌐 Go | 📅 2025-02-23 - Resiliency patterns for golang.
...
* [archives](https://github.com/mholt/archives) ⭐ 298 | 🐛 4 | 🌐 Go | 📅 2025-08-25 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [govader](https://github.com/jonreiter/govader) ⭐ 51 | 🐛 1 | 🌐 Go | 📅 2025-04-29 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,797 | 🐛 55 | 🌐 Python | 📅 2024-03-16.
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,558 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,350 | 🐛 689 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,339 | 🐛 15 | 🌐 Go | 📅 2025-08-01 - Package and an accompanying tool to work with localized text.
* [go-pinyin](https://github.com/mozillazg/go-pinyin) ⭐ 1,707 | 🐛 17 | 🌐 Go | 📅 2025-07-19 - CN Hanzi to Hanyu Pinyin converter.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,852 | 🐛 97 | 🌐 Go | 📅 2025-08-24 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,223 | 🐛 104 | 🌐 Go | 📅 2025-08-26 - A pure Go implementation of the WebRTC API.
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,215 | 🐛 133 | 🌐 Go | 📅 2025-08-13 - Extremely simple & fast udp tunnel based on KCP protocol.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 11,363 | 🐛 455 | 🌐 Go | 📅 2025-08-21 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,929 | 🐛 189 | 🌐 Go | 📅 2025-08-25 - An implementation of the QUIC protocol in pure Go.
...
* [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,459 | 🐛 92 | 🌐 Go | 📅 2025-08-26 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 4,119 | 🐛 14 | 🌐 Go | 📅 2025-08-10 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,968 | 🐛 56 | 🌐 Go | 📅 2025-01-27 - Higher-level API for building SSH servers (wraps crypto/ssh).
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,866 | 🐛 235 | 🌐 Go | 📅 2025-08-26 - BGP implemented in the Go Programming Language.
* [fortio](https://github.com/fortio/fortio) ⭐ 3,593 | 🐛 82 | 🌐 Go | 📅 2025-08-26 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,575 | 🐛 2 | 🌐 Go | 📅 2025-08-09 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
* [water](https://github.com/songgao/water) ⭐ 2,073 | 🐛 30 | 🌐 Go | 📅 2024-07-30 - Simple TUN/TAP library.
...
* [ftp](https://github.com/jlaffaye/ftp) ⭐ 1,366 | 🐛 45 | 🌐 Go | 📅 2025-08-26 - Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959).
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,290 | 🐛 41 | 🌐 Go | 📅 2025-08-17 - Simple mDNS (Multicast DNS) client/server library in Golang.
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,241 | 🐛 2 | 🌐 Go | 📅 2025-07-29 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [ftpserverlib](https://github.com/fclairamb/ftpserverlib) ⭐ 452 | 🐛 11 | 🌐 Go | 📅 2025-08-25 - Fully featured FTP server library.
* [winrm](https://github.com/masterzen/winrm) ⭐ 448 | 🐛 49 | 🌐 Go | 📅 2025-08-19 - Go WinRM client to remotely execute commands on Windows machines.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 88 | 🐛 2 | 🌐 Go | 📅 2025-08-26 - Package bart provides a fast routing table algorithm.
...
* [req](https://github.com/imroc/req) ⭐ 4,596 | 🐛 79 | 🌐 Go | 📅 2025-08-23 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,185 | 🐛 73 | 🌐 Go | 📅 2025-08-18 - Retryable HTTP client in Go.
* [grequests](https://github.com/levigross/grequests) ⭐ 2,169 | 🐛 24 | 🌐 Go | 📅 2025-06-06 - A Go "clone" of the great and famous Requests library.
...
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 322 | 🐛 8 | 🌐 Go | 📅 2025-08-25 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [glfw](https://github.com/go-gl/glfw) ⭐ 1,635 | 🐛 27 | 🌐 C | 📅 2025-03-01 - Go bindings for GLFW 3.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,760 | 🐛 479 | 🌐 Go | 📅 2025-08-26 - The fantastic ORM library for Golang, aims to be developer friendly.
* [ent](https://github.com/facebook/ent) ⭐ 16,483 | 🐛 598 | 🌐 Go | 📅 2025-08-14 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,917 | 🐛 104 | 🌐 Go | 📅 2025-08-26 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
* [bun](https://github.com/uptrace/bun) ⭐ 4,333 | 🐛 26 | 🌐 Go | 📅 2025-08-26 - SQL-first Golang ORM. Successor of go-pg.
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,592 | 🐛 4 | 🌐 Go | 📅 2025-08-11 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,431 | 🐛 14 | 🌐 Go | 📅 2025-08-26 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [rel](https://github.com/go-rel/rel) ⭐ 781 | 🐛 35 | 🌐 Go | 📅 2025-08-26 - Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API.
...
* [CQL](https://github.com/FrancoLiberali/cql) ⭐ 16 | 🐛 14 | 🌐 Go | 📅 2025-08-27 - Built on top of GORM, adds compile-time verified queries based on auto-generated code.
...
* [glide](https://github.com/Masterminds/glide) ⭐ 8,124 | 🐛 400 | 🌐 Go | 📅 2024-07-22 - Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip.
* [syft](https://github.com/anchore/syft) ⭐ 7,532 | 🐛 482 | 🌐 Go | 📅 2025-08-26 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,779 | 🐛 313 | 🌐 Go | 📅 2025-08-27 - A distributed tracing system.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,140 | 🐛 346 | 🌐 C++ | 📅 2025-08-13 - No instrumentation tracing for Golang applications via eBPF.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,449 | 🐛 377 | 🌐 Go | 📅 2025-08-26 - go generate based graphql server library.
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,099 | 🐛 238 | 🌐 Go | 📅 2025-07-28 - Implementation of GraphQL for Go.
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,537 | 🐛 48 | 🌐 Go | 📅 2025-08-26 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
* [graphql](https://github.com/neelance/graphql-go) ⭐ 4,714 | 🐛 19 | 🌐 Go | 📅 2025-08-24 - GraphQL server with a focus on ease of use.
...
* [reflectutils](https://github.com/muir/reflectutils) ⭐ 8 | 🐛 4 | 🌐 Go | 📅 2025-08-26 - Helpers for working with reflection: struct tag parsing; recursive walking; fill value from string.
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,021 | 🐛 23 | 🌐 Go | 📅 2024-08-07 - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,549 | 🐛 49 | 🌐 Go | 📅 2025-08-18 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
* [lego](https://github.com/go-acme/lego) ⭐ 8,824 | 🐛 159 | 🌐 Go | 📅 2025-08-24 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
* [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,305 | 🐛 25 | 🌐 Go | 📅 2025-08-05 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,661 | 🐛 28 | 🌐 Go | 📅 2025-07-13 - Tool and library to remotely hack RTSP streams from surveillance cameras.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,870 | 🐛 93 | 🌐 Go | 📅 2025-08-22 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
* [memguard](https://github.com/awnumar/memguard) ⭐ 2,658 | 🐛 11 | 🌐 Go | 📅 2025-07-14 - A pure Go library for handling sensitive values in memory.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,400 | 🐛 2 | 🌐 Go | 📅 2025-08-25 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [dongle](https://github.com/golang-module/dongle) ⭐ 996 | 🐛 4 | 🌐 Go | 📅 2025-08-23 - A simple, semantic and developer-friendly golang package for encoding\&decoding and encryption\&decryption.
...
* [jsoniter](https://github.com/json-iterator/go) ⭐ 13,858 | 🐛 267 | 🌐 Go | 📅 2024-05-27 - High-performance 100% compatible drop-in replacement of "encoding/json".
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 10,002 | 🐛 116 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 66,408 | 🐛 219 | 🌐 Go | 📅 2025-08-26 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
* [minio](https://github.com/minio/minio) ⭐ 54,837 | 🐛 58 | 🌐 Go | 📅 2025-08-22 - Minio is a distributed object storage server.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 50,152 | 🐛 289 | 🌐 Go | 📅 2025-08-26 - Highly-available key value store for shared configuration and service discovery.
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 50,099 | 🐛 20 | 🌐 Go | 📅 2025-08-26 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,904 | 🐛 122 | 🌐 Go | 📅 2025-08-22 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,229 | 🐛 87 | 🌐 Go | 📅 2025-08-26 - High-performance PHP application server, load-balancer and process manager.
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,849 | 🐛 7 | 🌐 Go | 📅 2025-08-26 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,531 | 🐛 48 | 🌐 Go | 📅 2025-08-26 - A self contained feature flag solution written in Go and Vue.js
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,340 | 🐛 15 | 🌐 Go | 📅 2025-08-26 - Make SSH apps, just like that!
* [Fider](https://github.com/getfider/fider) ⭐ 3,730 | 🐛 49 | 🌐 Go | 📅 2025-08-20 - Fider is an open platform to collect and organize customer feedback.
...
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,042 | 🐛 47 | 🌐 Go | 📅 2025-08-07 - HTTP reverse proxy cache and time series accelerator.
...
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,724 | 🐛 25 | 🌐 Go | 📅 2025-08-26 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
* [OpenRun](https://github.com/openrundev/openrun) ⭐ 654 | 🐛 1 | 🌐 Go | 📅 2025-08-26 - Open-source alternative to Google Cloud Run and AWS App Runner. Easily deploy internal tools across a team.
...
* [protoxy](https://github.com/camgraff/protoxy) ⭐ 33 | 🐛 0 | 🌐 Go | 📅 2020-11-08 - A proxy server that converts JSON request bodies to Protocol Buffers.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,618 | 🐛 61 | 🌐 Go | 📅 2025-08-18 - A HTML templating language that has great developer tooling.
...
* [pongo2](https://github.com/flosch/pongo2) ⭐ 2,974 | 🐛 72 | 🌐 Go | 📅 2024-08-14 - Django-like template-engine for Go.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 25,072 | 🐛 373 | 🌐 Go | 📅 2025-08-25 - Sacred extension to the standard go testing package.
* [keploy](https://github.com/keploy/keploy) ⭐ 10,346 | 🐛 263 | 🌐 Go | 📅 2025-08-26 - Generate Testcase and Data Mocks from API calls automatically.
* [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,382 | 🐛 167 | 🌐 Go | 📅 2024-07-30 - BDD-style framework with web UI and live reload.
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,494 | 🐛 49 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,294 | 🐛 157 | 🌐 Go | 📅 2025-08-25 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [godog](https://github.com/cucumber/godog) ⭐ 2,489 | 🐛 83 | 🌐 Go | 📅 2025-08-24 - Cucumber BDD framework for Go.
* [is](https://github.com/matryer/is) ⭐ 1,919 | 🐛 7 | 🌐 Go | 📅 2024-02-08 - Professional lightweight testing mini-framework for Go.
* [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,462 | 🐛 30 | 🌐 Go | 📅 2025-08-25 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
...
* [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 1,007 | 🐛 6 | 🌐 Go | 📅 2025-08-04 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
* [go-testdeep](https://github.com/maxatome/go-testdeep) ⭐ 451 | 🐛 4 | 🌐 Go | 📅 2025-08-25 - Extremely flexible golang deep comparison, extends the go testing package.
...
* [be](https://github.com/carlmjohnson/be) ⭐ 120 | 🐛 2 | 🌐 Go | 📅 2025-08-26 - The minimalist generic test assertion library.
...
* [stop-and-go](https://github.com/elgohr/stop-and-go) ⭐ 12 | 🐛 2 | 🌐 Go | 📅 2025-08-26 - Testing helper for concurrency.
...
* [mockery](https://github.com/vektra/mockery) ⭐ 6,760 | 🐛 49 | 🌐 Go | 📅 2025-08-22 - Tool to generate Go interfaces.
...
* [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,428 | 🐛 35 | 🌐 Go | 📅 2025-08-21 - HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI.
...
* [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,080 | 🐛 26 | 🌐 Go | 📅 2025-08-26 - Tool for generating self-contained mock objects.
* [minimock](https://github.com/gojuno/minimock) ⭐ 725 | 🐛 9 | 🌐 Go | 📅 2025-08-24 - Mock generator for Go interfaces.
...
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 518 | 🐛 2 | 🌐 Go | 📅 2025-08-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,354 | 🐛 241 | 🌐 Go | 📅 2025-08-09.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,182 | 🐛 149 | 🌐 Go | 📅 2025-08-05 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
* [rod](https://github.com/go-rod/rod) ⭐ 6,188 | 🐛 192 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,871 | 🐛 56 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
...
* [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,625 | 🐛 45 | 🌐 Go | 📅 2025-08-12 - Formatters for time, numbers, and memory size to human readable format.
...
* [bytes](https://github.com/labstack/gommon/tree/master/bytes) ⭐ 557 | 🐛 12 | 🌐 Go | 📅 2023-12-20 - Formats and parses numeric byte values (10K, 2M, 3G, etc.).
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,791 | 🐛 21 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,282 | 🐛 13 | 🌐 Go | 📅 2025-07-22 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,014 | 🐛 13 | 🌐 Go | 📅 2025-08-24 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
* [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,846 | 🐛 31 | 🌐 Go | 📅 2025-08-26 - Go library for the TOML format with query support and handy cli tools.
...
* [sh](https://github.com/mvdan/sh) ⭐ 8,015 | 🐛 96 | 🌐 Go | 📅 2025-08-18 - Shell parser and formatter.
...
* [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,495 | 🐛 26 | 🌐 Go | 📅 2025-04-04 - HTML Sanitizer.
* [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 68 | 🐛 1 | 🌐 Go | 📅 2025-06-01 - A sanitization-based swear filter for Go.

### Scrapers

* [colly](https://github.com/asciimoo/colly) ⭐ 24,578 | 🐛 191 | 🌐 Go | 📅 2025-08-21 - Fast and Elegant Scraping Framework for Gophers.
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,675 | 🐛 4 | 🌐 Go | 📅 2025-08-12 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [github](https://github.com/google/go-github) ⭐ 10,918 | 🐛 54 | 🌐 Go | 📅 2025-08-26 - Go library for accessing the GitHub REST API v3.
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,264 | 🐛 214 | 🌐 Go | 📅 2025-08-12 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,538 | 🐛 200 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
* [slack](https://github.com/slack-go/slack) ⭐ 4,829 | 🐛 107 | 🌐 Go | 📅 2025-08-25 - Slack API in Go.
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,317 | 🐛 372 | 🌐 Go | 📅 2025-08-27 - Google Cloud APIs Go Client Library.
* [google](https://github.com/google/google-api-go-client) ⭐ 4,316 | 🐛 17 | 🌐 Go | 📅 2025-08-26 - Auto-generated Google APIs for Go.
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,223 | 🐛 86 | 🌐 Go | 📅 2025-08-26 - The official AWS SDK for the Go programming language.
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,788 | 🐛 21 | 🌐 Go | 📅 2025-08-21 - Minio Go Library for Amazon S3 compatible cloud storage.
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,382 | 🐛 13 | 🌐 Go | 📅 2025-08-27 - Go client for the Stripe API.
...
* [facebook](https://github.com/huandu/facebook) ⭐ 1,395 | 🐛 1 | 🌐 Go | 📅 2025-06-16 - Go Library that supports the Facebook Graph API.
* [githubql](https://github.com/shurcooL/githubql) ⭐ 1,161 | 🐛 43 | 🌐 Go | 📅 2024-07-27 - Go library for accessing the GitHub GraphQL API v4.
...
* [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 170 | 🐛 15 | 🌐 Go | 📅 2025-08-25 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
* [wit-go](https://github.com/wit-ai/wit-go) ⭐ 169 | 🐛 0 | 🌐 Go | 📅 2025-08-21 - Go client for wit.ai HTTP API.
...
* [gosip](https://github.com/koltyakov/gosip) ⭐ 160 | 🐛 12 | 🌐 Go | 📅 2025-08-09 - Client library for SharePoint.
...
* [aws-encryption-sdk-go](https://github.com/chainifynet/aws-encryption-sdk-go) ⭐ 21 | 🐛 21 | 🌐 Go | 📅 2025-08-26 - Unofficial Go SDK implementation of the [AWS Encryption SDK](https://docs.aws.amazon.com/encryption-sdk/latest/developer-guide/index.html).
...
* [gopensky](https://github.com/navidys/gopensky) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2025-08-25 - Go client implementation for [OpenSKY Network](https://opensky-network.org/) live's API (airspace ADS-B and Mode S data).
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 73,229 | 🐛 302 | 🌐 Go | 📅 2025-08-26 - Command-line fuzzy finder written in Go.
* [dive](https://github.com/wagoodman/dive) ⭐ 51,833 | 🐛 178 | 🌐 Go | 📅 2025-08-21 - A tool for exploring each layer in a Docker image.
* [hub](https://github.com/github/hub) ⭐ 22,917 | 🐛 294 | 🌐 Go | 📅 2024-02-02 - wrap git commands with additional functionality to interact with github from the terminal.
* [lo](https://github.com/samber/lo) ⭐ 20,049 | 🐛 206 | 🌐 Go | 📅 2025-08-25 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,150 | 🐛 382 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,800 | 🐛 115 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 15,055 | 🐛 25 | 🌐 Go | 📅 2025-08-26 - Deliver Go binaries as fast and easily as possible.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,677 | 🐛 46 | 🌐 Go | 📅 2025-05-06 - Interactive cli tool for HTTP inspection.
* [usql](https://github.com/knq/usql) ⭐ 9,503 | 🐛 94 | 🌐 Go | 📅 2025-08-23 - usql is a universal command-line interface for SQL databases.
* [peco](https://github.com/peco/peco) ⭐ 7,782 | 🐛 52 | 🌐 Go | 📅 2025-06-21 - Simplistic interactive filtering tool.
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,170 | 🐛 8 | 🌐 Go | 📅 2025-08-21 - A comprehensive, efficient, and reusable util function library of go.
...
* [minify](https://github.com/tdewolff/minify) ⭐ 3,943 | 🐛 33 | 🌐 Go | 📅 2025-08-26 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
* [panicparse](https://github.com/maruel/panicparse) ⭐ 3,687 | 🐛 3 | 🌐 Go | 📅 2025-03-13 - Groups similar goroutines and colorizes stack dump.
* [mc](https://github.com/minio/mc) ⭐ 3,152 | 🐛 33 | 🌐 Go | 📅 2025-08-13 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
* [retry-go](https://github.com/avast/retry-go) ⭐ 2,767 | 🐛 15 | 🌐 Go | 📅 2025-08-25 - Simple library for retry mechanism.
...
* [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,257 | 🐛 2 | 🌐 Go | 📅 2025-08-21 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
* [jump](https://github.com/gsamokovarov/jump) ⭐ 1,875 | 🐛 2 | 🌐 Go | 📅 2025-07-16 - Jump helps you navigate faster by learning your habits.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,234 | 🐛 57 | 🌐 Go | 📅 2025-08-05 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [upterm](https://github.com/owenthereal/upterm) ⭐ 967 | 🐛 60 | 🌐 Go | 📅 2025-08-26 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
...
* [circuit](https://github.com/cep21/circuit) ⭐ 789 | 🐛 4 | 🌐 Go | 📅 2025-08-24 - An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern.
...
* [delve](https://github.com/derekparker/delve) ⭐ 656 | 🐛 2 | 🌐 Go | 📅 2025-08-24 - Go debugger.
...
* [scan](https://github.com/blockloop/scan) ⭐ 602 | 🐛 2 | 🌐 Go | 📅 2025-08-25 - Scan golang `sql.Rows` directly to structs, slices, or primitive types.
...
* [mani](https://github.com/alajmo/mani) ⭐ 576 | 🐛 22 | 🌐 Go | 📅 2025-05-26 - CLI tool to help you manage multiple repositories.
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,831 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,909 | 🐛 321 | 🌐 Go | 📅 2025-08-15 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 954 | 🐛 7 | 🌐 Go | 📅 2025-08-26 - A [Zod](https://github.com/colinhacks/zod) ⭐ 39,711 | 🐛 258 | 🌐 TypeScript | 📅 2025-08-26 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
* [gody](https://github.com/guiferpa/gody) ⭐ 168 | 🐛 1 | 🌐 Go | 📅 2025-05-30 - :balloon: A lightweight struct validator for Go.
* [jio](https://github.com/faceair/jio) ⭐ 117 | 🐛 2 | 🌐 Go | 📅 2024-07-04 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,147 | 🐛 185 | 🌐 JavaScript | 📅 2025-08-20.
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,802 | 🐛 179 | 🌐 Go | 📅 2025-08-26 - highly extensible Git implementation in pure Go.
...
* [froggit-go](https://github.com/jfrog/froggit-go) ⭐ 48 | 🐛 10 | 🌐 Go | 📅 2025-08-19 - Froggit-Go is a Go library, allowing to perform actions on VCS providers.
...
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 820 | 🐛 21 | 🌐 Go | 📅 2025-08-26 - Pure Go RTSP server and client library.
...
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 548 | 🐛 0 | 🌐 Go | 📅 2025-08-26 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
* [go-astiav](https://github.com/asticode/go-astiav) ⭐ 544 | 🐛 4 | 🌐 Go | 📅 2025-08-19 - Better C bindings for ffmpeg in GO.
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,725 | 🐛 874 | 🌐 Go | 📅 2025-08-12 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,486 | 🐛 84 | 🌐 Go | 📅 2025-08-26 - An Express.js inspired web framework build on Fasthttp.
* [Beego](https://github.com/beego/beego) ⭐ 32,220 | 🐛 20 | 🌐 Go | 📅 2025-08-21 - beego is an open-source, high-performance web framework for the Go programming language.
* [Echo](https://github.com/labstack/echo) ⭐ 31,452 | 🐛 109 | 🌐 Go | 📅 2025-08-25 - High performance, minimalist Go web framework.
* [Revel](https://github.com/revel/revel) ⭐ 13,221 | 🐛 99 | 🌐 Go | 📅 2023-10-28 - High-productivity web framework for the Go language.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,655 | 🐛 223 | 🌐 Go | 📅 2025-08-27 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 12,550 | 🐛 107 | 🌐 Go | 📅 2025-08-26 - Gofr is an opinionated microservice development framework.
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,660 | 🐛 38 | 🌐 Go | 📅 2025-08-26 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,930 | 🐛 35 | 🌐 Go | 📅 2025-08-25 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [goravel](https://github.com/goravel/goravel) ⭐ 3,992 | 🐛 55 | 🌐 Go | 📅 2025-08-23 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,346 | 🐛 136 | 🌐 Go | 📅 2025-08-05 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,493 | 🐛 41 | 🌐 Go | 📅 2025-08-26 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
...
* [templui](https://github.com/axzilla/templui) ⭐ 889 | 🐛 7 | 🌐 JavaScript | 📅 2025-08-26 - Modern UI Components for Go & Templ.
* [Yokai](https://github.com/ankorstore/yokai) ⭐ 748 | 🐛 1 | 🌐 Go | 📅 2025-06-17 - Simple, modular, and observable Go framework for backend applications.
* [iWF](https://github.com/indeedeng/iwf) ⭐ 589 | 🐛 76 | 🌐 Go | 📅 2025-08-27 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 542 | 🐛 36 | 🌐 Go | 📅 2025-08-24 - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
...
* [alice](https://github.com/justinas/alice) ⭐ 3,303 | 🐛 11 | 🌐 Go | 📅 2024-06-06 - Painless middleware chaining for Go.
* [render](https://github.com/unrolled/render) ⭐ 1,973 | 🐛 0 | 🌐 Go | 📅 2024-10-15 - Go package for easily rendering JSON, XML, and HTML template responses.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,549 | 🐛 34 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
* [chi](https://github.com/go-chi/chi) ⭐ 20,390 | 🐛 82 | 🌐 Go | 📅 2025-08-26 - Small, fast and expressive HTTP router built on net/context.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,610 | 🐛 529 | 🌐 Go | 📅 2025-08-23 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,167 | 🐛 116 | 🌐 Go | 📅 2025-08-11 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 239 | 🐛 17 | 🌐 Go | 📅 2025-08-26 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [go-ole](https://github.com/go-ole/go-ole) ⭐ 1,262 | 🐛 7 | 🌐 Go | 📅 2025-04-21 - Win32 OLE implementation for golang.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,549 | 🐛 107 | 🌐 Go | 📅 2025-08-26 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [workflow](https://github.com/luno/workflow) ⭐ 185 | 🐛 6 | 🌐 Go | 📅 2025-08-24 - A tech stack agnostic Event Driven Workflow framework.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,161 | 🐛 268 | 🌐 Go | 📅 2025-08-26 - Container Signing, Verification and Storage in an OCI registry.
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,531 | 🐛 255 | 🌐 Go | 📅 2025-08-26 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 111 | 🐛 21 | 🌐 Go | 📅 2025-08-26 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
* [Spire](https://github.com/spiffe/spire) ⭐ 2,031 | 🐛 156 | 🌐 Go | 📅 2025-08-27 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
* [in-toto](https://github.com/in-toto/in-toto-golang) ⭐ 140 | 🐛 40 | 🌐 Go | 📅 2025-08-26 - Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation.
* [Spiffe-Vault](https://github.com/philips-labs/spiffe-vault) ⭐ 92 | 🐛 2 | 🌐 Go | 📅 2025-08-26 - Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication.

## Code Analysis

*Source code analysis tools, also known as Static Application Security Testing (SAST) Tools.*

* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,560 | 🐛 114 | 🌐 Go | 📅 2025-08-26 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,552 | 🐛 586 | 🌐 Go | 📅 2025-08-08 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [revive](https://github.com/mgechev/revive) ⭐ 5,272 | 🐛 68 | 🌐 Go | 📅 2025-08-26 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,044 | 🐛 43 | 🌐 Go | 📅 2025-08-05 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 1,988 | 🐛 137 | 🌐 Go | 📅 2025-08-17 - source code linter that brings checks that are currently not implemented in other linters.
* [golines](https://github.com/segmentio/golines) ⭐ 1,102 | 🐛 71 | 🌐 Go | 📅 2025-08-25 - Formatter that automatically shortens long lines in Go code.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 822 | 🐛 71 | 🌐 Go | 📅 2025-08-26 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 150 | 🐛 39 | 🌐 Go | 📅 2025-08-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 25,072 | 🐛 373 | 🌐 Go | 📅 2025-08-25.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 577 | 🐛 14 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,780 | 🐛 102 | 🌐 Go | 📅 2025-08-25 features to Vim/Neovim.
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,820 | 🐛 615 | 🌐 Go | 📅 2025-08-21 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,356 | 🐛 71 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 117,082 | 🐛 2,644 | 🌐 Go | 📅 2025-08-26 - Container Cluster Manager from Google.
* [Moby](https://github.com/moby/moby) ⭐ 70,544 | 🐛 3,676 | 🌐 Go | 📅 2025-08-26 - Collaborative project for the container ecosystem to assemble container-based systems.
* [traefik](https://github.com/containous/traefik) ⭐ 56,215 | 🐛 669 | 🌐 Go | 📅 2025-08-26 - Reverse proxy and load balancer with support for multiple backends.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 50,329 | 🐛 2,791 | 🌐 Go | 📅 2025-08-26 - Fork of Gogs, entirely community driven.
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,861 | 🐛 553 | 🌐 Go | 📅 2025-08-26 - Run Kubernetes locally.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,605 | 🐛 140 | 🌐 Go | 📅 2025-08-26 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,596 | 🐛 758 | 🌐 Go | 📅 2025-08-26 - A modern load testing tool, using Go and JavaScript.
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,479 | 🐛 96 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
* [Hey](https://github.com/rakyll/hey) ⭐ 19,203 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,442 | 🐛 297 | 🌐 Go | 📅 2025-08-27 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,473 | 🐛 214 | 🌐 Go | 📅 2025-08-25 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,477 | 🐛 140 | 🌐 Go | 📅 2025-08-26 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,190 | 🐛 217 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,217 | 🐛 26 | 🌐 Go | 📅 2025-08-26 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,483 | 🐛 16 | 🌐 Go | 📅 2025-03-13 - High-performance load testing tool, written in Golang.
* [ko](https://github.com/google/ko) ⭐ 8,109 | 🐛 53 | 🌐 Go | 📅 2025-08-25 - Command line tool for building and deploying Go applications on Kubernetes
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,822 | 🐛 552 | 🌐 Go | 📅 2025-08-25 - Cloud native application delivery.
* [script](https://github.com/bitfield/script) ⭐ 6,809 | 🐛 41 | 🌐 Go | 📅 2025-03-22 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,479 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,976 | 🐛 253 | 🌐 Go | 📅 2025-08-25 - Little helper to run CNCF's k3s in Docker.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,677 | 🐛 30 | 🌐 Go | 📅 2025-08-25 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,445 | 🐛 2,691 | 🌐 Go | 📅 2025-08-27 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,234 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [tau](https://github.com/taubyte/tau) ⭐ 4,432 | 🐛 36 | 🌐 Go | 📅 2025-08-25 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,421 | 🐛 140 | 🌐 Go | 📅 2025-08-26 - Pomerium is an identity-aware access proxy.
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,536 | 🐛 148 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [bosun](https://github.com/bosun-monitor/bosun) ⚠️ Archived - Time Series Alerting Framework.
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,793 | 🐛 149 | 🌐 Go | 📅 2025-08-26 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,695 | 🐛 214 | 🌐 Go | 📅 2025-08-12 - aptly is a Debian repository management tool.
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,799 | 🐛 9 | 🌐 Go | 📅 2025-08-25 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
...
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,209 | 🐛 129 | 🌐 Go | 📅 2025-08-27 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
* [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,164 | 🐛 49 | 🌐 Go | 📅 2025-08-20 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 930 | 🐛 202 | 🌐 Go | 📅 2025-08-26 - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 388 | 🐛 14 | 🌐 Go | 📅 2025-08-25 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
* [croc](https://github.com/schollz/croc) ⭐ 30,916 | 🐛 12 | 🌐 Go | 📅 2025-08-25 - Easily and securely send files or folders from one computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,804 | 🐛 493 | 🌐 Go | 📅 2025-08-07 - De-duplicating backup program.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,616 | 🐛 608 | 🌐 Go | 📅 2025-08-27 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
* [Gor](https://github.com/buger/gor) ⭐ 19,067 | 🐛 340 | 🌐 Go | 📅 2025-04-05 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 12,076 | 🐛 153 | 🌐 Go | 📅 2025-08-26 - Distributed POSIX file system built on top of Redis and AWS S3.
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,439 | 🐛 92 | 🌐 Go | 📅 2025-08-25 - Proxy to simulate network and system conditions for automated tests.
...
* [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,705 | 🐛 408 | 🌐 C++ | 📅 2025-05-19 - LiteIDE is a simple, open source, cross-platform Go IDE.
* [scc](https://github.com/boyter/scc) ⭐ 7,590 | 🐛 54 | 🌐 Go | 📅 2025-08-23 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [drive](https://github.com/odeke-em/drive) ⭐ 6,726 | 🐛 287 | 🌐 Go | 📅 2024-02-09 - Google Drive client for the commandline.
* [nes](https://github.com/fogleman/nes) ⭐ 5,592 | 🐛 12 | 🌐 Go | 📅 2024-08-17 - Nintendo Entertainment System (NES) emulator written in Go.
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,575 | 🐛 69 | 🌐 Go | 📅 2025-08-26 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Documize](https://github.com/documize/community) ⭐ 2,281 | 🐛 46 | 🌐 JavaScript | 📅 2024-12-31 - Modern wiki software that integrates data from SaaS tools.
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,214 | 🐛 33 | 🌐 Go | 📅 2025-08-09 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,435 | 🐛 5 | 🌐 Go | 📅 2025-08-22 - Executing shell commands via http server (for prototyping or remote control).
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 613 | 🐛 8 | 🌐 Go | 📅 2025-08-26 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,439 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,802 | 🐛 2 | 🌐 Go | 📅 2024-12-22 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
* [gophers](https://github.com/egonelbre/gophers) ⭐ 3,708 | 🐛 5 | 🌐 Go | 📅 2022-07-06 - Free gophers.
* [gophers](https://github.com/ashleymcnamara/gophers) ⭐ 3,030 | 🐛 1 | 🌐 Go | 📅 2025-01-23 - Gopher artworks by Ashley McNamara.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,217 | 🐛 7,605 | 🌐 Go | 📅 2025-08-27
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,776 | 🐛 27 | 🌐 Makefile | 📅 2025-08-18
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,246 | 🐛 184 | 🌐 Go | 📅 2025-08-25
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 129,590 | 🐛 9,520 | 🌐 Go | 📅 2025-08-27 - List of projects on the Go community wiki.
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 39,576 | 🐛 8 | 📅 2025-07-30 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,783 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,800 | 🐛 66 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 23,089 | 🐛 68 | 🌐 Go | 📅 2025-08-21 - Learn Go with test-driven development.
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,454 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,697 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 7,034 | 🐛 8 | 🌐 Go | 📅 2025-08-25 - Clean Architecture template for Golang services.
...
* [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) ⭐ 1,101 | 🐛 6 | 🌐 Go | 📅 2025-08-27 - A GitHub repository offering coding challenges for Go technical interview preparation.
