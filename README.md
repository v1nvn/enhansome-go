...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 144,882](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 245,481.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 144,882 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 144,882; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,970 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,935 - Blazingly fast and light-weight Actor engine written in Golang.
...
- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 580 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,748 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,031 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 142,766 - Run large language models locally.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,686 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,034 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,112 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,106 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,610 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,671 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [paseto](https://github.com/o1egl/paseto) ⭐ 892 - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,332 - Session Manager for HTTP servers.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,073 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,506 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,931 - A complete implementation of a Lightning Network node.
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,313 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,172 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,333 - Telegram bot framework is written in Go.
- [telego](https://github.com/mymmrac/telego) ⭐ 718 - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,163 - Simple and clean Telegram bot client.
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,970 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,638 - Air - Live reload for Go apps.
...
- [Task](https://github.com/go-task/task) ⭐ 12,904 - simple "Make" alternative.
- [taskctl](https://github.com/taskctl/taskctl) ⭐ 311 - Concurrent task runner.
- [xc](https://github.com/joerdav/xc) ⭐ 1,290 - Task runner with README.md defined tasks, executable markdown.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,364 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 31,909 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,515 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,367 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,730.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,024 - Declaratively define styles for color, format and layout in the terminal.
...
- [pterm](https://github.com/pterm/pterm) ⭐ 5,097 - A library to beautify console output on every platform with many combinable components.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 665 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,272 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,616 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,020 - An expressive programming language and a versatile interactive shell.
...
- [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,149 - Struct-based argument parsing in Go.
...
- [pflag](https://github.com/spf13/pflag) ⭐ 2,566 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,219 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,506 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,315 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,224 - Go library for managing configuration data from environment variables.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,647 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,184 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,620 - Go configuration with fangs.
...
- [drone](https://github.com/drone/drone) ⭐ 32,812 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 151 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,562 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,726.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,100 - Woodpecker is a community fork of the Drone CI system.
...
- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,595 - Go package implementing Bloom filters.
...
- [algorithms](https://github.com/shady831213/algorithms) ⭐ 819 - Algorithms and data structures.CLRS study.
...
- [deque](https://github.com/gammazero/deque) ⭐ 684 - Fast ring-buffer deque (double-ended queue).
- [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) ⭐ 425 - Concurrent FIFO queue.
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,625 - Distributed, Fault-tolerant task queue.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,404 - Modern text indexing library for go.
...
- [gocache](https://github.com/eko/gocache) ⭐ 2,663 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [groupcache](https://github.com/golang/groupcache) ⭐ 13,179 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,103 -  A high performance memory-bound Go cache.
...
- [badger](https://github.com/dgraph-io/badger) ⭐ 14,625 - Fast key-value store in Go.
...
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 30,961 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,903 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,510 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,431 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,696 - Dolt – It's Git for Data.
...
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,267 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,702 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,121 - Scalable datastore for metrics, events, and real-time analytics.
- [ledisdb](https://github.com/siddontang/ledisdb) ⭐ 4,113 - Ledisdb is a high performance NoSQL like Redis based on LevelDB.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,117 - Milvus is a vector database for embedding management, analytics and search.
...
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,321 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,829 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,756 - Redis re-implemented with SQLite.
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,803 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,657 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,538 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,223 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,897 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,525 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,033 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,465 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,753 - Database migrations. CLI and Golang library.
...
- [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,753 - Go toolset to handle MySQL protocol and replication.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,617 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [goqu](https://github.com/doug-martin/goqu) ⭐ 2,527 - Idiomatic SQL builder and query library.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,203 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,236 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,431 - Go library that helps you build SQL queries.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,830 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,505 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 699 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,925 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,925 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,426 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,492 - Pure Go Postgres driver for database/sql.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,352 - Official MongoDB driver for the Go language.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,930 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,680 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 965 - Fast trigram based code search.
...
- [now](https://github.com/jinzhu/now) ⭐ 4,528 - Now is a time toolkit for golang.
...
- [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,182 - A feature complete and high performance multi-group Raft library in Go.
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,608 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,313 - A Go framework for the API or Microservice with handy scaffolding tools.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,066 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,322 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,136 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
...
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,029 - A cloud native Kubernetes Global Balancer.
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,463 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,404 - A modular-designed and easy-to-use microservices framework in Go.
...
- [micro](https://github.com/micro/micro) ⭐ 12,254 - A distributed systems runtime for the cloud and beyond.
...
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,272 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,607 - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 843 - Go implementation of the Raft consensus protocol, by CoreOS.
- [rain](https://github.com/cenkalti/rain) ⭐ 1,046 - BitTorrent client and library.
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,611 - Simplified distributed locking implementation using Redis.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,264).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,868 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,781 - BitTorrent client package.
...
- [GoDNS](https://github.com/timothyye/godns) ⭐ 1,580 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- [email](https://github.com/jordan-wright/email) ⭐ 2,732 - A robust and flexible email library for Go.
...
- [go-imap](https://github.com/emersion/go-imap) ⭐ 2,195 - IMAP library for clients and servers.
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 994 - A simple Go library for sending mails in Go.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,552 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,913 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,168 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 4,989 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,603.
...
- [expr](https://github.com/antonmedv/expr) ⭐ 6,891 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 7,977 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,264 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,183 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,603 - Lua 5.1 VM and compiler written in Go.
...
- [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,575 - The Wa Programming Language embedded in Go.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,656 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,220 - Go error library with error portability over the network.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 260 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
- [go-wkhtmltopdf](https://github.com/SebastiaanKlippert/go-wkhtmltopdf) ⭐ 1,120 - A package to convert an HTML template to a PDF file.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,673 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,791.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,761 - Arbitrary-precision fixed-point decimal numbers.
...
- [orderbook](https://github.com/i25959341/orderbook) ⭐ 488 - Matching Engine for Limit Order Book in Golang.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,263 - Terminal stock watcher and stock position tracker.
...
- [mo](https://github.com/samber/mo) ⭐ 2,985 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,086 - dead simple 2D game engine in Go.
...
- [g3n](https://github.com/g3n/engine) ⭐ 2,944 - Go 3D Game Engine.
...
- [goworld](https://github.com/xiaonanln/goworld) ⭐ 2,645 - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- [nano](https://github.com/lonng/nano) ⭐ 3,018 - Lightweight, facility, high performance golang based game server framework.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,061 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,218 - Generate decorators for Go interfaces using simple templates.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,167 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,378 - Compile shell scripts to Go.
...
- [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,970 - Compiler from Go to JavaScript.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,715 - A high-performance and low-cost goroutine pool in Go.
...
- [pond](https://github.com/alitto/pond) ⭐ 1,787 - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,389 - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 409 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 65,951 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,652.
...
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,249 - Build native macOS applications using Go.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,524 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [webview](https://github.com/zserge/webview) ⭐ 13,136 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,559 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [canvas](https://github.com/tdewolff/canvas) ⭐ 1,581 - Vector graphics to PDF, SVG or rasterized image.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,593 - 2D rendering in pure Go.
...
- [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 709 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
- [goimagehash](https://github.com/corona10/goimagehash) ⭐ 799 - Go Perceptual image hashing package.
...
- [govips](https://github.com/davidbyttow/govips) ⭐ 1,438 - A lightning fast image processing and resizing library for Go.
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,760 - Screenshoting webpages using go and headless chrome on command line.
...
- [transformimgs](https://github.com/Pixboost/transformimgs) ⭐ 261 - Transformimgs resizes and optimises images for Web using next-generation formats.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,113 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,878 - Simple, zero-dependency scheduling library for Go.
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,262 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,490.
...
- [glog](https://github.com/golang/glog) ⭐ 3,599 - Leveled execution logs for Go.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,279 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,279 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,279 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,279, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,066, [zap](https://github.com/uber-go/zap) ⭐ 23,154, [zerolog](https://github.com/rs/zerolog) ⭐ 11,461, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,112 - Simple rolling logger, implements io.WriteCloser.
...
- [pp](https://github.com/k0kubun/pp) ⭐ 1,949 - Colored pretty printer for Go language.
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,003 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,154 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,461 - Zero-allocation JSON logger.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 785 - An accelerated Machine Learning framework for Go.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,880 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,772 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,288 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 8,999 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,890 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,380 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,088 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,748 - Asynchronous task queue/job queue based on distributed message passing.
...
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,947 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,945 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,014 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,502 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [excelize](https://github.com/xuri/excelize) ⭐ 19,208 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,970 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
- [dig](https://github.com/uber-go/dig) ⭐ 4,190 - A reflection based dependency injection toolkit for Go.
- [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 184 - A dependency injection toolkit for Go, based on Guice.
- [do](https://github.com/samber/do) ⭐ 2,119 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,547 - A dependency injection based application framework for Go (built on top of dig).
...
- [gontainer](https://github.com/NVIDIA/gontainer) ⭐ 47 - A dependency injection service container for Go projects.
...
- [google/wire](https://github.com/google/wire) ⭐ 13,809 - Automated Initialization in Go.
...
- [cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) ⭐ 717 - A Go application boilerplate template for quick starting projects following production best practices.
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,550 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,595 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,595 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,236 - Nunu is a scaffolding tool for building Go applications.
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,532 - Rapid, easy full-stack web development starter kit built in Go.
...
- [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,113 - cross-platform, cli app to perform various operations on string.
...
- [archives](https://github.com/mholt/archives) ⭐ 238 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
- [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,235 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,496 - Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,944 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,203 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,525 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,136 which a Chinese word splitting algorithm.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,246 - Package and an accompanying tool to work with localized text.
- [go-mystem](https://github.com/dveselov/mystem) ⭐ 34 - CGo bindings to Yandex.Mystem - russian morphology analyzer.
- [go-pinyin](https://github.com/mozillazg/go-pinyin) ⭐ 1,685 - CN Hanzi to Hanyu Pinyin converter.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,720 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,356 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,606 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- [fortio](https://github.com/fortio/fortio) ⭐ 3,536 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,558 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,802 - BGP implemented in the Go Programming Language.
- [gopacket](https://github.com/google/gopacket) ⭐ 6,537 - Go library for packet processing with libpcap bindings.
- [gopcap](https://github.com/akrennmair/gopcap) ⭐ 492 - Go wrapper for libpcap.
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,369 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,497 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 749 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,706 - An implementation of the QUIC protocol in pure Go.
...
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,903 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [water](https://github.com/songgao/water) ⭐ 2,039 - Simple TUN/TAP library.
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,866 - A pure Go implementation of the WebRTC API.
...
- [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 252 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- [req](https://github.com/imroc/req) ⭐ 4,509 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,151 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,276 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,177 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,224 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,291 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [gup](https://github.com/nao1215/gup) ⭐ 412 - Update binaries installed by "go install".
...
- [syft](https://github.com/anchore/syft) ⭐ 7,090 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,415 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 169 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,043 - No instrumentation tracing for Golang applications via eBPF.
- [profile](https://github.com/pkg/profile) ⭐ 2,026 - Simple profiling support package for Go.
- [statsviz](https://github.com/arl/statsviz) ⭐ 3,299 - Live visualization of your Go application runtime statistics.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,362 - go generate based graphql server library.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,026 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,858 - gonum/plot provides an API for building and drawing plots in Go.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,014 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,152 - A secure low code honeypot framework, leveraging AI for System Virtualization.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,679 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,617 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [cbor](https://github.com/fxamacker/cbor) ⭐ 876 - Small, safe, and easy CBOR encoding and decoding library.
...
- [algernon](https://github.com/xyproto/algernon) ⭐ 2,908 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,688 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,534 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,527 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,491 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,389 - A self contained feature flag solution written in Go and Vue.js
...
- [minio](https://github.com/minio/minio) ⭐ 52,916 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,632 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,514 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,107 - Make SSH apps, just like that!
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,425 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,347 - A HTML templating language that has great developer tooling.
...
- [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 958 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
- [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,306 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,081 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,688 - Sacred extension to the standard go testing package.
...
- [gock](https://github.com/h2non/gock) ⭐ 2,170 - Versatile HTTP mocking made easy.
- [gomock](https://github.com/uber-go/mock) ⭐ 2,827 - Mocking framework for the Go programming language.
...
- [minimock](https://github.com/gojuno/minimock) ⭐ 683 - Mock generator for Go interfaces.
- [mockery](https://github.com/vektra/mockery) ⭐ 6,609 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 480 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,925.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,873 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [rod](https://github.com/go-rod/rod) ⭐ 5,953 - A Devtools driver to make web automation and scraping easy.
...
- [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,548 - Markdown processor in Go.
...
- [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,814 - Go library for the TOML format with query support and handy cli tools.
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,094 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,874 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,768 - Shell parser and formatter.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 24,237 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,509 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [github](https://github.com/google/go-github) ⭐ 10,821 - Go library for accessing the GitHub REST API v3.
- [githubql](https://github.com/shurcooL/githubql) ⭐ 1,149 - Go library for accessing the GitHub GraphQL API v4.
- [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 158 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
- [go-lark](https://github.com/go-lark/lark) ⭐ 221 - An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform.
...
- [google](https://github.com/google/google-api-go-client) ⭐ 4,245 - Auto-generated Google APIs for Go.
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 2,695 - Minio Go Library for Amazon S3 compatible cloud storage.
...
- [changie](https://github.com/miniscruff/changie) ⭐ 769 - Automated changelog tool for preparing releases with lots of customization options.
...
- [countries](https://github.com/biter777/countries) ⭐ 447 - Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standards.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 50,968 - A tool for exploring each layer in a Docker image.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,688 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,703 - Deliver Go binaries as fast and easily as possible.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,043 - A comprehensive, efficient, and reusable util function library of go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,516 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mani](https://github.com/alajmo/mani) ⭐ 550 - CLI tool to help you manage multiple repositories.
- [mc](https://github.com/minio/mc) ⭐ 3,055 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
- [mergo](https://github.com/imdario/mergo) ⭐ 2,995 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,811 - Package for MIME type detection based on magic numbers.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,055 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,965 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,383 - usql is a universal command-line interface for SQL databases.
...
- [uuid](https://github.com/google/uuid) ⭐ 5,672 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,125 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [gody](https://github.com/guiferpa/gody) ⭐ 147 - :balloon: A lightweight struct validator for Go.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,423 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 861 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,369 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,577 - highly extensible Git implementation in pure Go.
...
- [gortsplib](https://github.com/aler9/gortsplib) ⭐ 781 - Pure Go RTSP server and client library.
...
- [Beego](https://github.com/beego/beego) ⭐ 32,106 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,070 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 447 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,752 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,399 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,590 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 - Gin parameter automatic binding tool,gin rpc tools.
- [Goa](https://github.com/goadesign/goa) ⭐ 5,870 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 10,926 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,413 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [Gone](https://github.com/gone-io/gone) ⭐ 129 - A lightweight dependency injection and web framework inspired by Spring.
- [goravel](https://github.com/goravel/goravel) ⭐ 3,838 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,287 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,119 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 680 - Modern UI Components for Go & Templ.
...
- [CORS](https://github.com/rs/cors) ⭐ 2,783 - Easily add CORS capabilities to your API.
...
- [Limiter](https://github.com/ulule/limiter) ⭐ 2,212 - Dead simple rate limit middleware for Go.
...
- [alice](https://github.com/justinas/alice) ⭐ 3,253 - Painless middleware chaining for Go.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,879 - Small, fast and expressive HTTP router built on net/context.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,398 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,287 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,950 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,220 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [workflow](https://github.com/luno/workflow) ⭐ 162 - A tech stack agnostic Event Driven Workflow framework.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,964 - Container Signing, Verification and Storage in an OCI registry.
...
- [fatcontext](https://github.com/Crocmagnon/fatcontext) ⭐ 45 - Fatcontext detects nested contexts in loops or function literals.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,107 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,068 - Formatter that automatically shortens long lines in Go code.
- [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,004 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,181 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,688.
...
- [vacuum](https://github.com/daveshanley/vacuum) ⭐ 776 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 573 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,698 features to Vim/Neovim.
...
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,058 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,282 - Visualize call graph of your Go program using dot format.
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,585 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,767 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,394 - Fast cross-platform HTTP benchmarking tool.
...
- [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,483 - High-performance load testing tool, written in Golang.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,120 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,054 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,218 - Build powerful pipelines in any programming language.
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,746 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 48,908 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,960 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,922 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,830 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,841 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 27,939 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,188 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,023 - Command line tool for building and deploying Go applications on Kubernetes
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,509 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,377 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,708 - Cloud native application delivery.
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,160 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,495 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,839 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 355 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,086 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,710 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [tau](https://github.com/taubyte/tau) ⭐ 3,999 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,021 - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,270 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,359 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,391 - Simulate bad network connections.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,307 - Easily and securely send files or folders from one computer to another.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,897 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- [Gor](https://github.com/buger/gor) ⭐ 18,943 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,673 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [restic](https://github.com/restic/restic) ⭐ 28,838 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 694 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,365 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,663 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,273 - Proxy to simulate network and system conditions for automated tests.
...
- [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) ⭐ 2,120 - Go web framework benchmark.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,038 - A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,742 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [gophers](https://github.com/ashleymcnamara/gophers) ⭐ 3,005 - Gopher artworks by Ashley McNamara.
- [gophers](https://github.com/egonelbre/gophers) ⭐ 3,647 - Free gophers.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 30,961
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,137
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,538
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,182 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,611 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,181 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,607 - Golang ebook intro how to build a web app with golang.
...
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,508 - Curated list of Go design patterns, recipes and idioms.
...
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,846 - Learn Go with test-driven development.
