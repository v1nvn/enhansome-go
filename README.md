...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 147,257 | 🐛 125 | 🌐 Go | 📅 2025-07-12
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 381,762 | 🐛 45 | 📅 2025-07-05
[![Slack Widget](https://img.shields.io/badge/join-us%20on%20slack-gray.svg?longCache=true\&logo=slack\&colorB=red)](https://gophers.slack.com/messages/awesome)
[![Netlify Status](https://api.netlify.com/api/v1/badges/83a6dcbe-0da6-433e-b586-f68109286bd5/deploy-status)](https://app.netlify.com/sites/awesome-go/deploys)
[![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/avelino/awesome-go/)
[![Last Commit](https://img.shields.io/github/last-commit/avelino/awesome-go)](https://github.com/avelino/awesome-go/commits/main) ⭐ 147,257 | 🐛 125 | 🌐 Go | 📅 2025-07-12
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 250,107 | 🐛 479 | 🌐 Python | 📅 2025-07-05.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 147,257 | 🐛 125 | 🌐 Go | 📅 2025-07-12 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 147,257 | 🐛 125 | 🌐 Go | 📅 2025-07-12; you rock!
...
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 264 | 🐛 1 | 🌐 Go | 📅 2025-07-13 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
* [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,981 | 🐛 22 | 🌐 Go | 📅 2025-07-04 - Blazingly fast and light-weight Actor engine written in Golang.
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,265 | 🐛 87 | 🌐 Go | 📅 2024-08-22 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 629 | 🐛 12 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
* [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,124 | 🐛 372 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,829 | 🐛 473 | 🌐 Go | 📅 2025-07-13 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 146,418 | 🐛 1,892 | 🌐 Go | 📅 2025-07-12 - Run large language models locally.
...
* [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,735 | 🐛 24 | 🌐 Go | 📅 2025-06-27 - A low-level library to play sound on multiple platforms.
* [PortAudio](https://github.com/gordonklaus/portaudio) ⭐ 778 | 🐛 6 | 🌐 Go | 📅 2025-02-06 - Go bindings for the PortAudio audio I/O library.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,868 | 🐛 39 | 🌐 Go | 📅 2025-07-10 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [go-jose](https://github.com/go-jose/go-jose) ⭐ 418 | 🐛 35 | 🌐 Go | 📅 2025-07-11 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,101 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,250 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,130 | 🐛 5 | 🌐 Go | 📅 2025-07-13 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
* [keto](https://github.com/ory/keto) ⭐ 5,065 | 🐛 56 | 🌐 Go | 📅 2025-07-11 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,643 | 🐛 41 | 🌐 Go | 📅 2025-05-05 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,607 | 🐛 32 | 🌐 Go | 📅 2025-07-10 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
* [openfga](https://github.com/openfga/openfga) ⭐ 3,849 | 🐛 128 | 🌐 Go | 📅 2025-07-11 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 762 | 🐛 277 | 🌐 Go | 📅 2025-07-07 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,653 | 🐛 283 | 🌐 Go | 📅 2025-07-11 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 973 | 🐛 796 | 🌐 Go | 📅 2025-07-11 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,278 | 🐛 329 | 🌐 Go | 📅 2025-07-11 - Official Go implementation of the Ethereum protocol.
...
* [gossamer](https://github.com/ChainSafe/gossamer) ⭐ 451 | 🐛 397 | 🌐 Go | 📅 2025-07-14 - A Go implementation of the Polkadot Host.
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,567 | 🐛 1,102 | 🌐 Go | 📅 2025-07-11 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,971 | 🐛 820 | 🌐 Go | 📅 2025-07-11 - A complete implementation of a Lightning Network node.
* [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,349 | 🐛 140 | 🌐 Go | 📅 2025-03-14 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
* [bot](https://github.com/go-telegram/bot) ⭐ 1,225 | 🐛 12 | 🌐 Go | 📅 2025-07-08 - Zero-dependencies Telegram Bot library with additional UI components
...
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,390 | 🐛 55 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
* [telego](https://github.com/mymmrac/telego) ⭐ 736 | 🐛 3 | 🌐 Go | 📅 2025-07-01 - Telegram Bot API library for Golang with full one-to-one API implementation.
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,203 | 🐛 168 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
...
* [air](https://github.com/cosmtrek/air) ⭐ 21,020 | 🐛 181 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [Task](https://github.com/go-task/task) ⭐ 13,116 | 🐛 394 | 🌐 Go | 📅 2025-07-14 - simple "Make" alternative.
...
* [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,848 | 🐛 11 | 🌐 Go | 📅 2024-10-26 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
...
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,569 | 🐛 155 | 🌐 Go | 📅 2025-07-10 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 33,162 | 🐛 117 | 🌐 Go | 📅 2025-07-10 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,671 | 🐛 4 | 🌐 Go | 📅 2025-07-11 - Terminal JSON viewer & processor.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,384 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,822 | 🐛 673 | 🌐 Python | 📅 2025-07-03.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,289 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) ⭐ 553 | 🐛 12 | 🌐 Go | 📅 2023-12-20 - Style terminal text.
* [gookit/color](https://github.com/gookit/color) ⭐ 1,549 | 🐛 5 | 🌐 Go | 📅 2025-07-10 - Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows.
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,253 | 🐛 86 | 🌐 Go | 📅 2025-07-11 - Declaratively define styles for color, format and layout in the terminal.
...
* [pterm](https://github.com/pterm/pterm) ⭐ 5,165 | 🐛 64 | 🌐 Go | 📅 2025-07-10 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,847 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,385 | 🐛 103 | 🌐 Go | 📅 2025-07-10.
...
* [termui](https://github.com/gizak/termui) ⭐ 13,385 | 🐛 103 | 🌐 Go | 📅 2025-07-10 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,620 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
...
* [acmd](https://github.com/cristalhq/acmd) ⭐ 127 | 🐛 1 | 🌐 Go | 📅 2024-04-26 - Simple, useful, and opinionated CLI package in Go.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 741 | 🐛 40 | 🌐 Go | 📅 2025-07-01 - Command argument completion generator for spf13/cobra.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,345 | 🐛 74 | 🌐 Go | 📅 2025-07-13 - Multi-shell multi-command argument completer.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,110 | 🐛 318 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [elvish](https://github.com/elves/elvish) ⭐ 6,058 | 🐛 339 | 🌐 Go | 📅 2025-07-07 - An expressive programming language and a versatile interactive shell.
...
* [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,158 | 🐛 29 | 🌐 Go | 📅 2025-07-12 - Struct-based argument parsing in Go.
...
* [ops](https://github.com/nanovms/ops) ⭐ 1,367 | 🐛 140 | 🌐 Go | 📅 2025-06-29 - Unikernel Builder/Orchestrator.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,338 | 🐛 49 | 🌐 Go | 📅 2025-07-13 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,861 | 🐛 48 | 🌐 Go | 📅 2025-01-05 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
* [env](https://github.com/caarlos0/env) ⭐ 5,623 | 🐛 9 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,515 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,262 | 🐛 57 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,308 | 🐛 9 | 🌐 Go | 📅 2025-07-12 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
* [konf](https://github.com/nil-go/konf) ⭐ 324 | 🐛 5 | 🌐 Go | 📅 2025-07-07 - The simplest API for reading/watching config from file, env, flag and clouds (e.g. AWS, Azure, GCP).
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,393 | 🐛 22 | 🌐 Go | 📅 2025-07-08 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,857 | 🐛 519 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
* [xdg](https://github.com/adrg/xdg) ⭐ 843 | 🐛 6 | 🌐 Go | 📅 2025-07-10 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
* [CDS](https://github.com/ovh/cds) ⭐ 4,732 | 🐛 150 | 🌐 Go | 📅 2025-07-11 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
* [drone](https://github.com/drone/drone) ⭐ 32,961 | 🐛 74 | 🌐 Go | 📅 2025-07-11 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [go-semver-release](https://github.com/s0ders/go-semver-release) ⭐ 17 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - Automate the semantic versioning of Git repositories.
* [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 157 | 🐛 6 | 🌐 Go | 📅 2025-07-13 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
* [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 570 | 🐛 6 | 🌐 Go | 📅 2023-06-06 - go test output for humans.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,567 | 🐛 25 | 🌐 Go | 📅 2025-07-11 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,829 | 🐛 90 | 🌐 Rust | 📅 2025-07-10.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,236 | 🐛 345 | 🌐 Go | 📅 2025-07-14 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,409 | 🐛 528 | 🌐 Go | 📅 2025-07-13 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,138 | 🐛 138 | 🌐 Go | 📅 2025-07-12 - A high-performance ELT data integration framework with pluggable architecture.
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,733 | 🐛 69 | 🌐 Go | 📅 2025-07-10 - Go package implementing compressed bitsets.
...
* [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,626 | 🐛 18 | 🌐 Go | 📅 2024-12-10 - Go package implementing Bloom filters.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 17,014 | 🐛 68 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [go-shelve](https://github.com/lucmq/go-shelve) ⭐ 10 | 🐛 1 | 🌐 Go | 📅 2025-07-13 - A persistent, map-like object for the Go programming language. Supports multiple embedded key-value stores.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,823 | 🐛 78 | 🌐 TypeScript | 📅 2025-07-12 - Distributed, Fault-tolerant task queue.
...
* [go-edlib](https://github.com/hbollon/go-edlib) ⭐ 517 | 🐛 2 | 🌐 Go | 📅 2022-07-03 - Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode.
...
* [BigCache](https://github.com/allegro/bigcache) ⭐ 7,876 | 🐛 99 | 🌐 Go | 📅 2025-05-05 - Efficient key/value cache for gigabytes of data.
...
* [coherence-go-client](https://github.com/oracle/coherence-go-client) ⭐ 13 | 🐛 1 | 🌐 Go | 📅 2025-07-10 - Full implementation of Oracle Coherence cache API for Go applications using gRPC as network transport.
...
* [GCache](https://github.com/bluele/gcache) ⭐ 2,694 | 🐛 28 | 🌐 Go | 📅 2024-03-01 - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
* [gocache](https://github.com/eko/gocache) ⭐ 2,694 | 🐛 40 | 🌐 Go | 📅 2025-05-25 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,208 | 🐛 42 | 🌐 Go | 📅 2024-11-29 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,177 | 🐛 1 | 🌐 Go | 📅 2025-07-10 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,213 | 🐛 5 | 🌐 Go | 📅 2025-07-10 -  A high performance memory-bound Go cache.
...
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,757 | 🐛 28 | 🌐 Go | 📅 2025-07-10 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,908 | 🐛 43 | 🌐 Go | 📅 2025-07-10 - An embedded key/value database for Go.
* [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
* [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,737 | 🐛 32 | 🌐 Go | 📅 2024-09-10 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,083 | 🐛 7,408 | 🌐 Go | 📅 2025-07-14 - Scalable, Geo-Replicated, Transactional Datastore.
...
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,006 | 🐛 39 | 🌐 Go | 📅 2025-07-13 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,876 | 🐛 429 | 🌐 Go | 📅 2025-07-11 - Dolt – It's Git for Data.
...
* [godis](https://github.com/hdt3213/godis) ⭐ 3,722 | 🐛 16 | 🌐 Go | 📅 2025-07-05 - A Golang implemented high-performance Redis server and cluster.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,284 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,870 | 🐛 363 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 8,777 | 🐛 136 | 🌐 Go | 📅 2025-05-30 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,321 | 🐛 2,119 | 🌐 Rust | 📅 2025-07-11 - Scalable datastore for metrics, events, and real-time analytics.
...
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,941 | 🐛 691 | 🌐 Go | 📅 2025-07-14 - Milvus is a vector database for embedding management, analytics and search.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,378 | 🐛 297 | 🌐 Go | 📅 2025-07-13 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,443 | 🐛 693 | 🌐 Go | 📅 2025-07-11 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,870 | 🐛 3 | 🌐 Go | 📅 2025-07-13 - Redis re-implemented with SQLite.
* [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,830 | 🐛 2 | 🌐 Go | 📅 2025-04-22 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,750 | 🐛 77 | 🌐 Go | 📅 2025-07-13 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,719 | 🐛 5,182 | 🌐 Go | 📅 2025-07-14 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,522 | 🐛 785 | 🌐 Go | 📅 2025-07-12 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 7,031 | 🐛 219 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,736 | 🐛 122 | 🌐 Go | 📅 2025-07-14 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,127 | 🐛 28 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,731 | 🐛 97 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,987 | 🐛 436 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,328 | 🐛 18 | 🌐 Go | 📅 2025-07-11 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,350 | 🐛 91 | 🌐 Go | 📅 2025-04-17 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,787 | 🐛 151 | 🌐 Go | 📅 2025-07-10 - Go toolset to handle MySQL protocol and replication.
...
* [onedump](https://github.com/liweiyi88/onedump) ⭐ 200 | 🐛 0 | 🌐 Go | 📅 2025-07-02 - Database backup from different drivers to different destinations with one command and configuration.
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,192 | 🐛 1 | 🌐 Go | 📅 2025-06-30 - Advanced scheduling for PostgreSQL.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,946 | 🐛 35 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,840 | 🐛 886 | 🌐 Go | 📅 2025-07-13 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,272 | 🐛 42 | 🌐 Go | 📅 2025-07-03 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,520 | 🐛 617 | 🌐 Go | 📅 2025-07-09 - Generate type-safe code from SQL.
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,504 | 🐛 91 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
...
* [firebirdsql](https://github.com/nakagami/firebirdsql) ⭐ 243 | 🐛 14 | 🌐 Go | 📅 2025-05-09 - Firebird RDBMS SQL driver for Go.
...
* [go-mssqldb](https://github.com/denisenkom/go-mssqldb) ⭐ 1,856 | 🐛 177 | 🌐 Go | 📅 2025-04-26 - Microsoft MSSQL driver for Go.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,930 | 🐛 62 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,570 | 🐛 203 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 739 | 🐛 5 | 🌐 Go | 📅 2025-07-10 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,137 | 🐛 231 | 🌐 Go | 📅 2025-07-12 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,137 | 🐛 231 | 🌐 Go | 📅 2025-07-12 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,443 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
* [pq](https://github.com/lib/pq) ⭐ 9,541 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
...
* [surrealdb.go](https://github.com/surrealdb/surrealdb.go) ⭐ 279 | 🐛 30 | 🌐 Go | 📅 2025-07-13 - SurrealDB Driver for Go.
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 167 | 🐛 244 | 🌐 Go | 📅 2025-07-12 - native and database/sql driver YDB (Yandex Database)
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,392 | 🐛 14 | 🌐 Go | 📅 2025-07-14 - Official MongoDB driver for the Go language.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,072 | 🐛 98 | 🌐 Go | 📅 2025-07-11 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,719 | 🐛 14 | 🌐 Go | 📅 2025-07-13 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
* [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,099 | 🐛 95 | 🌐 Go | 📅 2025-07-11 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,913 | 🐛 82 | 🌐 Go | 📅 2025-07-01 - Official Elasticsearch client for Go.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1,007 | 🐛 23 | 🌐 Go | 📅 2025-06-27 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,102 | 🐛 1 | 🌐 Go | 📅 2025-07-12 - A simple, semantic and developer-friendly time package for golang.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,663 | 🐛 30 | 🌐 Go | 📅 2025-07-11 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [go-doudou](https://github.com/unionj-cloud/go-doudou) ⭐ 1,203 | 🐛 34 | 🌐 Go | 📅 2025-07-11 - A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,158 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,389 | 🐛 20 | 🌐 Go | 📅 2025-07-08 - A distributed systems development framework.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,410 | 🐛 352 | 🌐 Go | 📅 2025-07-13 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 22,011 | 🐛 140 | 🌐 Go | 📅 2025-07-11 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,527 | 🐛 55 | 🌐 Go | 📅 2025-07-10 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,588 | 🐛 125 | 🌐 Go | 📅 2025-06-01 - A modular-designed and easy-to-use microservices framework in Go.
...
* [lura](https://github.com/luraproject/lura) ⭐ 6,580 | 🐛 8 | 🌐 Go | 📅 2025-06-25 - Ultra performant API Gateway framework with middlewares.
* [micro](https://github.com/micro/micro) ⭐ 12,268 | 🐛 7 | 🌐 Go | 📅 2025-07-06 - A distributed systems runtime for the cloud and beyond.
...
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,487 | 🐛 461 | 🌐 Go | 📅 2025-07-14 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 619 | 🐛 55 | 🌐 Go | 📅 2025-07-10 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [outboxer](https://github.com/italolelis/outboxer) ⭐ 163 | 🐛 2 | 🌐 Go | 📅 2025-07-07 - Outboxer is a go library that implements the outbox pattern.
* [pglock](https://cirello.io/pglock) - PostgreSQL-backed distributed locking implementation.
* [pjrpc](https://gitlab.com/pjrpc/pjrpc) - Golang JSON-RPC Server-Client with Protobuf spec.
* [raft](https://github.com/hashicorp/raft) ⭐ 8,687 | 🐛 44 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/etcd-io/raft) ⭐ 877 | 🐛 70 | 🌐 Go | 📅 2025-07-10 - Go implementation of the Raft consensus protocol, by CoreOS.
* [rain](https://github.com/cenkalti/rain) ⭐ 1,048 | 🐛 2 | 🌐 Go | 📅 2025-07-01 - BitTorrent client and library.
* [redis-lock](https://github.com/bsm/redislock) ⭐ 1,633 | 🐛 4 | 🌐 Go | 📅 2025-06-09 - Simplified distributed locking implementation using Redis.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 381 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,360 | 🐛 356 | 🌐 C++ | 📅 2025-06-26).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,178 | 🐛 31 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 661 | 🐛 197 | 🌐 Go | 📅 2025-07-10 - Durable execution system for making code fault-tolerant and simple.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,809 | 🐛 63 | 🌐 Go | 📅 2025-07-11 - BitTorrent client package.
...
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,400 | 🐛 32 | 🌐 Go | 📅 2025-07-11 - A Go library for email verification without sending any emails.
...
* [go-imap](https://github.com/emersion/go-imap) ⭐ 2,208 | 🐛 60 | 🌐 Go | 📅 2025-07-09 - IMAP library for clients and servers.
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,036 | 🐛 4 | 🌐 Go | 📅 2025-07-11 - A simple Go library for sending mails in Go.
...
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,597 | 🐛 130 | 🌐 Go | 📅 2025-04-16 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,049 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,352 | 🐛 2 | 🌐 Go | 📅 2025-07-06 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,067 | 🐛 149 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,654 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,611 | 🐛 51 | 🌐 Go | 📅 2025-07-08 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,997 | 🐛 46 | 🌐 Go | 📅 2025-07-05 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,663 | 🐛 181 | 🌐 Go | 📅 2025-07-12 - PHP embedded in Go, with a `net/http` handler.
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,299 | 🐛 50 | 🌐 Go | 📅 2025-06-05 - Port of the Lua 5.2 VM to pure Go.
...
* [goja](https://github.com/dop251/goja) ⭐ 6,280 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [golua](https://github.com/aarzilli/golua) ⭐ 673 | 🐛 9 | 🌐 C | 📅 2025-02-17 - Go bindings for Lua C API.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,654 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [gval](https://github.com/PaesslerAG/gval) ⭐ 793 | 🐛 24 | 🌐 Go | 📅 2024-11-28 - A highly customizable expression language written in Go.
...
* [prolog](https://github.com/ichiban/prolog) ⭐ 675 | 🐛 24 | 🌐 Go | 📅 2025-07-05 - Embeddable Prolog.
...
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,594 | 🐛 5 | 🌐 Go | 📅 2025-07-14 - The Wa Programming Language embedded in Go.
...
* [afero](https://github.com/spf13/afero) ⭐ 6,267 | 🐛 153 | 🌐 Go | 📅 2025-07-10 - FileSystem Abstraction System for Go.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 98 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 72,003 | 🐛 294 | 🌐 Go | 📅 2025-07-13).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,608 | 🐛 51 | 🌐 Go | 📅 2025-07-09 - Disk usage analyzer with console interface.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,796 | 🐛 125 | 🌐 Go | 📅 2025-07-13 - PDF processor.
...
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,382 | 🐛 135 | 🌐 Go | 📅 2025-07-12 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,835 | 🐛 144 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
...
* [ledger](https://github.com/formancehq/ledger) ⭐ 990 | 🐛 8 | 🌐 Go | 📅 2025-07-14 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,320 | 🐛 37 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
...
* [go-functional](https://github.com/BooleanCat/go-functional) ⭐ 507 | 🐛 1 | 🌐 Go | 📅 2025-06-13 - Functional programming in Go using generics
...
* [mo](https://github.com/samber/mo) ⭐ 3,021 | 🐛 23 | 🌐 Go | 📅 2025-07-06 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,225 | 🐛 295 | 🌐 Go | 📅 2025-07-13 - dead simple 2D game engine in Go.
...
* [go-sdl2](https://github.com/veandco/go-sdl2) ⭐ 2,301 | 🐛 87 | 🌐 C | 📅 2025-02-20 - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).
...
* [Leaf](https://github.com/name5566/leaf) ⭐ 5,424 | 🐛 24 | 🌐 Go | 📅 2024-05-23 - Lightweight game server framework.
* [nano](https://github.com/lonng/nano) ⭐ 3,046 | 🐛 30 | 🌐 Go | 📅 2025-03-30 - Lightweight, facility, high performance golang based game server framework.
* [Oak](https://github.com/oakmound/oak) ⭐ 1,632 | 🐛 14 | 🌐 Go | 📅 2025-02-16 - Pure Go game engine.
* [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,573 | 🐛 58 | 🌐 Go | 📅 2025-07-11 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,100 | 🐛 4 | 🌐 C | 📅 2025-06-17 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) ⭐ 3,591 | 🐛 11 | 🌐 Go | 📅 2022-08-08 - .NET LINQ-like query methods for Go.
...
* [jennifer](https://github.com/dave/jennifer) ⭐ 3,517 | 🐛 17 | 🌐 Go | 📅 2024-09-08 - Generate arbitrary Go code without templates.
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,314 | 🐛 692 | 🌐 Go | 📅 2025-07-11 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [go2hx](https://github.com/go2hx/go2hx) ⭐ 136 | 🐛 32 | 🌐 Haxe | 📅 2025-07-13 - Compiler from Go to Haxe to Javascript/C++/Java/C#.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,821 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,995 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [go-actor](https://github.com/vladopajic/go-actor) ⭐ 233 | 🐛 0 | 🌐 Go | 📅 2025-06-05 - A tiny library for writing concurrent programs using actor model.
...
* [pond](https://github.com/alitto/pond) ⭐ 1,888 | 🐛 3 | 🌐 Go | 📅 2025-07-13 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [rill](https://github.com/destel/rill) ⭐ 1,687 | 🐛 2 | 🌐 Go | 📅 2025-02-02 - Go toolkit for clean, composable, channel-based concurrency.
...
* [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,399 | 🐛 20 | 🌐 Go | 📅 2025-02-13 - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 423 | 🐛 19 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,838 | 🐛 1,166 | 🌐 C++ | 📅 2025-07-11 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,687 | 🐛 17 | 🌐 Lua | 📅 2025-07-01.
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,040 | 🐛 227 | 🌐 Go | 📅 2025-07-14 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,748 | 🐛 746 | 🌐 Go | 📅 2025-07-12 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [ui](https://github.com/andlabs/ui) ⭐ 8,352 | 🐛 124 | 🌐 Go | 📅 2022-05-19 - Platform-native GUI library for Go. Cross platform.
...
* [walk](https://github.com/lxn/walk) ⭐ 6,986 | 🐛 346 | 🌐 Go | 📅 2024-01-21 - Windows application library kit for Go.
* [webview](https://github.com/zserge/webview) ⭐ 13,227 | 🐛 190 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,253 | 🐛 137 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,600 | 🐛 222 | 🌐 Go | 📅 2025-07-14 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
* [emgo](https://github.com/ziutek/emgo) ⭐ 1,085 | 🐛 13 | 🌐 C | 📅 2021-12-05 - Go-like language for programming embedded systems (e.g. STM32 MCU).
* [ghw](https://github.com/jaypipes/ghw) ⭐ 1,762 | 🐛 58 | 🌐 Go | 📅 2025-07-13 - Golang hardware discovery/inspection library.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 732 | 🐛 6 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,144 | 🐛 344 | 🌐 Go | 📅 2025-07-11 - Go package for computer vision using OpenCV 3.3+.
...
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,841 | 🐛 32 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
* [gridder](https://github.com/shomali11/gridder) ⭐ 80 | 🐛 0 | 🌐 Go | 📅 2021-09-30 - A Grid based 2D Graphics library.
* [image2ascii](https://github.com/qeesung/image2ascii) ⭐ 923 | 🐛 12 | 🌐 Go | 📅 2022-08-29 - Convert image to ASCII.
* [imagick](https://github.com/gographics/imagick) ⭐ 1,826 | 🐛 3 | 🌐 Go | 📅 2024-12-16 - Go binding to ImageMagick's MagickWand C API.
* [imaginary](https://github.com/h2non/imaginary) ⭐ 5,880 | 🐛 132 | 🌐 Go | 📅 2025-01-14 - Fast and simple HTTP microservice for image resizing.
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,527 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
* [imagor](https://github.com/cshum/imagor) ⭐ 3,685 | 🐛 39 | 🌐 Go | 📅 2025-06-30 - Fast, secure image processing server and Go library, using libvips.
...
* [picfit](https://github.com/thoas/picfit) ⭐ 2,254 | 🐛 12 | 🌐 Go | 📅 2025-06-10 - An image resizing server written in Go.
...
* [smartcrop](https://github.com/muesli/smartcrop) ⭐ 1,838 | 🐛 9 | 🌐 Go | 📅 2023-07-06 - Finds good crops for arbitrary images and crop sizes.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,612 | 🐛 60 | 🌐 Go | 📅 2025-07-14 - Lightweight data stream processing engine for IoT edge.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,219 | 🐛 103 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,198 | 🐛 8 | 🌐 Go | 📅 2025-07-10 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
* [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 | 🐛 39 | 🌐 Go | 📅 2019-11-04 - Lightweight stream processing engine for IoT.
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,355 | 🐛 30 | 🌐 Go | 📅 2025-07-11 - Kubernetes native IoT development framework.
...
* [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,893 | 🐛 3 | 🌐 Go | 📅 2025-05-24 - Simple, zero-dependency scheduling library for Go.
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,361 | 🐛 18 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,042 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,372 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,372 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,372 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,372 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,158 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,348 | 🐛 165 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,596 | 🐛 140 | 🌐 Go | 📅 2025-04-18, etc).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,162 | 🐛 99 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 974 | 🐛 53 | 🌐 Go | 📅 2025-07-08 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
...
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,269 | 🐛 65 | 🌐 Go | 📅 2024-04-06 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
* [tail](https://github.com/hpcloud/tail) ⭐ 2,766 | 🐛 75 | 🌐 Go | 📅 2022-10-25 - Go package striving to emulate the features of the BSD tail program.
...
* [zap](https://github.com/uber-go/zap) ⭐ 23,348 | 🐛 165 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,596 | 🐛 140 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [catboost-cgo](https://github.com/mirecl/catboost-cgo) ⭐ 16 | 🐛 5 | 🌐 C | 📅 2025-07-08 - Fast, scalable, high performance Gradient Boosting on Decision Trees library. Golang using Cgo for blazing fast inference CatBoost Model.
...
* [GoLearn](https://github.com/sjwhitworth/golearn) ⭐ 9,413 | 🐛 89 | 🌐 Go | 📅 2024-01-15 - General Machine Learning library for Go.
...
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 430 | 🐛 7 | 🌐 Go | 📅 2025-07-11 - Huggingface transformer pipelines for golang with onnxruntime.
* [libsvm](https://github.com/datastream/libsvm) ⭐ 73 | 🐛 1 | 🌐 Go | 📅 2016-05-09 - libsvm golang version derived work based on LIBSVM 3.14.
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,892 | 🐛 60 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
* [tfgo](https://github.com/galeone/tfgo) ⭐ 2,476 | 🐛 20 | 🌐 Go | 📅 2024-03-13 - Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python.
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,810 | 🐛 18 | 🌐 Go | 📅 2025-07-08 - Go RabbitMQ Client Library.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,575 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,120 | 🐛 22 | 🌐 Go | 📅 2025-07-13 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,943 | 🐛 283 | 🌐 HTML | 📅 2025-07-13 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
* [dbus](https://github.com/godbus/dbus) ⭐ 1,073 | 🐛 58 | 🌐 Go | 📅 2024-11-09 - Native Go bindings for D-Bus.
...
* [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,889 | 🐛 27 | 🌐 Go | 📅 2024-06-19 - The lightweight event bus with async compatibility.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,428 | 🐛 58 | 🌐 Go | 📅 2025-07-05 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,095 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,096 | 🐛 57 | 🌐 Go | 📅 2025-07-13 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,654 | 🐛 123 | 🌐 Go | 📅 2025-07-03 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [excelize](https://github.com/xuri/excelize) ⭐ 19,366 | 🐛 126 | 🌐 Go | 📅 2025-07-10 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,985 | 🐛 9 | 🌐 Go | 📅 2025-04-18 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
* [dig](https://github.com/uber-go/dig) ⭐ 4,221 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 185 | 🐛 15 | 🌐 Go | 📅 2025-05-27 - A dependency injection toolkit for Go, based on Guice.
* [do](https://github.com/samber/do) ⭐ 2,191 | 🐛 45 | 🌐 Go | 📅 2025-07-05 - A dependency injection framework based on Generics.
* [fx](https://github.com/uber-go/fx) ⭐ 6,653 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
...
* [google/wire](https://github.com/google/wire) ⭐ 13,939 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,821 | 🐛 0 | 🌐 Go | 📅 2025-07-12 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,821 | 🐛 0 | 🌐 Go | 📅 2025-07-12 for building production grade scalable web service applications.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,845 | 🐛 24 | 🌐 Go | 📅 2025-07-10 - Allows users to spin up a quick Go project using a popular framework.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,069 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,069 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
...
* [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,566 | 🐛 2 | 🌐 Go | 📅 2025-06-24 - Rapid, easy full-stack web development starter kit built in Go.
...
* [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,140 | 🐛 12 | 🌐 Go | 📅 2025-05-29 - cross-platform, cli app to perform various operations on string.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,681 | 🐛 225 | 🌐 Go | 📅 2025-07-11 - Automated service health dashboard.
...
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,996 | 🐛 13 | 🌐 Go | 📅 2025-06-26 - Random data generator written in go.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,306 | 🐛 213 | 🌐 Go | 📅 2025-07-10 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,283 | 🐛 83 | 🌐 Go | 📅 2024-07-26 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
* [xz](https://github.com/ulikunitz/xz) ⭐ 517 | 🐛 17 | 🌐 Go | 📅 2025-02-27 - Pure golang package for reading and writing xz-compressed files.
...
* [govader](https://github.com/jonreiter/govader) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2025-04-29 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,760 | 🐛 55 | 🌐 Python | 📅 2024-03-16.
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,542 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,243 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 75 | 🐛 0 | 🌐 Go | 📅 2025-07-13 - Package bart provides a fast routing table algorithm.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 11,020 | 🐛 442 | 🌐 Go | 📅 2025-07-07 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [dns](https://github.com/miekg/dns) ⭐ 8,419 | 🐛 9 | 🌐 Go | 📅 2025-07-09 - Go library for working with DNS.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,735 | 🐛 99 | 🌐 Go | 📅 2025-07-11 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [fortio](https://github.com/fortio/fortio) ⭐ 3,557 | 🐛 81 | 🌐 Go | 📅 2025-07-11 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
* [gev](https://github.com/Allenxuxu/gev) ⭐ 1,757 | 🐛 14 | 🌐 Go | 📅 2025-06-07 - gev is a lightweight, fast non-blocking TCP network library based on Reactor mode.
...
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,644 | 🐛 1 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,825 | 🐛 225 | 🌐 Go | 📅 2025-07-13 - BGP implemented in the Go Programming Language.
* [gopacket](https://github.com/google/gopacket) ⭐ 6,565 | 🐛 360 | 🌐 Go | 📅 2025-03-19 - Go library for packet processing with libpcap bindings.
* [gopcap](https://github.com/akrennmair/gopcap) ⭐ 491 | 🐛 11 | 🌐 Go | 📅 2021-05-17 - Go wrapper for libpcap.
* [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,400 | 🐛 85 | 🌐 Go | 📅 2025-07-10 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,177 | 🐛 131 | 🌐 Go | 📅 2025-07-11 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,274 | 🐛 41 | 🌐 Go | 📅 2025-07-13 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
* [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,354 | 🐛 26 | 🌐 Go | 📅 2025-06-17 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,134 | 🐛 2 | 🌐 Go | 📅 2025-07-14 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,816 | 🐛 187 | 🌐 Go | 📅 2025-07-12 - An implementation of the QUIC protocol in pure Go.
...
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,941 | 🐛 56 | 🌐 Go | 📅 2025-01-27 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,986 | 🐛 15 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,045 | 🐛 100 | 🌐 Go | 📅 2025-07-11 - A pure Go implementation of the WebRTC API.
...
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 284 | 🐛 6 | 🌐 Go | 📅 2025-07-14 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,159 | 🐛 73 | 🌐 Go | 📅 2025-07-07 - Retryable HTTP client in Go.
...
* [heimdall](https://github.com/gojektech/heimdall) ⭐ 2,683 | 🐛 50 | 🌐 Go | 📅 2024-05-29 - An enhanced http client with retry and hystrix capabilities.
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,042 | 🐛 36 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,197 | 🐛 37 | 🌐 Go | 📅 2025-06-17 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,359 | 🐛 19 | 🌐 Go | 📅 2025-07-09 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,251 | 🐛 26 | 🌐 Go | 📅 2025-07-11 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,352 | 🐛 586 | 🌐 Go | 📅 2025-07-11 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,507 | 🐛 469 | 🌐 Go | 📅 2025-07-07 - The fantastic ORM library for Golang, aims to be developer friendly.
...
* [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,306 | 🐛 115 | 🌐 Go | 📅 2025-07-11 - Prisma Client Go, Typesafe database access for Go.
...
* [gup](https://github.com/nao1215/gup) ⭐ 419 | 🐛 6 | 🌐 Go | 📅 2025-07-09 - Update binaries installed by "go install".
...
* [syft](https://github.com/anchore/syft) ⭐ 7,330 | 🐛 475 | 🌐 Go | 📅 2025-07-14 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [go-instrument](https://github.com/nikolaydubina/go-instrument) ⭐ 269 | 🐛 0 | 🌐 Go | 📅 2025-07-12 - Automatically add spans to all methods and functions.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,577 | 🐛 318 | 🌐 Go | 📅 2025-07-14 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 172 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,084 | 🐛 337 | 🌐 C++ | 📅 2025-07-11 - No instrumentation tracing for Golang applications via eBPF.
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,499 | 🐛 47 | 🌐 Go | 📅 2025-07-10 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,405 | 🐛 370 | 🌐 Go | 📅 2025-07-07 - go generate based graphql server library.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,222 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,269 | 🐛 1 | 🌐 Go | 📅 2025-07-13 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [booster](https://github.com/anatol/booster) ⭐ 577 | 🐛 72 | 🌐 Go | 📅 2025-07-12 - Fast initramfs generator with full-disk encryption support.
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,509 | 🐛 28 | 🌐 Go | 📅 2025-07-13 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
* [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,276 | 🐛 24 | 🌐 Go | 📅 2025-07-07 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,750 | 🐛 94 | 🌐 Go | 📅 2025-07-13 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
* [dongle](https://github.com/golang-module/dongle) ⭐ 988 | 🐛 2 | 🌐 Go | 📅 2025-07-14 - A simple, semantic and developer-friendly golang package for encoding\&decoding and encryption\&decryption.
...
* [go-yara](https://github.com/hillu/go-yara) ⭐ 372 | 🐛 8 | 🌐 Go | 📅 2025-07-01 - Go Bindings for [YARA](https://github.com/plusvic/yara) ⭐ 139 | 🐛 1 | 🌐 C | 📅 2020-03-13, the "pattern matching swiss knife for malware researchers (and everyone else)".
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,719 | 🐛 157 | 🌐 Go | 📅 2025-07-13 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
* [luks.go](https://github.com/anatol/luks.go) ⭐ 90 | 🐛 3 | 🌐 Go | 📅 2025-03-16 - Pure Golang library to manage LUKS partitions.
* [memguard](https://github.com/awnumar/memguard) ⭐ 2,643 | 🐛 9 | 🌐 Go | 📅 2025-07-13 - A pure Go library for handling sensitive values in memory.
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 896 | 🐛 26 | 🌐 Go | 📅 2025-07-14 - Small, safe, and easy CBOR encoding and decoding library.
* [colfer](https://github.com/pascaldekloe/colfer) ⭐ 749 | 🐛 10 | 🌐 Java | 📅 2024-08-07 - Code generation for the Colfer binary format.
* [csvutil](https://github.com/jszwec/csvutil) ⭐ 995 | 🐛 1 | 🌐 Go | 📅 2025-03-15 - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
...
* [go-codec](https://github.com/ugorji/go) ⭐ 1,898 | 🐛 2 | 🌐 Go | 📅 2025-06-17 - High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support.
...
* [jsoniter](https://github.com/json-iterator/go) ⭐ 13,819 | 🐛 267 | 🌐 Go | 📅 2024-05-27 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
* [algernon](https://github.com/xyproto/algernon) ⭐ 2,923 | 🐛 28 | 🌐 Go | 📅 2025-06-27 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,464 | 🐛 224 | 🌐 Go | 📅 2025-07-12 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
* [Clace](https://github.com/claceio/clace) ⭐ 638 | 🐛 2 | 🌐 Go | 📅 2025-06-11 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
* [consul](https://www.consul.io/) - Consul is a tool for service discovery, monitoring and configuration.
* [cortex-tenant](https://github.com/blind-oracle/cortex-tenant) ⭐ 125 | 🐛 2 | 🌐 Go | 📅 2025-06-04 - Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels.
...
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,836 | 🐛 22 | 🌐 Go | 📅 2025-07-13 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,833 | 🐛 313 | 🌐 Go | 📅 2025-07-13 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,606 | 🐛 49 | 🌐 Go | 📅 2025-07-12 - Fider is an open platform to collect and organize customer feedback.
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,506 | 🐛 6 | 🌐 Go | 📅 2025-06-23 - Flagr is an open-source feature flagging and A/B testing service.
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,458 | 🐛 55 | 🌐 Go | 📅 2025-07-14 - A self contained feature flag solution written in Go and Vue.js
...
* [go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) ⭐ 143 | 🐛 41 | 🌐 Go | 📅 2025-07-13 - Simple Reverse Proxy with Caching, written in Go, using Redis.
...
* [minio](https://github.com/minio/minio) ⭐ 53,776 | 🐛 54 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 49,099 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,688 | 🐛 111 | 🌐 Go | 📅 2025-07-12 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,036 | 🐛 46 | 🌐 Go | 📅 2025-06-30 - HTTP reverse proxy cache and time series accelerator.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,206 | 🐛 15 | 🌐 Go | 📅 2025-06-23 - Make SSH apps, just like that!
...
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,487 | 🐛 53 | 🌐 Go | 📅 2025-03-21 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
* [pongo2](https://github.com/flosch/pongo2) ⭐ 2,960 | 🐛 72 | 🌐 Go | 📅 2024-08-14 - Django-like template-engine for Go.
* [quicktemplate](https://github.com/valyala/quicktemplate) ⭐ 3,233 | 🐛 40 | 🌐 Go | 📅 2024-07-21 - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
...
* [sprout](https://github.com/go-sprout/sprout) ⭐ 174 | 🐛 4 | 🌐 Go | 📅 2025-06-30 - Useful template functions for Go templates.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,478 | 🐛 70 | 🌐 Go | 📅 2025-07-12 - A HTML templating language that has great developer tooling.
...
* [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 979 | 🐛 7 | 🌐 Go | 📅 2025-06-02 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-07-12 - HTTP client testing framework.
...
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,462 | 🐛 47 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
...
* [go-snaps](http://github.com/gkampitakis/go-snaps) ⭐ 220 | 🐛 8 | 🌐 Go | 📅 2025-06-04 - Jest-like snapshot testing in Golang.
...
* [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,313 | 🐛 3 | 🌐 Go | 📅 2025-07-03 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
* [godog](https://github.com/cucumber/godog) ⭐ 2,460 | 🐛 83 | 🌐 Go | 📅 2025-07-07 - Cucumber BDD framework for Go.
...
* [Gont](https://github.com/stv0g/gont) ⭐ 84 | 🐛 13 | 🌐 Go | 📅 2025-07-14 - Go network testing toolkit for testing building complex network topologies using Linux namespaces.
...
* [is](https://github.com/matryer/is) ⭐ 1,903 | 🐛 7 | 🌐 Go | 📅 2024-02-08 - Professional lightweight testing mini-framework for Go.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,287 | 🐛 240 | 🌐 Go | 📅 2025-07-13 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,186 | 🐛 140 | 🌐 Go | 📅 2025-07-09 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
* [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,165 | 🐛 24 | 🌐 Go | 📅 2025-07-12 - A helper for Rails' like test fixtures to test database applications.
* [Testify](https://github.com/stretchr/testify) ⭐ 24,892 | 🐛 371 | 🌐 Go | 📅 2025-07-01 - Sacred extension to the standard go testing package.
...
* [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,054 | 🐛 28 | 🌐 Go | 📅 2025-07-10 - Tool for generating self-contained mock objects.
...
* [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,395 | 🐛 41 | 🌐 Go | 📅 2024-09-11 - Mock SQL driver for testing database interactions.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,913 | 🐛 97 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [minimock](https://github.com/gojuno/minimock) ⭐ 708 | 🐛 9 | 🌐 Go | 📅 2025-06-10 - Mock generator for Go interfaces.
* [mockery](https://github.com/vektra/mockery) ⭐ 6,690 | 🐛 43 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [moq](https://github.com/matryer/moq) ⭐ 2,109 | 🐛 27 | 🌐 Go | 📅 2025-02-13 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 498 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,137 | 🐛 231 | 🌐 Go | 📅 2025-07-12.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,014 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,791 | 🐛 54 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
* [rod](https://github.com/go-rod/rod) ⭐ 6,072 | 🐛 185 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,830 | 🐛 33 | 🌐 Go | 📅 2025-05-10 - Go library for the TOML format with query support and handy cli tools.
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,184 | 🐛 9 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,928 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,755 | 🐛 19 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
...
* [editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) ⭐ 147 | 🐛 5 | 🌐 Go | 📅 2025-06-10 - Editorconfig file parser and manipulator for Go.
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,269 | 🐛 6 | 🌐 Go | 📅 2025-07-08 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,860 | 🐛 102 | 🌐 Go | 📅 2025-07-07 - Shell parser and formatter.
...
* [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,441 | 🐛 26 | 🌐 Go | 📅 2025-04-04 - HTML Sanitizer.
* [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 | 🐛 1 | 🌐 Go | 📅 2025-06-01 - A sanitization-based swear filter for Go.

### Scrapers

* [colly](https://github.com/asciimoo/colly) ⭐ 24,435 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,591 | 🐛 3 | 🌐 Go | 📅 2025-07-11 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,151 | 🐛 81 | 🌐 Go | 📅 2025-07-09 - The official AWS SDK for the Go programming language.
...
* [geo-golang](https://github.com/codingsince1985/geo-golang) ⭐ 533 | 🐛 7 | 🌐 Go | 📅 2025-03-26 - Go Library to access [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro), [MapQuest](https://developer.mapquest.com/documentation/api/geocoding/), [Nominatim](https://nominatim.org/release-docs/latest/api/Overview/), [OpenCage](https://opencagedata.com/api), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx), [Mapbox](https://www.mapbox.com/developers/api/geocoding/), and [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim) geocoding / reverse geocoding APIs.
* [github](https://github.com/google/go-github) ⭐ 10,859 | 🐛 32 | 🌐 Go | 📅 2025-07-10 - Go library for accessing the GitHub REST API v3.
...
* [go-jira](https://github.com/andygrunwald/go-jira) ⭐ 1,544 | 🐛 182 | 🌐 Go | 📅 2025-07-06 - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,156 | 🐛 210 | 🌐 Go | 📅 2025-07-12 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,288 | 🐛 387 | 🌐 Go | 📅 2025-07-14 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,740 | 🐛 21 | 🌐 Go | 📅 2025-07-10 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [slack](https://github.com/slack-go/slack) ⭐ 4,810 | 🐛 102 | 🌐 Go | 📅 2025-07-04 - Slack API in Go.
...
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,347 | 🐛 10 | 🌐 Go | 📅 2025-07-11 - Go client for the Stripe API.
...
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) ⭐ 1,148 | 🐛 23 | 🌐 Go | 📅 2024-05-15 - Circuit Breakers in Go.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 380 | 🐛 37 | 🌐 Go | 📅 2025-07-07 - Cross Platform tool to validate configuration files.
...
* [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,709 | 🐛 7 | 🌐 Go | 📅 2025-06-09 - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,274 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,387 | 🐛 169 | 🌐 Go | 📅 2025-07-07 - A tool for exploring each layer in a Docker image.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 72,003 | 🐛 294 | 🌐 Go | 📅 2025-07-13 - Command-line fuzzy finder written in Go.
...
* [go-funk](https://github.com/thoas/go-funk) ⭐ 4,911 | 🐛 8 | 🌐 Go | 📅 2024-07-24 - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,895 | 🐛 22 | 🌐 Go | 📅 2025-07-14 - Deliver Go binaries as fast and easily as possible.
...
* [immortal](https://github.com/immortal/immortal) ⭐ 820 | 🐛 2 | 🌐 Go | 📅 2024-07-21 - \*nix cross-platform (OS agnostic) supervisor.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,113 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - A comprehensive, efficient, and reusable util function library of go.
...
* [lo](https://github.com/samber/lo) ⭐ 19,734 | 🐛 206 | 🌐 Go | 📅 2025-07-07 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [mani](https://github.com/alajmo/mani) ⭐ 560 | 🐛 20 | 🌐 Go | 📅 2025-05-26 - CLI tool to help you manage multiple repositories.
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,829 | 🐛 42 | 🌐 Go | 📅 2025-07-12 - Package for MIME type detection based on magic numbers.
* [minify](https://github.com/tdewolff/minify) ⭐ 3,909 | 🐛 34 | 🌐 Go | 📅 2025-07-07 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
* [retry-go](https://github.com/avast/retry-go) ⭐ 2,724 | 🐛 14 | 🌐 Go | 📅 2025-03-21 - Simple library for retry mechanism.
...
* [rospo](https://github.com/ferama/rospo) ⭐ 339 | 🐛 7 | 🌐 Go | 📅 2025-06-22 - Simple and reliable ssh tunnels with embedded ssh server in Golang.
...
* [scany](https://github.com/georgysavva/scany) ⭐ 1,443 | 🐛 6 | 🌐 Go | 📅 2025-03-19 - Library for scanning data from a database into Go structs and more.
* [serve](https://github.com/syntaqx/serve) ⭐ 345 | 🐛 2 | 🌐 Go | 📅 2025-05-05 - A static http server anywhere you need.
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,141 | 🐛 54 | 🌐 Go | 📅 2025-07-10 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,043 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
...
* [upterm](https://github.com/owenthereal/upterm) ⭐ 938 | 🐛 51 | 🌐 Go | 📅 2025-07-07 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
* [usql](https://github.com/knq/usql) ⭐ 9,425 | 🐛 95 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
...
* [guid](https://github.com/sdrapkin/guid) ⭐ 67 | 🐛 1 | 🌐 Go | 📅 2025-07-12 - Fast cryptographically safe Guid generator for Go (\~10x faster than `uuid`).
...
* [uuid](https://github.com/google/uuid) ⭐ 5,730 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [gody](https://github.com/guiferpa/gody) ⭐ 157 | 🐛 1 | 🌐 Go | 📅 2025-05-30 - :balloon: A lightweight struct validator for Go.
...
* [jio](https://github.com/faceair/jio) ⭐ 118 | 🐛 2 | 🌐 Go | 📅 2024-07-04 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,121 | 🐛 192 | 🌐 JavaScript | 📅 2025-06-18.
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,949 | 🐛 57 | 🌐 Go | 📅 2024-03-23 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,643 | 🐛 323 | 🌐 Go | 📅 2025-07-02 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 903 | 🐛 6 | 🌐 Go | 📅 2025-07-13 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,996 | 🐛 529 | 🌐 TypeScript | 📅 2025-07-11 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,714 | 🐛 162 | 🌐 Go | 📅 2025-07-11 - highly extensible Git implementation in pure Go.
...
* [go-astiav](https://github.com/asticode/go-astiav) ⭐ 523 | 🐛 3 | 🌐 Go | 📅 2025-05-23 - Better C bindings for ffmpeg in GO.
...
* [libvlc-go](https://github.com/adrg/libvlc-go) ⭐ 472 | 🐛 10 | 🌐 Go | 📅 2025-06-03 - Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player).
* [m3u8](https://github.com/grafov/m3u8) ⚠️ Archived - Parser and generator library of M3U8 playlists for Apple HLS.
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 530 | 🐛 1 | 🌐 Go | 📅 2025-07-11 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
...
* [Beego](https://github.com/beego/beego) ⭐ 32,143 | 🐛 19 | 🌐 Go | 📅 2025-07-10 - beego is an open-source, high-performance web framework for the Go programming language.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,256 | 🐛 106 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 482 | 🐛 17 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,124 | 🐛 105 | 🌐 Go | 📅 2025-07-13 - An Express.js inspired web framework build on Fasthttp.
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 534 | 🐛 32 | 🌐 Go | 📅 2025-07-09 - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
...
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,439 | 🐛 39 | 🌐 Go | 📅 2025-07-08 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,104 | 🐛 855 | 🌐 Go | 📅 2025-07-13 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 | 🐛 13 | 🌐 Go | 📅 2025-07-05 - Gin parameter automatic binding tool,gin rpc tools.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,895 | 🐛 25 | 🌐 Go | 📅 2025-07-12 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 12,241 | 🐛 82 | 🌐 Go | 📅 2025-07-09 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,524 | 🐛 212 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,914 | 🐛 55 | 🌐 Go | 📅 2025-07-13 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
* [Goyave](https://github.com/go-goyave/goyave) ⭐ 1,715 | 🐛 15 | 🌐 Go | 📅 2025-07-03 - Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities.
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,376 | 🐛 45 | 🌐 Go | 📅 2025-07-10 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,228 | 🐛 120 | 🌐 Go | 📅 2025-07-02 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
* [iWF](https://github.com/indeedeng/iwf) ⭐ 579 | 🐛 72 | 🌐 Go | 📅 2025-07-07 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
* [templui](https://github.com/axzilla/templui) ⭐ 774 | 🐛 15 | 🌐 JavaScript | 📅 2025-07-10 - Modern UI Components for Go & Templ.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,124 | 🐛 85 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,923 | 🐛 82 | 🌐 Go | 📅 2024-07-22 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,471 | 🐛 34 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,454 | 🐛 502 | 🌐 Go | 📅 2025-07-12 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,037 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 234 | 🐛 15 | 🌐 Go | 📅 2025-07-13 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,391 | 🐛 110 | 🌐 Go | 📅 2025-07-13 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [xpath](https://github.com/antchfx/xpath) ⭐ 721 | 🐛 17 | 🌐 Go | 📅 2025-04-21 - XPath package for Go.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,054 | 🐛 263 | 🌐 Go | 📅 2025-07-09 - Container Signing, Verification and Storage in an OCI registry.
* [in-toto](https://github.com/in-toto/in-toto-golang) ⭐ 139 | 🐛 35 | 🌐 Go | 📅 2025-07-10 - Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation.
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,436 | 🐛 250 | 🌐 Go | 📅 2025-07-12 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 108 | 🐛 20 | 🌐 Go | 📅 2025-07-09 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,990 | 🐛 158 | 🌐 Go | 📅 2025-07-13 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,425 | 🐛 13 | 🌐 Go | 📅 2025-06-30 - Errcheck is a program for checking for unchecked errors in Go programs.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 1,972 | 🐛 137 | 🌐 Go | 📅 2025-07-13 - source code linter that brings checks that are currently not implemented in other linters.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,310 | 🐛 115 | 🌐 Go | 📅 2025-07-13 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,023 | 🐛 41 | 🌐 Go | 📅 2025-06-11 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,237 | 🐛 46 | 🌐 Go | 📅 2025-07-12 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,504 | 🐛 579 | 🌐 Go | 📅 2025-07-08 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 143 | 🐛 36 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,892 | 🐛 371 | 🌐 Go | 📅 2025-07-01.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 796 | 🐛 73 | 🌐 Go | 📅 2025-07-09 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,756 | 🐛 96 | 🌐 Go | 📅 2025-07-11 features to Vim/Neovim.
...
* [vim-go](https://github.com/fatih/vim-go) ⭐ 16,144 | 🐛 40 | 🌐 Vim Script | 📅 2025-06-21 - Go development plugin for Vim.
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,082 | 🐛 422 | 🌐 TypeScript | 📅 2025-07-07 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [envdoc](https://github.com/g4s8/envdoc) ⭐ 86 | 🐛 5 | 🌐 Go | 📅 2025-07-08 -  generate documentation for environment variables from Go source files.
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,316 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
...
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,422 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
...
* [dish](https://github.com/thevxn/dish) ⭐ 244 | 🐛 6 | 🌐 Go | 📅 2025-07-08 - A lightweight, remotely configurable monitoring service.
...
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,177 | 🐛 27 | 🌐 Go | 📅 2025-07-10 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,234 | 🐛 2,565 | 🌐 Go | 📅 2025-07-13 - Lightweight, programmable telemetry for servers and workstations.
...
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,559 | 🐛 2,722 | 🌐 Go | 📅 2025-07-13 - Fork of Gogs, entirely community driven.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,065 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,055 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,908 | 🐛 246 | 🌐 Go | 📅 2025-07-08 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,197 | 🐛 147 | 🌐 Go | 📅 2025-07-13 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,241 | 🐛 808 | 🌐 Go | 📅 2025-07-11 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,306 | 🐛 209 | 🌐 Go | 📅 2025-07-11 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [ko](https://github.com/google/ko) ⭐ 8,066 | 🐛 53 | 🌐 Go | 📅 2025-07-14 - Command line tool for building and deploying Go applications on Kubernetes
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,762 | 🐛 151 | 🌐 Go | 📅 2025-07-14 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,303 | 🐛 2,589 | 🌐 Go | 📅 2025-07-14 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,430 | 🐛 143 | 🌐 Go | 📅 2025-07-09 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,755 | 🐛 543 | 🌐 Go | 📅 2025-07-08 - Cloud native application delivery.
...
* [kwatch](https://github.com/abahmed/kwatch) ⭐ 982 | 🐛 25 | 🌐 Go | 📅 2025-07-12 - Monitor & detect crashes in your Kubernetes(K8s) cluster instantly.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,687 | 🐛 529 | 🌐 Go | 📅 2025-07-14 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,083 | 🐛 3,630 | 🌐 Go | 📅 2025-07-13 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,192 | 🐛 103 | 🌐 Go | 📅 2025-07-14 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,653 | 🐛 27 | 🌐 Go | 📅 2025-07-12 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,340 | 🐛 132 | 🌐 Go | 📅 2025-07-11 - Pomerium is an identity-aware access proxy.
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,428 | 🐛 143 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
...
* [skm](https://github.com/TimothyYe/skm) ⭐ 978 | 🐛 4 | 🌐 Go | 📅 2025-06-21 - SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily!
...
* [tau](https://github.com/taubyte/tau) ⭐ 4,054 | 🐛 31 | 🌐 Go | 📅 2025-07-12 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
* [tlm](https://github.com/yusufcanb/tlm) ⭐ 1,435 | 🐛 6 | 🌐 Go | 📅 2025-03-28 - Local cli copilot, powered by CodeLLaMa
* [traefik](https://github.com/containous/traefik) ⭐ 55,529 | 🐛 649 | 🌐 Go | 📅 2025-07-11 - Reverse proxy and load balancer with support for multiple backends.
...
* [uTask](https://github.com/ovh/utask) ⭐ 1,292 | 🐛 52 | 🌐 Go | 📅 2025-07-07 - Automation engine that models and executes business processes declared in yaml.
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,372 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,457 | 🐛 68 | 🌐 Go | 📅 2025-07-11 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 590 | 🐛 11 | 🌐 Go | 📅 2025-07-13 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [croc](https://github.com/schollz/croc) ⭐ 30,552 | 🐛 16 | 🌐 Go | 📅 2025-07-11 - Easily and securely send files or folders from one computer to another.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,093 | 🐛 19 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
* [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
* [GoNB](https://github.com/janpfeifer/gonb) ⭐ 884 | 🐛 10 | 🌐 Go | 📅 2025-06-01 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,873 | 🐛 131 | 🌐 Go | 📅 2025-07-14 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [restic](https://github.com/restic/restic) ⭐ 29,281 | 🐛 475 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 702 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,471 | 🐛 54 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,162 | 🐛 592 | 🌐 Go | 📅 2025-07-14 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,419 | 🐛 5 | 🌐 Go | 📅 2025-06-18 - Executing shell commands via http server (for prototyping or remote control).
...
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,350 | 🐛 91 | 🌐 Go | 📅 2025-07-07 - Proxy to simulate network and system conditions for automated tests.
...
* [yai](https://github.com/ekkinox/yai) ⭐ 805 | 🐛 29 | 🌐 Go | 📅 2024-07-31 - AI powered terminal assistant.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,222 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,083 | 🐛 7,408 | 🌐 Go | 📅 2025-07-14
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,643 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,707 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,703 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,869 | 🐛 9,404 | 🌐 Go | 📅 2025-07-11 - List of projects on the Go community wiki.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,687 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,941 | 🐛 7 | 🌐 Go | 📅 2025-07-08 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,669 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,389 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,965 | 🐛 66 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
...
* [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) ⭐ 410 | 🐛 5 | 🌐 Go | 📅 2025-07-13 - A GitHub repository offering coding challenges for Go technical interview preparation.
