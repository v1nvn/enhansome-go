...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 147,023 | 🐛 127 | 🌐 Go | 📅 2025-06-29
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 380,557 | 🐛 42 | 📅 2025-07-05
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 249,639 | 🐛 477 | 🌐 Python | 📅 2025-07-05.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 147,023 | 🐛 127 | 🌐 Go | 📅 2025-06-29 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 147,023 | 🐛 127 | 🌐 Go | 📅 2025-06-29; you rock!
...
* [Ergo](https://github.com/ergo-services/ergo) ⭐ 4,017 | 🐛 4 | 🌐 Go | 📅 2025-07-07 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 263 | 🐛 0 | 🌐 Go | 📅 2025-07-09 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
* [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,971 | 🐛 22 | 🌐 Go | 📅 2025-07-04 - Blazingly fast and light-weight Actor engine written in Golang.
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,262 | 🐛 87 | 🌐 Go | 📅 2024-08-22 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 626 | 🐛 11 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
* [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,086 | 🐛 370 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,765 | 🐛 480 | 🌐 Go | 📅 2025-07-09 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 146,067 | 🐛 1,867 | 🌐 Go | 📅 2025-07-09 - Run large language models locally.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,854 | 🐛 50 | 🌐 Go | 📅 2025-06-21 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,089 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,240 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,129 | 🐛 6 | 🌐 Go | 📅 2025-07-10 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
* [keto](https://github.com/ory/keto) ⭐ 5,058 | 🐛 56 | 🌐 Go | 📅 2025-07-09 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,640 | 🐛 40 | 🌐 Go | 📅 2025-05-05 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,604 | 🐛 31 | 🌐 Go | 📅 2025-07-02 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
* [openfga](https://github.com/openfga/openfga) ⭐ 3,815 | 🐛 133 | 🌐 Go | 📅 2025-07-10 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [paseto](https://github.com/o1egl/paseto) ⭐ 899 | 🐛 6 | 🌐 Go | 📅 2023-02-25 - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
* [scs](https://github.com/alexedwards/scs) ⭐ 2,362 | 🐛 31 | 🌐 Go | 📅 2025-07-08 - Session Manager for HTTP servers.
...
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,647 | 🐛 279 | 🌐 Go | 📅 2025-07-10 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 973 | 🐛 788 | 🌐 Go | 📅 2025-07-09 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,264 | 🐛 317 | 🌐 Go | 📅 2025-07-09 - Official Go implementation of the Ethereum protocol.
...
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,562 | 🐛 1,106 | 🌐 Go | 📅 2025-07-09 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,968 | 🐛 818 | 🌐 Go | 📅 2025-07-10 - A complete implementation of a Lightning Network node.
...
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,812 | 🐛 21 | 🌐 Go | 📅 2025-07-09 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
* [arikawa](https://github.com/diamondburned/arikawa) ⭐ 530 | 🐛 35 | 🌐 Go | 📅 2025-07-03 - A library and framework for the Discord API.
* [bot](https://github.com/go-telegram/bot) ⭐ 1,219 | 🐛 12 | 🌐 Go | 📅 2025-07-08 - Zero-dependencies Telegram Bot library with additional UI components
...
* [telego](https://github.com/mymmrac/telego) ⭐ 732 | 🐛 3 | 🌐 Go | 📅 2025-07-01 - Telegram Bot API library for Golang with full one-to-one API implementation.
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,200 | 🐛 168 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
* [wayback](https://github.com/wabarc/wayback) ⭐ 1,996 | 🐛 56 | 🌐 Go | 📅 2025-07-07 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [air](https://github.com/cosmtrek/air) ⭐ 20,965 | 🐛 177 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [Task](https://github.com/go-task/task) ⭐ 13,096 | 🐛 392 | 🌐 Go | 📅 2025-07-09 - simple "Make" alternative.
* [taskctl](https://github.com/taskctl/taskctl) ⭐ 312 | 🐛 6 | 🌐 Go | 📅 2025-01-18 - Concurrent task runner.
* [xc](https://github.com/joerdav/xc) ⭐ 1,301 | 🐛 17 | 🌐 Go | 📅 2025-07-04 - Task runner with README.md defined tasks, executable markdown.
...
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,556 | 🐛 156 | 🌐 Go | 📅 2025-07-09 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 33,033 | 🐛 116 | 🌐 Go | 📅 2025-07-07 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,656 | 🐛 4 | 🌐 Go | 📅 2025-07-08 - Terminal JSON viewer & processor.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,383 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,811 | 🐛 673 | 🌐 Python | 📅 2025-07-03.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,286 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) ⭐ 553 | 🐛 12 | 🌐 Go | 📅 2023-12-20 - Style terminal text.
* [gookit/color](https://github.com/gookit/color) ⭐ 1,548 | 🐛 5 | 🌐 Go | 📅 2025-06-07 - Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows.
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,233 | 🐛 86 | 🌐 Go | 📅 2025-07-08 - Declaratively define styles for color, format and layout in the terminal.
...
* [pterm](https://github.com/pterm/pterm) ⭐ 5,144 | 🐛 63 | 🌐 Go | 📅 2025-07-10 - A library to beautify console output on every platform with many combinable components.
* [simpletable](https://github.com/alexeyco/simpletable) ⭐ 541 | 🐛 5 | 🌐 Go | 📅 2021-04-23 - Simple tables in a terminal with Go.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,846 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,381 | 🐛 105 | 🌐 Go | 📅 2024-07-22.
* [termenv](https://github.com/muesli/termenv) ⭐ 1,864 | 🐛 37 | 🌐 Go | 📅 2025-05-05 - Advanced ANSI style & color support for your terminal applications.
* [termui](https://github.com/gizak/termui) ⭐ 13,381 | 🐛 105 | 🌐 Go | 📅 2024-07-22 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,619 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
* [uilive](https://github.com/gosuri/uilive) ⭐ 1,705 | 🐛 12 | 🌐 Go | 📅 2023-07-22 - Library for updating terminal output in real time.
* [uiprogress](https://github.com/gosuri/uiprogress) ⭐ 2,129 | 🐛 28 | 🌐 Go | 📅 2024-02-29 - Flexible library to render progress bars in terminal applications.
...
* [argparse](https://github.com/akamensky/argparse) ⭐ 624 | 🐛 8 | 🌐 Go | 📅 2022-10-31 - Command line argument parser inspired by Python's argparse module.
...
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,340 | 🐛 74 | 🌐 Go | 📅 2025-07-09 - Multi-shell multi-command argument completer.
...
* [cmdr](https://github.com/hedzr/cmdr) ⭐ 140 | 🐛 0 | 🌐 Go | 📅 2025-07-09 - A POSIX/GNU style, getopt-like command-line UI Go library.
* [cobra](https://github.com/spf13/cobra) ⭐ 41,083 | 🐛 319 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,320 | 🐛 50 | 🌐 Go | 📅 2025-06-14 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [env](https://github.com/caarlos0/env) ⭐ 5,616 | 🐛 9 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,468 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [hedzr/store](https://github.com/hedzr/store) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2025-07-05 - Extensible, high-performance configuration management library, optimized for hierarchical data.
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,259 | 🐛 56 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,295 | 🐛 11 | 🌐 Go | 📅 2025-06-30 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [kong](https://github.com/alecthomas/kong) ⭐ 2,713 | 🐛 26 | 🌐 Go | 📅 2025-07-04 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,367 | 🐛 22 | 🌐 Go | 📅 2025-07-08 - A blazingly fast JSON serializing & deserializing library.
...
* [xdg](https://github.com/adrg/xdg) ⭐ 842 | 🐛 5 | 🌐 Go | 📅 2025-06-04 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
* [yamagiconf](https://github.com/romshark/yamagiconf) ⭐ 18 | 🐛 2 | 🌐 Go | 📅 2025-02-01 - The "safe subset" of YAML for Go configs.
* [zerocfg](https://github.com/chaindead/zerocfg) ⭐ 191 | 🐛 3 | 🌐 Go | 📅 2025-07-08 - Zero-effort, concise configuration management that avoids boilerplate and repetitive code, supports multiple sources with priority overrides.
...
* [drone](https://github.com/drone/drone) ⭐ 32,952 | 🐛 74 | 🌐 Go | 📅 2025-07-09 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 157 | 🐛 7 | 🌐 Go | 📅 2025-07-09 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,568 | 🐛 25 | 🌐 Go | 📅 2025-07-09 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,813 | 🐛 89 | 🌐 Rust | 📅 2025-07-09.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,224 | 🐛 346 | 🌐 Go | 📅 2025-07-10 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,399 | 🐛 526 | 🌐 Go | 📅 2025-07-10 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,135 | 🐛 159 | 🌐 Go | 📅 2025-07-09 - A high-performance ELT data integration framework with pluggable architecture.
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,730 | 🐛 72 | 🌐 Go | 📅 2025-06-28 - Go package implementing compressed bitsets.

### Bit Sets

* [bitmap](https://github.com/kelindar/bitmap) ⭐ 340 | 🐛 9 | 🌐 Assembly | 📅 2025-06-28 - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
* [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,429 | 🐛 3 | 🌐 Go | 📅 2025-06-01 - Go package implementing bitsets.
...
* [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,814 | 🐛 30 | 🌐 Go | 📅 2024-05-16 - Collection of useful, performant, and thread-safe data structures.
* [gods](https://github.com/emirpasic/gods) ⭐ 17,006 | 🐛 67 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [deque](https://github.com/gammazero/deque) ⭐ 690 | 🐛 6 | 🌐 Go | 📅 2025-05-01 - Fast ring-buffer deque (double-ended queue).
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,807 | 🐛 81 | 🌐 TypeScript | 📅 2025-07-10 - Distributed, Fault-tolerant task queue.
* [memlog](https://github.com/embano1/memlog) ⭐ 133 | 🐛 1 | 🌐 Go | 📅 2025-07-10 - An easy to use, lightweight, thread-safe and append-only in-memory data structure inspired by Apache Kafka.
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,445 | 🐛 296 | 🌐 Go | 📅 2025-07-07 - Modern text indexing library for go.
...
* [BigCache](https://github.com/allegro/bigcache) ⭐ 7,870 | 🐛 99 | 🌐 Go | 📅 2025-05-05 - Efficient key/value cache for gigabytes of data.
...
* [GCache](https://github.com/bluele/gcache) ⭐ 2,693 | 🐛 28 | 🌐 Go | 📅 2024-03-01 - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
* [gocache](https://github.com/eko/gocache) ⭐ 2,690 | 🐛 40 | 🌐 Go | 📅 2025-05-25 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,161 | 🐛 1 | 🌐 Go | 📅 2025-07-07 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,200 | 🐛 5 | 🌐 Go | 📅 2025-07-10 -  A high performance memory-bound Go cache.
...
* [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,104 | 🐛 15 | 🌐 Go | 📅 2025-07-09 - An in-memory cache with item expiration and generics.
* [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2022-10-02 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

* [badger](https://github.com/dgraph-io/badger) ⭐ 14,740 | 🐛 28 | 🌐 Go | 📅 2025-07-10 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,901 | 🐛 43 | 🌐 Go | 📅 2025-07-09 - An embedded key/value database for Go.
...
* [clover](https://github.com/ostafen/clover) ⭐ 759 | 🐛 21 | 🌐 Go | 📅 2025-02-12 - A lightweight document-oriented NoSQL database written in pure Golang.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,062 | 🐛 7,335 | 🌐 Go | 📅 2025-07-10 - Scalable, Geo-Replicated, Transactional Datastore.
* [Coffer](https://github.com/claygod/coffer) ⭐ 40 | 🐛 1 | 🌐 Go | 📅 2023-04-09 - Simple ACID key-value database that supports transactions.
* [column](https://github.com/kelindar/column) ⭐ 1,486 | 🐛 26 | 🌐 Go | 📅 2025-06-28 - High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions.
...
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,999 | 🐛 39 | 🌐 Go | 📅 2025-07-09 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,860 | 🐛 431 | 🌐 Go | 📅 2025-07-10 - Dolt – It's Git for Data.
...
* [godis](https://github.com/hdt3213/godis) ⭐ 3,719 | 🐛 16 | 🌐 Go | 📅 2025-07-05 - A Golang implemented high-performance Redis server and cluster.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,281 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,845 | 🐛 363 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 8,773 | 🐛 134 | 🌐 Go | 📅 2025-05-30 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,299 | 🐛 2,117 | 🌐 Rust | 📅 2025-07-09 - Scalable datastore for metrics, events, and real-time analytics.
...
* [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,204 | 🐛 16 | 🌐 Go | 📅 2025-02-18 - Fast k/v database compatible with lsm and b+tree.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,876 | 🐛 704 | 🌐 Go | 📅 2025-07-10 - Milvus is a vector database for embedding management, analytics and search.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,375 | 🐛 295 | 🌐 Go | 📅 2025-07-10 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,381 | 🐛 703 | 🌐 Go | 📅 2025-07-09 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,855 | 🐛 3 | 🌐 Go | 📅 2025-07-09 - Redis re-implemented with SQLite.
* [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,827 | 🐛 2 | 🌐 Go | 📅 2025-04-22 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,745 | 🐛 73 | 🌐 Go | 📅 2025-07-09 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,703 | 🐛 5,206 | 🌐 Go | 📅 2025-07-09 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,492 | 🐛 787 | 🌐 Go | 📅 2025-07-09 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 7,011 | 🐛 218 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,721 | 🐛 120 | 🌐 Go | 📅 2025-07-10 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,119 | 🐛 28 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,679 | 🐛 97 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,959 | 🐛 435 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,329 | 🐛 18 | 🌐 Go | 📅 2025-07-09 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
* [soda](https://github.com/gobuffalo/pop/tree/master/soda) ⭐ 1,490 | 🐛 94 | 🌐 Go | 📅 2024-06-26 - Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.
...
* [dbbench](https://github.com/sj14/dbbench) ⭐ 108 | 🐛 11 | 🌐 Go | 📅 2025-07-10 - Database benchmarking tool with support for several databases and scripts.
...
* [onedump](https://github.com/liweiyi88/onedump) ⭐ 197 | 🐛 0 | 🌐 Go | 📅 2025-07-02 - Database backup from different drivers to different destinations with one command and configuration.
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,192 | 🐛 1 | 🌐 Go | 📅 2025-06-30 - Advanced scheduling for PostgreSQL.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,943 | 🐛 36 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
...
* [rdb](https://github.com/HDT3213/rdb) ⭐ 546 | 🐛 4 | 🌐 Go | 📅 2025-07-06 - Redis RDB file parser for secondary development and memory analysis.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,823 | 🐛 889 | 🌐 Go | 📅 2025-07-08 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
* [wescale](https://github.com/wesql/wescale) ⭐ 303 | 🐛 20 | 🌐 Go | 📅 2025-03-07 - WeScale is a database proxy designed to enhance the scalability, performance, security, and resilience of your applications.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,263 | 🐛 42 | 🌐 Go | 📅 2025-07-03 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,457 | 🐛 614 | 🌐 Go | 📅 2025-07-09 - Generate type-safe code from SQL.
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,496 | 🐛 91 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
* [xo](https://github.com/knq/xo) ⭐ 3,832 | 🐛 53 | 🌐 Go | 📅 2025-06-23 - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,917 | 🐛 62 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,566 | 🐛 203 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 736 | 🐛 5 | 🌐 Go | 📅 2025-07-09 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,113 | 🐛 235 | 🌐 Go | 📅 2025-06-26 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,113 | 🐛 235 | 🌐 Go | 📅 2025-06-26 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,440 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
* [pq](https://github.com/lib/pq) ⭐ 9,533 | 🐛 339 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 166 | 🐛 243 | 🌐 Go | 📅 2025-07-09 - native and database/sql driver YDB (Yandex Database)

### NoSQL Database Drivers

* [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) ⭐ 450 | 🐛 38 | 🌐 Go | 📅 2025-07-08 - Aerospike client in Go language.
...
* [gocb](https://github.com/couchbase/gocb) ⭐ 373 | 🐛 4 | 🌐 Go | 📅 2025-07-01 - Official Couchbase Go SDK.
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,389 | 🐛 13 | 🌐 Go | 📅 2025-07-09 - Official MongoDB driver for the Go language.
...
* [qmgo](https://github.com/qiniu/qmgo) ⭐ 1,326 | 🐛 49 | 🌐 Go | 📅 2025-07-05 - The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,052 | 🐛 99 | 🌐 Go | 📅 2025-07-07 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,716 | 🐛 21 | 🌐 Go | 📅 2025-07-09 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
* [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,095 | 🐛 93 | 🌐 Go | 📅 2025-07-09 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,909 | 🐛 82 | 🌐 Go | 📅 2025-07-01 - Official Elasticsearch client for Go.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1,001 | 🐛 23 | 🌐 Go | 📅 2025-06-27 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,097 | 🐛 1 | 🌐 Go | 📅 2025-07-09 - A simple, semantic and developer-friendly time package for golang.
...
* [now](https://github.com/jinzhu/now) ⭐ 4,542 | 🐛 13 | 🌐 Go | 📅 2025-06-09 - Now is a time toolkit for golang.
...
* [bedrock](https://github.com/z5labs/bedrock) ⭐ 13 | 🐛 2 | 🌐 Go | 📅 2025-07-10 - Provides a minimal, modular and composable foundation for quickly developing services and more use case specific frameworks in Go.
...
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,198 | 🐛 52 | 🌐 Go | 📅 2024-07-12 - A feature complete and high performance multi-group Raft library in Go.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,659 | 🐛 31 | 🌐 Go | 📅 2025-07-10 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,151 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,399 | 🐛 359 | 🌐 Go | 📅 2025-07-10 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 22,000 | 🐛 139 | 🌐 Go | 📅 2025-07-09 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,056 | 🐛 85 | 🌐 Go | 📅 2025-07-09 - A cloud native Kubernetes Global Balancer.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,523 | 🐛 54 | 🌐 Go | 📅 2025-07-07 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,574 | 🐛 122 | 🌐 Go | 📅 2025-06-01 - A modular-designed and easy-to-use microservices framework in Go.
* [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,606 | 🐛 43 | 🌐 Go | 📅 2024-04-19 - Lightweight, fault-tolerant message streams for NATS.
...
* [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,571 | 🐛 26 | 🌐 Go | 📅 2025-04-16 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,461 | 🐛 462 | 🌐 Go | 📅 2025-07-09 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 619 | 🐛 52 | 🌐 Go | 📅 2025-07-10 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,678 | 🐛 44 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/etcd-io/raft) ⭐ 872 | 🐛 70 | 🌐 Go | 📅 2025-07-01 - Go implementation of the Raft consensus protocol, by CoreOS.
...
* [ringpop-go](https://github.com/uber/ringpop-go) ⭐ 851 | 🐛 27 | 🌐 Go | 📅 2023-08-23 - Scalable, fault-tolerant application-layer sharding for Go applications.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,347 | 🐛 356 | 🌐 C++ | 📅 2025-06-26).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,124 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 659 | 🐛 197 | 🌐 Go | 📅 2025-07-09 - Durable execution system for making code fault-tolerant and simple.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,810 | 🐛 63 | 🌐 Go | 📅 2025-07-08 - BitTorrent client package.
* [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 989 | 🐛 8 | 🌐 Go | 📅 2025-04-18 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,399 | 🐛 31 | 🌐 Go | 📅 2025-07-04 - A Go library for email verification without sending any emails.
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,033 | 🐛 4 | 🌐 Go | 📅 2025-07-02 - A simple Go library for sending mails in Go.
...
* [mailgun-go](https://github.com/mailgun/mailgun-go) ⭐ 732 | 🐛 1 | 🌐 Go | 📅 2025-06-27 - Go library for sending mail with the Mailgun API.
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,033 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,335 | 🐛 1 | 🌐 Go | 📅 2025-07-06 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,058 | 🐛 148 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,643 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,608 | 🐛 50 | 🌐 Go | 📅 2025-07-08 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,991 | 🐛 46 | 🌐 Go | 📅 2025-07-05 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,619 | 🐛 177 | 🌐 Go | 📅 2025-07-09 - PHP embedded in Go, with a `net/http` handler.
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,296 | 🐛 50 | 🌐 Go | 📅 2025-06-05 - Port of the Lua 5.2 VM to pure Go.
...
* [goja](https://github.com/dop251/goja) ⭐ 6,263 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [golua](https://github.com/aarzilli/golua) ⭐ 673 | 🐛 9 | 🌐 C | 📅 2025-02-17 - Go bindings for Lua C API.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,643 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [gval](https://github.com/PaesslerAG/gval) ⭐ 792 | 🐛 24 | 🌐 Go | 📅 2024-11-28 - A highly customizable expression language written in Go.
* [metacall](https://github.com/metacall/core) ⭐ 1,665 | 🐛 52 | 🌐 C | 📅 2025-07-09 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
* [ngaro](https://github.com/db47h/ngaro) ⭐ 30 | 🐛 1 | 🌐 Go | 📅 2018-06-03 - Embeddable Ngaro VM implementation enabling scripting in Retro.
* [prolog](https://github.com/ichiban/prolog) ⭐ 674 | 🐛 24 | 🌐 Go | 📅 2025-07-05 - Embeddable Prolog.
* [purl](https://github.com/ian-kent/purl) ⭐ 41 | 🐛 2 | 🌐 Go | 📅 2014-12-07 - Perl 5.18.2 embedded in Go.
* [starlark-go](https://github.com/google/starlark-go) ⭐ 2,495 | 🐛 63 | 🌐 Go | 📅 2025-07-01 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
* [starlet](https://github.com/1set/starlet) ⭐ 30 | 🐛 2 | 🌐 Go | 📅 2025-04-15 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,495 | 🐛 63 | 🌐 Go | 📅 2025-07-01 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
* [tengo](https://github.com/d5/tengo) ⭐ 3,664 | 🐛 84 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,594 | 🐛 5 | 🌐 Go | 📅 2025-07-09 - The Wa Programming Language embedded in Go.
...
* [errors](https://github.com/naughtygopher/errors) ⭐ 72 | 🐛 0 | 🌐 Go | 📅 2025-07-04 - Drop-in replacement for builtin Go errors. This is a minimal error handling package with custom error types, user friendly messages, Unwrap & Is. With very easy to use and straightforward helper functions.
...
* [multierr](https://github.com/uber-go/multierr) ⭐ 1,143 | 🐛 2 | 🌐 Go | 📅 2024-04-29 - Package for representing a list of errors as a single error.
...
* [afero](https://github.com/spf13/afero) ⭐ 6,266 | 🐛 153 | 🌐 Go | 📅 2025-07-01 - FileSystem Abstraction System for Go.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 98 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,806 | 🐛 291 | 🌐 Go | 📅 2025-07-06).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,602 | 🐛 51 | 🌐 Go | 📅 2025-07-09 - Disk usage analyzer with console interface.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,783 | 🐛 126 | 🌐 Go | 📅 2025-07-09 - PDF processor.
...
* [vfs](https://github.com/C2FO/vfs) ⭐ 342 | 🐛 9 | 🌐 Go | 📅 2025-07-08 - A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS.
...
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,380 | 🐛 134 | 🌐 Go | 📅 2025-07-09 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [go-money](https://github.com/rhymond/go-money) ⭐ 1,779 | 🐛 23 | 🌐 Go | 📅 2025-04-30 - Implementation of Fowler's Money pattern.
* [go-nowpayments](https://github.com/matm/go-nowpayments) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2023-01-24 - Library for the crypto NOWPayments API.
* [ledger](https://github.com/formancehq/ledger) ⭐ 990 | 🐛 7 | 🌐 Go | 📅 2025-07-09 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,311 | 🐛 37 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
...
* [httpin](https://github.com/ggicci/httpin) ⭐ 362 | 🐛 9 | 🌐 Go | 📅 2025-06-20 - Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc.
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,213 | 🐛 299 | 🌐 Go | 📅 2025-07-09 - dead simple 2D game engine in Go.
...
* [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,572 | 🐛 58 | 🌐 Go | 📅 2025-06-04 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) ⭐ 3,590 | 🐛 11 | 🌐 Go | 📅 2022-08-08 - .NET LINQ-like query methods for Go.
* [goderive](https://github.com/awalterschulze/goderive) ⭐ 1,262 | 🐛 19 | 🌐 Go | 📅 2025-03-06 - Derives functions from input types
* [goverter](https://github.com/jmattheis/goverter) ⭐ 717 | 🐛 17 | 🌐 Go | 📅 2025-07-06 - Generate converters by defining an interface.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,301 | 🐛 692 | 🌐 Go | 📅 2025-07-09 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,371 | 🐛 151 | 🌐 Go | 📅 2025-06-17 - Geolocation DB with spatial index and realtime geofencing.
...
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,425 | 🐛 14 | 🌐 Go | 📅 2025-05-18 - Compile shell scripts to Go.
...
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,990 | 🐛 192 | 🌐 Go | 📅 2025-06-16 - Compiler from Go to JavaScript.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,813 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,988 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [pond](https://github.com/alitto/pond) ⭐ 1,886 | 🐛 3 | 🌐 Go | 📅 2025-06-20 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,397 | 🐛 20 | 🌐 Go | 📅 2025-02-13 - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,723 | 🐛 42 | 🌐 Go | 📅 2025-07-08 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 422 | 🐛 19 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,739 | 🐛 1,157 | 🌐 C++ | 📅 2025-07-09 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,682 | 🐛 17 | 🌐 Lua | 📅 2025-07-01.
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,034 | 🐛 225 | 🌐 Go | 📅 2025-07-09 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,719 | 🐛 747 | 🌐 Go | 📅 2025-07-07 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [gotk3](https://github.com/gotk3/gotk3) ⭐ 2,171 | 🐛 122 | 🌐 Go | 📅 2024-08-08 - Go bindings for GTK3.
...
* [qt](https://github.com/therecipe/qt) ⭐ 10,690 | 🐛 373 | 🌐 Go | 📅 2024-03-04 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
* [webview](https://github.com/zserge/webview) ⭐ 13,217 | 🐛 190 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,248 | 🐛 136 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
* [zenity](https://github.com/ncruces/zenity) ⭐ 819 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,595 | 🐛 218 | 🌐 Go | 📅 2025-07-08 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [go-rpio](https://github.com/stianeikeland/go-rpio) ⭐ 2,248 | 🐛 42 | 🌐 Go | 📅 2023-09-30 - GPIO for Go, doesn't require cgo.
...
* [sysinfo](https://github.com/zcalusic/sysinfo) ⭐ 549 | 🐛 16 | 🌐 Go | 📅 2024-12-09 - A pure Go library providing Linux OS / kernel / hardware system information.
...
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,118 | 🐛 20 | 🌐 Go | 📅 2024-09-24 - Collection of image processing algorithms in pure Go.
* [bimg](https://github.com/h2non/bimg) ⭐ 2,882 | 🐛 175 | 🌐 Go | 📅 2025-01-23 - Small package for fast and efficient image processing using libvips.
...
* [gg](https://github.com/fogleman/gg) ⭐ 4,619 | 🐛 94 | 🌐 Go | 📅 2023-12-14 - 2D rendering in pure Go.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,138 | 🐛 344 | 🌐 Go | 📅 2025-07-08 - Go package for computer vision using OpenCV 3.3+.
...
* [govips](https://github.com/davidbyttow/govips) ⭐ 1,459 | 🐛 31 | 🌐 Go | 📅 2025-07-07 - A lightning fast image processing and resizing library for Go.
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,838 | 🐛 32 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
...
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,519 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
* [imagor](https://github.com/cshum/imagor) ⭐ 3,678 | 🐛 39 | 🌐 Go | 📅 2025-06-30 - Fast, secure image processing server and Go library, using libvips.
* [img](https://github.com/hawx/img) ⭐ 156 | 🐛 4 | 🌐 Go | 📅 2015-05-01 - Selection of image manipulation tools.
* [ln](https://github.com/fogleman/ln) ⭐ 3,329 | 🐛 12 | 🌐 Go | 📅 2019-07-19 - 3D line art rendering in Go.
...
* [picfit](https://github.com/thoas/picfit) ⭐ 2,253 | 🐛 12 | 🌐 Go | 📅 2025-06-10 - An image resizing server written in Go.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,608 | 🐛 62 | 🌐 Go | 📅 2025-07-10 - Lightweight data stream processing engine for IoT edge.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,212 | 🐛 103 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,192 | 🐛 8 | 🌐 Go | 📅 2025-07-08 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
* [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 | 🐛 39 | 🌐 Go | 📅 2019-11-04 - Lightweight stream processing engine for IoT.
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,352 | 🐛 30 | 🌐 Go | 📅 2025-07-08 - Kubernetes native IoT development framework.
...
* [cheek](https://github.com/bart6114/cheek) ⭐ 191 | 🐛 7 | 🌐 Go | 📅 2025-07-06 - A simple crontab like scheduler that aims to offer a KISS approach to job scheduling.
...
* [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,892 | 🐛 3 | 🌐 Go | 📅 2025-05-24 - Simple, zero-dependency scheduling library for Go.
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,356 | 🐛 17 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,493 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,032 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [jsondiff](https://github.com/wI2L/jsondiff) ⭐ 586 | 🐛 0 | 🌐 Go | 📅 2025-05-09 - JSON diff library for Go based on RFC6902 (JSON Patch).
...
* [OjG](https://github.com/ohler55/ojg) ⭐ 902 | 🐛 0 | 🌐 Go | 📅 2025-06-29 - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 592 | 🐛 1 | 🌐 Go | 📅 2025-05-29 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,360 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,360 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,360 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,360 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,151 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,331 | 🐛 165 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,586 | 🐛 140 | 🌐 Go | 📅 2025-04-18, etc).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,155 | 🐛 100 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [pp](https://github.com/k0kubun/pp) ⭐ 1,965 | 🐛 6 | 🌐 Go | 📅 2025-07-09 - Colored pretty printer for Go language.
...
* [tint](https://github.com/lmittmann/tint) ⭐ 1,043 | 🐛 0 | 🌐 Go | 📅 2025-06-07 - A slog.Handler that writes tinted logs.
...
* [GoLearn](https://github.com/sjwhitworth/golearn) ⭐ 9,410 | 🐛 89 | 🌐 Go | 📅 2024-01-15 - General Machine Learning library for Go.
...
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 827 | 🐛 2 | 🌐 Go | 📅 2025-07-04 - An accelerated Machine Learning framework for Go.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,800 | 🐛 111 | 🌐 Go | 📅 2024-08-12 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 429 | 🐛 7 | 🌐 Go | 📅 2025-07-09 - Huggingface transformer pipelines for golang with onnxruntime.
* [libsvm](https://github.com/datastream/libsvm) ⭐ 73 | 🐛 1 | 🌐 Go | 📅 2016-05-09 - libsvm golang version derived work based on LIBSVM 3.14.
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,890 | 🐛 60 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
* [ocrserver](https://github.com/otiai10/ocrserver) ⭐ 739 | 🐛 4 | 🌐 Go | 📅 2021-08-05 - A simple OCR API server, seriously easy to be deployed by Docker and Heroku.
* [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 803 | 🐛 44 | 🌐 Go | 📅 2024-09-02 - Go Interface to Open Neural Network Exchange (ONNX).
...
* [tfgo](https://github.com/galeone/tfgo) ⭐ 2,475 | 🐛 20 | 🌐 Go | 📅 2024-03-13 - Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python.
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,805 | 🐛 18 | 🌐 Go | 📅 2025-07-08 - Go RabbitMQ Client Library.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,548 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,086 | 🐛 23 | 🌐 Go | 📅 2025-07-08 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,935 | 🐛 284 | 🌐 HTML | 📅 2025-07-09 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [Go-MediatR](https://github.com/mehdihadeli/Go-MediatR) ⭐ 246 | 🐛 3 | 🌐 Go | 📅 2025-05-08 - A library for handling mediator patterns and simplified CQRS patterns within an event-driven architecture, inspired by csharp MediatR library.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,424 | 🐛 58 | 🌐 Go | 📅 2025-07-05 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,095 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,777 | 🐛 244 | 🌐 Go | 📅 2025-06-30 - Asynchronous task queue/job queue based on distributed message passing.
...
* [melody](https://github.com/olahol/melody) ⭐ 3,944 | 🐛 13 | 🌐 Go | 📅 2025-06-08 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
* [Mercure](https://github.com/dunglas/mercure) ⭐ 4,982 | 🐛 26 | 🌐 Go | 📅 2025-06-27 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,008 | 🐛 169 | 🌐 Go | 📅 2025-07-09 - Go client for the NATS
  messaging system.
...
* [Quamina](https://github.com/timbray/quamina) ⭐ 429 | 🐛 16 | 🌐 Go | 📅 2025-07-03 - Fast pattern-matching for filtering messages and events.
...
* [rabtap](https://github.com/jandelgado/rabtap) ⭐ 270 | 🐛 5 | 🌐 Go | 📅 2025-07-09 - RabbitMQ swiss army knife cli app.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,080 | 🐛 66 | 🌐 Go | 📅 2025-07-09 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,631 | 🐛 123 | 🌐 Go | 📅 2025-07-03 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [excelize](https://github.com/xuri/excelize) ⭐ 19,348 | 🐛 125 | 🌐 Go | 📅 2025-07-10 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [dig](https://github.com/uber-go/dig) ⭐ 4,219 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 185 | 🐛 15 | 🌐 Go | 📅 2025-05-27 - A dependency injection toolkit for Go, based on Guice.
* [do](https://github.com/samber/do) ⭐ 2,188 | 🐛 45 | 🌐 Go | 📅 2025-07-05 - A dependency injection framework based on Generics.
* [fx](https://github.com/uber-go/fx) ⭐ 6,644 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
...
* [google/wire](https://github.com/google/wire) ⭐ 13,929 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,781 | 🐛 30 | 🌐 Go | 📅 2025-07-10 - Allows users to spin up a quick Go project using a popular framework.
...
* [goapp](https://github.com/naughtygopher/goapp) ⭐ 982 | 🐛 0 | 🌐 Go | 📅 2025-07-06 - An opinionated guideline to structure & develop a Go web application/service.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,026 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,026 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
...
* [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,135 | 🐛 12 | 🌐 Go | 📅 2025-05-29 - cross-platform, cli app to perform various operations on string.
...
* [archives](https://github.com/mholt/archives) ⭐ 264 | 🐛 7 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,659 | 🐛 220 | 🌐 Go | 📅 2025-07-08 - Automated service health dashboard.
...
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,991 | 🐛 13 | 🌐 Go | 📅 2025-06-26 - Random data generator written in go.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,296 | 🐛 216 | 🌐 Go | 📅 2025-07-10 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [stateless](https://github.com/qmuntal/stateless) ⭐ 1,077 | 🐛 19 | 🌐 Go | 📅 2025-05-23 - A fluent library for creating state machines.
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,540 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,233 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [gse](https://github.com/go-ego/gse) ⭐ 2,678 | 🐛 13 | 🌐 Go | 📅 2025-06-09 - Go efficient text segmentation; support english, chinese, japanese and other.
...
* [go-pinyin](https://github.com/mozillazg/go-pinyin) ⭐ 1,691 | 🐛 18 | 🌐 Go | 📅 2023-07-12 - CN Hanzi to Hanyu Pinyin converter.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 74 | 🐛 0 | 🌐 Go | 📅 2025-07-08 - Package bart provides a fast routing table algorithm.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,991 | 🐛 443 | 🌐 Go | 📅 2025-07-07 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,723 | 🐛 110 | 🌐 Go | 📅 2025-07-05 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
* [ftp](https://github.com/jlaffaye/ftp) ⭐ 1,357 | 🐛 41 | 🌐 Go | 📅 2025-06-13 - Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959).
...
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,637 | 🐛 1 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,825 | 🐛 224 | 🌐 Go | 📅 2025-07-08 - BGP implemented in the Go Programming Language.
* [gopacket](https://github.com/google/gopacket) ⭐ 6,563 | 🐛 360 | 🌐 Go | 📅 2025-03-19 - Go library for packet processing with libpcap bindings.
* [gopcap](https://github.com/akrennmair/gopcap) ⭐ 491 | 🐛 11 | 🌐 Go | 📅 2021-05-17 - Go wrapper for libpcap.
* [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,398 | 🐛 85 | 🌐 Go | 📅 2025-07-09 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
* [gosnmp](https://github.com/soniah/gosnmp) ⭐ 1,198 | 🐛 59 | 🌐 Go | 📅 2025-07-09 - Native Go library for performing SNMP actions.
* [gotcp](https://github.com/gansidui/gotcp) ⭐ 514 | 🐛 0 | 🌐 Go | 📅 2023-08-08 - Go package for quickly writing tcp applications.
* [grab](https://github.com/cavaliercoder/grab) ⭐ 1,447 | 🐛 33 | 🌐 Go | 📅 2024-05-14 - Go package for managing file downloads.
* [graval](https://github.com/koofr/graval) ⭐ 28 | 🐛 0 | 🌐 Go | 📅 2020-10-02 - Experimental FTP server framework.
* [gws](https://github.com/lxzan/gws) ⭐ 1,565 | 🐛 1 | 🌐 Go | 📅 2025-05-13 - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,286 | 🐛 63 | 🌐 Go | 📅 2025-06-18 - KCP - Fast and Reliable ARQ Protocol.
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,173 | 🐛 130 | 🌐 Go | 📅 2025-07-01 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,352 | 🐛 25 | 🌐 Go | 📅 2025-06-17 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,111 | 🐛 2 | 🌐 Go | 📅 2025-07-08 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [psql-wire](https://github.com/jeroenrinzema/psql-wire) ⭐ 150 | 🐛 16 | 🌐 Go | 📅 2025-07-01 - PostgreSQL server wire protocol. Build your own server and start serving connections..
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,807 | 🐛 189 | 🌐 Go | 📅 2025-07-07 - An implementation of the QUIC protocol in pure Go.
...
* [sdns](https://github.com/semihalev/sdns) ⭐ 999 | 🐛 1 | 🌐 Go | 📅 2025-07-09 - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
* [sftp](https://github.com/pkg/sftp) ⭐ 1,586 | 🐛 48 | 🌐 Go | 📅 2025-06-02 - Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>.
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,938 | 🐛 56 | 🌐 Go | 📅 2025-01-27 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,976 | 🐛 16 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,030 | 🐛 100 | 🌐 Go | 📅 2025-07-03 - A pure Go implementation of the WebRTC API.
...
* [go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) ⭐ 401 | 🐛 5 | 🌐 Go | 📅 2025-06-25 - Get easily stdlib HTTP client, which does not share any state with other clients.
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,156 | 🐛 73 | 🌐 Go | 📅 2025-07-07 - Retryable HTTP client in Go.
...
* [heimdall](https://github.com/gojektech/heimdall) ⭐ 2,680 | 🐛 50 | 🌐 Go | 📅 2024-05-29 - An enhanced http client with retry and hystrix capabilities.
...
* [req](https://github.com/imroc/req) ⭐ 4,543 | 🐛 74 | 🌐 Go | 📅 2025-06-27 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
* [requests](https://github.com/carlmjohnson/requests) ⭐ 1,619 | 🐛 2 | 🌐 Go | 📅 2025-04-16 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
...
* [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,193 | 🐛 36 | 🌐 Go | 📅 2025-06-17 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,351 | 🐛 19 | 🌐 Go | 📅 2025-07-09 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,239 | 🐛 27 | 🌐 Go | 📅 2025-07-09 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,339 | 🐛 586 | 🌐 Go | 📅 2025-06-20 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,567 | 🐛 6 | 🌐 Go | 📅 2025-07-06 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
* [gormt](https://github.com/xxjwxc/gormt) ⭐ 2,404 | 🐛 57 | 🌐 Go | 📅 2025-06-24 - Mysql database to golang gorm struct.
...
* [pop/soda](https://github.com/gobuffalo/pop) ⭐ 1,490 | 🐛 94 | 🌐 Go | 📅 2024-06-26 - Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.
* [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,304 | 🐛 115 | 🌐 Go | 📅 2025-07-09 - Prisma Client Go, Typesafe database access for Go.
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,893 | 🐛 104 | 🌐 Go | 📅 2025-06-27 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
* [gup](https://github.com/nao1215/gup) ⭐ 417 | 🐛 6 | 🌐 Go | 📅 2025-07-09 - Update binaries installed by "go install".
...
* [syft](https://github.com/anchore/syft) ⭐ 7,314 | 🐛 471 | 🌐 Go | 📅 2025-07-09 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,566 | 🐛 320 | 🌐 Go | 📅 2025-07-10 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 171 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,081 | 🐛 330 | 🌐 C++ | 📅 2025-07-09 - No instrumentation tracing for Golang applications via eBPF.
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,496 | 🐛 48 | 🌐 Go | 📅 2025-03-28 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,403 | 🐛 368 | 🌐 Go | 📅 2025-07-07 - go generate based graphql server library.
...
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,080 | 🐛 237 | 🌐 Go | 📅 2025-04-01 - Implementation of GraphQL for Go.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,086 | 🐛 246 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [Poly](https://github.com/bebop/poly) ⭐ 707 | 🐛 30 | 🌐 Go | 📅 2024-10-21 - A Go package for engineering organisms.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,195 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,258 | 🐛 2 | 🌐 Go | 📅 2025-07-10 - A secure low code honeypot framework, leveraging AI for System Virtualization.
...
* [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,273 | 🐛 24 | 🌐 Go | 📅 2025-07-07 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,746 | 🐛 94 | 🌐 Go | 📅 2025-07-10 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,719 | 🐛 161 | 🌐 Go | 📅 2025-07-08 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [csvutil](https://github.com/jszwec/csvutil) ⭐ 993 | 🐛 1 | 🌐 Go | 📅 2025-03-15 - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,979 | 🐛 116 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [jsoniter](https://github.com/json-iterator/go) ⭐ 13,815 | 🐛 267 | 🌐 Go | 📅 2024-05-27 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,405 | 🐛 220 | 🌐 Go | 📅 2025-07-09 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,834 | 🐛 21 | 🌐 Go | 📅 2025-07-09 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,804 | 🐛 321 | 🌐 Go | 📅 2025-07-09 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,600 | 🐛 50 | 🌐 Go | 📅 2025-07-09 - Fider is an open platform to collect and organize customer feedback.
...
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,687 | 🐛 21 | 🌐 Go | 📅 2025-07-09 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [minio](https://github.com/minio/minio) ⭐ 53,691 | 🐛 52 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 48,849 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,182 | 🐛 80 | 🌐 Go | 📅 2025-07-07 - High-performance PHP application server, load-balancer and process manager.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,675 | 🐛 110 | 🌐 Go | 📅 2025-07-03 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,034 | 🐛 46 | 🌐 Go | 📅 2025-06-30 - HTTP reverse proxy cache and time series accelerator.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,198 | 🐛 14 | 🌐 Go | 📅 2025-06-23 - Make SSH apps, just like that!
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,058 | 🐛 4 | 🌐 Go | 📅 2025-05-11 - Go stream processing library.
...
* [jet](https://github.com/CloudyKit/jet) ⭐ 1,340 | 🐛 21 | 🌐 Go | 📅 2025-03-23 - Jet template engine.
* [liquid](https://github.com/osteele/liquid) ⭐ 309 | 🐛 30 | 🌐 Go | 📅 2025-06-01 - Go implementation of Shopify Liquid templates.
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,483 | 🐛 53 | 🌐 Go | 📅 2025-03-21 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,460 | 🐛 70 | 🌐 Go | 📅 2025-07-09 - A HTML templating language that has great developer tooling.
...
* [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 975 | 🐛 7 | 🌐 Go | 📅 2025-06-02 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-07-08 - HTTP client testing framework.
...
* [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,445 | 🐛 24 | 🌐 Go | 📅 2025-07-09 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
...
* [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,363 | 🐛 167 | 🌐 Go | 📅 2024-07-30 - BDD-style framework with web UI and live reload.
...
* [is](https://github.com/matryer/is) ⭐ 1,901 | 🐛 7 | 🌐 Go | 📅 2024-02-08 - Professional lightweight testing mini-framework for Go.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,287 | 🐛 238 | 🌐 Go | 📅 2025-07-09 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,183 | 🐛 138 | 🌐 Go | 📅 2025-07-09 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,054 | 🐛 28 | 🌐 Go | 📅 2025-06-06 - Tool for generating self-contained mock objects.
...
* [gock](https://github.com/h2non/gock) ⭐ 2,181 | 🐛 47 | 🌐 Go | 📅 2024-09-24 - Versatile HTTP mocking made easy.
* [gomock](https://github.com/uber-go/mock) ⭐ 2,902 | 🐛 95 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,037 | 🐛 5 | 🌐 Go | 📅 2025-04-05 - Easy mocking of HTTP responses from external resources.
* [minimock](https://github.com/gojuno/minimock) ⭐ 696 | 🐛 9 | 🌐 Go | 📅 2025-06-10 - Mock generator for Go interfaces.
* [mockery](https://github.com/vektra/mockery) ⭐ 6,687 | 🐛 41 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 494 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,113 | 🐛 235 | 🌐 Go | 📅 2025-06-26.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,006 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,778 | 🐛 54 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
* [rod](https://github.com/go-rod/rod) ⭐ 6,064 | 🐛 184 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,579 | 🐛 41 | 🌐 Go | 📅 2025-07-01 - Formatters for time, numbers, and memory size to human readable format.
* [gotabulate](https://github.com/bndr/gotabulate) ⭐ 337 | 🐛 5 | 🌐 Go | 📅 2021-02-09 - Easily pretty-print your tabular data with Go.
* [sq](https://github.com/neilotoole/sq) ⭐ 2,305 | 🐛 31 | 🌐 Go | 📅 2025-04-16 - Convert data from SQL databases or document formats like CSV or Excel into formats such as JSON, Excel, CSV, HTML, Markdown, XML, and YAML.
...
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,177 | 🐛 8 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,923 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [go-fasttld](https://github.com/elliotwutingfeng/go-fasttld) ⭐ 38 | 🐛 1 | 🌐 Go | 📅 2025-07-08 - High performance effective top level domains (eTLD) extraction module.
* [go-nmea](https://github.com/adrianmo/go-nmea) ⭐ 244 | 🐛 1 | 🌐 Go | 📅 2024-12-09 - NMEA parser library for the Go language.
* [go-querystring](https://github.com/google/go-querystring) ⭐ 2,059 | 🐛 20 | 🌐 Go | 📅 2025-06-23 - Go library for encoding structs into URL query parameters.
* [go-vcard](https://github.com/emersion/go-vcard) ⭐ 117 | 🐛 7 | 🌐 Go | 📅 2024-10-24 - Parse and format vCard.
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,263 | 🐛 4 | 🌐 Go | 📅 2025-07-08 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,848 | 🐛 100 | 🌐 Go | 📅 2025-07-07 - Shell parser and formatter.
...
* [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,436 | 🐛 26 | 🌐 Go | 📅 2025-04-04 - HTML Sanitizer.
* [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 | 🐛 1 | 🌐 Go | 📅 2025-06-01 - A sanitization-based swear filter for Go.

### Scrapers

* [colly](https://github.com/asciimoo/colly) ⭐ 24,426 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
...
* [xurls](https://github.com/mvdan/xurls) ⭐ 1,225 | 🐛 2 | 🌐 Go | 📅 2025-02-22 - Extract urls from text.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,146 | 🐛 82 | 🌐 Go | 📅 2025-07-09 - The official AWS SDK for the Go programming language.
...
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,460 | 🐛 187 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
...
* [github](https://github.com/google/go-github) ⭐ 10,857 | 🐛 32 | 🌐 Go | 📅 2025-07-04 - Go library for accessing the GitHub REST API v3.
* [githubql](https://github.com/shurcooL/githubql) ⭐ 1,152 | 🐛 43 | 🌐 Go | 📅 2024-07-27 - Go library for accessing the GitHub GraphQL API v4.
...
* [go-jira](https://github.com/andygrunwald/go-jira) ⭐ 1,542 | 🐛 182 | 🌐 Go | 📅 2025-07-06 - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,145 | 🐛 209 | 🌐 Go | 📅 2025-07-08 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,283 | 🐛 17 | 🌐 Go | 📅 2025-07-09 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,286 | 🐛 382 | 🌐 Go | 📅 2025-07-10 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,735 | 🐛 21 | 🌐 Go | 📅 2025-07-10 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [slack](https://github.com/slack-go/slack) ⭐ 4,807 | 🐛 104 | 🌐 Go | 📅 2025-07-04 - Slack API in Go.
...
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,345 | 🐛 9 | 🌐 Go | 📅 2025-07-09 - Go client for the Stripe API.
...
* [bed](https://github.com/itchyny/bed) ⭐ 1,305 | 🐛 1 | 🌐 Go | 📅 2024-12-01 - A Vim-like binary editor written in Go.
...
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,236 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,359 | 🐛 169 | 🌐 Go | 📅 2025-07-07 - A tool for exploring each layer in a Docker image.
...
* [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,809 | 🐛 27 | 🌐 Go | 📅 2025-06-24 - Fault tolerance and resilience patterns for Go.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 71,806 | 🐛 291 | 🌐 Go | 📅 2025-07-06 - Command-line fuzzy finder written in Go.
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,824 | 🐛 25 | 🌐 Go | 📅 2025-07-10 - Deliver Go binaries as fast and easily as possible.
...
* [hub](https://github.com/github/hub) ⭐ 22,911 | 🐛 294 | 🌐 Go | 📅 2024-02-02 - wrap git commands with additional functionality to interact with github from the terminal.
...
* [jump](https://github.com/gsamokovarov/jump) ⭐ 1,865 | 🐛 2 | 🌐 Go | 📅 2025-06-20 - Jump helps you navigate faster by learning your habits.
...
* [lo](https://github.com/samber/lo) ⭐ 19,719 | 🐛 206 | 🌐 Go | 📅 2025-07-07 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,825 | 🐛 42 | 🌐 Go | 📅 2025-07-07 - Package for MIME type detection based on magic numbers.
...
* [scan](https://github.com/blockloop/scan) ⭐ 597 | 🐛 1 | 🌐 Go | 📅 2025-06-06 - Scan golang `sql.Rows` directly to structs, slices, or primitive types.
* [scan](https://github.com/wroge/scan) ⭐ 66 | 🐛 0 | 🌐 Go | 📅 2024-03-08 - Scan sql rows into any type powered by generics.
* [scany](https://github.com/georgysavva/scany) ⭐ 1,440 | 🐛 6 | 🌐 Go | 📅 2025-03-19 - Library for scanning data from a database into Go structs and more.
* [serve](https://github.com/syntaqx/serve) ⭐ 345 | 🐛 2 | 🌐 Go | 📅 2025-05-05 - A static http server anywhere you need.
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,132 | 🐛 54 | 🌐 Go | 📅 2025-07-03 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,035 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
...
* [toolbox](https://github.com/viant/toolbox) ⭐ 221 | 🐛 5 | 🌐 Go | 📅 2024-12-10 - Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer.
...
* [usql](https://github.com/knq/usql) ⭐ 9,422 | 🐛 94 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,756 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [uuid](https://github.com/google/uuid) ⭐ 5,722 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [validate](https://github.com/gookit/validate) ⭐ 1,098 | 🐛 27 | 🌐 Go | 📅 2025-06-30 - Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,630 | 🐛 322 | 🌐 Go | 📅 2025-07-02 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 897 | 🐛 7 | 🌐 Go | 📅 2025-07-03 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,941 | 🐛 512 | 🌐 TypeScript | 📅 2025-07-10 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,704 | 🐛 163 | 🌐 Go | 📅 2025-07-09 - highly extensible Git implementation in pure Go.
...
* [goav](https://github.com/giorgisio/goav) ⭐ 2,120 | 🐛 48 | 🌐 Go | 📅 2022-05-19 - Comprehensive Go bindings for FFmpeg.
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 804 | 🐛 19 | 🌐 Go | 📅 2025-07-06 - Pure Go RTSP server and client library.
...
* [Beego](https://github.com/beego/beego) ⭐ 32,140 | 🐛 18 | 🌐 Go | 📅 2025-06-25 - beego is an open-source, high-performance web framework for the Go programming language.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,243 | 🐛 106 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 480 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,082 | 🐛 104 | 🌐 Go | 📅 2025-07-10 - An Express.js inspired web framework build on Fasthttp.
...
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,436 | 🐛 39 | 🌐 Go | 📅 2025-07-08 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,049 | 🐛 861 | 🌐 Go | 📅 2025-07-08 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,946 | 🐛 78 | 🌐 Go | 📅 2025-07-09 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,514 | 🐛 208 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,370 | 🐛 44 | 🌐 Go | 📅 2025-07-09 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,220 | 🐛 119 | 🌐 Go | 📅 2025-07-02 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
* [Revel](https://github.com/revel/revel) ⭐ 13,200 | 🐛 99 | 🌐 Go | 📅 2023-10-28 - High-productivity web framework for the Go language.
...
* [templui](https://github.com/axzilla/templui) ⭐ 761 | 🐛 10 | 🌐 JavaScript | 📅 2025-07-09 - Modern UI Components for Go & Templ.
...
* [render](https://github.com/unrolled/render) ⭐ 1,966 | 🐛 1 | 🌐 Go | 📅 2024-10-15 - Go package for easily rendering JSON, XML, and HTML template responses.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,090 | 🐛 84 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,916 | 🐛 82 | 🌐 Go | 📅 2024-07-22 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,449 | 🐛 504 | 🌐 Go | 📅 2025-07-09 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,030 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 233 | 🐛 15 | 🌐 Go | 📅 2025-07-08 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,379 | 🐛 110 | 🌐 Go | 📅 2025-07-09 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,047 | 🐛 260 | 🌐 Go | 📅 2025-07-09 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,426 | 🐛 240 | 🌐 Go | 📅 2025-07-09 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 108 | 🐛 20 | 🌐 Go | 📅 2025-07-09 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,986 | 🐛 159 | 🌐 Go | 📅 2025-07-09 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,424 | 🐛 13 | 🌐 Go | 📅 2025-06-30 - Errcheck is a program for checking for unchecked errors in Go programs.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,288 | 🐛 120 | 🌐 Go | 📅 2025-07-09 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,223 | 🐛 52 | 🌐 Go | 📅 2025-07-10 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 141 | 🐛 35 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,878 | 🐛 371 | 🌐 Go | 📅 2025-07-01.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 792 | 🐛 71 | 🌐 Go | 📅 2025-07-09 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,754 | 🐛 96 | 🌐 Go | 📅 2025-07-09 features to Vim/Neovim.
...
* [goimports-reviser](https://github.com/incu6us/goimports-reviser) ⭐ 674 | 🐛 24 | 🌐 Go | 📅 2025-04-16 - Formatting tool for imports.
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,309 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,796 | 🐛 608 | 🌐 Go | 📅 2025-06-27 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [gotutor](https://github.com/ahmedakef/gotutor) ⭐ 47 | 🐛 0 | 🌐 Elm | 📅 2025-07-08 - Online Go Debugger & Visualizer.
...
* [alaz](https://github.com/ddosify/alaz) ⭐ 689 | 🐛 7 | 🌐 C | 📅 2024-10-02 - Effortless, Low-Overhead, eBPF-based Kubernetes Monitoring.
...
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,415 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
...
* [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,479 | 🐛 16 | 🌐 Go | 📅 2025-03-13 - High-performance load testing tool, written in Golang.
* [decompose](https://github.com/s0rg/decompose) ⭐ 105 | 🐛 3 | 🌐 Go | 📅 2024-12-13 - tool to generate and process Docker containers connections graphs.
...
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,177 | 🐛 28 | 🌐 Go | 📅 2025-07-09 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,214 | 🐛 2,566 | 🌐 Go | 📅 2025-07-10 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,229 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,771 | 🐛 12 | 🌐 Go | 📅 2025-07-04 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,492 | 🐛 2,721 | 🌐 Go | 📅 2025-07-10 - Fork of Gogs, entirely community driven.
...
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) ⭐ 1,619 | 🐛 16 | 🌐 Go | 📅 2024-08-17 - Enable your Go applications to self update.
...
* [grapes](https://github.com/yaronsumel/grapes) ⭐ 169 | 🐛 2 | 🌐 Go | 📅 2025-06-05 - Lightweight tool designed to distribute commands over ssh with ease.
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,056 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,040 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,895 | 🐛 246 | 🌐 Go | 📅 2025-07-08 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,173 | 🐛 130 | 🌐 Go | 📅 2025-07-08 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,224 | 🐛 804 | 🌐 Go | 📅 2025-07-09 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,293 | 🐛 209 | 🌐 Go | 📅 2025-07-08 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [ko](https://github.com/google/ko) ⭐ 8,059 | 🐛 54 | 🌐 Go | 📅 2025-07-10 - Command line tool for building and deploying Go applications on Kubernetes
* [kool](https://github.com/kool-dev/kool) ⭐ 690 | 🐛 6 | 🌐 Go | 📅 2025-05-23 - Command line tool for managing Docker environments as an easy way.
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,760 | 🐛 146 | 🌐 Go | 📅 2025-07-10 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,238 | 🐛 2,605 | 🌐 Go | 📅 2025-07-10 - Container Cluster Manager from Google.
...
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,753 | 🐛 543 | 🌐 Go | 📅 2025-07-08 - Cloud native application delivery.
* [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,182 | 🐛 5 | 🌐 Go | 📅 2025-07-10 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
* [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,146 | 🐛 47 | 🌐 Go | 📅 2025-07-09 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,670 | 🐛 524 | 🌐 Go | 📅 2025-07-09 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,062 | 🐛 3,613 | 🌐 Go | 📅 2025-07-09 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,408 | 🐛 304 | 🌐 Go | 📅 2025-07-10 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 436 | 🐛 1 | 🌐 Go | 📅 2024-06-19 - Flexible HTTP command line stress tester.
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,185 | 🐛 108 | 🌐 Go | 📅 2025-07-10 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,646 | 🐛 29 | 🌐 Go | 📅 2025-06-27 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,332 | 🐛 134 | 🌐 Go | 📅 2025-07-09 - Pomerium is an identity-aware access proxy.
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,400 | 🐛 140 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 925 | 🐛 202 | 🌐 Go | 📅 2025-07-09 - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [tlm](https://github.com/yusufcanb/tlm) ⭐ 1,433 | 🐛 6 | 🌐 Go | 📅 2025-03-28 - Local cli copilot, powered by CodeLLaMa
* [traefik](https://github.com/containous/traefik) ⭐ 55,482 | 🐛 658 | 🌐 Go | 📅 2025-07-09 - Reverse proxy and load balancer with support for multiple backends.
...
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,363 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,445 | 🐛 66 | 🌐 Go | 📅 2025-07-04 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 585 | 🐛 10 | 🌐 Go | 📅 2025-07-09 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [croc](https://github.com/schollz/croc) ⭐ 30,538 | 🐛 14 | 🌐 Go | 📅 2025-07-07 - Easily and securely send files or folders from one computer to another.
...
* [GoNB](https://github.com/janpfeifer/gonb) ⭐ 881 | 🐛 10 | 🌐 Go | 📅 2025-06-01 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,858 | 🐛 130 | 🌐 Go | 📅 2025-07-09 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [nes](https://github.com/fogleman/nes) ⭐ 5,575 | 🐛 12 | 🌐 Go | 📅 2024-08-17 - Nintendo Entertainment System (NES) emulator written in Go.
...
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,662 | 🐛 28 | 🌐 Go | 📅 2024-08-20 - Portal is a quick and easy command-line file transfer utility from any computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,251 | 🐛 474 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 702 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,461 | 🐛 53 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,122 | 🐛 590 | 🌐 Go | 📅 2025-07-10 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,345 | 🐛 91 | 🌐 Go | 📅 2025-07-07 - Proxy to simulate network and system conditions for automated tests.
...
* [yai](https://github.com/ekkinox/yai) ⭐ 804 | 🐛 29 | 🌐 Go | 📅 2024-07-31 - AI powered terminal assistant.
...
* [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 431 | 🐛 0 | 🌐 Go | 📅 2025-03-14 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
* [Build Web Application with Golang](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/)
* [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
* [Go 101](https://go101.org) - A book focusing on Go syntax/semantics and all kinds of details.
* [Go AST Book (Chinese)](https://github.com/chai2010/go-ast-book) ⭐ 5,464 | 🐛 8 | 🌐 Go | 📅 2024-09-26 - A book focusing on Go `go/*` packages.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,197 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,062 | 🐛 7,335 | 🌐 Go | 📅 2025-07-10
* [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
* [Google](https://google.github.io/styleguide/go/)
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,188 | 🐛 182 | 🌐 Go | 📅 2025-06-30
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,634 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,655 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,694 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,805 | 🐛 9,388 | 🌐 Go | 📅 2025-07-09 - List of projects on the Go community wiki.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,679 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
...
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,661 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
...
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,652 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,382 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,957 | 🐛 66 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
