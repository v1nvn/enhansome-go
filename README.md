...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,626](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 246,919.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,626 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,626; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,983 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,242 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
...
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,871 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,256 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 143,946 - Run large language models locally.
...
- [authboss](https://github.com/volatiletech/authboss) ⭐ 3,959 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,760 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,047 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,155 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- [keto](https://github.com/ory/keto) ⭐ 5,043 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,625 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
- [oidc](https://github.com/zitadel/oidc) ⭐ 1,578 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
- [openfga](https://github.com/openfga/openfga) ⭐ 3,712 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,349 - Session Manager for HTTP servers.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,143 - Official Go implementation of the Ethereum protocol.
...
- [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,325 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
- [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,803 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,191 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,350 - Telegram bot framework is written in Go.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,770 - Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4,355 - Mage is a make/rake-like build tool using Go.
...
- [Task](https://github.com/go-task/task) ⭐ 12,982 - simple "Make" alternative.
...
- [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 497 - An interactive table component for bubbletea.
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,430 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,291 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,556 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,372 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,766.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,263 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,105 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,416 - Basic thread-safe progress bar that works in every OS.
- [pterm](https://github.com/pterm/pterm) ⭐ 5,111 - A library to beautify console output on every platform with many combinable components.
- [simpletable](https://github.com/alexeyco/simpletable) ⭐ 539 - Simple tables in a terminal with Go.
- [spinner](https://github.com/briandowns/spinner) ⭐ 2,438 - Go package to easily provide a terminal spinner with options.
...
- [termbox-go](https://github.com/nsf/termbox-go) ⭐ 4,730 - Termbox is a library for creating cross-platform text-based interfaces.
...
- [termenv](https://github.com/muesli/termenv) ⭐ 1,845 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,372 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,608.
...
- [yacspin](https://github.com/theckman/yacspin) ⭐ 449 - Yet Another CLi Spinner package, for working with terminal spinners.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 686 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,293 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,736 - Commander for modern Go CLI interactions.
...
- [console](https://github.com/reeflective/console) ⭐ 95 Closed-loop application library for Cobra commands, with oh-my-posh prompts, and more.
...
- [kingpin](https://github.com/alecthomas/kingpin) ⭐ 3,533 - Command line and flag parser supporting sub commands (superseded by `kong`; see below).
...
- [ops](https://github.com/nanovms/ops) ⭐ 1,356 - Unikernel Builder/Orchestrator.
- [pflag](https://github.com/spf13/pflag) ⭐ 2,575 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,253 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,844 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,541 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,362 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,235 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,248 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
- [konf](https://github.com/nil-go/konf) ⭐ 323 - The simplest API for reading/watching config from file, env, flag and clouds (e.g. AWS, Azure, GCP).
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,661 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,219 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,692 - Go configuration with fangs.
...
- [drone](https://github.com/drone/drone) ⭐ 32,868 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,566 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,747.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,154 - Woodpecker is a community fork of the Drone CI system.
...
- [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,122 - A high-performance ELT data integration framework with pluggable architecture.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,714 - Go package implementing compressed bitsets.
...
- [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) ⭐ 1,177 - Cuckoo filter: a good alternative to a counting bloom filter implemented in Go.
...
- [gods](https://github.com/emirpasic/gods) ⭐ 16,950 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [gota](https://github.com/kniren/gota) ⭐ 3,191 - Implementation of dataframes, series, and data wrangling methods for Go.
...
- [deque](https://github.com/gammazero/deque) ⭐ 685 - Fast ring-buffer deque (double-ended queue).
- [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) ⭐ 427 - Concurrent FIFO queue.
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,700 - Distributed, Fault-tolerant task queue.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,414 - Modern text indexing library for go.
...
- [gocache](https://github.com/eko/gocache) ⭐ 2,668 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,128 -  A high performance memory-bound Go cache.
- [sturdyc](https://github.com/viccon/sturdyc) ⭐ 1,208 - A caching library with advanced concurrency features designed to make I/O heavy applications robust and highly performant.
...
- [badger](https://github.com/dgraph-io/badger) ⭐ 14,660 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,848 - An embedded key/value database for Go.
...
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,004 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,941 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,543 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,433 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,746 - Dolt – It's Git for Data.
...
- [godis](https://github.com/hdt3213/godis) ⭐ 3,699 - A Golang implemented high-performance Redis server and cluster.
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,274 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,751 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,184 - Scalable datastore for metrics, events, and real-time analytics.
...
- [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,165 - Fast k/v database compatible with lsm and b+tree.
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,443 - Milvus is a vector database for embedding management, analytics and search.
- [moss](https://github.com/couchbase/moss) ⭐ 1,004 - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,477 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
- [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,229 - High-performance embedded Object Database (NoSQL) with Go API.
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,346 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,019 - Monitoring system and time series database.
...
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,680 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,588 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,322 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,943 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,583 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,061 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,544 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
- [gorm-seeder](https://github.com/Kachit/gorm-seeder) ⭐ 16 - Simple database seeder for Gorm ORM.
- [gormigrate](https://github.com/go-gormigrate/gormigrate) ⭐ 1,095 - Database schema migration helper for Gorm ORM.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,832 - Database migrations. CLI and Golang library.
...
- [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,342 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
- [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,763 - Go toolset to handle MySQL protocol and replication.
...
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,918 - Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,697 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,224 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,324 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,456 - Go library that helps you build SQL queries.
- [xo](https://github.com/knq/xo) ⭐ 3,823 - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
- [cayley](https://github.com/google/cayley) ⭐ 14,937 - Graph database with support for multiple backends.
...
- [firebirdsql](https://github.com/nakagami/firebirdsql) ⭐ 241 - Firebird RDBMS SQL driver for Go.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,864 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,525 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 712 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [KSQL](https://github.com/VinGarcia/ksql) ⭐ 332 - A Simple and Powerful Golang SQL Library
- [pgx](https://github.com/jackc/pgx) ⭐ 11,981 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,981 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,434 query results easily.
...
- [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 160 - native and database/sql driver YDB (Yandex Database)
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,375 - Official MongoDB driver for the Go language.
...
- [qmgo](https://github.com/qiniu/qmgo) ⭐ 1,327 - The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo.
- [redeo](https://github.com/bsm/redeo) ⭐ 445 - Redis-protocol compatible TCP servers/services.
- [redigo](https://github.com/gomodule/redigo) ⭐ 9,824 - Redigo is a Go client for the Redis database.
- [redis](https://github.com/redis/go-redis) ⭐ 20,973 - Redis client for Golang.
...
- [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,891 - Official Elasticsearch client for Go.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 977 - Fast trigram based code search.
...
- [digota](https://github.com/digota/digota) ⭐ 515 - grpc ecommerce microservice.
...
- [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,187 - A feature complete and high performance multi-group Raft library in Go.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,093 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,349 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,230 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,938 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,477 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,471 - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,603 - Lightweight, fault-tolerant message streams for NATS.
- [lura](https://github.com/luraproject/lura) ⭐ 6,565 - Ultra performant API Gateway framework with middlewares.
- [micro](https://github.com/micro/micro) ⭐ 12,256 - A distributed systems runtime for the cloud and beyond.
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,546 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,339 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
- [outboxer](https://github.com/italolelis/outboxer) ⭐ 162 - Outboxer is a go library that implements the outbox pattern.
- [pglock](https://cirello.io/pglock) - PostgreSQL-backed distributed locking implementation.
- [pjrpc](https://gitlab.com/pjrpc/pjrpc) - Golang JSON-RPC Server-Client with Protobuf spec.
- [raft](https://github.com/hashicorp/raft) ⭐ 8,638 - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 851 - Go implementation of the Raft consensus protocol, by CoreOS.
...
- [rpcx](https://github.com/smallnest/rpcx) ⭐ 8,223 - Distributed pluggable RPC service framework like alibaba Dubbo.
- [Semaphore](https://github.com/jexia/semaphore) ⭐ 94 - A straightforward (micro) service orchestrator.
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,294).
...
- [email](https://github.com/jordan-wright/email) ⭐ 2,736 - A robust and flexible email library for Go.
...
- [go-imap](https://github.com/emersion/go-imap) ⭐ 2,201 - IMAP library for clients and servers.
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,009 - A simple Go library for sending mails in Go.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,565 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,954 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,227 - Email and SMTP testing tool for developers.
...
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,613.
- [cel-go](https://github.com/google/cel-go) ⭐ 2,571 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,949 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,471 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,276 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,217 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,613 - Lua 5.1 VM and compiler written in Go.
...
- [starlark-go](https://github.com/google/starlark-go) ⭐ 2,481 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
- [starlet](https://github.com/1set/starlet) ⭐ 30 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,481 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,235 - Go error library with error portability over the network.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 280 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
- [multierr](https://github.com/uber-go/multierr) ⭐ 1,140 - Package for representing a list of errors as a single error.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,529 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,717 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,813.
...
- [ach](https://github.com/moov-io/ach) ⭐ 489 - A reader, writer, and validator for Automated Clearing House (ACH) files.
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1,366 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,789 - Arbitrary-precision fixed-point decimal numbers.
...
- [ledger](https://github.com/formancehq/ledger) ⭐ 980 - A programmable financial ledger that provides a foundation for money-moving applications.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,281 - Terminal stock watcher and stock position tracker.
...
- [go-functional](https://github.com/BooleanCat/go-functional) ⭐ 502 - Functional programming in Go using generics
...
- [Ark](https://github.com/mlange-42/ark) ⭐ 81 - Archetype-based Entity Component System (ECS) for Go.
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,133 - dead simple 2D game engine in Go.
...
- [Leaf](https://github.com/name5566/leaf) ⭐ 5,415 - Lightweight game server framework.
...
- [goverter](https://github.com/jmattheis/goverter) ⭐ 700 - Generate converters by defining an interface.
- [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,223 - Generate decorators for Go interfaces using simple templates.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,213 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 728 - A simple Go-based server for map tiles stored in mbtiles format.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,403 - Compile shell scripts to Go.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,748 - A high-performance and low-cost goroutine pool in Go.
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,928 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [pond](https://github.com/alitto/pond) ⭐ 1,793 - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,392 - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,694 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 415 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,214 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,658.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,594 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [walk](https://github.com/lxn/walk) ⭐ 6,981 - Windows application library kit for Go.
- [webview](https://github.com/zserge/webview) ⭐ 13,161 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,194 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
- [systray](https://github.com/getlantern/systray) ⭐ 3,495 - Cross platform Go library to place an icon and menu in the notification area.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,572 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
- [emgo](https://github.com/ziutek/emgo) ⭐ 1,085 - Go-like language for programming embedded systems (e.g. STM32 MCU).
- [ghw](https://github.com/jaypipes/ghw) ⭐ 1,756 - Golang hardware discovery/inspection library.
...
- [bild](https://github.com/anthonynsimon/bild) ⭐ 4,111 - Collection of image processing algorithms in pure Go.
- [bimg](https://github.com/h2non/bimg) ⭐ 2,864 - Small package for fast and efficient image processing using libvips.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,092 - Go package for computer vision using OpenCV 3.3+.
...
- [govips](https://github.com/davidbyttow/govips) ⭐ 1,445 - A lightning fast image processing and resizing library for Go.
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,779 - Screenshoting webpages using go and headless chrome on command line.
...
- [imagor](https://github.com/cshum/imagor) ⭐ 3,655 - Fast, secure image processing server and Go library, using libvips.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,132 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [cheek](https://github.com/bart6114/cheek) ⭐ 188 - A simple crontab like scheduler that aims to offer a KISS approach to job scheduling.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,303 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,490.
...
- [fastjson](https://github.com/valyala/fastjson) ⭐ 2,383 - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,986 - Get a JSON value with one line of code.
...
- [JayDiff](https://github.com/yazgazan/jaydiff) ⭐ 107 - JSON diff utility written in Go.
...
- [OjG](https://github.com/ohler55/ojg) ⭐ 895 - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 567 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,312 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,312 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,312 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,312, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,093, [zap](https://github.com/uber-go/zap) ⭐ 23,218, [zerolog](https://github.com/rs/zerolog) ⭐ 11,501, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,125 - Simple rolling logger, implements io.WriteCloser.
...
- [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 972 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
...
- [slog-formatter](https://github.com/samber/slog-formatter) ⭐ 172 - Common formatters for slog and helpers to build your own.
- [slog-multi](https://github.com/samber/slog-multi) ⭐ 487 - Chain of slog.Handler (pipeline, fanout...).
- [slogor](https://gitlab.com/greyxor/slogor) - A colorful slog handler.
- [spew](https://github.com/davecgh/go-spew) ⭐ 6,252 - Implements a deep pretty printer for Go data structures to aid in debugging.
- [sqldb-logger](https://github.com/simukti/sqldb-logger) ⭐ 374 - A logger for Go SQL database driver without modify existing \*sql.DB stdlib usage.
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,019 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,218 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,501 - Zero-allocation JSON logger.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 802 - An accelerated Machine Learning framework for Go.
...
- [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,785 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,890 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 789 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,786 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,386 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,033 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,769 - Asynchronous task queue/job queue based on distributed message passing.
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,963 - Go client for the NATS
  messaging system.
...
- [pubsub](https://github.com/tuxychandru/pubsub) ⭐ 437 - Simple pubsub package for go.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,554 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,591 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize](https://github.com/xuri/excelize) ⭐ 19,273 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [do](https://github.com/samber/do) ⭐ 2,135 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,576 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,841 - Automated Initialization in Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,798 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,798 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,620 - Allows users to spin up a quick Go project using a popular framework.
...
- [go-todo-backend](https://github.com/Fs02/go-todo-backend) ⭐ 331 - Go Todo Backend example using modular project layout for product microservice.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,757 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,757 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,257 - Nunu is a scaffolding tool for building Go applications.
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,540 - Rapid, easy full-stack web development starter kit built in Go.
...
- [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,124 - cross-platform, cli app to perform various operations on string.
...
- [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,247 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
- [basexx](https://github.com/bobg/basexx) ⭐ 5 - Convert to, from, and between digit strings in various number bases.
- [battery](https://github.com/distatus/battery) ⭐ 259 - Cross-platform, normalized battery information library.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,551 - Automated service health dashboard.
...
- [go-resiliency](https://github.com/eapache/go-resiliency) ⭐ 2,294 - Resiliency patterns for golang.
- [go-unarr](https://github.com/gen2brain/go-unarr) ⭐ 292 - Decompression library for RAR, TAR, ZIP and 7z archives.
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,957 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,235 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [xz](https://github.com/ulikunitz/xz) ⭐ 514 - Pure golang package for reading and writing xz-compressed files.
...
- [kagome](https://github.com/ikawaha/kagome) ⭐ 876 - JP morphological analyzer written in pure Go.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,531 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,171 which a Chinese word splitting algorithm.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,259 - Package and an accompanying tool to work with localized text.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,821 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,635 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gaio](https://github.com/xtaci/gaio) ⭐ 789 - High performance async-io networking for Golang in proactor mode.
...
- [gmqtt](https://github.com/DrmagicE/gmqtt) ⭐ 1,005 - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,592 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
- [gnet](https://github.com/fish-tennis/gnet) ⭐ 21 - `gnet` is a high-performance networking framework,especially for game servers.
- [gNxI](https://github.com/google/gnxi) ⭐ 273 - A collection of tools for Network Management that use the gNMI and gNOI protocols.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,811 - BGP implemented in the Go Programming Language.
- [gopacket](https://github.com/google/gopacket) ⭐ 6,545 - Go library for packet processing with libpcap bindings.
- [gopcap](https://github.com/akrennmair/gopcap) ⭐ 492 - Go wrapper for libpcap.
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,383 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,266 - KCP - Fast and Reliable ARQ Protocol.
...
- [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,318 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 918 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [psql-wire](https://github.com/jeroenrinzema/psql-wire) ⭐ 142 - PostgreSQL server wire protocol. Build your own server and start serving connections..
- [publicip](https://github.com/polera/publicip) ⭐ 29 - Package publicip returns your public facing IPv4 address (internet egress).
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,738 - An implementation of the QUIC protocol in pure Go.
...
- [sftp](https://github.com/pkg/sftp) ⭐ 1,580 - Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>.
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,913 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,917 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [water](https://github.com/songgao/water) ⭐ 2,042 - Simple TUN/TAP library.
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,929 - A pure Go implementation of the WebRTC API.
...
- [req](https://github.com/imroc/req) ⭐ 4,516 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,966 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
- [rq](https://github.com/ddo/rq) ⭐ 53 - A nicer interface for golang stdlib HTTP client.
- [sling](https://github.com/dghubble/sling) ⭐ 1,703 - Sling is a Go HTTP client library for creating and sending API requests.
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,167 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [glfw](https://github.com/go-gl/glfw) ⭐ 1,626 - Go bindings for GLFW 3.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,310 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,202 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,269 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,351 - The fantastic ORM library for Golang, aims to be developer friendly.
- [gormt](https://github.com/xxjwxc/gormt) ⭐ 2,399 - Mysql database to golang gorm struct.
- [gorp](https://github.com/go-gorp/gorp) ⭐ 3,747 - Go Relational Persistence, ORM-ish library for Go.
...
- [upper.io/db](https://github.com/upper/db) ⭐ 3,597 - Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.
...
- [gup](https://github.com/nao1215/gup) ⭐ 413 - Update binaries installed by "go install".
...
- [syft](https://github.com/anchore/syft) ⭐ 7,214 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,470 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 170 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,058 - No instrumentation tracing for Golang applications via eBPF.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,482 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,376 - go generate based graphql server library.
...
- [ewma](https://github.com/VividCortex/ewma) ⭐ 447 - Exponentially-weighted moving averages.
...
- [go-hep](https://github.com/go-hep/hep) ⭐ 245 - A set of libraries and tools for performing High Energy Physics analyses with ease.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,046 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,866 - gonum/plot provides an API for building and drawing plots in Go.
...
- [orb](https://github.com/paulmach/orb) ⭐ 993 - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
- [acmetool](https://github.com/hlandau/acme) ⭐ 2,074 - ACME (Let's Encrypt) client tool with automatic renewal.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,069 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,168 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 565 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,398 - Tool and library to remotely hack RTSP streams from surveillance cameras.
- [certificates](https://github.com/mvmaasakkers/certificates) ⭐ 38 - An opinionated tool for generating tls certificates.
- [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,241 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,703 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [go-yara](https://github.com/hillu/go-yara) ⭐ 370 - Go Bindings for [YARA](https://github.com/plusvic/yara) ⭐ 138, the "pattern matching swiss knife for malware researchers (and everyone else)".
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,652 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [cbor](https://github.com/fxamacker/cbor) ⭐ 884 - Small, safe, and easy CBOR encoding and decoding library.
...
- [go-codec](https://github.com/ugorji/go) ⭐ 1,894 - High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support.
...
- [mapstructure](https://github.com/mitchellh/mapstructure) ⭐ 7,987 - Go library for decoding generic map values into native Go structures.
...
- [algernon](https://github.com/xyproto/algernon) ⭐ 2,913 - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,938 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [discovery](https://github.com/Bilibili/discovery) ⭐ 1,793 - A registry for resilient mid-tier load balancing and failover.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,631 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,548 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,499 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,423 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,671 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 53,191 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,824 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,172 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,578 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,140 - Make SSH apps, just like that!
...
- [go-etl](https://github.com/Breeze0806/go-etl) ⭐ 148 - A lightweight toolkit for data source extraction, transformation, and loading (ETL).
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,438 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
- [pongo2](https://github.com/flosch/pongo2) ⭐ 2,957 - Django-like template-engine for Go.
- [quicktemplate](https://github.com/valyala/quicktemplate) ⭐ 3,223 - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
- [raymond](https://github.com/aymerick/raymond) ⭐ 636 - Complete handlebars implementation in Go.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,385 - A HTML templating language that has great developer tooling.
...
- [go-cmp](https://github.com/google/go-cmp) ⭐ 4,429 - Package for comparing Go values in tests.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,235 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,119 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,746 - Sacred extension to the standard go testing package.
...
- [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,050 - Tool for generating self-contained mock objects.
...
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,376 - Mock SQL driver for testing database interactions.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,851 - Mocking framework for the Go programming language.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,634 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 484 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,981.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,922 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,737 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,995 - A Devtools driver to make web automation and scraping easy.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,562 - Formatters for time, numbers, and memory size to human readable format.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,122 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,886 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [go-querystring](https://github.com/google/go-querystring) ⭐ 2,050 - Go library for encoding structs into URL query parameters.
...
- [godump (goforj)](https://github.com/goforj/godump) ⭐ 900 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 24,328 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,534 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [go-runewidth](https://github.com/mattn/go-runewidth) ⭐ 639 - Functions to get fixed width of the character or string.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,099 - The official AWS SDK for the Go programming language.
...
- [github](https://github.com/google/go-github) ⭐ 10,829 - Go library for accessing the GitHub REST API v3.
...
- [go-lark](https://github.com/go-lark/lark) ⭐ 223 - An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,071 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 2,708 - Minio Go Library for Amazon S3 compatible cloud storage.
...
- [paypal](https://github.com/logpacker/PayPal-Go-SDK) ⭐ 731 - Wrapper for PayPal payment API.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,792 - Slack API in Go.
...
- [stripe](https://github.com/stripe/stripe-go) ⭐ 2,329 - Go client for the Stripe API.
...
- [bed](https://github.com/itchyny/bed) ⭐ 1,297 - A Vim-like binary editor written in Go.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,191 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [debounce](https://github.com/floatdrop/debounce) ⭐ 20 - A zero-allocation debouncer written in Go.
- [delve](https://github.com/derekparker/delve) ⭐ 651 - Go debugger.
- [dive](https://github.com/wagoodman/dive) ⭐ 51,113 - A tool for exploring each layer in a Docker image.
...
- [filetype](https://github.com/h2non/filetype) ⭐ 2,195 - Small package to infer the file type checking the magic numbers signature.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 71,047 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,744 - Deliver Go binaries as fast and easily as possible.
...
- [hub](https://github.com/github/hub) ⭐ 22,911 - wrap git commands with additional functionality to interact with github from the terminal.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,058 - A comprehensive, efficient, and reusable util function library of go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,574 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mc](https://github.com/minio/mc) ⭐ 3,061 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
- [mergo](https://github.com/imdario/mergo) ⭐ 3,006 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,075 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,002 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,736 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/google/uuid) ⭐ 5,697 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,140 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,161 - Validators and sanitizers for strings, numerics, slices and structs.
...
- [jio](https://github.com/faceair/jio) ⭐ 118 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,116.
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,935 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,486 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 873 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,636 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,633 - highly extensible Git implementation in pure Go.
...
- [go-astiav](https://github.com/asticode/go-astiav) ⭐ 510 - Better C bindings for ffmpeg in GO.
...
- [gortsplib](https://github.com/aler9/gortsplib) ⭐ 785 - Pure Go RTSP server and client library.
...
- [Beego](https://github.com/beego/beego) ⭐ 32,121 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,151 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 455 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,883 - An Express.js inspired web framework build on Fasthttp.
- [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 529 - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,413 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,777 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,806 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,453 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,861 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,312 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,158 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 720 - Modern UI Components for Go & Templ.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,953 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,897 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,412 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,339 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 229 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
- [go-ole](https://github.com/go-ole/go-ole) ⭐ 1,246 - Win32 OLE implementation for golang.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,259 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 552 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
- [workflow](https://github.com/luno/workflow) ⭐ 167 - A tech stack agnostic Event Driven Workflow framework.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 5,006 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,372 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,163 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,200 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 139 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,746.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 574 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,719 features to Vim/Neovim.
...
- [goimports-reviser](https://github.com/incu6us/goimports-reviser) ⭐ 671 - Formatting tool for imports.
...
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,069 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [gotests](https://github.com/cweill/gotests) ⭐ 5,071 - Generate Go tests from your source code.
...
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,605 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
- [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,663 - aptly is a Debian repository management tool.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,137 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,093 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,224 - Build powerful pipelines in any programming language.
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,754 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,105 - Fork of Gogs, entirely community driven.
...
- [go-selfupdate](https://github.com/sanbornm/go-selfupdate) ⭐ 1,616 - Enable your Go applications to self update.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,998 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,975 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,851 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,965 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,053 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,217 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,036 - Command line tool for building and deploying Go applications on Kubernetes
- [kool](https://github.com/kool-dev/kool) ⭐ 687 - Command line tool for managing Docker environments as an easy way.
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,738 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,815 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,383 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,722 - Cloud native application delivery.
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,171 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,557 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,919 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Packer](https://github.com/mitchellh/packer) ⭐ 15,391 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
- [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,620 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,302 - Pomerium is an identity-aware access proxy.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,339 - Blazing fast S3 and local filesystem execution tool.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,019 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,196 - Reverse proxy and load balancer with support for multiple backends.
...
- [uTask](https://github.com/ovh/utask) ⭐ 1,284 - Automation engine that models and executes business processes declared in yaml.
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,294 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,394 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,399 - Simulate bad network connections.
- [confd](https://github.com/kelseyhightower/confd) ⭐ 8,393 - Manage local application configuration files using templates and data from etcd or consul.
- [crawley](https://github.com/s0rg/crawley) ⭐ 300 - Web scraper/crawler for cli.
- [croc](https://github.com/schollz/croc) ⭐ 30,384 - Easily and securely send files or folders from one computer to another.
- [Documize](https://github.com/documize/community) ⭐ 2,253 - Modern wiki software that integrates data from SaaS tools.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,457 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,946 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
- [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 868 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
- [Gor](https://github.com/buger/gor) ⭐ 18,961 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,713 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,651 - Portal is a quick and easy command-line file transfer utility from any computer to another.
- [restic](https://github.com/restic/restic) ⭐ 29,017 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 699 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,409 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,825 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,312 - Proxy to simulate network and system conditions for automated tests.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,088 - A curated list of Go books.
...
- [The Golang Standard Library by Example (Chinese)](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) ⭐ 9,546
...
- [gophers](https://github.com/egonelbre/gophers) ⭐ 3,657 - Free gophers.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,004
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,153
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,575
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,366 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,642 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,424 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,633 - Golang ebook intro how to build a web app with golang.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,878 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,566 - Curated list of Go design patterns, recipes and idioms.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,337 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,893 - Learn Go with test-driven development.
