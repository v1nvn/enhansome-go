...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 146,830 | 🐛 125 | 🌐 Go | 📅 2025-06-29
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 379,166 | 🐛 41 | 📅 2025-07-05
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 249,252 | 🐛 475 | 🌐 Python | 📅 2025-07-05.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 146,830 | 🐛 125 | 🌐 Go | 📅 2025-06-29 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 146,830 | 🐛 125 | 🌐 Go | 📅 2025-06-29; you rock!
...
* [Ergo](https://github.com/ergo-services/ergo) ⭐ 4,013 | 🐛 4 | 🌐 Go | 📅 2025-07-04 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 261 | 🐛 0 | 🌐 Go | 📅 2025-07-06 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
* [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,968 | 🐛 22 | 🌐 Go | 📅 2025-07-04 - Blazingly fast and light-weight Actor engine written in Golang.
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,260 | 🐛 87 | 🌐 Go | 📅 2024-08-22 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 623 | 🐛 11 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
* [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,057 | 🐛 366 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,712 | 🐛 476 | 🌐 Go | 📅 2025-07-06 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 145,743 | 🐛 1,864 | 🌐 Go | 📅 2025-07-06 - Run large language models locally.
...
* [flac](https://github.com/mewkiz/flac) ⭐ 335 | 🐛 8 | 🌐 Go | 📅 2024-08-11 - Native Go FLAC encoder/decoder with support for FLAC streams.
...
* [malgo](https://github.com/gen2brain/malgo) ⭐ 338 | 🐛 9 | 🌐 C | 📅 2024-10-22 - Mini audio library.
...
* [authboss](https://github.com/volatiletech/authboss) ⭐ 3,989 | 🐛 41 | 🌐 Go | 📅 2025-06-26 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,836 | 🐛 48 | 🌐 Go | 📅 2025-06-21 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,083 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,231 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,128 | 🐛 4 | 🌐 Go | 📅 2025-07-03 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
* [keto](https://github.com/ory/keto) ⭐ 5,057 | 🐛 57 | 🌐 Go | 📅 2025-07-04 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,638 | 🐛 40 | 🌐 Go | 📅 2025-05-05 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
* [openfga](https://github.com/openfga/openfga) ⭐ 3,793 | 🐛 131 | 🌐 Go | 📅 2025-07-07 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
* [osin](https://github.com/openshift/osin) ⭐ 1,926 | 🐛 3 | 🌐 Go | 📅 2025-05-08 - Golang OAuth2 server library.
...
* [paseto](https://github.com/o1egl/paseto) ⭐ 898 | 🐛 6 | 🌐 Go | 📅 2023-02-25 - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
* [scs](https://github.com/alexedwards/scs) ⭐ 2,358 | 🐛 29 | 🌐 Go | 📅 2025-04-17 - Session Manager for HTTP servers.
...
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 759 | 🐛 272 | 🌐 Go | 📅 2025-07-03 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,643 | 🐛 273 | 🌐 Go | 📅 2025-07-04 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 973 | 🐛 787 | 🌐 Go | 📅 2025-07-07 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,246 | 🐛 316 | 🌐 Go | 📅 2025-07-05 - Official Go implementation of the Ethereum protocol.
...
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,555 | 🐛 1,105 | 🌐 Go | 📅 2025-07-03 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,965 | 🐛 815 | 🌐 Go | 📅 2025-07-04 - A complete implementation of a Lightning Network node.
...
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,810 | 🐛 22 | 🌐 Go | 📅 2025-07-06 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
* [bot](https://github.com/go-telegram/bot) ⭐ 1,214 | 🐛 13 | 🌐 Go | 📅 2025-05-21 - Zero-dependencies Telegram Bot library with additional UI components
...
* [slack-bot](https://github.com/innogames/slack-bot) ⭐ 198 | 🐛 7 | 🌐 Go | 📅 2025-07-04 - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
* [slacker](https://github.com/slack-io/slacker) ⭐ 54 | 🐛 9 | 🌐 Go | 📅 2024-11-16 - Easy to use framework to create Slack bots.
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,383 | 🐛 55 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,198 | 🐛 168 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
* [wayback](https://github.com/wabarc/wayback) ⭐ 1,993 | 🐛 55 | 🌐 Go | 📅 2025-07-06 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [air](https://github.com/cosmtrek/air) ⭐ 20,941 | 🐛 178 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [Task](https://github.com/go-task/task) ⭐ 13,071 | 🐛 394 | 🌐 Go | 📅 2025-07-03 - simple "Make" alternative.
* [taskctl](https://github.com/taskctl/taskctl) ⭐ 312 | 🐛 6 | 🌐 Go | 📅 2025-01-18 - Concurrent task runner.
* [xc](https://github.com/joerdav/xc) ⭐ 1,300 | 🐛 17 | 🌐 Go | 📅 2025-07-04 - Task runner with README.md defined tasks, executable markdown.
...
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,538 | 🐛 153 | 🌐 Go | 📅 2025-06-29 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,940 | 🐛 121 | 🌐 Go | 📅 2025-07-03 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,382 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,800 | 🐛 673 | 🌐 Python | 📅 2025-07-03.
...
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,213 | 🐛 87 | 🌐 Go | 📅 2025-07-04 - Declaratively define styles for color, format and layout in the terminal.
...
* [mpb](https://github.com/vbauerster/mpb) ⭐ 2,412 | 🐛 17 | 🌐 Go | 📅 2025-06-05 - Multi progress bar for terminal applications.
...
* [pterm](https://github.com/pterm/pterm) ⭐ 5,135 | 🐛 59 | 🌐 Go | 📅 2025-06-07 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,845 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,377 | 🐛 105 | 🌐 Go | 📅 2024-07-22.
* [termenv](https://github.com/muesli/termenv) ⭐ 1,857 | 🐛 37 | 🌐 Go | 📅 2025-05-05 - Advanced ANSI style & color support for your terminal applications.
* [termui](https://github.com/gizak/termui) ⭐ 13,377 | 🐛 105 | 🌐 Go | 📅 2024-07-22 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,618 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
* [uilive](https://github.com/gosuri/uilive) ⭐ 1,705 | 🐛 12 | 🌐 Go | 📅 2023-07-22 - Library for updating terminal output in real time.
* [uiprogress](https://github.com/gosuri/uiprogress) ⭐ 2,128 | 🐛 28 | 🌐 Go | 📅 2024-02-29 - Flexible library to render progress bars in terminal applications.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 728 | 🐛 40 | 🌐 Go | 📅 2025-07-01 - Command argument completion generator for spf13/cobra.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,339 | 🐛 74 | 🌐 Go | 📅 2025-07-02 - Multi-shell multi-command argument completer.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,047 | 🐛 319 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [elvish](https://github.com/elves/elvish) ⭐ 6,053 | 🐛 337 | 🌐 Go | 📅 2025-06-29 - An expressive programming language and a versatile interactive shell.
...
* [ops](https://github.com/nanovms/ops) ⭐ 1,364 | 🐛 140 | 🌐 Go | 📅 2025-06-29 - Unikernel Builder/Orchestrator.
* [pflag](https://github.com/spf13/pflag) ⭐ 2,588 | 🐛 177 | 🌐 Go | 📅 2025-06-28 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,313 | 🐛 50 | 🌐 Go | 📅 2025-06-14 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,859 | 🐛 48 | 🌐 Go | 📅 2025-01-05 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
* [env](https://github.com/caarlos0/env) ⭐ 5,606 | 🐛 9 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,454 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,257 | 🐛 56 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,285 | 🐛 11 | 🌐 Go | 📅 2025-06-30 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [kong](https://github.com/alecthomas/kong) ⭐ 2,707 | 🐛 26 | 🌐 Go | 📅 2025-07-04 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,322 | 🐛 24 | 🌐 Go | 📅 2025-06-19 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,816 | 🐛 518 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
...
* [CDS](https://github.com/ovh/cds) ⭐ 4,728 | 🐛 149 | 🌐 Go | 📅 2025-07-04 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
* [drone](https://github.com/drone/drone) ⭐ 32,941 | 🐛 74 | 🌐 Go | 📅 2025-07-04 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 568 | 🐛 6 | 🌐 Go | 📅 2023-06-06 - go test output for humans.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,215 | 🐛 344 | 🌐 Go | 📅 2025-07-07 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,396 | 🐛 528 | 🌐 Go | 📅 2025-07-04 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,134 | 🐛 134 | 🌐 Go | 📅 2025-07-07 - A high-performance ELT data integration framework with pluggable architecture.
...
* [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,619 | 🐛 18 | 🌐 Go | 📅 2024-12-10 - Go package implementing Bloom filters.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 16,996 | 🐛 67 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [gota](https://github.com/kniren/gota) ⭐ 3,203 | 🐛 81 | 🌐 Go | 📅 2023-08-09 - Implementation of dataframes, series, and data wrangling methods for Go.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,790 | 🐛 80 | 🌐 TypeScript | 📅 2025-07-06 - Distributed, Fault-tolerant task queue.
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,440 | 🐛 296 | 🌐 Go | 📅 2025-07-03 - Modern text indexing library for go.
...
* [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 416 | 🐛 3 | 🌐 Go | 📅 2025-05-19 - Implementation to calculate levenshtein distance in Go.
...
* [coherence-go-client](https://github.com/oracle/coherence-go-client) ⭐ 13 | 🐛 1 | 🌐 Go | 📅 2025-07-05 - Full implementation of Oracle Coherence cache API for Go applications using gRPC as network transport.
...
* [gocache](https://github.com/eko/gocache) ⭐ 2,685 | 🐛 39 | 🌐 Go | 📅 2025-05-25 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,127 | 🐛 2 | 🌐 Go | 📅 2025-07-06 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,196 | 🐛 5 | 🌐 Go | 📅 2025-06-16 -  A high performance memory-bound Go cache.
...
* [theine](https://github.com/Yiling-J/theine-go) ⭐ 332 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
...
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,736 | 🐛 30 | 🌐 Go | 📅 2025-07-03 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,899 | 🐛 47 | 🌐 Go | 📅 2025-07-06 - An embedded key/value database for Go.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,050 | 🐛 7,333 | 🌐 Go | 📅 2025-07-07 - Scalable, Geo-Replicated, Transactional Datastore.
* [Coffer](https://github.com/claygod/coffer) ⭐ 40 | 🐛 1 | 🌐 Go | 📅 2023-04-09 - Simple ACID key-value database that supports transactions.
* [column](https://github.com/kelindar/column) ⭐ 1,485 | 🐛 26 | 🌐 Go | 📅 2025-06-28 - High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions.
...
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,992 | 🐛 35 | 🌐 Go | 📅 2025-07-05 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,846 | 🐛 432 | 🌐 Go | 📅 2025-07-05 - Dolt – It's Git for Data.
...
* [godis](https://github.com/hdt3213/godis) ⭐ 3,714 | 🐛 16 | 🌐 Go | 📅 2025-07-05 - A Golang implemented high-performance Redis server and cluster.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,283 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,823 | 🐛 362 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 8,770 | 🐛 134 | 🌐 Go | 📅 2025-05-30 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,277 | 🐛 2,113 | 🌐 Rust | 📅 2025-07-04 - Scalable datastore for metrics, events, and real-time analytics.
...
* [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,198 | 🐛 16 | 🌐 Go | 📅 2025-02-18 - Fast k/v database compatible with lsm and b+tree.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,811 | 🐛 701 | 🌐 Go | 📅 2025-07-07 - Milvus is a vector database for embedding management, analytics and search.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,366 | 🐛 299 | 🌐 Go | 📅 2025-07-06 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,334 | 🐛 728 | 🌐 Go | 📅 2025-07-06 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,846 | 🐛 3 | 🌐 Go | 📅 2025-07-06 - Redis re-implemented with SQLite.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,741 | 🐛 74 | 🌐 Go | 📅 2025-07-07 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,683 | 🐛 5,201 | 🌐 Go | 📅 2025-07-07 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,465 | 🐛 955 | 🌐 Go | 📅 2025-07-07 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 7,005 | 🐛 219 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,701 | 🐛 122 | 🌐 Go | 📅 2025-07-06 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,109 | 🐛 29 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,665 | 🐛 97 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,942 | 🐛 435 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,325 | 🐛 18 | 🌐 Go | 📅 2025-07-04 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,779 | 🐛 151 | 🌐 Go | 📅 2025-07-06 - Go toolset to handle MySQL protocol and replication.
...
* [onedump](https://github.com/liweiyi88/onedump) ⭐ 195 | 🐛 1 | 🌐 Go | 📅 2025-07-02 - Database backup from different drivers to different destinations with one command and configuration.
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,192 | 🐛 1 | 🌐 Go | 📅 2025-06-30 - Advanced scheduling for PostgreSQL.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,940 | 🐛 36 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
* [prep](https://github.com/hexdigest/prep) ⭐ 35 | 🐛 0 | 🌐 Go | 📅 2017-12-19 - Use prepared SQL statements without changing your code.
* [pREST](https://github.com/prest/prest) ⭐ 4,366 | 🐛 141 | 🌐 Go | 📅 2025-04-29 - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,807 | 🐛 880 | 🌐 Go | 📅 2025-07-06 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,440 | 🐛 612 | 🌐 Go | 📅 2025-07-02 - Generate type-safe code from SQL.
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,494 | 🐛 91 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,910 | 🐛 62 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,559 | 🐛 203 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 732 | 🐛 6 | 🌐 Go | 📅 2025-07-04 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,096 | 🐛 232 | 🌐 Go | 📅 2025-06-26 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,096 | 🐛 232 | 🌐 Go | 📅 2025-06-26 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,440 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
* [pq](https://github.com/lib/pq) ⭐ 9,528 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 166 | 🐛 244 | 🌐 Go | 📅 2025-07-06 - native and database/sql driver YDB (Yandex Database)
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,386 | 🐛 9 | 🌐 Go | 📅 2025-07-07 - Official MongoDB driver for the Go language.
...
* [qmgo](https://github.com/qiniu/qmgo) ⭐ 1,323 | 🐛 49 | 🌐 Go | 📅 2025-07-05 - The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo.
* [redeo](https://github.com/bsm/redeo) ⭐ 445 | 🐛 2 | 🌐 Go | 📅 2023-01-20 - Redis-protocol compatible TCP servers/services.
* [redigo](https://github.com/gomodule/redigo) ⭐ 9,831 | 🐛 23 | 🌐 Go | 📅 2025-05-21 - Redigo is a Go client for the Redis database.
* [redis](https://github.com/redis/go-redis) ⭐ 21,042 | 🐛 95 | 🌐 Go | 📅 2025-07-05 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,712 | 🐛 24 | 🌐 Go | 📅 2025-07-06 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
* [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,092 | 🐛 92 | 🌐 Go | 📅 2025-07-03 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,906 | 🐛 82 | 🌐 Go | 📅 2025-07-01 - Official Elasticsearch client for Go.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 996 | 🐛 23 | 🌐 Go | 📅 2025-06-27 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,090 | 🐛 1 | 🌐 Go | 📅 2025-07-07 - A simple, semantic and developer-friendly time package for golang.
...
* [now](https://github.com/jinzhu/now) ⭐ 4,538 | 🐛 13 | 🌐 Go | 📅 2025-06-09 - Now is a time toolkit for golang.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,656 | 🐛 27 | 🌐 Go | 📅 2025-07-07 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [emitter-io](https://github.com/emitter-io/emitter) ⭐ 3,945 | 🐛 15 | 🌐 Go | 📅 2025-03-13 - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
...
* [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,323 | 🐛 25 | 🌐 Go | 📅 2025-07-03 - A Go framework for the API or Microservice with handy scaffolding tools.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,142 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,370 | 🐛 359 | 🌐 Go | 📅 2025-07-04 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,990 | 🐛 137 | 🌐 Go | 📅 2025-07-02 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,053 | 🐛 88 | 🌐 Go | 📅 2025-07-05 - A cloud native Kubernetes Global Balancer.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,516 | 🐛 53 | 🌐 Go | 📅 2025-07-07 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,559 | 🐛 122 | 🌐 Go | 📅 2025-06-01 - A modular-designed and easy-to-use microservices framework in Go.
...
* [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,565 | 🐛 26 | 🌐 Go | 📅 2025-04-16 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,441 | 🐛 462 | 🌐 Go | 📅 2025-07-06 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 617 | 🐛 59 | 🌐 Go | 📅 2025-07-07 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,671 | 🐛 44 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,334 | 🐛 356 | 🌐 C++ | 📅 2025-06-26).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,092 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 657 | 🐛 198 | 🌐 Go | 📅 2025-07-04 - Durable execution system for making code fault-tolerant and simple.
...
* [GoDNS](https://github.com/timothyye/godns) ⭐ 1,591 | 🐛 16 | 🌐 Go | 📅 2025-07-02 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,397 | 🐛 31 | 🌐 Go | 📅 2025-07-04 - A Go library for email verification without sending any emails.
...
* [go-imap](https://github.com/emersion/go-imap) ⭐ 2,208 | 🐛 59 | 🌐 Go | 📅 2025-06-11 - IMAP library for clients and servers.
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,027 | 🐛 4 | 🌐 Go | 📅 2025-07-02 - A simple Go library for sending mails in Go.
...
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,588 | 🐛 130 | 🌐 Go | 📅 2025-04-16 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,015 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,320 | 🐛 0 | 🌐 Go | 📅 2025-07-06 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,052 | 🐛 148 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [cel-go](https://github.com/google/cel-go) ⭐ 2,605 | 🐛 49 | 🌐 Go | 📅 2025-07-01 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,984 | 🐛 45 | 🌐 Go | 📅 2025-07-05 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,565 | 🐛 176 | 🌐 Go | 📅 2025-07-06 - PHP embedded in Go, with a `net/http` handler.
...
* [goja](https://github.com/dop251/goja) ⭐ 6,262 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
...
* [metacall](https://github.com/metacall/core) ⭐ 1,664 | 🐛 53 | 🌐 C | 📅 2025-07-02 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
* [tengo](https://github.com/d5/tengo) ⭐ 3,662 | 🐛 84 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,587 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - The Wa Programming Language embedded in Go.
...
* [oops](https://github.com/samber/oops) ⭐ 705 | 🐛 15 | 🌐 Go | 📅 2025-07-06 - Error handling with context, stack trace and source fragments.
...
* [afero](https://github.com/spf13/afero) ⭐ 6,261 | 🐛 153 | 🌐 Go | 📅 2025-07-01 - FileSystem Abstraction System for Go.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 98 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,547 | 🐛 290 | 🌐 Go | 📅 2025-07-06).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,596 | 🐛 51 | 🌐 Go | 📅 2025-07-02 - Disk usage analyzer with console interface.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,777 | 🐛 128 | 🌐 Go | 📅 2025-06-28 - PDF processor.
...
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,380 | 🐛 136 | 🌐 Go | 📅 2025-07-05 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,830 | 🐛 142 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,305 | 🐛 37 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
...
* [form](https://github.com/go-playground/form) ⭐ 844 | 🐛 15 | 🌐 Go | 📅 2025-03-21 - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
* [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,129 | 🐛 28 | 🌐 Go | 📅 2025-04-14 - CSRF protection for Go web applications & services.
...
* [fpGo](https://github.com/TeaEntityLab/fpGo) ⭐ 352 | 🐛 0 | 🌐 Go | 📅 2024-10-28 - Monad, Functional Programming features for Golang.
* [fuego](https://github.com/seborama/fuego) ⭐ 145 | 🐛 0 | 🌐 Go | 📅 2024-04-13 - Functional Experiment in Go.
* [go-functional](https://github.com/BooleanCat/go-functional) ⭐ 506 | 🐛 1 | 🌐 Go | 📅 2025-06-13 - Functional programming in Go using generics
...
* [mo](https://github.com/samber/mo) ⭐ 3,016 | 🐛 23 | 🌐 Go | 📅 2025-07-06 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ark](https://github.com/mlange-42/ark) ⭐ 89 | 🐛 9 | 🌐 Go | 📅 2025-05-16 - Archetype-based Entity Component System (ECS) for Go.
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,202 | 🐛 301 | 🌐 Go | 📅 2025-07-06 - dead simple 2D game engine in Go.
...
* [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,570 | 🐛 58 | 🌐 Go | 📅 2025-06-04 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
* [Pixel](https://github.com/gopxl/pixel) ⭐ 332 | 🐛 33 | 🌐 Go | 📅 2025-03-07 - Hand-crafted 2D game library in Go.
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,095 | 🐛 4 | 🌐 C | 📅 2025-06-17 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
* [goverter](https://github.com/jmattheis/goverter) ⭐ 715 | 🐛 16 | 🌐 Go | 📅 2025-07-06 - Generate converters by defining an interface.
* [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,227 | 🐛 22 | 🌐 Go | 📅 2025-06-27 - Generate decorators for Go interfaces using simple templates.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,293 | 🐛 692 | 🌐 Go | 📅 2025-06-29 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [geoos](https://github.com/spatial-go/geoos) ⭐ 521 | 🐛 21 | 🌐 Go | 📅 2024-07-03 - A library provides spatial data and geometric algorithms.
...
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,760 | 🐛 36 | 🌐 Go | 📅 2025-07-04 - S2 geometry library in Go.
...
* [go2hx](https://github.com/go2hx/go2hx) ⭐ 136 | 🐛 31 | 🌐 Haxe | 📅 2025-07-06 - Compiler from Go to Haxe to Javascript/C++/Java/C#.
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,989 | 🐛 191 | 🌐 Go | 📅 2025-06-16 - Compiler from Go to JavaScript.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,806 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,980 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [go-actor](https://github.com/vladopajic/go-actor) ⭐ 229 | 🐛 0 | 🌐 Go | 📅 2025-06-05 - A tiny library for writing concurrent programs using actor model.
...
* [pond](https://github.com/alitto/pond) ⭐ 1,879 | 🐛 3 | 🌐 Go | 📅 2025-06-20 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,396 | 🐛 20 | 🌐 Go | 📅 2025-02-13 - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 421 | 🐛 19 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,671 | 🐛 1,172 | 🌐 C++ | 📅 2025-07-05 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,677 | 🐛 17 | 🌐 Lua | 📅 2025-07-01.
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,033 | 🐛 226 | 🌐 Go | 📅 2025-07-06 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,707 | 🐛 741 | 🌐 Go | 📅 2025-07-06 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [webview](https://github.com/zserge/webview) ⭐ 13,205 | 🐛 190 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,239 | 🐛 135 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
* [systray](https://github.com/getlantern/systray) ⭐ 3,505 | 🐛 109 | 🌐 Go | 📅 2024-07-03 - Cross platform Go library to place an icon and menu in the notification area.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,591 | 🐛 216 | 🌐 Go | 📅 2025-07-07 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [go-rpio](https://github.com/stianeikeland/go-rpio) ⭐ 2,247 | 🐛 42 | 🌐 Go | 📅 2023-09-30 - GPIO for Go, doesn't require cgo.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 726 | 🐛 6 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,129 | 🐛 343 | 🌐 Go | 📅 2025-07-06 - Go package for computer vision using OpenCV 3.3+.
...
* [govips](https://github.com/davidbyttow/govips) ⭐ 1,455 | 🐛 34 | 🌐 Go | 📅 2025-06-14 - A lightning fast image processing and resizing library for Go.
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,833 | 🐛 32 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
...
* [imagor](https://github.com/cshum/imagor) ⭐ 3,666 | 🐛 39 | 🌐 Go | 📅 2025-06-30 - Fast, secure image processing server and Go library, using libvips.
* [img](https://github.com/hawx/img) ⭐ 156 | 🐛 4 | 🌐 Go | 📅 2015-05-01 - Selection of image manipulation tools.
* [ln](https://github.com/fogleman/ln) ⭐ 3,328 | 🐛 12 | 🌐 Go | 📅 2019-07-19 - 3D line art rendering in Go.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,606 | 🐛 56 | 🌐 Go | 📅 2025-07-02 - Lightweight data stream processing engine for IoT edge.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,188 | 🐛 8 | 🌐 Go | 📅 2025-07-07 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
* [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 | 🐛 39 | 🌐 Go | 📅 2019-11-04 - Lightweight stream processing engine for IoT.
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,351 | 🐛 30 | 🌐 Go | 📅 2025-07-03 - Kubernetes native IoT development framework.
...
* [cheek](https://github.com/bart6114/cheek) ⭐ 190 | 🐛 7 | 🌐 Go | 📅 2025-07-06 - A simple crontab like scheduler that aims to offer a KISS approach to job scheduling.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,342 | 🐛 17 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,027 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [OjG](https://github.com/ohler55/ojg) ⭐ 901 | 🐛 0 | 🌐 Go | 📅 2025-06-29 - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 590 | 🐛 1 | 🌐 Go | 📅 2025-05-29 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,354 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,354 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,354 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,354 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,142 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,320 | 🐛 165 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,575 | 🐛 139 | 🌐 Go | 📅 2025-04-18, etc).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,150 | 🐛 100 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [pp](https://github.com/k0kubun/pp) ⭐ 1,962 | 🐛 7 | 🌐 Go | 📅 2025-07-01 - Colored pretty printer for Go language.
...
* [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 974 | 🐛 53 | 🌐 Go | 📅 2025-07-03 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
...
* [slog](https://github.com/gookit/slog) ⭐ 483 | 🐛 2 | 🌐 Go | 📅 2025-06-30 - Lightweight, configurable, extensible logger for Go.
* [slog-formatter](https://github.com/samber/slog-formatter) ⭐ 175 | 🐛 0 | 🌐 Go | 📅 2025-06-30 - Common formatters for slog and helpers to build your own.
...
* [zap](https://github.com/uber-go/zap) ⭐ 23,320 | 🐛 165 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,575 | 🐛 139 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,900 | 🐛 33 | 🌐 Go | 📅 2025-03-24 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,889 | 🐛 60 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,803 | 🐛 18 | 🌐 Go | 📅 2025-07-02 - Go RabbitMQ Client Library.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,522 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,079 | 🐛 22 | 🌐 Go | 📅 2025-07-04 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,926 | 🐛 284 | 🌐 HTML | 📅 2025-07-06 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [emitter](https://github.com/olebedev/emitter) ⭐ 521 | 🐛 4 | 🌐 Go | 📅 2023-04-11 - Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,418 | 🐛 58 | 🌐 Go | 📅 2025-07-05 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,095 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,775 | 🐛 244 | 🌐 Go | 📅 2025-06-30 - Asynchronous task queue/job queue based on distributed message passing.
* [mangos](https://github.com/nanomsg/mangos) ⭐ 714 | 🐛 30 | 🌐 Go | 📅 2025-05-16 - Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability.
...
* [Mercure](https://github.com/dunglas/mercure) ⭐ 4,976 | 🐛 25 | 🌐 Go | 📅 2025-06-27 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,002 | 🐛 188 | 🌐 Go | 📅 2025-06-30 - Go client for the NATS
  messaging system.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,071 | 🐛 63 | 🌐 Go | 📅 2025-07-04 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,627 | 🐛 123 | 🌐 Go | 📅 2025-07-03 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [excelize](https://github.com/xuri/excelize) ⭐ 19,334 | 🐛 125 | 🌐 Go | 📅 2025-07-07 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,982 | 🐛 9 | 🌐 Go | 📅 2025-04-18 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
* [fx](https://github.com/uber-go/fx) ⭐ 6,629 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
...
* [google/wire](https://github.com/google/wire) ⭐ 13,915 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,817 | 🐛 2 | 🌐 Go | 📅 2025-06-26 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,817 | 🐛 2 | 🌐 Go | 📅 2025-06-26 for building production grade scalable web service applications.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,766 | 🐛 45 | 🌐 Go | 📅 2025-07-07 - Allows users to spin up a quick Go project using a popular framework.
...
* [go-starter](https://github.com/allaboutapps/go-starter) ⭐ 560 | 🐛 6 | 🌐 Go | 📅 2025-04-09 - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
...
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,289 | 🐛 0 | 🌐 Go | 📅 2025-06-14 - Nunu is a scaffolding tool for building Go applications.
...
* [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,132 | 🐛 12 | 🌐 Go | 📅 2025-05-29 - cross-platform, cli app to perform various operations on string.
...
* [archives](https://github.com/mholt/archives) ⭐ 260 | 🐛 7 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,256 | 🐛 6 | 🌐 Go | 📅 2025-06-25 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,642 | 🐛 220 | 🌐 Go | 📅 2025-07-03 - Automated service health dashboard.
...
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,983 | 🐛 13 | 🌐 Go | 📅 2025-06-26 - Random data generator written in go.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,289 | 🐛 211 | 🌐 Go | 📅 2025-07-02 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [govader](https://github.com/jonreiter/govader) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2025-04-29 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,757 | 🐛 55 | 🌐 Python | 📅 2024-03-16.
...
* [kagome](https://github.com/ikawaha/kagome) ⭐ 882 | 🐛 4 | 🌐 Go | 📅 2025-06-18 - JP morphological analyzer written in pure Go.
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,539 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,225 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 73 | 🐛 0 | 🌐 Go | 📅 2025-07-06 - Package bart provides a fast routing table algorithm.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,968 | 🐛 442 | 🌐 Go | 📅 2025-07-03 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [dns](https://github.com/miekg/dns) ⭐ 8,412 | 🐛 12 | 🌐 Go | 📅 2025-06-01 - Go library for working with DNS.
...
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,625 | 🐛 1 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,825 | 🐛 221 | 🌐 Go | 📅 2025-07-05 - BGP implemented in the Go Programming Language.
* [gopacket](https://github.com/google/gopacket) ⭐ 6,559 | 🐛 360 | 🌐 Go | 📅 2025-03-19 - Go library for packet processing with libpcap bindings.
...
* [grab](https://github.com/cavaliercoder/grab) ⭐ 1,445 | 🐛 33 | 🌐 Go | 📅 2024-05-14 - Go package for managing file downloads.
...
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,272 | 🐛 40 | 🌐 Go | 📅 2025-07-06 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,541 | 🐛 2 | 🌐 Go | 📅 2025-07-02 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
* [net](https://golang.org/x/net) - This repository holds supplementary Go networking libraries.
* [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,349 | 🐛 25 | 🌐 Go | 📅 2025-06-17 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,087 | 🐛 1 | 🌐 Go | 📅 2025-07-07 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,798 | 🐛 189 | 🌐 Go | 📅 2025-06-29 - An implementation of the QUIC protocol in pure Go.
...
* [sdns](https://github.com/semihalev/sdns) ⭐ 998 | 🐛 0 | 🌐 Go | 📅 2025-07-06 - A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
...
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,936 | 🐛 56 | 🌐 Go | 📅 2025-01-27 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,966 | 🐛 15 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [water](https://github.com/songgao/water) ⭐ 2,050 | 🐛 30 | 🌐 Go | 📅 2024-07-30 - Simple TUN/TAP library.
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,013 | 🐛 99 | 🌐 Go | 📅 2025-07-03 - A pure Go implementation of the WebRTC API.
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,153 | 🐛 73 | 🌐 Go | 📅 2025-07-06 - Retryable HTTP client in Go.
...
* [heimdall](https://github.com/gojektech/heimdall) ⭐ 2,679 | 🐛 50 | 🌐 Go | 📅 2024-05-29 - An enhanced http client with retry and hystrix capabilities.
...
* [req](https://github.com/imroc/req) ⭐ 4,539 | 🐛 71 | 🌐 Go | 📅 2025-06-27 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
* [requests](https://github.com/carlmjohnson/requests) ⭐ 1,612 | 🐛 2 | 🌐 Go | 📅 2025-04-16 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
* [resty](https://github.com/go-resty/resty) ⭐ 11,022 | 🐛 36 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,189 | 🐛 35 | 🌐 Go | 📅 2025-06-17 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,347 | 🐛 20 | 🌐 Go | 📅 2025-07-06 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,237 | 🐛 29 | 🌐 Go | 📅 2025-07-04 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,330 | 🐛 586 | 🌐 Go | 📅 2025-06-20 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,462 | 🐛 462 | 🌐 Go | 📅 2025-07-07 - The fantastic ORM library for Golang, aims to be developer friendly.
* [gormt](https://github.com/xxjwxc/gormt) ⭐ 2,403 | 🐛 57 | 🌐 Go | 📅 2025-06-24 - Mysql database to golang gorm struct.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,287 | 🐛 473 | 🌐 Go | 📅 2025-07-07 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,556 | 🐛 320 | 🌐 Go | 📅 2025-07-06 - A distributed tracing system.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,398 | 🐛 367 | 🌐 Go | 📅 2025-07-01 - go generate based graphql server library.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,082 | 🐛 246 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,179 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,209 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [booster](https://github.com/anatol/booster) ⭐ 571 | 🐛 73 | 🌐 Go | 📅 2025-03-15 - Fast initramfs generator with full-disk encryption support.
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,458 | 🐛 28 | 🌐 Go | 📅 2024-10-11 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
* [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,271 | 🐛 25 | 🌐 Go | 📅 2025-07-02 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,737 | 🐛 94 | 🌐 Go | 📅 2025-07-01 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [go-password-validator](https://github.com/lane-c-wagner/go-password-validator) ⭐ 536 | 🐛 5 | 🌐 Go | 📅 2022-09-22 - Password validator based on raw cryptographic entropy values.
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,709 | 🐛 157 | 🌐 Go | 📅 2025-07-05 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [secure](https://github.com/unrolled/secure) ⭐ 2,312 | 🐛 0 | 🌐 Go | 📅 2024-10-22 - HTTP middleware for Go that facilitates some quick security wins.
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 891 | 🐛 23 | 🌐 Go | 📅 2025-07-05 - Small, safe, and easy CBOR encoding and decoding library.
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,976 | 🐛 115 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [jsoniter](https://github.com/json-iterator/go) ⭐ 13,809 | 🐛 267 | 🌐 Go | 📅 2024-05-27 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,330 | 🐛 219 | 🌐 Go | 📅 2025-07-01 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
* [cortex-tenant](https://github.com/blind-oracle/cortex-tenant) ⭐ 124 | 🐛 2 | 🌐 Go | 📅 2025-06-04 - Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels.
...
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,835 | 🐛 21 | 🌐 Go | 📅 2025-07-05 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,776 | 🐛 314 | 🌐 Go | 📅 2025-07-06 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,590 | 🐛 49 | 🌐 Go | 📅 2025-07-04 - Fider is an open platform to collect and organize customer feedback.
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,504 | 🐛 6 | 🌐 Go | 📅 2025-06-23 - Flagr is an open-source feature flagging and A/B testing service.
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,454 | 🐛 54 | 🌐 Go | 📅 2025-07-07 - A self contained feature flag solution written in Go and Vue.js
...
* [minio](https://github.com/minio/minio) ⭐ 53,581 | 🐛 51 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 48,439 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,177 | 🐛 80 | 🌐 Go | 📅 2025-07-05 - High-performance PHP application server, load-balancer and process manager.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,663 | 🐛 110 | 🌐 Go | 📅 2025-07-03 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,031 | 🐛 44 | 🌐 Go | 📅 2025-06-30 - HTTP reverse proxy cache and time series accelerator.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,194 | 🐛 14 | 🌐 Go | 📅 2025-06-23 - Make SSH apps, just like that!
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,054 | 🐛 4 | 🌐 Go | 📅 2025-05-11 - Go stream processing library.
...
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,476 | 🐛 53 | 🌐 Go | 📅 2025-03-21 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,449 | 🐛 70 | 🌐 Go | 📅 2025-07-06 - A HTML templating language that has great developer tooling.
...
* [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,444 | 🐛 27 | 🌐 Go | 📅 2025-07-03 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
...
* [go-snaps](http://github.com/gkampitakis/go-snaps) ⭐ 219 | 🐛 7 | 🌐 Go | 📅 2025-06-04 - Jest-like snapshot testing in Golang.
...
* [godog](https://github.com/cucumber/godog) ⭐ 2,456 | 🐛 83 | 🌐 Go | 📅 2025-07-05 - Cucumber BDD framework for Go.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,284 | 🐛 237 | 🌐 Go | 📅 2025-07-03 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcase](https://github.com/adamluzsi/testcase) ⭐ 123 | 🐛 0 | 🌐 Go | 📅 2025-07-04 - Idiomatic testing framework for Behavior Driven Development.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,176 | 🐛 139 | 🌐 Go | 📅 2025-07-03 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,896 | 🐛 95 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,036 | 🐛 5 | 🌐 Go | 📅 2025-04-05 - Easy mocking of HTTP responses from external resources.
* [minimock](https://github.com/gojuno/minimock) ⭐ 692 | 🐛 9 | 🌐 Go | 📅 2025-06-10 - Mock generator for Go interfaces.
* [mockery](https://github.com/vektra/mockery) ⭐ 6,677 | 🐛 40 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [moq](https://github.com/matryer/moq) ⭐ 2,104 | 🐛 27 | 🌐 Go | 📅 2025-02-13 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 491 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,096 | 🐛 232 | 🌐 Go | 📅 2025-06-26.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 11,998 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,774 | 🐛 54 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
* [rod](https://github.com/go-rod/rod) ⭐ 6,058 | 🐛 183 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,574 | 🐛 41 | 🌐 Go | 📅 2025-07-01 - Formatters for time, numbers, and memory size to human readable format.
...
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,162 | 🐛 8 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,912 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,261 | 🐛 5 | 🌐 Go | 📅 2025-07-04 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
* [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,713 | 🐛 54 | 🌐 Go | 📅 2025-05-27 - Parse RSS and Atom feeds in Go.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,842 | 🐛 99 | 🌐 Go | 📅 2025-07-06 - Shell parser and formatter.
...
* [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,433 | 🐛 26 | 🌐 Go | 📅 2025-04-04 - HTML Sanitizer.
* [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 | 🐛 1 | 🌐 Go | 📅 2025-06-01 - A sanitization-based swear filter for Go.

### Scrapers

* [colly](https://github.com/asciimoo/colly) ⭐ 24,402 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,578 | 🐛 3 | 🌐 Go | 📅 2025-06-07 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,141 | 🐛 81 | 🌐 Go | 📅 2025-07-03 - The official AWS SDK for the Go programming language.
...
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,450 | 🐛 187 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
...
* [github](https://github.com/google/go-github) ⭐ 10,853 | 🐛 32 | 🌐 Go | 📅 2025-07-04 - Go library for accessing the GitHub REST API v3.
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,135 | 🐛 211 | 🌐 Go | 📅 2025-06-25 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [golang-tmdb](https://github.com/cyruzin/golang-tmdb) ⭐ 138 | 🐛 2 | 🌐 Go | 📅 2025-07-03 - Golang wrapper for The Movie Database API v3.
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,282 | 🐛 20 | 🌐 Go | 📅 2025-07-06 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,282 | 🐛 382 | 🌐 Go | 📅 2025-07-04 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,731 | 🐛 18 | 🌐 Go | 📅 2025-07-01 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [slack](https://github.com/slack-go/slack) ⭐ 4,807 | 🐛 102 | 🌐 Go | 📅 2025-07-04 - Slack API in Go.
...
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,342 | 🐛 9 | 🌐 Go | 📅 2025-07-02 - Go client for the Stripe API.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 380 | 🐛 36 | 🌐 Go | 📅 2025-07-01 - Cross Platform tool to validate configuration files.
...
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,233 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,319 | 🐛 167 | 🌐 Go | 📅 2025-06-30 - A tool for exploring each layer in a Docker image.
...
* [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,254 | 🐛 4 | 🌐 Go | 📅 2025-07-03 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
* [filetype](https://github.com/h2non/filetype) ⭐ 2,207 | 🐛 46 | 🌐 Go | 📅 2025-06-27 - Small package to infer the file type checking the magic numbers signature.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 71,547 | 🐛 290 | 🌐 Go | 📅 2025-07-06 - Command-line fuzzy finder written in Go.
...
* [go-funk](https://github.com/thoas/go-funk) ⭐ 4,909 | 🐛 8 | 🌐 Go | 📅 2024-07-24 - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,809 | 🐛 23 | 🌐 Go | 📅 2025-07-05 - Deliver Go binaries as fast and easily as possible.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,106 | 🐛 5 | 🌐 Go | 📅 2025-07-07 - A comprehensive, efficient, and reusable util function library of go.
...
* [limiters](https://github.com/mennanov/limiters) ⭐ 569 | 🐛 6 | 🌐 Go | 📅 2025-07-01 - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
* [lo](https://github.com/samber/lo) ⭐ 19,707 | 🐛 206 | 🌐 Go | 📅 2025-07-07 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [mc](https://github.com/minio/mc) ⭐ 3,085 | 🐛 41 | 🌐 Go | 📅 2025-07-02 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,823 | 🐛 42 | 🌐 Go | 📅 2025-07-05 - Package for MIME type detection based on magic numbers.
...
* [peco](https://github.com/peco/peco) ⭐ 7,766 | 🐛 52 | 🌐 Go | 📅 2025-06-21 - Simplistic interactive filtering tool.
...
* [rospo](https://github.com/ferama/rospo) ⭐ 338 | 🐛 7 | 🌐 Go | 📅 2025-06-22 - Simple and reliable ssh tunnels with embedded ssh server in Golang.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,123 | 🐛 54 | 🌐 Go | 📅 2025-07-03 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,027 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
...
* [toolbox](https://github.com/viant/toolbox) ⭐ 220 | 🐛 5 | 🌐 Go | 📅 2024-12-10 - Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer.
...
* [usql](https://github.com/knq/usql) ⭐ 9,415 | 🐛 94 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
...
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,664 | 🐛 46 | 🌐 Go | 📅 2025-05-06 - Interactive cli tool for HTTP inspection.
...
* [uuid](https://github.com/gofrs/uuid) ⭐ 1,701 | 🐛 6 | 🌐 Go | 📅 2025-07-01 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
* [uuid](https://github.com/google/uuid) ⭐ 5,718 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [xid](https://github.com/rs/xid) ⭐ 4,148 | 🐛 17 | 🌐 Go | 📅 2025-05-12 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
* [jio](https://github.com/faceair/jio) ⭐ 118 | 🐛 2 | 🌐 Go | 📅 2024-07-04 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,116 | 🐛 192 | 🌐 JavaScript | 📅 2025-06-18.
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,942 | 🐛 57 | 🌐 Go | 📅 2024-03-23 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,620 | 🐛 323 | 🌐 Go | 📅 2025-07-02 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 896 | 🐛 7 | 🌐 Go | 📅 2025-07-03 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,891 | 🐛 532 | 🌐 TypeScript | 📅 2025-07-04 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,693 | 🐛 169 | 🌐 Go | 📅 2025-07-01 - highly extensible Git implementation in pure Go.
...
* [go-astits](https://github.com/asticode/go-astits) ⭐ 572 | 🐛 8 | 🌐 Go | 📅 2024-12-22 - Parse and demux MPEG Transport Streams (.ts) natively in GO.
...
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 803 | 🐛 18 | 🌐 Go | 📅 2025-07-06 - Pure Go RTSP server and client library.
...
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 530 | 🐛 1 | 🌐 Go | 📅 2025-07-06 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
...
* [Beego](https://github.com/beego/beego) ⭐ 32,138 | 🐛 17 | 🌐 Go | 📅 2025-06-25 - beego is an open-source, high-performance web framework for the Go programming language.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,241 | 🐛 105 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 476 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,058 | 🐛 103 | 🌐 Go | 📅 2025-07-04 - An Express.js inspired web framework build on Fasthttp.
...
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,434 | 🐛 37 | 🌐 Go | 📅 2025-06-30 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,015 | 🐛 855 | 🌐 Go | 📅 2025-07-01 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 | 🐛 13 | 🌐 Go | 📅 2025-07-05 - Gin parameter automatic binding tool,gin rpc tools.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,890 | 🐛 24 | 🌐 Go | 📅 2025-07-06 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,761 | 🐛 83 | 🌐 Go | 📅 2025-07-04 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,509 | 🐛 207 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,900 | 🐛 56 | 🌐 Go | 📅 2025-07-04 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
* [Goyave](https://github.com/go-goyave/goyave) ⭐ 1,713 | 🐛 11 | 🌐 Go | 📅 2025-07-03 - Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities.
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,360 | 🐛 44 | 🌐 Go | 📅 2025-07-04 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,217 | 🐛 118 | 🌐 Go | 📅 2025-07-02 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
* [templui](https://github.com/axzilla/templui) ⭐ 755 | 🐛 6 | 🌐 JavaScript | 📅 2025-07-07 - Modern UI Components for Go & Templ.
...
* [Limiter](https://github.com/ulule/limiter) ⭐ 2,234 | 🐛 14 | 🌐 Go | 📅 2024-12-10 - Dead simple rate limit middleware for Go.
...
* [alice](https://github.com/justinas/alice) ⭐ 3,265 | 🐛 11 | 🌐 Go | 📅 2024-06-06 - Painless middleware chaining for Go.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,079 | 🐛 83 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,465 | 🐛 35 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,435 | 🐛 499 | 🌐 Go | 📅 2025-07-04 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,024 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 233 | 🐛 11 | 🌐 Go | 📅 2025-07-06 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [Cadence-client](https://github.com/uber-go/cadence-client) ⭐ 359 | 🐛 73 | 🌐 Go | 📅 2025-07-04 - A framework for authoring workflows and activities running on top of the Cadence orchestration engine made by Uber.
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,370 | 🐛 112 | 🌐 Go | 📅 2025-07-06 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [workflow](https://github.com/luno/workflow) ⭐ 175 | 🐛 4 | 🌐 Go | 📅 2025-07-02 - A tech stack agnostic Event Driven Workflow framework.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,041 | 🐛 261 | 🌐 Go | 📅 2025-07-01 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,419 | 🐛 245 | 🌐 Go | 📅 2025-07-06 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 | 🐛 19 | 🌐 Go | 📅 2025-07-02 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,983 | 🐛 158 | 🌐 Go | 📅 2025-07-04 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,275 | 🐛 118 | 🌐 Go | 📅 2025-07-06 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,022 | 🐛 41 | 🌐 Go | 📅 2025-06-11 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,222 | 🐛 48 | 🌐 Go | 📅 2025-06-25 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,493 | 🐛 579 | 🌐 Go | 📅 2025-06-11 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 791 | 🐛 77 | 🌐 Go | 📅 2025-07-02 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,751 | 🐛 96 | 🌐 Go | 📅 2025-07-01 features to Vim/Neovim.
...
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,079 | 🐛 418 | 🌐 TypeScript | 📅 2025-07-02 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [gotests](https://github.com/cweill/gotests) ⭐ 5,085 | 🐛 63 | 🌐 Go | 📅 2023-09-12 - Generate Go tests from your source code.
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,308 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
* [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,624 | 🐛 7 | 🌐 Go | 📅 2025-07-07 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,797 | 🐛 607 | 🌐 Go | 📅 2025-06-27 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [cassowary](https://github.com/rogerwelin/cassowary) ⭐ 803 | 🐛 6 | 🌐 Go | 📅 2025-06-10 - Modern cross-platform HTTP load-testing tool written in Go.
...
* [dish](https://github.com/thevxn/dish) ⭐ 240 | 🐛 9 | 🌐 Go | 📅 2025-07-03 - A lightweight, remotely configurable monitoring service.
...
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,178 | 🐛 29 | 🌐 Go | 📅 2025-06-30 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,191 | 🐛 2,525 | 🌐 Go | 📅 2025-07-07 - Lightweight, programmable telemetry for servers and workstations.
...
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,404 | 🐛 2,700 | 🌐 Go | 📅 2025-07-07 - Fork of Gogs, entirely community driven.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,050 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,033 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,890 | 🐛 246 | 🌐 Go | 📅 2025-06-28 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,139 | 🐛 125 | 🌐 Go | 📅 2025-07-06 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,189 | 🐛 795 | 🌐 Go | 📅 2025-07-04 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,279 | 🐛 207 | 🌐 Go | 📅 2025-07-01 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [ko](https://github.com/google/ko) ⭐ 8,057 | 🐛 52 | 🌐 Go | 📅 2025-07-03 - Command line tool for building and deploying Go applications on Kubernetes
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,755 | 🐛 149 | 🌐 Go | 📅 2025-07-04 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,174 | 🐛 2,619 | 🌐 Go | 📅 2025-07-07 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,415 | 🐛 139 | 🌐 Go | 📅 2025-07-01 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,751 | 🐛 541 | 🌐 Go | 📅 2025-07-04 - Cloud native application delivery.
...
* [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,145 | 🐛 48 | 🌐 Go | 📅 2025-06-30 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,649 | 🐛 534 | 🌐 Go | 📅 2025-07-03 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,044 | 🐛 3,616 | 🌐 Go | 📅 2025-07-05 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,182 | 🐛 107 | 🌐 Go | 📅 2025-07-04 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,642 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,331 | 🐛 142 | 🌐 Go | 📅 2025-07-06 - Pomerium is an identity-aware access proxy.
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,392 | 🐛 140 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
...
* [tau](https://github.com/taubyte/tau) ⭐ 4,047 | 🐛 28 | 🌐 Go | 📅 2025-06-23 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
* [traefik](https://github.com/containous/traefik) ⭐ 55,442 | 🐛 655 | 🌐 Go | 📅 2025-07-04 - Reverse proxy and load balancer with support for multiple backends.
...
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,340 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,438 | 🐛 66 | 🌐 Go | 📅 2025-07-04 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 584 | 🐛 10 | 🌐 Go | 📅 2025-07-06 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,412 | 🐛 26 | 🌐 Go | 📅 2025-03-20 - Simulate bad network connections.
...
* [croc](https://github.com/schollz/croc) ⭐ 30,520 | 🐛 12 | 🌐 Go | 📅 2025-07-04 - Easily and securely send files or folders from one computer to another.
...
* [fjira](https://github.com/mk-5/fjira) ⭐ 181 | 🐛 21 | 🌐 Go | 📅 2025-07-05 - A fuzzy-search based terminal UI application for Attlasian Jira
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,007 | 🐛 18 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
* [Gor](https://github.com/buger/gor) ⭐ 18,994 | 🐛 339 | 🌐 Go | 📅 2025-04-05 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,837 | 🐛 121 | 🌐 Go | 📅 2025-07-07 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,659 | 🐛 28 | 🌐 Go | 📅 2024-08-20 - Portal is a quick and easy command-line file transfer utility from any computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,220 | 🐛 473 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 701 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,450 | 🐛 53 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,081 | 🐛 591 | 🌐 Go | 📅 2025-07-07 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,184 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [gophers](https://github.com/egonelbre/gophers) ⭐ 3,682 | 🐛 5 | 🌐 Go | 📅 2022-07-06 - Free gophers.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,050 | 🐛 7,333 | 🌐 Go | 📅 2025-07-07
* [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
* [Google](https://google.github.io/styleguide/go/)
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,182 | 🐛 181 | 🌐 Go | 📅 2025-06-30
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,623 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,610 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,688 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,749 | 🐛 9,368 | 🌐 Go | 📅 2025-07-05 - List of projects on the Go community wiki.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,670 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
...
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,660 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,931 | 🐛 8 | 🌐 Go | 📅 2025-07-07 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,641 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,953 | 🐛 66 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
