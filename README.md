...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 146,660 | 🐛 124 | 🌐 Go | 📅 2025-06-29
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 377,963 | 🐛 42 | 📅 2025-06-11
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 248,858 | 🐛 492 | 🌐 Python | 📅 2024-08-11.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 146,660 | 🐛 124 | 🌐 Go | 📅 2025-06-29 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 146,660 | 🐛 124 | 🌐 Go | 📅 2025-06-29; you rock!
...
* [Ergo](https://github.com/ergo-services/ergo) ⭐ 4,009 | 🐛 4 | 🌐 Go | 📅 2025-06-30 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 260 | 🐛 0 | 🌐 Go | 📅 2025-07-03 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
...
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,255 | 🐛 87 | 🌐 Go | 📅 2024-08-22 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 616 | 🐛 11 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
* [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,033 | 🐛 364 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,652 | 🐛 477 | 🌐 Go | 📅 2025-07-03 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 145,497 | 🐛 1,886 | 🌐 Go | 📅 2025-07-03 - Run large language models locally.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,824 | 🐛 48 | 🌐 Go | 📅 2025-06-21 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [go-jose](https://github.com/go-jose/go-jose) ⭐ 414 | 🐛 31 | 🌐 Go | 📅 2025-06-26 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
* [goth](https://github.com/markbates/goth) ⭐ 6,077 | 🐛 132 | 🌐 Go | 📅 2025-04-04 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,217 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
* [keto](https://github.com/ory/keto) ⭐ 5,054 | 🐛 57 | 🌐 Go | 📅 2025-07-03 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,602 | 🐛 30 | 🌐 Go | 📅 2025-07-02 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
* [openfga](https://github.com/openfga/openfga) ⭐ 3,780 | 🐛 130 | 🌐 Go | 📅 2025-07-03 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 758 | 🐛 271 | 🌐 Go | 📅 2025-07-03 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,638 | 🐛 270 | 🌐 Go | 📅 2025-07-02 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 972 | 🐛 795 | 🌐 Go | 📅 2025-07-03 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,231 | 🐛 314 | 🌐 Go | 📅 2025-07-04 - Official Go implementation of the Ethereum protocol.
...
* [gossamer](https://github.com/ChainSafe/gossamer) ⭐ 451 | 🐛 394 | 🌐 Go | 📅 2025-07-03 - A Go implementation of the Polkadot Host.
...
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,962 | 🐛 807 | 🌐 Go | 📅 2025-07-03 - A complete implementation of a Lightning Network node.
...
* [slack-bot](https://github.com/innogames/slack-bot) ⭐ 198 | 🐛 8 | 🌐 Go | 📅 2025-07-03 - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
* [slacker](https://github.com/slack-io/slacker) ⭐ 54 | 🐛 9 | 🌐 Go | 📅 2024-11-16 - Easy to use framework to create Slack bots.
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,380 | 🐛 55 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
...
* [air](https://github.com/cosmtrek/air) ⭐ 20,926 | 🐛 178 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [Task](https://github.com/go-task/task) ⭐ 13,063 | 🐛 392 | 🌐 Go | 📅 2025-07-03 - simple "Make" alternative.
...
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,523 | 🐛 153 | 🌐 Go | 📅 2025-06-29 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,859 | 🐛 121 | 🌐 Go | 📅 2025-07-03 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,645 | 🐛 5 | 🌐 Go | 📅 2025-06-25 - Terminal JSON viewer & processor.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,380 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,795 | 🐛 672 | 🌐 Python | 📅 2025-07-03.
...
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,198 | 🐛 86 | 🌐 Go | 📅 2025-07-03 - Declaratively define styles for color, format and layout in the terminal.
...
* [pterm](https://github.com/pterm/pterm) ⭐ 5,131 | 🐛 59 | 🌐 Go | 📅 2025-06-07 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,841 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,377 | 🐛 105 | 🌐 Go | 📅 2024-07-22.
...
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,331 | 🐛 74 | 🌐 Go | 📅 2025-07-02 - Multi-shell multi-command argument completer.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,013 | 🐛 318 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [goopt](https://github.com/napalu/goopt) ⭐ 3 | 🐛 0 | 🌐 Go | 📅 2025-07-03 - A declarative, struct-tag based CLI framework for Go, with a broad feature set such as hierarchical commands/flags, i18n, shell completion, and validation.
...
* [pflag](https://github.com/spf13/pflag) ⭐ 2,585 | 🐛 177 | 🌐 Go | 📅 2025-06-28 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,306 | 🐛 50 | 🌐 Go | 📅 2025-06-14 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,434 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,255 | 🐛 56 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,275 | 🐛 11 | 🌐 Go | 📅 2025-06-30 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [kong](https://github.com/alecthomas/kong) ⭐ 2,705 | 🐛 27 | 🌐 Go | 📅 2025-06-30 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,306 | 🐛 24 | 🌐 Go | 📅 2025-06-19 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,800 | 🐛 518 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
...
* [CDS](https://github.com/ovh/cds) ⭐ 4,727 | 🐛 149 | 🌐 Go | 📅 2025-07-03 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
* [drone](https://github.com/drone/drone) ⭐ 32,932 | 🐛 74 | 🌐 Go | 📅 2025-07-03 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 157 | 🐛 5 | 🌐 Go | 📅 2025-07-03 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,568 | 🐛 24 | 🌐 Go | 📅 2025-07-03 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,797 | 🐛 89 | 🌐 Rust | 📅 2025-07-03.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,210 | 🐛 345 | 🌐 Go | 📅 2025-07-03 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,392 | 🐛 529 | 🌐 Go | 📅 2025-07-03 - A message streaming bridge between a range of protocols.
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,726 | 🐛 72 | 🌐 Go | 📅 2025-06-28 - Go package implementing compressed bitsets.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 16,994 | 🐛 67 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,783 | 🐛 78 | 🌐 TypeScript | 📅 2025-07-04 - Distributed, Fault-tolerant task queue.
...
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,542 | 🐛 12 | 🌐 Go | 📅 2025-06-10 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
* [bleve](https://github.com/blevesearch/bleve) ⭐ 10,437 | 🐛 296 | 🌐 Go | 📅 2025-07-03 - Modern text indexing library for go.
...
* [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 408 | 🐛 3 | 🌐 Go | 📅 2025-05-19 - Implementation to calculate levenshtein distance in Go.
...
* [coherence-go-client](https://github.com/oracle/coherence-go-client) ⭐ 13 | 🐛 1 | 🌐 Go | 📅 2025-07-03 - Full implementation of Oracle Coherence cache API for Go applications using gRPC as network transport.
...
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,202 | 🐛 42 | 🌐 Go | 📅 2024-11-29 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,094 | 🐛 3 | 🌐 Go | 📅 2025-07-03 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,186 | 🐛 5 | 🌐 Go | 📅 2025-06-16 -  A high performance memory-bound Go cache.
...
* [theine](https://github.com/Yiling-J/theine-go) ⭐ 324 | 🐛 6 | 🌐 Go | 📅 2025-03-02 - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
...
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,727 | 🐛 30 | 🌐 Go | 📅 2025-07-03 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,886 | 🐛 50 | 🌐 Go | 📅 2025-07-03 - An embedded key/value database for Go.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,039 | 🐛 7,285 | 🌐 Go | 📅 2025-07-04 - Scalable, Geo-Replicated, Transactional Datastore.
...
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,988 | 🐛 34 | 🌐 Go | 📅 2025-07-03 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,830 | 🐛 435 | 🌐 Go | 📅 2025-07-03 - Dolt – It's Git for Data.
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,283 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,811 | 🐛 361 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 8,766 | 🐛 134 | 🌐 Go | 📅 2025-05-30 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,262 | 🐛 2,115 | 🌐 Rust | 📅 2025-07-03 - Scalable datastore for metrics, events, and real-time analytics.
...
* [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,192 | 🐛 16 | 🌐 Go | 📅 2025-02-18 - Fast k/v database compatible with lsm and b+tree.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,754 | 🐛 705 | 🌐 Go | 📅 2025-07-04 - Milvus is a vector database for embedding management, analytics and search.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,366 | 🐛 296 | 🌐 Go | 📅 2025-07-03 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,290 | 🐛 731 | 🌐 Go | 📅 2025-07-03 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,827 | 🐛 3 | 🌐 Go | 📅 2025-05-15 - Redis re-implemented with SQLite.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,725 | 🐛 75 | 🌐 Go | 📅 2025-07-04 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,668 | 🐛 5,197 | 🌐 Go | 📅 2025-07-04 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,444 | 🐛 947 | 🌐 Go | 📅 2025-07-04 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 6,994 | 🐛 218 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,684 | 🐛 120 | 🌐 Go | 📅 2025-07-04 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,104 | 🐛 29 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,657 | 🐛 96 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,926 | 🐛 431 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [dbbench](https://github.com/sj14/dbbench) ⭐ 108 | 🐛 12 | 🌐 Go | 📅 2025-07-04 - Database benchmarking tool with support for several databases and scripts.
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,776 | 🐛 151 | 🌐 Go | 📅 2025-06-11 - Go toolset to handle MySQL protocol and replication.
...
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,937 | 🐛 36 | 🌐 Go | 📅 2025-06-15 - Web-based PostgreSQL database browser.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,764 | 🐛 877 | 🌐 Go | 📅 2025-07-02 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,252 | 🐛 41 | 🌐 Go | 📅 2025-07-03 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,422 | 🐛 611 | 🌐 Go | 📅 2025-07-02 - Generate type-safe code from SQL.
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,489 | 🐛 91 | 🌐 Go | 📅 2024-04-24 - Go library that helps you build SQL queries.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,909 | 🐛 61 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,556 | 🐛 203 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 728 | 🐛 6 | 🌐 Go | 📅 2025-06-30 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,079 | 🐛 232 | 🌐 Go | 📅 2025-06-26 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,079 | 🐛 232 | 🌐 Go | 📅 2025-06-26 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,441 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 166 | 🐛 249 | 🌐 Go | 📅 2025-07-03 - native and database/sql driver YDB (Yandex Database)
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,036 | 🐛 96 | 🌐 Go | 📅 2025-07-03 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,710 | 🐛 20 | 🌐 Go | 📅 2025-07-04 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
* [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,088 | 🐛 91 | 🌐 Go | 📅 2025-07-03 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,902 | 🐛 82 | 🌐 Go | 📅 2025-07-01 - Official Elasticsearch client for Go.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 994 | 🐛 23 | 🌐 Go | 📅 2025-06-27 - Fast trigram based code search.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,651 | 🐛 26 | 🌐 Go | 📅 2025-07-03 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,137 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,377 | 🐛 19 | 🌐 Go | 📅 2025-07-02 - A distributed systems development framework.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,350 | 🐛 360 | 🌐 Go | 📅 2025-07-04 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,982 | 🐛 136 | 🌐 Go | 📅 2025-07-02 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,052 | 🐛 89 | 🌐 Go | 📅 2025-07-03 - A cloud native Kubernetes Global Balancer.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,510 | 🐛 55 | 🌐 Go | 📅 2025-07-03 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,550 | 🐛 122 | 🌐 Go | 📅 2025-06-01 - A modular-designed and easy-to-use microservices framework in Go.
...
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,433 | 🐛 462 | 🌐 Go | 📅 2025-07-03 - NATS is a simple, secure, and
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,665 | 🐛 44 | 🌐 Go | 📅 2025-07-01 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/etcd-io/raft) ⭐ 868 | 🐛 70 | 🌐 Go | 📅 2025-07-01 - Go implementation of the Raft consensus protocol, by CoreOS.
* [rain](https://github.com/cenkalti/rain) ⭐ 1,049 | 🐛 2 | 🌐 Go | 📅 2025-07-01 - BitTorrent client and library.
* [redis-lock](https://github.com/bsm/redislock) ⭐ 1,631 | 🐛 3 | 🌐 Go | 📅 2025-06-09 - Simplified distributed locking implementation using Redis.
...
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,045 | 🐛 29 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 657 | 🐛 200 | 🌐 Go | 📅 2025-07-03 - Durable execution system for making code fault-tolerant and simple.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,803 | 🐛 63 | 🌐 Go | 📅 2025-07-03 - BitTorrent client package.
...
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,585 | 🐛 131 | 🌐 Go | 📅 2025-04-16 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,000 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,308 | 🐛 1 | 🌐 Go | 📅 2025-07-02 - Email and SMTP testing tool for developers.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,637 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,604 | 🐛 49 | 🌐 Go | 📅 2025-07-01 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,979 | 🐛 45 | 🌐 Go | 📅 2025-06-30 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,531 | 🐛 173 | 🌐 Go | 📅 2025-07-01 - PHP embedded in Go, with a `net/http` handler.
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,291 | 🐛 50 | 🌐 Go | 📅 2025-06-05 - Port of the Lua 5.2 VM to pure Go.
...
* [goja](https://github.com/dop251/goja) ⭐ 6,255 | 🐛 26 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [golua](https://github.com/aarzilli/golua) ⭐ 674 | 🐛 9 | 🌐 C | 📅 2025-02-17 - Go bindings for Lua C API.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,637 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
...
* [starlark-go](https://github.com/google/starlark-go) ⭐ 2,490 | 🐛 64 | 🌐 Go | 📅 2025-07-01 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
* [starlet](https://github.com/1set/starlet) ⭐ 30 | 🐛 2 | 🌐 Go | 📅 2025-04-15 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,490 | 🐛 64 | 🌐 Go | 📅 2025-07-01 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
* [tengo](https://github.com/d5/tengo) ⭐ 3,660 | 🐛 84 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,586 | 🐛 6 | 🌐 Go | 📅 2025-07-04 - The Wa Programming Language embedded in Go.
...
* [errors](https://github.com/naughtygopher/errors) ⭐ 72 | 🐛 0 | 🌐 Go | 📅 2025-07-03 - Drop-in replacement for builtin Go errors. This is a minimal error handling package with custom error types, user friendly messages, Unwrap & Is. With very easy to use and straightforward helper functions.
...
* [afero](https://github.com/spf13/afero) ⭐ 6,260 | 🐛 153 | 🌐 Go | 📅 2025-07-01 - FileSystem Abstraction System for Go.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 98 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,480 | 🐛 290 | 🌐 Go | 📅 2025-07-03).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,586 | 🐛 51 | 🌐 Go | 📅 2025-07-02 - Disk usage analyzer with console interface.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,771 | 🐛 125 | 🌐 Go | 📅 2025-06-28 - PDF processor.
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 | 🐛 1 | 🌐 Go | 📅 2023-09-21 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,837 | 🐛 39 | 📅 2025-01-16.
...
* [ach](https://github.com/moov-io/ach) ⭐ 492 | 🐛 13 | 🌐 Go | 📅 2025-07-03 - A reader, writer, and validator for Automated Clearing House (ACH) files.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,378 | 🐛 136 | 🌐 Go | 📅 2025-07-03 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,823 | 🐛 141 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
...
* [ledger](https://github.com/formancehq/ledger) ⭐ 989 | 🐛 7 | 🌐 Go | 📅 2025-07-02 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [mo](https://github.com/samber/mo) ⭐ 3,013 | 🐛 23 | 🌐 Go | 📅 2025-07-02 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,189 | 🐛 304 | 🌐 Go | 📅 2025-07-03 - dead simple 2D game engine in Go.
...
* [go-sdl2](https://github.com/veandco/go-sdl2) ⭐ 2,299 | 🐛 87 | 🌐 C | 📅 2025-02-20 - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,090 | 🐛 4 | 🌐 C | 📅 2025-06-17 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
* [jennifer](https://github.com/dave/jennifer) ⭐ 3,513 | 🐛 17 | 🌐 Go | 📅 2024-09-08 - Generate arbitrary Go code without templates.
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,285 | 🐛 691 | 🌐 Go | 📅 2025-06-29 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [geoos](https://github.com/spatial-go/geoos) ⭐ 521 | 🐛 20 | 🌐 Go | 📅 2024-07-03 - A library provides spatial data and geometric algorithms.
...
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,422 | 🐛 12 | 🌐 Go | 📅 2025-05-18 - Compile shell scripts to Go.
...
* [go2hx](https://github.com/go2hx/go2hx) ⭐ 136 | 🐛 31 | 🌐 Haxe | 📅 2025-07-03 - Compiler from Go to Haxe to Javascript/C++/Java/C#.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,797 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,719 | 🐛 42 | 🌐 Go | 📅 2025-04-16 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 421 | 🐛 17 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,604 | 🐛 1,168 | 🌐 C++ | 📅 2025-06-30 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,675 | 🐛 17 | 🌐 Lua | 📅 2025-07-01.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,683 | 🐛 750 | 🌐 Go | 📅 2025-07-02 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [gotk3](https://github.com/gotk3/gotk3) ⭐ 2,168 | 🐛 123 | 🌐 Go | 📅 2024-08-08 - Go bindings for GTK3.
...
* [walk](https://github.com/lxn/walk) ⭐ 6,983 | 🐛 346 | 🌐 Go | 📅 2024-01-21 - Windows application library kit for Go.
* [webview](https://github.com/zserge/webview) ⭐ 13,196 | 🐛 190 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,229 | 🐛 135 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,589 | 🐛 219 | 🌐 Go | 📅 2025-07-03 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
* [emgo](https://github.com/ziutek/emgo) ⭐ 1,085 | 🐛 13 | 🌐 C | 📅 2021-12-05 - Go-like language for programming embedded systems (e.g. STM32 MCU).
* [ghw](https://github.com/jaypipes/ghw) ⭐ 1,759 | 🐛 58 | 🌐 Go | 📅 2025-07-03 - Golang hardware discovery/inspection library.
...
* [bimg](https://github.com/h2non/bimg) ⭐ 2,879 | 🐛 175 | 🌐 Go | 📅 2025-01-23 - Small package for fast and efficient image processing using libvips.
...
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,829 | 🐛 32 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
...
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,512 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,604 | 🐛 56 | 🌐 Go | 📅 2025-07-02 - Lightweight data stream processing engine for IoT edge.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,185 | 🐛 8 | 🌐 Go | 📅 2025-07-02 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,017 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [jsondiff](https://github.com/wI2L/jsondiff) ⭐ 584 | 🐛 0 | 🌐 Go | 📅 2025-05-09 - JSON diff library for Go based on RFC6902 (JSON Patch).
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,346 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,346 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,346 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,346 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,137 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,305 | 🐛 164 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,566 | 🐛 139 | 🌐 Go | 📅 2025-04-18, etc).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,148 | 🐛 100 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [slog](https://github.com/gookit/slog) ⭐ 480 | 🐛 2 | 🌐 Go | 📅 2025-06-30 - Lightweight, configurable, extensible logger for Go.
...
* [zap](https://github.com/uber-go/zap) ⭐ 23,305 | 🐛 164 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,566 | 🐛 139 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 821 | 🐛 2 | 🌐 Go | 📅 2025-07-02 - An accelerated Machine Learning framework for Go.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,796 | 🐛 111 | 🌐 Go | 📅 2024-08-12 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,898 | 🐛 33 | 🌐 Go | 📅 2025-03-24 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 425 | 🐛 6 | 🌐 Go | 📅 2025-06-26 - Huggingface transformer pipelines for golang with onnxruntime.
...
* [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 801 | 🐛 44 | 🌐 Go | 📅 2024-09-02 - Go Interface to Open Neural Network Exchange (ONNX).
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,799 | 🐛 18 | 🌐 Go | 📅 2025-07-02 - Go RabbitMQ Client Library.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,509 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,074 | 🐛 22 | 🌐 Go | 📅 2025-07-01 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,921 | 🐛 284 | 🌐 HTML | 📅 2025-07-03 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,416 | 🐛 59 | 🌐 Go | 📅 2025-05-12 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,095 | 🐛 33 | 🌐 Go | 📅 2024-10-25 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [melody](https://github.com/olahol/melody) ⭐ 3,936 | 🐛 13 | 🌐 Go | 📅 2025-06-08 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,997 | 🐛 186 | 🌐 Go | 📅 2025-06-30 - Go client for the NATS
  messaging system.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,067 | 🐛 64 | 🌐 Go | 📅 2025-07-03 - Go library for Apache Kafka.
...
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,602 | 🐛 122 | 🌐 Go | 📅 2025-07-03 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
* [excelize](https://github.com/xuri/excelize) ⭐ 19,325 | 🐛 126 | 🌐 Go | 📅 2025-06-25 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [do](https://github.com/samber/do) ⭐ 2,180 | 🐛 45 | 🌐 Go | 📅 2025-05-05 - A dependency injection framework based on Generics.
...
* [google/wire](https://github.com/google/wire) ⭐ 13,907 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,738 | 🐛 43 | 🌐 Go | 📅 2025-06-30 - Allows users to spin up a quick Go project using a popular framework.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,951 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,951 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
...
* [goxygen](https://github.com/shpota/goxygen) ⭐ 3,588 | 🐛 15 | 🌐 Go | 📅 2024-12-18 - Generate a modern Web project with Go and Angular, React, or Vue in seconds.
...
* [archives](https://github.com/mholt/archives) ⭐ 259 | 🐛 7 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,624 | 🐛 220 | 🌐 Go | 📅 2025-07-03 - Automated service health dashboard.
...
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,978 | 🐛 13 | 🌐 Go | 📅 2025-06-26 - Random data generator written in go.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,283 | 🐛 210 | 🌐 Go | 📅 2025-07-02 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [govader](https://github.com/jonreiter/govader) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2025-04-29 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,755 | 🐛 55 | 🌐 Python | 📅 2024-03-16.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,280 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Package and an accompanying tool to work with localized text.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 73 | 🐛 0 | 🌐 Go | 📅 2025-07-03 - Package bart provides a fast routing table algorithm.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,934 | 🐛 441 | 🌐 Go | 📅 2025-07-03 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [dns](https://github.com/miekg/dns) ⭐ 8,407 | 🐛 11 | 🌐 Go | 📅 2025-06-01 - Go library for working with DNS.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,707 | 🐛 110 | 🌐 Go | 📅 2025-07-02 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,619 | 🐛 4 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,824 | 🐛 224 | 🌐 Go | 📅 2025-07-03 - BGP implemented in the Go Programming Language.
...
* [gosnmp](https://github.com/soniah/gosnmp) ⭐ 1,196 | 🐛 61 | 🌐 Go | 📅 2025-07-01 - Native Go library for performing SNMP actions.
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,284 | 🐛 63 | 🌐 Go | 📅 2025-06-18 - KCP - Fast and Reliable ARQ Protocol.
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,166 | 🐛 130 | 🌐 Go | 📅 2025-07-01 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,269 | 🐛 40 | 🌐 Go | 📅 2025-07-01 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,086 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,795 | 🐛 189 | 🌐 Go | 📅 2025-06-29 - An implementation of the QUIC protocol in pure Go.
...
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,933 | 🐛 56 | 🌐 Go | 📅 2025-01-27 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,952 | 🐛 15 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [water](https://github.com/songgao/water) ⭐ 2,047 | 🐛 30 | 🌐 Go | 📅 2024-07-30 - Simple TUN/TAP library.
* [webrtc](https://github.com/pions/webrtc) ⭐ 14,998 | 🐛 99 | 🌐 Go | 📅 2025-07-03 - A pure Go implementation of the WebRTC API.
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,018 | 🐛 36 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,186 | 🐛 35 | 🌐 Go | 📅 2025-06-17 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,339 | 🐛 22 | 🌐 Go | 📅 2025-07-02 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [bun](https://github.com/uptrace/bun) ⭐ 4,235 | 🐛 29 | 🌐 Go | 📅 2025-06-27 - SQL-first Golang ORM. Successor of go-pg.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,322 | 🐛 588 | 🌐 Go | 📅 2025-06-20 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,446 | 🐛 463 | 🌐 Go | 📅 2025-06-25 - The fantastic ORM library for Golang, aims to be developer friendly.
* [gormt](https://github.com/xxjwxc/gormt) ⭐ 2,402 | 🐛 57 | 🌐 Go | 📅 2025-06-24 - Mysql database to golang gorm struct.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,275 | 🐛 471 | 🌐 Go | 📅 2025-07-03 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,544 | 🐛 323 | 🌐 Go | 📅 2025-07-03 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 171 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,078 | 🐛 332 | 🌐 C++ | 📅 2025-07-02 - No instrumentation tracing for Golang applications via eBPF.
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,494 | 🐛 48 | 🌐 Go | 📅 2025-03-28 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,074 | 🐛 246 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,004 | 🐛 23 | 🌐 Go | 📅 2024-08-07 - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,159 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,200 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [booster](https://github.com/anatol/booster) ⭐ 570 | 🐛 73 | 🌐 Go | 📅 2025-03-15 - Fast initramfs generator with full-disk encryption support.
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,452 | 🐛 28 | 🌐 Go | 📅 2024-10-11 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,732 | 🐛 93 | 🌐 Go | 📅 2025-07-01 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,701 | 🐛 156 | 🌐 Go | 📅 2025-07-03 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,968 | 🐛 115 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,275 | 🐛 220 | 🌐 Go | 📅 2025-07-01 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,835 | 🐛 20 | 🌐 Go | 📅 2025-07-03 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,744 | 🐛 318 | 🌐 Go | 📅 2025-07-03 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,586 | 🐛 51 | 🌐 Go | 📅 2025-07-03 - Fider is an open platform to collect and organize customer feedback.
...
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,449 | 🐛 45 | 🌐 Go | 📅 2025-07-03 - A self contained feature flag solution written in Go and Vue.js
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,685 | 🐛 22 | 🌐 Go | 📅 2025-07-03 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [minio](https://github.com/minio/minio) ⭐ 53,511 | 🐛 51 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 48,107 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,650 | 🐛 110 | 🌐 Go | 📅 2025-07-03 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,182 | 🐛 14 | 🌐 Go | 📅 2025-06-23 - Make SSH apps, just like that!
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,053 | 🐛 4 | 🌐 Go | 📅 2025-05-11 - Go stream processing library.
...
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,474 | 🐛 53 | 🌐 Go | 📅 2025-03-21 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,438 | 🐛 72 | 🌐 Go | 📅 2025-07-03 - A HTML templating language that has great developer tooling.
...
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,453 | 🐛 46 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
...
* [godog](https://github.com/cucumber/godog) ⭐ 2,456 | 🐛 83 | 🌐 Go | 📅 2025-07-03 - Cucumber BDD framework for Go.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,285 | 🐛 237 | 🌐 Go | 📅 2025-07-03 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,166 | 🐛 139 | 🌐 Go | 📅 2025-07-03 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 24,869 | 🐛 370 | 🌐 Go | 📅 2025-07-01 - Sacred extension to the standard go testing package.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,888 | 🐛 95 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [mockery](https://github.com/vektra/mockery) ⭐ 6,668 | 🐛 40 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 490 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,079 | 🐛 232 | 🌐 Go | 📅 2025-06-26.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 11,986 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,763 | 🐛 54 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
* [rod](https://github.com/go-rod/rod) ⭐ 6,050 | 🐛 183 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,562 | 🐛 218 | 🌐 Go | 📅 2024-01-29 - Markdown processor in Go.
...
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,905 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,750 | 🐛 18 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
...
* [go-querystring](https://github.com/google/go-querystring) ⭐ 2,055 | 🐛 20 | 🌐 Go | 📅 2025-06-23 - Go library for encoding structs into URL query parameters.
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,257 | 🐛 10 | 🌐 Go | 📅 2025-06-30 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
* [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,710 | 🐛 54 | 🌐 Go | 📅 2025-05-27 - Parse RSS and Atom feeds in Go.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,836 | 🐛 99 | 🌐 Go | 📅 2025-06-22 - Shell parser and formatter.
...
* [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,429 | 🐛 26 | 🌐 Go | 📅 2025-04-04 - HTML Sanitizer.
* [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 | 🐛 1 | 🌐 Go | 📅 2025-06-01 - A sanitization-based swear filter for Go.

### Scrapers

* [colly](https://github.com/asciimoo/colly) ⭐ 24,390 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,571 | 🐛 3 | 🌐 Go | 📅 2025-06-07 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,131 | 🐛 80 | 🌐 Go | 📅 2025-07-03 - The official AWS SDK for the Go programming language.
...
* [github](https://github.com/google/go-github) ⭐ 10,851 | 🐛 32 | 🌐 Go | 📅 2025-07-02 - Go library for accessing the GitHub REST API v3.
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,128 | 🐛 211 | 🌐 Go | 📅 2025-06-25 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,280 | 🐛 20 | 🌐 Go | 📅 2025-07-03 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,280 | 🐛 381 | 🌐 Go | 📅 2025-07-03 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,727 | 🐛 18 | 🌐 Go | 📅 2025-07-01 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,229 | 🐛 112 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,297 | 🐛 167 | 🌐 Go | 📅 2025-06-30 - A tool for exploring each layer in a Docker image.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 71,480 | 🐛 290 | 🌐 Go | 📅 2025-07-03 - Command-line fuzzy finder written in Go.
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,804 | 🐛 23 | 🌐 Go | 📅 2025-07-04 - Deliver Go binaries as fast and easily as possible.
...
* [jump](https://github.com/gsamokovarov/jump) ⭐ 1,860 | 🐛 2 | 🌐 Go | 📅 2025-06-20 - Jump helps you navigate faster by learning your habits.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,101 | 🐛 8 | 🌐 Go | 📅 2025-06-25 - A comprehensive, efficient, and reusable util function library of go.
...
* [lo](https://github.com/samber/lo) ⭐ 19,695 | 🐛 209 | 🌐 Go | 📅 2025-07-02 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,821 | 🐛 44 | 🌐 Go | 📅 2025-07-03 - Package for MIME type detection based on magic numbers.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,118 | 🐛 54 | 🌐 Go | 📅 2025-07-03 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,751 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [uuid](https://github.com/google/uuid) ⭐ 5,714 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,601 | 🐛 322 | 🌐 Go | 📅 2025-07-02 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 894 | 🐛 7 | 🌐 Go | 📅 2025-07-03 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,849 | 🐛 532 | 🌐 TypeScript | 📅 2025-07-04 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,687 | 🐛 168 | 🌐 Go | 📅 2025-07-01 - highly extensible Git implementation in pure Go.
...
* [gortsplib](https://github.com/aler9/gortsplib) ⭐ 803 | 🐛 25 | 🌐 Go | 📅 2025-07-02 - Pure Go RTSP server and client library.
...
* [Beego](https://github.com/beego/beego) ⭐ 32,130 | 🐛 16 | 🌐 Go | 📅 2025-06-25 - beego is an open-source, high-performance web framework for the Go programming language.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,234 | 🐛 105 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 473 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,029 | 🐛 102 | 🌐 Go | 📅 2025-07-03 - An Express.js inspired web framework build on Fasthttp.
...
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,432 | 🐛 37 | 🌐 Go | 📅 2025-06-30 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Gin](https://github.com/gin-gonic/gin) ⭐ 82,981 | 🐛 855 | 🌐 Go | 📅 2025-07-01 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,738 | 🐛 89 | 🌐 Go | 📅 2025-07-03 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,504 | 🐛 206 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,350 | 🐛 45 | 🌐 Go | 📅 2025-07-02 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,207 | 🐛 117 | 🌐 Go | 📅 2025-07-02 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
* [templui](https://github.com/axzilla/templui) ⭐ 748 | 🐛 3 | 🌐 JavaScript | 📅 2025-07-04 - Modern UI Components for Go & Templ.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,063 | 🐛 82 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,454 | 🐛 35 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,424 | 🐛 500 | 🌐 Go | 📅 2025-06-30 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,018 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 233 | 🐛 13 | 🌐 Go | 📅 2025-07-03 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,363 | 🐛 113 | 🌐 Go | 📅 2025-07-03 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 559 | 🐛 4 | 🌐 Go | 📅 2025-07-03 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,034 | 🐛 261 | 🌐 Go | 📅 2025-07-01 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,411 | 🐛 245 | 🌐 Go | 📅 2025-07-03 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 | 🐛 19 | 🌐 Go | 📅 2025-07-02 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,981 | 🐛 157 | 🌐 Go | 📅 2025-07-03 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,269 | 🐛 115 | 🌐 Go | 📅 2025-07-01 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,021 | 🐛 41 | 🌐 Go | 📅 2025-06-11 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,490 | 🐛 579 | 🌐 Go | 📅 2025-06-11 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 141 | 🐛 35 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,869 | 🐛 370 | 🌐 Go | 📅 2025-07-01.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,748 | 🐛 95 | 🌐 Go | 📅 2025-07-01 features to Vim/Neovim.
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,307 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
* [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,622 | 🐛 7 | 🌐 Go | 📅 2025-07-01 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,410 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
...
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,173 | 🐛 29 | 🌐 Go | 📅 2025-06-30 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,182 | 🐛 2,521 | 🌐 Go | 📅 2025-07-04 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,226 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,770 | 🐛 13 | 🌐 Go | 📅 2025-07-03 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,358 | 🐛 2,707 | 🌐 Go | 📅 2025-07-03 - Fork of Gogs, entirely community driven.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,045 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,031 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,884 | 🐛 246 | 🌐 Go | 📅 2025-06-28 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,110 | 🐛 123 | 🌐 Go | 📅 2025-07-03 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,172 | 🐛 795 | 🌐 Go | 📅 2025-07-03 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,267 | 🐛 207 | 🌐 Go | 📅 2025-07-01 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [ko](https://github.com/google/ko) ⭐ 8,053 | 🐛 51 | 🌐 Go | 📅 2025-07-03 - Command line tool for building and deploying Go applications on Kubernetes
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,754 | 🐛 147 | 🌐 Go | 📅 2025-07-04 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,112 | 🐛 2,610 | 🌐 Go | 📅 2025-07-03 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,412 | 🐛 138 | 🌐 Go | 📅 2025-07-01 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,748 | 🐛 543 | 🌐 Go | 📅 2025-06-30 - Cloud native application delivery.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,631 | 🐛 538 | 🌐 Go | 📅 2025-07-03 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,031 | 🐛 3,605 | 🌐 Go | 📅 2025-07-03 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,406 | 🐛 305 | 🌐 Go | 📅 2025-07-04 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 435 | 🐛 1 | 🌐 Go | 📅 2024-06-19 - Flexible HTTP command line stress tester.
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,181 | 🐛 103 | 🌐 Go | 📅 2025-07-04 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,640 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,330 | 🐛 133 | 🌐 Go | 📅 2025-07-03 - Pomerium is an identity-aware access proxy.
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,390 | 🐛 140 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 923 | 🐛 200 | 🌐 Go | 📅 2025-07-03 - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [tau](https://github.com/taubyte/tau) ⭐ 4,043 | 🐛 28 | 🌐 Go | 📅 2025-06-23 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
* [traefik](https://github.com/containous/traefik) ⭐ 55,401 | 🐛 654 | 🌐 Go | 📅 2025-07-03 - Reverse proxy and load balancer with support for multiple backends.
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,435 | 🐛 68 | 🌐 Go | 📅 2025-07-03 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 583 | 🐛 7 | 🌐 Go | 📅 2025-06-28 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,410 | 🐛 26 | 🌐 Go | 📅 2025-03-20 - Simulate bad network connections.
* [confd](https://github.com/kelseyhightower/confd) ⭐ 8,400 | 🐛 179 | 🌐 Go | 📅 2024-07-16 - Manage local application configuration files using templates and data from etcd or consul.
* [crawley](https://github.com/s0rg/crawley) ⭐ 302 | 🐛 3 | 🌐 Go | 📅 2025-06-18 - Web scraper/crawler for cli.
* [croc](https://github.com/schollz/croc) ⭐ 30,498 | 🐛 11 | 🌐 Go | 📅 2025-06-23 - Easily and securely send files or folders from one computer to another.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,992 | 🐛 18 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
* [Gor](https://github.com/buger/gor) ⭐ 18,992 | 🐛 339 | 🌐 Go | 📅 2025-04-05 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,819 | 🐛 121 | 🌐 Go | 📅 2025-07-04 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,693 | 🐛 405 | 🌐 C++ | 📅 2025-05-19 - LiteIDE is a simple, open source, cross-platform Go IDE.
...
* [restic](https://github.com/restic/restic) ⭐ 29,191 | 🐛 472 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 701 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,444 | 🐛 53 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,008 | 🐛 593 | 🌐 Go | 📅 2025-07-03 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [go\_serialization\_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) ⭐ 1,593 | 🐛 6 | 🌐 Go | 📅 2025-07-04 - Benchmarks of Go serialization methods.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,167 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,039 | 🐛 7,285 | 🌐 Go | 📅 2025-07-04
* [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
* [Google](https://google.github.io/styleguide/go/)
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,181 | 🐛 181 | 🌐 Go | 📅 2025-06-30
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,616 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,574 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,681 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,687 | 🐛 9,364 | 🌐 Go | 📅 2025-07-04 - List of projects on the Go community wiki.
...
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,656 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,925 | 🐛 9 | 🌐 Go | 📅 2025-07-03 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,632 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,371 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,948 | 🐛 65 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
