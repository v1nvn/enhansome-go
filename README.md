...
* [bcl](https://github.com/wkhere/bcl) ⭐ 27 | 🐛 4 | 🌐 Go | 📅 2025-08-22 - BCL is a configuration language similar to HCL.
...
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,581 | 🐛 13 | 🌐 Go | 📅 2025-08-15 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,457 | 🐛 152 | 🌐 Go | 📅 2025-08-15 - Geolocation DB with spatial index and realtime geofencing.
...
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,464 | 🐛 13 | 🌐 Go | 📅 2025-08-21 - Compile shell scripts to Go.
...
* [routine](https://github.com/timandy/routine) ⭐ 270 | 🐛 0 | 🌐 Go | 📅 2025-08-18 - `routine` is a `ThreadLocal` for go library. It encapsulates and provides some easy-to-use, non-competitive, high-performance `goroutine` context access interfaces, which can help you access coroutine context information more gracefully.
...
* [govips](https://github.com/davidbyttow/govips) ⭐ 1,477 | 🐛 31 | 🌐 Go | 📅 2025-07-07 - A lightning fast image processing and resizing library for Go.
...
* [Beaver](https://github.com/Clivern/Beaver) ⭐ 1,574 | 🐛 12 | 🌐 Go | 📅 2025-08-13 - A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps.
...
* [jsonpath](https://github.com/AsaiYusuke/jsonpath) ⭐ 27 | 🐛 2 | 🌐 Go | 📅 2025-08-22 - A query library for retrieving part of JSON based on JSONPath syntax.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-08-22 - HTTP client testing framework.
...
* [changie](https://github.com/miniscruff/changie) ⭐ 788 | 🐛 6 | 🌐 Go | 📅 2025-08-23 - Automated changelog tool for preparing releases with lots of customization options.
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 387 | 🐛 13 | 🌐 Go | 📅 2025-08-22 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,211 | 🐛 33 | 🌐 Go | 📅 2025-08-09 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
