...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 146,260
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 375,082
...
We use the *[Golang Bridge](https://github.com/gobridge/about-us/blob/master/README.md) ⭐ 408* community Slack for instant communication, follow the [form here to join](https://invite.slack.golangbridge.org/).
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 248,076.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 146,260 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 146,260; you rock!
...
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 144,939 - Run large language models locally.
...
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,539 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
...
* [bot](https://github.com/go-telegram/bot) ⭐ 1,205 - Zero-dependencies Telegram Bot library with additional UI components
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,184 - Simple and clean Telegram bot client.
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,646 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,625 - Terminal JSON viewer & processor.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 40,913 - Commander for modern Go CLI interactions.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,764 - Go configuration with fangs.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,568 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,773.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,777 - Dolt – It's Git for Data.
...
* [ledisdb](https://github.com/siddontang/ledisdb) ⭐ 4,117 - Ledisdb is a high performance NoSQL like Redis based on LevelDB.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,183 - Monitoring system and time series database.
* [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
* [redka](https://github.com/nalgeon/redka) ⭐ 3,809 - Redis re-implemented with SQLite.
...
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,635 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,902 - Database migrations. CLI and Golang library.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,191 - Advanced scheduling for PostgreSQL.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,034 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,034 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,438 query results easily.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,641 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,321).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,951 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,625.
...
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,625 - Lua 5.1 VM and compiler written in Go.
...
* [Fault](https://github.com/Southclaws/fault) ⭐ 284 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,830.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,255 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,757 - S2 geometry library in Go.
...
* [webview](https://github.com/zserge/webview) ⭐ 13,191 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [imaginary](https://github.com/h2non/imaginary) ⭐ 5,867 - Fast and simple HTTP microservice for image resizing.
...
* [excelize](https://github.com/xuri/excelize) ⭐ 19,301 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,252 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
* [browscap\_go](https://github.com/digitalcrab/browscap_go) ⭐ 49 - GoLang Library for [Browser Capabilities Project](https://browscap.org/).
...
* [peerdiscovery](https://github.com/schollz/peerdiscovery) ⭐ 659 - Pure Go library for cross-platform local peer discovery using UDP multicast.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,125 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [php\_session\_decoder](https://github.com/yvasiyarov/php_session_decoder) ⭐ 167 - GoLang library for working with PHP session format and PHP Serialize/Unserialize functions.
...
* [minio](https://github.com/minio/minio) ⭐ 53,385 - Minio is a distributed object storage server.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,172 - Make SSH apps, just like that!
...
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 485 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,034.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,816 - Shell parser and formatter.
...
* [hostctl](https://github.com/guumaster/hostctl) ⭐ 1,162 - A CLI tool to manage /etc/hosts with easy commands.
...
* [sshman](https://github.com/shoobyban/sshman) ⭐ 51 - SSH Manager for authorized\_keys files on multiple remote servers.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 886 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,769 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
