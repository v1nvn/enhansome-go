...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 146,891 | 🐛 126 | 🌐 Go | 📅 2025-06-29
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 379,691 | 🐛 42 | 📅 2025-07-05
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 249,397 | 🐛 476 | 🌐 Python | 📅 2025-07-05.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 146,891 | 🐛 126 | 🌐 Go | 📅 2025-06-29 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 146,891 | 🐛 126 | 🌐 Go | 📅 2025-06-29; you rock!
...
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,261 | 🐛 87 | 🌐 Go | 📅 2024-08-22 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 624 | 🐛 11 | 🌐 Go | 📅 2025-04-27 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
* [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,066 | 🐛 367 | 🌐 Go | 📅 2025-06-29 - LangChainGo is a framework for developing applications powered by language models.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,735 | 🐛 480 | 🌐 Go | 📅 2025-07-07 - Open Source OpenAI alternative, self-host AI models.
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 145,842 | 🐛 1,860 | 🌐 Go | 📅 2025-07-08 - Run large language models locally.
...
* [flac](https://github.com/mewkiz/flac) ⭐ 336 | 🐛 8 | 🌐 Go | 📅 2024-08-11 - Native Go FLAC encoder/decoder with support for FLAC streams.
...
* [malgo](https://github.com/gen2brain/malgo) ⭐ 339 | 🐛 9 | 🌐 C | 📅 2024-10-22 - Mini audio library.
* [minimp3](https://github.com/tosone/minimp3) ⭐ 129 | 🐛 2 | 🌐 C | 📅 2023-08-02 - Lightweight MP3 decoder library.
* [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,733 | 🐛 24 | 🌐 Go | 📅 2025-06-27 - A low-level library to play sound on multiple platforms.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,841 | 🐛 48 | 🌐 Go | 📅 2025-06-21 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
* [go-jose](https://github.com/go-jose/go-jose) ⭐ 415 | 🐛 34 | 🌐 Go | 📅 2025-06-26 - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
...
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,234 | 🐛 46 | 🌐 Go | 📅 2025-07-01 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
* [keto](https://github.com/ory/keto) ⭐ 5,058 | 🐛 55 | 🌐 Go | 📅 2025-07-07 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,639 | 🐛 40 | 🌐 Go | 📅 2025-05-05 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,603 | 🐛 30 | 🌐 Go | 📅 2025-07-02 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
* [openfga](https://github.com/openfga/openfga) ⭐ 3,797 | 🐛 130 | 🌐 Go | 📅 2025-07-07 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
* [scs](https://github.com/alexedwards/scs) ⭐ 2,360 | 🐛 29 | 🌐 Go | 📅 2025-04-17 - Session Manager for HTTP servers.
...
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,646 | 🐛 275 | 🌐 Go | 📅 2025-07-07 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [gno](https://github.com/gnolang/gno) ⭐ 973 | 🐛 790 | 🌐 Go | 📅 2025-07-07 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,252 | 🐛 312 | 🌐 Go | 📅 2025-07-07 - Official Go implementation of the Ethereum protocol.
...
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,555 | 🐛 1,106 | 🌐 Go | 📅 2025-07-07 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,968 | 🐛 819 | 🌐 Go | 📅 2025-07-07 - A complete implementation of a Lightning Network node.
* [solana-go](https://github.com/gagliardetto/solana-go) ⭐ 1,347 | 🐛 140 | 🌐 Go | 📅 2025-03-14 - Go library to interface with Solana JSON RPC and WebSocket interfaces.
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,811 | 🐛 22 | 🌐 Go | 📅 2025-07-06 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
* [arikawa](https://github.com/diamondburned/arikawa) ⭐ 527 | 🐛 35 | 🌐 Go | 📅 2025-07-03 - A library and framework for the Discord API.
* [bot](https://github.com/go-telegram/bot) ⭐ 1,217 | 🐛 11 | 🌐 Go | 📅 2025-05-21 - Zero-dependencies Telegram Bot library with additional UI components
...
* [wayback](https://github.com/wabarc/wayback) ⭐ 1,995 | 🐛 55 | 🌐 Go | 📅 2025-07-07 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [air](https://github.com/cosmtrek/air) ⭐ 20,950 | 🐛 177 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
...
* [mage](https://github.com/magefile/mage) ⭐ 4,378 | 🐛 128 | 🌐 Go | 📅 2025-06-15 - Mage is a make/rake-like build tool using Go.
...
* [Task](https://github.com/go-task/task) ⭐ 13,080 | 🐛 392 | 🌐 Go | 📅 2025-07-07 - simple "Make" alternative.
...
* [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,843 | 🐛 11 | 🌐 Go | 📅 2024-10-26 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
* [aurora](https://github.com/logrusorgru/aurora) ⭐ 1,457 | 🐛 2 | 🌐 Go | 📅 2025-01-07 - ANSI terminal colors that support fmt.Printf/Sprintf.
...
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,547 | 🐛 153 | 🌐 Go | 📅 2025-06-29 - TUI components for bubbletea.
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,975 | 🐛 116 | 🌐 Go | 📅 2025-07-07 - Go framework to build terminal apps, based on The Elm Architecture.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 19,654 | 🐛 5 | 🌐 Go | 📅 2025-06-25 - Terminal JSON viewer & processor.
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,383 | 🐛 115 | 🌐 Go | 📅 2024-07-14 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,805 | 🐛 673 | 🌐 Python | 📅 2025-07-03.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,284 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) ⭐ 553 | 🐛 12 | 🌐 Go | 📅 2023-12-20 - Style terminal text.
* [gookit/color](https://github.com/gookit/color) ⭐ 1,547 | 🐛 5 | 🌐 Go | 📅 2025-06-07 - Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows.
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,218 | 🐛 86 | 🌐 Go | 📅 2025-07-08 - Declaratively define styles for color, format and layout in the terminal.
...
* [mpb](https://github.com/vbauerster/mpb) ⭐ 2,413 | 🐛 17 | 🌐 Go | 📅 2025-06-05 - Multi progress bar for terminal applications.
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,435 | 🐛 13 | 🌐 Go | 📅 2025-02-08 - Basic thread-safe progress bar that works in every OS.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,135 | 🐛 60 | 🌐 Go | 📅 2025-06-07 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,845 | 🐛 46 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,378 | 🐛 105 | 🌐 Go | 📅 2024-07-22.
* [termenv](https://github.com/muesli/termenv) ⭐ 1,860 | 🐛 37 | 🌐 Go | 📅 2025-05-05 - Advanced ANSI style & color support for your terminal applications.
* [termui](https://github.com/gizak/termui) ⭐ 13,378 | 🐛 105 | 🌐 Go | 📅 2024-07-22 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,619 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 731 | 🐛 40 | 🌐 Go | 📅 2025-07-01 - Command argument completion generator for spf13/cobra.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,056 | 🐛 319 | 🌐 Go | 📅 2025-05-31 - Commander for modern Go CLI interactions.
...
* [Dnote](https://github.com/dnote/dnote) ⭐ 2,884 | 🐛 60 | 🌐 Go | 📅 2024-07-01 - A simple command line notebook with multi-device sync.
...
* [goopt](https://github.com/napalu/goopt) ⭐ 3 | 🐛 0 | 🌐 Go | 📅 2025-07-06 - A declarative, struct-tag based CLI framework for Go, with a broad feature set such as hierarchical commands/flags, i18n, shell completion, and validation.
...
* [pflag](https://github.com/spf13/pflag) ⭐ 2,590 | 🐛 177 | 🌐 Go | 📅 2025-06-28 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,316 | 🐛 50 | 🌐 Go | 📅 2025-06-14 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [aconfig](https://github.com/cristalhq/aconfig) ⭐ 593 | 🐛 16 | 🌐 Go | 📅 2025-07-03 - Simple, useful and opinionated config loader.
...
* [env](https://github.com/caarlos0/env) ⭐ 5,610 | 🐛 9 | 🌐 Go | 📅 2025-05-05 - Parse environment variables to Go structs (with defaults).
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,457 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,258 | 🐛 56 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,286 | 🐛 11 | 🌐 Go | 📅 2025-06-30 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [kong](https://github.com/alecthomas/kong) ⭐ 2,709 | 🐛 26 | 🌐 Go | 📅 2025-07-04 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,333 | 🐛 24 | 🌐 Go | 📅 2025-07-07 - A blazingly fast JSON serializing & deserializing library.
...
* [viper](https://github.com/spf13/viper) ⭐ 28,821 | 🐛 518 | 🌐 Go | 📅 2025-06-27 - Go configuration with fangs.
* [xdg](https://github.com/adrg/xdg) ⭐ 841 | 🐛 5 | 🌐 Go | 📅 2025-06-04 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
* [yamagiconf](https://github.com/romshark/yamagiconf) ⭐ 18 | 🐛 2 | 🌐 Go | 📅 2025-02-01 - The "safe subset" of YAML for Go configs.
* [zerocfg](https://github.com/chaindead/zerocfg) ⭐ 191 | 🐛 3 | 🌐 Go | 📅 2025-07-07 - Zero-effort, concise configuration management that avoids boilerplate and repetitive code, supports multiple sources with priority overrides.
...
* [CDS](https://github.com/ovh/cds) ⭐ 4,729 | 🐛 149 | 🌐 Go | 📅 2025-07-07 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
* [drone](https://github.com/drone/drone) ⭐ 32,946 | 🐛 74 | 🌐 Go | 📅 2025-07-07 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,568 | 🐛 25 | 🌐 Go | 📅 2025-07-03 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,801 | 🐛 87 | 🌐 Rust | 📅 2025-07-06.
...
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,219 | 🐛 345 | 🌐 Go | 📅 2025-07-08 - Woodpecker is a community fork of the Drone CI system.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,397 | 🐛 525 | 🌐 Go | 📅 2025-07-08 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,134 | 🐛 140 | 🌐 Go | 📅 2025-07-07 - A high-performance ELT data integration framework with pluggable architecture.
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,728 | 🐛 72 | 🌐 Go | 📅 2025-06-28 - Go package implementing compressed bitsets.
...
* [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,621 | 🐛 18 | 🌐 Go | 📅 2024-12-10 - Go package implementing Bloom filters.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 16,997 | 🐛 67 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
* [gostl](https://github.com/liyue201/gostl) ⭐ 1,097 | 🐛 4 | 🌐 Go | 📅 2025-01-03 - Data structure and algorithm library for go, designed to provide functions similar to C++ STL.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,796 | 🐛 80 | 🌐 TypeScript | 📅 2025-07-07 - Distributed, Fault-tolerant task queue.
...
* [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 418 | 🐛 3 | 🌐 Go | 📅 2025-05-19 - Implementation to calculate levenshtein distance in Go.
...
* [BigCache](https://github.com/allegro/bigcache) ⭐ 7,871 | 🐛 99 | 🌐 Go | 📅 2025-05-05 - Efficient key/value cache for gigabytes of data.
...
* [GCache](https://github.com/bluele/gcache) ⭐ 2,691 | 🐛 28 | 🌐 Go | 📅 2024-03-01 - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
* [gocache](https://github.com/eko/gocache) ⭐ 2,688 | 🐛 39 | 🌐 Go | 📅 2025-05-25 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,142 | 🐛 1 | 🌐 Go | 📅 2025-07-07 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,197 | 🐛 5 | 🌐 Go | 📅 2025-06-16 -  A high performance memory-bound Go cache.
...
* [theine](https://github.com/Yiling-J/theine-go) ⭐ 334 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
* [timedmap](https://github.com/zekroTJA/timedmap) ⭐ 75 | 🐛 0 | 🌐 Go | 📅 2024-05-05 - Map with expiring key-value pairs.
* [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,102 | 🐛 15 | 🌐 Go | 📅 2025-07-05 - An in-memory cache with item expiration and generics.
* [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2022-10-02 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

* [badger](https://github.com/dgraph-io/badger) ⭐ 14,742 | 🐛 30 | 🌐 Go | 📅 2025-07-03 - Fast key-value store in Go.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,899 | 🐛 46 | 🌐 Go | 📅 2025-07-07 - An embedded key/value database for Go.
* [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
* [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,732 | 🐛 32 | 🌐 Go | 📅 2024-09-10 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,053 | 🐛 7,316 | 🌐 Go | 📅 2025-07-08 - Scalable, Geo-Replicated, Transactional Datastore.
...
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,995 | 🐛 36 | 🌐 Go | 📅 2025-07-08 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 18,852 | 🐛 430 | 🌐 Go | 📅 2025-07-08 - Dolt – It's Git for Data.
...
* [godis](https://github.com/hdt3213/godis) ⭐ 3,717 | 🐛 16 | 🌐 Go | 📅 2025-07-05 - A Golang implemented high-performance Redis server and cluster.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,280 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,832 | 🐛 362 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 8,771 | 🐛 134 | 🌐 Go | 📅 2025-05-30 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,287 | 🐛 2,114 | 🌐 Rust | 📅 2025-07-07 - Scalable datastore for metrics, events, and real-time analytics.
* [ledisdb](https://github.com/siddontang/ledisdb) ⭐ 4,122 | 🐛 0 | 🌐 Go | 📅 2023-10-22 - Ledisdb is a high performance NoSQL like Redis based on LevelDB.
...
* [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,200 | 🐛 16 | 🌐 Go | 📅 2025-02-18 - Fast k/v database compatible with lsm and b+tree.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,827 | 🐛 703 | 🌐 Go | 📅 2025-07-08 - Milvus is a vector database for embedding management, analytics and search.
...
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,368 | 🐛 297 | 🌐 Go | 📅 2025-07-08 - RocksDB/LevelDB inspired key-value database in Go.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,347 | 🐛 729 | 🌐 Go | 📅 2025-07-07 - Monitoring system and time series database.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 3,850 | 🐛 3 | 🌐 Go | 📅 2025-07-07 - Redis re-implemented with SQLite.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,742 | 🐛 73 | 🌐 Go | 📅 2025-07-07 - The lightweight, distributed, relational database built on SQLite.
* [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2018-02-14 - Key-value store for temporary items.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,686 | 🐛 5,198 | 🌐 Go | 📅 2025-07-08 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,471 | 🐛 799 | 🌐 Go | 📅 2025-07-08 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

* [atlas](https://github.com/ariga/atlas) ⭐ 7,007 | 🐛 219 | 🌐 Go | 📅 2025-07-02 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,704 | 🐛 120 | 🌐 Go | 📅 2025-07-07 - Safe database schema change and version control for DevOps teams.
* [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2023-02-24 - Database schema evolution library for Go.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,114 | 🐛 28 | 🌐 Go | 📅 2025-06-20 - A lightweight, framework-agnostic database migration tool.
...
* [goose](https://github.com/pressly/goose) ⭐ 8,671 | 🐛 97 | 🌐 Go | 📅 2025-06-28 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,948 | 🐛 435 | 🌐 Go | 📅 2025-04-25 - Database migrations. CLI and Golang library.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,328 | 🐛 18 | 🌐 Go | 📅 2025-07-04 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,348 | 🐛 90 | 🌐 Go | 📅 2025-04-17 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,781 | 🐛 152 | 🌐 Go | 📅 2025-07-06 - Go toolset to handle MySQL protocol and replication.
* [gorm-multitenancy](https://github.com/bartventer/gorm-multitenancy) ⭐ 61 | 🐛 13 | 🌐 Go | 📅 2025-07-07 - Multi-tenancy support for GORM managed databases.
...
* [onedump](https://github.com/liweiyi88/onedump) ⭐ 196 | 🐛 1 | 🌐 Go | 📅 2025-07-02 - Database backup from different drivers to different destinations with one command and configuration.
...
* [rdb](https://github.com/HDT3213/rdb) ⭐ 544 | 🐛 4 | 🌐 Go | 📅 2025-07-06 - Redis RDB file parser for secondary development and memory analysis.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 19,807 | 🐛 884 | 🌐 Go | 📅 2025-07-06 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,260 | 🐛 41 | 🌐 Go | 📅 2025-07-03 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) ⭐ 650 | 🐛 41 | 🌐 Go | 📅 2023-05-01 - Powerful data retrieval methods as well as DB-agnostic query building capabilities.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,444 | 🐛 613 | 🌐 Go | 📅 2025-07-02 - Generate type-safe code from SQL.
...
* [go-transaction-manager](https://github.com/avito-tech/go-transaction-manager) ⭐ 318 | 🐛 1 | 🌐 Go | 📅 2025-04-17 - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
...
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,563 | 🐛 203 | 🌐 C | 📅 2025-04-16 - SQLite3 driver for go that uses database/sql.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 733 | 🐛 6 | 🌐 Go | 📅 2025-07-08 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [KSQL](https://github.com/VinGarcia/ksql) ⭐ 337 | 🐛 0 | 🌐 Go | 📅 2025-06-08 - A Simple and Powerful Golang SQL Library
* [pgx](https://github.com/jackc/pgx) ⭐ 12,104 | 🐛 234 | 🌐 Go | 📅 2025-06-26 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,104 | 🐛 234 | 🌐 Go | 📅 2025-06-26 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,440 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
* [pq](https://github.com/lib/pq) ⭐ 9,530 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 166 | 🐛 242 | 🌐 Go | 📅 2025-07-07 - native and database/sql driver YDB (Yandex Database)
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,388 | 🐛 12 | 🌐 Go | 📅 2025-07-07 - Official MongoDB driver for the Go language.
...
* [qmgo](https://github.com/qiniu/qmgo) ⭐ 1,324 | 🐛 49 | 🌐 Go | 📅 2025-07-05 - The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,045 | 🐛 96 | 🌐 Go | 📅 2025-07-07 - Redis client for Golang.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,713 | 🐛 25 | 🌐 Go | 📅 2025-07-07 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
* [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,093 | 🐛 92 | 🌐 Go | 📅 2025-07-08 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
* [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,907 | 🐛 82 | 🌐 Go | 📅 2025-07-01 - Official Elasticsearch client for Go.
...
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 999 | 🐛 23 | 🌐 Go | 📅 2025-06-27 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,093 | 🐛 1 | 🌐 Go | 📅 2025-07-07 - A simple, semantic and developer-friendly time package for golang.
...
* [dateparse](https://github.com/araddon/dateparse) ⭐ 2,089 | 🐛 64 | 🌐 Go | 📅 2023-12-30 - Parse date's without knowing format in advance.
...
* [now](https://github.com/jinzhu/now) ⭐ 4,541 | 🐛 13 | 🌐 Go | 📅 2025-06-09 - Now is a time toolkit for golang.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,657 | 🐛 32 | 🌐 Go | 📅 2025-07-08 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [evans](https://github.com/ktr0731/evans) ⭐ 4,401 | 🐛 36 | 🌐 Go | 📅 2023-12-26 - Evans: more expressive universal gRPC client.
...
* [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,326 | 🐛 25 | 🌐 Go | 📅 2025-07-03 - A Go framework for the API or Microservice with handy scaffolding tools.
...
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,146 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,379 | 🐛 20 | 🌐 Go | 📅 2025-07-07 - A distributed systems development framework.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,379 | 🐛 359 | 🌐 Go | 📅 2025-07-04 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,993 | 🐛 136 | 🌐 Go | 📅 2025-07-08 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,055 | 🐛 88 | 🌐 Go | 📅 2025-07-07 - A cloud native Kubernetes Global Balancer.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,518 | 🐛 54 | 🌐 Go | 📅 2025-07-07 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,568 | 🐛 122 | 🌐 Go | 📅 2025-06-01 - A modular-designed and easy-to-use microservices framework in Go.
...
* [micro](https://github.com/micro/micro) ⭐ 12,266 | 🐛 7 | 🌐 Go | 📅 2025-07-06 - A distributed systems runtime for the cloud and beyond.
* [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,568 | 🐛 26 | 🌐 Go | 📅 2025-04-16 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,451 | 🐛 464 | 🌐 Go | 📅 2025-07-07 - NATS is a simple, secure, and
  performant communications system for digital systems, services, and devices.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 618 | 🐛 53 | 🌐 Go | 📅 2025-07-08 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,670 | 🐛 44 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/etcd-io/raft) ⭐ 869 | 🐛 70 | 🌐 Go | 📅 2025-07-01 - Go implementation of the Raft consensus protocol, by CoreOS.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,336 | 🐛 356 | 🌐 C++ | 📅 2025-06-26).
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,105 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 657 | 🐛 195 | 🌐 Go | 📅 2025-07-07 - Durable execution system for making code fault-tolerant and simple.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,807 | 🐛 63 | 🌐 Go | 📅 2025-07-03 - BitTorrent client package.
* [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 984 | 🐛 8 | 🌐 Go | 📅 2025-04-18 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,030 | 🐛 4 | 🌐 Go | 📅 2025-07-02 - A simple Go library for sending mails in Go.
...
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,589 | 🐛 130 | 🌐 Go | 📅 2025-04-16 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,025 | 🐛 251 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,327 | 🐛 1 | 🌐 Go | 📅 2025-07-06 - Email and SMTP testing tool for developers.
...
* [mox](https://github.com/mjl-/mox) ⭐ 5,053 | 🐛 147 | 🌐 Go | 📅 2025-06-09 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
* [SendGrid](https://github.com/sendgrid/sendgrid-go) ⭐ 1,020 | 🐛 32 | 🌐 Go | 📅 2025-05-29 - SendGrid's Go library for sending email.
...
* [cel-go](https://github.com/google/cel-go) ⭐ 2,605 | 🐛 51 | 🌐 Go | 📅 2025-07-01 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [expr](https://github.com/antonmedv/expr) ⭐ 6,988 | 🐛 45 | 🌐 Go | 📅 2025-07-05 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 9,581 | 🐛 178 | 🌐 Go | 📅 2025-07-07 - PHP embedded in Go, with a `net/http` handler.
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,294 | 🐛 50 | 🌐 Go | 📅 2025-06-05 - Port of the Lua 5.2 VM to pure Go.
...
* [metacall](https://github.com/metacall/core) ⭐ 1,665 | 🐛 53 | 🌐 C | 📅 2025-07-02 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
* [starlark-go](https://github.com/google/starlark-go) ⭐ 2,492 | 🐛 63 | 🌐 Go | 📅 2025-07-01 - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
* [starlet](https://github.com/1set/starlet) ⭐ 30 | 🐛 2 | 🌐 Go | 📅 2025-04-15 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,492 | 🐛 63 | 🌐 Go | 📅 2025-07-01 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
* [tengo](https://github.com/d5/tengo) ⭐ 3,663 | 🐛 84 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,591 | 🐛 5 | 🌐 Go | 📅 2025-07-07 - The Wa Programming Language embedded in Go.
...
* [errors](https://github.com/cockroachdb/errors) ⭐ 2,247 | 🐛 18 | 🌐 Go | 📅 2025-05-16 - Go error library with error portability over the network.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 98 | 🐛 3 | 🌐 Go | 📅 2025-06-21 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,583 | 🐛 290 | 🌐 Go | 📅 2025-07-06).
...
* [gdu](https://github.com/dundee/gdu) ⭐ 4,598 | 🐛 52 | 🌐 Go | 📅 2025-07-02 - Disk usage analyzer with console interface.
...
* [go-wkhtmltopdf](https://github.com/SebastiaanKlippert/go-wkhtmltopdf) ⭐ 1,130 | 🐛 10 | 🌐 Go | 📅 2024-07-02 - A package to convert an HTML template to a PDF file.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,776 | 🐛 128 | 🌐 Go | 📅 2025-06-28 - PDF processor.
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 | 🐛 1 | 🌐 Go | 📅 2023-09-21 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,842 | 🐛 39 | 📅 2025-01-16.
* [vfs](https://github.com/C2FO/vfs) ⭐ 342 | 🐛 10 | 🌐 Go | 📅 2025-05-12 - A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS.
...
* [ach](https://github.com/moov-io/ach) ⭐ 492 | 🐛 14 | 🌐 Go | 📅 2025-07-03 - A reader, writer, and validator for Automated Clearing House (ACH) files.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,380 | 🐛 136 | 🌐 Go | 📅 2025-07-08 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,832 | 🐛 144 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
...
* [go-money](https://github.com/rhymond/go-money) ⭐ 1,778 | 🐛 23 | 🌐 Go | 📅 2025-04-30 - Implementation of Fowler's Money pattern.
* [go-nowpayments](https://github.com/matm/go-nowpayments) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2023-01-24 - Library for the crypto NOWPayments API.
* [ledger](https://github.com/formancehq/ledger) ⭐ 990 | 🐛 7 | 🌐 Go | 📅 2025-07-04 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,306 | 🐛 37 | 🌐 Go | 📅 2025-05-29 - Terminal stock watcher and stock position tracker.
...
* [form](https://github.com/go-playground/form) ⭐ 845 | 🐛 15 | 🌐 Go | 📅 2025-03-21 - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,202 | 🐛 301 | 🌐 Go | 📅 2025-07-07 - dead simple 2D game engine in Go.
...
* [Leaf](https://github.com/name5566/leaf) ⭐ 5,423 | 🐛 24 | 🌐 Go | 📅 2024-05-23 - Lightweight game server framework.
* [nano](https://github.com/lonng/nano) ⭐ 3,042 | 🐛 30 | 🌐 Go | 📅 2025-03-30 - Lightweight, facility, high performance golang based game server framework.
* [Oak](https://github.com/oakmound/oak) ⭐ 1,632 | 🐛 14 | 🌐 Go | 📅 2025-02-16 - Pure Go game engine.
* [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,571 | 🐛 58 | 🌐 Go | 📅 2025-06-04 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
* [goverter](https://github.com/jmattheis/goverter) ⭐ 716 | 🐛 16 | 🌐 Go | 📅 2025-07-06 - Generate converters by defining an interface.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,298 | 🐛 692 | 🌐 Go | 📅 2025-07-07 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,761 | 🐛 33 | 🌐 Go | 📅 2025-07-07 - S2 geometry library in Go.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,368 | 🐛 151 | 🌐 Go | 📅 2025-06-17 - Geolocation DB with spatial index and realtime geofencing.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,812 | 🐛 0 | 🌐 Go | 📅 2025-04-12 - A high-performance and low-cost goroutine pool in Go.
...
* [conc](https://github.com/sourcegraph/conc) ⭐ 9,982 | 🐛 24 | 🌐 Go | 📅 2024-04-26 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
* [pond](https://github.com/alitto/pond) ⭐ 1,881 | 🐛 3 | 🌐 Go | 📅 2025-06-20 - Minimalistic and High-performance goroutine worker pool written in Go.
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,722 | 🐛 42 | 🌐 Go | 📅 2025-04-16 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 422 | 🐛 19 | 🌐 C++ | 📅 2025-07-01 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,697 | 🐛 1,166 | 🌐 C++ | 📅 2025-07-07 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,678 | 🐛 17 | 🌐 Lua | 📅 2025-07-01.
* [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,034 | 🐛 226 | 🌐 Go | 📅 2025-07-08 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
* [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,276 | 🐛 37 | 🌐 Go | 📅 2025-03-08 - Build native macOS applications using Go.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,712 | 🐛 740 | 🌐 Go | 📅 2025-07-07 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
* [gotk3](https://github.com/gotk3/gotk3) ⭐ 2,171 | 🐛 124 | 🌐 Go | 📅 2024-08-08 - Go bindings for GTK3.
...
* [Spot](https://github.com/roblillack/spot) ⭐ 1,226 | 🐛 7 | 🌐 Go | 📅 2024-12-19 - Reactive, cross-platform desktop GUI toolkit.
...
* [webview](https://github.com/zserge/webview) ⭐ 13,209 | 🐛 190 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,241 | 🐛 135 | 🌐 Go | 📅 2025-06-15 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,593 | 🐛 217 | 🌐 Go | 📅 2025-07-07 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
* [emgo](https://github.com/ziutek/emgo) ⭐ 1,085 | 🐛 13 | 🌐 C | 📅 2021-12-05 - Go-like language for programming embedded systems (e.g. STM32 MCU).
* [ghw](https://github.com/jaypipes/ghw) ⭐ 1,760 | 🐛 57 | 🌐 Go | 📅 2025-07-04 - Golang hardware discovery/inspection library.
...
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,593 | 🐛 19 | 🌐 Go | 📅 2025-05-08 - Vector graphics to PDF, SVG or rasterized image.
...
* [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 727 | 🐛 6 | 🌐 Go | 📅 2025-05-15 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,131 | 🐛 343 | 🌐 Go | 📅 2025-07-07 - Go package for computer vision using OpenCV 3.3+.
...
* [govips](https://github.com/davidbyttow/govips) ⭐ 1,457 | 🐛 31 | 🌐 Go | 📅 2025-07-07 - A lightning fast image processing and resizing library for Go.
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,836 | 🐛 32 | 🌐 Go | 📅 2025-05-27 - Screenshoting webpages using go and headless chrome on command line.
...
* [imaginary](https://github.com/h2non/imaginary) ⭐ 5,875 | 🐛 132 | 🌐 Go | 📅 2025-01-14 - Fast and simple HTTP microservice for image resizing.
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,518 | 🐛 33 | 🌐 Go | 📅 2023-09-21 - Simple Go image processing package.
* [imagor](https://github.com/cshum/imagor) ⭐ 3,668 | 🐛 39 | 🌐 Go | 📅 2025-06-30 - Fast, secure image processing server and Go library, using libvips.
...
* [picfit](https://github.com/thoas/picfit) ⭐ 2,251 | 🐛 12 | 🌐 Go | 📅 2025-06-10 - An image resizing server written in Go.
...
* [stegify](https://github.com/DimitarPetrov/stegify) ⭐ 1,239 | 🐛 0 | 🌐 Go | 📅 2023-04-11 - Go tool for LSB steganography, capable of hiding any file within an image.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,606 | 🐛 58 | 🌐 Go | 📅 2025-07-02 - Lightweight data stream processing engine for IoT edge.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,211 | 🐛 103 | 🌐 Go | 📅 2025-05-05 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [rulego](https://github.com/rulego/rulego) ⭐ 1,189 | 🐛 8 | 🌐 Go | 📅 2025-07-07 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
* [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 | 🐛 39 | 🌐 Go | 📅 2019-11-04 - Lightweight stream processing engine for IoT.
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,351 | 🐛 30 | 🌐 Go | 📅 2025-07-07 - Kubernetes native IoT development framework.
...
* [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,891 | 🐛 3 | 🌐 Go | 📅 2025-05-24 - Simple, zero-dependency scheduling library for Go.
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,348 | 🐛 17 | 🌐 Go | 📅 2025-05-16 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,492 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,030 | 🐛 89 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 591 | 🐛 1 | 🌐 Go | 📅 2025-05-29 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,357 | 🐛 80 | 🌐 Go | 📅 2025-06-20 - Structured logger for Go.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,357 | 🐛 80 | 🌐 Go | 📅 2025-06-20 logger.
* [logrusly](https://github.com/sebest/logrusly) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,357 | 🐛 80 | 🌐 Go | 📅 2025-06-20 plug-in to send errors to a [Loggly](https://www.loggly.com/).
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,357 | 🐛 80 | 🌐 Go | 📅 2025-06-20, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,146 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,327 | 🐛 165 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,578 | 🐛 139 | 🌐 Go | 📅 2025-04-18, etc).
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,152 | 🐛 100 | 🌐 Go | 📅 2024-08-05 - Simple rolling logger, implements io.WriteCloser.
...
* [pp](https://github.com/k0kubun/pp) ⭐ 1,964 | 🐛 7 | 🌐 Go | 📅 2025-07-01 - Colored pretty printer for Go language.
...
* [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 974 | 🐛 52 | 🌐 Go | 📅 2025-07-07 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
...
* [slog](https://github.com/gookit/slog) ⭐ 483 | 🐛 1 | 🌐 Go | 📅 2025-07-07 - Lightweight, configurable, extensible logger for Go.
...
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,267 | 🐛 65 | 🌐 Go | 📅 2024-04-06 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
* [zap](https://github.com/uber-go/zap) ⭐ 23,327 | 🐛 165 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
...
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,578 | 🐛 139 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [catboost-cgo](https://github.com/mirecl/catboost-cgo) ⭐ 16 | 🐛 4 | 🌐 C | 📅 2025-07-06 - Fast, scalable, high performance Gradient Boosting on Decision Trees library. Golang using Cgo for blazing fast inference CatBoost Model.
...
* [gorse](https://github.com/zhenghaoz/gorse) ⭐ 4 | 🐛 0 | 📅 2025-04-18 - An offline recommender system backend based on collaborative filtering written in Go.
* [goscore](https://github.com/asafschers/goscore) ⭐ 102 | 🐛 3 | 🌐 Go | 📅 2019-08-23 - Go Scoring API for PMML.
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,902 | 🐛 33 | 🌐 Go | 📅 2025-03-24 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 427 | 🐛 6 | 🌐 Go | 📅 2025-07-04 - Huggingface transformer pipelines for golang with onnxruntime.
...
* [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 802 | 🐛 44 | 🌐 Go | 📅 2024-09-02 - Go Interface to Open Neural Network Exchange (ONNX).
...
* [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,804 | 🐛 18 | 🌐 Go | 📅 2025-07-02 - Go RabbitMQ Client Library.
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,534 | 🐛 249 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,082 | 🐛 22 | 🌐 Go | 📅 2025-07-04 - Real-time messaging (Websockets or SockJS) server in Go.
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,930 | 🐛 284 | 🌐 HTML | 📅 2025-07-07 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
* [go-nsq](https://github.com/nsqio/go-nsq) ⭐ 2,632 | 🐛 33 | 🌐 Go | 📅 2025-03-13 - the official Go package for NSQ.
...
* [Mercure](https://github.com/dunglas/mercure) ⭐ 4,978 | 🐛 26 | 🌐 Go | 📅 2025-06-27 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,003 | 🐛 185 | 🌐 Go | 📅 2025-07-07 - Go client for the NATS
  messaging system.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,077 | 🐛 65 | 🌐 Go | 📅 2025-07-07 - Go library for Apache Kafka.
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,614 | 🐛 26 | 🌐 Go | 📅 2025-05-21 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/xuri/excelize) ⭐ 19,337 | 🐛 126 | 🌐 Go | 📅 2025-07-07 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,983 | 🐛 9 | 🌐 Go | 📅 2025-04-18 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
* [dig](https://github.com/uber-go/dig) ⭐ 4,218 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 185 | 🐛 15 | 🌐 Go | 📅 2025-05-27 - A dependency injection toolkit for Go, based on Guice.
* [do](https://github.com/samber/do) ⭐ 2,186 | 🐛 45 | 🌐 Go | 📅 2025-07-05 - A dependency injection framework based on Generics.
* [fx](https://github.com/uber-go/fx) ⭐ 6,635 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
...
* [google/wire](https://github.com/google/wire) ⭐ 13,919 | 🐛 110 | 🌐 Go | 📅 2024-07-24 - Automated Initialization in Go.
...
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,818 | 🐛 0 | 🌐 Go | 📅 2025-07-07 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,818 | 🐛 0 | 🌐 Go | 📅 2025-07-07 for building production grade scalable web service applications.
...
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,773 | 🐛 45 | 🌐 Go | 📅 2025-07-07 - Allows users to spin up a quick Go project using a popular framework.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,008 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,008 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
...
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,290 | 🐛 0 | 🌐 Go | 📅 2025-06-14 - Nunu is a scaffolding tool for building Go applications.
* [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,564 | 🐛 2 | 🌐 Go | 📅 2025-06-24 - Rapid, easy full-stack web development starter kit built in Go.
...
* [archives](https://github.com/mholt/archives) ⭐ 262 | 🐛 7 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,258 | 🐛 6 | 🌐 Go | 📅 2025-06-25 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
* [basexx](https://github.com/bobg/basexx) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Convert to, from, and between digit strings in various number bases.
* [battery](https://github.com/distatus/battery) ⭐ 263 | 🐛 7 | 🌐 Go | 📅 2023-09-27 - Cross-platform, normalized battery information library.
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,647 | 🐛 221 | 🌐 Go | 📅 2025-07-03 - Automated service health dashboard.
...
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,987 | 🐛 13 | 🌐 Go | 📅 2025-06-26 - Random data generator written in go.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,290 | 🐛 215 | 🌐 Go | 📅 2025-07-02 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,280 | 🐛 83 | 🌐 Go | 📅 2024-07-26 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
* [stateless](https://github.com/qmuntal/stateless) ⭐ 1,076 | 🐛 19 | 🌐 Go | 📅 2025-05-23 - A fluent library for creating state machines.
...
* [lingua-go](https://github.com/pemistahl/lingua-go) ⭐ 1,253 | 🐛 9 | 🌐 Go | 📅 2025-02-06 - An accurate natural language detection library, suitable for long and short text alike. Supports detecting multiple languages in mixed-language text.
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,540 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,227 | 🐛 690 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,283 | 🐛 15 | 🌐 Go | 📅 2025-07-01 - Package and an accompanying tool to work with localized text.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 74 | 🐛 0 | 🌐 Go | 📅 2025-07-07 - Package bart provides a fast routing table algorithm.
...
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,980 | 🐛 443 | 🌐 Go | 📅 2025-07-07 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [dns](https://github.com/miekg/dns) ⭐ 8,414 | 🐛 12 | 🌐 Go | 📅 2025-06-01 - Go library for working with DNS.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,717 | 🐛 109 | 🌐 Go | 📅 2025-07-05 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [fortio](https://github.com/fortio/fortio) ⭐ 3,554 | 🐛 80 | 🌐 Go | 📅 2025-06-23 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
* [ftpserverlib](https://github.com/fclairamb/ftpserverlib) ⭐ 449 | 🐛 8 | 🌐 Go | 📅 2025-07-06 - Fully featured FTP server library.
...
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,627 | 🐛 1 | 🌐 Go | 📅 2025-06-20 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,825 | 🐛 220 | 🌐 Go | 📅 2025-07-08 - BGP implemented in the Go Programming Language.
* [gopacket](https://github.com/google/gopacket) ⭐ 6,562 | 🐛 360 | 🌐 Go | 📅 2025-03-19 - Go library for packet processing with libpcap bindings.
* [gopcap](https://github.com/akrennmair/gopcap) ⭐ 491 | 🐛 11 | 🌐 Go | 📅 2021-05-17 - Go wrapper for libpcap.
* [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,398 | 🐛 85 | 🌐 Go | 📅 2025-06-05 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,172 | 🐛 130 | 🌐 Go | 📅 2025-07-01 - Extremely simple & fast udp tunnel based on KCP protocol.
...
* [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,350 | 🐛 25 | 🌐 Go | 📅 2025-06-17 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,090 | 🐛 2 | 🌐 Go | 📅 2025-07-07 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,802 | 🐛 188 | 🌐 Go | 📅 2025-07-07 - An implementation of the QUIC protocol in pure Go.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,971 | 🐛 15 | 🌐 Go | 📅 2025-06-20 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [water](https://github.com/songgao/water) ⭐ 2,051 | 🐛 30 | 🌐 Go | 📅 2024-07-30 - Simple TUN/TAP library.
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,018 | 🐛 99 | 🌐 Go | 📅 2025-07-03 - A pure Go implementation of the WebRTC API.
...
* [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,154 | 🐛 73 | 🌐 Go | 📅 2025-07-07 - Retryable HTTP client in Go.
...
* [req](https://github.com/imroc/req) ⭐ 4,541 | 🐛 71 | 🌐 Go | 📅 2025-06-27 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
* [requests](https://github.com/carlmjohnson/requests) ⭐ 1,613 | 🐛 2 | 🌐 Go | 📅 2025-04-16 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
* [resty](https://github.com/go-resty/resty) ⭐ 11,031 | 🐛 36 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,190 | 🐛 35 | 🌐 Go | 📅 2025-06-17 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,348 | 🐛 22 | 🌐 Go | 📅 2025-07-06 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
...
* [ent](https://github.com/facebook/ent) ⭐ 16,334 | 🐛 586 | 🌐 Go | 📅 2025-06-20 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,471 | 🐛 463 | 🌐 Go | 📅 2025-07-07 - The fantastic ORM library for Golang, aims to be developer friendly.
...
* [Prisma](https://github.com/prisma/prisma-client-go) ⭐ 2,305 | 🐛 115 | 🌐 Go | 📅 2025-07-02 - Prisma Client Go, Typesafe database access for Go.
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,891 | 🐛 104 | 🌐 Go | 📅 2025-06-27 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,294 | 🐛 473 | 🌐 Go | 📅 2025-07-07 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,563 | 🐛 322 | 🌐 Go | 📅 2025-07-07 - A distributed tracing system.
* [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 171 | 🐛 1 | 🌐 Go | 📅 2025-01-05 - Generic manual memory management for golang.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,080 | 🐛 333 | 🌐 C++ | 📅 2025-07-02 - No instrumentation tracing for Golang applications via eBPF.
* [profile](https://github.com/pkg/profile) ⭐ 2,031 | 🐛 11 | 🌐 Go | 📅 2022-10-20 - Simple profiling support package for Go.
* [statsviz](https://github.com/arl/statsviz) ⭐ 3,312 | 🐛 11 | 🌐 Go | 📅 2025-06-17 - Live visualization of your Go application runtime statistics.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,401 | 🐛 367 | 🌐 Go | 📅 2025-07-07 - go generate based graphql server library.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,083 | 🐛 246 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [acra](https://github.com/cossacklabs/acra) ⭐ 1,407 | 🐛 13 | 🌐 Go | 📅 2025-04-17 - Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system.
* [age](https://github.com/FiloSottile/age) ⭐ 19,184 | 🐛 43 | 🌐 Go | 📅 2025-06-15 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,214 | 🐛 1 | 🌐 Go | 📅 2025-07-01 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [booster](https://github.com/anatol/booster) ⭐ 575 | 🐛 73 | 🌐 Go | 📅 2025-03-15 - Fast initramfs generator with full-disk encryption support.
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,460 | 🐛 28 | 🌐 Go | 📅 2024-10-11 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,739 | 🐛 95 | 🌐 Go | 📅 2025-07-07 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [lego](https://github.com/go-acme/lego) ⭐ 8,712 | 🐛 158 | 🌐 Go | 📅 2025-07-07 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 892 | 🐛 23 | 🌐 Go | 📅 2025-07-05 - Small, safe, and easy CBOR encoding and decoding library.
...
* [go-codec](https://github.com/ugorji/go) ⭐ 1,897 | 🐛 2 | 🌐 Go | 📅 2025-06-17 - High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support.
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,978 | 🐛 115 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [jsoniter](https://github.com/json-iterator/go) ⭐ 13,814 | 🐛 267 | 🌐 Go | 📅 2024-05-27 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,348 | 🐛 221 | 🌐 Go | 📅 2025-07-08 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 49,787 | 🐛 321 | 🌐 Go | 📅 2025-07-08 - Highly-available key value store for shared configuration and service discovery.
...
* [Fider](https://github.com/getfider/fider) ⭐ 3,593 | 🐛 49 | 🌐 Go | 📅 2025-07-04 - Fider is an open platform to collect and organize customer feedback.
...
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,454 | 🐛 45 | 🌐 Go | 📅 2025-07-07 - A self contained feature flag solution written in Go and Vue.js
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,686 | 🐛 24 | 🌐 Go | 📅 2025-07-07 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [minio](https://github.com/minio/minio) ⭐ 53,615 | 🐛 51 | 🌐 Go | 📅 2025-07-01 - Minio is a distributed object storage server.
...
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 48,664 | 🐛 18 | 🌐 Go | 📅 2025-06-29 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,178 | 🐛 79 | 🌐 Go | 📅 2025-07-07 - High-performance PHP application server, load-balancer and process manager.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,665 | 🐛 110 | 🌐 Go | 📅 2025-07-03 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,031 | 🐛 46 | 🌐 Go | 📅 2025-06-30 - HTTP reverse proxy cache and time series accelerator.
...
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,195 | 🐛 14 | 🌐 Go | 📅 2025-06-23 - Make SSH apps, just like that!
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,055 | 🐛 4 | 🌐 Go | 📅 2025-05-11 - Go stream processing library.
...
* [liquid](https://github.com/osteele/liquid) ⭐ 308 | 🐛 30 | 🌐 Go | 📅 2025-06-01 - Go implementation of Shopify Liquid templates.
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,479 | 🐛 53 | 🌐 Go | 📅 2025-03-21 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,453 | 🐛 69 | 🌐 Go | 📅 2025-07-07 - A HTML templating language that has great developer tooling.
...
* [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 973 | 🐛 7 | 🌐 Go | 📅 2025-06-02 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-07-06 - HTTP client testing framework.
...
* [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,445 | 🐛 27 | 🌐 Go | 📅 2025-07-03 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
* [go-carpet](https://github.com/msoap/go-carpet) ⭐ 248 | 🐛 3 | 🌐 Go | 📅 2024-09-30 - Tool for viewing test coverage in terminal.
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,458 | 🐛 46 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
...
* [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,310 | 🐛 3 | 🌐 Go | 📅 2025-07-03 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
* [httpexpect](https://github.com/gavv/httpexpect) ⭐ 2,652 | 🐛 16 | 🌐 Go | 📅 2025-06-02 - Concise, declarative, and easy to use end-to-end HTTP and REST API testing.
...
* [keploy](https://github.com/keploy/keploy) ⭐ 10,283 | 🐛 238 | 🌐 Go | 📅 2025-07-03 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcase](https://github.com/adamluzsi/testcase) ⭐ 123 | 🐛 0 | 🌐 Go | 📅 2025-07-07 - Idiomatic testing framework for Behavior Driven Development.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,178 | 🐛 139 | 🌐 Go | 📅 2025-07-03 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 24,874 | 🐛 371 | 🌐 Go | 📅 2025-07-01 - Sacred extension to the standard go testing package.
...
* [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,053 | 🐛 28 | 🌐 Go | 📅 2025-06-06 - Tool for generating self-contained mock objects.
...
* [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,391 | 🐛 41 | 🌐 Go | 📅 2024-09-11 - Mock SQL driver for testing database interactions.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,898 | 🐛 95 | 🌐 Go | 📅 2025-07-01 - Mocking framework for the Go programming language.
...
* [minimock](https://github.com/gojuno/minimock) ⭐ 692 | 🐛 9 | 🌐 Go | 📅 2025-06-10 - Mock generator for Go interfaces.
* [mockery](https://github.com/vektra/mockery) ⭐ 6,680 | 🐛 40 | 🌐 Go | 📅 2025-06-27 - Tool to generate Go interfaces.
...
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 491 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,104 | 🐛 234 | 🌐 Go | 📅 2025-06-26.
* [timex](https://github.com/cabify/timex) ⭐ 71 | 🐛 1 | 🌐 Go | 📅 2020-08-03 - A test-friendly replacement for the native `time` package.
* [xgo](https://github.com/xhd2015/xgo) ⭐ 412 | 🐛 59 | 🌐 Go | 📅 2025-07-01 - A general pureposed function mocking library.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,001 | 🐛 146 | 🌐 Go | 📅 2025-06-20 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,775 | 🐛 54 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
* [rod](https://github.com/go-rod/rod) ⭐ 6,057 | 🐛 183 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
...
* [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,576 | 🐛 41 | 🌐 Go | 📅 2025-07-01 - Formatters for time, numbers, and memory size to human readable format.
...
* [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,563 | 🐛 218 | 🌐 Go | 📅 2024-01-29 - Markdown processor in Go.
...
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,167 | 🐛 8 | 🌐 Go | 📅 2025-06-13 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,915 | 🐛 15 | 🌐 Go | 📅 2025-06-09 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,751 | 🐛 18 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
...
* [go-querystring](https://github.com/google/go-querystring) ⭐ 2,057 | 🐛 20 | 🌐 Go | 📅 2025-06-23 - Go library for encoding structs into URL query parameters.
...
* [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,262 | 🐛 7 | 🌐 Go | 📅 2025-07-08 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
* [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,714 | 🐛 54 | 🌐 Go | 📅 2025-05-27 - Parse RSS and Atom feeds in Go.
...
* [sh](https://github.com/mvdan/sh) ⭐ 7,843 | 🐛 99 | 🌐 Go | 📅 2025-07-07 - Shell parser and formatter.
...
* [colly](https://github.com/asciimoo/colly) ⭐ 24,410 | 🐛 192 | 🌐 Go | 📅 2025-06-18 - Fast and Elegant Scraping Framework for Gophers.
...
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,579 | 🐛 3 | 🌐 Go | 📅 2025-06-07 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,142 | 🐛 81 | 🌐 Go | 📅 2025-07-03 - The official AWS SDK for the Go programming language.
...
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,453 | 🐛 187 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
...
* [github](https://github.com/google/go-github) ⭐ 10,854 | 🐛 32 | 🌐 Go | 📅 2025-07-04 - Go library for accessing the GitHub REST API v3.
...
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,139 | 🐛 212 | 🌐 Go | 📅 2025-06-25 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
* [golang-tmdb](https://github.com/cyruzin/golang-tmdb) ⭐ 138 | 🐛 3 | 🌐 Go | 📅 2025-07-03 - Golang wrapper for The Movie Database API v3.
...
* [google](https://github.com/google/google-api-go-client) ⭐ 4,283 | 🐛 20 | 🌐 Go | 📅 2025-07-07 - Auto-generated Google APIs for Go.
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,282 | 🐛 386 | 🌐 Go | 📅 2025-07-08 - Google Cloud APIs Go Client Library.
...
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,732 | 🐛 19 | 🌐 Go | 📅 2025-07-01 - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [slack](https://github.com/slack-go/slack) ⭐ 4,808 | 🐛 102 | 🌐 Go | 📅 2025-07-04 - Slack API in Go.
...
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,343 | 🐛 9 | 🌐 Go | 📅 2025-07-07 - Go client for the Stripe API.
...
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) ⭐ 1,147 | 🐛 23 | 🌐 Go | 📅 2024-05-15 - Circuit Breakers in Go.
* [clipboard](https://github.com/golang-design/clipboard) ⭐ 697 | 🐛 24 | 🌐 Go | 📅 2025-06-14 - 📋 cross-platform clipboard package in Go.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 51,334 | 🐛 167 | 🌐 Go | 📅 2025-07-07 - A tool for exploring each layer in a Docker image.
...
* [filetype](https://github.com/h2non/filetype) ⭐ 2,207 | 🐛 47 | 🌐 Go | 📅 2025-06-27 - Small package to infer the file type checking the magic numbers signature.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 71,583 | 🐛 290 | 🌐 Go | 📅 2025-07-06 - Command-line fuzzy finder written in Go.
...
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,814 | 🐛 23 | 🌐 Go | 📅 2025-07-08 - Deliver Go binaries as fast and easily as possible.
...
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,108 | 🐛 5 | 🌐 Go | 📅 2025-07-07 - A comprehensive, efficient, and reusable util function library of go.
...
* [lo](https://github.com/samber/lo) ⭐ 19,714 | 🐛 206 | 🌐 Go | 📅 2025-07-07 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
* [mani](https://github.com/alajmo/mani) ⭐ 559 | 🐛 20 | 🌐 Go | 📅 2025-05-26 - CLI tool to help you manage multiple repositories.
* [mc](https://github.com/minio/mc) ⭐ 3,086 | 🐛 41 | 🌐 Go | 📅 2025-07-02 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,823 | 🐛 42 | 🌐 Go | 📅 2025-07-07 - Package for MIME type detection based on magic numbers.
* [minify](https://github.com/tdewolff/minify) ⭐ 3,903 | 🐛 34 | 🌐 Go | 📅 2025-07-07 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
* [retry-go](https://github.com/avast/retry-go) ⭐ 2,717 | 🐛 14 | 🌐 Go | 📅 2025-03-21 - Simple library for retry mechanism.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,125 | 🐛 54 | 🌐 Go | 📅 2025-07-03 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,031 | 🐛 381 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
...
* [upterm](https://github.com/owenthereal/upterm) ⭐ 935 | 🐛 51 | 🌐 Go | 📅 2025-07-07 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
* [usql](https://github.com/knq/usql) ⭐ 9,419 | 🐛 94 | 🌐 Go | 📅 2025-05-19 - usql is a universal command-line interface for SQL databases.
...
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,666 | 🐛 46 | 🌐 Go | 📅 2025-05-06 - Interactive cli tool for HTTP inspection.
...
* [uuid](https://github.com/google/uuid) ⭐ 5,720 | 🐛 45 | 🌐 Go | 📅 2024-11-14 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
* [xid](https://github.com/rs/xid) ⭐ 4,149 | 🐛 17 | 🌐 Go | 📅 2025-05-12 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,944 | 🐛 57 | 🌐 Go | 📅 2024-03-23 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,625 | 🐛 322 | 🌐 Go | 📅 2025-07-02 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [Zog](https://github.com/Oudwins/zog) ⭐ 897 | 🐛 7 | 🌐 Go | 📅 2025-07-03 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,904 | 🐛 531 | 🌐 TypeScript | 📅 2025-07-07 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,697 | 🐛 169 | 🌐 Go | 📅 2025-07-07 - highly extensible Git implementation in pure Go.
...
* [go-astiav](https://github.com/asticode/go-astiav) ⭐ 519 | 🐛 1 | 🌐 Go | 📅 2025-05-23 - Better C bindings for ffmpeg in GO.
...
* [go-astits](https://github.com/asticode/go-astits) ⭐ 573 | 🐛 8 | 🌐 Go | 📅 2024-12-22 - Parse and demux MPEG Transport Streams (.ts) natively in GO.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,241 | 🐛 106 | 🌐 Go | 📅 2025-05-22 - High performance, minimalist Go web framework.
* [Fastschema](https://github.com/fastschema/fastschema) ⭐ 479 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A flexible Go web framework and Headless CMS.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,069 | 🐛 103 | 🌐 Go | 📅 2025-07-07 - An Express.js inspired web framework build on Fasthttp.
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 533 | 🐛 30 | 🌐 Go | 📅 2025-07-07 - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
...
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,435 | 🐛 38 | 🌐 Go | 📅 2025-07-08 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,026 | 🐛 859 | 🌐 Go | 📅 2025-07-08 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 | 🐛 13 | 🌐 Go | 📅 2025-07-05 - Gin parameter automatic binding tool,gin rpc tools.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,892 | 🐛 24 | 🌐 Go | 📅 2025-07-06 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,800 | 🐛 94 | 🌐 Go | 📅 2025-07-08 - Gofr is an opinionated microservice development framework.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,511 | 🐛 207 | 🌐 Go | 📅 2025-06-24 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,900 | 🐛 57 | 🌐 Go | 📅 2025-07-07 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,361 | 🐛 44 | 🌐 Go | 📅 2025-07-04 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,219 | 🐛 119 | 🌐 Go | 📅 2025-07-02 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
* [iWF](https://github.com/indeedeng/iwf) ⭐ 580 | 🐛 72 | 🌐 Go | 📅 2025-07-07 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
* [Revel](https://github.com/revel/revel) ⭐ 13,199 | 🐛 99 | 🌐 Go | 📅 2023-10-28 - High-productivity web framework for the Go language.
...
* [templui](https://github.com/axzilla/templui) ⭐ 757 | 🐛 8 | 🌐 JavaScript | 📅 2025-07-08 - Modern UI Components for Go & Templ.
...
* [Limiter](https://github.com/ulule/limiter) ⭐ 2,236 | 🐛 14 | 🌐 Go | 📅 2024-12-10 - Dead simple rate limit middleware for Go.
...
* [alice](https://github.com/justinas/alice) ⭐ 3,266 | 🐛 11 | 🌐 Go | 📅 2024-06-06 - Painless middleware chaining for Go.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,083 | 🐛 83 | 🌐 Go | 📅 2025-06-20 - Small, fast and expressive HTTP router built on net/context.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,468 | 🐛 35 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,438 | 🐛 500 | 🌐 Go | 📅 2025-07-07 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,025 | 🐛 116 | 🌐 Go | 📅 2025-01-12 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 233 | 🐛 14 | 🌐 Go | 📅 2025-07-07 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [Cadence-client](https://github.com/uber-go/cadence-client) ⭐ 359 | 🐛 73 | 🌐 Go | 📅 2025-07-07 - A framework for authoring workflows and activities running on top of the Cadence orchestration engine made by Uber.
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,373 | 🐛 112 | 🌐 Go | 📅 2025-07-06 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 560 | 🐛 2 | 🌐 Go | 📅 2025-07-04 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,043 | 🐛 264 | 🌐 Go | 📅 2025-07-07 - Container Signing, Verification and Storage in an OCI registry.
...
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,423 | 🐛 246 | 🌐 Go | 📅 2025-07-07 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 | 🐛 19 | 🌐 Go | 📅 2025-07-02 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
...
* [Spire](https://github.com/spiffe/spire) ⭐ 1,984 | 🐛 158 | 🌐 Go | 📅 2025-07-07 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,282 | 🐛 118 | 🌐 Go | 📅 2025-07-07 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
* [golines](https://github.com/segmentio/golines) ⭐ 1,078 | 🐛 72 | 🌐 Go | 📅 2025-04-14 - Formatter that automatically shortens long lines in Go code.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,222 | 🐛 49 | 🌐 Go | 📅 2025-06-25 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,495 | 🐛 579 | 🌐 Go | 📅 2025-06-11 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 141 | 🐛 35 | 🌐 Go | 📅 2025-07-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,874 | 🐛 371 | 🌐 Go | 📅 2025-07-01.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 792 | 🐛 74 | 🌐 Go | 📅 2025-07-07 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,751 | 🐛 96 | 🌐 Go | 📅 2025-07-07 features to Vim/Neovim.
...
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,079 | 🐛 418 | 🌐 TypeScript | 📅 2025-07-07 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [envdoc](https://github.com/g4s8/envdoc) ⭐ 86 | 🐛 7 | 🌐 Go | 📅 2025-07-07 -  generate documentation for environment variables from Go source files.
...
* [xgen](https://github.com/xuri/xgen) ⭐ 372 | 🐛 29 | 🌐 Go | 📅 2025-07-03 - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,311 | 🐛 70 | 🌐 Go | 📅 2025-01-04 - Visualize call graph of your Go program using dot format.
* [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,625 | 🐛 7 | 🌐 Go | 📅 2025-07-07 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,798 | 🐛 607 | 🌐 Go | 📅 2025-06-27 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,673 | 🐛 202 | 🌐 Go | 📅 2025-06-21 - aptly is a Debian repository management tool.
...
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,413 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
...
* [dish](https://github.com/thevxn/dish) ⭐ 243 | 🐛 11 | 🌐 Go | 📅 2025-07-07 - A lightweight, remotely configurable monitoring service.
...
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,193 | 🐛 2,527 | 🌐 Go | 📅 2025-07-07 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,227 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,770 | 🐛 13 | 🌐 Go | 📅 2025-07-04 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,424 | 🐛 2,706 | 🌐 Go | 📅 2025-07-08 - Fork of Gogs, entirely community driven.
...
* [gobrew](https://github.com/kevincobain2000/gobrew) ⭐ 396 | 🐛 1 | 🌐 Go | 📅 2025-06-11 - Go version manager. Super simple tool to install and manage Go versions. Install go without root. Gobrew doesn't require shell rehash.
...
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,052 | 🐛 216 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Hey](https://github.com/rakyll/hey) ⭐ 19,037 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,891 | 🐛 246 | 🌐 Go | 📅 2025-06-28 - Little helper to run CNCF's k3s in Docker.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,155 | 🐛 126 | 🌐 Go | 📅 2025-07-07 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,201 | 🐛 796 | 🌐 Go | 📅 2025-07-07 - A modern load testing tool, using Go and JavaScript.
...
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,287 | 🐛 207 | 🌐 Go | 📅 2025-07-01 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,755 | 🐛 149 | 🌐 Go | 📅 2025-07-07 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 116,192 | 🐛 2,616 | 🌐 Go | 📅 2025-07-08 - Container Cluster Manager from Google.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,415 | 🐛 140 | 🌐 Go | 📅 2025-07-07 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,752 | 🐛 541 | 🌐 Go | 📅 2025-07-04 - Cloud native application delivery.
* [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,182 | 🐛 3 | 🌐 Go | 📅 2025-07-05 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
* [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,145 | 🐛 47 | 🌐 Go | 📅 2025-07-08 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,660 | 🐛 541 | 🌐 Go | 📅 2025-07-07 - Run Kubernetes locally.
* [Moby](https://github.com/moby/moby) ⭐ 70,051 | 🐛 3,617 | 🌐 Go | 📅 2025-07-07 - Collaborative project for the container ecosystem to assemble container-based systems.
...
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,406 | 🐛 303 | 🌐 Go | 📅 2025-07-07 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,644 | 🐛 30 | 🌐 Go | 📅 2025-06-27 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,331 | 🐛 136 | 🌐 Go | 📅 2025-07-08 - Pomerium is an identity-aware access proxy.
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 367 | 🐛 21 | 🌐 Go | 📅 2025-07-04 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,393 | 🐛 140 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 924 | 🐛 199 | 🌐 Go | 📅 2025-07-04 - Manage BareMetal Servers from Command Line (as easily as with Docker).
* [script](https://github.com/bitfield/script) ⭐ 6,769 | 🐛 42 | 🌐 Go | 📅 2025-03-22 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
* [tau](https://github.com/taubyte/tau) ⭐ 4,049 | 🐛 28 | 🌐 Go | 📅 2025-06-23 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
* [traefik](https://github.com/containous/traefik) ⭐ 55,445 | 🐛 656 | 🌐 Go | 📅 2025-07-07 - Reverse proxy and load balancer with support for multiple backends.
...
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,350 | 🐛 94 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,440 | 🐛 66 | 🌐 Go | 📅 2025-07-04 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,414 | 🐛 26 | 🌐 Go | 📅 2025-03-20 - Simulate bad network connections.
...
* [croc](https://github.com/schollz/croc) ⭐ 30,524 | 🐛 14 | 🌐 Go | 📅 2025-07-07 - Easily and securely send files or folders from one computer to another.
...
* [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,471 | 🐛 322 | 🌐 Go | 📅 2025-05-03 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,008 | 🐛 18 | 🌐 Go | 📅 2025-06-26 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
* [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
* [GoNB](https://github.com/janpfeifer/gonb) ⭐ 880 | 🐛 10 | 🌐 Go | 📅 2025-06-01 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
* [Gor](https://github.com/buger/gor) ⭐ 18,996 | 🐛 339 | 🌐 Go | 📅 2025-04-05 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,846 | 🐛 123 | 🌐 Go | 📅 2025-07-08 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [Plik](https://github.com/root-gg/plik) ⭐ 1,581 | 🐛 46 | 🌐 Go | 📅 2025-06-14 - Plik is a temporary file upload system (Wetransfer like) in Go.
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,660 | 🐛 28 | 🌐 Go | 📅 2024-08-20 - Portal is a quick and easy command-line file transfer utility from any computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,231 | 🐛 473 | 🌐 Go | 📅 2025-07-01 - De-duplicating backup program.
* [sake](https://github.com/alajmo/sake) ⭐ 701 | 🐛 13 | 🌐 Go | 📅 2025-04-18 - sake is a command runner for local and remote hosts.
* [scc](https://github.com/boyter/scc) ⭐ 7,452 | 🐛 53 | 🌐 Go | 📅 2025-06-29 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,092 | 🐛 592 | 🌐 Go | 📅 2025-07-08 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [yai](https://github.com/ekkinox/yai) ⭐ 803 | 🐛 29 | 🌐 Go | 📅 2024-07-31 - AI powered terminal assistant.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,188 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,053 | 🐛 7,316 | 🌐 Go | 📅 2025-07-08
* [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
* [Google](https://google.github.io/styleguide/go/)
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,184 | 🐛 182 | 🌐 Go | 📅 2025-06-30
...
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,629 | 🐛 24 | 🌐 Makefile | 📅 2025-06-16
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,622 | 🐛 4 | 📅 2025-05-11 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,691 | 🐛 41 | 🌐 Ruby | 📅 2024-06-02 - List of other amazingly awesome lists.
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,763 | 🐛 9,370 | 🌐 Go | 📅 2025-07-08 - List of projects on the Go community wiki.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,673 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
...
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,932 | 🐛 8 | 🌐 Go | 📅 2025-07-07 - Clean Architecture template for Golang services.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,645 | 🐛 65 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
...
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,375 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,958 | 🐛 66 | 🌐 Go | 📅 2025-06-17 - Learn Go with test-driven development.
