...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 150,811 | 🐛 146 | 🌐 Go | 📅 2025-08-21
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 394,921 | 🐛 55 | 📅 2025-07-18
[![Slack Widget](https://img.shields.io/badge/join-us%20on%20slack-gray.svg?longCache=true\&logo=slack\&colorB=red)](https://gophers.slack.com/messages/awesome)
[![Netlify Status](https://api.netlify.com/api/v1/badges/83a6dcbe-0da6-433e-b586-f68109286bd5/deploy-status)](https://app.netlify.com/sites/awesome-go/deploys)
[![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/avelino/awesome-go/)
[![Last Commit](https://img.shields.io/github/last-commit/avelino/awesome-go)](https://github.com/avelino/awesome-go/commits/main) ⭐ 150,811 | 🐛 146 | 🌐 Go | 📅 2025-08-21
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 256,706 | 🐛 489 | 🌐 Python | 📅 2025-07-17.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 150,811 | 🐛 146 | 🌐 Go | 📅 2025-08-21 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 150,811 | 🐛 146 | 🌐 Go | 📅 2025-08-21; you rock!
...
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 276 | 🐛 0 | 🌐 Go | 📅 2025-08-25 - Fast and Distributed Actor framework using protocol buffers as message for Golang.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [Ollama](https://github.com/jmorganca/ollama) ⭐ 150,902 | 🐛 2,144 | 🌐 Go | 📅 2025-08-25 - Run large language models locally.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 34,836 | 🐛 395 | 🌐 Go | 📅 2025-08-25 - Open Source OpenAI alternative, self-host AI models.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,457 | 🐛 364 | 🌐 Go | 📅 2025-08-25 - LangChainGo is a framework for developing applications powered by language models.
* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 688 | 🐛 12 | 🌐 Go | 📅 2025-08-02 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 19,055 | 🐛 31 | 🌐 Go | 📅 2025-08-14 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,411 | 🐛 44 | 🌐 Go | 📅 2025-08-25 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
* [goth](https://github.com/markbates/goth) ⭐ 6,183 | 🐛 131 | 🌐 Go | 📅 2025-08-22 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
* [spicedb](https://github.com/authzed/spicedb) ⭐ 5,974 | 🐛 115 | 🌐 Go | 📅 2025-08-25 - A Zanzibar-inspired database that enables fine-grained authorization.
...
* [keto](https://github.com/ory/keto) ⭐ 5,098 | 🐛 58 | 🌐 Go | 📅 2025-08-25 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [openfga](https://github.com/openfga/openfga) ⭐ 4,028 | 🐛 137 | 🌐 Go | 📅 2025-08-25 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
* [scs](https://github.com/alexedwards/scs) ⭐ 2,396 | 🐛 33 | 🌐 Go | 📅 2025-08-13 - Session Manager for HTTP servers.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,187 | 🐛 7 | 🌐 Go | 📅 2025-08-25 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
...
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,642 | 🐛 28 | 🌐 Go | 📅 2025-08-25 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
...
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,621 | 🐛 315 | 🌐 Go | 📅 2025-08-25 - Official Go implementation of the Ethereum protocol.
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,655 | 🐛 1,074 | 🌐 Go | 📅 2025-08-25 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 8,005 | 🐛 806 | 🌐 Go | 📅 2025-08-20 - A complete implementation of a Lightning Network node.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,704 | 🐛 211 | 🌐 Go | 📅 2025-08-25 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,826 | 🐛 25 | 🌐 Go | 📅 2025-08-21 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
* [gno](https://github.com/gnolang/gno) ⭐ 987 | 🐛 706 | 🌐 Go | 📅 2025-08-26 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 774 | 🐛 305 | 🌐 Go | 📅 2025-08-25 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,240 | 🐛 172 | 🌐 Go | 📅 2024-08-14 - Simple and clean Telegram bot client.
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,424 | 🐛 58 | 🌐 Go | 📅 2025-05-28 - Telegram bot framework is written in Go.
* [wayback](https://github.com/wabarc/wayback) ⭐ 2,048 | 🐛 56 | 🌐 Go | 📅 2025-08-25 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [telego](https://github.com/mymmrac/telego) ⭐ 768 | 🐛 5 | 🌐 Go | 📅 2025-08-25 - Telegram Bot API library for Golang with full one-to-one API implementation.
...
* [slack-bot](https://github.com/innogames/slack-bot) ⭐ 199 | 🐛 8 | 🌐 Go | 📅 2025-08-21 - Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github...
...
* [air](https://github.com/cosmtrek/air) ⭐ 21,492 | 🐛 186 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
* [Task](https://github.com/go-task/task) ⭐ 13,404 | 🐛 402 | 🌐 Go | 📅 2025-08-26 - simple "Make" alternative.
...
* [goyek](https://github.com/goyek/goyek) ⭐ 633 | 🐛 2 | 🌐 Go | 📅 2025-08-25 - Create build pipelines in Go.
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 34,690 | 🐛 126 | 🌐 Go | 📅 2025-08-19 - Go framework to build terminal apps, based on The Elm Architecture.
* [fx](https://github.com/antonmedv/fx) ⭐ 19,782 | 🐛 5 | 🌐 Go | 📅 2025-08-21 - Terminal JSON viewer & processor.
...
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,523 | 🐛 91 | 🌐 Go | 📅 2025-08-18 - Declaratively define styles for color, format and layout in the terminal.
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,831 | 🐛 170 | 🌐 Go | 📅 2025-08-24 - TUI components for bubbletea.
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,398 | 🐛 114 | 🌐 Go | 📅 2025-08-12 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,901 | 🐛 678 | 🌐 Python | 📅 2025-08-17.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,221 | 🐛 66 | 🌐 Go | 📅 2025-08-08 - A library to beautify console output on every platform with many combinable components.
...
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,469 | 🐛 16 | 🌐 Go | 📅 2025-02-08 - Basic thread-safe progress bar that works in every OS.
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,875 | 🐛 48 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,412 | 🐛 104 | 🌐 Go | 📅 2025-07-10.
* [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 2,872 | 🐛 14 | 🌐 Go | 📅 2024-10-26 - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
...
* [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 514 | 🐛 18 | 🌐 Go | 📅 2025-08-13 - An interactive table component for bubbletea.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,543 | 🐛 322 | 🌐 Go | 📅 2025-08-11 - Commander for modern Go CLI interactions.
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,457 | 🐛 50 | 🌐 Go | 📅 2025-08-16 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,410 | 🐛 80 | 🌐 Go | 📅 2025-08-25 - Multi-shell multi-command argument completer.
...
* [carapace](https://github.com/rsteube/carapace) ⭐ 801 | 🐛 42 | 🌐 Go | 📅 2025-08-16 - Command argument completion generator for spf13/cobra.
...
* [carapace-spec](https://github.com/rsteube/carapace-spec) ⭐ 22 | 🐛 17 | 🌐 Go | 📅 2025-08-25 - Define simple completions using a spec file.
...
* [viper](https://github.com/spf13/viper) ⭐ 29,139 | 🐛 520 | 🌐 Go | 📅 2025-08-21 - Go configuration with fangs.
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,685 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,530 | 🐛 26 | 🌐 Go | 📅 2025-08-22 - A blazingly fast JSON serializing & deserializing library.
* [env](https://github.com/caarlos0/env) ⭐ 5,708 | 🐛 12 | 🌐 Go | 📅 2025-08-12 - Parse environment variables to Go structs (with defaults).
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,304 | 🐛 59 | 🌐 Go | 📅 2025-06-28 - Go library for managing configuration data from environment variables.
* [ini](https://github.com/go-ini/ini) ⭐ 3,521 | 🐛 65 | 🌐 Go | 📅 2024-05-01 - Go package to read and write INI files.
* [koanf](https://github.com/knadh/koanf) ⭐ 3,409 | 🐛 9 | 🌐 Go | 📅 2025-08-25 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
* [kong](https://github.com/alecthomas/kong) ⭐ 2,764 | 🐛 30 | 🌐 Go | 📅 2025-08-18 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
* [xdg](https://github.com/adrg/xdg) ⭐ 866 | 🐛 6 | 🌐 Go | 📅 2025-08-25 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
* [drone](https://github.com/drone/drone) ⭐ 33,128 | 🐛 76 | 🌐 Go | 📅 2025-08-25 - Drone is a Continuous Integration platform built on Docker, written in Go.
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,403 | 🐛 348 | 🌐 Go | 📅 2025-08-26 - Woodpecker is a community fork of the Drone CI system.
* [CDS](https://github.com/ovh/cds) ⭐ 4,753 | 🐛 158 | 🌐 Go | 📅 2025-08-25 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,570 | 🐛 23 | 🌐 Go | 📅 2025-08-19 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,912 | 🐛 99 | 🌐 Rust | 📅 2025-08-26.
...
* [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,432 | 🐛 531 | 🌐 Go | 📅 2025-08-25 - A message streaming bridge between a range of protocols.
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,181 | 🐛 158 | 🌐 Go | 📅 2025-08-25 - A high-performance ELT data integration framework with pluggable architecture.
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,749 | 🐛 69 | 🌐 Go | 📅 2025-08-25 - Go package implementing compressed bitsets.
...
* [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,446 | 🐛 3 | 🌐 Go | 📅 2025-08-18 - Go package implementing bitsets.
...
* [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,648 | 🐛 19 | 🌐 Go | 📅 2025-08-18 - Go package implementing Bloom filters.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 17,100 | 🐛 68 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [gota](https://github.com/kniren/gota) ⭐ 3,228 | 🐛 81 | 🌐 Go | 📅 2023-08-09 - Implementation of dataframes, series, and data wrangling methods for Go.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,968 | 🐛 95 | 🌐 Python | 📅 2025-08-25 - Distributed, Fault-tolerant task queue.
...
* [go-edlib](https://github.com/hbollon/go-edlib) ⭐ 560 | 🐛 0 | 🌐 Go | 📅 2025-08-19 - Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode.
...
* [BigCache](https://github.com/allegro/bigcache) ⭐ 7,916 | 🐛 99 | 🌐 Go | 📅 2025-08-18 - Efficient key/value cache for gigabytes of data.
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,401 | 🐛 7 | 🌐 Go | 📅 2025-08-20 -  A high performance memory-bound Go cache.
...
* [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,133 | 🐛 16 | 🌐 Go | 📅 2025-08-12 - An in-memory cache with item expiration and generics.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 60,072 | 🐛 731 | 🌐 Go | 📅 2025-08-26 - Monitoring system and time series database.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,930 | 🐛 5,227 | 🌐 Go | 📅 2025-08-26 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 36,785 | 🐛 675 | 🌐 Go | 📅 2025-08-26 - Milvus is a vector database for embedding management, analytics and search.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,212 | 🐛 7,601 | 🌐 Go | 📅 2025-08-26 - Scalable, Geo-Replicated, Transactional Datastore.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,528 | 🐛 2,141 | 🌐 Rust | 📅 2025-08-26 - Scalable datastore for metrics, events, and real-time analytics.
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,169 | 🐛 43 | 🌐 Go | 📅 2025-08-26 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
* [dolt](https://github.com/dolthub/dolt) ⭐ 19,009 | 🐛 436 | 🌐 Go | 📅 2025-08-26 - Dolt – It's Git for Data.
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,891 | 🐛 76 | 🌐 Go | 📅 2025-08-26 - The lightweight, distributed, relational database built on SQLite.
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,942 | 🐛 32 | 🌐 Go | 📅 2025-08-20 - Fast key-value store in Go.
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,841 | 🐛 804 | 🌐 Go | 📅 2025-08-26 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,036 | 🐛 43 | 🌐 Go | 📅 2025-08-21 - An embedded key/value database for Go.
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,296 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 38,033 | 🐛 366 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,462 | 🐛 311 | 🌐 Go | 📅 2025-08-26 - RocksDB/LevelDB inspired key-value database in Go.
...
* [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,766 | 🐛 33 | 🌐 Go | 📅 2024-09-10 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
* [redka](https://github.com/nalgeon/redka) ⭐ 4,149 | 🐛 2 | 🌐 Go | 📅 2025-07-14 - Redis re-implemented with SQLite.
...
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,497 | 🐛 69 | 🌐 Go | 📅 2025-08-18 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 17,250 | 🐛 436 | 🌐 Go | 📅 2025-08-24 - Database migrations. CLI and Golang library.
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,916 | 🐛 128 | 🌐 Go | 📅 2025-08-26 - Safe database schema change and version control for DevOps teams.
* [goose](https://github.com/pressly/goose) ⭐ 8,994 | 🐛 102 | 🌐 Go | 📅 2025-08-24 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
* [atlas](https://github.com/ariga/atlas) ⭐ 7,231 | 🐛 226 | 🌐 Go | 📅 2025-08-25 - A Database Toolkit. A CLI designed to help companies better work with their data.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,285 | 🐛 37 | 🌐 Go | 📅 2025-08-25 - A lightweight, framework-agnostic database migration tool.
* [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,363 | 🐛 91 | 🌐 Go | 📅 2025-07-16 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,331 | 🐛 19 | 🌐 Go | 📅 2025-08-21 - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 20,032 | 🐛 881 | 🌐 Go | 📅 2025-08-25 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [onedump](https://github.com/liweiyi88/onedump) ⭐ 219 | 🐛 0 | 🌐 Go | 📅 2025-07-02 - Database backup from different drivers to different destinations with one command and configuration.
...
* [dbbench](https://github.com/sj14/dbbench) ⭐ 110 | 🐛 11 | 🌐 Go | 📅 2025-08-25 - Database benchmarking tool with support for several databases and scripts.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,806 | 🐛 603 | 🌐 Go | 📅 2025-08-25 - Generate type-safe code from SQL.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,340 | 🐛 46 | 🌐 Go | 📅 2025-08-09 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
* [goqu](https://github.com/doug-martin/goqu) ⭐ 2,556 | 🐛 145 | 🌐 Go | 📅 2024-05-22 - Idiomatic SQL builder and query library.
...
* [pgx](https://github.com/jackc/pgx) ⭐ 12,348 | 🐛 240 | 🌐 Go | 📅 2025-08-09 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pq](https://github.com/lib/pq) ⭐ 9,597 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,667 | 🐛 203 | 🌐 C | 📅 2025-08-14 - SQLite3 driver for go that uses database/sql.
* [go-mssqldb](https://github.com/denisenkom/go-mssqldb) ⭐ 1,863 | 🐛 177 | 🌐 Go | 📅 2025-04-26 - Microsoft MSSQL driver for Go.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 764 | 🐛 6 | 🌐 Go | 📅 2025-08-23 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [Sqinn-Go](https://github.com/cvilsmeier/sqinn-go) ⭐ 475 | 🐛 0 | 🌐 Go | 📅 2025-08-21 - SQLite with pure Go.
...
* [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 167 | 🐛 244 | 🌐 Go | 📅 2025-08-22 - native and database/sql driver YDB (Yandex Database)
...
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 1 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,348 | 🐛 240 | 🌐 Go | 📅 2025-08-09 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,456 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,435 | 🐛 85 | 🌐 Go | 📅 2025-08-25 - Redis client for Golang.
...
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,750 | 🐛 14 | 🌐 Go | 📅 2025-08-25 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
* [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) ⭐ 450 | 🐛 37 | 🌐 Go | 📅 2025-08-22 - Aerospike client in Go language.
...
* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,125 | 🐛 88 | 🌐 Go | 📅 2025-08-22 - ClickHouse SQL client for Go with a `database/sql` compatibility.
* [elasticsql](https://github.com/cch123/elasticsql) ⭐ 1,190 | 🐛 13 | 🌐 Go | 📅 2023-08-06 - Convert sql to elasticsearch dsl in Go.
* [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1,061 | 🐛 20 | 🌐 Go | 📅 2025-08-21 - Fast trigram based code search.
...
* [carbon](https://github.com/dromara/carbon) ⭐ 5,116 | 🐛 2 | 🌐 Go | 📅 2025-08-20 - A simple, semantic and developer-friendly time package for golang.
* [now](https://github.com/jinzhu/now) ⭐ 4,561 | 🐛 14 | 🌐 Go | 📅 2025-08-11 - Now is a time toolkit for golang.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,675 | 🐛 342 | 🌐 Go | 📅 2025-08-22 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
...
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,753 | 🐛 126 | 🌐 Go | 📅 2025-08-20 - A modular-designed and easy-to-use microservices framework in Go.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,461 | 🐛 22 | 🌐 Go | 📅 2025-08-19 - A distributed systems development framework.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 22,130 | 🐛 143 | 🌐 Go | 📅 2025-08-25 - The Go language implementation of gRPC. HTTP/2 based RPC.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,861 | 🐛 447 | 🌐 Go | 📅 2025-08-25 - NATS is a simple, secure, and
...
* [raft](https://github.com/hashicorp/raft) ⭐ 8,733 | 🐛 46 | 🌐 Go | 📅 2025-07-06 - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [rpcx](https://github.com/smallnest/rpcx) ⭐ 8,240 | 🐛 8 | 🌐 Go | 📅 2025-08-26 - Distributed pluggable RPC service framework like alibaba Dubbo.
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,623 | 🐛 62 | 🌐 Go | 📅 2025-08-25 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
* [lura](https://github.com/luraproject/lura) ⭐ 6,599 | 🐛 10 | 🌐 Go | 📅 2025-08-25 - Ultra performant API Gateway framework with middlewares.
* [torrent](https://github.com/anacrolix/torrent) ⭐ 5,836 | 🐛 66 | 🌐 Go | 📅 2025-08-22 - BitTorrent client package.
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,226 | 🐛 56 | 🌐 Go | 📅 2025-07-23 - A feature complete and high performance multi-group Raft library in Go.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,755 | 🐛 27 | 🌐 Go | 📅 2025-08-26 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
* [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,626 | 🐛 43 | 🌐 Go | 📅 2024-04-19 - Lightweight, fault-tolerant message streams for NATS.
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,403 | 🐛 33 | 🌐 Go | 📅 2025-08-24 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
* [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,358 | 🐛 25 | 🌐 Go | 📅 2025-07-25 - A Go framework for the API or Microservice with handy scaffolding tools.
* [redis-lock](https://github.com/bsm/redislock) ⭐ 1,670 | 🐛 4 | 🌐 Go | 📅 2025-06-09 - Simplified distributed locking implementation using Redis.
* [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,617 | 🐛 26 | 🌐 Go | 📅 2025-04-16 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,071 | 🐛 89 | 🌐 Go | 📅 2025-08-25 - A cloud native Kubernetes Global Balancer.
...
* [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 1,019 | 🐛 10 | 🌐 Go | 📅 2025-07-11 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
* [raft](https://github.com/etcd-io/raft) ⭐ 897 | 🐛 71 | 🌐 Go | 📅 2025-08-22 - Go implementation of the Raft consensus protocol, by CoreOS.
...
* [consistent](https://github.com/buraksezer/consistent) ⭐ 743 | 🐛 6 | 🌐 Go | 📅 2023-11-07 - Consistent hashing with bounded loads.
* [gorpc](https://github.com/valyala/gorpc) ⭐ 709 | 🐛 14 | 🌐 Go | 📅 2022-10-07 - Simple, fast and scalable RPC library for high load.
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 703 | 🐛 189 | 🌐 Go | 📅 2025-08-19 - Durable execution system for making code fault-tolerant and simple.
* [opentelemetry-go-auto-instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) ⭐ 660 | 🐛 37 | 🌐 Go | 📅 2025-08-26 - OpenTelemetry Compile-Time Instrumentation for Golang.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 383 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,457 | 🐛 360 | 🌐 C++ | 📅 2025-08-08).
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,199 | 🐛 252 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,602 | 🐛 1 | 🌐 Go | 📅 2025-08-26 - Email and SMTP testing tool for developers.
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,649 | 🐛 132 | 🌐 Go | 📅 2025-07-18 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
* [mox](https://github.com/mjl-/mox) ⭐ 5,148 | 🐛 151 | 🌐 Go | 📅 2025-08-21 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,429 | 🐛 34 | 🌐 Go | 📅 2025-08-25 - A Go library for email verification without sending any emails.
...
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 10,122 | 🐛 193 | 🌐 Go | 📅 2025-08-26 - PHP embedded in Go, with a `net/http` handler.
* [expr](https://github.com/antonmedv/expr) ⭐ 7,124 | 🐛 49 | 🌐 Go | 📅 2025-08-12 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,710 | 🐛 102 | 🌐 Go | 📅 2024-11-09 - Lua 5.1 VM and compiler written in Go.
* [goja](https://github.com/dop251/goja) ⭐ 6,392 | 🐛 25 | 🌐 Go | 📅 2025-06-30 - ECMAScript 5.1(+) implementation in Go.
* [tengo](https://github.com/d5/tengo) ⭐ 3,685 | 🐛 86 | 🌐 Go | 📅 2025-05-24 - Bytecode compiled script language for Go.
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,329 | 🐛 50 | 🌐 Go | 📅 2025-07-18 - Port of the Lua 5.2 VM to pure Go.
* [cel-go](https://github.com/google/cel-go) ⭐ 2,651 | 🐛 52 | 🌐 Go | 📅 2025-08-18 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
* [metacall](https://github.com/metacall/core) ⭐ 1,688 | 🐛 56 | 🌐 C | 📅 2025-08-09 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,605 | 🐛 5 | 🌐 Go | 📅 2025-08-26 - The Wa Programming Language embedded in Go.
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,710 | 🐛 102 | 🌐 Go | 📅 2024-11-09.
...
* [starlet](https://github.com/1set/starlet) ⭐ 32 | 🐛 3 | 🌐 Go | 📅 2025-04-15 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,514 | 🐛 64 | 🌐 Go | 📅 2025-08-04 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [oops](https://github.com/samber/oops) ⭐ 735 | 🐛 15 | 🌐 Go | 📅 2025-08-12 - Error handling with context, stack trace and source fragments.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,929 | 🐛 138 | 🌐 Go | 📅 2025-08-18 - PDF processor.
* [afero](https://github.com/spf13/afero) ⭐ 6,333 | 🐛 159 | 🌐 Go | 📅 2025-08-22 - FileSystem Abstraction System for Go.
* [gdu](https://github.com/dundee/gdu) ⭐ 4,714 | 🐛 55 | 🌐 Go | 📅 2025-07-09 - Disk usage analyzer with console interface.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 103 | 🐛 3 | 🌐 Go | 📅 2025-08-20 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 73,196 | 🐛 301 | 🌐 Go | 📅 2025-08-26).
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 | 🐛 1 | 🌐 Go | 📅 2023-09-21 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,948 | 🐛 41 | 📅 2025-07-08.
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,478 | 🐛 35 | 🌐 Go | 📅 2025-08-03 - Terminal stock watcher and stock position tracker.
* [go-money](https://github.com/rhymond/go-money) ⭐ 1,796 | 🐛 25 | 🌐 Go | 📅 2025-04-30 - Implementation of Fowler's Money pattern.
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,511 | 🐛 140 | 🌐 Go | 📅 2025-08-25 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
* [ledger](https://github.com/formancehq/ledger) ⭐ 1,021 | 🐛 11 | 🌐 Go | 📅 2025-08-25 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [ach](https://github.com/moov-io/ach) ⭐ 505 | 🐛 22 | 🌐 Go | 📅 2025-08-25 - A reader, writer, and validator for Automated Clearing House (ACH) files.
...
* [nosurf](https://github.com/justinas/nosurf) ⭐ 1,693 | 🐛 15 | 🌐 Go | 📅 2025-05-13 - CSRF protection middleware for Go.
...
* [httpin](https://github.com/ggicci/httpin) ⭐ 371 | 🐛 11 | 🌐 Go | 📅 2025-08-20 - Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc.
...
* [mo](https://github.com/samber/mo) ⭐ 3,075 | 🐛 17 | 🌐 Go | 📅 2025-08-18 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,365 | 🐛 297 | 🌐 Go | 📅 2025-08-25 - dead simple 2D game engine in Go.
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,146 | 🐛 6 | 🌐 C | 📅 2025-08-07 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
* [Ark](https://github.com/mlange-42/ark) ⭐ 103 | 🐛 11 | 🌐 Go | 📅 2025-08-25 - Archetype-based Entity Component System (ECS) for Go.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,514 | 🐛 714 | 🌐 Go | 📅 2025-08-20 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,460 | 🐛 152 | 🌐 Go | 📅 2025-08-26 - Geolocation DB with spatial index and realtime geofencing.
...
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 13,002 | 🐛 192 | 🌐 Go | 📅 2025-08-19 - Compiler from Go to JavaScript.
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,500 | 🐛 14 | 🌐 Go | 📅 2025-08-25 - Compile shell scripts to Go.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,922 | 🐛 0 | 🌐 Go | 📅 2025-08-08 - A high-performance and low-cost goroutine pool in Go.
...
* [async](https://github.com/reugn/async) ⭐ 266 | 🐛 0 | 🌐 Go | 📅 2025-07-05 - An alternative sync library for Go (Future, Promise, Locks).
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,988 | 🐛 748 | 🌐 Go | 📅 2025-08-25 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
* [webview](https://github.com/zserge/webview) ⭐ 13,299 | 🐛 192 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,755 | 🐛 45 | 🌐 Go | 📅 2025-08-02 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
...
* [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,297 | 🐛 39 | 🌐 Go | 📅 2025-03-08 - Build native macOS applications using Go.
...
* [gotk3](https://github.com/gotk3/gotk3) ⭐ 2,182 | 🐛 120 | 🌐 Go | 📅 2024-08-08 - Go bindings for GTK3.
...
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 443 | 🐛 20 | 🌐 C++ | 📅 2025-08-23 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 67,797 | 🐛 1,183 | 🌐 C++ | 📅 2025-08-20 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,710 | 🐛 17 | 🌐 Lua | 📅 2025-07-14.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,631 | 🐛 225 | 🌐 Go | 📅 2025-08-26 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,194 | 🐛 339 | 🌐 Go | 📅 2025-08-06 - Go package for computer vision using OpenCV 3.3+.
...
* [gg](https://github.com/fogleman/gg) ⭐ 4,651 | 🐛 94 | 🌐 Go | 📅 2023-12-14 - 2D rendering in pure Go.
...
* [imagor](https://github.com/cshum/imagor) ⭐ 3,720 | 🐛 39 | 🌐 Go | 📅 2025-08-25 - Fast, secure image processing server and Go library, using libvips.
* [ln](https://github.com/fogleman/ln) ⭐ 3,336 | 🐛 12 | 🌐 Go | 📅 2019-07-19 - 3D line art rendering in Go.
* [bimg](https://github.com/h2non/bimg) ⭐ 2,899 | 🐛 177 | 🌐 Go | 📅 2025-01-23 - Small package for fast and efficient image processing using libvips.
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,278 | 🐛 91 | 🌐 Go | 📅 2025-08-23 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
* [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,364 | 🐛 30 | 🌐 Go | 📅 2025-08-19 - Kubernetes native IoT development framework.
* [rulego](https://github.com/rulego/rulego) ⭐ 1,251 | 🐛 8 | 🌐 Go | 📅 2025-08-25 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,485 | 🐛 18 | 🌐 Go | 📅 2025-08-14 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,497 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,145 | 🐛 91 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,446 | 🐛 74 | 🌐 Go | 📅 2025-08-04 - Structured logger for Go.
* [zap](https://github.com/uber-go/zap) ⭐ 23,543 | 🐛 166 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,751 | 🐛 144 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,301 | 🐛 65 | 🌐 Go | 📅 2024-04-06 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
* [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 987 | 🐛 42 | 🌐 Go | 📅 2025-08-25 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
* [phuslu/log](https://github.com/phuslu/log) ⭐ 790 | 🐛 7 | 🌐 Go | 📅 2025-08-17 - High performance structured logging.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 656 | 🐛 3 | 🌐 Go | 📅 2025-05-29 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,446 | 🐛 74 | 🌐 Go | 📅 2025-08-04, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,256 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,543 | 🐛 166 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,751 | 🐛 144 | 🌐 Go | 📅 2025-04-18, etc).
...
* [logrusly](https://github.com/sebest/logrusly) ⭐ 29 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,446 | 🐛 74 | 🌐 Go | 📅 2025-08-04 plug-in to send errors to a [Loggly](https://www.loggly.com/).
...
* [kemba](https://github.com/clok/kemba) ⭐ 16 | 🐛 6 | 🌐 Go | 📅 2025-08-24 - A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug) ⭐ 11,313 | 🐛 79 | 🌐 JavaScript | 📅 2025-05-13, great for CLI tools and applications.
* [log](https://github.com/heartwilltell/log) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2022-12-06 - Simple leveled logging wrapper around standard log package.
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,446 | 🐛 74 | 🌐 Go | 📅 2025-08-04 logger.
...
* [go-log](https://github.com/pieterclaerhout/go-log) ⭐ 11 | 🐛 1 | 🌐 Go | 📅 2025-08-26 - A logging library with stack traces, object dumping and optional timestamps.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,827 | 🐛 112 | 🌐 Go | 📅 2024-08-12 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 868 | 🐛 1 | 🌐 Go | 📅 2025-08-25 - An accelerated Machine Learning framework for Go.
...
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 443 | 🐛 8 | 🌐 Go | 📅 2025-08-24 - Huggingface transformer pipelines for golang with onnxruntime.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,169 | 🐛 49 | 🌐 Go | 📅 2025-08-25 - Go library for Apache Kafka.
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,875 | 🐛 253 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,235 | 🐛 25 | 🌐 Go | 📅 2025-08-25 - Real-time messaging (Websockets or SockJS) server in Go.
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,790 | 🐛 89 | 🌐 Go | 📅 2025-08-25 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,480 | 🐛 58 | 🌐 Go | 📅 2025-08-24 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,117 | 🐛 32 | 🌐 Go | 📅 2025-07-22 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,104 | 🐛 156 | 🌐 Go | 📅 2025-08-22 - Go client for the NATS
  messaging system.
...
* [Mercure](https://github.com/dunglas/mercure) ⭐ 5,029 | 🐛 14 | 🌐 Go | 📅 2025-08-25 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,985 | 🐛 289 | 🌐 HTML | 📅 2025-08-26 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
* [melody](https://github.com/olahol/melody) ⭐ 3,984 | 🐛 14 | 🌐 Go | 📅 2025-06-08 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
...
* [Quamina](https://github.com/timbray/quamina) ⭐ 433 | 🐛 15 | 🌐 Go | 📅 2025-08-22 - Fast pattern-matching for filtering messages and events.
...
* [excelize](https://github.com/xuri/excelize) ⭐ 19,544 | 🐛 134 | 🌐 Go | 📅 2025-08-19 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [fx](https://github.com/uber-go/fx) ⭐ 6,811 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
* [dig](https://github.com/uber-go/dig) ⭐ 4,281 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [do](https://github.com/samber/do) ⭐ 2,259 | 🐛 35 | 🌐 Go | 📅 2025-08-25 - A dependency injection framework based on Generics.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,594 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,594 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 8,065 | 🐛 29 | 🌐 Go | 📅 2025-07-19 - Allows users to spin up a quick Go project using a popular framework.
* [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,858 | 🐛 1 | 🌐 Go | 📅 2025-08-20 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,858 | 🐛 1 | 🌐 Go | 📅 2025-08-20 for building production grade scalable web service applications.
...
* [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,815 | 🐛 3 | 🌐 Go | 📅 2025-08-15 - Rapid, easy full-stack web development starter kit built in Go.
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,364 | 🐛 1 | 🌐 Go | 📅 2025-08-25 - Nunu is a scaffolding tool for building Go applications.
...
* [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,167 | 🐛 12 | 🌐 Go | 📅 2025-07-25 - cross-platform, cli app to perform various operations on string.
...
* [bexp](https://github.com/happy-sdk/happy/tree/main/pkg/strings/bexp) ⭐ 21 | 🐛 0 | 🌐 Go | 📅 2025-08-25 - Go implementation of Brace Expansion mechanism to generate arbitrary strings.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,404 | 🐛 223 | 🌐 Go | 📅 2025-08-25 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 8,011 | 🐛 218 | 🌐 Go | 📅 2025-08-25 - Automated service health dashboard.
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 5,134 | 🐛 13 | 🌐 Go | 📅 2025-08-19 - Random data generator written in go.
* [go-resiliency](https://github.com/eapache/go-resiliency) ⭐ 2,308 | 🐛 2 | 🌐 Go | 📅 2025-02-23 - Resiliency patterns for golang.
* [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,286 | 🐛 6 | 🌐 Go | 📅 2025-06-25 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
* [gosms](https://github.com/haxpax/gosms) ⭐ 1,468 | 🐛 5 | 🌐 Go | 📅 2021-02-05 - Your own local SMS gateway in Go that can be used to send SMS.
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,322 | 🐛 85 | 🌐 Go | 📅 2024-07-26 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
* [xz](https://github.com/ulikunitz/xz) ⭐ 522 | 🐛 17 | 🌐 Go | 📅 2025-08-24 - Pure golang package for reading and writing xz-compressed files.
...
* [archives](https://github.com/mholt/archives) ⭐ 296 | 🐛 4 | 🌐 Go | 📅 2025-08-25 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [govader](https://github.com/jonreiter/govader) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2025-04-29 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,796 | 🐛 55 | 🌐 Python | 📅 2024-03-16.
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,558 | 🐛 16 | 🌐 Go | 📅 2025-06-06 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,345 | 🐛 689 | 🌐 Python | 📅 2024-08-21 which a Chinese word splitting algorithm.
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,336 | 🐛 15 | 🌐 Go | 📅 2025-08-01 - Package and an accompanying tool to work with localized text.
...
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,220 | 🐛 104 | 🌐 Go | 📅 2025-08-25 - A pure Go implementation of the WebRTC API.
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,214 | 🐛 133 | 🌐 Go | 📅 2025-08-13 - Extremely simple & fast udp tunnel based on KCP protocol.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 11,360 | 🐛 454 | 🌐 Go | 📅 2025-08-21 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,928 | 🐛 189 | 🌐 Go | 📅 2025-08-25 - An implementation of the QUIC protocol in pure Go.
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,752 | 🐛 4 | 🌐 Go | 📅 2025-08-10 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
* [dns](https://github.com/miekg/dns) ⭐ 8,475 | 🐛 3 | 🌐 Go | 📅 2025-08-18 - Go library for working with DNS.
* [gopacket](https://github.com/google/gopacket) ⭐ 6,601 | 🐛 359 | 🌐 Go | 📅 2025-03-19 - Go library for packet processing with libpcap bindings.
* [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,458 | 🐛 89 | 🌐 Go | 📅 2025-08-12 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,305 | 🐛 65 | 🌐 Go | 📅 2025-07-31 - KCP - Fast and Reliable ARQ Protocol.
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 4,115 | 🐛 14 | 🌐 Go | 📅 2025-08-10 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 3,866 | 🐛 235 | 🌐 Go | 📅 2025-08-23 - BGP implemented in the Go Programming Language.
* [fortio](https://github.com/fortio/fortio) ⭐ 3,592 | 🐛 83 | 🌐 Go | 📅 2025-08-20 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
* [nodepass](https://github.com/yosebyte/nodepass) ⭐ 1,242 | 🐛 2 | 🌐 Go | 📅 2025-07-29 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
* [go-powerdns](https://github.com/joeig/go-powerdns) ⭐ 97 | 🐛 2 | 🌐 Go | 📅 2025-08-26 - PowerDNS API bindings for Golang.
...
* [bart](https://github.com/gaissmai/bart) ⭐ 88 | 🐛 2 | 🌐 Go | 📅 2025-08-24 - Package bart provides a fast routing table algorithm.
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,163 | 🐛 46 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [grequests](https://github.com/levigross/grequests) ⭐ 2,168 | 🐛 24 | 🌐 Go | 📅 2025-06-06 - A Go "clone" of the great and famous Requests library.
...
* [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,234 | 🐛 37 | 🌐 Go | 📅 2025-07-31 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
* [go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) ⭐ 408 | 🐛 6 | 🌐 Go | 📅 2025-08-25 - Get easily stdlib HTTP client, which does not share any state with other clients.
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 320 | 🐛 8 | 🌐 Go | 📅 2025-08-25 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,755 | 🐛 478 | 🌐 Go | 📅 2025-08-20 - The fantastic ORM library for Golang, aims to be developer friendly.
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,917 | 🐛 105 | 🌐 Go | 📅 2025-08-08 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
* [bun](https://github.com/uptrace/bun) ⭐ 4,333 | 🐛 25 | 🌐 Go | 📅 2025-08-24 - SQL-first Golang ORM. Successor of go-pg.
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,590 | 🐛 4 | 🌐 Go | 📅 2025-08-11 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,428 | 🐛 14 | 🌐 Go | 📅 2025-08-19 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
* [rel](https://github.com/go-rel/rel) ⭐ 781 | 🐛 34 | 🌐 Go | 📅 2024-12-02 - Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API.
...
* [CQL](https://github.com/FrancoLiberali/cql) ⭐ 16 | 🐛 13 | 🌐 Go | 📅 2025-08-26 - Built on top of GORM, adds compile-time verified queries based on auto-generated code.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,523 | 🐛 480 | 🌐 Go | 📅 2025-08-26 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [gup](https://github.com/nao1215/gup) ⭐ 443 | 🐛 4 | 🌐 Go | 📅 2025-08-16 - Update binaries installed by "go install".
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,775 | 🐛 313 | 🌐 Go | 📅 2025-08-25 - A distributed tracing system.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,139 | 🐛 346 | 🌐 C++ | 📅 2025-08-13 - No instrumentation tracing for Golang applications via eBPF.
* [statsviz](https://github.com/arl/statsviz) ⭐ 3,458 | 🐛 9 | 🌐 Go | 📅 2025-08-08 - Live visualization of your Go application runtime statistics.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,447 | 🐛 380 | 🌐 Go | 📅 2025-08-25 - go generate based graphql server library.
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,099 | 🐛 238 | 🌐 Go | 📅 2025-07-28 - Implementation of GraphQL for Go.
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,536 | 🐛 49 | 🌐 Go | 📅 2025-08-26 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
* [graphql](https://github.com/neelance/graphql-go) ⭐ 4,713 | 🐛 19 | 🌐 Go | 📅 2025-08-24 - GraphQL server with a focus on ease of use.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,127 | 🐛 251 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [gograph](https://github.com/hmdsefi/gograph) ⭐ 89 | 🐛 4 | 🌐 Go | 📅 2025-08-25 - A golang generic graph library that provides mathematical graph-theory and algorithms.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,541 | 🐛 49 | 🌐 Go | 📅 2025-08-18 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
* [lego](https://github.com/go-acme/lego) ⭐ 8,823 | 🐛 158 | 🌐 Go | 📅 2025-08-24 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,660 | 🐛 28 | 🌐 Go | 📅 2025-07-13 - Tool and library to remotely hack RTSP streams from surveillance cameras.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,870 | 🐛 92 | 🌐 Go | 📅 2025-08-22 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [booster](https://github.com/anatol/booster) ⭐ 585 | 🐛 77 | 🌐 Go | 📅 2025-07-12 - Fast initramfs generator with full-disk encryption support.
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 66,386 | 🐛 216 | 🌐 Go | 📅 2025-08-25 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
* [minio](https://github.com/minio/minio) ⭐ 54,809 | 🐛 55 | 🌐 Go | 📅 2025-08-22 - Minio is a distributed object storage server.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 50,145 | 🐛 282 | 🌐 Go | 📅 2025-08-25 - Highly-available key value store for shared configuration and service discovery.
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 50,077 | 🐛 21 | 🌐 Go | 📅 2025-08-23 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,898 | 🐛 121 | 🌐 Go | 📅 2025-08-22 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,228 | 🐛 84 | 🌐 Go | 📅 2025-08-21 - High-performance PHP application server, load-balancer and process manager.
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,848 | 🐛 7 | 🌐 Go | 📅 2025-08-25 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,531 | 🐛 51 | 🌐 Go | 📅 2025-08-26 - A self contained feature flag solution written in Go and Vue.js
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,339 | 🐛 15 | 🌐 Go | 📅 2025-08-18 - Make SSH apps, just like that!
* [Fider](https://github.com/getfider/fider) ⭐ 3,730 | 🐛 48 | 🌐 Go | 📅 2025-08-20 - Fider is an open platform to collect and organize customer feedback.
...
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,514 | 🐛 8 | 🌐 Go | 📅 2025-08-19 - Flagr is an open-source feature flagging and A/B testing service.
...
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,722 | 🐛 29 | 🌐 Go | 📅 2025-08-25 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,612 | 🐛 61 | 🌐 Go | 📅 2025-08-18 - A HTML templating language that has great developer tooling.
...
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,512 | 🐛 56 | 🌐 Go | 📅 2025-03-21 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 25,064 | 🐛 372 | 🌐 Go | 📅 2025-08-25 - Sacred extension to the standard go testing package.
* [keploy](https://github.com/keploy/keploy) ⭐ 10,347 | 🐛 264 | 🌐 Go | 📅 2025-08-25 - Generate Testcase and Data Mocks from API calls automatically.
* [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,382 | 🐛 167 | 🌐 Go | 📅 2024-07-30 - BDD-style framework with web UI and live reload.
* [go-cmp](https://github.com/google/go-cmp) ⭐ 4,493 | 🐛 49 | 🌐 Go | 📅 2025-02-21 - Package for comparing Go values in tests.
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,290 | 🐛 156 | 🌐 Go | 📅 2025-08-25 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [godog](https://github.com/cucumber/godog) ⭐ 2,488 | 🐛 83 | 🌐 Go | 📅 2025-08-24 - Cucumber BDD framework for Go.
* [is](https://github.com/matryer/is) ⭐ 1,919 | 🐛 7 | 🌐 Go | 📅 2024-02-08 - Professional lightweight testing mini-framework for Go.
* [gnomock](https://github.com/orlangure/gnomock) ⭐ 1,463 | 🐛 30 | 🌐 Go | 📅 2025-08-25 - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
* [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,322 | 🐛 2 | 🌐 Go | 📅 2025-08-25 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
* [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 1,006 | 🐛 6 | 🌐 Go | 📅 2025-08-04 - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
* [arch-go](https://github.com/arch-go/arch-go) ⭐ 219 | 🐛 23 | 🌐 Go | 📅 2025-08-21 - Architecture testing tool for Go projects.
...
* [be](https://github.com/carlmjohnson/be) ⭐ 119 | 🐛 1 | 🌐 Go | 📅 2025-08-15 - The minimalist generic test assertion library.
...
* [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2025-08-24 - HTTP client testing framework.
...
* [gomock](https://github.com/uber-go/mock) ⭐ 2,997 | 🐛 100 | 🌐 Go | 📅 2025-08-18 - Mocking framework for the Go programming language.
...
* [moq](https://github.com/matryer/moq) ⭐ 2,120 | 🐛 27 | 🌐 Go | 📅 2025-02-13 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
...
* [minimock](https://github.com/gojuno/minimock) ⭐ 724 | 🐛 11 | 🌐 Go | 📅 2025-08-24 - Mock generator for Go interfaces.
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 516 | 🐛 2 | 🌐 Go | 📅 2025-08-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,348 | 🐛 240 | 🌐 Go | 📅 2025-08-09.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,178 | 🐛 149 | 🌐 Go | 📅 2025-08-05 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
* [rod](https://github.com/go-rod/rod) ⭐ 6,188 | 🐛 192 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,870 | 🐛 56 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
...
* [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,624 | 🐛 45 | 🌐 Go | 📅 2025-08-12 - Formatters for time, numbers, and memory size to human readable format.
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,790 | 🐛 21 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,279 | 🐛 12 | 🌐 Go | 📅 2025-07-22 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,012 | 🐛 13 | 🌐 Go | 📅 2025-08-24 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
* [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,846 | 🐛 32 | 🌐 Go | 📅 2025-08-26 - Go library for the TOML format with query support and handy cli tools.
...
* [sh](https://github.com/mvdan/sh) ⭐ 8,011 | 🐛 96 | 🌐 Go | 📅 2025-08-18 - Shell parser and formatter.
* [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,739 | 🐛 53 | 🌐 Go | 📅 2025-05-27 - Parse RSS and Atom feeds in Go.
...
* [godump](https://github.com/yassinebenaid/godump) ⭐ 220 | 🐛 3 | 🌐 Go | 📅 2025-08-21 - Pretty print any GO variable with ease, an alternative to Go's `fmt.Printf("%#v")`.
* [editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) ⭐ 147 | 🐛 6 | 🌐 Go | 📅 2025-08-25 - Editorconfig file parser and manipulator for Go.
...
* [colly](https://github.com/asciimoo/colly) ⭐ 24,573 | 🐛 191 | 🌐 Go | 📅 2025-08-21 - Fast and Elegant Scraping Framework for Gophers.
...
* [github](https://github.com/google/go-github) ⭐ 10,917 | 🐛 51 | 🌐 Go | 📅 2025-08-18 - Go library for accessing the GitHub REST API v3.
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,266 | 🐛 214 | 🌐 Go | 📅 2025-08-12 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,536 | 🐛 199 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
* [slack](https://github.com/slack-go/slack) ⭐ 4,828 | 🐛 107 | 🌐 Go | 📅 2025-08-25 - Slack API in Go.
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,316 | 🐛 369 | 🌐 Go | 📅 2025-08-26 - Google Cloud APIs Go Client Library.
* [google](https://github.com/google/google-api-go-client) ⭐ 4,315 | 🐛 17 | 🌐 Go | 📅 2025-08-25 - Auto-generated Google APIs for Go.
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,222 | 🐛 87 | 🌐 Go | 📅 2025-08-25 - The official AWS SDK for the Go programming language.
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,786 | 🐛 21 | 🌐 Go | 📅 2025-08-21 - Minio Go Library for Amazon S3 compatible cloud storage.
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,381 | 🐛 13 | 🌐 Go | 📅 2025-08-26 - Go client for the Stripe API.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 73,196 | 🐛 301 | 🌐 Go | 📅 2025-08-26 - Command-line fuzzy finder written in Go.
* [dive](https://github.com/wagoodman/dive) ⭐ 51,821 | 🐛 177 | 🌐 Go | 📅 2025-08-21 - A tool for exploring each layer in a Docker image.
* [hub](https://github.com/github/hub) ⭐ 22,917 | 🐛 293 | 🌐 Go | 📅 2024-02-02 - wrap git commands with additional functionality to interact with github from the terminal.
* [lo](https://github.com/samber/lo) ⭐ 20,042 | 🐛 208 | 🌐 Go | 📅 2025-08-25 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,149 | 🐛 382 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,797 | 🐛 115 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 15,052 | 🐛 25 | 🌐 Go | 📅 2025-08-26 - Deliver Go binaries as fast and easily as possible.
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,677 | 🐛 46 | 🌐 Go | 📅 2025-05-06 - Interactive cli tool for HTTP inspection.
* [usql](https://github.com/knq/usql) ⭐ 9,501 | 🐛 94 | 🌐 Go | 📅 2025-08-23 - usql is a universal command-line interface for SQL databases.
* [peco](https://github.com/peco/peco) ⭐ 7,781 | 🐛 52 | 🌐 Go | 📅 2025-06-21 - Simplistic interactive filtering tool.
* [lancet](https://github.com/duke-git/lancet) ⭐ 5,169 | 🐛 8 | 🌐 Go | 📅 2025-08-21 - A comprehensive, efficient, and reusable util function library of go.
...
* [minify](https://github.com/tdewolff/minify) ⭐ 3,943 | 🐛 32 | 🌐 Go | 📅 2025-08-20 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
* [panicparse](https://github.com/maruel/panicparse) ⭐ 3,688 | 🐛 3 | 🌐 Go | 📅 2025-03-13 - Groups similar goroutines and colorizes stack dump.
* [mc](https://github.com/minio/mc) ⭐ 3,148 | 🐛 33 | 🌐 Go | 📅 2025-08-13 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 1,843 | 🐛 38 | 🌐 Go | 📅 2025-08-25 - Package for MIME type detection based on magic numbers.
...
* [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,233 | 🐛 57 | 🌐 Go | 📅 2025-08-05 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
* [upterm](https://github.com/owenthereal/upterm) ⭐ 965 | 🐛 60 | 🌐 Go | 📅 2025-08-21 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
...
* [scan](https://github.com/blockloop/scan) ⭐ 600 | 🐛 2 | 🌐 Go | 📅 2025-08-25 - Scan golang `sql.Rows` directly to structs, slices, or primitive types.
...
* [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 386 | 🐛 34 | 🌐 Go | 📅 2025-08-19 - Cross Platform tool to validate configuration files.
...
* [rospo](https://github.com/ferama/rospo) ⭐ 343 | 🐛 8 | 🌐 Go | 📅 2025-08-25 - Simple and reliable ssh tunnels with embedded ssh server in Golang.
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,830 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,905 | 🐛 321 | 🌐 Go | 📅 2025-08-15 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
* [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,178 | 🐛 167 | 🌐 Go | 📅 2025-01-22 - Validators and sanitizers for strings, numerics, slices and structs.
...
* [validate](https://github.com/gookit/validate) ⭐ 1,108 | 🐛 32 | 🌐 Go | 📅 2025-08-21 - Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features.
* [Zog](https://github.com/Oudwins/zog) ⭐ 951 | 🐛 8 | 🌐 Go | 📅 2025-08-24 - A [Zod](https://github.com/colinhacks/zod) ⭐ 39,684 | 🐛 255 | 🌐 TypeScript | 📅 2025-08-26 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,802 | 🐛 177 | 🌐 Go | 📅 2025-08-25 - highly extensible Git implementation in pure Go.
...
* [froggit-go](https://github.com/jfrog/froggit-go) ⭐ 48 | 🐛 9 | 🌐 Go | 📅 2025-08-19 - Froggit-Go is a Go library, allowing to perform actions on VCS providers.
...
* [go-astisub](https://github.com/asticode/go-astisub) ⭐ 653 | 🐛 6 | 🌐 Go | 📅 2025-03-01 - Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).
...
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 548 | 🐛 1 | 🌐 Go | 📅 2025-08-23 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,717 | 🐛 874 | 🌐 Go | 📅 2025-08-12 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,477 | 🐛 86 | 🌐 Go | 📅 2025-08-26 - An Express.js inspired web framework build on Fasthttp.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,448 | 🐛 109 | 🌐 Go | 📅 2025-08-25 - High performance, minimalist Go web framework.
* [Revel](https://github.com/revel/revel) ⭐ 13,222 | 🐛 99 | 🌐 Go | 📅 2023-10-28 - High-productivity web framework for the Go language.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,653 | 🐛 224 | 🌐 Go | 📅 2025-08-23 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 12,549 | 🐛 87 | 🌐 Go | 📅 2025-08-25 - Gofr is an opinionated microservice development framework.
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,655 | 🐛 41 | 🌐 Go | 📅 2025-08-25 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
* [goravel](https://github.com/goravel/goravel) ⭐ 3,989 | 🐛 55 | 🌐 Go | 📅 2025-08-23 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,343 | 🐛 136 | 🌐 Go | 📅 2025-08-05 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,491 | 🐛 39 | 🌐 Go | 📅 2025-08-25 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
...
* [templui](https://github.com/axzilla/templui) ⭐ 886 | 🐛 4 | 🌐 JavaScript | 📅 2025-08-25 - Modern UI Components for Go & Templ.
...
* [iWF](https://github.com/indeedeng/iwf) ⭐ 589 | 🐛 76 | 🌐 Go | 📅 2025-08-26 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
* [Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) ⭐ 576 | 🐛 27 | 🌐 Go | 📅 2025-08-22 - Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications.
...
* [chi](https://github.com/go-chi/chi) ⭐ 20,386 | 🐛 86 | 🌐 Go | 📅 2025-08-15 - Small, fast and expressive HTTP router built on net/context.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,607 | 🐛 529 | 🌐 Go | 📅 2025-08-23 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [Extism Go SDK](https://github.com/extism/go-sdk) ⭐ 133 | 🐛 5 | 🌐 Go | 📅 2025-05-14 - Universal, cross-language WebAssembly framework for building plug-in systems and polyglot apps.
...
* [webhook](https://github.com/adnanh/webhook) ⭐ 11,165 | 🐛 116 | 🌐 Go | 📅 2025-08-11 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
* [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 239 | 🐛 16 | 🌐 Go | 📅 2025-08-25 - A webhooks gateway for message receiving, processing, and reliable delivering.
...
* [go-ole](https://github.com/go-ole/go-ole) ⭐ 1,261 | 🐛 7 | 🌐 Go | 📅 2025-04-21 - Win32 OLE implementation for golang.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,546 | 🐛 112 | 🌐 Go | 📅 2025-08-25 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
* [workflow](https://github.com/luno/workflow) ⭐ 184 | 🐛 6 | 🌐 Go | 📅 2025-08-24 - A tech stack agnostic Event Driven Workflow framework.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,159 | 🐛 265 | 🌐 Go | 📅 2025-08-21 - Container Signing, Verification and Storage in an OCI registry.
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,531 | 🐛 256 | 🌐 Go | 📅 2025-08-25 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 111 | 🐛 20 | 🌐 Go | 📅 2025-08-25 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
* [Spire](https://github.com/spiffe/spire) ⭐ 2,031 | 🐛 153 | 🌐 Go | 📅 2025-08-25 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [Spiffe-Vault](https://github.com/philips-labs/spiffe-vault) ⭐ 92 | 🐛 4 | 🌐 Go | 📅 2025-08-26 - Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication.

## Code Analysis

*Source code analysis tools, also known as Static Application Security Testing (SAST) Tools.*

* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,554 | 🐛 114 | 🌐 Go | 📅 2025-08-24 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
* [revive](https://github.com/mgechev/revive) ⭐ 5,271 | 🐛 69 | 🌐 Go | 📅 2025-08-24 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,042 | 🐛 43 | 🌐 Go | 📅 2025-08-05 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
* [vacuum](https://github.com/daveshanley/vacuum) ⭐ 821 | 🐛 70 | 🌐 Go | 📅 2025-08-25 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 150 | 🐛 39 | 🌐 Go | 📅 2025-08-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 25,064 | 🐛 372 | 🌐 Go | 📅 2025-08-25.
...
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,106 | 🐛 430 | 🌐 TypeScript | 📅 2025-08-21 - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,818 | 🐛 614 | 🌐 Go | 📅 2025-08-21 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,657 | 🐛 10 | 🌐 Go | 📅 2025-08-25 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 117,061 | 🐛 2,633 | 🌐 Go | 📅 2025-08-21 - Container Cluster Manager from Google.
* [Moby](https://github.com/moby/moby) ⭐ 70,537 | 🐛 3,670 | 🌐 Go | 📅 2025-08-25 - Collaborative project for the container ecosystem to assemble container-based systems.
* [traefik](https://github.com/containous/traefik) ⭐ 56,209 | 🐛 668 | 🌐 Go | 📅 2025-08-25 - Reverse proxy and load balancer with support for multiple backends.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 50,311 | 🐛 2,790 | 🌐 Go | 📅 2025-08-26 - Fork of Gogs, entirely community driven.
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,856 | 🐛 547 | 🌐 Go | 📅 2025-08-25 - Run Kubernetes locally.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,591 | 🐛 138 | 🌐 Go | 📅 2025-08-25 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,586 | 🐛 757 | 🌐 Go | 📅 2025-08-26 - A modern load testing tool, using Go and JavaScript.
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,478 | 🐛 96 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
* [Hey](https://github.com/rakyll/hey) ⭐ 19,196 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,440 | 🐛 297 | 🌐 Go | 📅 2025-08-26 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,469 | 🐛 215 | 🌐 Go | 📅 2025-08-25 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,477 | 🐛 142 | 🌐 Go | 📅 2025-08-24 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,185 | 🐛 217 | 🌐 Shell | 📅 2024-08-08 - GVM provides an interface to manage Go versions.
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,218 | 🐛 27 | 🌐 Go | 📅 2025-08-25 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,484 | 🐛 16 | 🌐 Go | 📅 2025-03-13 - High-performance load testing tool, written in Golang.
* [ko](https://github.com/google/ko) ⭐ 8,107 | 🐛 53 | 🌐 Go | 📅 2025-08-25 - Command line tool for building and deploying Go applications on Kubernetes
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,821 | 🐛 552 | 🌐 Go | 📅 2025-08-25 - Cloud native application delivery.
...
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,478 | 🐛 18 | 🌐 Go | 📅 2025-03-25 - Fast cross-platform HTTP benchmarking tool.
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,974 | 🐛 253 | 🌐 Go | 📅 2025-08-25 - Little helper to run CNCF's k3s in Docker.
...
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,441 | 🐛 2,700 | 🌐 Go | 📅 2025-08-26 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,233 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [tau](https://github.com/taubyte/tau) ⭐ 4,430 | 🐛 36 | 🌐 Go | 📅 2025-08-25 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,421 | 🐛 140 | 🌐 Go | 📅 2025-08-26 - Pomerium is an identity-aware access proxy.
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,534 | 🐛 148 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [bosun](https://github.com/bosun-monitor/bosun) ⚠️ Archived - Time Series Alerting Framework.
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,792 | 🐛 147 | 🌐 Go | 📅 2025-08-26 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
...
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,209 | 🐛 122 | 🌐 Go | 📅 2025-08-26 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,202 | 🐛 0 | 🌐 Go | 📅 2025-08-24 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
* [KusionStack](https://github.com/KusionStack/kusion) ⭐ 1,165 | 🐛 50 | 🌐 Go | 📅 2025-08-20 - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
...
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 930 | 🐛 205 | 🌐 Go | 📅 2025-08-25 - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [croc](https://github.com/schollz/croc) ⭐ 30,904 | 🐛 12 | 🌐 Go | 📅 2025-08-25 - Easily and securely send files or folders from one computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,787 | 🐛 492 | 🌐 Go | 📅 2025-08-07 - De-duplicating backup program.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,603 | 🐛 609 | 🌐 Go | 📅 2025-08-26 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 12,066 | 🐛 152 | 🌐 Go | 📅 2025-08-25 - Distributed POSIX file system built on top of Redis and AWS S3.
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,438 | 🐛 92 | 🌐 Go | 📅 2025-08-25 - Proxy to simulate network and system conditions for automated tests.
...
* [scc](https://github.com/boyter/scc) ⭐ 7,587 | 🐛 54 | 🌐 Go | 📅 2025-08-23 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,573 | 🐛 70 | 🌐 Go | 📅 2025-08-25 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,213 | 🐛 33 | 🌐 Go | 📅 2025-08-09 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
* [sonic](https://github.com/go-sonic/sonic) ⭐ 2,102 | 🐛 2 | 🌐 Go | 📅 2024-05-10 - Sonic is a Go Blogging Platform. Simple and Powerful.
...
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,688 | 🐛 28 | 🌐 Go | 📅 2024-08-20 - Portal is a quick and easy command-line file transfer utility from any computer to another.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 613 | 🐛 7 | 🌐 Go | 📅 2025-08-25 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [go\_serialization\_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) ⭐ 1,603 | 🐛 8 | 🌐 Go | 📅 2025-07-04 - Benchmarks of Go serialization methods.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,433 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 461 | 🐛 0 | 🌐 Go | 📅 2025-08-17 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,212 | 🐛 7,601 | 🌐 Go | 📅 2025-08-26
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,772 | 🐛 27 | 🌐 Makefile | 📅 2025-08-18
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,244 | 🐛 184 | 🌐 Go | 📅 2025-08-25
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 129,579 | 🐛 9,512 | 🌐 Go | 📅 2025-08-26 - List of projects on the Go community wiki.
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 39,561 | 🐛 8 | 📅 2025-07-30 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,780 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,799 | 🐛 66 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 23,085 | 🐛 68 | 🌐 Go | 📅 2025-08-21 - Learn Go with test-driven development.
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,452 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,694 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 7,033 | 🐛 8 | 🌐 Go | 📅 2025-08-25 - Clean Architecture template for Golang services.
...
* [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) ⭐ 1,089 | 🐛 11 | 🌐 Go | 📅 2025-08-25 - A GitHub repository offering coding challenges for Go technical interview preparation.
