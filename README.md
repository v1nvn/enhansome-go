...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 144,990](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 245,702.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 144,990 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 144,990; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,974 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,938 - Blazingly fast and light-weight Actor engine written in Golang.
...
- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 583 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,773 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,076 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 142,964 - Run large language models locally.
...
- [PortAudio](https://github.com/gordonklaus/portaudio) ⭐ 768 - Go bindings for the PortAudio audio I/O library.
...
- [authboss](https://github.com/volatiletech/authboss) ⭐ 3,956 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,699 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [gorbac](https://github.com/mikespook/gorbac) ⭐ 1,627 - provides a lightweight role-based access control (RBAC) implementation in Golang.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,036 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,119 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,108 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
- [keto](https://github.com/ory/keto) ⭐ 5,034 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,615 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,673 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,337 - Session Manager for HTTP servers.
...
- [cometbft](https://github.com/cometbft/cometbft) ⭐ 751 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,086 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,511 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,932 - A complete implementation of a Lightning Network node.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,177 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,337 - Telegram bot framework is written in Go.
- [telego](https://github.com/mymmrac/telego) ⭐ 720 - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,165 - Simple and clean Telegram bot client.
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,971 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,662 - Air - Live reload for Go apps.
...
- [Task](https://github.com/go-task/task) ⭐ 12,916 - simple "Make" alternative.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,379 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 31,964 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,526 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,367 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,735.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,029 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,403 - Basic thread-safe progress bar that works in every OS.
- [pterm](https://github.com/pterm/pterm) ⭐ 5,100 - A library to beautify console output on every platform with many combinable components.
...
- [termenv](https://github.com/muesli/termenv) ⭐ 1,838 - Advanced ANSI style & color support for your terminal applications.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 669 - Command argument completion generator for spf13/cobra.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,639 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,023 - An expressive programming language and a versatile interactive shell.
...
- [pflag](https://github.com/spf13/pflag) ⭐ 2,569 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,222 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,837 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,515 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,322 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,227 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,227 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 2,650 - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,188 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,629 - Go configuration with fangs.
...
- [CDS](https://github.com/ovh/cds) ⭐ 4,713 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [drone](https://github.com/drone/drone) ⭐ 32,818 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 152 - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,563 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,730.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,119 - Woodpecker is a community fork of the Drone CI system.
...
- [omniparser](https://github.com/jf-tech/omniparser) ⭐ 1,047 - A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,712 - Go package implementing compressed bitsets.

### Bit Sets

- [bitmap](https://github.com/kelindar/bitmap) ⭐ 335 - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
- [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,421 - Go package implementing bitsets.
...
- [gods](https://github.com/emirpasic/gods) ⭐ 16,938 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,636 - Distributed, Fault-tolerant task queue.
...
- [cache2go](https://github.com/muesli/cache2go) ⭐ 2,153 - In-memory key:value cache which supports automatic invalidation based on timeouts.
...
- [fastcache](https://github.com/VictoriaMetrics/fastcache) ⭐ 2,224 - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
...
- [go-cache](https://github.com/viney-shih/go-cache) ⭐ 156 - A flexible multi-layer Go caching library to deal with in-memory and shared cache by adopting Cache-Aside pattern.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,108 -  A high performance memory-bound Go cache.
...
- [badger](https://github.com/dgraph-io/badger) ⭐ 14,630 - Fast key-value store in Go.
...
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 30,972 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,908 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,517 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,431 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,706 - Dolt – It's Git for Data.
...
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,268 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,710 key/value database in Go.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,129 - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,158 - Milvus is a vector database for embedding management, analytics and search.
...
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,327 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,858 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,777 - Redis re-implemented with SQLite.
...
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,549 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,250 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,906 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,475 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,763 - Database migrations. CLI and Golang library.
...
- [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,340 - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
- [pREST](https://github.com/prest/prest) ⭐ 4,358 - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,624 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,207 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,255 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,433 - Go library that helps you build SQL queries.
...
- [go-transaction-manager](https://github.com/avito-tech/go-transaction-manager) ⭐ 309 - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,834 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,510 - SQLite3 driver for go that uses database/sql.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,934 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,934 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,426 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,499 - Pure Go Postgres driver for database/sql.
...
- [go-mongox](https://github.com/chenmingyong0423/go-mongox) ⭐ 189 - A Go Mongo library based on the official driver, featuring streamlined document operations, generic binding of structs to collections, built-in CRUD, aggregation, automated field updates, struct validation, hooks, and plugin-based programming.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,356 - Official MongoDB driver for the Go language.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,940 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,682 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
- [xredis](https://github.com/shomali11/xredis) ⭐ 19 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

- [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,069 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
- [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,882 - Official Elasticsearch client for Go.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,609 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [gleam](https://github.com/chrislusf/gleam) ⭐ 3,520 - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
...
- [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,315 - A Go framework for the API or Microservice with handy scaffolding tools.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,071 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,326 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,144 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,902 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,035 - A cloud native Kubernetes Global Balancer.
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,465 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,417 - A modular-designed and easy-to-use microservices framework in Go.
...
- [micro](https://github.com/micro/micro) ⭐ 12,255 - A distributed systems runtime for the cloud and beyond.
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,529 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,281 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,617 - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,614 - Simplified distributed locking implementation using Redis.
...
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,875 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [Temporal](https://github.com/temporalio/sdk-go) ⭐ 643 - Durable execution system for making code fault-tolerant and simple.
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,784 - BitTorrent client package.
- [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 967 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,554 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,918 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,178 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 4,991 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,604.
- [cel-go](https://github.com/google/cel-go) ⭐ 2,564 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,899 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 7,999 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,268 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,194 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,604 - Lua 5.1 VM and compiler written in Go.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,225 - Go error library with error portability over the network.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 272 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,232 - FileSystem Abstraction System for Go.
- [afs](https://github.com/viant/afs) ⭐ 329 - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,478 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,682 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,796.
...
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1,358 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,767 - Arbitrary-precision fixed-point decimal numbers.
...
- [mo](https://github.com/samber/mo) ⭐ 2,987 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,093 - dead simple 2D game engine in Go.
- [ecs](https://github.com/andygeiss/ecs) ⭐ 144 - Build your own Game-Engine based on the Entity Component System concept in Golang.
- [engo](https://github.com/EngoEngine/engo) ⭐ 1,794 - Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm.
- [fantasyname](https://github.com/s0rg/fantasyname) ⭐ 36 - Fantasy names generator.
- [g3n](https://github.com/g3n/engine) ⭐ 2,946 - Go 3D Game Engine.
...
- [Harfang3D](https://github.com/harfang3d/harfang3d) ⭐ 615 - 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev](https://github.com/harfang3d/harfang-go) ⭐ 38).
- [Leaf](https://github.com/name5566/leaf) ⭐ 5,407 - Lightweight game server framework.
- [nano](https://github.com/lonng/nano) ⭐ 3,020 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,626 - Pure Go game engine.
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,549 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,066 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,176 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 724 - A simple Go-based server for map tiles stored in mbtiles format.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,380 - Compile shell scripts to Go.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,725 - A high-performance and low-cost goroutine pool in Go.
...
- [rill](https://github.com/destel/rill) ⭐ 1,675 - Go toolkit for clean, composable, channel-based concurrency.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,675 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 410 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 65,986 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,653.
- [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,022 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,250 - Build native macOS applications using Go.
- [energy](https://github.com/energye/energy) ⭐ 477 - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,528 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,174 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [bimg](https://github.com/h2non/bimg) ⭐ 2,857 - Small package for fast and efficient image processing using libvips.
...
- [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 713 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,267 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,489.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,964 - Get a JSON value with one line of code.
...
- [kemba](https://github.com/clok/kemba) ⭐ 16 - A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug) ⭐ 11,282, great for CLI tools and applications.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,282 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,282 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,282 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,282, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,071, [zap](https://github.com/uber-go/zap) ⭐ 23,161, [zerolog](https://github.com/rs/zerolog) ⭐ 11,467, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,115 - Simple rolling logger, implements io.WriteCloser.
...
- [tail](https://github.com/hpcloud/tail) ⭐ 2,762 - Go package striving to emulate the features of the BSD tail program.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,161 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,467 - Zero-allocation JSON logger.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 787 - An accelerated Machine Learning framework for Go.
...
- [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,771 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,882 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,777 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,308 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,002 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,386 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,090 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,754 - Asynchronous task queue/job queue based on distributed message passing.
...
- [melody](https://github.com/olahol/melody) ⭐ 3,919 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,950 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,948 - Go client for the NATS
  messaging system.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,508 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,585 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize](https://github.com/xuri/excelize) ⭐ 19,220 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [dig](https://github.com/uber-go/dig) ⭐ 4,194 - A reflection based dependency injection toolkit for Go.
...
- [fx](https://github.com/uber-go/fx) ⭐ 6,552 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,813 - Automated Initialization in Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,790 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,790 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,563 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,623 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,623 for more information. Nonetheless, some may find the layout useful.
...
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,534 - Rapid, easy full-stack web development starter kit built in Go.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,502 - Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,948 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,207 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,525 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,141 which a Chinese word splitting algorithm.
...
- [gse](https://github.com/go-ego/gse) ⭐ 2,663 - Go efficient text segmentation; support english, chinese, japanese and other.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,733 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,357 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,611 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gaio](https://github.com/xtaci/gaio) ⭐ 785 - High performance async-io networking for Golang in proactor mode.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,566 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,804 - BGP implemented in the Go Programming Language.
...
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,371 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,711 - An implementation of the QUIC protocol in pure Go.
...
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,906 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,883 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,878 - A pure Go implementation of the WebRTC API.
...
- [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 253 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) ⭐ 2,139 - Retryable HTTP client in Go.
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,924 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,288 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,226 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,553 - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,296 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,123 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,421 - A distributed tracing system.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,468 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,365 - go generate based graphql server library.
...
- [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,069 - Implementation of GraphQL for Go.
...
- [go-hep](https://github.com/go-hep/hep) ⭐ 244 - A set of libraries and tools for performing High Energy Physics analyses with ease.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,032 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,859 - gonum/plot provides an API for building and drawing plots in Go.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,023 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,156 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 566 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,381 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,682 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,623 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
- [luks.go](https://github.com/anatol/luks.go) ⭐ 90 - Pure Golang library to manage LUKS partitions.
- [memguard](https://github.com/awnumar/memguard) ⭐ 2,632 - A pure Go library for handling sensitive values in memory.
...
- [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,954 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,726 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,547 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,529 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,491 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,396 - A self contained feature flag solution written in Go and Vue.js
...
- [minio](https://github.com/minio/minio) ⭐ 52,956 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,670 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,522 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
- [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,029 - HTTP reverse proxy cache and time series accelerator.
...
- [go-etl](https://github.com/Breeze0806/go-etl) ⭐ 145 - A lightweight toolkit for data source extraction, transformation, and loading (ETL).
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,427 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,352 - A HTML templating language that has great developer tooling.
...
- [go-cmp](https://github.com/google/go-cmp) ⭐ 4,422 - Package for comparing Go values in tests.
...
- [gotest.tools](https://github.com/gotestyourself/gotest.tools) ⭐ 564 - A collection of packages to augment the go testing package and support common patterns.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,129 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,090 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,695 - Sacred extension to the standard go testing package.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,829 - Mocking framework for the Go programming language.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,613 - Tool to generate Go interfaces.
...
- [moq](https://github.com/matryer/moq) ⭐ 2,089 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 481 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,934.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,881 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,710 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,966 - A Devtools driver to make web automation and scraping easy.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,548 - Formatters for time, numbers, and memory size to human readable format.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,100 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,875 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,694 - Parse RSS and Atom feeds in Go.
- [gographviz](https://github.com/awalterschulze/gographviz) ⭐ 561 - Parses the Graphviz DOT language.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,770 - Shell parser and formatter.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 24,256 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,516 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,079 - The official AWS SDK for the Go programming language.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,034 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google](https://github.com/google/google-api-go-client) ⭐ 4,258 - Auto-generated Google APIs for Go.
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 2,698 - Minio Go Library for Amazon S3 compatible cloud storage.
...
- [clipboard](https://github.com/golang-design/clipboard) ⭐ 681 - 📋 cross-platform clipboard package in Go.
...
- [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,695 - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,167 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 50,993 - A tool for exploring each layer in a Docker image.
...
- [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,238 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
- [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,788 - Fault tolerance and resilience patterns for Go.
- [filetype](https://github.com/h2non/filetype) ⭐ 2,194 - Small package to infer the file type checking the magic numbers signature.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,743 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,708 - Deliver Go binaries as fast and easily as possible.
...
- [lo](https://github.com/samber/lo) ⭐ 19,527 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mergo](https://github.com/imdario/mergo) ⭐ 2,998 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [minify](https://github.com/tdewolff/minify) ⭐ 3,887 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,969 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,385 - usql is a universal command-line interface for SQL databases.
...
- [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,664 - Interactive cli tool for HTTP inspection.
...
- [uuid](https://github.com/google/uuid) ⭐ 5,678 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,127 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,927 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,436 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 864 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,407 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,584 - highly extensible Git implementation in pure Go.
...
- [Beego](https://github.com/beego/beego) ⭐ 32,108 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,084 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 448 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,774 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,403 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,618 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,108 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,420 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,841 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,125 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
- [iWF](https://github.com/indeedeng/iwf) ⭐ 571 - iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
- [templui](https://github.com/axzilla/templui) ⭐ 688 - Modern UI Components for Go & Templ.
...
- [alice](https://github.com/justinas/alice) ⭐ 3,254 - Painless middleware chaining for Go.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,885 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,887 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,293 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,959 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,230 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [xmlquery](https://github.com/antchfx/xmlquery) ⭐ 465 - xmlquery is Golang XPath package for XML query.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,973 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,345 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 106 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [Spire](https://github.com/spiffe/spire) ⭐ 1,961 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,116 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,068 - Formatter that automatically shortens long lines in Go code.
- [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,008 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,450 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,695.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 573 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,703 features to Vim/Neovim.
...
- [options-gen](https://github.com/kazhuravlev/options-gen) ⭐ 93 - Functional options described by Dave Cheney's post "Functional options for friendly APIs".
...
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,587 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,124 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,058 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,219 - Build powerful pipelines in any programming language.
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,747 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 48,943 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,965 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,932 - Hey is a tiny program that sends some load to a web application.
...
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,857 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 27,953 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,191 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,026 - Command line tool for building and deploying Go applications on Kubernetes
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,557 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,379 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,708 - Cloud native application delivery.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,510 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,847 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,614 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
...
- [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 357 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,094 - Blazing fast S3 and local filesystem execution tool.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,039 - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,276 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,366 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,323 - Easily and securely send files or folders from one computer to another.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,443 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,910 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
- [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 858 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,685 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [nes](https://github.com/fogleman/nes) ⭐ 5,556 - Nintendo Entertainment System (NES) emulator written in Go.
...
- [restic](https://github.com/restic/restic) ⭐ 28,866 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 695 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,369 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,700 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,277 - Proxy to simulate network and system conditions for automated tests.
...
- [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) ⭐ 2,121 - Go web framework benchmark.
...
- [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 415 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,046 - A curated list of Go books.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 30,972
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,140
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,542
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,213 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,620 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,224 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,606 - Golang ebook intro how to build a web app with golang.
...
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,516 - Curated list of Go design patterns, recipes and idioms.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,320 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,850 - Learn Go with test-driven development.
