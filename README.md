...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,813](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 247,255.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,813 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,813; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,990 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,953 - Blazingly fast and light-weight Actor engine written in Golang.
- [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,246 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.

## Artificial Intelligence

_Libraries for building programs that leverage AI._

- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 598 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,932 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,322 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 144,341 - Run large language models locally.
...
- [authboss](https://github.com/volatiletech/authboss) ⭐ 3,971 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,775 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth](https://github.com/markbates/goth) ⭐ 6,049 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,167 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,119 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,632 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,724 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,617 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,162 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,528 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,951 - A complete implementation of a Lightning Network node.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,195 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,355 - Telegram bot framework is written in Go.
- [telego](https://github.com/mymmrac/telego) ⭐ 725 - Telegram Bot API library for Golang with full one-to-one API implementation.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,795 - Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4,360 - Mage is a make/rake-like build tool using Go.
...
- [Task](https://github.com/go-task/task) ⭐ 12,996 - simple "Make" alternative.
...
- [aurora](https://github.com/logrusorgru/aurora) ⭐ 1,456 - ANSI terminal colors that support fmt.Printf/Sprintf.
- [box-cli-maker](https://github.com/Delta456/box-cli-maker) ⭐ 564 - Make Highly Customized Boxes for your CLI.
- [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 500 - An interactive table component for bubbletea.
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,447 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,394 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,585 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,376 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,771.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,266 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,120 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,419 - Basic thread-safe progress bar that works in every OS.
...
- [termui](https://github.com/gizak/termui) ⭐ 13,371 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,608.
- [uilive](https://github.com/gosuri/uilive) ⭐ 1,708 - Library for updating terminal output in real time.
- [uiprogress](https://github.com/gosuri/uiprogress) ⭐ 2,132 - Flexible library to render progress bars in terminal applications.
- [uitable](https://github.com/gosuri/uitable) ⭐ 743 - Library to improve readability in terminal apps using tabular data.
...
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,303 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,821 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,041 - An expressive programming language and a versatile interactive shell.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,261 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,552 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,373 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,237 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,252 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,238 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,718 - Go configuration with fangs.
- [xdg](https://github.com/adrg/xdg) ⭐ 828 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
- [CDS](https://github.com/ovh/cds) ⭐ 4,721 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [drone](https://github.com/drone/drone) ⭐ 32,878 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,566 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,749.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,162 - Woodpecker is a community fork of the Drone CI system.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,719 - Go package implementing compressed bitsets.
...
- [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,608 - Go package implementing Bloom filters.
...
- [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) ⭐ 1,178 - Cuckoo filter: a good alternative to a counting bloom filter implemented in Go.
- [ring](https://github.com/TheTannerRyan/ring) ⭐ 141 - Go implementation of a high performance, thread safe bloom filter.

### Data Structure and Algorithm Collections

- [algorithms](https://github.com/shady831213/algorithms) ⭐ 820 - Algorithms and data structures.CLRS study.
- [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,807 - Collection of useful, performant, and thread-safe data structures.
- [gods](https://github.com/emirpasic/gods) ⭐ 16,960 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,534 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 400 - Implementation to calculate levenshtein distance in Go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,854 - Efficient key/value cache for gigabytes of data.
...
- [otter](https://github.com/maypok86/otter) ⭐ 1,900 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,135 -  A high performance memory-bound Go cache.
...
- [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,089 - An in-memory cache with item expiration and generics.
- [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger](https://github.com/dgraph-io/badger) ⭐ 14,675 - Fast key-value store in Go.
...
- [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,718 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover](https://github.com/ostafen/clover) ⭐ 758 - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,009 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,307 - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,950 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,554 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,435 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,762 - Dolt – It's Git for Data.
...
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,275 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,760 key/value database in Go.
...
- [immudb](https://github.com/codenotary/immudb) ⭐ 8,757 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,198 - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,507 - Milvus is a vector database for embedding management, analytics and search.
...
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,351 - RocksDB/LevelDB inspired key-value database in Go.
- [piladb](https://github.com/fern4lvarez/piladb) ⭐ 207 - Lightweight RESTful database engine based on stack data structures.
- [pogreb](https://github.com/akrylysov/pogreb) ⭐ 1,339 - Embedded key-value store for read-heavy workloads.
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,062 - Monitoring system and time series database.
...
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,815 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,688 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,599 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
- [tiedot](https://github.com/HouzuoGuo/tiedot) ⭐ 2,722 - Your NoSQL database powered by Golang.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,349 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,954 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,605 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,069 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,554 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
- [gorm-seeder](https://github.com/Kachit/gorm-seeder) ⭐ 16 - Simple database seeder for Gorm ORM.
- [gormigrate](https://github.com/go-gormigrate/gormigrate) ⭐ 1,096 - Database schema migration helper for Gorm ORM.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,850 - Database migrations. CLI and Golang library.
...
- [pREST](https://github.com/prest/prest) ⭐ 4,360 - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,712 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3,229 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,339 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,461 - Go library that helps you build SQL queries.
...
- [cayley](https://github.com/google/cayley) ⭐ 14,939 - Graph database with support for multiple backends.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,879 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,528 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 716 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,991 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,991 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,437 query results easily.
...
- [ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) ⭐ 162 - native and database/sql driver YDB (Yandex Database)
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,980 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,697 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 981 - Fast trigram based code search.
...
- [carbon](https://github.com/dromara/carbon) ⭐ 5,082 - A simple, semantic and developer-friendly time package for golang.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,626 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [gleam](https://github.com/chrislusf/gleam) ⭐ 3,523 - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
- [glow](https://github.com/chrislusf/glow) ⭐ 3,216 - Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,103 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,355 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,253 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,948 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,484 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,487 - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,603 - Lightweight, fault-tolerant message streams for NATS.
- [lura](https://github.com/luraproject/lura) ⭐ 6,568 - Ultra performant API Gateway framework with middlewares.
- [micro](https://github.com/micro/micro) ⭐ 12,257 - A distributed systems runtime for the cloud and beyond.
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,552 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,362 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,642 - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,623 - Simplified distributed locking implementation using Redis.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,302).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,897 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,790 - BitTorrent client package.
...
- [GoDNS](https://github.com/timothyye/godns) ⭐ 1,587 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,384 - A Go library for email verification without sending any emails.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,013 - A simple Go library for sending mails in Go.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,567 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,962 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,242 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5,025 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [cel-go](https://github.com/google/cel-go) ⭐ 2,576 - Fast, portable, non-Turing complete expression evaluation with gradual typing.
- [ecal](https://github.com/krotik/ecal) ⭐ 47 - A simple embeddable scripting language which supports concurrent event processing.
- [expr](https://github.com/antonmedv/expr) ⭐ 6,952 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,936 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,279 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,230 - ECMAScript 5.1(+) implementation in Go.
...
- [tengo](https://github.com/d5/tengo) ⭐ 3,656 - Bytecode compiled script language for Go.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,666 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [oops](https://github.com/samber/oops) ⭐ 686 - Error handling with context, stack trace and source fragments.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,246 - FileSystem Abstraction System for Go.
...
- [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 97 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 71,136).
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,537 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,728 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,818.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,797 - Arbitrary-precision fixed-point decimal numbers.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,282 - Terminal stock watcher and stock position tracker.
...
- [udecimal](https://github.com/quagmt/udecimal) ⭐ 146 - High performance, high precision, zero allocation fixed-point decimal library for financial applications.
...
- [form](https://github.com/go-playground/form) ⭐ 839 - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
- [mo](https://github.com/samber/mo) ⭐ 2,998 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,142 - dead simple 2D game engine in Go.
- [ecs](https://github.com/andygeiss/ecs) ⭐ 145 - Build your own Game-Engine based on the Entity Component System concept in Golang.
- [engo](https://github.com/EngoEngine/engo) ⭐ 1,795 - Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm.
- [fantasyname](https://github.com/s0rg/fantasyname) ⭐ 36 - Fantasy names generator.
- [g3n](https://github.com/g3n/engine) ⭐ 2,957 - Go 3D Game Engine.
...
- [Harfang3D](https://github.com/harfang3d/harfang3d) ⭐ 617 - 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev](https://github.com/harfang3d/harfang-go) ⭐ 38).
- [Leaf](https://github.com/name5566/leaf) ⭐ 5,417 - Lightweight game server framework.
- [nano](https://github.com/lonng/nano) ⭐ 3,034 - Lightweight, facility, high performance golang based game server framework.
- [Oak](https://github.com/oakmound/oak) ⭐ 1,628 - Pure Go game engine.
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,560 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,078 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
- [termloop](https://github.com/JoelOtter/termloop) ⭐ 1,458 - Terminal-based game engine for Go, built on top of Termbox.
- [tile](https://github.com/kelindar/tile) ⭐ 194 - Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export.
...
- [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,226 - Generate decorators for Go interfaces using simple templates.
- [interfaces](https://github.com/rjeczalik/interfaces) ⭐ 431 - Command line tool for generating interface definitions.
- [jennifer](https://github.com/dave/jennifer) ⭐ 3,510 - Generate arbitrary Go code without templates.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,353 - Geolocation DB with spatial index and realtime geofencing.
...
- [go2hx](https://github.com/go2hx/go2hx) ⭐ 135 - Compiler from Go to Haxe to Javascript/C++/Java/C#.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,761 - A high-performance and low-cost goroutine pool in Go.
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,937 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [pond](https://github.com/alitto/pond) ⭐ 1,797 - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,700 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 415 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,274 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,659.
- [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,027 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,607 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [webview](https://github.com/zserge/webview) ⭐ 13,169 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,200 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
- [systray](https://github.com/getlantern/systray) ⭐ 3,497 - Cross platform Go library to place an icon and menu in the notification area.
...
- [go-qrcode](https://github.com/yeqown/go-qrcode) ⭐ 717 - Generate QR codes with personalized styles, allowing adjustments to color, block size, shape, and icons.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,101 - Go package for computer vision using OpenCV 3.3+.
...
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,496 - Simple Go image processing package.
...
- [picfit](https://github.com/thoas/picfit) ⭐ 2,233 - An image resizing server written in Go.
...
- [flogo](https://github.com/tibcosoftware/flogo) ⭐ 2,464 - Project Flogo is an Open Source Framework for IoT Edge Apps & Integration.
- [gatt](https://github.com/paypal/gatt) ⭐ 1,157 - Gatt is a Go package for building Bluetooth Low Energy peripherals.
- [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,195 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,137 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [go-quartz](https://github.com/reugn/go-quartz) ⭐ 1,883 - Simple, zero-dependency scheduling library for Go.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,992 - Get a JSON value with one line of code.
...
- [kemba](https://github.com/clok/kemba) ⭐ 16 - A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug) ⭐ 11,288, great for CLI tools and applications.
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 572 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,316 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,316 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,316 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,316, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,103, [zap](https://github.com/uber-go/zap) ⭐ 23,229, [zerolog](https://github.com/rs/zerolog) ⭐ 11,509, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,127 - Simple rolling logger, implements io.WriteCloser.
...
- [pp](https://github.com/k0kubun/pp) ⭐ 1,955 - Colored pretty printer for Go language.
...
- [spew](https://github.com/davecgh/go-spew) ⭐ 6,256 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,229 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,509 - Zero-allocation JSON logger.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 803 - An accelerated Machine Learning framework for Go.
...
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 413 - Huggingface transformer pipelines for golang with onnxruntime.
...
- [APNs2](https://github.com/sideshow/apns2) ⭐ 3,091 - HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps.
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,420 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,042 - Real-time messaging (Websockets or SockJS) server in Go.
- [Chanify](https://github.com/chanify/chanify) ⭐ 1,305 - A push notification server send message to your iOS devices.
...
- [go-socket.io](https://github.com/googollee/go-socket.io) ⭐ 5,777 - socket.io library for golang, a realtime application framework.
...
- [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) ⭐ 2,078 - gopush-cluster is a go push server cluster.
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,402 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,091 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,771 - Asynchronous task queue/job queue based on distributed message passing.
...
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,964 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,969 - Go client for the NATS
  messaging system.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,045 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,563 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,596 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.
...
- [do](https://github.com/samber/do) ⭐ 2,143 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,581 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,859 - Automated Initialization in Go.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 3,801 - A [starter kit](https://github.com/ardanlabs/service/wiki) ⭐ 3,801 for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,635 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,793 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,793 for more information. Nonetheless, some may find the layout useful.
- [golang-templates/seed](https://github.com/golang-templates/seed) ⭐ 524 - Go application GitHub repository template.
- [goxygen](https://github.com/shpota/goxygen) ⭐ 3,583 - Generate a modern Web project with Go and Angular, React, or Vue in seconds.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,267 - Nunu is a scaffolding tool for building Go applications.
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,544 - Rapid, easy full-stack web development starter kit built in Go.
...
- [sttr](https://github.com/abhimanyu003/sttr) ⭐ 1,125 - cross-platform, cli app to perform various operations on string.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,559 - Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,962 - Random data generator written in go.
- [gommit](https://github.com/antham/gommit) ⭐ 115 - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,251 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [lingua-go](https://github.com/pemistahl/lingua-go) ⭐ 1,248 - An accurate natural language detection library, suitable for long and short text alike. Supports detecting multiple languages in mixed-language text.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,740.
...
- [spaGO](https://github.com/nlpodyssey/spago) ⭐ 1,806 - Self-contained Machine Learning and Natural Language Processing library in Go.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,534 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,183 which a Chinese word splitting algorithm.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,263 - Package and an accompanying tool to work with localized text.
...
- [gotext](https://github.com/leonelquinteros/gotext) ⭐ 470 - GNU gettext utilities for Go.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,846 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,379 - Go library for working with DNS.
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,652 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gev](https://github.com/Allenxuxu/gev) ⭐ 1,752 - gev is a lightweight, fast non-blocking TCP network library based on Reactor mode.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,603 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,815 - BGP implemented in the Go Programming Language.
- [gopacket](https://github.com/google/gopacket) ⭐ 6,547 - Go library for packet processing with libpcap bindings.
...
- [grab](https://github.com/cavaliercoder/grab) ⭐ 1,439 - Go package for managing file downloads.
...
- [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,149 - Extremely simple & fast udp tunnel based on KCP protocol.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 977 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
- [peerdiscovery](https://github.com/schollz/peerdiscovery) ⭐ 657 - Pure Go library for cross-platform local peer discovery using UDP multicast.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,744 - An implementation of the QUIC protocol in pure Go.
...
- [sftp](https://github.com/pkg/sftp) ⭐ 1,582 - Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>.
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,924 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,945 - A pure Go implementation of the WebRTC API.
...
- [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 263 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- [req](https://github.com/imroc/req) ⭐ 4,524 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [requests](https://github.com/carlmjohnson/requests) ⭐ 1,608 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
- [resty](https://github.com/go-resty/resty) ⭐ 10,978 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,319 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,213 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,278 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,375 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,884 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,223 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,060 - No instrumentation tracing for Golang applications via eBPF.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,485 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,381 - go generate based graphql server library.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,052 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,867 - gonum/plot provides an API for building and drawing plots in Go.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,090 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,178 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 565 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,404 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,705 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [go-yara](https://github.com/hillu/go-yara) ⭐ 371 - Go Bindings for [YARA](https://github.com/plusvic/yara) ⭐ 138, the "pattern matching swiss knife for malware researchers (and everyone else)".
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,663 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,785 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 65,006 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- [Clace](https://github.com/claceio/clace) ⭐ 629 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,655 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,553 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,500 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,430 - A self contained feature flag solution written in Go and Vue.js
...
- [minio](https://github.com/minio/minio) ⭐ 53,253 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,869 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,174 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,592 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,445 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,391 - A HTML templating language that has great developer tooling.
...
- [goc](https://github.com/qiniu/goc) ⭐ 860 - Goc is a comprehensive coverage testing system for The Go Programming Language.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,133 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,770 - Sacred extension to the standard go testing package.
...
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,381 - Mock SQL driver for testing database interactions.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,857 - Mocking framework for the Go programming language.
...
- [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,031 - Easy mocking of HTTP responses from external resources.
- [minimock](https://github.com/gojuno/minimock) ⭐ 689 - Mock generator for Go interfaces.
- [mockery](https://github.com/vektra/mockery) ⭐ 6,642 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 485 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,991.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,938 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,743 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 6,004 - A Devtools driver to make web automation and scraping easy.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,130 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,889 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [godump (goforj)](https://github.com/goforj/godump) ⭐ 1,017 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,797 - Shell parser and formatter.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 24,341 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,537 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,103 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,429 - Go bindings for the Discord Chat API.
...
- [github](https://github.com/google/go-github) ⭐ 10,836 - Go library for accessing the GitHub REST API v3.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,083 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 2,711 - Minio Go Library for Amazon S3 compatible cloud storage.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,796 - Slack API in Go.
...
- [stripe](https://github.com/stripe/stripe-go) ⭐ 2,332 - Go client for the Stripe API.
...
- [webhooks](https://github.com/go-playground/webhooks) ⭐ 987 - Webhook receiver for GitHub and Bitbucket.
...
- [bed](https://github.com/itchyny/bed) ⭐ 1,299 - A Vim-like binary editor written in Go.
...
- [clipboard](https://github.com/golang-design/clipboard) ⭐ 687 - 📋 cross-platform clipboard package in Go.
...
- [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,699 - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,199 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 51,144 - A tool for exploring each layer in a Docker image.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 71,136 - Command-line fuzzy finder written in Go.
...
- [lo](https://github.com/samber/lo) ⭐ 19,609 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mc](https://github.com/minio/mc) ⭐ 3,062 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
- [minify](https://github.com/tdewolff/minify) ⭐ 3,898 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- [rospo](https://github.com/ferama/rospo) ⭐ 334 - Simple and reliable ssh tunnels with embedded ssh server in Golang.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,007 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,404 - usql is a universal command-line interface for SQL databases.
...
- [uuid](https://github.com/gofrs/uuid) ⭐ 1,695 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,515 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 880 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,677 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,650 - highly extensible Git implementation in pure Go.
...
- [gortsplib](https://github.com/aler9/gortsplib) ⭐ 790 - Pure Go RTSP server and client library.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,167 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 455 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,920 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,419 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,806 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 - Gin parameter automatic binding tool,gin rpc tools.
- [Goa](https://github.com/goadesign/goa) ⭐ 5,881 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,870 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,327 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,169 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 725 - Modern UI Components for Go & Templ.
...
- [CORS](https://github.com/rs/cors) ⭐ 2,788 - Easily add CORS capabilities to your API.
...
- [alice](https://github.com/justinas/alice) ⭐ 3,260 - Painless middleware chaining for Go.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,968 - Small, fast and expressive HTTP router built on net/context.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,418 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,363 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,991 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,273 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [workflow](https://github.com/luno/workflow) ⭐ 169 - A tech stack agnostic Event Driven Workflow framework.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 5,010 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,386 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) ⭐ 941 - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,176 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
- [golines](https://github.com/segmentio/golines) ⭐ 1,072 - Formatter that automatically shortens long lines in Go code.
- [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,014 - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- [revive](https://github.com/mgechev/revive) ⭐ 5,210 – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,470 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 139 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,770.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 574 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,736 features to Vim/Neovim.
...
- [gotests](https://github.com/cweill/gotests) ⭐ 5,073 - Generate Go tests from your source code.
...
- [decouple](https://github.com/bobg/decouple) ⭐ 29 - Find “overspecified” function parameters that could be generalized with interface types.
...
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,777 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [OctoLinker](https://github.com/OctoLinker/browser-extension) ⭐ 5,317 - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.
- [richgo](https://github.com/kyoh86/richgo) ⭐ 860 - Enrich `go test` outputs with text decorations.
- [roumon](https://github.com/becheran/roumon) ⭐ 214 - Monitor current state of all active goroutines via a command line interface.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,148 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,118 - Lightweight, programmable telemetry for servers and workstations.
...
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,143 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 11,009 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,981 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,858 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,991 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,080 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,226 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,855 - Container Cluster Manager from Google.
- [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 11,385 - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,570 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,940 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,172 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
- [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,623 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,306 - Pomerium is an identity-aware access proxy.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,354 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,736 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [StatusOK](https://github.com/sanathp/statusok) ⭐ 1,627 - Monitor your Website and REST APIs.Get Notified through Slack, E-mail when your server is down or response time is more than expected.
- [tau](https://github.com/taubyte/tau) ⭐ 4,022 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [tlm](https://github.com/yusufcanb/tlm) ⭐ 1,431 - Local cli copilot, powered by CodeLLaMa
- [traefik](https://github.com/containous/traefik) ⭐ 55,229 - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,305 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,397 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Circuit](https://github.com/gocircuit/circuit) ⭐ 1,986 - Circuit is a programmable platform-as-a-service (PaaS) and/or Infrastructure-as-a-Service (IaaS), for management, discovery, synchronization and orchestration of services and hosts comprising cloud applications.
...
- [Documize](https://github.com/documize/community) ⭐ 2,254 - Modern wiki software that integrates data from SaaS tools.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,459 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,950 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
- [GoLand](https://jetbrains.com/go) - Full featured cross-platform Go IDE.
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 873 - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
- [Gor](https://github.com/buger/gor) ⭐ 18,963 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,728 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [restic](https://github.com/restic/restic) ⭐ 29,044 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 699 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,414 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,862 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,321 - Proxy to simulate network and system conditions for automated tests.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,100 - A curated list of Go books.
...
- [The Golang Standard Library by Example (Chinese)](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) ⭐ 9,547
...
- [gophers](https://github.com/egonelbre/gophers) ⭐ 3,658 - Free gophers.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,009
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,582
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,395 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,495 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,640 - Golang ebook intro how to build a web app with golang.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,893 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,581 - Curated list of Go design patterns, recipes and idioms.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,341 - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,900 - Learn Go with test-driven development.
