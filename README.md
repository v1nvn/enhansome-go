...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,562](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 246,821.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,562 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,562; you rock!
...
- [Goakt](https://github.com/Tochemey/goakt) ⭐ 254 - Fast and Distributed Actor framework using protocol buffers as message for Golang.
- [Hollywood](https://github.com/anthdm/hollywood) ⭐ 1,949 - Blazingly fast and light-weight Actor engine written in Golang.
...
- [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 594 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
- [fun](https://gitlab.com/tozd/go/fun) - The simplest but powerful way to use large language models (LLMs) in Go.
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,859 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,241 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 143,847 - Run large language models locally.
...
- [PortAudio](https://github.com/gordonklaus/portaudio) ⭐ 774 - Go bindings for the PortAudio audio I/O library.
...
- [authboss](https://github.com/volatiletech/authboss) ⭐ 3,958 - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,755 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,151 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,117 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
- [keto](https://github.com/ory/keto) ⭐ 5,041 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,624 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,706 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,348 - Session Manager for HTTP servers.
...
- [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,614 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,140 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,527 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,945 - A complete implementation of a Lightning Network node.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1,190 - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot](https://github.com/tucnak/telebot) ⭐ 4,349 - Telegram bot framework is written in Go.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,768 - Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4,352 - Mage is a make/rake-like build tool using Go.
- [mmake](https://github.com/tj/mmake) ⭐ 1,725 - Modern Make.
- [realize](https://github.com/tockins/realize) ⭐ 4,459 - Go build a system with file watchers and live to reload. Run, build and watch file changes with custom paths.
- [Task](https://github.com/go-task/task) ⭐ 12,977 - simple "Make" alternative.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,423 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,264 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,554 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,371 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,761.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,099 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,414 - Basic thread-safe progress bar that works in every OS.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,831 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,373.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,845 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,373 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,608.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 685 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,292 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,729 - Commander for modern Go CLI interactions.
...
- [ops](https://github.com/nanovms/ops) ⭐ 1,355 - Unikernel Builder/Orchestrator.
- [pflag](https://github.com/spf13/pflag) ⭐ 2,574 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,251 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,536 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,359 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,236 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,247 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,216 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,688 - Go configuration with fangs.
- [xdg](https://github.com/adrg/xdg) ⭐ 825 - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
- [CDS](https://github.com/ovh/cds) ⭐ 4,718 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
...
- [drone](https://github.com/drone/drone) ⭐ 32,863 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 562 - go test output for humans.
- [goveralls](https://github.com/mattn/goveralls) ⭐ 790 - Go integration for Coveralls.io continuous code coverage tracking system.
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,566 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,746.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,152 - Woodpecker is a community fork of the Drone CI system.
...
- [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,120 - A high-performance ELT data integration framework with pluggable architecture.
...
- [bitmap](https://github.com/kelindar/bitmap) ⭐ 336 - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
...
- [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,805 - Collection of useful, performant, and thread-safe data structures.
- [gods](https://github.com/emirpasic/gods) ⭐ 16,949 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [gota](https://github.com/kniren/gota) ⭐ 3,190 - Implementation of dataframes, series, and data wrangling methods for Go.
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,693 - Distributed, Fault-tolerant task queue.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 10,413 - Modern text indexing library for go.
...
- [GCache](https://github.com/bluele/gcache) ⭐ 2,684 - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
- [gocache](https://github.com/eko/gocache) ⭐ 2,667 - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [otter](https://github.com/maypok86/otter) ⭐ 1,899 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,124 -  A high performance memory-bound Go cache.
- [sturdyc](https://github.com/viccon/sturdyc) ⭐ 1,207 - A caching library with advanced concurrency features designed to make I/O heavy applications robust and highly performant.
- [theine](https://github.com/Yiling-J/theine-go) ⭐ 296 - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
...
- [badger](https://github.com/dgraph-io/badger) ⭐ 14,655 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,845 - An embedded key/value database for Go.
...
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,002 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,938 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,535 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,433 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,742 - Dolt – It's Git for Data.
...
- [godis](https://github.com/hdt3213/godis) ⭐ 3,697 - A Golang implemented high-performance Redis server and cluster.
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,272 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,745 key/value database in Go.
...
- [immudb](https://github.com/codenotary/immudb) ⭐ 8,754 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,172 - Scalable datastore for metrics, events, and real-time analytics.
...
- [lotusdb](https://github.com/flower-corp/lotusdb) ⭐ 2,164 - Fast k/v database compatible with lsm and b+tree.
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,415 - Milvus is a vector database for embedding management, analytics and search.
...
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,343 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 59,000 - Monitoring system and time series database.
- [pudge](https://github.com/recoilme/pudge) ⭐ 373 - Fast and simple key/value store written using Go's standard library.
- [redka](https://github.com/nalgeon/redka) ⭐ 3,784 - Redis re-implemented with SQLite.
- [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,809 - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rotom](https://github.com/xgzlucario/rotom) ⭐ 39 - A tiny Redis server built with Golang, compatible with RESP protocols.
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,676 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,584 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,321 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,934 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,577 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,056 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,542 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,826 - Database migrations. CLI and Golang library.
...
- [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,761 - Go toolset to handle MySQL protocol and replication.
...
- [onedump](https://github.com/liweiyi88/onedump) ⭐ 190 - Database backup from different drivers to different destinations with one command and configuration.
- [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,184 - Advanced scheduling for PostgreSQL.
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,914 - Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,692 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [Dotsql](https://github.com/gchaincl/dotsql) ⭐ 746 - Go library that helps you keep sql files in one place and use them with ease.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,317 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,455 - Go library that helps you build SQL queries.
- [xo](https://github.com/knq/xo) ⭐ 3,822 - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
- [gokv](https://github.com/philippgille/gokv) ⭐ 790 - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,860 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,523 - SQLite3 driver for go that uses database/sql.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,978 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,978 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,432 query results easily.
- [pq](https://github.com/lib/pq) ⭐ 9,503 - Pure Go Postgres driver for database/sql.
...
- [go-mongox](https://github.com/chenmingyong0423/go-mongox) ⭐ 191 - A Go Mongo library based on the official driver, featuring streamlined document operations, generic binding of structs to collections, built-in CRUD, aggregation, automated field updates, struct validation, hooks, and plugin-based programming.
...
- [gomemcache](https://github.com/bradfitz/gomemcache/) ⭐ 1,816 - memcache client library for the Go programming language.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,372 - Official MongoDB driver for the Go language.
...
- [redis](https://github.com/redis/go-redis) ⭐ 20,967 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,691 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
- [xredis](https://github.com/shomali11/xredis) ⭐ 19 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

- [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,073 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 975 - Fast trigram based code search.
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,622 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [evans](https://github.com/ktr0731/evans) ⭐ 4,395 - Evans: more expressive universal gRPC client.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,089 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,348 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,220 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,935 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,041 - A cloud native Kubernetes Global Balancer.
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,476 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,463 - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,603 - Lightweight, fault-tolerant message streams for NATS.
- [lura](https://github.com/luraproject/lura) ⭐ 6,563 - Ultra performant API Gateway framework with middlewares.
- [micro](https://github.com/micro/micro) ⭐ 12,257 - A distributed systems runtime for the cloud and beyond.
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,541 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,332 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,637 - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
- [redis-lock](https://github.com/bsm/redislock) ⭐ 1,620 - Simplified distributed locking implementation using Redis.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,291).
...
- [Temporal](https://github.com/temporalio/sdk-go) ⭐ 648 - Durable execution system for making code fault-tolerant and simple.
- [torrent](https://github.com/anacrolix/torrent) ⭐ 5,789 - BitTorrent client package.
- [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 972 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
- [GoDNS](https://github.com/timothyye/godns) ⭐ 1,584 - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,381 - A Go library for email verification without sending any emails.
...
- [go-imap](https://github.com/emersion/go-imap) ⭐ 2,200 - IMAP library for clients and servers.
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,008 - A simple Go library for sending mails in Go.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,562 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,950 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,218 - Email and SMTP testing tool for developers.
...
- [anko](https://github.com/mattn/anko) ⭐ 1,520 - Scriptable interpreter written in Go.
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,612.
...
- [expr](https://github.com/antonmedv/expr) ⭐ 6,947 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,107 - PHP embedded in Go, with a `net/http` handler.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,215 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,612 - Lua 5.1 VM and compiler written in Go.
- [gval](https://github.com/PaesslerAG/gval) ⭐ 793 - A highly customizable expression language written in Go.
- [metacall](https://github.com/metacall/core) ⭐ 1,655 - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
- [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,581 - The Wa Programming Language embedded in Go.
...
- [eris](https://github.com/rotisserie/eris) ⭐ 1,663 - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,234 - Go error library with error portability over the network.
...
- [afero](https://github.com/spf13/afero) ⭐ 6,245 - FileSystem Abstraction System for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,524 - Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,714 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,812.
...
- [accounting](https://github.com/leekchan/accounting) ⭐ 897 - money and currency formatting for golang.
- [ach](https://github.com/moov-io/ach) ⭐ 489 - A reader, writer, and validator for Automated Clearing House (ACH) files.
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1,365 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,786 - Arbitrary-precision fixed-point decimal numbers.
...
- [go-money](https://github.com/rhymond/go-money) ⭐ 1,775 - Implementation of Fowler's Money pattern.
- [go-nowpayments](https://github.com/matm/go-nowpayments) ⭐ 3 - Library for the crypto NOWPayments API.
- [ledger](https://github.com/formancehq/ledger) ⭐ 979 - A programmable financial ledger that provides a foundation for money-moving applications.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,280 - Terminal stock watcher and stock position tracker.
...
- [udecimal](https://github.com/quagmt/udecimal) ⭐ 144 - High performance, high precision, zero allocation fixed-point decimal library for financial applications.
...
- [nosurf](https://github.com/justinas/nosurf) ⭐ 1,670 - CSRF protection middleware for Go.
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,131 - dead simple 2D game engine in Go.
...
- [g3n](https://github.com/g3n/engine) ⭐ 2,955 - Go 3D Game Engine.
...
- [Leaf](https://github.com/name5566/leaf) ⭐ 5,413 - Lightweight game server framework.
- [nano](https://github.com/lonng/nano) ⭐ 3,028 - Lightweight, facility, high performance golang based game server framework.
...
- [go-enum](https://github.com/abice/go-enum) ⭐ 835 - Code generation for enums from code comments.
...
- [goverter](https://github.com/jmattheis/goverter) ⭐ 698 - Generate converters by defining an interface.
...
- [jennifer](https://github.com/dave/jennifer) ⭐ 3,506 - Generate arbitrary Go code without templates.
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,208 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [H3](https://github.com/uber/h3-go) ⭐ 350 - Go bindings for H3, a hierarchical hexagonal geospatial indexing system.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,349 - Geolocation DB with spatial index and realtime geofencing.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,400 - Compile shell scripts to Go.
...
- [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 12,978 - Compiler from Go to JavaScript.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,744 - A high-performance and low-cost goroutine pool in Go.
...
- [async](https://github.com/reugn/async) ⭐ 248 - An alternative sync library for Go (Future, Promise, Locks).
...
- [conc](https://github.com/sourcegraph/conc) ⭐ 9,927 - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [go-actor](https://github.com/vladopajic/go-actor) ⭐ 225 - A tiny library for writing concurrent programs using actor model.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,693 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 415 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,191 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,658.
- [Cogent Core](https://github.com/cogentcore/core) ⭐ 2,025 - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
- [DarwinKit](https://github.com/progrium/darwinkit) ⭐ 5,259 - Build native macOS applications using Go.
- [energy](https://github.com/energye/energy) ⭐ 482 - Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux)
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,588 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [qt](https://github.com/therecipe/qt) ⭐ 10,672 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- [walk](https://github.com/lxn/walk) ⭐ 6,979 - Windows application library kit for Go.
- [webview](https://github.com/zserge/webview) ⭐ 13,160 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,188 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [ghw](https://github.com/jaypipes/ghw) ⭐ 1,755 - Golang hardware discovery/inspection library.
...
- [sysinfo](https://github.com/zcalusic/sysinfo) ⭐ 547 - A pure Go library providing Linux OS / kernel / hardware system information.
...
- [bimg](https://github.com/h2non/bimg) ⭐ 2,862 - Small package for fast and efficient image processing using libvips.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,606 - 2D rendering in pure Go.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,090 - Go package for computer vision using OpenCV 3.3+.
...
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,781 - Screenshoting webpages using go and headless chrome on command line.
...
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,490 - Simple Go image processing package.
- [imagor](https://github.com/cshum/imagor) ⭐ 3,652 - Fast, secure image processing server and Go library, using libvips.
...
- [svgo](https://github.com/ajstarks/svgo) ⭐ 2,198 - Go Language Library for SVG generation.
...
- [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,599 - Lightweight data stream processing engine for IoT edge.
...
- [flogo](https://github.com/tibcosoftware/flogo) ⭐ 2,465 - Project Flogo is an Open Source Framework for IoT Edge Apps & Integration.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,131 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
- [sensorbee](https://github.com/sensorbee/sensorbee) ⭐ 231 - Lightweight stream processing engine for IoT.
- [shifu](https://github.com/Edgenesis/shifu) ⭐ 1,342 - Kubernetes native IoT development framework.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,304 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,491.
...
- [fastjson](https://github.com/valyala/fastjson) ⭐ 2,382 - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
...
- [glog](https://github.com/golang/glog) ⭐ 3,602 - Leveled execution logs for Go.
...
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 562 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,308 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,308 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,308 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,308, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,089, [zap](https://github.com/uber-go/zap) ⭐ 23,214, [zerolog](https://github.com/rs/zerolog) ⭐ 11,499, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,124 - Simple rolling logger, implements io.WriteCloser.
...
- [pp](https://github.com/k0kubun/pp) ⭐ 1,954 - Colored pretty printer for Go language.
...
- [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 971 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
...
- [slog](https://github.com/gookit/slog) ⭐ 476 - Lightweight, configurable, extensible logger for Go.
- [slog-formatter](https://github.com/samber/slog-formatter) ⭐ 171 - Common formatters for slog and helpers to build your own.
- [slog-multi](https://github.com/samber/slog-multi) ⭐ 485 - Chain of slog.Handler (pipeline, fanout...).
- [slogor](https://gitlab.com/greyxor/slogor) - A colorful slog handler.
- [spew](https://github.com/davecgh/go-spew) ⭐ 6,250 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,018 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,214 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,499 - Zero-allocation JSON logger.
...
- [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,784 - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,885 - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
- [tfgo](https://github.com/galeone/tfgo) ⭐ 2,469 - Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python.
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,784 - Go RabbitMQ Client Library.
- [APNs2](https://github.com/sideshow/apns2) ⭐ 3,090 - HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps.
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,370 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,030 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,905 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- [Go-MediatR](https://github.com/mehdihadeli/Go-MediatR) ⭐ 244 - A library for handling mediator patterns and simplified CQRS patterns within an event-driven architecture, inspired by csharp MediatR library.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8,398 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,090 and google [GCM](https://github.com/google/go-gcm) ⭐ 105.
...
- [melody](https://github.com/olahol/melody) ⭐ 3,924 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,962 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 5,959 - Go client for the NATS
  messaging system.
...
- [pubsub](https://github.com/tuxychandru/pubsub) ⭐ 436 - Simple pubsub package for go.
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,034 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,550 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [excelize](https://github.com/xuri/excelize) ⭐ 19,269 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [godocx](https://github.com/gomutex/godocx) ⭐ 181 - Library for reading and writing Microsoft Word (Docx) files.
...
- [do](https://github.com/samber/do) ⭐ 2,133 - A dependency injection framework based on Generics.
- [fx](https://github.com/uber-go/fx) ⭐ 6,572 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,837 - Automated Initialization in Go.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,615 - Allows users to spin up a quick Go project using a popular framework.
...
- [go-starter](https://github.com/allaboutapps/go-starter) ⭐ 553 - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,743 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,743 for more information. Nonetheless, some may find the layout useful.
- [golang-templates/seed](https://github.com/golang-templates/seed) ⭐ 523 - Go application GitHub repository template.
- [goxygen](https://github.com/shpota/goxygen) ⭐ 3,581 - Generate a modern Web project with Go and Angular, React, or Vue in seconds.
...
- [pagoda](https://github.com/mikestefanello/pagoda) ⭐ 2,539 - Rapid, easy full-stack web development starter kit built in Go.
...
- [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,246 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
- [basexx](https://github.com/bobg/basexx) ⭐ 5 - Convert to, from, and between digit strings in various number bases.
- [battery](https://github.com/distatus/battery) ⭐ 258 - Cross-platform, normalized battery information library.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,547 - Automated service health dashboard.
...
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,232 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,267 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
- [sitemap-format](https://github.com/mingard/sitemap-format) ⭐ 6 - A simple sitemap generator, with a little syntactic sugar.
- [stateless](https://github.com/qmuntal/stateless) ⭐ 1,063 - A fluent library for creating state machines.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,529 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,167 which a Chinese word splitting algorithm.
...
- [gse](https://github.com/go-ego/gse) ⭐ 2,667 - Go efficient text segmentation; support english, chinese, japanese and other.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,258 - Package and an accompanying tool to work with localized text.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,811 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
- [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,634 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- [fortio](https://github.com/fortio/fortio) ⭐ 3,541 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,586 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6,382 - A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [gws](https://github.com/lxzan/gws) ⭐ 1,555 - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
- [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,147 - Extremely simple & fast udp tunnel based on KCP protocol.
...
- [mdns](https://github.com/hashicorp/mdns) ⭐ 1,267 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
- [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,316 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 898 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,736 - An implementation of the QUIC protocol in pure Go.
...
- [sftp](https://github.com/pkg/sftp) ⭐ 1,579 - Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>.
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,909 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 14,925 - A pure Go implementation of the WebRTC API.
...
- [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 260 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- [gentleman](https://github.com/h2non/gentleman) ⭐ 1,108 - Full-featured plugin-driven HTTP client library.
...
- [grequests](https://github.com/levigross/grequests) ⭐ 2,156 - A Go "clone" of the great and famous Requests library.
- [heimdall](https://github.com/gojektech/heimdall) ⭐ 2,672 - An enhanced http client with retry and hystrix capabilities.
...
- [req](https://github.com/imroc/req) ⭐ 4,515 - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [requests](https://github.com/carlmjohnson/requests) ⭐ 1,607 - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
- [resty](https://github.com/go-resty/resty) ⭐ 10,960 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,165 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,308 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,200 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,268 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,344 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,882 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,206 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,463 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 170 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,055 - No instrumentation tracing for Golang applications via eBPF.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,481 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,375 - go generate based graphql server library.
...
- [graphql](https://github.com/neelance/graphql-go) ⭐ 4,707 - GraphQL server with a focus on ease of use.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,045 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,865 - gonum/plot provides an API for building and drawing plots in Go.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,068 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,167 - A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 566 - Fast initramfs generator with full-disk encryption support.
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,396 - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,700 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,650 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [simple-scrypt](https://github.com/elithrar/simple-scrypt) ⭐ 199 - Scrypt package with a simple, obvious API and automatic cost calibration built-in.
...
- [teler-waf](https://github.com/kitabisa/teler-waf) ⭐ 379 - teler-waf is a Go HTTP middleware that provide teler IDS functionality to protect against web-based attacks and improve the security of Go-based web applications. It is highly configurable and easy to integrate into existing Go applications.
...
- [cbor](https://github.com/fxamacker/cbor) ⭐ 881 - Small, safe, and easy CBOR encoding and decoding library.
- [colfer](https://github.com/pascaldekloe/colfer) ⭐ 749 - Code generation for the Colfer binary format.
- [csvutil](https://github.com/jszwec/csvutil) ⭐ 981 - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13,779 - High-performance 100% compatible drop-in replacement of "encoding/json".
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,917 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- [Clace](https://github.com/claceio/clace) ⭐ 627 - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
- [consul](https://www.consul.io/) - Consul is a tool for service discovery, monitoring and configuration.
- [cortex-tenant](https://github.com/blind-oracle/cortex-tenant) ⭐ 122 - Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels.
- [devd](https://github.com/cortesi/devd) ⭐ 3,454 - Local webserver for developers.
- [discovery](https://github.com/Bilibili/discovery) ⭐ 1,792 - A registry for resilient mid-tier load balancing and failover.
- [dudeldu](https://github.com/krotik/dudeldu) ⭐ 144 - A simple SHOUTcast server.
- [Easegress](https://github.com/megaease/easegress) ⭐ 5,829 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,613 - Highly-available key value store for shared configuration and service discovery.
- [Euterpe](https://github.com/ironsmile/euterpe) ⭐ 556 - Self-hosted music streaming server with built-in web UI and REST API.
- [Fider](https://github.com/getfider/fider) ⭐ 3,544 - Fider is an open platform to collect and organize customer feedback.
- [Flagr](https://github.com/checkr/flagr) ⭐ 2,499 - Flagr is an open-source feature flagging and A/B testing service.
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,422 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,670 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 53,170 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,802 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,169 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,577 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,137 - Make SSH apps, just like that!
...
- [fasttemplate](https://github.com/valyala/fasttemplate) ⭐ 875 - Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/).
...
- [jet](https://github.com/CloudyKit/jet) ⭐ 1,332 - Jet template engine.
- [liquid](https://github.com/osteele/liquid) ⭐ 303 - Go implementation of Shopify Liquid templates.
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,437 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [go-cmp](https://github.com/google/go-cmp) ⭐ 4,428 - Package for comparing Go values in tests.
...
- [goc](https://github.com/qiniu/goc) ⭐ 856 - Goc is a comprehensive coverage testing system for The Go Programming Language.
- [gocheck](https://labix.org/gocheck) - More advanced testing framework alternative to gotest.
- [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,356 - BDD-style framework with web UI and live reload.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,225 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,118 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testify](https://github.com/stretchr/testify) ⭐ 24,744 - Sacred extension to the standard go testing package.
...
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,375 - Mock SQL driver for testing database interactions.
...
- [gomock](https://github.com/uber-go/mock) ⭐ 2,849 - Mocking framework for the Go programming language.
- [govcr](https://github.com/seborama/govcr) ⭐ 187 - HTTP mock for Golang: record and replay HTTP interactions for offline testing.
- [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,417 - HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI.
- [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,032 - Easy mocking of HTTP responses from external resources.
- [minimock](https://github.com/gojuno/minimock) ⭐ 686 - Mock generator for Go interfaces.
- [mockery](https://github.com/vektra/mockery) ⭐ 6,631 - Tool to generate Go interfaces.
...
- [moq](https://github.com/matryer/moq) ⭐ 2,093 - Utility that generates a struct from any interface. The struct can be used in test code as a mock of the interface.
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 484 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,978.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,917 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,732 - browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 5,993 - A Devtools driver to make web automation and scraping easy.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,560 - Formatters for time, numbers, and memory size to human readable format.
...
- [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,552 - Markdown processor in Go.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,116 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 2,885 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [toml](https://github.com/BurntSushi/toml) ⭐ 4,741 - TOML configuration format (encoder/decoder with reflection).
...
- [go-querystring](https://github.com/google/go-querystring) ⭐ 2,048 - Go library for encoding structs into URL query parameters.
...
- [godump (goforj)](https://github.com/goforj/godump) ⭐ 897 - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
- [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,703 - Parse RSS and Atom feeds in Go.
- [gographviz](https://github.com/awalterschulze/gographviz) ⭐ 562 - Parses the Graphviz DOT language.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,792 - Shell parser and formatter.
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,414 - HTML Sanitizer.
- [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) ⭐ 69 - A sanitization-based swear filter for Go.

### Scrapers

- [colly](https://github.com/asciimoo/colly) ⭐ 24,323 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,533 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,097 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,424 - Go bindings for the Discord Chat API.
...
- [github](https://github.com/google/go-github) ⭐ 10,827 - Go library for accessing the GitHub REST API v3.
- [githubql](https://github.com/shurcooL/githubql) ⭐ 1,151 - Go library for accessing the GitHub GraphQL API v4.
- [go-atlassian](https://github.com/ctreminiom/go-atlassian) ⭐ 164 - Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud)
...
- [go-jira](https://github.com/andygrunwald/go-jira) ⭐ 1,535 - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,066 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [google](https://github.com/google/google-api-go-client) ⭐ 4,265 - Auto-generated Google APIs for Go.
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 2,704 - Minio Go Library for Amazon S3 compatible cloud storage.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,790 - Slack API in Go.
...
- [countries](https://github.com/biter777/countries) ⭐ 451 - Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standards.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,188 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [debounce](https://github.com/floatdrop/debounce) ⭐ 18 - A zero-allocation debouncer written in Go.
- [delve](https://github.com/derekparker/delve) ⭐ 651 - Go debugger.
- [dive](https://github.com/wagoodman/dive) ⭐ 51,097 - A tool for exploring each layer in a Docker image.
...
- [EaseProbe](https://github.com/megaease/easeprobe) ⭐ 2,243 - A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification.
...
- [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,792 - Fault tolerance and resilience patterns for Go.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 71,018 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,745 - Deliver Go binaries as fast and easily as possible.
...
- [goval](https://github.com/maja42/goval) ⭐ 169 - Evaluate arbitrary expressions in Go.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,053 - A comprehensive, efficient, and reusable util function library of go.
...
- [limiters](https://github.com/mennanov/limiters) ⭐ 566 - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
- [lo](https://github.com/samber/lo) ⭐ 19,568 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mergo](https://github.com/imdario/mergo) ⭐ 3,004 - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- [minify](https://github.com/tdewolff/minify) ⭐ 3,892 - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- [mole](https://github.com/davrodpin/mole) ⭐ 1,716 - cli app to easily create ssh tunnels.
...
- [remote-touchpad](https://github.com/Unrud/remote-touchpad) ⭐ 604 - Control mouse and keyboard from a smartphone.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,701 - Simple library for retry mechanism.
...
- [scany](https://github.com/georgysavva/scany) ⭐ 1,432 - Library for scanning data from a database into Go structs and more.
- [serve](https://github.com/syntaqx/serve) ⭐ 341 - A static http server anywhere you need.
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,074 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,001 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [upterm](https://github.com/owenthereal/upterm) ⭐ 924 - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
- [usql](https://github.com/knq/usql) ⭐ 9,398 - usql is a universal command-line interface for SQL databases.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,734 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/gofrs/uuid) ⭐ 1,694 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
- [uuid](https://github.com/google/uuid) ⭐ 5,696 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [xid](https://github.com/rs/xid) ⭐ 4,139 - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- [jio](https://github.com/faceair/jio) ⭐ 118 - jio is a json schema validator similar to [joi](https://github.com/hapijs/joi) ⭐ 21,114.
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 3,933 - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,480 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 872 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,607 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,631 - highly extensible Git implementation in pure Go.
...
- [go-astiav](https://github.com/asticode/go-astiav) ⭐ 509 - Better C bindings for ffmpeg in GO.
...
- [Atreugo](https://github.com/savsgio/atreugo) ⭐ 1,277 - High performance and extensible micro web framework with zero memory allocations in hot paths.
- [Beego](https://github.com/beego/beego) ⭐ 32,119 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,150 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 454 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,869 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,412 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,762 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,807 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,451 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,860 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,308 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,152 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [templui](https://github.com/axzilla/templui) ⭐ 719 - Modern UI Components for Go & Templ.
...
- [Yokai](https://github.com/ankorstore/yokai) ⭐ 720 - Simple, modular, and observable Go framework for backend applications.
...
- [CORS](https://github.com/rs/cors) ⭐ 2,786 - Easily add CORS capabilities to your API.
...
- [Tollbooth](https://github.com/didip/tollbooth) ⭐ 2,798 - Rate limit HTTP request handler.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,949 - Small, fast and expressive HTTP router built on net/context.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,411 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,336 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,983 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,257 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 551 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
- [workflow](https://github.com/luno/workflow) ⭐ 166 - A tech stack agnostic Event Driven Workflow framework.
...
- [xmlquery](https://github.com/antchfx/xmlquery) ⭐ 468 - xmlquery is Golang XPath package for XML query.
...
- [zek](https://github.com/miku/zek) ⭐ 766 - Generate a Go struct from XML.

## Zero Trust

_Libraries and tools to implement Zero Trust architectures._

- [Cosign](https://github.com/sigstore/cosign) ⭐ 5,001 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,370 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,160 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 138 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,744.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 574 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,718 features to Vim/Neovim.
...
- [goimports-reviser](https://github.com/incu6us/goimports-reviser) ⭐ 670 - Formatting tool for imports.
...
- [envdoc](https://github.com/g4s8/envdoc) ⭐ 84 -  generate documentation for environment variables from Go source files.
...
- [gotests](https://github.com/cweill/gotests) ⭐ 5,070 - Generate Go tests from your source code.
...
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,603 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,775 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [MoniGO](https://github.com/iyashjayesh/monigo) ⭐ 271 - A performance monitoring library for Go applications. It provides real-time insights into application performance! 🚀
- [OctoLinker](https://github.com/OctoLinker/browser-extension) ⭐ 5,316 - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.
...
- [alaz](https://github.com/ddosify/alaz) ⭐ 690 - Effortless, Low-Overhead, eBPF-based Kubernetes Monitoring.
- [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,662 - aptly is a Debian repository management tool.
...
- [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,402 - Fast cross-platform HTTP benchmarking tool.
...
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,085 - Lightweight, programmable telemetry for servers and workstations.
...
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,084 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,995 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,974 - Hey is a tiny program that sends some load to a web application.
...
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,950 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,042 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,218 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,737 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,796 - Container Cluster Manager from Google.
...
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,720 - Cloud native application delivery.
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,169 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,548 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,910 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,171 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
- [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,619 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,299 - Pomerium is an identity-aware access proxy.
- [Rodent](https://github.com/alouche/rodent) ⭐ 33 - Rodent helps you manage Go versions, projects and track dependencies.
- [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 359 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,331 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,731 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [skm](https://github.com/TimothyYe/skm) ⭐ 974 - SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily!
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,018 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,170 - Reverse proxy and load balancer with support for multiple backends.
...
- [uTask](https://github.com/ovh/utask) ⭐ 1,283 - Automation engine that models and executes business processes declared in yaml.
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,390 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Chapar](https://github.com/chapar-rest/chapar) ⭐ 578 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
- [Cherry](https://github.com/rafael-santiago/cherry) ⭐ 301 - Tiny webchat server in Go.
- [Circuit](https://github.com/gocircuit/circuit) ⭐ 1,985 - Circuit is a programmable platform-as-a-service (PaaS) and/or Infrastructure-as-a-Service (IaaS), for management, discovery, synchronization and orchestration of services and hosts comprising cloud applications.
- [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,396 - Simulate bad network connections.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,379 - Easily and securely send files or folders from one computer to another.
- [Documize](https://github.com/documize/community) ⭐ 2,251 - Modern wiki software that integrates data from SaaS tools.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,943 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,712 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,688 - LiteIDE is a simple, open source, cross-platform Go IDE.
...
- [restic](https://github.com/restic/restic) ⭐ 29,004 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 699 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,402 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,819 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,308 - Proxy to simulate network and system conditions for automated tests.
...
- [yai](https://github.com/ekkinox/yai) ⭐ 800 - AI powered terminal assistant.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,086 - A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3,753 - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,002
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,574
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,349 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,407 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,630 - Golang ebook intro how to build a web app with golang.
...
- [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,646 - Go's reference card.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,873 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,561 - Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,731 - Examples of Golang compared to Node.js for learning.
...
- [golang-examples](https://github.com/SimonWaldherr/golang-examples) ⭐ 1,625 - Many examples to learn Golang.
...
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,890 - Learn Go with test-driven development.
