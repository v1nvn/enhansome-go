...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main) ⭐ 145,423](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain)
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 246,626.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 145,423 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 145,423; you rock!
...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 3,982 - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,240 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
...
- [langchaingo](https://github.com/tmc/langchaingo) ⭐ 6,834 - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 33,208 - Open Source OpenAI alternative, self-host AI models.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 143,680 - Run large language models locally.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 18,744 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,146 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,115 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
...
- [oauth2](https://github.com/golang/oauth2) ⭐ 5,621 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [openfga](https://github.com/openfga/openfga) ⭐ 3,704 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- [scs](https://github.com/alexedwards/scs) ⭐ 2,345 - Session Manager for HTTP servers.
...
- [gno](https://github.com/gnolang/gno) ⭐ 961 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,123 - Official Go implementation of the Ethereum protocol.
...
- [kubo](https://github.com/ipfs/kubo) ⭐ 16,524 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- [lnd](https://github.com/lightningnetwork/lnd) ⭐ 7,943 - A complete implementation of a Lightning Network node.
...
- [telego](https://github.com/mymmrac/telego) ⭐ 723 - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,175 - Simple and clean Telegram bot client.
- [wayback](https://github.com/wabarc/wayback) ⭐ 1,978 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [air](https://github.com/cosmtrek/air) ⭐ 20,745 - Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4,353 - Mage is a make/rake-like build tool using Go.
...
- [Task](https://github.com/go-task/task) ⭐ 12,965 - simple "Make" alternative.
...
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,413 - TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 32,227 - Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 19,550 - Terminal JSON viewer & processor.
...
- [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,369 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,758.
- [gocui](https://github.com/jroimartin/gocui) ⭐ 10,258 - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,093 - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar](https://github.com/schollz/progressbar) ⭐ 4,413 - Basic thread-safe progress bar that works in every OS.
- [pterm](https://github.com/pterm/pterm) ⭐ 5,109 - A library to beautify console output on every platform with many combinable components.
- [simpletable](https://github.com/alexeyco/simpletable) ⭐ 538 - Simple tables in a terminal with Go.
...
- [termdash](https://github.com/mum4k/termdash) ⭐ 2,829 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,368.
- [termenv](https://github.com/muesli/termenv) ⭐ 1,845 - Advanced ANSI style & color support for your terminal applications.
- [termui](https://github.com/gizak/termui) ⭐ 13,368 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,607.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 682 - Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,287 - Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 40,709 - Commander for modern Go CLI interactions.
...
- [elvish](https://github.com/elves/elvish) ⭐ 6,036 - An expressive programming language and a versatile interactive shell.
...
- [ops](https://github.com/nanovms/ops) ⭐ 1,354 - Unikernel Builder/Orchestrator.
- [pflag](https://github.com/spf13/pflag) ⭐ 2,573 - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 23,244 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 1,843 - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env](https://github.com/caarlos0/env) ⭐ 5,531 - Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 9,355 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,234 - Go library for managing configuration data from environment variables.
- [koanf](https://github.com/knadh/koanf) ⭐ 3,241 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
- [konf](https://github.com/nil-go/konf) ⭐ 322 - The simplest API for reading/watching config from file, env, flag and clouds (e.g. AWS, Azure, GCP).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 8,212 - A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 28,674 - Go configuration with fangs.
...
- [drone](https://github.com/drone/drone) ⭐ 32,859 - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [gotestfmt](https://github.com/GoTestTools/gotestfmt) ⭐ 561 - go test output for humans.
- [goveralls](https://github.com/mattn/goveralls) ⭐ 790 - Go integration for Coveralls.io continuous code coverage tracking system.
- [muffet](https://github.com/raviqqe/muffet) ⭐ 2,566 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,742.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,149 - Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8,376 - A message streaming bridge between a range of protocols.
...
- [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) ⭐ 426 - Concurrent FIFO queue.
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,687 - Distributed, Fault-tolerant task queue.
...
- [queue](https://github.com/adrianbrad/queue) ⭐ 308 - Multiple thread-safe, generic queue implementations for Go.

### Sets

- [dsu](https://github.com/ihebu/dsu) ⭐ 15 - Disjoint Set data structure implementation in Go.
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,528 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 7,849 - Efficient key/value cache for gigabytes of data.
...
- [groupcache](https://github.com/golang/groupcache) ⭐ 13,182 - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,118 -  A high performance memory-bound Go cache.
...
- [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1,061 - An in-memory cache with item expiration and generics.
- [ttlcache](https://github.com/cheshir/ttlcache) ⭐ 10 - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger](https://github.com/dgraph-io/badger) ⭐ 14,652 - Fast key-value store in Go.
- [bbolt](https://github.com/etcd-io/bbolt) ⭐ 8,837 - An embedded key/value database for Go.
- [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,714 - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover](https://github.com/ostafen/clover) ⭐ 756 - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 30,991 - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 20,930 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [DiceDB](https://github.com/DiceDB/dice) ⭐ 10,533 - An open-source, fast, reactive, in-memory database optimized for modern hardware. Higher throughput and lower median latencies, making it ideal for modern workloads.
- [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,433 - Home-grown disk-backed key-value store.
- [dolt](https://github.com/dolthub/dolt) ⭐ 18,739 - Dolt – It's Git for Data.
...
- [godis](https://github.com/hdt3213/godis) ⭐ 3,696 - A Golang implemented high-performance Redis server and cluster.
- [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,272 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 37,736 key/value database in Go.
...
- [immudb](https://github.com/codenotary/immudb) ⭐ 8,751 - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,158 - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 35,361 - Milvus is a vector database for embedding management, analytics and search.
- [moss](https://github.com/couchbase/moss) ⭐ 1,004 - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,475 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
- [objectbox-go](https://github.com/objectbox/objectbox-go) ⭐ 1,229 - High-performance embedded Object Database (NoSQL) with Go API.
- [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,340 - RocksDB/LevelDB inspired key-value database in Go.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 58,968 - Monitoring system and time series database.
...
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,675 - The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 38,573 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,309 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 6,928 - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,568 - Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 149 - Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,051 - A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 8,525 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 16,818 - Database migrations. CLI and Golang library.
...
- [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,360 - HTTP proxy for ClickHouse database.
...
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 8,911 - Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 19,673 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,307 - Generate type-safe code from SQL.
...
- [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,451 - Go library that helps you build SQL queries.
- [xo](https://github.com/knq/xo) ⭐ 3,820 - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 14,852 - MySQL driver for Go.
- [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,523 - SQLite3 driver for go that uses database/sql.
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 710 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 11,972 - PostgreSQL driver supporting features beyond those exposed by database/sql.
- [pig](https://github.com/alexeyco/pig) ⭐ 17 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 11,972 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,432 query results easily.
...
- [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,370 - Official MongoDB driver for the Go language.
...
- [qmgo](https://github.com/qiniu/qmgo) ⭐ 1,325 - The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo.
- [redeo](https://github.com/bsm/redeo) ⭐ 445 - Redis-protocol compatible TCP servers/services.
- [redigo](https://github.com/gomodule/redigo) ⭐ 9,822 - Redigo is a Go client for the Redis database.
- [redis](https://github.com/redis/go-redis) ⭐ 20,964 - Redis client for Golang.
- [rueidis](http://github.com/rueian/rueidis) ⭐ 2,690 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
- [xredis](https://github.com/shomali11/xredis) ⭐ 19 - Typesafe, customizable, clean & easy to use Redis client.

### Search and Analytic Databases

- [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,068 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
- [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 5,890 - Official Elasticsearch client for Go.
...
- [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,186 - A feature complete and high performance multi-group Raft library in Go.
...
- [go-eagle](https://github.com/go-eagle/eagle) ⭐ 2,319 - A Go framework for the API or Microservice with handy scaffolding tools.
...
- [go-kit](https://github.com/go-kit/kit) ⭐ 27,088 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro](https://github.com/micro/go-micro) ⭐ 22,343 - A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,209 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 709 - Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 21,928 - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,040 - A cloud native Kubernetes Global Balancer.
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,474 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,452 - A modular-designed and easy-to-use microservices framework in Go.
...
- [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,536 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
- [NATS](https://github.com/nats-io/nats-server) ⭐ 17,317 - NATS is a simple, secure, and
...
- [raft](https://github.com/hashicorp/raft) ⭐ 8,629 - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
- [sleuth](https://github.com/ursiform/sleuth) ⭐ 380 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,290).
- [sponge](https://github.com/zhufuyi/sponge) ⭐ 1,890 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 14,941 - Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,213 - Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5,010 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
- [SendGrid](https://github.com/sendgrid/sendgrid-go) ⭐ 1,015 - SendGrid's Go library for sending email.
...
- [binder](https://github.com/alexeyco/binder) ⭐ 79 - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,610.
...
- [expr](https://github.com/antonmedv/expr) ⭐ 6,936 - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 8,091 - PHP embedded in Go, with a `net/http` handler.
...
- [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,275 - Port of the Lua 5.2 VM to pure Go.
...
- [goja](https://github.com/dop251/goja) ⭐ 6,212 - ECMAScript 5.1(+) implementation in Go.
- [golua](https://github.com/aarzilli/golua) ⭐ 673 - Go bindings for Lua C API.
- [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,610 - Lua 5.1 VM and compiler written in Go.
...
- [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,580 - The Wa Programming Language embedded in Go.
...
- [errors](https://github.com/cockroachdb/errors) ⭐ 2,231 - Go error library with error portability over the network.
...
- [Fault](https://github.com/Southclaws/fault) ⭐ 279 - An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values.
- [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2,457 - Go (golang) package for representing a list of errors as a single error.
...
- [oops](https://github.com/samber/oops) ⭐ 685 - Error handling with context, stack trace and source fragments.
...
- [afs](https://github.com/viant/afs) ⭐ 336 - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 4,519 - Disk usage analyzer with console interface.
...
- [go-wkhtmltopdf](https://github.com/SebastiaanKlippert/go-wkhtmltopdf) ⭐ 1,122 - A package to convert an HTML template to a PDF file.
- [gofs](https://github.com/no-src/gofs) ⭐ 508 - A cross-platform real-time file synchronization tool out of the box.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,712 - PDF processor.
...
- [todotxt](https://github.com/1set/todotxt) ⭐ 25 - Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt) ⭐ 2,808.
...
- [ach](https://github.com/moov-io/ach) ⭐ 488 - A reader, writer, and validator for Automated Clearing House (ACH) files.
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1,363 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 6,781 - Arbitrary-precision fixed-point decimal numbers.
- [decimal](https://github.com/govalues/decimal) ⭐ 164 - Immutable decimal numbers with panic-free arithmetic.
...
- [ledger](https://github.com/formancehq/ledger) ⭐ 976 - A programmable financial ledger that provides a foundation for money-moving applications.
...
- [orderbook](https://github.com/i25959341/orderbook) ⭐ 491 - Matching Engine for Limit Order Book in Golang.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 5,276 - Terminal stock watcher and stock position tracker.
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,121 - dead simple 2D game engine in Go.
...
- [goworld](https://github.com/xiaonanln/goworld) ⭐ 2,649 - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- [Leaf](https://github.com/name5566/leaf) ⭐ 5,412 - Lightweight game server framework.
...
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,558 - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [tile](https://github.com/kelindar/tile) ⭐ 193 - Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,203 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [Tile38](https://github.com/tidwall/tile38) ⭐ 9,343 - Geolocation DB with spatial index and realtime geofencing.
...
- [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,393 - Compile shell scripts to Go.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 13,739 - A high-performance and low-cost goroutine pool in Go.
...
- [pond](https://github.com/alitto/pond) ⭐ 1,792 - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [app](https://github.com/murlokswarm/app) ⭐ 8,689 - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 413 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 66,148 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,657.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 26,576 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [qt](https://github.com/therecipe/qt) ⭐ 10,670 - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- [unison](https://github.com/richardwilkes/unison) ⭐ 268 - A unified graphical user experience toolkit for Go desktop applications. macOS, Windows, and Linux are supported.
...
- [webview](https://github.com/zserge/webview) ⭐ 13,156 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,183 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,569 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [gg](https://github.com/fogleman/gg) ⭐ 4,603 - 2D rendering in pure Go.
- [gift](https://github.com/disintegration/gift) ⭐ 1,772 - Package of image processing filters.
...
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 3,777 - Screenshoting webpages using go and headless chrome on command line.
...
- [imaginary](https://github.com/h2non/imaginary) ⭐ 5,860 - Fast and simple HTTP microservice for image resizing.
- [imaging](https://github.com/disintegration/imaging) ⭐ 5,490 - Simple Go image processing package.
- [imagor](https://github.com/cshum/imagor) ⭐ 3,650 - Fast, secure image processing server and Go library, using libvips.
...
- [transformimgs](https://github.com/Pixboost/transformimgs) ⭐ 264 - Transformimgs resizes and optimises images for Web using next-generation formats.
...
- [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,191 - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1,125 - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 6,297 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,491.
...
- [gronx](https://github.com/adhocore/gronx) ⭐ 451 - Cron expression parser, task runner and daemon consuming crontab like task list.
...
- [fastjson](https://github.com/valyala/fastjson) ⭐ 2,380 - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
...
- [GJSON](https://github.com/tidwall/gjson) ⭐ 14,979 - Get a JSON value with one line of code.
...
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 557 - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,303 - Structured logger for Go.
- [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,303 logger.
- [logrusly](https://github.com/sebest/logrusly) ⭐ 28 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,303 plug-in to send errors to a [Loggly](https://www.loggly.com/).
- [logur](https://github.com/logur/logur) ⭐ 205 - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,303, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,088, [zap](https://github.com/uber-go/zap) ⭐ 23,198, [zerolog](https://github.com/rs/zerolog) ⭐ 11,492, etc).
...
- [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,123 - Simple rolling logger, implements io.WriteCloser.
...
- [phuslu/log](https://github.com/phuslu/log) ⭐ 767 - High performance structured logging.
...
- [spew](https://github.com/davecgh/go-spew) ⭐ 6,248 - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1,013 - A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 23,198 - Fast, structured, leveled logging in Go.
- [zax](https://github.com/yuseferi/zax) ⭐ 27 - Integrate Context with Zap logger, which leads to more flexibility in Go logging.
- [zerolog](https://github.com/rs/zerolog) ⭐ 11,492 - Zero-allocation JSON logger.
...
- [GoLearn](https://github.com/sjwhitworth/golearn) ⭐ 9,402 - General Machine Learning library for Go.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 800 - An accelerated Machine Learning framework for Go.
...
- [gosseract](https://github.com/otiai10/gosseract) ⭐ 2,889 - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 410 - Huggingface transformer pipelines for golang with onnxruntime.
...
- [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 787 - Go Interface to Open Neural Network Exchange (ONNX).
...
- [amqp](https://github.com/rabbitmq/amqp091-go) ⭐ 1,781 - Go RabbitMQ Client Library.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 11,351 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,023 - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,904 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- [go-nsq](https://github.com/nsqio/go-nsq) ⭐ 2,628 - the official Go package for NSQ.
...
- [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,767 - Asynchronous task queue/job queue based on distributed message passing.
...
- [melody](https://github.com/olahol/melody) ⭐ 3,923 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
- [Mercure](https://github.com/dunglas/mercure) ⭐ 4,960 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [sarama](https://github.com/Shopify/sarama) ⭐ 12,031 - Go library for Apache Kafka.
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,543 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [excelize](https://github.com/xuri/excelize) ⭐ 19,259 - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [xlsx](https://github.com/tealeg/xlsx) ⭐ 5,972 - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
- [dig](https://github.com/uber-go/dig) ⭐ 4,197 - A reflection based dependency injection toolkit for Go.
...
- [fx](https://github.com/uber-go/fx) ⭐ 6,567 - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire](https://github.com/google/wire) ⭐ 13,833 - Automated Initialization in Go.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 7,606 - Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 52,723 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 52,723 for more information. Nonetheless, some may find the layout useful.
...
- [nunu](https://github.com/go-nunu/nunu) ⭐ 2,253 - Nunu is a scaffolding tool for building Go applications.
...
- [base64Captcha](https://github.com/mojocn/base64Captcha) ⭐ 2,243 - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 7,539 - Automated service health dashboard.
...
- [go-resiliency](https://github.com/eapache/go-resiliency) ⭐ 2,293 - Resiliency patterns for golang.
- [go-unarr](https://github.com/gen2brain/go-unarr) ⭐ 292 - Decompression library for RAR, TAR, ZIP and 7z archives.
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 4,956 - Random data generator written in go.
...
- [gtree](https://github.com/ddddddO/gtree) ⭐ 300 - Provide CLI, Package and Web for tree output and directories creation from Markdown or programmatically.
...
- [shortid](https://github.com/teris-io/shortid) ⭐ 951 - Distributed generation of super short, unique, non-sequential, URL friendly IDs.
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,264 - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
- [sitemap-format](https://github.com/mingard/sitemap-format) ⭐ 6 - A simple sitemap generator, with a little syntactic sugar.
- [stateless](https://github.com/qmuntal/stateless) ⭐ 1,061 - A fluent library for creating state machines.
...
- [govader](https://github.com/jonreiter/govader) ⭐ 50 - Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 4,735.
...
- [kagome](https://github.com/ikawaha/kagome) ⭐ 874 - JP morphological analyzer written in pure Go.
...
- [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,528 - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) ⭐ 34,157 which a Chinese word splitting algorithm.
...
- [gse](https://github.com/go-ego/gse) ⭐ 2,665 - Go efficient text segmentation; support english, chinese, japanese and other.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,256 - Package and an accompanying tool to work with localized text.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 10,790 - Cloudflare Tunnel client (formerly Argo Tunnel).
- [dhcp6](https://github.com/mdlayher/dhcp6) ⭐ 79 - Package dhcp6 implements a DHCPv6 server, as described in RFC 3315.
- [dns](https://github.com/miekg/dns) ⭐ 8,375 - Go library for working with DNS.
...
- [fortio](https://github.com/fortio/fortio) ⭐ 3,540 - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- [gaio](https://github.com/xtaci/gaio) ⭐ 787 - High performance async-io networking for Golang in proactor mode.
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 10,580 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 3,809 - BGP implemented in the Go Programming Language.
...
- [gws](https://github.com/lxzan/gws) ⭐ 1,553 - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,264 - KCP - Fast and Reliable ARQ Protocol.
...
- [mdns](https://github.com/hashicorp/mdns) ⭐ 1,266 - Simple mDNS (Multicast DNS) client/server library in Golang.
...
- [nbio](https://github.com/lesismal/nbio) ⭐ 2,504 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
- [net](https://golang.org/x/net) - This repository holds supplementary Go networking libraries.
- [netpoll](https://github.com/cloudwego/netpoll) ⭐ 4,311 - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [nodepass](https://github.com/yosebyte/nodepass) ⭐ 860 - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,731 - An implementation of the QUIC protocol in pure Go.
...
- [ssh](https://github.com/gliderlabs/ssh) ⭐ 3,912 - Higher-level API for building SSH servers (wraps crypto/ssh).
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 3,908 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
- [resty](https://github.com/go-resty/resty) ⭐ 10,957 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1,163 - net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bob](https://github.com/stephenafamo/bob) ⭐ 1,307 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
- [bun](https://github.com/uptrace/bun) ⭐ 4,193 - SQL-first Golang ORM. Successor of go-pg.
...
- [ent](https://github.com/facebook/ent) ⭐ 16,256 - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 38,334 - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,881 - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- [syft](https://github.com/anchore/syft) ⭐ 7,201 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- [go-instrument](https://github.com/nikolaydubina/go-instrument) ⭐ 266 - Automatically add spans to all methods and functions.
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,456 - A distributed tracing system.
- [mm-go](https://github.com/joetifa2003/mm-go) ⭐ 170 - Generic manual memory management for golang.
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,053 - No instrumentation tracing for Golang applications via eBPF.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 7,476 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,072 - Implementation of GraphQL for Go.
...
- [gonum](https://github.com/gonum/gonum) ⭐ 8,043 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- [gonum/plot](https://github.com/gonum/plot) ⭐ 2,864 - gonum/plot provides an API for building and drawing plots in Go.
...
- [age](https://github.com/FiloSottile/age) ⭐ 19,055 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [CertMagic](https://github.com/caddyserver/certmagic) ⭐ 5,238 - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,696 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 8,644 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
- [luks.go](https://github.com/anatol/luks.go) ⭐ 90 - Pure Golang library to manage LUKS partitions.
- [memguard](https://github.com/awnumar/memguard) ⭐ 2,635 - A pure Go library for handling sensitive values in memory.
...
- [simple-scrypt](https://github.com/elithrar/simple-scrypt) ⭐ 198 - Scrypt package with a simple, obvious API and automatic cost calibration built-in.
...
- [goprotobuf](https://github.com/golang/protobuf) ⭐ 9,960 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 64,872 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 49,598 - Highly-available key value store for shared configuration and service discovery.
...
- [flipt](https://github.com/markphelps/flipt) ⭐ 4,415 - A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,668 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 53,121 - Minio is a distributed object storage server.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 47,782 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,166 - High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,560 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 4,135 - Make SSH apps, just like that!
...
- [go-streams](https://github.com/reugn/go-streams) ⭐ 2,046 - Go stream processing library.
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2,434 - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [sprout](https://github.com/go-sprout/sprout) ⭐ 169 - Useful template functions for Go templates.
...
- [templ](https://github.com/a-h/templ) ⭐ 9,378 - A HTML templating language that has great developer tooling.
...
- [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,355 - BDD-style framework with web UI and live reload.
- [gocrest](https://github.com/corbym/gocrest) ⭐ 106 - Composable hamcrest-like matchers for Go assertions.
- [godog](https://github.com/cucumber/godog) ⭐ 2,441 - Cucumber BDD framework for Go.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 10,213 - Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,105 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
- [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,160 - A helper for Rails' like test fixtures to test database applications.
- [Testify](https://github.com/stretchr/testify) ⭐ 24,734 - Sacred extension to the standard go testing package.
...
- [gock](https://github.com/h2non/gock) ⭐ 2,172 - Versatile HTTP mocking made easy.
- [gomock](https://github.com/uber-go/mock) ⭐ 2,846 - Mocking framework for the Go programming language.
- [govcr](https://github.com/seborama/govcr) ⭐ 187 - HTTP mock for Golang: record and replay HTTP interactions for offline testing.
- [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,415 - HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI.
...
- [mockery](https://github.com/vektra/mockery) ⭐ 6,627 - Tool to generate Go interfaces.
...
- [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 483 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 11,972.
...
- [chromedp](https://github.com/knq/chromedp) ⭐ 11,910 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,557 - Formatters for time, numbers, and memory size to human readable format.
- [gotabulate](https://github.com/bndr/gotabulate) ⭐ 338 - Easily pretty-print your tabular data with Go.
- [sq](https://github.com/neilotoole/sq) ⭐ 2,291 - Convert data from SQL databases or document formats like CSV or Excel into formats such as JSON, Excel, CSV, HTML, Markdown, XML, and YAML.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 4,111 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [sh](https://github.com/mvdan/sh) ⭐ 7,786 - Shell parser and formatter.
- [tokenizer](https://github.com/bzick/tokenizer) ⭐ 125 - Parse any string, slice or infinite buffer to any tokens.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 24,314 - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,530 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,094 - The official AWS SDK for the Go programming language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,421 - Go bindings for the Discord Chat API.
...
- [github](https://github.com/google/go-github) ⭐ 10,825 - Go library for accessing the GitHub REST API v3.
...
- [go-lark](https://github.com/go-lark/lark) ⭐ 222 - An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,062 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4,789 - Slack API in Go.
...
- [config-file-validator](https://github.com/Boeing/config-file-validator) ⭐ 376 - Cross Platform tool to validate configuration files.
...
- [ctop](https://github.com/bcicen/ctop) ⭐ 16,181 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 51,073 - A tool for exploring each layer in a Docker image.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 70,951 - Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 14,741 - Deliver Go binaries as fast and easily as possible.
...
- [jump](https://github.com/gsamokovarov/jump) ⭐ 1,855 - Jump helps you navigate faster by learning your habits.
...
- [lancet](https://github.com/duke-git/lancet) ⭐ 5,051 - A comprehensive, efficient, and reusable util function library of go.
...
- [mc](https://github.com/minio/mc) ⭐ 3,060 - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
...
- [panicparse](https://github.com/maruel/panicparse) ⭐ 3,667 - Groups similar goroutines and colorizes stack dump.
- [pattern-match](https://github.com/alexpantyukhin/go-pattern-match) ⭐ 248 - Pattern matching library.
- [peco](https://github.com/peco/peco) ⭐ 7,753 - Simplistic interactive filtering tool.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2,700 - Simple library for retry mechanism.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 1,071 - Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 16,995 - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql](https://github.com/knq/usql) ⭐ 9,396 - usql is a universal command-line interface for SQL databases.
...
- [ulid](https://github.com/oklog/ulid) ⭐ 4,731 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid](https://github.com/gofrs/uuid) ⭐ 1,690 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
- [uuid](https://github.com/google/uuid) ⭐ 5,691 - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [govalid](https://github.com/twharmon/govalid) ⭐ 91 - Fast, tag-based validation for structs.
...
- [validator](https://github.com/go-playground/validator) ⭐ 18,469 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [Zog](https://github.com/Oudwins/zog) ⭐ 870 - A [Zod](https://github.com/colinhacks/zod) ⭐ 38,567 inspired schema builder for runtime value parsing and validation.
**[⬆ back to top](#contents)**
...
- [go-git](https://github.com/go-git/go-git) ⭐ 6,622 - highly extensible Git implementation in pure Go.
...
- [m3u8](https://github.com/grafov/m3u8) ⭐ 1,263 - Parser and generator library of M3U8 playlists for Apple HLS.
...
- [Beego](https://github.com/beego/beego) ⭐ 32,116 - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo](https://github.com/labstack/echo) ⭐ 31,135 - High performance, minimalist Go web framework.
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 453 - A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 36,854 - An Express.js inspired web framework build on Fasthttp.
...
- [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,411 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
- [Gin](https://github.com/gin-gonic/gin) ⭐ 82,729 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- [Ginrpc](https://github.com/xxjwxc/ginrpc) ⭐ 297 - Gin parameter automatic binding tool,gin rpc tools.
- [Goa](https://github.com/goadesign/goa) ⭐ 5,877 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 11,809 - Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 12,444 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 3,856 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,303 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Ronykit](https://github.com/clubpay/ronykit) ⭐ 31 - Web framework with pluggable architecture and very performant.
- [rux](https://github.com/gookit/rux) ⭐ 97 - Simple and fast web framework for build golang HTTP applications.
- [templui](https://github.com/axzilla/templui) ⭐ 707 - Modern UI Components for Go & Templ.
...
- [alice](https://github.com/justinas/alice) ⭐ 3,258 - Painless middleware chaining for Go.
...
- [chi](https://github.com/go-chi/chi) ⭐ 19,937 - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 16,893 - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux](https://github.com/gorilla/mux) ⭐ 21,410 - Powerful URL router and dispatcher for golang.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,324 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 10,976 - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,253 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 4,997 - Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,363 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 107 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39
...
- [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) ⭐ 939 - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,148 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
- [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,465 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
- [testifylint](https://github.com/Antonboom/testifylint) ⭐ 137 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 24,734.
...
- [vacuum](https://github.com/daveshanley/vacuum) ⭐ 781 - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 574 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,711 features to Vim/Neovim.
...
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,598 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
- [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,774 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [OctoLinker](https://github.com/OctoLinker/browser-extension) ⭐ 5,313 - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,134 - Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,079 - Lightweight, programmable telemetry for servers and workstations.
- [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,222 - Build powerful pipelines in any programming language.
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,752 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 49,067 - Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 10,989 - GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 18,963 - Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 5,848 - Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 29,935 - Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 28,031 - A modern load testing tool, using Go and JavaScript.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,210 - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8,034 - Command line tool for building and deploying Go applications on Kubernetes
- [kool](https://github.com/kool-dev/kool) ⭐ 687 - Command line tool for managing Docker environments as an easy way.
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,734 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 115,754 - Container Cluster Manager from Google.
...
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,716 - Cloud native application delivery.
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,167 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 30,540 - Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 69,897 - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,169 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,295 - Pomerium is an identity-aware access proxy.
...
- [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,320 - Blazing fast S3 and local filesystem execution tool.
...
- [script](https://github.com/bitfield/script) ⭐ 6,728 - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- [tau](https://github.com/taubyte/tau) ⭐ 4,014 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- [traefik](https://github.com/containous/traefik) ⭐ 55,139 - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,291 - HTTP load testing tool and library. It's over 9000!
...
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,383 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [Chapar](https://github.com/chapar-rest/chapar) ⭐ 577 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
- [croc](https://github.com/schollz/croc) ⭐ 30,365 - Easily and securely send files or folders from one computer to another.
- [Documize](https://github.com/documize/community) ⭐ 2,248 - Modern wiki software that integrates data from SaaS tools.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,456 - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 1,939 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- [Gor](https://github.com/buger/gor) ⭐ 18,958 - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 11,705 - Distributed POSIX file system built on top of Redis and AWS S3.
...
- [nes](https://github.com/fogleman/nes) ⭐ 5,561 - Nintendo Entertainment System (NES) emulator written in Go.
- [Orbit](https://github.com/gulien/orbit) ⭐ 185 - A simple tool for running commands and generating files from templates.
- [peg](https://github.com/pointlander/peg) ⭐ 1,060 - Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator.
...
- [restic](https://github.com/restic/restic) ⭐ 28,981 - De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 697 - sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 7,396 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 24,801 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
- [shell2http](https://github.com/msoap/shell2http) ⭐ 1,411 - Executing shell commands via http server (for prototyping or remote control).
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 11,304 - Proxy to simulate network and system conditions for automated tests.
...
- [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 421 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,071 - A curated list of Go books.
...
- [gophers](https://github.com/egonelbre/gophers) ⭐ 3,656 - Free gophers.
...
- [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 30,991
- [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- [Google](https://google.github.io/styleguide/go/)
- [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,149
...
- [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,569
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 38,323 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 32,638 - List of other amazingly awesome lists.
...
- [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 128,366 - List of projects on the Go community wiki.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,622 - Golang ebook intro how to build a web app with golang.
...
- [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 6,865 - Clean Architecture template for Golang services.
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,553 - Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4,730 - Examples of Golang compared to Node.js for learning.
...
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 22,876 - Learn Go with test-driven development.
