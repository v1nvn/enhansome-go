...
[![Build Status](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/avelino/awesome-go/actions/workflows/tests.yaml?query=branch%3Amain) ⭐ 150,730 | 🐛 146 | 🌐 Go | 📅 2025-08-21
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 394,628 | 🐛 55 | 📅 2025-07-18
[![Slack Widget](https://img.shields.io/badge/join-us%20on%20slack-gray.svg?longCache=true\&logo=slack\&colorB=red)](https://gophers.slack.com/messages/awesome)
[![Netlify Status](https://api.netlify.com/api/v1/badges/83a6dcbe-0da6-433e-b586-f68109286bd5/deploy-status)](https://app.netlify.com/sites/awesome-go/deploys)
[![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/avelino/awesome-go/)
[![Last Commit](https://img.shields.io/github/last-commit/avelino/awesome-go)](https://github.com/avelino/awesome-go/commits/main) ⭐ 150,730 | 🐛 146 | 🌐 Go | 📅 2025-08-21
...
> A curated list of awesome Go frameworks, libraries, and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 256,564 | 🐛 488 | 🌐 Python | 📅 2025-07-17.

**Contributing:**

Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md) ⭐ 150,730 | 🐛 146 | 🌐 Go | 📅 2025-08-21 first. Thanks to all [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ⭐ 150,730 | 🐛 146 | 🌐 Go | 📅 2025-08-21; you rock!
...
* [ProtoActor](https://github.com/asynkron/protoactor-go) ⭐ 5,304 | 🐛 55 | 🌐 Go | 📅 2025-08-24 - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
...
* [Goakt](https://github.com/Tochemey/goakt) ⭐ 276 | 🐛 0 | 🌐 Go | 📅 2025-08-24 - Fast and Distributed Actor framework using protocol buffers as message for Golang.

## Artificial Intelligence

*Libraries for building programs that leverage AI.*

* [Ollama](https://github.com/jmorganca/ollama) ⭐ 150,846 | 🐛 2,135 | 🌐 Go | 📅 2025-08-24 - Run large language models locally.
* [LocalAI](https://github.com/mudler/LocalAI) ⭐ 34,820 | 🐛 395 | 🌐 Go | 📅 2025-08-24 - Open Source OpenAI alternative, self-host AI models.
* [langchaingo](https://github.com/tmc/langchaingo) ⭐ 7,448 | 🐛 363 | 🌐 Go | 📅 2025-08-24 - LangChainGo is a framework for developing applications powered by language models.
* [chromem-go](https://github.com/philippgille/chromem-go) ⭐ 686 | 🐛 12 | 🌐 Go | 📅 2025-08-02 - Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-memory with optional persistence.
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 19,053 | 🐛 27 | 🌐 Go | 📅 2025-08-14 - Authorization library that supports access control models like ACL, RBAC, and ABAC.
* [jwt-go](https://github.com/golang-jwt/jwt) ⭐ 8,407 | 🐛 43 | 🌐 Go | 📅 2025-08-21 - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
* [goth](https://github.com/markbates/goth) ⭐ 6,181 | 🐛 131 | 🌐 Go | 📅 2025-08-22 - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
* [spicedb](https://github.com/authzed/spicedb) ⭐ 5,970 | 🐛 114 | 🌐 Go | 📅 2025-08-21 - A Zanzibar-inspired database that enables fine-grained authorization.
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,680 | 🐛 43 | 🌐 Go | 📅 2025-08-13 - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
* [keto](https://github.com/ory/keto) ⭐ 5,096 | 🐛 58 | 🌐 Go | 📅 2025-08-22 - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
* [openfga](https://github.com/openfga/openfga) ⭐ 4,026 | 🐛 139 | 🌐 Go | 📅 2025-08-23 - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
* [scs](https://github.com/alexedwards/scs) ⭐ 2,396 | 🐛 33 | 🌐 Go | 📅 2025-08-13 - Session Manager for HTTP servers.
* [jwx](https://github.com/lestrrat-go/jwx) ⭐ 2,187 | 🐛 5 | 🌐 Go | 📅 2025-08-21 - Go module implementing various JWx (JWA/JWE/JWK/JWS/JWT, otherwise known as JOSE) technologies
...
* [oidc](https://github.com/zitadel/oidc) ⭐ 1,640 | 🐛 27 | 🌐 Go | 📅 2025-08-19 - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
...
* [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 49,620 | 🐛 322 | 🌐 Go | 📅 2025-08-25 - Official Go implementation of the Ethereum protocol.
* [kubo](https://github.com/ipfs/kubo) ⭐ 16,656 | 🐛 1,074 | 🌐 Go | 📅 2025-08-24 - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
* [lnd](https://github.com/lightningnetwork/lnd) ⭐ 8,005 | 🐛 805 | 🌐 Go | 📅 2025-08-20 - A complete implementation of a Lightning Network node.
* [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) ⭐ 6,705 | 🐛 203 | 🌐 Go | 📅 2025-08-25 - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,827 | 🐛 26 | 🌐 Go | 📅 2025-08-21 - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
* [gno](https://github.com/gnolang/gno) ⭐ 987 | 🐛 701 | 🌐 Go | 📅 2025-08-25 - A comprehensive smart contract suite built with Golang and Gnolang, a deterministic, purpose-built Go variant for blockchains.
* [cometbft](https://github.com/cometbft/cometbft) ⭐ 774 | 🐛 302 | 🌐 Go | 📅 2025-08-22 - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
* [gossamer](https://github.com/ChainSafe/gossamer) ⭐ 452 | 🐛 403 | 🌐 Go | 📅 2025-08-25 - A Go implementation of the Polkadot Host.
...
* [wayback](https://github.com/wabarc/wayback) ⭐ 2,048 | 🐛 56 | 🌐 Go | 📅 2025-08-19 - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
* [air](https://github.com/cosmtrek/air) ⭐ 21,482 | 🐛 186 | 🌐 Go | 📅 2025-05-31 - Air - Live reload for Go apps.
* [Task](https://github.com/go-task/task) ⭐ 13,400 | 🐛 400 | 🌐 Go | 📅 2025-08-25 - simple "Make" alternative.
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 34,670 | 🐛 125 | 🌐 Go | 📅 2025-08-19 - Go framework to build terminal apps, based on The Elm Architecture.
* [fx](https://github.com/antonmedv/fx) ⭐ 19,777 | 🐛 5 | 🌐 Go | 📅 2025-08-21 - Terminal JSON viewer & processor.
* [termui](https://github.com/gizak/termui) ⭐ 13,412 | 🐛 104 | 🌐 Go | 📅 2025-07-10 - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,633 | 🐛 97 | 🌐 JavaScript | 📅 2024-01-09.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,347 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go library aimed at creating Console User Interfaces.
* [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 9,524 | 🐛 91 | 🌐 Go | 📅 2025-08-18 - Declaratively define styles for color, format and layout in the terminal.
* [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 6,824 | 🐛 170 | 🌐 Go | 📅 2025-08-24 - TUI components for bubbletea.
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,397 | 🐛 114 | 🌐 Go | 📅 2025-08-12 - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 9,897 | 🐛 676 | 🌐 Python | 📅 2025-08-17.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,217 | 🐛 66 | 🌐 Go | 📅 2025-08-08 - A library to beautify console output on every platform with many combinable components.
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 2,873 | 🐛 48 | 🌐 Go | 📅 2024-09-24 - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui) ⭐ 13,412 | 🐛 104 | 🌐 Go | 📅 2025-07-10.
...
* [cobra](https://github.com/spf13/cobra) ⭐ 41,531 | 🐛 322 | 🌐 Go | 📅 2025-08-11 - Commander for modern Go CLI interactions.
* [urfave/cli](https://github.com/urfave/cli) ⭐ 23,454 | 🐛 50 | 🌐 Go | 📅 2025-08-16 - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [kingpin](https://github.com/alecthomas/kingpin) ⭐ 3,538 | 🐛 29 | 🌐 Go | 📅 2025-08-24 - Command line and flag parser supporting sub commands (superseded by `kong`; see below).
...
* [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,179 | 🐛 31 | 🌐 Go | 📅 2025-07-12 - Struct-based argument parsing in Go.
* [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1,410 | 🐛 79 | 🌐 Go | 📅 2025-08-24 - Multi-shell multi-command argument completer.
...
* [carapace-spec](https://github.com/rsteube/carapace-spec) ⭐ 22 | 🐛 18 | 🌐 Go | 📅 2025-08-24 - Define simple completions using a spec file.
...
* [viper](https://github.com/spf13/viper) ⭐ 29,131 | 🐛 520 | 🌐 Go | 📅 2025-08-21 - Go configuration with fangs.
* [godotenv](https://github.com/joho/godotenv) ⭐ 9,683 | 🐛 77 | 🌐 Go | 📅 2024-12-16 - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
* [sonic](https://github.com/bytedance/sonic) ⭐ 8,528 | 🐛 26 | 🌐 Go | 📅 2025-08-22 - A blazingly fast JSON serializing & deserializing library.
* [env](https://github.com/caarlos0/env) ⭐ 5,709 | 🐛 12 | 🌐 Go | 📅 2025-08-12 - Parse environment variables to Go structs (with defaults).
...
* [koanf](https://github.com/knadh/koanf) ⭐ 3,408 | 🐛 11 | 🌐 Go | 📅 2025-08-22 - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
* [envh](https://github.com/antham/envh) ⭐ 100 | 🐛 1 | 🌐 Go | 📅 2025-08-25 - Helpers to manage environment variables.
...
* [drone](https://github.com/drone/drone) ⭐ 33,124 | 🐛 76 | 🌐 Go | 📅 2025-08-22 - Drone is a Continuous Integration platform built on Docker, written in Go.
* [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 5,399 | 🐛 346 | 🌐 Go | 📅 2025-08-25 - Woodpecker is a community fork of the Drone CI system.
* [CDS](https://github.com/ovh/cds) ⭐ 4,753 | 🐛 158 | 🌐 Go | 📅 2025-08-22 - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
* [muffet](https://github.com/raviqqe/muffet) ⭐ 2,570 | 🐛 23 | 🌐 Go | 📅 2025-08-19 - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) ⭐ 2,909 | 🐛 100 | 🌐 Rust | 📅 2025-08-24.
...
* [CloudQuery](http://github.com/cloudquery/cloudquery) ⭐ 6,181 | 🐛 161 | 🌐 Go | 📅 2025-08-23 - A high-performance ELT data integration framework with pluggable architecture.
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,750 | 🐛 69 | 🌐 Go | 📅 2025-08-19 - Go package implementing compressed bitsets.
...
* [bitset](https://github.com/bits-and-blooms/bitset) ⭐ 1,444 | 🐛 3 | 🌐 Go | 📅 2025-08-18 - Go package implementing bitsets.
...
* [bloom](https://github.com/bits-and-blooms/bloom) ⭐ 2,647 | 🐛 19 | 🌐 Go | 📅 2025-08-18 - Go package implementing Bloom filters.
...
* [gods](https://github.com/emirpasic/gods) ⭐ 17,098 | 🐛 68 | 🌐 Go | 📅 2025-03-12 - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
* [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 5,963 | 🐛 94 | 🌐 Python | 📅 2025-08-22 - Distributed, Fault-tolerant task queue.
...
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,584 | 🐛 13 | 🌐 Go | 📅 2025-08-15 - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
* [go-edlib](https://github.com/hbollon/go-edlib) ⭐ 558 | 🐛 0 | 🌐 Go | 📅 2025-08-19 - Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode.
...
* [ristretto](https://github.com/dgraph-io/ristretto) ⭐ 6,397 | 🐛 7 | 🌐 Go | 📅 2025-08-20 -  A high performance memory-bound Go cache.
...
* [otter](https://github.com/maypok86/otter) ⭐ 2,290 | 🐛 1 | 🌐 Go | 📅 2025-08-12 - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
* [jetcache-go](https://github.com/mgtv-tech/jetcache-go) ⭐ 507 | 🐛 4 | 🌐 Go | 📅 2025-08-11 - Unified Go cache library supporting multi-level caching.
...
* [go-freelru](https://github.com/elastic/go-freelru) ⭐ 249 | 🐛 18 | 🌐 Go | 📅 2025-08-21 A GC-less, fast and generic LRU hashmap library with optional locking, sharding, eviction and expiration.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 60,058 | 🐛 728 | 🌐 Go | 📅 2025-08-22 - Monitoring system and time series database.
* [tidb](https://github.com/pingcap/tidb) ⭐ 38,926 | 🐛 5,224 | 🌐 Go | 📅 2025-08-23 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
* [Milvus](https://github.com/milvus-io/milvus) ⭐ 36,769 | 🐛 669 | 🌐 Go | 📅 2025-08-25 - Milvus is a vector database for embedding management, analytics and search.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 31,210 | 🐛 7,626 | 🌐 Go | 📅 2025-08-25 - Scalable, Geo-Replicated, Transactional Datastore.
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 30,526 | 🐛 2,141 | 🌐 Rust | 📅 2025-08-22 - Scalable datastore for metrics, events, and real-time analytics.
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,169 | 🐛 43 | 🌐 Go | 📅 2025-08-24 - Scalable, Distributed, Low Latency, High Throughput Graph Database.
* [dolt](https://github.com/dolthub/dolt) ⭐ 19,005 | 🐛 433 | 🌐 Go | 📅 2025-08-23 - Dolt – It's Git for Data.
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 16,886 | 🐛 74 | 🌐 Go | 📅 2025-08-24 - The lightweight, distributed, relational database built on SQLite.
* [badger](https://github.com/dgraph-io/badger) ⭐ 14,943 | 🐛 32 | 🌐 Go | 📅 2025-08-20 - Fast key-value store in Go.
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 14,840 | 🐛 800 | 🌐 Go | 📅 2025-08-24 - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,295 | 🐛 108 | 🌐 Go | 📅 2024-05-14 - Implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 38,033 | 🐛 366 | 🌐 C++ | 📅 2025-01-30 key/value database in Go.
* [pebble](https://github.com/cockroachdb/pebble) ⭐ 5,462 | 🐛 312 | 🌐 Go | 📅 2025-08-24 - RocksDB/LevelDB inspired key-value database in Go.
...
* [redka](https://github.com/nalgeon/redka) ⭐ 4,147 | 🐛 2 | 🌐 Go | 📅 2025-07-14 - Redis re-implemented with SQLite.
...
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,496 | 🐛 69 | 🌐 Go | 📅 2025-08-18 - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 17,248 | 🐛 436 | 🌐 Go | 📅 2025-08-24 - Database migrations. CLI and Golang library.
* [bytebase](https://github.com/bytebase/bytebase) ⭐ 12,911 | 🐛 128 | 🌐 Go | 📅 2025-08-25 - Safe database schema change and version control for DevOps teams.
* [goose](https://github.com/pressly/goose) ⭐ 8,989 | 🐛 102 | 🌐 Go | 📅 2025-08-24 - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
* [atlas](https://github.com/ariga/atlas) ⭐ 7,231 | 🐛 224 | 🌐 Go | 📅 2025-08-22 - A Database Toolkit. A CLI designed to help companies better work with their data.
* [dbmate](https://github.com/amacneil/dbmate) ⭐ 6,263 | 🐛 37 | 🌐 Go | 📅 2025-08-18 - A lightweight, framework-agnostic database migration tool.
...
* [libschema](https://github.com/muir/libschema) ⭐ 17 | 🐛 2 | 🌐 Go | 📅 2025-08-22 - Define your migrations separately in each library. Migrations for open source libraries. MySQL & PostgreSQL.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 20,024 | 🐛 877 | 🌐 Go | 📅 2025-08-24 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,386 | 🐛 61 | 🌐 Go | 📅 2025-08-24 - HTTP proxy for ClickHouse database.
...
* [onedump](https://github.com/liweiyi88/onedump) ⭐ 217 | 🐛 0 | 🌐 Go | 📅 2025-07-02 - Database backup from different drivers to different destinations with one command and configuration.
...
* [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 15,803 | 🐛 605 | 🌐 Go | 📅 2025-08-24 - Generate type-safe code from SQL.
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,338 | 🐛 46 | 🌐 Go | 📅 2025-08-09 - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
* [cayley](https://github.com/google/cayley) ⭐ 14,957 | 🐛 92 | 🌐 Go | 📅 2025-06-27 - Graph database with support for multiple backends.
...
* [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15,020 | 🐛 63 | 🌐 Go | 📅 2025-06-13 - MySQL driver for Go.
* [pgx](https://github.com/jackc/pgx) ⭐ 12,344 | 🐛 240 | 🌐 Go | 📅 2025-08-09 - PostgreSQL driver supporting features beyond those exposed by database/sql.
* [pq](https://github.com/lib/pq) ⭐ 9,595 | 🐛 338 | 🌐 Go | 📅 2024-11-26 - Pure Go Postgres driver for database/sql.
* [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 8,663 | 🐛 203 | 🌐 C | 📅 2025-08-14 - SQLite3 driver for go that uses database/sql.
* [go-mssqldb](https://github.com/denisenkom/go-mssqldb) ⭐ 1,863 | 🐛 177 | 🌐 Go | 📅 2025-04-26 - Microsoft MSSQL driver for Go.
* [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 763 | 🐛 6 | 🌐 Go | 📅 2025-08-23 - This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
* [pig](https://github.com/alexeyco/pig) ⭐ 17 | 🐛 1 | 🌐 Go | 📅 2021-04-18 - Simple [pgx](https://github.com/jackc/pgx) ⭐ 12,344 | 🐛 240 | 🌐 Go | 📅 2025-08-09 wrapper to execute and [scan](https://github.com/georgysavva/scany) ⭐ 1,456 | 🐛 6 | 🌐 Go | 📅 2025-03-19 query results easily.
...
* [redis](https://github.com/redis/go-redis) ⭐ 21,436 | 🐛 86 | 🌐 Go | 📅 2025-08-22 - Redis client for Golang.
* [redigo](https://github.com/gomodule/redigo) ⭐ 9,848 | 🐛 23 | 🌐 Go | 📅 2025-05-21 - Redigo is a Go client for the Redis database.
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,428 | 🐛 10 | 🌐 Go | 📅 2025-08-25 - Official MongoDB driver for the Go language.
* [rueidis](http://github.com/rueian/rueidis) ⭐ 2,748 | 🐛 14 | 🌐 Go | 📅 2025-08-06 - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
* [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) ⭐ 3,123 | 🐛 88 | 🌐 Go | 📅 2025-08-22 - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
* [go-zero](https://github.com/tal-tech/go-zero) ⭐ 31,672 | 🐛 340 | 🌐 Go | 📅 2025-08-22 - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,257 | 🐛 57 | 🌐 Go | 📅 2024-07-19 - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [Kratos](https://github.com/go-kratos/kratos) ⭐ 24,752 | 🐛 126 | 🌐 Go | 📅 2025-08-20 - A modular-designed and easy-to-use microservices framework in Go.
* [go-micro](https://github.com/micro/go-micro) ⭐ 22,461 | 🐛 22 | 🌐 Go | 📅 2025-08-19 - A distributed systems development framework.
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 22,126 | 🐛 142 | 🌐 Go | 📅 2025-08-22 - The Go language implementation of gRPC. HTTP/2 based RPC.
* [NATS](https://github.com/nats-io/nats-server) ⭐ 17,852 | 🐛 436 | 🌐 Go | 📅 2025-08-24 - NATS is a simple, secure, and
...
* [Kitex](https://github.com/cloudwego/kitex) ⭐ 7,621 | 🐛 62 | 🌐 Go | 📅 2025-08-21 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
...
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,226 | 🐛 55 | 🌐 Go | 📅 2025-07-23 - A feature complete and high performance multi-group Raft library in Go.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 2,753 | 🐛 24 | 🌐 Go | 📅 2025-08-23 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
* [sponge](https://github.com/zhufuyi/sponge) ⭐ 2,399 | 🐛 33 | 🌐 Go | 📅 2025-08-24 - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
* [mochi mqtt](https://github.com/mochi-co/mqtt) ⭐ 1,616 | 🐛 26 | 🌐 Go | 📅 2025-04-16 - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
...
* [K8gb](https://github.com/k8gb-io/k8gb) ⭐ 1,070 | 🐛 87 | 🌐 Go | 📅 2025-08-24 - A cloud native Kubernetes Global Balancer.
...
* [trpc-go](https://github.com/trpc-group/trpc-go) ⭐ 1,018 | 🐛 10 | 🌐 Go | 📅 2025-07-11 - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
* [Temporal](https://github.com/temporalio/sdk-go) ⭐ 703 | 🐛 199 | 🌐 Go | 📅 2025-08-19 - Durable execution system for making code fault-tolerant and simple.
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 383 | 🐛 0 | 🌐 Go | 📅 2023-07-09 - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,454 | 🐛 360 | 🌐 C++ | 📅 2025-08-08).
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 15,197 | 🐛 252 | 🌐 Go | 📅 2024-02-13 - Email and SMTP testing with web and API interface.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 7,597 | 🐛 0 | 🌐 Go | 📅 2025-08-24 - Email and SMTP testing tool for developers.
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 5,651 | 🐛 132 | 🌐 Go | 📅 2025-07-18 - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
* [mox](https://github.com/mjl-/mox) ⭐ 5,146 | 🐛 151 | 🌐 Go | 📅 2025-08-21 - Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,101 | 🐛 6 | 🌐 Go | 📅 2025-08-08 - A simple Go library for sending mails in Go.
...
* [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 10,116 | 🐛 199 | 🌐 Go | 📅 2025-08-23 - PHP embedded in Go, with a `net/http` handler.
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,327 | 🐛 50 | 🌐 Go | 📅 2025-07-18 - Port of the Lua 5.2 VM to pure Go.
...
* [Wa/凹语言](https://github.com/wa-lang/wa) ⭐ 1,605 | 🐛 5 | 🌐 Go | 📅 2025-08-25 - The Wa Programming Language embedded in Go.
...
* [starlet](https://github.com/1set/starlet) ⭐ 32 | 🐛 3 | 🌐 Go | 📅 2025-04-15 - Go wrapper for [starlark-go](https://github.com/google/starlark-go) ⭐ 2,516 | 🐛 64 | 🌐 Go | 📅 2025-08-04 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 7,925 | 🐛 138 | 🌐 Go | 📅 2025-08-18 - PDF processor.
* [afero](https://github.com/spf13/afero) ⭐ 6,313 | 🐛 159 | 🌐 Go | 📅 2025-08-22 - FileSystem Abstraction System for Go.
* [gdu](https://github.com/dundee/gdu) ⭐ 4,711 | 🐛 55 | 🌐 Go | 📅 2025-07-09 - Disk usage analyzer with console interface.
...
* [fastwalk](https://github.com/charlievieth/fastwalk) ⭐ 103 | 🐛 3 | 🌐 Go | 📅 2025-08-20 - Fast parallel directory traversal library (used by [fzf](https://github.com/junegunn/fzf) ⭐ 73,160 | 🐛 300 | 🌐 Go | 📅 2025-08-24).
...
* [todotxt](https://github.com/1set/todotxt) ⭐ 25 | 🐛 1 | 🌐 Go | 📅 2023-09-21 - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt) ⭐ 2,943 | 🐛 41 | 📅 2025-07-08.
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 6,901 | 🐛 145 | 🌐 Go | 📅 2025-06-24 - Arbitrary-precision fixed-point decimal numbers.
...
* [bbgo](https://github.com/c9s/bbgo) ⭐ 1,512 | 🐛 142 | 🌐 Go | 📅 2025-08-25 - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
* [ledger](https://github.com/formancehq/ledger) ⭐ 1,021 | 🐛 11 | 🌐 Go | 📅 2025-08-22 - A programmable financial ledger that provides a foundation for money-moving applications.
...
* [ach](https://github.com/moov-io/ach) ⭐ 505 | 🐛 25 | 🌐 Go | 📅 2025-08-24 - A reader, writer, and validator for Automated Clearing House (ACH) files.
...
* [mo](https://github.com/samber/mo) ⭐ 3,076 | 🐛 17 | 🌐 Go | 📅 2025-08-18 - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 12,365 | 🐛 297 | 🌐 Go | 📅 2025-08-24 - dead simple 2D game engine in Go.
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,144 | 🐛 6 | 🌐 C | 📅 2025-08-07 - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
* [Pixel](https://github.com/gopxl/pixel) ⭐ 346 | 🐛 32 | 🌐 Go | 📅 2025-03-07 - Hand-crafted 2D game library in Go.
...
* [ecs](https://github.com/andygeiss/ecs) ⭐ 158 | 🐛 0 | 🌐 Go | 📅 2025-07-27 - Build your own Game-Engine based on the Entity Component System concept in Golang.
* [Ark](https://github.com/mlange-42/ark) ⭐ 103 | 🐛 10 | 🌐 Go | 📅 2025-08-24 - Archetype-based Entity Component System (ECS) for Go.
...
* [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 7,515 | 🐛 714 | 🌐 Go | 📅 2025-08-20 - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
* [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,250 | 🐛 22 | 🌐 Go | 📅 2025-08-21 - Generate decorators for Go interfaces using simple templates.
* [go-enum](https://github.com/abice/go-enum) ⭐ 864 | 🐛 12 | 🌐 Go | 📅 2025-08-19 - Code generation for enums from code comments.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,459 | 🐛 152 | 🌐 Go | 📅 2025-08-15 - Geolocation DB with spatial index and realtime geofencing.
...
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 13,004 | 🐛 192 | 🌐 Go | 📅 2025-08-19 - Compiler from Go to JavaScript.
* [bunster](https://github.com/yassinebenaid/bunster) ⭐ 2,489 | 🐛 15 | 🌐 Go | 📅 2025-08-24 - Compile shell scripts to Go.
...
* [ants](https://github.com/panjf2000/ants) ⭐ 13,921 | 🐛 0 | 🌐 Go | 📅 2025-08-08 - A high-performance and low-cost goroutine pool in Go.
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 26,985 | 🐛 748 | 🌐 Go | 📅 2025-08-22 - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
* [webview](https://github.com/zserge/webview) ⭐ 13,297 | 🐛 192 | 🌐 C++ | 📅 2025-07-01 - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
* [cimgui-go](https://github.com/AllenDang/cimgui-go) ⭐ 443 | 🐛 20 | 🌐 C++ | 📅 2025-08-23 - Auto generated Go wrapper for [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 67,767 | 🐛 1,184 | 🌐 C++ | 📅 2025-08-20 via [cimgui](https://github.com/cimgui/cimgui) ⭐ 1,710 | 🐛 17 | 🌐 Lua | 📅 2025-07-14.
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,331 | 🐛 137 | 🌐 Go | 📅 2025-08-03 - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
* [systray](https://github.com/getlantern/systray) ⭐ 3,552 | 🐛 109 | 🌐 Go | 📅 2024-07-03 - Cross platform Go library to place an icon and menu in the notification area.
...
* [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 4,634 | 🐛 224 | 🌐 Go | 📅 2025-08-25 - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
* [go-rpio](https://github.com/stianeikeland/go-rpio) ⭐ 2,250 | 🐛 43 | 🌐 Go | 📅 2023-09-30 - GPIO for Go, doesn't require cgo.
* [ghw](https://github.com/jaypipes/ghw) ⭐ 1,773 | 🐛 60 | 🌐 Go | 📅 2025-08-24 - Golang hardware discovery/inspection library.
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,192 | 🐛 339 | 🌐 Go | 📅 2025-08-06 - Go package for computer vision using OpenCV 3.3+.
...
* [imagor](https://github.com/cshum/imagor) ⭐ 3,720 | 🐛 37 | 🌐 Go | 📅 2025-08-23 - Fast, secure image processing server and Go library, using libvips.
...
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,608 | 🐛 19 | 🌐 Go | 📅 2025-07-28 - Vector graphics to PDF, SVG or rasterized image.
...
* [ekuiper](https://github.com/lf-edge/ekuiper) ⭐ 1,624 | 🐛 53 | 🌐 Go | 📅 2025-08-25 - Lightweight data stream processing engine for IoT edge.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 6,481 | 🐛 18 | 🌐 Go | 📅 2025-08-14 - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron) ⭐ 3,497 | 🐛 46 | 🌐 Go | 📅 2023-11-27.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,142 | 🐛 91 | 🌐 Go | 📅 2024-10-10 - Get a JSON value with one line of code.
...
* [logrus](https://github.com/Sirupsen/logrus) ⭐ 25,442 | 🐛 74 | 🌐 Go | 📅 2025-08-04 - Structured logger for Go.
* [zap](https://github.com/uber-go/zap) ⭐ 23,538 | 🐛 166 | 🌐 Go | 📅 2025-06-02 - Fast, structured, leveled logging in Go.
* [zerolog](https://github.com/rs/zerolog) ⭐ 11,750 | 🐛 144 | 🌐 Go | 📅 2025-04-18 - Zero-allocation JSON logger.
...
* [sentry-go](https://github.com/getsentry/sentry-go) ⭐ 987 | 🐛 44 | 🌐 Go | 📅 2025-08-14 - Sentry SDK for Go. Helps monitor and track errors with real-time alerts and performance monitoring.
...
* [logur](https://github.com/logur/logur) ⚠️ Archived - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus) ⭐ 25,442 | 🐛 74 | 🌐 Go | 📅 2025-08-04, [go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,257 | 🐛 57 | 🌐 Go | 📅 2024-07-19, [zap](https://github.com/uber-go/zap) ⭐ 23,538 | 🐛 166 | 🌐 Go | 📅 2025-06-02, [zerolog](https://github.com/rs/zerolog) ⭐ 11,750 | 🐛 144 | 🌐 Go | 📅 2025-04-18, etc).
...
* [logrusly](https://github.com/sebest/logrusly) ⭐ 29 | 🐛 3 | 🌐 Go | 📅 2021-07-27 - [logrus](https://github.com/sirupsen/logrus) ⭐ 25,442 | 🐛 74 | 🌐 Go | 📅 2025-08-04 plug-in to send errors to a [Loggly](https://www.loggly.com/).
...
* [logrusiowriter](https://github.com/cabify/logrusiowriter) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2024-10-09 - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) ⭐ 25,442 | 🐛 74 | 🌐 Go | 📅 2025-08-04 logger.
...
* [GoMLX](https://github.com/gomlx/gomlx) ⭐ 867 | 🐛 1 | 🌐 Go | 📅 2025-08-22 - An accelerated Machine Learning framework for Go.
...
* [hugot](https://github.com/knights-analytics/hugot) ⭐ 442 | 🐛 8 | 🌐 Go | 📅 2025-08-24 - Huggingface transformer pipelines for golang with onnxruntime.
...
* [catboost-cgo](https://github.com/mirecl/catboost-cgo) ⭐ 18 | 🐛 5 | 🌐 C | 📅 2025-08-22 - Fast, scalable, high performance Gradient Boosting on Decision Trees library. Golang using Cgo for blazing fast inference CatBoost Model.
...
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,168 | 🐛 58 | 🌐 Go | 📅 2025-08-24 - Go library for Apache Kafka.
* [Asynq](https://github.com/hibiken/asynq) ⭐ 11,871 | 🐛 253 | 🌐 Go | 📅 2025-05-15 - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 9,237 | 🐛 28 | 🌐 Go | 📅 2025-08-18 - Real-time messaging (Websockets or SockJS) server in Go.
* [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 8,788 | 🐛 98 | 🌐 Go | 📅 2025-08-22 - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,476 | 🐛 58 | 🌐 Go | 📅 2025-08-24 - Push notification server using [APNs2](https://github.com/sideshow/apns2) ⭐ 3,115 | 🐛 32 | 🌐 Go | 📅 2025-07-22 and google [GCM](https://github.com/google/go-gcm) ⚠️ Archived.
...
* [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6,102 | 🐛 156 | 🌐 Go | 📅 2025-08-22 - Go client for the NATS
  messaging system.
...
* [Mercure](https://github.com/dunglas/mercure) ⭐ 5,029 | 🐛 14 | 🌐 Go | 📅 2025-08-23 - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 4,984 | 🐛 289 | 🌐 HTML | 📅 2025-08-25 - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
* [melody](https://github.com/olahol/melody) ⭐ 3,980 | 🐛 14 | 🌐 Go | 📅 2025-06-08 - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,651 | 🐛 25 | 🌐 Go | 📅 2025-08-19 - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/xuri/excelize) ⭐ 19,539 | 🐛 134 | 🌐 Go | 📅 2025-08-19 - Golang library for reading and writing Microsoft Excel™ (XLSX) files.
...
* [fx](https://github.com/uber-go/fx) ⭐ 6,809 | 🐛 67 | 🌐 Go | 📅 2025-05-13 - A dependency injection based application framework for Go (built on top of dig).
* [dig](https://github.com/uber-go/dig) ⭐ 4,278 | 🐛 29 | 🌐 Go | 📅 2025-05-13 - A reflection based dependency injection toolkit for Go.
* [do](https://github.com/samber/do) ⭐ 2,260 | 🐛 36 | 🌐 Go | 📅 2025-08-23 - A dependency injection framework based on Generics.
...
* [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 185 | 🐛 17 | 🌐 Go | 📅 2025-08-24 - A dependency injection toolkit for Go, based on Guice.
...
* [nject](https://github.com/muir/nject) ⭐ 30 | 🐛 4 | 🌐 Go | 📅 2025-08-22 - A type safe, reflective framework for libraries, tests, http endpoints, and service startup.
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 53,578 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) ⭐ 53,578 | 🐛 94 | 🌐 Makefile | 📅 2025-01-14 for more information. Nonetheless, some may find the layout useful.
* [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 8,060 | 🐛 29 | 🌐 Go | 📅 2025-07-19 - Allows users to spin up a quick Go project using a popular framework.
...
* [nunu](https://github.com/go-nunu/nunu) ⭐ 2,361 | 🐛 1 | 🌐 Go | 📅 2025-08-25 - Nunu is a scaffolding tool for building Go applications.
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,402 | 🐛 223 | 🌐 Go | 📅 2025-08-25 - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 8,003 | 🐛 224 | 🌐 Go | 📅 2025-08-24 - Automated service health dashboard.
...
* [archives](https://github.com/mholt/archives) ⭐ 296 | 🐛 8 | 🌐 Go | 📅 2025-06-26 - a cross-platform, multi-format Go library for working with archives and compression formats with a unified API and as virtual file systems compatible with io/fs.
...
* [gse](https://github.com/go-ego/gse) ⭐ 2,702 | 🐛 13 | 🌐 Go | 📅 2025-06-09 - Go efficient text segmentation; support english, chinese, japanese and other.
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 22,851 | 🐛 97 | 🌐 Go | 📅 2025-08-24 - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
* [webrtc](https://github.com/pions/webrtc) ⭐ 15,219 | 🐛 105 | 🌐 Go | 📅 2025-08-24 - A pure Go implementation of the WebRTC API.
* [kcptun](https://github.com/xtaci/kcptun) ⭐ 14,212 | 🐛 133 | 🌐 Go | 📅 2025-08-13 - Extremely simple & fast udp tunnel based on KCP protocol.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 11,359 | 🐛 454 | 🌐 Go | 📅 2025-08-21 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 10,926 | 🐛 189 | 🌐 Go | 📅 2025-08-24 - An implementation of the QUIC protocol in pure Go.
* [gnet](https://github.com/panjf2000/gnet) ⭐ 10,753 | 🐛 4 | 🌐 Go | 📅 2025-08-10 - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,304 | 🐛 65 | 🌐 Go | 📅 2025-07-31 - KCP - Fast and Reliable ARQ Protocol.
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 4,109 | 🐛 14 | 🌐 Go | 📅 2025-08-10 - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
...
* [nbio](https://github.com/lesismal/nbio) ⭐ 2,572 | 🐛 2 | 🌐 Go | 📅 2025-08-09 - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
...
* [dnsmonster](https://github.com/mosajjal/dnsmonster) ⭐ 336 | 🐛 5 | 🌐 Go | 📅 2025-08-18 - Passive DNS Capture/Monitoring Framework.
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,163 | 🐛 45 | 🌐 Go | 📅 2025-05-11 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [grequests](https://github.com/levigross/grequests) ⭐ 2,166 | 🐛 24 | 🌐 Go | 📅 2025-06-06 - A Go "clone" of the great and famous Requests library.
...
* [azuretls-client](https://github.com/Noooste/azuretls-client) ⭐ 316 | 🐛 8 | 🌐 Go | 📅 2025-08-24 -  An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 38,746 | 🐛 477 | 🌐 Go | 📅 2025-08-20 - The fantastic ORM library for Golang, aims to be developer friendly.
...
* [bun](https://github.com/uptrace/bun) ⭐ 4,330 | 🐛 24 | 🌐 Go | 📅 2025-08-24 - SQL-first Golang ORM. Successor of go-pg.
...
* [bob](https://github.com/stephenafamo/bob) ⭐ 1,424 | 🐛 14 | 🌐 Go | 📅 2025-08-19 - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
...
* [CQL](https://github.com/FrancoLiberali/cql) ⭐ 16 | 🐛 13 | 🌐 Go | 📅 2025-08-25 - Built on top of GORM, adds compile-time verified queries based on auto-generated code.
...
* [syft](https://github.com/anchore/syft) ⭐ 7,518 | 🐛 478 | 🌐 Go | 📅 2025-08-22 - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
* [gup](https://github.com/nao1215/gup) ⭐ 442 | 🐛 4 | 🌐 Go | 📅 2025-08-16 - Update binaries installed by "go install".
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 21,774 | 🐛 312 | 🌐 Go | 📅 2025-08-25 - A distributed tracing system.
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,139 | 🐛 345 | 🌐 C++ | 📅 2025-08-13 - No instrumentation tracing for Golang applications via eBPF.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,445 | 🐛 374 | 🌐 Go | 📅 2025-08-24 - go generate based graphql server library.
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,099 | 🐛 238 | 🌐 Go | 📅 2025-07-28 - Implementation of GraphQL for Go.
* [dasel](https://github.com/tomwright/dasel) ⭐ 7,536 | 🐛 46 | 🌐 Go | 📅 2025-08-23 - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
* [graphql](https://github.com/neelance/graphql-go) ⭐ 4,712 | 🐛 19 | 🌐 Go | 📅 2025-08-24 - GraphQL server with a focus on ease of use.
...
* [jsonpath](https://github.com/AsaiYusuke/jsonpath) ⭐ 27 | 🐛 2 | 🌐 Go | 📅 2025-08-24 - A query library for retrieving part of JSON based on JSONPath syntax.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,126 | 🐛 251 | 🌐 Go | 📅 2025-06-08 - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
* [gograph](https://github.com/hmdsefi/gograph) ⭐ 89 | 🐛 4 | 🌐 Go | 📅 2025-08-22 - A golang generic graph library that provides mathematical graph-theory and algorithms.
...
* [age](https://github.com/FiloSottile/age) ⭐ 19,534 | 🐛 49 | 🌐 Go | 📅 2025-08-18 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
* [lego](https://github.com/go-acme/lego) ⭐ 8,822 | 🐛 158 | 🌐 Go | 📅 2025-08-24 - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 4,658 | 🐛 28 | 🌐 Go | 📅 2025-07-13 - Tool and library to remotely hack RTSP streams from surveillance cameras.
* [Coraza](https://github.com/corazawaf/coraza) ⭐ 2,869 | 🐛 92 | 🌐 Go | 📅 2025-08-22 - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
* [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,397 | 🐛 3 | 🌐 Go | 📅 2025-08-24 - A secure low code honeypot framework, leveraging AI for System Virtualization.
* [dongle](https://github.com/golang-module/dongle) ⭐ 996 | 🐛 3 | 🌐 Go | 📅 2025-08-23 - A simple, semantic and developer-friendly golang package for encoding\&decoding and encryption\&decryption.
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 10,001 | 🐛 116 | 🌐 Go | 📅 2024-08-05 - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
* [Caddy](https://github.com/caddyserver/caddy) ⭐ 66,365 | 🐛 215 | 🌐 Go | 📅 2025-08-23 - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
* [minio](https://github.com/minio/minio) ⭐ 54,788 | 🐛 54 | 🌐 Go | 📅 2025-08-22 - Minio is a distributed object storage server.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 50,137 | 🐛 285 | 🌐 Go | 📅 2025-08-24 - Highly-available key value store for shared configuration and service discovery.
* [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 50,052 | 🐛 19 | 🌐 Go | 📅 2025-08-23 - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 10,894 | 🐛 121 | 🌐 Go | 📅 2025-08-22 - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
* [Easegress](https://github.com/megaease/easegress) ⭐ 5,849 | 🐛 8 | 🌐 Go | 📅 2025-08-25 - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,530 | 🐛 47 | 🌐 Go | 📅 2025-08-24 - A self contained feature flag solution written in Go and Vue.js
* [Wish](https://github.com/charmbracelet/wish) ⭐ 4,338 | 🐛 15 | 🌐 Go | 📅 2025-08-18 - Make SSH apps, just like that!
* [Fider](https://github.com/getfider/fider) ⭐ 3,727 | 🐛 48 | 🌐 Go | 📅 2025-08-20 - Fider is an open platform to collect and organize customer feedback.
...
* [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 1,722 | 🐛 44 | 🌐 Go | 📅 2025-08-25 - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,085 | 🐛 5 | 🌐 Go | 📅 2025-08-16 - Go stream processing library.
...
* [templ](https://github.com/a-h/templ) ⭐ 9,611 | 🐛 61 | 🌐 Go | 📅 2025-08-18 - A HTML templating language that has great developer tooling.
...
* [pongo2](https://github.com/flosch/pongo2) ⭐ 2,973 | 🐛 72 | 🌐 Go | 📅 2024-08-14 - Django-like template-engine for Go.
...
* [Testify](https://github.com/stretchr/testify) ⭐ 25,055 | 🐛 373 | 🌐 Go | 📅 2025-08-24 - Sacred extension to the standard go testing package.
* [keploy](https://github.com/keploy/keploy) ⭐ 10,352 | 🐛 264 | 🌐 Go | 📅 2025-08-25 - Generate Testcase and Data Mocks from API calls automatically.
...
* [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4,284 | 🐛 158 | 🌐 Go | 📅 2025-08-21 - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
* [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,322 | 🐛 3 | 🌐 Go | 📅 2025-08-17 - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
* [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,184 | 🐛 13 | 🌐 Go | 📅 2025-08-24 - A helper for Rails' like test fixtures to test database applications.
...
* [go-testdeep](https://github.com/maxatome/go-testdeep) ⭐ 451 | 🐛 3 | 🌐 Go | 📅 2025-08-24 - Extremely flexible golang deep comparison, extends the go testing package.
...
* [Gont](https://github.com/stv0g/gont) ⭐ 86 | 🐛 13 | 🌐 Go | 📅 2025-08-25 - Go network testing toolkit for testing building complex network topologies using Linux namespaces.
...
* [mockery](https://github.com/vektra/mockery) ⭐ 6,757 | 🐛 49 | 🌐 Go | 📅 2025-08-22 - Tool to generate Go interfaces.
* [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,437 | 🐛 41 | 🌐 Go | 📅 2024-09-11 - Mock SQL driver for testing database interactions.
* [gomock](https://github.com/uber-go/mock) ⭐ 2,992 | 🐛 100 | 🌐 Go | 📅 2025-08-18 - Mocking framework for the Go programming language.
...
* [minimock](https://github.com/gojuno/minimock) ⭐ 721 | 🐛 11 | 🌐 Go | 📅 2025-08-24 - Mock generator for Go interfaces.
* [pgxmock](https://github.com/pashagolub/pgxmock) ⭐ 515 | 🐛 2 | 🌐 Go | 📅 2025-08-19 - A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/) ⭐ 12,344 | 🐛 240 | 🌐 Go | 📅 2025-08-09.
...
* [chromedp](https://github.com/knq/chromedp) ⭐ 12,176 | 🐛 148 | 🌐 Go | 📅 2025-08-05 - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
* [rod](https://github.com/go-rod/rod) ⭐ 6,187 | 🐛 192 | 🌐 Go | 📅 2024-12-07 - A Devtools driver to make web automation and scraping easy.
* [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 2,869 | 🐛 56 | 🌐 Go | 📅 2025-05-09 - browser automation library to control Chromium, Firefox and WebKit with a single API.
...
* [toml](https://github.com/BurntSushi/toml) ⭐ 4,789 | 🐛 21 | 🌐 Go | 📅 2025-06-06 - TOML configuration format (encoder/decoder with reflection).
* [goldmark](https://github.com/yuin/goldmark) ⭐ 4,277 | 🐛 12 | 🌐 Go | 📅 2025-07-22 - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
* [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,008 | 🐛 13 | 🌐 Go | 📅 2025-08-24 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
* [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,846 | 🐛 33 | 🌐 Go | 📅 2025-08-24 - Go library for the TOML format with query support and handy cli tools.
...
* [sh](https://github.com/mvdan/sh) ⭐ 8,005 | 🐛 96 | 🌐 Go | 📅 2025-08-18 - Shell parser and formatter.
...
* [colly](https://github.com/asciimoo/colly) ⭐ 24,571 | 🐛 191 | 🌐 Go | 📅 2025-08-21 - Fast and Elegant Scraping Framework for Gophers.
* [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,677 | 🐛 4 | 🌐 Go | 📅 2025-08-12 - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
* [github](https://github.com/google/go-github) ⭐ 10,915 | 🐛 51 | 🌐 Go | 📅 2025-08-18 - Go library for accessing the GitHub REST API v3.
* [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10,263 | 🐛 214 | 🌐 Go | 📅 2025-08-12 - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,536 | 🐛 198 | 🌐 Go | 📅 2025-07-05 - Go bindings for the Discord Chat API.
* [slack](https://github.com/slack-go/slack) ⭐ 4,825 | 🐛 106 | 🌐 Go | 📅 2025-08-19 - Slack API in Go.
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,315 | 🐛 369 | 🌐 Go | 📅 2025-08-23 - Google Cloud APIs Go Client Library.
* [google](https://github.com/google/google-api-go-client) ⭐ 4,314 | 🐛 18 | 🌐 Go | 📅 2025-08-24 - Auto-generated Google APIs for Go.
* [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3,222 | 🐛 85 | 🌐 Go | 📅 2025-08-22 - The official AWS SDK for the Go programming language.
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,786 | 🐛 20 | 🌐 Go | 📅 2025-08-21 - Minio Go Library for Amazon S3 compatible cloud storage.
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,381 | 🐛 13 | 🌐 Go | 📅 2025-08-20 - Go client for the Stripe API.
...
* [gopensky](https://github.com/navidys/gopensky) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2025-08-22 - Go client implementation for [OpenSKY Network](https://opensky-network.org/) live's API (airspace ADS-B and Mode S data).
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 73,160 | 🐛 300 | 🌐 Go | 📅 2025-08-24 - Command-line fuzzy finder written in Go.
* [dive](https://github.com/wagoodman/dive) ⭐ 51,804 | 🐛 177 | 🌐 Go | 📅 2025-08-21 - A tool for exploring each layer in a Docker image.
...
* [lo](https://github.com/samber/lo) ⭐ 20,035 | 🐛 208 | 🌐 Go | 📅 2025-08-24 - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,145 | 🐛 382 | 🌐 Go | 📅 2024-08-15 - provides a set of extensions on top of the excellent built-in database/sql package.
* [ctop](https://github.com/bcicen/ctop) ⭐ 16,794 | 🐛 115 | 🌐 Go | 📅 2024-07-08 - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 15,048 | 🐛 24 | 🌐 Go | 📅 2025-08-25 - Deliver Go binaries as fast and easily as possible.
...
* [retry-go](https://github.com/avast/retry-go) ⭐ 2,766 | 🐛 14 | 🌐 Go | 📅 2025-03-21 - Simple library for retry mechanism.
...
* [jump](https://github.com/gsamokovarov/jump) ⭐ 1,874 | 🐛 2 | 🌐 Go | 📅 2025-07-16 - Jump helps you navigate faster by learning your habits.
...
* [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 1,823 | 🐛 28 | 🌐 Go | 📅 2025-08-24 - Fault tolerance and resilience patterns for Go.
...
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) ⭐ 1,155 | 🐛 23 | 🌐 Go | 📅 2024-05-15 - Circuit Breakers in Go.
...
* [changie](https://github.com/miniscruff/changie) ⭐ 788 | 🐛 5 | 🌐 Go | 📅 2025-08-24 - Automated changelog tool for preparing releases with lots of customization options.
* [circuit](https://github.com/cep21/circuit) ⭐ 788 | 🐛 4 | 🌐 Go | 📅 2025-08-24 - An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern.
...
* [ulid](https://github.com/oklog/ulid) ⭐ 4,832 | 🐛 5 | 🌐 Go | 📅 2025-06-09 - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
* [uuid](https://github.com/gofrs/uuid) ⭐ 1,716 | 🐛 8 | 🌐 Go | 📅 2025-08-11 - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
...
* [validator](https://github.com/go-playground/validator) ⭐ 18,896 | 🐛 319 | 🌐 Go | 📅 2025-08-15 - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [validate](https://github.com/gookit/validate) ⭐ 1,110 | 🐛 32 | 🌐 Go | 📅 2025-08-21 - Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features.
* [Zog](https://github.com/Oudwins/zog) ⭐ 951 | 🐛 8 | 🌐 Go | 📅 2025-08-24 - A [Zod](https://github.com/colinhacks/zod) ⭐ 39,664 | 🐛 262 | 🌐 TypeScript | 📅 2025-08-24 inspired schema builder for runtime value parsing and validation.
  **[⬆ back to top](#contents)**
...
* [go-git](https://github.com/go-git/go-git) ⭐ 6,802 | 🐛 175 | 🌐 Go | 📅 2025-08-20 - highly extensible Git implementation in pure Go.
...
* [mp4ff](https://github.com/Eyevinn/mp4ff) ⭐ 547 | 🐛 1 | 🌐 Go | 📅 2025-08-23 - Library and tools for working with MP4 files containing video, audio, subtitles, or metadata.
* [go-astiav](https://github.com/asticode/go-astiav) ⭐ 543 | 🐛 4 | 🌐 Go | 📅 2025-08-19 - Better C bindings for ffmpeg in GO.
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 83,704 | 🐛 873 | 🌐 Go | 📅 2025-08-12 - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Fiber](https://github.com/gofiber/fiber) ⭐ 37,464 | 🐛 84 | 🌐 Go | 📅 2025-08-24 - An Express.js inspired web framework build on Fasthttp.
...
* [Echo](https://github.com/labstack/echo) ⭐ 31,444 | 🐛 110 | 🌐 Go | 📅 2025-08-12 - High performance, minimalist Go web framework.
* [Revel](https://github.com/revel/revel) ⭐ 13,223 | 🐛 99 | 🌐 Go | 📅 2023-10-28 - High-productivity web framework for the Go language.
* [GoFrame](https://github.com/gogf/gf) ⭐ 12,654 | 🐛 223 | 🌐 Go | 📅 2025-08-23 - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
* [GoFr](https://github.com/gofr-dev/gofr) ⭐ 12,548 | 🐛 87 | 🌐 Go | 📅 2025-08-22 - Gofr is an opinionated microservice development framework.
* [Hertz](https://github.com/cloudwego/hertz) ⭐ 6,651 | 🐛 40 | 🌐 Go | 📅 2025-08-21 - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
* [Goa](https://github.com/goadesign/goa) ⭐ 5,933 | 🐛 30 | 🌐 Go | 📅 2025-08-24 - Goa provides a holistic approach for developing remote APIs and microservices in Go.
* [goravel](https://github.com/goravel/goravel) ⭐ 3,988 | 🐛 55 | 🌐 Go | 📅 2025-08-23 - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
* [Huma](https://github.com/danielgtaylor/huma/) ⭐ 3,341 | 🐛 136 | 🌐 Go | 📅 2025-08-05 - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
* [Fuego](https://github.com/go-fuego/fuego) ⭐ 1,490 | 🐛 41 | 🌐 Go | 📅 2025-08-20 - The framework for busy Go developers! Web framework generating OpenAPI 3 spec from source code.
...
* [templui](https://github.com/axzilla/templui) ⭐ 883 | 🐛 0 | 🌐 JavaScript | 📅 2025-08-24 - Modern UI Components for Go & Templ.
...
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 543 | 🐛 36 | 🌐 Go | 📅 2025-08-24 - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
...
* [alice](https://github.com/justinas/alice) ⭐ 3,301 | 🐛 11 | 🌐 Go | 📅 2024-06-06 - Painless middleware chaining for Go.
...
* [mux](https://github.com/gorilla/mux) ⭐ 21,546 | 🐛 34 | 🌐 Go | 📅 2024-08-15 - Powerful URL router and dispatcher for golang.
* [chi](https://github.com/go-chi/chi) ⭐ 20,380 | 🐛 86 | 🌐 Go | 📅 2025-08-15 - Small, fast and expressive HTTP router built on net/context.
...
* [nchi](https://github.com/muir/nchi) ⭐ 18 | 🐛 3 | 🌐 Go | 📅 2025-08-22 - chi-like router built on httprouter with dependency injection based middleware wrappers
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 16,600 | 🐛 527 | 🌐 Go | 📅 2025-08-23 - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
* [Dagu](https://github.com/dagu-go/dagu) ⭐ 2,546 | 🐛 113 | 🌐 Go | 📅 2025-08-25 - No-code workflow executor. it executes DAGs defined in a simple YAML format.
* [go-taskflow](https://github.com/noneback/go-taskflow) ⭐ 572 | 🐛 0 | 🌐 Go | 📅 2025-08-04 - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
...
* [Cosign](https://github.com/sigstore/cosign) ⭐ 5,155 | 🐛 265 | 🌐 Go | 📅 2025-08-21 - Container Signing, Verification and Storage in an OCI registry.
* [OpenZiti](https://github.com/openziti/ziti) ⭐ 3,529 | 🐛 257 | 🌐 Go | 📅 2025-08-22 - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) ⭐ 111 | 🐛 21 | 🌐 Go | 📅 2025-08-20 allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2025-06-25
* [Spire](https://github.com/spiffe/spire) ⭐ 2,029 | 🐛 153 | 🌐 Go | 📅 2025-08-24 - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
* [Spiffe-Vault](https://github.com/philips-labs/spiffe-vault) ⭐ 92 | 🐛 2 | 🌐 Go | 📅 2025-08-22 - Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication.

## Code Analysis

*Source code analysis tools, also known as Static Application Security Testing (SAST) Tools.*

* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 17,548 | 🐛 114 | 🌐 Go | 📅 2025-08-24 – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,550 | 🐛 586 | 🌐 Go | 📅 2025-08-08 - staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [revive](https://github.com/mgechev/revive) ⭐ 5,270 | 🐛 68 | 🌐 Go | 📅 2025-08-24 – \~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
* [testifylint](https://github.com/Antonboom/testifylint) ⭐ 150 | 🐛 39 | 🌐 Go | 📅 2025-08-01 – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify) ⭐ 25,055 | 🐛 373 | 🌐 Go | 📅 2025-08-24.
...
* [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) ⭐ 577 | 🐛 14 | 🌐 TypeScript | 📅 2024-10-22 - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) ⭐ 7,780 | 🐛 102 | 🌐 Go | 📅 2025-08-21 features to Vim/Neovim.
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,820 | 🐛 614 | 🌐 Go | 📅 2025-08-21 - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
* [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 1,656 | 🐛 10 | 🌐 Go | 📅 2025-08-25 - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 117,049 | 🐛 2,622 | 🌐 Go | 📅 2025-08-21 - Container Cluster Manager from Google.
* [Moby](https://github.com/moby/moby) ⭐ 70,530 | 🐛 3,669 | 🌐 Go | 📅 2025-08-22 - Collaborative project for the container ecosystem to assemble container-based systems.
* [traefik](https://github.com/containous/traefik) ⭐ 56,196 | 🐛 670 | 🌐 Go | 📅 2025-08-22 - Reverse proxy and load balancer with support for multiple backends.
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 50,292 | 🐛 2,788 | 🌐 Go | 📅 2025-08-24 - Fork of Gogs, entirely community driven.
* [minikube](https://github.com/kubernetes/minikube) ⭐ 30,852 | 🐛 544 | 🌐 Go | 📅 2025-08-23 - Run Kubernetes locally.
* [k3s](https://github.com/k3s-io/k3s) ⭐ 30,583 | 🐛 127 | 🌐 Go | 📅 2025-08-22 - Lightweight Kubernetes.
* [k6](https://github.com/grafana/k6) ⭐ 28,577 | 🐛 752 | 🌐 Go | 📅 2025-08-24 - A modern load testing tool, using Go and JavaScript.
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 24,474 | 🐛 96 | 🌐 Go | 📅 2024-10-28 - HTTP load testing tool and library. It's over 9000!
* [Hey](https://github.com/rakyll/hey) ⭐ 19,194 | 🐛 182 | 🌐 Go | 📅 2024-08-20 - Hey is a tiny program that sends some load to a web application.
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,442 | 🐛 297 | 🌐 Go | 📅 2025-08-25 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 14,465 | 🐛 214 | 🌐 Go | 📅 2025-08-21 - Kubernetes IN Docker - local clusters for testing Kubernetes.
...
* [Flannel](https://github.com/flannel-io/flannel) ⭐ 9,217 | 🐛 25 | 🌐 Go | 📅 2025-08-20 - Flannel is a network fabric for containers, designed for Kubernetes.
* [Ddosify](https://github.com/ddosify/ddosify) ⭐ 8,484 | 🐛 16 | 🌐 Go | 📅 2025-03-13 - High-performance load testing tool, written in Golang.
* [ko](https://github.com/google/ko) ⭐ 8,107 | 🐛 54 | 🌐 Go | 📅 2025-08-25 - Command line tool for building and deploying Go applications on Kubernetes
* [KubeVela](https://github.com/kubevela/kubevela) ⭐ 6,818 | 🐛 552 | 🌐 Go | 📅 2025-08-23 - Cloud native application delivery.
...
* [k3d](https://github.com/k3d-io/k3d) ⭐ 5,972 | 🐛 253 | 🌐 Go | 📅 2025-07-29 - Little helper to run CNCF's k3s in Docker.
* [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5,677 | 🐛 30 | 🌐 Go | 📅 2025-08-22 - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
* [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 5,435 | 🐛 2,676 | 🌐 Go | 📅 2025-08-24 - Lightweight, programmable telemetry for servers and workstations.
* [gaia](https://github.com/gaia-pipeline/gaia) ⭐ 5,233 | 🐛 55 | 🌐 Go | 📅 2023-08-22 - Build powerful pipelines in any programming language.
* [tau](https://github.com/taubyte/tau) ⭐ 4,428 | 🐛 35 | 🌐 Go | 📅 2025-08-23 - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,420 | 🐛 137 | 🌐 Go | 📅 2025-08-22 - Pomerium is an identity-aware access proxy.
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 3,533 | 🐛 148 | 🌐 Go | 📅 2025-06-13 - Blazing fast S3 and local filesystem execution tool.
* [bosun](https://github.com/bosun-monitor/bosun) ⚠️ Archived - Time Series Alerting Framework.
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 2,793 | 🐛 146 | 🌐 Go | 📅 2025-08-25 - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 1,799 | 🐛 8 | 🌐 Go | 📅 2025-08-25 - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
...
* [PipeCD](https://github.com/pipe-cd/pipecd) ⭐ 1,208 | 🐛 121 | 🌐 Go | 📅 2025-08-25 - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
* [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1,201 | 🐛 0 | 🌐 Go | 📅 2025-08-24 - KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 388 | 🐛 14 | 🌐 Go | 📅 2025-08-24 - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
* [croc](https://github.com/schollz/croc) ⭐ 30,898 | 🐛 11 | 🌐 Go | 📅 2025-08-12 - Easily and securely send files or folders from one computer to another.
* [restic](https://github.com/restic/restic) ⭐ 29,776 | 🐛 492 | 🌐 Go | 📅 2025-08-07 - De-duplicating backup program.
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 25,593 | 🐛 609 | 🌐 Go | 📅 2025-08-25 - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 12,056 | 🐛 149 | 🌐 Go | 📅 2025-08-25 - Distributed POSIX file system built on top of Redis and AWS S3.
...
* [scc](https://github.com/boyter/scc) ⭐ 7,585 | 🐛 54 | 🌐 Go | 📅 2025-08-23 - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
...
* [blocky](https://github.com/0xERR0R/blocky) ⭐ 5,572 | 🐛 72 | 🌐 Go | 📅 2025-08-22 - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
* [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2,212 | 🐛 33 | 🌐 Go | 📅 2025-08-09 - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
* [portal](https://github.com/SpatiumPortae/portal) ⭐ 1,687 | 🐛 28 | 🌐 Go | 📅 2024-08-20 - Portal is a quick and easy command-line file transfer utility from any computer to another.
...
* [Chapar](https://github.com/chapar-rest/chapar) ⭐ 613 | 🐛 8 | 🌐 Go | 📅 2025-08-24 - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
* [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 18,426 | 🐛 2 | 📅 2025-04-05 - A curated list of Go books.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md) ⭐ 31,210 | 🐛 7,626 | 🌐 Go | 📅 2025-08-25
* [Uber](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 16,771 | 🐛 27 | 🌐 Makefile | 📅 2025-08-18
* [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst) ⭐ 16,241 | 🐛 186 | 🌐 Go | 📅 2025-08-24
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) ⭐ 129,574 | 🐛 9,509 | 🌐 Go | 📅 2025-08-25 - List of projects on the Go community wiki.
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 39,550 | 🐛 7 | 📅 2025-07-30 - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43,777 | 🐛 133 | 🌐 Go | 📅 2024-05-12 - Golang ebook intro how to build a web app with golang.
* [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 26,797 | 🐛 66 | 🌐 Go | 📅 2024-05-14 - Curated list of Go design patterns, recipes and idioms.
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 23,086 | 🐛 68 | 🌐 Go | 📅 2025-08-21 - Learn Go with test-driven development.
* [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 19,447 | 🐛 40 | 🌐 Go | 📅 2025-06-24 - Learn Go with thousands of examples, exercises, and quizzes.
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) ⭐ 8,693 | 🐛 24 | 📅 2023-11-08 - Go's reference card.
* [go-clean-template](https://github.com/evrone/go-clean-template) ⭐ 7,030 | 🐛 8 | 🌐 Go | 📅 2025-08-22 - Clean Architecture template for Golang services.
...
* [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) ⭐ 1,079 | 🐛 11 | 🌐 Go | 📅 2025-08-25 - A GitHub repository offering coding challenges for Go technical interview preparation.
